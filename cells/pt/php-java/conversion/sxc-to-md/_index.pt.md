---
title: Conversor PHP SXC para MD - SXC para MD
description: Aspose Excel. Converta SXC em MD de forma rápida e fácil com Aspose.Cells. PHP SXC em MD. PHP Salve SXC em MD. Salve SXC como MD usando PHP.
...
{{% cells-convert title="Exemplo de código para converter SXC em MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="md" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Como converter SXC para MD via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC para MD programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em MD em apenas algumas linhas de código.
...
1.  Converta SXC em MD chamando o método save da pasta de trabalho.
