---
title: รวม XLSB ถึง BMP - รวม XLSB ถึง BMP ใน C#
url: /th/net/merger/merge-xlsb-to-bmp/ 
description: Aspose เอ็กเซล. C# Aspose.Cells รวม XLSB เป็น BMP บันทึกฟอร์แมต C# รวมรูปแบบ XLSB ถึง BMP รวม XLSB ถึง BMP เข้า C# XLSB รวม.
...
{{% blocks/products/pf/agp/content h2="รวม XLSB ถึง BMP ใน C#" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน XLSB ถึง BMP ใน Aspose.Cells for .NET
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่ายๆ เพื่อรวม XLSB ถึง BMP อัปโหลดไฟล์ของคุณ เรียกวิธี Workbook.Combine เพื่อรวมไฟล์ จากนั้นบันทึกลงในไฟล์ BMP หากคุณพัฒนาโค้ดใน C# สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง C# ที่รวม XLSB กับ BMP

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="โค้ดตัวอย่างที่จะรวม XLSB ถึง BMP ใน C#" InputFormat="xlsb" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="วิธีรวม XLSB ถึง BMP ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม XLSB กับ BMP โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2=".NET ห้องสมุดรวม XLSB เป็น BMP" %}}
