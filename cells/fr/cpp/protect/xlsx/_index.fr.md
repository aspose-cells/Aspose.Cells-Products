...
weight: 1140
description: Exemple de code C++ pour verrouiller le fichier XLSX à l'aide du mot de passe sur l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
---
...
1.  Charger le fichier XLSX à l'aide de la classe IWorkbook
