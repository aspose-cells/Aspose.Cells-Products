---
title: Fusionner EXCEL vers PRN - Combiner EXCEL vers PRN dans C#
url: /fr/net/merger/merge-excel-to-prn/ 
description: Aspose Excel. C# Aspose.Cells. Fusion gratuite en ligne EXCEL au format de sauvegarde PRN. C# Combinez le format EXCEL au format PRN. Fusionner EXCEL à PRN en C#. Fusionner EXCEL.
...
{{% blocks/products/pf/agp/content h2="Fusionner EXCEL à PRN en C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner EXCEL vers PRN dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner EXCEL vers PRN. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier PRN. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne EXCEL à PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner EXCEL vers PRN en C#" InputFormat="xlsx" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner EXCEL vers PRN via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner EXCEL vers PRN par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner EXCEL à PRN" %}}
