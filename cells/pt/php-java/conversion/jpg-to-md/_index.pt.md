---
title: Conversor PHP de JPG para MD - JPG para MD
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores PHP uma abordagem totalmente integrada para converter JPG para o formato MD, permitindo o salvamento perfeito de dados JPG em formato MD usando a biblioteca Aspose.Cells, tudo por meio de código PHP eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Como converter JPG para MD via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos JPG para MD programaticamente? Desenvolvedores PHP podem facilmente carregar e converter JPG para MD com apenas algumas linhas de código.
...
1.  Converter JPG para MD chamando o método save da Workbook.
1.  Obtenha o resultado da conversão de JPG para MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter JPG em MD" %}}
