...
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C++ uma abordagem totalmente integrada para converter XLS para o formato TABDELIMITED, permitindo o salvamento perfeito de dados XLS no formato TABDELIMITED usando a biblioteca Aspose.Cells, tudo por meio de código C++ eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Converter XLS para TABDELIMITED usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salvar XLS em TABDELIMITED em C++" %}}

O exemplo a seguir demonstra como converter XLS para TABDELIMITED em C++.
...
Precisa converter arquivos XLS para TABDELIMITED programaticamente? Desenvolvedores que trabalham com C++ podem facilmente converter arquivos XLS para TABDELIMITED com apenas algumas linhas de código.
...
1. Converta XLS para TABDELIMITED chamando o método Save().
