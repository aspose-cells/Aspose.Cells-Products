...
description: Aspose Excel. Java Aspose.Cells. Sloučit TXT do SXC uložit formát. Java Kombinujte formát TXT až SXC. Sloučit TXT až SXC v Java. TXT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit TXT až SXC v Java" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení TXT až SXC v Java" InputFormat="txt" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
