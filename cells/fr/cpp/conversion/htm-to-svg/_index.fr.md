---
title: C++ HTM à SVG - Convertisseur HTM à SVG
description: Aspose Exceller. Convertissez HTM en SVG rapidement et facilement avec Aspose.Cells. C++ HTM en SVG. C++ Enregistrez HTM en SVG. Enregistrez HTM sous SVG en utilisant C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTM en SVG dans C++" h2="Conversion HTM vers SVG haute performance à l\'aide de la bibliothèque C++ sans avoir besoin d\'installation Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM au SVG dans C++" %}}

L'exemple suivant montre comment convertir HTM en SVG en C++.
...
{{% cells-convert title="Exemple de code pour convertir HTM en SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="svg" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en SVG via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers HTM en SVG par programme ? Les développeurs C++ peuvent facilement convertir HTM en SVG en quelques lignes de code seulement.
...
1.  Convertissez HTM en SVG en appelant la méthode Save().
1.  Obtenez le résultat de la conversion de HTM en SVG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour convertir HTM en SVG" %}}
