---
title: Python IMAGE σε TSV - IMAGE to TSV Converter
description: Aspose Excel. Python Aspose.Cells. IMAGE σε TSV στο Python. Python Μετατροπή IMAGE σε TSV saveformat. Μορφή Python IMAGE έως TSV. Αποθηκεύστε την ΕΙΚΟΝΑ στο TSV Python.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το IMAGE στο TSV στο Python" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή IMAGE σε TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="tsv" IsLandingPage="true" language="pythonnet" %}}
