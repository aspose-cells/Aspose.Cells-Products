---
title: Voeg TXT samen met IMAGE - Combineer TXT met IMAGE in C++
url: /nl/cpp/merger/merge-txt-to-image/ 
description: Aspose Excel. C++ Aspose.Cells. Voeg TXT samen naar het IMAGE-opslagformaat. C++ Combineer TXT tot IMAGE-formaat. Voeg TXT samen met AFBEELDING in C++. TXT Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg TXT samen met AFBEELDING in C++" %}}

Het volgende voorbeeld laat zien hoe u TXT samenvoegt met IMAGE in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TXT samen te voegen met IMAGE. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het IMAGE-bestand. Als u code ontwikkelt in C++, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld C++ waarin TXT wordt samengevoegd met IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om TXT samen te voegen met AFBEELDING in C++" InputFormat="txt" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe TXT samen te voegen met IMAGE via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TXT programmatisch samenvoegen met IMAGE? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om TXT samen te voegen met IMAGE" %}}
