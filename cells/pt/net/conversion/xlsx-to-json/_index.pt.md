...
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLSX para JSON em C#" h2="Biblioteca C# de alta velocidade para converter XLSX em JSON. Esta é uma solução de software profissional para importar e exportar XLSX, JSON e muitos outros formatos nas plataformas .NET Framework, .NET Core ou Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Precisa converter arquivos XLSX para JSON programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter XLSX em JSON em apenas algumas linhas de código.
...
1.  Converta XLSX em JSON chamando o método Workbook.Save.
