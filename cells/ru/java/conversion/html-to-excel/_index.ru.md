...
{{% blocks/products/pf/agp/content h2="Преобразовать HTML в Excel, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните значение HTML в Excel в файле Java." %}}

Следующий пример демонстрирует, как преобразовать значение HTML в формат EXCEL в файле Java.
...
Нужно программно преобразовать файлы HTML в Excel? Разработчики, работающие с файлами Java, могут легко преобразовать файлы HTML в Excel всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для преобразования файла HTML в Excel." %}}
{{% blocks/products/pf/agp/text %}}
