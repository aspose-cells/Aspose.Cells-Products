...
description: Aspose Excel. A XLTM-es számot PNG-re gyorsan és egyszerűen a Aspose.Cells-es számmal alakíthatja át. C# XLTM-PNG-re. 13481 a C# számon.
...
{{% blocks/products/pf/agp/content h2="Mentse a XLTM-PNG számot a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet a XLTM-et PNG-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód a XLTM PNG-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A XLTM konvertálása PNG-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A XLTM fájlt programozottan PNG-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a XLTM-et PNG-re.
...
1.  Konvertálja a XLTM-et PNG-re a Workbook.Save metódus meghívásával.
1.  Szerezze meg a XLTM-es konverziós eredményt PNG-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a XLTM konvertálásához PNG-re" %}}
