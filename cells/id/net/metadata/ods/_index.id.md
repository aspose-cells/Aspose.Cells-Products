---
title:  Lihat atau Edit ODS File Metadata via .NET
weight: 320
description: Kode sumber C# untuk mengedit atau melihat metadata format ODS pada Kerangka .NET, Inti .NET, Mono atau Platform Xamarin.
...
+ Muat ODS dengan instance Buku Kerja
