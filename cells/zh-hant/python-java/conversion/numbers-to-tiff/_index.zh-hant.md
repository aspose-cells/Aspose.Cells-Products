...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 NUMBERS 轉換為 TIFF。將 Python NUMBERS 轉換為 TIFF。Python 將 NUMBERS 儲存為 TIFF863481 將 NUMBERS 儲存為 TIFF863481 。
...
{{% blocks/products/pf/agp/content h2="將號碼儲存到 Python 中的 TIFF" %}}

以下範例示範如何將 Python 中的 NUMBERS 轉換為 TIFF。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 NUMBERS 轉換為 TIFF。上傳您的 NUMBERS 文件，然後只需將其另存為 TIFF 文件。對於 NUMBERS 讀取和 TIFF 寫入，您可以使用完全限定的檔案名稱。輸出 TIFF 內容和格式將與原始 NUMBERS 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將數字轉換為 TIFF 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="tiff" IsLandingPage="true" language="pythonjava" %}}
