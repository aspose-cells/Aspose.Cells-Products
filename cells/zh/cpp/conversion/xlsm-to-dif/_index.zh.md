...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 将 XLSM 转换为 DIF" %}}

 为了将 XLSM 转换为 DIF，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C++ 将 XLSM 转换为 DIF 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 C++ 开发人员只需几行代码即可轻松地将 XLSM 文件转换为 DIF。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加载 XLSM 文件。1. 调用 Save() 方法。1. 使用 (DIF) 文件扩展名传递输出文件路径。1. DIF 文件将保存在指定路径。1. 在兼容程序中打开 DIF 文件。
...
{{% blocks/products/pf/agp/code-block title="XLSM 到 DIF C++ 转换源代码" offSpacer="" %}}
