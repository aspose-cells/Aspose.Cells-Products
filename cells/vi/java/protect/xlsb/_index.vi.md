---
title:  Bảo vệ và khóa XLSB tài liệu via Java
weight: 6590
description: Mã mẫu Java để khóa tệp XLSB bằng mật khẩu trên Java Môi trường thời gian chạy cho ứng dụng JSP/JSF và ứng dụng máy tính để bàn.
...
{{< blocks/products/pf/i18n/upper-banner h1="Mã hóa XLSB Tệp via Java" h2="Bảng tính Excel được bảo vệ bằng mật khẩu bao gồm định dạng XLSB sử dụng Thư viện .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước bảo vệ XLSB Tệp via Java" %}}
