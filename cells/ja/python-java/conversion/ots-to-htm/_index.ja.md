...
{{% blocks/products/pf/agp/content h2="Python を使用して OTS を HTM に変換する" %}}
...
次の例は、Python で OTS を HTM に変換する方法を示しています。
...
{{% cells-convert title="OTS を HTM に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="htm" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python 経由で OTS を HTM に変換する方法" %}}
