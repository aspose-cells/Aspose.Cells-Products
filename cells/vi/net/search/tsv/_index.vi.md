---
title:  Tìm kiếm tài liệu TSV không cần mở via .NET
weight: 2810
description: Mã nguồn C# để tìm kiếm các từ có mẫu trong tệp TSV trên .NET Framework, .NET Core, Mono hoặc Xamarin Platforms.
...
{{< blocks/products/pf/i18n/upper-banner h1="Tìm kiếm định dạng TSV trong C#" h2="Tìm kiếm tài liệu TSV gốc và hiệu suất cao bằng API Aspose.Cells for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tìm kiếm file TSV trong C#" %}}
...
+ Load file TSV sử dụng lớp Workbook.
...
{{% blocks/products/pf/agp/code-block title="Tìm kiếm TSV File - C#" offSpacer="" %}}
