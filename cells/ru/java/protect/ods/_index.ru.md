...
{{< blocks/products/pf/i18n/upper-banner h1="Шифровать файлы ODS через Java" h2="Защищайте паролем электронные таблицы Excel, включая формат ODS, с помощью библиотеки .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по защите файлов ODS с помощью Java" %}}
...
1. Загрузите файл ODS, создав экземпляр класса Workbook1. Используйте метод Protect(..) с ProtectionType и Password1. Сохраните защищенный файл ODS с помощью метода save().
