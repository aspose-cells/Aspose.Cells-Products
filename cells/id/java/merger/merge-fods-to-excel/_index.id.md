---
title: Gabungkan FODS ke EXCEL - Gabungkan FODS ke EXCEL di Java
url: /id/java/merger/merge-fods-to-excel/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan FODS ke format simpan EXCEL. Java Gabungkan FODS ke format EXCEL. Gabungkan FODS menjadi EXCEL di Java. FODS Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan FODS ke EXCEL di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan FODS ke EXCEL di Java" InputFormat="fods" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan FODS menjadi EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan FODS ke EXCEL secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
