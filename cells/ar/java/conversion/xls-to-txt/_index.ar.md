...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLS إلى TXT عبر Java" h2="XLS إلى TXT Java لتحويل صفحات مفردة أو متعددة إلى TXT باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLS إلى TXT باستخدام Java" %}}

 من أجل تقديم XLS إلى TXT ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLS إلى TXT عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف XLS إلى TXT في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف XLS مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد TXT و SaveFormat كمعلمات1. تحقق من المسار المحدد لملف TXT الناتج
...
{{% blocks/products/pf/agp/code-block title="XLS إلى TXT Java شفرة مصدر التحويل" offSpacer="" %}}
