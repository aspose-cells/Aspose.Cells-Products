---
title: Преобразователь C# FODS в XLTX - FODS в XLTX
description: Aspose Эксель. Преобразуйте FODS в XLTX быстро и легко с помощью Aspose.Cells. C# FODS в XLTX. C# Сохранить FODS в XLTX. Сохранить FODS как 07611134 81, используя C#.
...
{{% blocks/products/pf/agp/content h2="Сохраните с FODS по XLTX в C#." %}}
...
Нужно программно преобразовать файлы FODS в XLTX? Разработчики .NET могут легко загрузить и преобразовать FODS в XLTX всего за несколько строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования FODS в XLTX" %}}
