---
title: Converti XLT in XPS tramite l'applicazione C++ 
url: /it/cpp/conversion/xlt-to-xps/ 
description: Esempio di codice di conversione C++ per documento XLT in formato XPS. I programmatori possono utilizzare questo codice sorgente per la conversione batch da XLT a XPS all'interno di qualsiasi applicazione C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti XLT in XPS tramite C++" h2="Conversione da XLT a XPS ad alte prestazioni utilizzando la libreria C++ senza la necessità di installare Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente file XLT in XPS in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLT usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (XPS).1. Il file XPS verrà salvato nel percorso specificato.1. Apri il file XPS nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLT a XPS C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Dimostrazioni live di conversione da XLT a XPS" sectionDescription="[Converti XLT in XPS](https://products.aspose.app/cells/conversion/xlt-to-xps) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file XLT, verrà convertito istantaneamente in XPS." >}}
