...
description: Aspose Excel. Convierta XLTM a XLTX rápida y fácilmente con Aspose.Cells. Python XLTM a XLTX. Python Guarde XLTM en XLTX. Guarde XLTM como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLTM al XLTX en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLTM a XLTX en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLTM en XLTX" %}}
