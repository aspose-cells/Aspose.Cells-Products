---
title: Unisci CSV a JSON - Combina CSV a JSON in C#
url: /it/net/merger/merge-csv-to-json/ 
description: Aspose Excel. C# Aspose.Cells. Unione online gratuita da CSV a JSON saveformat. C# Combina il formato CSV con JSON. Unisci CSV a JSON in C#. CSV Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci CSV a JSON in C# online gratuitamente" %}}

L'esempio seguente mostra come unire CSV a JSON in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire CSV a JSON. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file JSON. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedere l'esempio C# che unisce CSV a JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire CSV a JSON in C#" InputFormat="csv" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire CSV a JSON tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire CSV a JSON a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca da unire CSV a JSON" %}}
