...
C++ разработчики могут легко преобразовать XML в OTS, написав всего несколько строк кода.
