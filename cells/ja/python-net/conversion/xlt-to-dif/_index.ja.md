---
title: Python XLT ～ DIF - XLT ～ DIF コンバータ
description: Aspose エクセル。 XLT を Aspose.Cells ですばやく簡単に DIF に変換します。 Python XLT から DIF に変換します。 Python XLT を DIF に保存します。 XLT を 07611134 として保存しますPythonを使用して81。
...
{{% cells-convert title="XLT を DIF に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="dif" IsLandingPage="true" language="pythonnet" %}}
