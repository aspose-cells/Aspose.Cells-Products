...
description: Aspose Excel. Konwertuj HTM na ETT szybko i łatwo za pomocą Aspose.Cells. Python HTM na ETT. Python Zapisz HTM w ETT. Zapisz HTM jako ETT, używając numeru Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj HTM na ETT w Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM w ETT pod numerem Python" %}}

Poniższy przykład pokazuje, jak przekonwertować HTM na ETT w Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji HTM na ETT" %}}
