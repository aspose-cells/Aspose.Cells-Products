...
{{% blocks/products/pf/agp/content h2="Convertir TABDELIMITED a BMP en Python" %}}
...
El siguiente ejemplo demuestra cómo convertir TABDELIMITED a BMP en Python via NET.
