...
description: Aspose エクセル。 Aspose.Cells を使用して、TABDELIMITED を SXC にすばやく簡単に変換します。 PHP TABDELIMITED を SXC に変換します。 PHP TABDELIMITED を SXC に保存します。 PHP を使用して、TABDELIMITED を SXC として保存します。
...
{{% blocks/products/pf/agp/content h2="PHP で TABDELIMITED を SXC に保存します" %}}

次の例は、PHP で TABDELIMITED を SXC に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

TABDELIMITED を SXC に変換するには、簡単な手順に従ってください。 TABDELIMITED ファイルをアップロードし、SXC ファイルとして保存するだけです。 TABDELIMITED の読み取りと SXC の書き込みの両方で、完全修飾ファイル名を使用できます。出力 SXC の内容と形式は、元の TABDELIMITED ドキュメントと同じになります。
...
{{% blocks/products/pf/agp/content h2="PHP 経由で TABDELIMITED を SXC に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

TABDELIMITED ファイルをプログラムで SXC に変換する必要がありますか? PHP 開発者は、わずか数行のコードで TABDELIMITED を簡単にロードして SXC に変換できます。
...
1.  TABDELIMITEDからSXCへの変換結果を取得します。
