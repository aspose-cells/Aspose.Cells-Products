...
url: /nl/python-java/merger/merge-prn-to-xlsx/ 
...
Het volgende voorbeeld laat zien hoe u PRN samenvoegt met XLSX in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u PRN programmatisch samenvoegen met XLSX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
