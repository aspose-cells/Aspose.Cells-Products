---
title: Convert SXC to TXT via .NET 
...
{{% blocks/products/pf/agp/content h2="Export Excel" %}}
 ...
 In order to convert SXC to TXT, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells makes it easy for the developers to load & convert SXC files to TXT in just a few lines of code.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert SXC to TXT" sectionDescription="Check our live demos for [SXC to TXT conversion](https://products.aspose.app/cells/conversion/sxc-to-txt) with following benefits." >}}
