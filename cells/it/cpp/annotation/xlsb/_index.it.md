---
title:  Aggiungi o rimuovi file Excel XLSB Annotazione tramite C++
weight: 860
description: Codice di esempio C++ per eliminare le annotazioni del formato XLSB sull'ambiente runtime C++ per Windows a 32 bit, Windows a 64 bit e Linux a 64 bit.
...
1.  Caricare il file Excel XLSB utilizzando l'oggetto classe IWorkbook.
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API può essere utilizzato per creare, modificare, convertire ed eseguire il rendering dei formati Excel Microsoft in diversi formati. Inoltre, può essere utilizzato per grafici completi, reporting scalabile e calcoli affidabili all'interno di applicazioni software. Aspose.Cells è un API autonomo e non richiede alcun software come Microsoft o OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Aggiungi/rimuovi annotazione da XLSB tramite l\'app online" sectionDescription=" Elimina subito le annotazioni del documento XLSB visitando il nostro[Sito web delle demo dal vivo](https://products.aspose.app/cells/annotation). La demo live presenta i seguenti vantaggi" >}}
