...
{{% blocks/products/pf/agp/content h2="كيفية إدراج/إنشاء مخطط انسيابي في ملف Excel باستخدام Python via .Net" %}}

 من أجل إدراج/إنشاء مخطط انسيابي في ملف Excel، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج/إنشاء مخطط انسيابي لملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) لإدراج مخطط انسيابي في ورقة العمل المحددة.
...
يوضح نموذج التعليمات البرمجية أدناه كيفية إدراج "Multidocument". لمزيد من الأنواع، يرجى الرجوع إلى "نظرة عامة على أنواع المخططات الانسيابية" أدناه.

{{% blocks/products/pf/agp/code-block title="إدراج/إنشاء مخطط انسيابي - Python via .Net" offSpacer="" %}}
...
<div class="container-fluid features-section bg-gray">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
 نظرة عامة على أنواع المخططات الانسيابية
   </h2>
   <div class="col-lg-4">
