---
title: Scal IMAGE do TABDELIMITED - Połącz IMAGE do TABDELIMITED w C#
url: /pl/net/merger/merge-image-to-tabdelimited/ 
description: Aspose Excel. C# Aspose.Cells. Scal OBRAZ do formatu zapisu TABDELIMITED. C# Połącz OBRAZ do formatu TABDELIMITED. Scal IMAGE do TABDELIMITED w C#. IMAGE Scal.
...
{{% blocks/products/pf/agp/content h2="Scal OBRAZ z TABDELIMITED w C#" %}}

Poniższy przykład ilustruje, jak połączyć IMAGE z TABDELIMITED w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić OBRAZ z TABDELIMITED. Prześlij swoje pliki, wywołaj metodę Workbook.Combine w celu łączenia plików, a następnie zapisz je w pliku TABDELIMITED. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy IMAGE z TABDELIMITED.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do scalania OBRAZU z TABDELIMITED w C#" InputFormat="png" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć IMAGE z TABDELIMITED poprzez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić IMAGE z TABDELIMITED? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do scalania IMAGE z TABDELIMITED" %}}
