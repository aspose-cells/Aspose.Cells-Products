...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการประกอบ XLSX ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. สร้างอินสแตนซ์ WorkbookDesigner class1. ตั้งเครื่องหมายในเซลล์ใด ๆ ของเวิร์กชีตใด ๆ1. ตั้งค่าแหล่งข้อมูลสำหรับวัตถุ WorkbookDesigner1. วิธีการเรียก WorkbookDesigner.Process เพื่อเติมเทมเพลตด้วย data1. บันทึกผลลัพธ์ในรูปแบบ XLSX ผ่าน WorkbookDesigner.Worbook.Save method
...
{{% blocks/products/pf/agp/code-block title="สร้างรายงาน XLSX" offSpacer="" %}}
