...
Hai bisogno di convertire i file MHT in XLAM tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire MHT in XLAM in poche righe di codice.
...
1.  Convertire MHT in XLAM chiamando il metodo Save().
