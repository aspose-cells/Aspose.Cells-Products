...
{{% blocks/products/pf/agp/content h2="Sla HTML op in MHTML in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar MHTML in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar MHTML of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar MHTML? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar MHTML met slechts een paar regels code.
