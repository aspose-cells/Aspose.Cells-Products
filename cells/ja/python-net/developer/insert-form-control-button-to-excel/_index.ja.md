---
title:  Python via .Net を使用して Excel にボタン (フォーム コントロール) を挿入します。
weight: 200
description: Python via Excel にボタン (フォーム コントロール) を挿入するための .Net ソース コード。
...
{{% blocks/products/pf/agp/content h2="Python via .Netを使用してExcelファイルにボタン(フォームコントロール)を挿入する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .Net を使用して Excel ファイルにボタン (フォーム コントロール) を挿入する手順" %}}
...
+ インデックスからワークシートを選択します。
 シェイプコレクションの追加を使用します[方法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_button/#int-int-int-int-int-int)選択したワークシートにボタン (フォーム コントロール) を挿入します。
...
{{% blocks/products/pf/agp/code-block title="挿入ボタン(フォームコントロール) - Python via .Net" offSpacer="" %}}
