---
title:  Tìm kiếm tài liệu XLS không cần mở via Java
weight: 9430
description: Mã mẫu Java để tìm kiếm các từ có mẫu trong tệp XLS trên Java Môi trường thời gian chạy cho ứng dụng JSP/JSF và ứng dụng máy tính để bàn.
...
{{< blocks/products/pf/i18n/upper-banner h1="Tìm kiếm định dạng XLS trong Java" h2="Tìm kiếm tài liệu XLS gốc và hiệu suất cao bằng API Aspose.Cells for Java phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tìm kiếm file XLS trong Java" %}}
...
+ Load file XLS bằng cách khởi tạo đối tượng Workbook.
+ Truy cập vào bảng tính đầu tiên trong file XLS.
...
{{% blocks/products/pf/agp/code-block title="Tìm kiếm XLS File - Java" offSpacer="" %}}
