---
title: PHP PRN से SXC - PRN से SXC कनवर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ PRN को जल्दी और आसानी से SXC में बदलें। PHP PRN को SXC पर बदलें। PHP PRN को SXC पर सहेजें। PHP का उपयोग करके PRN को SXC के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="PHP के माध्यम से PRN को SXC में कैसे परिवर्तित करें" %}}

{{% blocks/products/pf/agp/text %}}

क्या आपको PRN फ़ाइलों को प्रोग्रामेटिक रूप से SXC में कनवर्ट करने की आवश्यकता है? PHP डेवलपर्स कोड की कुछ पंक्तियों में आसानी से PRN को SXC में लोड और परिवर्तित कर सकते हैं।
...
1.  वर्कबुक की सेव विधि को कॉल करके पीआरएन को SXC में बदलें।
