---
title: Konversi XLTM ke DIF melalui C++ aplikasi 

description: Contoh C++ kode konversi untuk dokumen XLTM ke format DIF. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch XLTM ke DIF dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan XLTM ke DIF melalui C++" h2="Konversi XLTM ke DIF berperforma tinggi menggunakan pustaka C++ tanpa memerlukan instalasi Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file XLTM ke DIF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLTM menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file output dengan ekstensi file (DIF).1. File DIF akan disimpan di jalur yang ditentukan.1. Buka file DIF di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLTM ke DIF C++ Kode Sumber Konversi" offSpacer="" %}}
