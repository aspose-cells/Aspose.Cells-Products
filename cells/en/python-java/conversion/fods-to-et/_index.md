---
title: FODS to ET - Convert FODS to ET Python via Python
...
{{% blocks/products/pf/agp/content h2="Convert FODS to ET Using Python" %}}
...
The following example demonstrates how to convert FODS to ET in Python.
