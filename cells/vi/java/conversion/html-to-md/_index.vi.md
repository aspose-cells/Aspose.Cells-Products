---
title: Java HTML sang MD - HTML sang MD Bộ chuyển đổi
description: Aspose Excel. Chuyển đổi HTML sang MD nhanh chóng và dễ dàng với Aspose.Cells. Java HTML sang MD. Java Lưu HTML vào MD. Lưu HTML dưới dạng MD bằng Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi HTML sang MD trong Java" h2="Thư viện Java tốc độ cao để chuyển đổi HTML sang MD. Đây là giải pháp phần mềm chuyên nghiệp để nhập xuất HTML, MD và nhiều định dạng khác sử dụng Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu HTML vào MD trong Java" %}}
...
Cần chuyển đổi tập tin HTML sang MD theo chương trình? Các nhà phát triển Java có thể dễ dàng chuyển đổi HTML thành MD chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi HTML thành MD bằng cách gọi phương thức Workbook.save.
