---
title: Gabungkan JPEG ke MD - Gabungkan JPEG ke MD di C#
url: /id/net/merger/merge-jpeg-to-md/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan JPEG ke format simpan MD. C# Gabungkan JPEG ke format MD. Gabung JPEG menjadi MD di C#. JPEG Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan JPEG menjadi MD di C#" %}}

Contoh berikut menunjukkan cara menggabungkan JPEG ke MD di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan JPEG ke MD. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file MD. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan JPEG ke MD.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan JPEG ke MD secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
