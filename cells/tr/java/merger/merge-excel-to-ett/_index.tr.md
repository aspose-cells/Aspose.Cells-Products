...
description: Aspose Excel'de. Java Aspose.Cells. EXCEL'i ETT kaydetme biçimiyle birleştirin. Java EXCEL'i ETT formatıyla birleştirin. Java'de EXCEL'i ETT ile birleştir. EXCEL Birleştir.
...
{{% blocks/products/pf/agp/content h2="Java\'de EXCEL\'i ETT ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de EXCEL'in ETT ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="Java\'de EXCEL\'i ETT ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i ETT via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL'i ETT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
