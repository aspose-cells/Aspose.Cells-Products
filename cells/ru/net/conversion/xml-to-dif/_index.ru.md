...
{{% blocks/products/pf/agp/content h2="Преобразование XML в DIF с использованием C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в DIF в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат DIF в формате C#.
...
1.  Преобразовать XML в формат DIF, вызвав метод Workbook.Save.
