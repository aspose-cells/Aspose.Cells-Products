...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLT thành HTML thành Python" %}}
...
Ví dụ sau đây minh họa cách chuyển đổi XLT thành HTML trong Python via NET.
