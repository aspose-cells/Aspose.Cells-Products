...
url: /tr/net/merger/merge-json-to-et/ 
...
Aşağıdaki örnek, JSON'in Aspose.Cells for .NET'deki ET ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 JSON'i programlı olarak ET ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET kütüphanesi, JSON\'i ET ile birleştirecek" %}}
