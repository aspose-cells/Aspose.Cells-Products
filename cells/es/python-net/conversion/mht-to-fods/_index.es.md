...
description: Aspose Excel. Convierta MHT a FODS rápida y fácilmente con Aspose.Cells. Python MHT a FODS. Python Guarde MHT en FODS. Guarde MHT como FODS usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde MHT en FODS en Python" %}}

El siguiente ejemplo demuestra cómo convertir MHT a FODS en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir MHT a FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="fods" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir MHT a FODS" %}}
