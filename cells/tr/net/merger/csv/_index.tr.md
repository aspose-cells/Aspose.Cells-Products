...
+ Save() yöntemini çağırın ve dosya adını (tam yol) ve biçimini (CSV) parametre olarak iletin.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi CSV Birleşme Canlı Demoları" sectionDescription=" CSV belgemizi hemen ziyaret ederek birleştirin[Canlı Demolar web sitesi](https://products.aspose.app/cells/merger). Canlı demo aşağıdaki avantajlara sahiptir" >}}
