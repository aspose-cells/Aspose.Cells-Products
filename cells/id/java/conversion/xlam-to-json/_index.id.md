---
title: XLAM hingga JSON - Konversi file XLAM menjadi JSON Java
description: Aspose Unggul. Online Gratis Konversi format simpan XLAM ke JSON. Format Java XLAM hingga JSON. Simpan XLAM sebagai JSON di Java.
keywords: [Aspose Excel., Java Aspose.Cells., Java XLAM to JSON saveformat., Free Online XLAM to JSON Converter]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah XLAM menjadi JSON di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi XLAM menjadi JSON. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLAM, JSON, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLAM hingga JSON di Java Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi XLAM menjadi JSON di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLAM menjadi JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLAM ke JSON secara terprogram? Pengembang Java dapat dengan mudah mengonversi XLAM menjadi JSON hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengubah XLAM menjadi JSON" %}}
{{% blocks/products/pf/agp/text %}}
