...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa la collezione di forme[aggiungere metodo](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addCheckBox(int,%20int,%20int,%20int,%20int,%20int)) per inserire un CheckBox(Controllo modulo) nel foglio di lavoro selezionato.
