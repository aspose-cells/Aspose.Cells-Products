---
title: Sloučit PRN s XLS – Sloučit PRN s XLS v C#
url: /cs/net/merger/merge-prn-to-xls/ 
description: Aspose Excel. C# Aspose.Cells. Zdarma online sloučit PRN do formátu uložení XLS. C# Zkombinujte PRN do formátu XLS. Sloučit PRN na XLS v C#. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN na XLS v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit PRN s XLS v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN do XLS. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XLS. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí PRN do XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení PRN na XLS v C#" InputFormat="prn" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN na XLS přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit PRN s XLS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení PRN s XLS" %}}
