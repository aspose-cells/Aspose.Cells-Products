...
description: Aspose Excel. Java Aspose.Cells. Συγχώνευση XLSB σε μορφή αποθήκευσης SXC. Java Συνδυάστε τη μορφή XLSB με SXC. Συγχώνευση XLSB σε SXC στο Java. XLSB Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση XLSB με SXC στο Java" %}}
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση XLSB έως SXC στο Java" InputFormat="xlsb" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
