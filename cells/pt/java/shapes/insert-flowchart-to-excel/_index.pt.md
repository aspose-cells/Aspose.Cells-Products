...
weight: 360
description: Insira/Crie um FlowChart usando Aspose.Cells' Java API sem nenhum software como Microsoft ou Open Office, Adobe PDF, etc.
---
...
{{% blocks/products/pf/agp/content h2="Como inserir/criar um FlowChart no arquivo Excel usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para inserir/criar um FlowChart para o arquivo Excel via Java" %}}
...
+ Selecione a planilha por meio de seu índice.
 + Use o[adicionar método](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) inserir/criar um FlowChart na planilha selecionada
