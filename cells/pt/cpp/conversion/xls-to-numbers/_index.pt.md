...
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLS para NÚMEROS em C++" h2="Conversão de alto desempenho de XLS para NÚMEROS usando a biblioteca C++ sem a necessidade de instalação do Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Precisa converter arquivos XLS para NÚMEROS programaticamente? Desenvolvedores que trabalham com C++ podem facilmente converter XLS para NÚMEROS com apenas algumas linhas de código.
...
1.  Converta XLS para NÚMEROS chamando o método Save().
