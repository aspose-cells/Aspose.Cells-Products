...
{{% blocks/products/pf/agp/content h2="Konversikan XLTX ke PDF menggunakan Java" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTX ke PDF di Java" %}}

Contoh berikut menunjukkan cara mengkonversi XLTX menjadi PDF di Java.
...
Perlu mengkonversi file XLTX ke PDF secara terprogram? Pengembang Java dapat dengan mudah mengkonversi XLTX ke PDF hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi XLTX menjadi PDF" %}}
{{% blocks/products/pf/agp/text %}}
