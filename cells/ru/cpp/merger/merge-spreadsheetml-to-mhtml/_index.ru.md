---
title:  Объединить SPREADSHETML в MHTML через C++
...
В следующем примере показано, как объединить SPREADSHEETML с MHTML в C++.
