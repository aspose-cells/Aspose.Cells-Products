---
title: Conversor de PHP XLTX para MHT - XLTX para MHT
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores PHP uma abordagem totalmente integrada para converter XLTX para o formato MHT, permitindo o salvamento perfeito de dados XLTX no formato MHT usando a biblioteca Aspose.Cells, tudo por meio de código PHP eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX para MHT via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX para MHT programaticamente? Desenvolvedores PHP podem facilmente carregar e converter arquivos XLTX para MHT com apenas algumas linhas de código.
...
1.  Converta XLTX para MHT chamando o método save da Workbook.
1.  Obtenha o resultado da conversão de XLTX para MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter XLTX em MHT" %}}
