...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in XLS in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar XLS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar XLS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar XLS? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar XLS met slechts een paar regels code.
