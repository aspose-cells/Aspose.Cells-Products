---
title: Merge PNG to PNG - Combine PNG to PNG via C#
url: /net/merger/merge-png-to-png/ 
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. PNG Merge. Free Online Merge PNG to PNG C#. C# Merge PNG to PNG format. Combine PNG to PNG in C#.
keywords: [Aspose Excel., C# Aspose.Cells., C# Aspose Cells., PNG Merge., C# Merge PNG to PNG., Free Online Merge PNG to png in C#., C# Combine PNG to PNG format Online for Free]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge PNG to PNG via C#" h2="High-speed C# library for merging PNG to PNG. Use our excel conversion API to develop high-level, platform independent software in C#. This is a professional software solution to import and export Excel, CSV, OpenOffice, PDF, HTML, image, and many other excel formats." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="PNG" additionalConversionTag="PNG" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Merge PNG to PNG in C# Online for Free" %}}

The following example demonstrates how to merge PNG to PNG in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to merge PNG to PNG. Upload your files, call Workbook.Combine method for merging files, and then save it to PNG file. If you develop code in C#, this will be simpler than it sounds. See C# example that merges PNG to PNG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Free Online to Merge PNG to PNG in C#" InputFormat="png" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="How to Merge PNG to PNG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to merge PNG to PNG programmatically? A basic document merging and concatenating with [Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs can be done with just few lines of code.
...
{{% blocks/products/pf/agp/content h2=".NET library to merge PNG to PNG" %}}
