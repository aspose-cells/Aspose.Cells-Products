...
url: /hu/python-java/merger/merge-xltx-to-xml/ 
...
A következő példa bemutatja, hogyan egyesítheti a XLTX-et XML-be a Aspose.Cells for Python via Java-ben.
...
Programozottan egyesítenie kell a XLTX-et XML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Az API-k néhány sornyi kóddal elkészíthetők.
