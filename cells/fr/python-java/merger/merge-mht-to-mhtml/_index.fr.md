---
title:  Fusionner MHT avec MHTML via Python
url: /fr/python-java/merger/merge-mht-to-mhtml/ 
description: Fusionnez MHT avec MHTML en ligne gratuitement. MHT en ligne gratuit à MHTML Fusion. Fusionnez MHT avec Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner MHT avec MHTML dans Python.
...
{{% cells-merger title="Application gratuite pour fusionner MHT avec MHTML en ligne" InputFormat="mht" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
