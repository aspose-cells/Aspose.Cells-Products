---
title:  Protéger et verrouiller le document XLSB via le C++
weight: 4860
description: Exemple de code C++ pour verrouiller le fichier XLSB à l'aide d'un mot de passe sur l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
