---
title: Voeg PNG samen met NUMBERS - Combineer PNG met NUMBERS in C#
url: /nl/net/merger/merge-png-to-numbers/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online Samenvoegen PNG naar NUMBERS opslagformaat. C# Combineer PNG tot NUMBERS formaat. Voeg PNG samen tot NUMMERS in C#. PNG Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg PNG samen met NUMBERS in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe u PNG kunt samenvoegen tot NUMBERS in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om PNG samen te voegen met NUMBERS. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het NUMBERS-bestand. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# dat PNG samenvoegt tot NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om PNG samen te voegen tot NUMMERS in C#" InputFormat="png" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe PNG samen te voegen tot NUMMERS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u PNG programmatisch samenvoegen met NUMBERS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om PNG samen te voegen tot NUMBERS" %}}
