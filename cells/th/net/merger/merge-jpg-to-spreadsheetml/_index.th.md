---
title: รวม JPG เข้ากับ SPREADSHEETML - รวม JPG เข้ากับ SPREADSHEETML ใน C#
url: /th/net/merger/merge-jpg-to-spreadsheetml/ 
description: Aspose เอ็กเซล. C# Aspose.Cells รวม JPG เข้ากับรูปแบบการบันทึก SPREADSHEETML C# รวมรูปแบบ JPG เข้ากับ SPREADSHEETML รวม JPG เป็น SPREADSHEETML ใน C# JPG ผสาน
...
{{% blocks/products/pf/agp/content h2="รวม JPG เข้ากับ SPREADSHEETML ใน C#" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน JPG เข้ากับ SPREADSHEETML ใน Aspose.Cells for .NET
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อรวม JPG เข้ากับ SPREADSHEETML อัปโหลดไฟล์ของคุณ เรียกใช้เมธอด Workbook.Combine สำหรับการรวมไฟล์ จากนั้นบันทึกลงในไฟล์ SPREADSHEETML หากคุณพัฒนาโค้ดใน C# สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง C# ที่ผสาน JPG เข้ากับ SPREADSHEETML

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="โค้ดตัวอย่างเพื่อรวม JPG เป็น SPREADSHEETML ใน C#" InputFormat="jpg" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="วิธีรวม JPG เป็น SPREADSHEETML ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม JPG เข้ากับ SPREADSHEETML โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2=".NET ไลบรารี่เพื่อรวม JPG เข้ากับ SPREADSHEETML" %}}
