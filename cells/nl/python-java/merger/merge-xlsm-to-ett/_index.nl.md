...
Het volgende voorbeeld laat zien hoe u XLSM samenvoegt met ETT in Aspose.Cells for Python via Java.
...
Wilt u XLSM programmatisch samenvoegen met ETT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
