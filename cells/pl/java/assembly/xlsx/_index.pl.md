---
title:  Generuj raporty w plikach XLSX via Java
weight: 7710
description: Java przykładowy kod do tworzenia raportów w formacie XLSX w środowisku wykonawczym Java dla aplikacji JSP/JSF i aplikacji komputerowych.
...
{{< blocks/products/pf/i18n/upper-banner h1="Zbiorcze generowanie raportu w formacie XLSX via Java" h2="Generuj raporty w formacie XLSX, korzystając ze źródła danych i szablonu." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wygenerować raporty XLSX przy użyciu Java" %}}

 Aby utworzyć raporty w pliku XLSX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wygenerować raporty XLSX via Java" %}}
...
1.  Zapisz wynik w formacie XLSX za pomocą metody Worbook.save
...
{{% blocks/products/pf/agp/code-block title="Generuj raporty Excel w formacie XLSX - Java" offSpacer="" %}}
