...
Hai bisogno di convertire i file MHT in NUMBERS a livello di programmazione? C++ gli sviluppatori possono facilmente convertire MHT in NUMBERS in poche righe di codice.
...
1.  Converti MHT in NUMBERS chiamando il metodo Save().
