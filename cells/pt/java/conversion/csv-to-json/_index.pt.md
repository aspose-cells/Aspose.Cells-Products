---
title: Converter CSV para JSON via Java 
weight: 9040
url: /pt/java/conversion/csv-to-json/ 
description: Exemplo de código de conversão Java para formato CSV em arquivo JSON. Os programadores podem usar este código de exemplo para exportar planilhas do Excel e OpenOffice para JSON em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter CSV para JSON via Java" h2="Conversão de CSV para JSON Java para converter uma ou várias páginas em JSON usando a biblioteca local Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter CSV para JSON usando Java" %}}

 Para renderizar CSV para JSON, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter CSV em JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java os desenvolvedores podem converter facilmente arquivos CSV em JSON em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo CSV com uma instância da classe Workbook1. Crie um intervalo de dados a ser exportado usando o método Cells.createRange1. Chame o método JsonUtility.exportRangeToJson com referências de Range & ExportRangeToJsonOptions1. Gravar dados JSON de string no arquivo por meio do método BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de CSV para JSON Java" offSpacer="" %}}
