---
title: Java HTML tot XLSB - HTML tot XLSB Converter
...
{{% blocks/products/pf/agp/content h2="Sla HTML op in XLSB in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar XLSB in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar XLSB of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar XLSB? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar XLSB met slechts een paar regels code.
