...
ต้องการแปลงไฟล์ NUMBERS เป็น EXCEL ด้วยโปรแกรมใช่ไหม? นักพัฒนา C++ สามารถแปลง NUMBERS เป็น EXCEL ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลงตัวเลขเป็นค่าในไฟล์ Excel โดยเรียกใช้เมธอด Save()
