...
{{% blocks/products/pf/agp/content h2="Python を使用して JSON を XLAM に変換します" %}}
...
次の例は、JSON を Python の XLAM に変換する方法を示しています。
...
{{% blocks/products/pf/agp/content h2="Python経由でJSONをXLAMに変換する方法" %}}
