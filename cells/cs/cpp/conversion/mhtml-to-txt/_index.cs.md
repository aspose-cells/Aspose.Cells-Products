---
title: C++ MHTML až TXT - MHTML až TXT Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C++ plně integrovaný přístup k převodu formátu MHTML do formátu TXT, což umožňuje bezproblémové ukládání dat MHTML do formátu TXT pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte MHTML na TXT v C++" h2="Vysoce výkonná konverze z MHTML na TXT s využitím knihovny C++ bez nutnosti instalace Excelu, OpenOffice nebo Adobe Acrobatu Microsoft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte MHTML na TXT v C++" %}}

Následující příklad ukazuje, jak převést číslo MHTML na TXT v kódu C++.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na TXT přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory MHTML na TXT? Vývojáři C++ mohou snadno převést MHTML na TXT pomocí několika řádků kódu.
...
1.  Převeďte číslo MHTML na TXT voláním metody Save().
1.  Získejte výsledek převodu MHTML na TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C++ pro převod MHTML na TXT" %}}
