---
title: JPG mit PDF zusammenführen - JPG mit PDF in Python kombinieren
url: /de/python-net/merger/merge-jpg-to-pdf/ 
description: Aspose Excel. Python Excel. JPG mit PDF Saveformat zusammenführen. Python JPG mit PDF Format kombinieren. JPG mit PDF in Python Excel-Bibliothek zusammenführen. JPG zusammenführen.
...
{{% blocks/products/pf/agp/content h2="JPG mit PDF zusammenführen, indem die Excel-Bibliothek Python verwendet wird" %}}

Wie füge ich JPG mit PDF zusammen? Mit der Bibliothek Aspose.Cells for Python via .NET können Sie JPG mit wenigen Codezeilen problemlos programmgesteuert mit PDF zusammenführen.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python) ist in der Lage, plattformübergreifende Anwendungen zu erstellen, mit denen alle Excel-Dateien generiert, geändert, konvertiert, dargestellt und gedruckt werden können. Python Excel API konvertiert nicht nur zwischen Tabellenkalkulationsformaten, sondern kann Excel-Dateien auch als Bilder darstellen, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT und mehr, was es zur perfekten Wahl für den Austausch von Dokumenten in Industriestandardformaten macht. Sie können Aspose.Cells for Python via .NET installieren von<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , verwenden Sie den Befehl wie folgt:<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="JPG mit PDF in der Excel-Bibliothek Python zusammenführen" %}}

Das folgende Beispiel zeigt, wie JPG mit PDF in Aspose.Cells for Python via .NET zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um JPG mit PDF zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Methode Workbook.Combine zum Zusammenführen von Dateien auf und speichern Sie sie dann in der Datei PDF. Wenn Sie Code in Python entwickeln, ist dies einfacher, als es klingt. Sehen Sie sich das Beispiel Python an, das JPG mit PDF zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Beispielcode zum Zusammenführen von JPG mit PDF in der Excel-Bibliothek Python" InputFormat="jpg" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="So fügen Sie JPG mit PDF über die Excel-Bibliothek Python zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie JPG programmgesteuert mit PDF zusammenführen? Ein grundlegendes Dokument, das zusammengeführt und verknüpft wird mit[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="Python-Bibliothek zum Zusammenführen von JPG mit PDF" %}}
