---
title: TXT'i MD'ye birleştir - TXT'i Java'de MD'ye birleştir
url: /tr/java/merger/merge-txt-to-md/ 
description: Aspose excel. Java Aspose.Cells. TXT'i MD saveformat'a Ücretsiz Çevrimiçi Birleştirme. Java TXT'i MD formatına birleştirin. TXT'i Java'de MD ile birleştir. TXT Birleştir.
...
{{% blocks/products/pf/agp/content h2="TXT\'i MD ile Java Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, TXT'in Aspose.Cells for Java'de MD ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TXT'i MD ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından MD dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. TXT'i MD ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TXT\'i Java\'de MD ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="txt" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TXT ile MD via Java Nasıl Birleştirilir" %}}

{{% blocks/products/pf/agp/text %}}

 TXT'i programlı olarak MD ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="TXT\'i MD ile birleştirmek için Java kitaplığı" %}}
