...
{{% blocks/products/pf/agp/content h2="Zapisz OTS do POWERPOINT w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować OTS na POWERPOINT w formacie Java.
...
Trzeba programowo przekonwertować pliki OTS do formatu POWERPOINT? Programiści Java mogą łatwo przekonwertować pliki OTS do formatu POWERPOINT za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji OTS na POWERPOINT" %}}
{{% blocks/products/pf/agp/text %}}
