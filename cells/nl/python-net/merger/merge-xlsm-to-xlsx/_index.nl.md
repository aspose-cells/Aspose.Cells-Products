...
Het volgende voorbeeld laat zien hoe u XLSM samenvoegt met XLSX in Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u XLSM programmatisch samenvoegen met XLSX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen met slechts enkele regels code worden uitgevoerd.
