---
title: Konvertieren Sie JSON in SVG über C#
url: /de/net/conversion/json-to-svg/
description: Beispielcode für die Umwandlung von json in svg C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von JSON-Dateien in SVG in VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können JSON-Dateien in nur wenigen Codezeilen einfach laden und in SVG konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die JSON-Datei mit einer Instanz von Workbook1. Rufen Sie die Workbook.Save-Methode auf1. Übergeben Sie den Ausgabepfad mit der SVG-Erweiterung als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende SVG-Datei
...
{{% cells-convert title="Kostenlose App und Beispielcode zum Konvertieren von JSON in SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="json" outformat="svg" IsLandingPage="true" %}}
