---
title: Convierta SPREADSHEETML a XLAM a través de Python

description: Código de muestra para la conversión de hoja de cálculo a xlam Python. Use el código de ejemplo API para archivos de hoja de cálculo por lotes para la conversión xlam dentro de la aplicación Python.
---
...
{{% blocks/products/pf/agp/content h2="Cómo convertir SPREADSHEETML a XLAM usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir SPREADSHEETML a XLAM a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Python pueden cargar y convertir fácilmente archivos SPREADSHEETML a XLAM con solo unas pocas líneas de código.
