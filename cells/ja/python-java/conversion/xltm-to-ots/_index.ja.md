...
description: Aspose Excel。Python Excel。Aspose.Cells を使用して、XLTM を OTS にすばやく簡単に変換します。Python XLTM を OTS に変換します。Python XLTM を OTS に保存します。Python Excel ライブラリを使用して、XLTM を OTS として保存します。
