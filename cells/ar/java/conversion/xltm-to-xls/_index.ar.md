---
title: Java XLTM الى XLS - XLTM الى XLS محول
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين Java نهجًا متكاملًا تمامًا لتحويل XLTM إلى تنسيق XLS، مما يتيح حفظ البيانات بسلاسة في تنسيق XLS باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود Java فعال وقابل للتخصيص.
...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل العدد XLTM إلى XLS في العدد Java" h2="مكتبة Java عالية السرعة لتحويل XLTM إلى XLS. هذا حل برمجي احترافي لاستيراد وتصدير XLTM وXLS والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ الأرقام من XLTM إلى XLS في Java" %}}
...
{{% cells-convert title="نموذج كود لتحويل XLTM إلى XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xltm" outformat="xls" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل الرقم XLTM إلى XLS أو via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات بصيغة XLTM إلى XLS برمجيًا؟ يمكن لمطوري Java تحويل ملفات XLTM إلى XLS بسهولة في بضعة أسطر من التعليمات البرمجية.
