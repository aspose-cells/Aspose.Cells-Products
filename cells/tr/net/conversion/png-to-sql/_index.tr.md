---
title: C# PNG'den SQL'e - Çevrimiçi PNG'den SQL'e Dönüştürücü
description: Aspose excel. C# Aspose.Cells. C# Aspose Cells. Ücretsiz Çevrimiçi C# PNG'i SQL saveformat'a dönüştürün. C# PNG SQL formatına. PNG'i SQL C#'e kaydedin.
...
{{% blocks/products/pf/agp/content h2="PNG\'i C# Online\'da SQL\'e Ücretsiz Olarak Kaydet" %}}

Aşağıdaki örnek, PNG'in C#'de SQL'e nasıl dönüştürüleceğini gösterir.
{{% blocks/products/pf/agp/text %}}

PNG'i SQL'e dönüştürmek için kolay adımları izleyin. PNG dosyanızı yükleyin, ardından SQL dosyası olarak kaydedin. Hem PNG okuma hem de SQL yazma için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı SQL içeriği ve biçimlendirmesi orijinal PNG belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="PNG\'i Çevrimiçi SQL\'e Dönüştürmek İçin Ücretsiz Uygulama ve Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="sql" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PNG\'i C# üzerinden SQL\'e Dönüştürme" %}}
...
1.  PNG'in SQL'e dönüştürme sonucunu alın.
