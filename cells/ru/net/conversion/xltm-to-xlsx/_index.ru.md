---
title: Преобразователь C# XLTM в XLSX - XLTM в XLSX
...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в XLSX в C#" %}}
...
Нужно программно преобразовать файлы XLTM в XLSX? Разработчики .NET могут легко загрузить и преобразовать XLTM в XLSX всего за несколько строк кода.
...
1.  Преобразуйте значение XLTM в XLSX, вызвав метод Workbook.Save.
