---
title: C++ OTS en PRN - Convertisseur OTS en PRN
description: Aspose Excel. Cette solution complète offre aux développeurs C++ une approche entièrement intégrée pour convertir le format OTS au format PRN, permettant un enregistrement transparent des données OTS au format PRN à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C++ efficace et personnalisable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir OTS en PRN dans C++" h2="Conversion OTS vers PRN haute performance utilisant la bibliothèque C++ sans avoir besoin de l\'installation d\'Excel, d\'OpenOffice ou d\'Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PRN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer OTS à PRN dans C++" %}}

L'exemple suivant montre comment convertir OTS en PRN dans C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir OTS en PRN. Téléchargez votre fichier OTS, puis enregistrez-le simplement en tant que fichier PRN. Pour la lecture OTS et l'écriture PRN, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage du PRN de sortie seront identiques au document OTS d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir OTS en PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ots" outformat="prn" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir OTS en PRN via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers OTS en PRN par programmation ? Les développeurs C++ peuvent facilement convertir des fichiers OTS en PRN en quelques lignes de code seulement.
...
1.  Convertissez OTS en PRN en appelant la méthode Save().
1.  Obtenez le résultat de la conversion de OTS en PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour convertir OTS en PRN" %}}
