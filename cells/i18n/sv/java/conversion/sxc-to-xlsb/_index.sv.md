---
title: Konvertera SXC till XLSB via Java 
url: /sv/java/conversion/sxc-to-xlsb/ 
description: Exempel Java-konverteringskod för SXC-format till XLSB-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till XLSB inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera SXC till XLSB via Java" h2="SXC till XLSB Java-konvertering för att konvertera enstaka eller flera sidor till XLSB med hjälp av lokalt Java-bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du SXC till XLSB med Java" %}}

 För att rendera SXC till XLSB kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera SXC till XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera SXC-fil till XLSB på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda SXC-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med XLSB-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande XLSB-filen
...
{{% blocks/products/pf/agp/code-block title="SXC till XLSB Java omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC till XLSB Conversion Live Demos" sectionDescription="[Konvertera SXC till XLSB](https://products.aspose.app/cells/conversion/sxc-to-xlsb) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din SXC-fil, den konverteras omedelbart till XLSB." >}}
