...
{{% blocks/products/pf/agp/content h2="Chuyển đổi HTML thành XLS thành Python" %}}
...
Ví dụ sau đây minh họa cách chuyển đổi HTML thành XLS trong Python via NET.
