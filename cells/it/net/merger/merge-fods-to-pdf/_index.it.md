---
title: Unisci FODS a PDF - Combina FODS a PDF in C#
url: /it/net/merger/merge-fods-to-pdf/ 
description: Aspose Excel. C# Aspose.Cells. Unione online gratuita da FODS a PDF saveformat. C# Combina il formato FODS con PDF. Unisci FODS a PDF in C#. FODS Unisci.
...
L'esempio seguente mostra come unire FODS a PDF in Aspose.Cells for .NET.
...
{{% cells-merger title="Online gratuito per unire FODS a PDF in C#" InputFormat="fods" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire FODS a PDF tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire FODS a PDF a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
