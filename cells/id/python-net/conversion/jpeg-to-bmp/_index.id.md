...
description: Aspose Unggul. Ubah JPEG menjadi BMP dengan cepat dan mudah dengan Aspose.Cells. Python JPEG menjadi BMP. Python Simpan JPEG menjadi BMP. Simpan JPEG sebagai 07611134 81 menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Ubah JPEG menjadi BMP di Python" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan JPEG hingga BMP di Python" %}}

Contoh berikut menunjukkan cara mengonversi JPEG menjadi BMP di Python via NET.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengubah JPEG menjadi BMP" %}}
