...
url: /tr/python-net/merger/merge-xltm-to-mht/ 
...
Aşağıdaki örnek, XLTM'in Aspose.Cells for Python via .NET'deki MHT ile nasıl birleştirileceğini gösterir.
...
XLTM'i MHT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
