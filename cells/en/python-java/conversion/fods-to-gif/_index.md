...
Follow the easy steps to convert FODS into GIF. Upload your FODS file, then simply save it as GIF file. For both FODS reading and GIF writing you can use fully qualified filenames. The output GIF content and formatting will be identical to the original FODS document.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Python developers can easily load & convert FODS to GIF in just a few lines of code.
