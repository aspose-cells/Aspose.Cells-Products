...
description: Aspose Excel。此综合解决方案为 C# 开发人员提供了一种完全集成的方法，可将 FODS 转换为 SXC 格式，从而能够使用 Aspose.Cells 库将 FODS 数据无缝保存为 SXC 格式，所有这些都通过高效且可定制的 C# 代码实现。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 FODS 转换为 SXC，其中 C#" h2="高速 C# 库，用于将 FODS 转换为 SXC。这是一个专业的软件解决方案，可在 .NET 框架、.NET 核心或 Mono 平台上导入和导出 FODS、SXC 和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="将 FODS 保存到 SXC，即 C#" %}}

以下示例演示了如何在 C# 中将 FODS 转换为 SXC。
...
{{% cells-convert title="将 FODS 转换为 SXC 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="sxc" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何将 FODS 通过 C# 转换为 SXC" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 FODS 文件转换为 SXC 吗？.NET 开发人员只需几行代码即可轻松加载并将 FODS 转换为 SXC。
...
{{% blocks/products/pf/agp/content h2="使用 C# 库将 FODS 转换为 SXC" %}}
