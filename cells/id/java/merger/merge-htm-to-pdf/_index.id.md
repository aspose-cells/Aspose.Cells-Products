...
description: Aspose Unggul. Java Aspose.Cells. Gabungkan HTM ke format simpan PDF. Java Gabungkan format HTM ke PDF. Gabungkan HTM ke PDF di Java. Gabungkan HTM.
...
{{% blocks/products/pf/agp/content h2="Gabungkan HTM ke PDF di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan HTM ke PDF di Java" InputFormat="htm" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan HTM ke PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan HTM ke PDF secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka Java untuk menggabungkan HTM menjadi PDF" %}}
