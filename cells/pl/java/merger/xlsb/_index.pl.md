---
title:  Połącz pliki XLSB via Java
weight: 4840
description: Java przykładowy kod do łączenia dokumentów XLSB w środowisku wykonawczym Java dla aplikacji JSP/JSF i aplikacji komputerowych.
---
...
{{% blocks/products/pf/agp/content h2="Jak połączyć pliki XLSB przy użyciu Java" %}}

 Aby połączyć plik XLSB, użyjemy[Aspose.Cells for Java](https://products.aspose.com/cells/java) API, która jest bogatą w funkcje, wydajną i łatwą w użyciu platformą fuzji API for Java. Możesz pobrać jego najnowszą wersję bezpośrednio ze strony[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) i zainstaluj go w projekcie opartym na Maven, dodając następujące konfiguracje do pliku pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki łączenia plików XLSB w Java" %}}
...
+ zapisz połączony plik XLSB w określonej ścieżce
