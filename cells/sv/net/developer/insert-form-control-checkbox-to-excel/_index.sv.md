...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga CheckBox till Excel-fil via C#" %}}
...
+ Välj kalkylblad via dess index.
 + Använd[lägga till metod](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcheckbox) för att infoga en kryssruta i det valda arbetsbladet
...
{{% blocks/products/pf/agp/code-block title="Infoga checkbox - C#" offSpacer="" %}}
