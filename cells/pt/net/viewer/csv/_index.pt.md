---
title:  Ver formatos de arquivo CSV via .NET
weight: 7690
description: Código-fonte C# para carregar, renderizar e exibir documentos CSV em plataformas .NET Framework, .NET Core, Mono ou Xamarin.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells torna mais fácil para os desenvolvedores visualizarem o arquivo CSV com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código de exemplo C# para visualizar o arquivo CSV" offSpacer="" %}}
 ...
 Aspose.Cells API pode ser usado para criar, editar, converter e renderizar formatos Excel Microsoft em diferentes formatos. Além disso, pode ser usado para gráficos abrangentes, relatórios escalonáveis e cálculos confiáveis em aplicativos de software. Aspose.Cells é um API independente e não requer nenhum software como Microsoft ou OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para visualizar CSV" sectionDescription=" Confira nossas demonstrações ao vivo para[Ver CSV](https://products.aspose.app/cells/viewer/csv) com os seguintes benefícios." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta fazer upload do arquivo CSV e clicar no botão \"Visualizar\"" >}}
