---
title: Edytuj lub wyświetl metadane plików XLSX za pomocą Java 
weight: 1240

description: Java przykładowy kod do edycji lub przeglądania metadanych formatu XLSX w Java środowisku wykonawczym dla aplikacji JSP/JSF i aplikacji komputerowych.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wyodrębnij metadane XLSX przez Java" h2="Twórz własne Java aplikacje, aby dodawać, edytować, usuwać lub wyodrębniać metadane z plików XLSX przy użyciu interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak wyodrębnić metadane XLSX za pomocą Java" %}}

 Aby uzyskać metadane pliku XLSX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki wyodrębniania metadanych XLSX za pomocą Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Wyodrębnij metadane XLSX — Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/java/metadata/xls/" name="XLS" description="Format binarny programu Excel" >}}
