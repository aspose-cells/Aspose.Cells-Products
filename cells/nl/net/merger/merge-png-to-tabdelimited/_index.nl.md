---
title: Voeg PNG samen tot TABDELIMITED - Combineer PNG tot TABDELLIMITED in C#
url: /nl/net/merger/merge-png-to-tabdelimited/ 
description: Aspose Excel. C# Aspose.Cells. Voeg PNG samen naar TABDELIMITED-opslagformaat. C# Combineer PNG tot TABDELLIMITED-formaat. Voeg PNG samen tot TABDELIMITED in C#. PNG Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg PNG samen tot TABDELIMITED in C#" %}}

Het volgende voorbeeld laat zien hoe u PNG samenvoegt met TABDELLIMITED in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om PNG samen te voegen tot TABDELLIMITED. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in het TABDELLIMITED-bestand. Als u code ontwikkelt in C#, zal dit eenvoudiger zijn dan het klinkt. Zie het voorbeeld C# waarin PNG wordt samengevoegd tot TABDELLIMITED.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om PNG samen te voegen met TABDELLIMITED in C#" InputFormat="png" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe u PNG samenvoegt met TABDELLIMITED via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u PNG programmatisch samenvoegen met TABDELLIMITED? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om PNG samen te voegen tot TABDELLIMITED" %}}
