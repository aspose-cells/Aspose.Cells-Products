...
{{% blocks/products/pf/agp/content h2="Konwertuj HTM na PDF używając Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM do PDF w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować HTM na PDF w Java.
...
Trzeba programowo przekonwertować pliki HTM do formatu PDF? Programiści Java mogą łatwo przekonwertować pliki HTM do formatu PDF za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji HTM na PDF" %}}
{{% blocks/products/pf/agp/text %}}
