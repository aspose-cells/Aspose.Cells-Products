...
url: /tr/python-java/merger/merge-png-to-xlsb/ 
...
Aşağıdaki örnek, PNG'in Aspose.Cells for Python via Java'de XLSB ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 PNG ile XLSB'i programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
