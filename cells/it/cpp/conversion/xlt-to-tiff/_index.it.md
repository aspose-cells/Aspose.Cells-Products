---
title: Converti XLT in TIFF tramite l'applicazione C++ 
url: /it/cpp/conversion/xlt-to-tiff/ 
description: Esempio di codice di conversione C++ per documento XLT in formato TIFF. I programmatori possono utilizzare questo codice sorgente per la conversione batch da XLT a TIFF all'interno di qualsiasi applicazione C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ gli sviluppatori possono convertire facilmente file XLT in TIFF in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file XLT usando Factory::CreateIWorkbook.1. Seleziona il primo foglio di lavoro.1. Imposta le opzioni (TIFF).1. Scorri ogni pagina del foglio e renderizza.1. Apri il file TIFF nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da XLT a TIFF C++" offSpacer="" %}}
