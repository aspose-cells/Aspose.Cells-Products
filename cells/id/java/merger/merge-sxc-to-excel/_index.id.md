---
title: Gabungkan SXC ke EXCEL - Gabungkan SXC ke EXCEL di Java
url: /id/java/merger/merge-sxc-to-excel/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan SXC ke format simpan EXCEL. Java Gabungkan SXC ke format EXCEL. Gabungkan SXC menjadi EXCEL di Java. SXC Gabungkan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Gabungkan SXC menjadi EXCEL via Java" h2="Pustaka Java berkecepatan tinggi untuk menggabungkan SXC ke EXCEL. Gunakan konversi excel kami API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di Java. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor Excel, CSV, OpenOffice, PDF, HTML, image, dan banyak format excel lainnya." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="SXC" additionalConversionTag="EXCEL" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Gabungkan SXC ke EXCEL di Java" %}}

Contoh berikut menunjukkan cara menggabungkan SXC ke EXCEL di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan SXC ke EXCEL. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file EXCEL. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan SXC ke EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan SXC ke EXCEL di Java" InputFormat="sxc" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan SXC menjadi EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan SXC ke EXCEL secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk menggabungkan SXC ke EXCEL" %}}
