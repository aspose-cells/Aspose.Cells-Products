---
title:  Konvertera diagram till EMF bilder via .NET
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera diagram till EMF-filer i C#" %}}
...
+ Skapa XLSX-fil.
Skaffa diagrammet.
+ Konvertera diagram till EMF bild.
...
{{% blocks/products/pf/agp/code-block title="Konvertera XLSX fildiagram till EMF bild - C#" offSpacer="" %}}
