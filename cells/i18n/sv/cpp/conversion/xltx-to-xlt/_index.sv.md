...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera XLTX-fil till XLT på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLTX-fil med Factory::CreateIWorkbook.1. Anropa metoden Save().1. Skicka utdatafilens sökväg med (XLT) filtillägg.1. XLT-filen kommer att sparas på den angivna sökvägen.1. Öppna XLT-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="XLTX till XLT C++ omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLTX till XLT Conversion Live Demos" sectionDescription="[Konvertera XLTX till XLT](https://products.aspose.app/cells/conversion/xltx-to-xlt) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din XLTX-fil, den kommer omedelbart att konverteras till XLT." >}}
