---
title: C++ HTM σε MD - Μετατροπέας HTM σε MD
description: Aspose Excel. Μετατρέψτε το HTM σε MD γρήγορα και εύκολα με το Aspose.Cells. C++ HTM σε MD. C++ Αποθήκευση HTM στο MD. Αποθηκεύστε το HTM ως MD χρησιμοποιώντας το C++.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το HTM στο MD στο C++" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή HTM σε MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="md" IsLandingPage="true" language="cpp" %}}
