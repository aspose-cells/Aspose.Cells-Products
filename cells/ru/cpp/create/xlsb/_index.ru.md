...
description: Aspose Эксель. C++ Создайте файл XLSB быстро и легко с помощью Aspose.Cells. Создайте файл XLSB с помощью C++. Создайте XLSB в C++. C++ XLSB Creater.
...
1.  Сохраните книгу как файл .xlsb, используя метод Save().
