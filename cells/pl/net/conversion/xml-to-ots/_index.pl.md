...
{{% blocks/products/pf/agp/content h2="Zapisz XML do OTS pod numerem C# Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować XML na OTS w C#.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XML na OTS przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo załadować i przekonwertować XML na OTS w zaledwie kilku wierszach kodu.
...
{{% blocks/products/pf/agp/content h2="C# biblioteka do konwersji XML na OTS" %}}
