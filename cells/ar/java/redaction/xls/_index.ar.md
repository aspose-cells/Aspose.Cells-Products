---
title:  بحث واستبدال النص في XLS مستند via Java
weight: 7900
description: نموذج التعليمات البرمجية Java لتنقيح المعلومات الحساسة في ملف XLS على Java بيئة التشغيل لتطبيقات JSP/JSF وتطبيقات سطح المكتب.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تنقيح XLS الملفات في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="تنقيح XLS ملفات - Java" offSpacer="" %}}
