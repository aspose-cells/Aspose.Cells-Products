---
title: Chuyển đổi XLT sang XLSM qua Java 
url: /vi/java/conversion/xlt-to-xlsm/ 
description: Mã chuyển đổi Java mẫu cho định dạng XLT thành tệp XLSM. Lập trình viên có thể sử dụng mã mẫu này để xuất bảng tính Excel & OpenOffice sang XLSM trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLT sang XLSM qua Java" h2="Chuyển đổi XLT sang XLSM Java để chuyển đổi một hoặc nhiều trang sang XLSM bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLT sang XLSM bằng cách sử dụng Java" %}}

 Để hiển thị XLT thành XLSM, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi XLT sang XLSM qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp XLT sang XLSM chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp XLT với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Truyền đường dẫn đầu ra với phần mở rộng XLSM & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp XLSM kết quả
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi XLT sang XLSM Java" offSpacer="" %}}

```cs
// tải tệp XLT trong một phiên bản của Workbook
Workbook book = new Workbook("template.xlt");
// lưu XLT dưới dạng XLSM
