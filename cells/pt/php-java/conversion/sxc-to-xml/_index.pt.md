---
title: PHP SXC para XML - SXC para conversor XML
description: Aspose Excel. Converta SXC para XML de forma rápida e fácil com Aspose.Cells. PHP SXC para XML. PHP Salve SXC em XML. Salve SXC como XML usando PHP.
...
Precisa converter arquivos SXC em XML programaticamente? Os desenvolvedores de PHP podem facilmente carregar e converter SXC em XML em apenas algumas linhas de código.
...
1.  Converta SXC em XML chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de SXC para XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter SXC para XML" %}}
