---
title: محول PHP OTS إلى XPS - محول OTS إلى XPS
description: Aspose Excel. يوفر هذا الحل الشامل لمطوري PHP نهجًا متكاملًا تمامًا لتحويل OTS إلى تنسيق XPS، مما يتيح حفظ بيانات OTS بسلاسة بتنسيق XPS باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود PHP فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل رمز OTS إلى XPS باستخدام PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات OTS إلى XPS برمجيًا؟ يمكن لمطوري PHP تحميل ملفات OTS وتحويلها إلى XPS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل OTS إلى XPS عن طريق استدعاء طريقة الحفظ الخاصة بـ Workbook.
1.  احصل على نتيجة تحويل OTS إلى XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة PHP لتحويل OTS إلى XPS" %}}
