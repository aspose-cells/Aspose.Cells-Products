...
โหลดไฟล์ XLTX ทั้งหมดที่มีเส้นทางแบบเต็ม
+ สร้างเอกสารหนึ่งฉบับเป็นไฟล์ฐาน
+ เรียกวิธีการที่เกี่ยวข้องสำหรับการต่อและรวมไฟล์ทีละไฟล์
+ เรียกเมธอด Save() และส่งชื่อไฟล์ (เส้นทางแบบเต็ม) และรูปแบบ (XLTX) เป็นพารามิเตอร์
