---
title:  Połącz pliki XLTM via Java
weight: 8210
...
{{% blocks/products/pf/agp/content h2="Jak połączyć pliki XLTM przy użyciu Java" %}}

 Aby połączyć plik XLTM, użyjemy[Aspose.Cells for Java](https://products.aspose.com/cells/java) API, która jest bogatą w funkcje, wydajną i łatwą w użyciu platformą fuzji API for Java. Możesz pobrać jego najnowszą wersję bezpośrednio ze strony[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) i zainstaluj go w projekcie opartym na Maven, dodając następujące konfiguracje do pliku pom.xml.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Online XLTM Pokazy fuzji na żywo" sectionDescription=" Połącz dokumenty XLTM już teraz, odwiedzając naszą stronę[Witryna internetowa z prezentacjami na żywo](https://products.aspose.app/cells/merger). Demo na żywo ma następujące zalety" >}}
