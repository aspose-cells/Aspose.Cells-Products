---
title: PHP TABDELIMITED na OTS - TABDELIMITED na OTS Converter
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům PHP plně integrovaný přístup k převodu dat TABDELIMITED do formátu OTS, což umožňuje bezproblémové ukládání dat TABDELIMITED do formátu OTS pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na OTS pomocí PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory TABDELIMITED do OTS? Vývojáři PHP mohou snadno načíst a převést soubory TABDELIMITED do OTS pomocí několika řádků kódu.
...
1. Převeďte TABDELIMITED na OTS voláním metody save v sešitu.
1.  Získejte výsledek převodu TABDELIMITED na OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP knihovna pro převod TABDELIMITED na OTS" %}}
