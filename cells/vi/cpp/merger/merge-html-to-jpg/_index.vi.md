...
Ví dụ sau minh họa cách hợp nhất HTML thành JPG trong Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/content h2="Thư viện C++ để hợp nhất HTML thành JPG" %}}
