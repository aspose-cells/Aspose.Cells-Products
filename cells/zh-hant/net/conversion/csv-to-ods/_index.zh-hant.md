...
{{% blocks/products/pf/agp/content h2="免費在線保存CSV至ODS至C#" %}}

以下示例演示如何將 C# 中的 CSV 轉換為 ODS。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 CSV 轉換為 ODS。上傳您的 CSV 文件，然後將其另存為 ODS 文件。對於 CSV 讀取和 ODS 寫入，您可以使用完全限定的文件名。輸出 ODS 內容和格式將與原始 CSV 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="在線將 CSV 轉換為 ODS 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過C#將CSV轉換為ODS" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 開發人員只需幾行代碼即可輕鬆加載和轉換 CSV 為 ODS。
...
{{% blocks/products/pf/agp/content h2="C# 庫將 CSV 轉換為 ODS" %}}
