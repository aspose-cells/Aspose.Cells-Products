...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ geliştiricileri, yalnızca birkaç kod satırıyla XLTM dosyasını XLS'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook kullanarak XLTM dosyasını yükleyin.1. Save() yöntemini çağırın.1. Çıktı dosyası yolunu (XLS) dosya uzantısıyla iletin.1. XLS dosyası belirtilen yola kaydedilecektir.1. XLS dosyasını uyumlu programda açın.
...
{{% blocks/products/pf/agp/code-block title="XLTM - XLS C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
