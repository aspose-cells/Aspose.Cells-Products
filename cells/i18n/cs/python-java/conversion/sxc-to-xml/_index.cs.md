...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na XML pomocí Python" %}}

 K převodu SXC na XML použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na XML prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory SXC do formátu XML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí Workbook1. Zavolejte metodu Workbook.Save1. Předejte výstupní cestu s příponou XML jako parametr1. Zkontrolujte zadanou cestu pro výsledný soubor XML
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod SXC do XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xml" IsLandingPage="true" language="python" %}}
