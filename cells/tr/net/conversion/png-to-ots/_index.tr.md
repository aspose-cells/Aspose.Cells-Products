---
title: C# PNG'den OTS'ye - Çevrimiçi PNG'den OTS'ye Dönüştürücü
description: Aspose excel. C# Aspose.Cells. C# Aspose Cells. Ücretsiz Çevrimiçi C# PNG'i OTS saveformat'a dönüştürün. C# PNG'den OTS formatına. PNG'i OTS C#'e kaydedin.
...
{{% blocks/products/pf/agp/content h2="PNG\'i C# Online\'da OTS\'ye Ücretsiz Olarak Kaydet" %}}

Aşağıdaki örnek, PNG'in C#'de OTS'ye nasıl dönüştürüleceğini gösterir.
...
PNG dosyalarını programlı olarak OTS'ye dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PNG'i kolayca yükleyebilir ve OTS'ye dönüştürebilir.
