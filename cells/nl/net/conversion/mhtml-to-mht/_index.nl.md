---
title: C# MHTML naar MHT - MHTML naar MHT-converter
description: Aspose Excel. Converteer MHTML snel en eenvoudig naar MHT met Aspose.Cells. C# MHTML naar MHT. C# Bewaar MHTML in MHT. Sla MHTML op als MHT met behulp van C#.
...
In het volgende voorbeeld ziet u hoe u MHTML naar MHT converteert in C#.
...
{{% blocks/products/pf/agp/content h2="Hoe u MHTML naar MHT converteert via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML-bestanden programmatisch naar MHT converteren? .NET-ontwikkelaars kunnen MHTML eenvoudig in slechts een paar regels code laden en converteren naar MHT.
