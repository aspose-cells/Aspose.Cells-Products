...
Aşağıdaki örnek, XLTM'in Aspose.Cells for .NET'de ETT ile nasıl birleştirileceğini gösterir.
...
XLTM'i programlı olarak ETT ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="XLTM\'i ETT ile birleştirmek için .NET kitaplığı" %}}
