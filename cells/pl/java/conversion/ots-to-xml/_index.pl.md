...
description: Aspose Excel. Konwertuj OTS na XML szybko i łatwo za pomocą Aspose.Cells. Java OTS na XML. Java Zapisz OTS w formacie XML. Zapisz OTS jako XML, używając numeru Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz OTS w formacie XML pod numerem Java" %}}

Poniższy przykład ilustruje, jak przekonwertować OTS na XML w Java.
...
Chcesz programowo przekonwertować pliki OTS na XML? Programiści Java mogą z łatwością przekonwertować OTS na XML w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji OTS na XML" %}}
{{% blocks/products/pf/agp/text %}}
