---
title:  แทรกป้ายกำกับ (ตัวควบคุมฟอร์ม) ลงใน Excel โดยใช้ Python via .Net
weight: 80
description: Python via ซอร์สโค้ด .Net เพื่อแทรก Label (Form control) ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกป้ายกำกับ (ตัวควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}

 ในการแทรก Label(Form control) ลงในไฟล์ excel เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการใส่ Label (Form control) ลงในไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_label/#int-int-int-int-int-int) เพื่อแทรกป้ายกำกับ (ตัวควบคุมฟอร์ม) ในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกป้ายกำกับ(การควบคุมแบบฟอร์ม) - Python via .Net" offSpacer="" %}}
