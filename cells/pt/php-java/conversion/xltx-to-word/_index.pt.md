---
title: Conversor PHP XLTX para WORD - XLTX para WORD
description: Aspose Excel. Converta XLTX em WORD de forma rápida e fácil com Aspose.Cells. PHP XLTX em WORD. PHP Salve XLTX em WORD. Salve XLTX como WORD usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX em WORD via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em WORD programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em WORD em apenas algumas linhas de código.
...
1.  Converta XLTX em WORD chamando o método save da pasta de trabalho.
