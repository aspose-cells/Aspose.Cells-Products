...
+ Save() yöntemini çağırın ve dosya adını (tam yol) ve biçimini (XLTM) parametre olarak iletin.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi XLTM Birleşme Canlı Demoları" sectionDescription=" XLTM belgemizi hemen ziyaret ederek birleştirin[Canlı Demolar web sitesi](https://products.aspose.app/cells/merger). Canlı demo aşağıdaki avantajlara sahiptir" >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API\'i indirmenize gerek yok." >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="XLTM dosyalarınızı yüklemeniz yeterli." >}}
