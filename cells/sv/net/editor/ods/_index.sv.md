...
description: C# källkod för att redigera ODS dokument på .NET Framework, .NET Core, Windows Azure, Mono eller Xamarin Platforms.
---
 ...
 Aspose.Cells API kan användas för att skapa, redigera, konvertera och rendera Microsoft Excel-format till olika format. Dessutom kan den användas för omfattande kartläggning, skalbar rapportering och tillförlitliga beräkningar inom mjukvaruapplikationer. Aspose.Cells är en fristående API och den kräver ingen programvara som Microsoft eller OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online ODS Editor Live Demos" sectionDescription=" Redigera ODS dokument just nu genom att besöka vår[Live Demos webbplats](https://products.aspose.app/cells/editor). Livedemon har följande fördelar" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Ladda bara upp dina ODS-filer, Använd onlineredigerare för att redigera omedelbart." >}}
