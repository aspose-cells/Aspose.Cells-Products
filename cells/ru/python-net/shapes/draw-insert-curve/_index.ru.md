---
title: Как нарисовать или вставить изогнутую форму в Excel, используя Python via .Net
weight: 10
description: Python via Исходный код .Net для вставки изогнутой формы в Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Вставьте изогнутую форму в Excel, используя Python via .Net" h2="Вставьте изогнутую форму, используя Aspose.Cells\' API без какого-либо программного обеспечения, такого как Microsoft или Open Office, Adobe PDF и т. д." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Как вставить изогнутую форму в файл Excel, используя Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по вставке изогнутой формы в файл Excel с использованием Python via .Net" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте добавление коллекции форм[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) , чтобы вставить изогнутую форму в выбранный рабочий лист.
...
-  Любая операционная система, которая может запускать сценарии Python via .Net, например Windows и Linux
...
{{% blocks/products/pf/agp/code-block title="Вставка изогнутой формы - Python via .Net" offSpacer="" %}}
