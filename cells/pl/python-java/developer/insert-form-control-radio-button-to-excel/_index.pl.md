---
title:  Wstaw RadioButton (kontrolka formularza) do Excela, używając Python via java
weight: 60
description: Python via kod źródłowy Java umożliwiający wstawienie przycisku RadioButton (kontrolka formularza) do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić RadioButton (kontrolka formularza) do pliku Excel przy użyciu Python via java" %}}

 Aby wstawić RadioButton (kontrolka formularza) do pliku Excel, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić RadioButton (kontrolka formularza) do pliku Excel przy użyciu Java Python via" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRadioButton(int,%20int,%20int,%20int,%20int,%20int)), aby wstawić przycisk RadioButton (kontrolka formularza) w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw RadioButton (kontrolka formularza) - Python via java" offSpacer="" %}}
