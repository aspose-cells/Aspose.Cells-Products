...
url: /nl/net/merger/merge-png-to-xml/ 
...
Het volgende voorbeeld laat zien hoe u PNG samenvoegt met XML in Aspose.Cells for .NET.
...
Wilt u PNG programmatisch samenvoegen met XML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2=".NET-bibliotheek om PNG samen te voegen met XML" %}}
