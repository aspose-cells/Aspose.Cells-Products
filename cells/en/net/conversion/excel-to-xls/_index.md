---
title: C# EXCEL to XLS - EXCEL to XLS Converter
description: Aspose Excel. C# Aspose.Cells. EXCEL to XLS in C#. C# Convert EXCEL to XLS saveformat. C# EXCEL to XLS format. Save EXCEL to XLS C#.
keywords: [Aspose Excel., C# Aspose.Cells., EXCEL to XLS in C#., C# EXCEL to XLS saveformat., EXCEL to XLS C#., C# Convert EXCEL to XLS]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert EXCEL to XLS in C#" h2="High-speed C# library for converting EXCEL to XLS. This is a professional software solution to import and export EXCEL, XLS, and many other formats on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EXCEL" >}}
...
{{% blocks/products/pf/agp/content h2="Save EXCEL to XLS in C#" %}}

The following example demonstrates how to convert EXCEL to XLS in C#.
...
{{% cells-convert title="Sample Code to Convert EXCEL to XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xls" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert EXCEL to XLS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert EXCEL files to XLS programmatically? .NET developers can easily load & convert EXCEL to XLS in just a few lines of code.
