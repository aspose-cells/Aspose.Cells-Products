...
Aşağıdaki örnekte OTS'nin Aspose.Cells for C++'deki HTML ile nasıl birleştirileceği gösterilmektedir.
...
{{% cells-merger title="C++\'de OTS\'yi HTML ile Birleştirmek için Örnek Kod" InputFormat="ots" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="OTS\'yi C++ aracılığıyla HTML ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 OTS'yi programlı olarak HTML ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
