---
title:  Combinar XLS a TXT via Java
...
El siguiente ejemplo muestra cómo combinar XLS con TXT en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar XLS a TXT en línea" InputFormat="xls" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
