...
description: Aspose Эксель. Python Aspose.Cells. Объедините HTML и ODS в формате сохранения. Python Объедините форматы HTML и ODS. Объедините HTML и ODS в Python. HTML Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините HTML с ODS, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините HTML и ODS в Python." %}}

В следующем примере показано, как объединить HTML и ODS в Aspose.Cells for Python via Java.
