...
{{% blocks/products/pf/agp/content h2="Převést XML na PPTX pomocí knihovny Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Uložte XML na PPTX v knihovně Excel Python" %}}

Následující příklad ukazuje, jak převést XML na PPTX v knihovně Excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Knihovna Excel pro převod XML na PPTX" %}}
