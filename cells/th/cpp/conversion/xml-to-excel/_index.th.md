...
description: Aspose เอ็กเซล. แปลง XML เป็น EXCEL อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XML เป็น EXCEL C++ บันทึก XML ลงใน EXCEL บันทึก XML เป็น EXCEL โดยใช้ C++
...
1.  แปลง XML เป็น EXCEL โดยการเรียกเมธอด Save()
