---
title:  Upravit nebo zobrazit ODS Metadata souborů via Java
weight: 2080
description: Java ukázkový kód k úpravě nebo zobrazení ODS metadata formátu na Java Runtime Environment pro JSP/JSF aplikace a desktopové aplikace.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Výpis ODS Metadata via Java" h2="Sestavte si své vlastní aplikace Java pro přidávání, úpravy, odstraňování nebo extrahování metadat ze souborů ODS pomocí rozhraní API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k extrahování metadat ODS via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Extrahujte metadata ODS - Java" offSpacer="" %}}
