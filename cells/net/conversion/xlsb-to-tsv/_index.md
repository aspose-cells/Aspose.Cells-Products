---
title: Convert XLSB to TSV via C#
url: /net/conversion/xlsb-to-tsv/
description: Sample code for xlsb to tsv C# conversion. Use API example code for batch xlsb files to tsv conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert XLSB files to TSV in just a few lines of code.
...
{{% cells-convert title="Free App and Sample Code to Convert XLSB to TSV" formats=pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx InputFormat=xlsb outformat=tsv IsLandingPage=true %}}
