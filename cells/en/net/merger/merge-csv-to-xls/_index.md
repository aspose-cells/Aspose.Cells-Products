...
description: Merge CSV to XLS in .NET. Merge CSV to XLS via .NET online for free. Combine CSV to XLS using VB.NET, Asp.NET or any .NET based application.
---
...
The following example demonstrates how to merge CSV to XLS in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to merge CSV to XLS. Upload your files, call Workbook.Combine method for merging files, and then save it to XLS file. If you develop code in C#, this will be simpler than it sounds. See {{platform} example that merges CSV to XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Free App to merge CSV to XLS on line" InputFormat="csv" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
