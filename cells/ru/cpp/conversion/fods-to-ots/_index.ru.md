...
Нужно программно преобразовать файлы FODS в OTS? Разработчики C++ могут легко преобразовать FODS в OTS всего за несколько строк кода.
