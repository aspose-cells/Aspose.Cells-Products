...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج ملف Arc to Excel عبر الرقم C#" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addArc) لإدراج قوس في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="أدخل القوس - C#" offSpacer="" %}}
