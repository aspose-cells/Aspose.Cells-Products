---
title: Konvertera XLSM till ODS via Python
url: /sv/python-java/conversion/xlsm-to-ods/
description: Exempelkod för konvertering av xlsm till ods Python. Använd API exempelkod för batch-xlsm-filer till ods-konvertering i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLSM till ODS med Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLSM till ODS via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera XLSM-filer till ODS på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLSM-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med ODS-tillägg som parameter1. Kontrollera den angivna sökvägen för den resulterande ODS-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera XLSM till ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="ods" IsLandingPage="true" language="python" %}}
