...
weight: 9280
description: C++ 예제 코드는 XLSX 파일에서 특정 패턴을 사용하여 단어를 검색하는 코드이며, C++ 런타임 환경(Windows 32비트, Windows 64비트 및 Linux 64비트)에서 사용 가능합니다.
...
{{< blocks/products/pf/i18n/upper-banner h1="C++에서 XLSX 형식을 검색하세요" h2="어떤 소프트웨어(예: Microsoft 또는 Adobe PDF)도 사용하지 않고 서버 측 API를 이용한 네이티브 고성능 문서 검색(XLSX)이 가능합니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="C++을 사용하여 XLSX 파일을 검색하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++에서 XLSX 파일을 검색하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="XLSX 파일 검색 - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="온라인 XLSX 라이브 데모 검색" sectionDescription=" 지금 바로 저희 웹사이트를 방문하여 XLSX 문서 내의 텍스트, 단어, 구문을 검색하세요.[라이브 데모 웹사이트](https://products.aspose.app/cells/search). 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
 ...
 XLSX은 Microsoft Excel 문서에 사용되는 잘 알려진 형식으로, Microsoft 버전에서 Office 2007과 함께 도입되었습니다. ECMA-376 OOXML 표준 2부에 명시된 개방형 패키징 규칙에 따라 구성된 구조를 기반으로 하는 이 새로운 형식은 여러 XML 파일이 포함된 zip 패키지입니다. .xlsx 파일의 압축을 풀면 기본 구조와 파일을 확인할 수 있습니다.
