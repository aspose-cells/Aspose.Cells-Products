---
title: Java XLTX ～ XLSB - XLTX ～ XLSB コンバータ
description: Aspose エクセル。 XLTX を Aspose.Cells ですばやく簡単に XLSB に変換します。 Java XLTX から XLSB に変換します。 Java XLTX を XLSB に保存します。 XLTX を 07611134 として保存しますJavaを使用して81。
...
{{% blocks/products/pf/agp/content h2="Java を使用して XLTX を XLSB に変換します" %}}
...
次の例は、XLTX を Java の XLSB に変換する方法を示しています。
...
{{% cells-convert title="XLTX を XLSB に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="xlsb" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="XLTX を XLSB via Java に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLTX ファイルをプログラムで XLSB に変換する必要がありますか? Java 開発者は、わずか数行のコードで XLTX を XLSB に簡単に変換できます。
