...
description: Aspose Excel. Konwertuj EXCEL na PRN szybko i łatwo za pomocą Aspose.Cells. Java EXCEL na PRN. Java Zapisz EXCEL w PRN. Zapisz EXCEL jako PRN, używając numeru Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz EXCEL w PRN pod numerem Java" %}}

Poniższy przykład ilustruje konwersję programu EXCEL na PRN w formacie Java.
...
{{% cells-convert title="Przykładowy kod do konwersji EXCEL na PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="prn" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować EXCEL na PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki EXCEL na PRN? Programiści Java mogą łatwo przekonwertować EXCEL na PRN w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji EXCEL-a na PRN" %}}
{{% blocks/products/pf/agp/text %}}
