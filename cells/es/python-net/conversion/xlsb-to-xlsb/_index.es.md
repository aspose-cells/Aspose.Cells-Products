...
description: Aspose Excel. Convierta XLSB a XLSB rápida y fácilmente con Aspose.Cells. Python XLSB a XLSB. Python Guarde XLSB en XLSB. Guarde XLSB como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLSB al XLSB en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSB a XLSB en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSB en XLSB" %}}
