...
{{% blocks/products/pf/agp/feature-section-col title="StepsВ to Redact XLSM Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="RedactВ XLSM Files - Java" offSpacer="" %}}
