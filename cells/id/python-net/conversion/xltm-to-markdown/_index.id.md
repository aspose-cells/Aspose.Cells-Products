...
{{% blocks/products/pf/agp/content h2="Ubah XLTM menjadi MARKDOWN di Python" %}}
...
Contoh berikut menunjukkan cara mengonversi XLTM menjadi MARKDOWN di Python via NET.
