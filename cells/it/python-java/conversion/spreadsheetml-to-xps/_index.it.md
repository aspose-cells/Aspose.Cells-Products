...
{{% blocks/products/pf/agp/content h2="Converti SPREADSHEETML in XPS utilizzando la libreria Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Salva FOGLIO DI CALCOLOML in XPS nella libreria Excel Python" %}}

L'esempio seguente dimostra come convertire SPREADSHEETML in XPS nella libreria Excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Libreria Excel per convertire SPREADSHEETML in XPS" %}}
