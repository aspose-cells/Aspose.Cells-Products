...
{{% blocks/products/pf/agp/content h2="Sla HTML op in BMP in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar BMP in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar BMP of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar BMP? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar BMP met slechts een paar regels code.
