---
title: C# EXCEL'den PDF'e - EXCEL'den PDF'e dönüştürücü
description: Aspose Excel. Bu kapsamlı çözüm, C# geliştiricilere EXCEL'i PDF formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, Aspose.Cells kütüphanesini kullanarak EXCEL verilerinin PDF formatına sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C# kod aracılığıyla gerçekleştirilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL dosyasını PDF adresine C# olarak kaydedin." %}}

Aşağıdaki örnek, EXCEL dosyasını C# formatında PDF formatına nasıl dönüştüreceğinizi göstermektedir.
{{% blocks/products/pf/agp/text %}}

EXCEL'i PDF'e dönüştürmek için kolay adımları izleyin. EXCEL dosyanızı yükleyin ve ardından PDF dosyası olarak kaydedin. Hem EXCEL okuma hem de PDF yazma için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı PDF içeriği ve formatı orijinal EXCEL belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Excel dosyasını PDF\'e dönüştürmek için örnek kod." formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="pdf" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i C# aracılığıyla PDF\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL dosyalarını programlı olarak PDF'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyip PDF'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını PDF formatına dönüştürün.
1.  EXCEL'in PDF'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i PDF\'e dönüştürmek için C# kütüphanesi" %}}
