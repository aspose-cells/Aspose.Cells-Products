---
title: Gabungkan SXC menjadi XPS - Gabungkan SXC menjadi XPS menjadi Java
url: /id/java/merger/merge-sxc-to-xps/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan SXC menjadi XPS format simpan. Java Gabungkan format SXC menjadi XPS. Gabungkan SXC menjadi XPS di Java. SXC Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan SXC menjadi XPS di Java" %}}

Contoh berikut menunjukkan cara menggabungkan SXC menjadi XPS di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan SXC ke XPS. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file XPS. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan SXC menjadi XPS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan SXC menjadi XPS di Java" InputFormat="sxc" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan SXC menjadi XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan SXC ke XPS secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk digabungkan SXC menjadi XPS" %}}
