...
url: /hu/net/merger/merge-spreadsheetml-to-image/ 
...
A következő példa bemutatja, hogyan lehet egyesíteni a SPREADSHEETML fájlt az IMAGE fájllal a Aspose.Cells for .NET számon.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a SPREADSHEETML-t az IMAGE-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a SPREADSHEETML és az IMAGE egyesítéséhez" %}}
