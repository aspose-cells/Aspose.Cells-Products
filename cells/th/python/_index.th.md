...
{{< blocks/products/pf/i18n/upper-banner h1="Python สเปรดชีต Excel การแยกวิเคราะห์ APIs" h2="สร้าง อ่าน เขียน หรือจัดการสเปรดชีต รวมทั้งส่งออกไฟล์ Excel เป็นหลายรูปแบบภายในแอปพลิเคชัน Python" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/headers/aspose_cells-for-python-java.svg" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="https://downloads.aspose.com/cells/python" >}}
...
{{< blocks/products/pf/carousel-item h3="ความเป็นอิสระของแพลตฟอร์ม" description="Aspose.Cells สำหรับ Python มีให้สำหรับ" >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
<p>Python sheets API provides a powerful Formula Calculation Engine that supports almost all of the standard and advanced Microsoft Excel formulas and functions. Formula calculation engine makes it easy to read, set and calculate the results of the built-in or add-in type, array and R1C1 reference style formulas.</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Cells สำหรับ Python ให้การควบคุมเต็มรูปแบบในการตั้งค่าหน้า ทำให้สามารถจัดการตัวเลือกการแสดงผลได้หลายแบบ เช่น ตัวแบ่งหน้าตัวอย่าง กำหนดระดับการซูม ตั้งค่าการวางแนวของหน้า ควบคุมการมองเห็นข้อมูลด้วยช่องแช่แข็ง ขนาดกระดาษ มาตราส่วน ส่วนหัว &amp; ส่วนท้ายและพื้นที่พิมพ์
    </p>
   </div>
   <!--<div class="col-lg-12">
...
<p>Aspose.Cells for Android via Java API allows you to manipulate rows and columns in many different ways. You can easily adjust row height and column width, auto size the width & height of cells according to the contents, insert or delete, hide or show and group or ungroup rows & columns.</p>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Cells สำหรับ Python API ให้การสนับสนุนอย่างกว้างขวางสำหรับการจัดการข้อมูลเวิร์กชีต สามารถจัดการเซลล์ใดๆ ในเวิร์กชีตได้อย่างง่ายดายในขณะใช้งานจริง หรือนำเข้าข้อมูลไปยังเวิร์กชีตจากแหล่งข้อมูลต่างๆ
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Cells สำหรับ Python ให้การสนับสนุนอย่างเต็มที่สำหรับการสร้างแผนภูมิ คุณสามารถเพิ่มแผนภูมิมาตรฐานและแบบกำหนดเองหรือตั้งค่าข้อมูลแผนภูมิแบบไดนามิกเพื่อรีเฟรชแผนภูมิโดยใช้ไลบรารีหลามนี้
    </p>
   </div>
   <!--
...
{{< blocks/products/pf/slr-element name="Aspose.Cells API ข้อมูลอ้างอิง" href="https://apireference.aspose.com/python/cells" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="ทำไมต้อง Aspose.Cells สำหรับ Python" tabId="success-stories" >}}
