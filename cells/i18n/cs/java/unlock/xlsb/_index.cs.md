---
title: Odemknout dokument XLSB přes Java 
weight: 5860
url: /cs/java/unlock/xlsb/ 
description: Java ukázkový kód k odemknutí heslem chráněného souboru XLSB v Java Runtime Environment pro JSP/JSF aplikace a desktopové aplikace.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Odemknout soubory XLSB přes Java" h2="Odstraňte ochranu z tabulek aplikace Excel včetně souboru XLSB pomocí knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Jak odebrat soubor XLSB ochrany pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k odemknutí XLSB přes Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Odemknout soubory XLSB přes C#" offSpacer="" %}}
