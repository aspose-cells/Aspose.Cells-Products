---
title: C# ODS a XLSX - ODS a XLSX Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter ODS para o formato XLSX, permitindo o salvamento perfeito de dados ODS no formato XLSX usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve ODS a XLSX em C#" %}}

exemplo a seguir demonstra como converter ODS em XLSX em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter ODS em XLSX por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS em XLSX programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em XLSX em apenas algumas linhas de código.
...
1.  Converta ODS para XLSX chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para XLSX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter ODS em XLSX" %}}
