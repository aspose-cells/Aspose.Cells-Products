...
weight: 10
description: Python via Java codice sorgente per inserire controllo ActiveX in Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci il controllo ActiveX in Excel utilizzando Python via java" h2="Inserisci oggetti utilizzando API lato server senza alcun software come Microsoft o Open Office, Adobe PDF, ecc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come inserire il controllo ActiveX nel file Excel utilizzando Python via Java" %}}
 ...
 Per inserire il controllo ActiveX nel file Excel, utilizzeremo
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa le collezioni di forme[aggiungi metodo](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addActiveXControl(int,%20int,%20int,%20int,%20int,%20int,%20int)) per inserire un controllo ActiveX nel foglio di lavoro selezionato.
