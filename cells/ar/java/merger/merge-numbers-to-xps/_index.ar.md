---
title:  دمج الأرقام في XPS via Java
...
يوضح المثال التالي كيفية دمج الأرقام مع XPS في Java.
...
{{% cells-merger title="تطبيق مجاني لدمج الأرقام في XPS على الإنترنت" InputFormat="numbers" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
