---
title:  ادمج CSV مع HTM via Java
...
يوضح المثال التالي كيفية دمج CSV إلى HTM في Java.
...
{{% cells-merger title="تطبيق مجاني لدمج CSV إلى HTM عبر الإنترنت" InputFormat="csv" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
