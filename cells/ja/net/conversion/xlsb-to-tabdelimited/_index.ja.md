---
title: C# XLSB から TABDELIMITED - XLSB から TABDELIMITED コンバータ
description: Aspose エクセル。 Aspose.Cells を使用して、XLSB を TABDELIMITED にすばやく簡単に変換します。C# XLSB を TABDELIMITED に変換します。 C# XLSB を TABDELIMITED に保存します。 C# を使用して、XLSB を TABDELIMITED として保存します。
...
{{% cells-convert title="XLSB を TABDELIMITED に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="tsv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="XLSB を経由して XLSB を TABDELIMITED に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSB ファイルをプログラムで TABDELIMITED に変換する必要がありますか? .NET 開発者は、わずか数行のコードで XLSB を簡単にロードして TABDELIMITED に変換できます。
