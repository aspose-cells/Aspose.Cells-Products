---
title: Konversikan TSV ke XLTM melalui Java 
weight: 4220
url: /id/java/conversion/tsv-to-xltm/ 
description: Contoh Java kode konversi untuk format TSV ke file XLTM. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke XLTM dalam Aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan TSV ke XLTM melalui Java" h2="Konversi TSV ke XLTM Java untuk mengonversi satu atau beberapa halaman ke XLTM menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi TSV ke XLTM Menggunakan Java" %}}

 Untuk merender TSV ke XLTM, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi TSV ke XLTM melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file TSV ke XLTM hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file TSV dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi XLTM & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file XLTM yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="TSV ke XLTM Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file TSV dalam contoh Workbook
Workbook book = new Workbook("template.tsv");
// simpan TSV sebagai XLTM
