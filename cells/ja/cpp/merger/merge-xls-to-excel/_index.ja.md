...
description: Aspose エクセル。 C++ Aspose.Cells。XLS を EXCEL 保存形式にマージします。 C++ XLSをEXCEL形式に結合します。 XLS を C++ の EXCEL にマージします。 XLS マージします。
...
{{% blocks/products/pf/agp/content h2="XLS を C++ の EXCEL にマージ" %}}
...
{{% cells-merger title="XLSをC++のEXCELにマージするサンプルコード" InputFormat="xls" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
