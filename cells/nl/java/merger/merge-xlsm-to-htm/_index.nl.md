---
title: Voeg XLSM samen met HTM - Combineer XLSM met HTM in Java
url: /nl/java/merger/merge-xlsm-to-htm/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online samenvoegen XLSM naar HTM-opslagformaat. Java Combineer XLSM naar HTM-formaat. Voeg XLSM samen met HTM in Java. XLSM Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis XLSM samen met HTM in Java online" %}}

Het volgende voorbeeld laat zien hoe u XLSM kunt samenvoegen met HTM in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLSM samen te voegen met HTM. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in een HTM-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat XLSM samenvoegt met HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om XLSM samen te voegen met HTM in Java" InputFormat="xlsm" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLSM samen te voegen met HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLSM programmatisch samenvoegen met HTM? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLSM samen te voegen met HTM" %}}
