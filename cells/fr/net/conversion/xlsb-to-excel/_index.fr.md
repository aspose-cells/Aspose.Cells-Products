---
title: C# XLSB vers EXCEL - Convertisseur en ligne XLSB vers EXCEL
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertissez XLSB en format de sauvegarde EXCEL. C# XLSB au format EXCEL. Enregistrez XLSB dans EXCEL C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB vers EXCEL dans C# en ligne gratuitement" %}}
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir XLSB en EXCEL en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en EXCEL via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en EXCEL par programmation ? Les développeurs de .NET peuvent facilement charger et convertir XLSB en EXCEL en quelques lignes de code.
