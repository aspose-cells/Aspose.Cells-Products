---
title:  Inserte la etiqueta (control de formulario) en Excel usando Python via .Net
weight: 80
description: Python via Código fuente .Net para insertar la etiqueta (control de formulario) en Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Inserte la etiqueta (control de formulario) en Excel usando Python via .Net" h2="Inserte objetos utilizando las API del lado del servidor sin ningún software como Microsoft u Open Office, Adobe PDF, etc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo insertar una etiqueta (control de formulario) en un archivo de Excel usando Python via .Net" %}}

 Para insertar la etiqueta (control de formulario) en el archivo de Excel, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar la etiqueta (control de formulario) en un archivo de Excel usando Python via .Net" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el complemento de la colección de formas[método](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_label/#int-int-int-int-int-int) para insertar una etiqueta (control de formulario) en la hoja de trabajo seleccionada.
...
{{% blocks/products/pf/agp/code-block title="Insertar etiqueta (control de formulario) - Python via .Net" offSpacer="" %}}
