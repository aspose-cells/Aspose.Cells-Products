...
description: Aspose Unggul. Java Aspose.Cells. Gabungkan HTM ke format simpan XLSB. Java Gabungkan format HTM ke XLSB. Gabungkan HTM ke XLSB di Java. Gabungkan HTM.
...
{{% blocks/products/pf/agp/content h2="Gabungkan HTM ke XLSB di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan HTM ke XLSB di Java" InputFormat="htm" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan HTM ke XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan HTM ke XLSB secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka Java untuk menggabungkan HTM menjadi XLSB" %}}
