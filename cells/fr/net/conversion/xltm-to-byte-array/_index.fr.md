...
weight: 7690
description: C# Exemple de code pour la conversion de XLTM en tableau d'octets. Utilisez ce code pour la conversion Excel XLTM en tableau d'octets dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLTM en tableau d\'octets via C#" h2="Conversion native et hautes performances d\'Excel XLTM en tableau d\'octets ou vice versa pour le traitement des données de feuilles de calcul à l\'aide d\'API côté serveur .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array est utile pour le traitement ou le stockage des données. Vous pouvez convertir le fichier XLTM en Byte Array ainsi qu'un**Tableau d'octets vers XLTM** document utilisant la langue C#. Afin de convertir XLTM en tableau d'octets, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Il est facile pour les développeurs de charger et de convertir les fichiers XLTM en tableau d'octets pour d'autres tâches de manipulation en seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre XLTM en tableau d\'octets C# Conversion" offSpacer="" %}}
