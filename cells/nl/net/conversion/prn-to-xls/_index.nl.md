---
title: C# PRN naar XLS - PRN naar XLS Converter
description: Aspose Excel. Converteer PRN snel en eenvoudig naar XLS met Aspose.Cells. C# PRN naar XLS. C# Bewaar PRN naar XLS. Sla PRN op als XLS met behulp van C#.
...
{{% blocks/products/pf/agp/content h2="Bewaar PRN op XLS in C#" %}}

In het volgende voorbeeld ziet u hoe u PRN converteert naar XLS in C#.
...
Wilt u PRN-bestanden programmatisch naar XLS converteren? .NET-ontwikkelaars kunnen PRN eenvoudig laden en converteren naar XLS in slechts een paar regels code.
