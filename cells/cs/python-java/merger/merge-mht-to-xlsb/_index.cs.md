---
title:  Sloučit MHT na XLSB přes Python
...
Následující příklad ukazuje, jak sloučit MHT s XLSB v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení MHT na XLSB online" InputFormat="mht" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
