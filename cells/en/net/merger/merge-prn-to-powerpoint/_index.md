---
title: Merge PRN to POWERPOINT via C# 
url: /net/merger/merge-prn-to-powerpoint/ 
description: Merge PRN to POWERPOINT Online for Free. Free Online PRN to POWERPOINT Merger. Merge PRN to Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS and more.
keywords: [Merge PRN to POWERPOINT via C#., PRN to POWERPOINT Merger., Merge PRN to POWERPOINT Online for Free]
---
...
The following example demonstrates how to merge PRN to POWERPOINT in C#.
...
{{% cells-merger title="Free App to merge PRN to POWERPOINT on line" InputFormat="prn" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
