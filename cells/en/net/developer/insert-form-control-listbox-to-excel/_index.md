...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert ListBox to Excel file via C#" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addlistbox) to insert a ListBox in the selected worksheet
