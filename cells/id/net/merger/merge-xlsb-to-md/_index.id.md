---
title: Gabungkan XLSB ke MD - Gabungkan XLSB ke MD di C#
url: /id/net/merger/merge-xlsb-to-md/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan XLSB ke format simpan MD. C# Gabungkan XLSB ke format MD. Gabung XLSB menjadi MD di C#. XLSB Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSB menjadi MD di C#" %}}

Contoh berikut menunjukkan cara menggabungkan XLSB ke MD di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan XLSB ke MD. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file MD. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan XLSB ke MD.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan XLSB ke MD secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
