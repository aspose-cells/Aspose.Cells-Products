---
title: XML egyesítése ET-be – XML-összevonás ET-be a C++-ben
url: /hu/cpp/merger/merge-xml-to-et/ 
description: Aspose Excel. C++ Aspose.Cells. Ingyenes online egyesítés XML-ből ET mentési formátumba. C++ XML kombinálása ET formátumba. XML egyesítése ET-hez a C++-ben. XML-egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse az XML-t az ET-hez a C++ Online ingyen" %}}

A következő példa bemutatja, hogyan lehet XML-t egyesíteni az ET-vel a Aspose.Cells for C++-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket az XML és az ET egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el ET fájlba. Ha kódot fejleszt a C++-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C++-es példát, amely az XML-t ET-vel egyesíti.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online az XML és az ET egyesítése a C++ számon" InputFormat="xml" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hogyan lehet XML-t egyesíteni ET-be a C++ számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan kell egyesíteni az XML-t az ET-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár az XML és az ET egyesítéséhez" %}}
