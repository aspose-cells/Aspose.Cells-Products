...
weight: 360
description: Các đối tượng Group And Ungroup sử dụng Aspose.Cells' Java API mà không cần bất kỳ phần mềm nào như Microsoft hay Open Office, Adobe PDF, v.v.
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước nhóm và rã nhóm các hình dạng trong file Excel via Java" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng[phương pháp nhóm](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#group-com.aspose.cells.Shape---) để nhóm các hình dạng trong bảng tính đã chọn
 + Sử dụng[phương pháp tách nhóm](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#ungroup-com.aspose.cells.GroupShape-) để rã nhóm các hình dạng trong bảng tính đã chọn
