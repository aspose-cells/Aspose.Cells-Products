...
هل تحتاج إلى تحويل ملفات IMAGE إلى EXCEL برمجياً؟ يمكن للمطورين C++ تحويل IMAGE إلى EXCEL بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1. قم بتحويل IMAGE إلى EXCEL عن طريق استدعاء طريقة Save().
