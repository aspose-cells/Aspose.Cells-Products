...
url: /cs/python-net/merger/merge-xlsb-to-htm/ 
...
Následující příklad ukazuje, jak sloučit XLSB do HTM v Aspose.Cells for Python via .NET.
...
Potřebujete sloučit XLSB do HTM programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
