...
description: Aspose Excel. Μετατρέψτε JPG σε MD γρήγορα και εύκολα με Aspose.Cells. C++ JPG σε MD. C++ Αποθήκευση JPG στο MD. Αποθηκεύστε το JPG ως MD χρησιμοποιώντας το C++.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε JPG στο MD στο C++" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή JPG σε MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="md" IsLandingPage="true" language="cpp" %}}
