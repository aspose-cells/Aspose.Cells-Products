---
title: C# HTML a MHT - Convertidor en línea HTML a MHT
description: AsposeExcel. C# Aspose.Cells. C# Aspose Cells. Gratis en línea C# Convertir HTML a formato guardado MHT. C# HTML a formato MHT. Guardar HTML a MHT C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTML a MHT en C#" h2="Biblioteca C# de alta velocidad para convertir HTML a MHT. Esta es una solución de software profesional para importar y exportar HTML, MHT y muchos otros formatos en .NET Framework, .NET Core o Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Guarde HTML a MHT en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo convertir HTML a MHT en C#.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir HTML a MHT. Cargue su archivo HTML, luego simplemente guárdelo como archivo MHT. Tanto para la lectura HTML como para la escritura MHT, puede usar nombres de archivo completos. El contenido y el formato MHT de salida serán idénticos al documento original HTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicación gratuita y código de muestra para convertir HTML a MHT en línea" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir HTML a MHT a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTML a MHT mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente HTML a MHT con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="C# biblioteca para convertir HTML a MHT" %}}
