...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bis DOCX in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie XLS in DOCX in C# konvertiert wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um XLS in DOCX zu konvertieren. Laden Sie Ihre XLS-Datei hoch und speichern Sie sie dann einfach als DOCX-Datei. Sowohl für das Lesen von XLS als auch für das Schreiben von DOCX können Sie vollständig qualifizierte Dateinamen verwenden. Der Inhalt und die Formatierung der Ausgabe DOCX sind identisch mit dem Originaldokument XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Kostenlose App und Beispielcode zum Online-Konvertieren von XLS in DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in DOCX" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in DOCX konvertieren? .NET-Entwickler können XLS problemlos in nur wenigen Codezeilen laden und in DOCX konvertieren.
...
1.  Konvertieren Sie XLS in DOCX, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLS in DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLS in DOCX" %}}
