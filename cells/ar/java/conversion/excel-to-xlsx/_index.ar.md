...
description: Aspose اكسل. قم بتحويل EXCEL إلى XLSX بسرعة وسهولة باستخدام Aspose.Cells. Java EXCEL إلى XLSX. Java احفظ EXCEL إلى XLSX. احفظ EXCEL كـ XLSX باستخدام Java.
...
{{% blocks/products/pf/agp/content h2="تحويل EXCEL إلى XLSX باستخدام Java" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ EXCEL إلى XLSX في Java" %}}
...
هل تحتاج إلى تحويل ملفات EXCEL إلى XLSX برمجياً؟ يمكن لمطوري Java تحويل EXCEL بسهولة إلى XLSX في بضعة أسطر من التعليمات البرمجية.
