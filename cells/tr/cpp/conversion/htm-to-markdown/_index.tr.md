...
{{% blocks/products/pf/agp/content h2="C++ kullanarak HTM\'yi MARKDOWN\'e dönüştürün." %}}
...
{{% blocks/products/pf/agp/content h2="HTM\'yi MARKDOWN\'e C++\'e kaydedin." %}}

Aşağıdaki örnek, HTM'nin C++'den MARKDOWN'e nasıl dönüştürüleceğini göstermektedir.
...
HTML dosyalarını programatik olarak MARKDOWN formatına dönüştürmeniz mi gerekiyor? C++ geliştiricileri, sadece birkaç satır kodla HTML dosyalarını kolayca MARKDOWN formatına dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="C++ kütüphanesi, HTM\'yi MARKDOWN\'e dönüştürür." %}}
