---
title: Utwórz SXC - Utwórz plik SXC w C#
description: Aspose Excel. Bezproblemowo generuj i manipuluj plikami SXC dzięki bibliotece Aspose.Cells for .NET. Ta wydajna biblioteka API zapewnia usprawnione i wydajne rozwiązanie do tworzenia, edytowania i zarządzania plikami SXC bezpośrednio w aplikacjach C#, spełniając specyficzne potrzeby programistów z wysoką precyzją.
...
{{% blocks/products/pf/agp/content h2="Jak utworzyć SXC w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik SXC w C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do utworzenia pliku SXC" %}}
