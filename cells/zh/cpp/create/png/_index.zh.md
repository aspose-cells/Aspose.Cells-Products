---
title: 创建 PNG - 在 C++ 中创建 PNG 文件
description: Aspose Excel。使用 Aspose.Cells for C++ 库，轻松生成和操作 PNG 文件。这款强大的 API 库提供了一种简化高效的解决方案，可直接在您的 C++ 应用程序中创建、编辑和管理 PNG 文件，从而高精度地满足开发人员的特定需求。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 C++ 中创建 PNG 文件" h2="无需使用 C++ 库，以编程方式创建本机和高性能 PNG 文件，无需 Micorsoft Office。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何在 C++ 中创建 PNG" %}}

{{% blocks/products/pf/agp/text %}}

开发人员只需几行代码即可在正在运行的报告应用程序中轻松创建、加载、修改和转换 PNG 文件以进行数据处理。
...
{{% blocks/products/pf/agp/code-block title="示例代码显示如何在 C++ 中创建 PNG 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++ 库创建 PNG 文件" %}}
