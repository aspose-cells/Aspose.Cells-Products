---
title: Convertir SXC en ODS via C#

description: Exemple de code pour la conversion sxc en ods C#. Utilisez API exemple de code pour la conversion par lots de fichiers sxc en ods dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir SXC en ODS en utilisant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SXC en ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers SXC en ODS en quelques lignes de code seulement.
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir SXC en ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="ods" IsLandingPage="true" %}}
