---
title: Gộp MHTML thành MHT - Gộp MHTML thành MHT thành Java
url: /vi/java/merger/merge-mhtml-to-mht/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất trực tuyến miễn phí MHTML thành MHT saveformat. Java Gộp MHTML sang định dạng MHT. Hợp nhất MHTML thành MHT Java. MHTML Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất MHTML với MHT trong Java Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất MHTML với MHT trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất MHTML với MHT. Tải lên các tệp của bạn, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu tệp đó vào tệp MHT. Nếu bạn phát triển mã trong Java, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ Java hợp nhất MHTML với MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất MHTML với MHT trong Java" InputFormat="mhtml" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất MHTML thành MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất MHTML với MHT theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="thư viện Java để hợp nhất MHTML với MHT" %}}
