---
title: C# PNG a SVG - En línea PNG a SVG Convertidor
description: AsposeExcel. C# Aspose.Cells. C# Aspose Cells. Gratis en línea C# Convertir PNG a SVG guardar formato. Formato C# PNG al SVG. Aparta del PNG al SVG C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PNG a SVG en C#" h2="Biblioteca C# de alta velocidad para convertir PNG a SVG. Esta es una solución de software profesional para importar y exportar PNG, SVG y muchos otros formatos en .NET Framework, .NET Core o Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/content h2="Guarde PNG a SVG en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo convertir PNG a SVG en C#.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir PNG a SVG. Cargue su archivo PNG, luego simplemente guárdelo como archivo SVG. Tanto para la lectura PNG como para la escritura SVG, puede utilizar nombres de archivo completos. El contenido y el formato de la salida SVG serán idénticos al documento original PNG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicación gratuita y código de muestra para convertir PNG a SVG en línea" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="svg" IsLandingPage="true" %}}
...
{{% blocks/products/pf/agp/content h2="C# biblioteca para convertir PNG a SVG" %}}
