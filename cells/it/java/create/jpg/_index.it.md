...
description: Aspose Excel. Genera e manipola senza sforzo file JPG con la libreria Aspose.Cells for Java. Questa potente libreria API offre una soluzione semplificata ed efficiente per creare, modificare e gestire file JPG direttamente all'interno delle tue applicazioni Java, soddisfacendo le esigenze specifiche degli sviluppatori con elevata precisione.
...
{{% blocks/products/pf/agp/content h2="Come creare JPG in Java" %}}
...
1.  Salvare la cartella di lavoro in formato JPG utilizzando il metodo save().
