---
title: Durchsuchen Sie das CSV-Dokument, ohne es über C++ zu öffnen 
weight: 5540
url: /de/cpp/search/csv/ 
description: C++ Beispielcode zum Suchen von Wörtern mit Muster in der CSV-Datei in der C++ Laufzeitumgebung für Windows 32 Bit, Windows 64 Bit und Linux 64 Bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Suche nach CSV-Formaten in C++" h2="Native und leistungsstarke CSV-Dokumentsuche mit serverseitigen Aspose.Cells für C++-APIs, ohne Verwendung von Software wie Microsoft oder Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
+ Laden Sie eine CSV-Datei, indem Sie eine IWorkbook-Klasse instanziieren.
...
+ Speichern Sie die CSV-Datei mit der Methode IWorkbook->Save(.).
