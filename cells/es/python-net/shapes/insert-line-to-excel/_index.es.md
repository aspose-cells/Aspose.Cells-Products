...
+ Utilice el método de adición de la colección de formas para insertar una línea en la hoja de cálculo seleccionada.
...
-  Cualquier sistema operativo que pueda ejecutar scripts de python, como Windows y Linux
