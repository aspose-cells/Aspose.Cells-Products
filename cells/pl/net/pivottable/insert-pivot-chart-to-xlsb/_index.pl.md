---
title:  Wstaw wykres przestawny do plików Micorsoft Excel XLSB za pośrednictwem C#
weight: 7690
description: C# Przykładowy kod do generowania dokumentów XLSB z wykresem przestawnym. Użyj tego kodu do tworzenia plików Micorsoft Excel XLSB z wykresem przestawnym w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw wykres przestawny do dokumentów XLSB za pośrednictwem C#" h2="Natywny i wydajny arkusz kalkulacyjny Microsoft Excel XLSB z programowym tworzeniem wykresów przestawnych przy użyciu interfejsów API .NET po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Dynamiczne generowanie pliku MS Excel XLSB z wykresem przestawnym w uruchomionej aplikacji jest łatwe. Aby utworzyć od podstaw dokumenty XLSB z wykresem przestawnym bez konieczności posiadania pakietu MS Office, użyjemy
...
Programiści mogą łatwo wstawić wykres przestawny w arkuszu kalkulacyjnym w formacie XLSB w ramach różnych aplikacji raportujących do przetwarzania danych w zaledwie kilku wierszach kodu.
