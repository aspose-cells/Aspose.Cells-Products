...
Besoin de convertir les fichiers XLSB en OTS par programmation ? Les développeurs de C++ peuvent facilement convertir XLSB en OTS en seulement quelques lignes de code.
...
1.  Convertissez XLSB en OTS en appelant la méthode Save().
