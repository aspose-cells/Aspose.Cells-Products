...
{{% blocks/products/pf/agp/content h2="Cómo crear PDF en C#" %}}

{{% blocks/products/pf/agp/text %}}

 Es fácil para los desarrolladores crear, cargar, modificar y convertir archivos PDF al ejecutar diferentes aplicaciones de informes para el procesamiento de datos en solo unas pocas líneas de código.
...
1. Utilice el método Guardar para guardar el libro de trabajo como archivo PDF.

{{% blocks/products/pf/agp/code-block title="El código de muestra muestra cómo crear el archivo PDF en C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# biblioteca para crear el archivo PDF" %}}
