...
{{% blocks/products/pf/agp/content h2="PNG\'i C#\'de SQL\'e kaydedin" %}}

Aşağıdaki örnek, PNG'in C#'de SQL'e nasıl dönüştürüleceğini gösterir.
{{% blocks/products/pf/agp/text %}}

PNG'i SQL'e dönüştürmek için kolay adımları izleyin. PNG dosyanızı yükleyin ve ardından SQL dosyası olarak kaydedin. Hem PNG okuma hem de SQL yazma için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı SQL içeriği ve biçimlendirmesi orijinal PNG belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="PNG\'i SQL\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="sql" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PNG\'i C# aracılığıyla SQL\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PNG dosyalarını programlı olarak SQL'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PNG'i kolayca yükleyebilir ve SQL'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak PNG'i SQL'e dönüştürün.
1.  PNG'in SQL'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PNG\'i SQL\'e dönüştürmek için C# kitaplığı" %}}
