---
title: Combinar MHTML a XLSM - Combinar MHTML a XLSM en C#
url: /es/net/merger/merge-mhtml-to-xlsm/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea MHTML a XLSM guardar formato. C# Combina el formato MHTML con el XLSM. Combinar MHTML a XLSM en C#. MHTML Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine MHTML a XLSM en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar MHTML con XLSM en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar MHTML a XLSM. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo XLSM. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que combina MHTML con XLSM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar MHTML a XLSM en C#" InputFormat="mhtml" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar MHTML a XLSM a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar MHTML con XLSM mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar MHTML a XLSM" %}}
