---
title: C# PRN naar XLSM - PRN naar XLSM Converter
description: Aspose Excel. Converteer PRN snel en eenvoudig naar XLSM met Aspose.Cells. C# PRN naar XLSM. C# Bewaar PRN naar XLSM. Sla PRN op als XLSM met behulp van C#.
...
{{% blocks/products/pf/agp/content h2="Bewaar PRN op XLSM in C#" %}}

In het volgende voorbeeld ziet u hoe u PRN converteert naar XLSM in C#.
...
Wilt u PRN-bestanden programmatisch naar XLSM converteren? .NET-ontwikkelaars kunnen PRN eenvoudig laden en converteren naar XLSM in slechts een paar regels code.
