...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in SXC in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar SXC in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar SXC of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar SXC? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar SXC met slechts een paar regels code.
