...
weight: 1140
description: C++ 使用密碼鎖定 XLSX 文件的示例代碼 C++ Windows 32 位、Windows 64 位和 Linux 64 位運行時環境。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C++ 加密 XLSX 文件" h2="使用 .NET 庫使用密碼保護 Excel 電子表格，包括 XLSX 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
API這是一個功能豐富、功能強大且易於使用的文檔加密API for C++平台。可以直接下載其最新版本，打開即可
...
1. 使用 IWorkbook 類加載 XLSX 文件
1. 使用帶有 ProtectionType 和 Password 的 Protect(..) 方法
1. 通過 Save() 方法保存被保護的 XLSX 文件
...
{{< blocks/products/pf/agp/other-supported-section title="其他支持的保護文檔" subTitle="使用 C++，可以保護其他文件，包括。" >}}
