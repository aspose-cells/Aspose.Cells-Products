...
{{% blocks/products/pf/agp/content h2="Hur man infogar anteckningar i ODS-filen via Python" %}}
...
I Office 365 är anteckningar för anteckningar, du kan använda följande Python-kod för att infoga och ta bort anteckningar i ODS-filen.

{{% blocks/products/pf/agp/code-block title="Python exempelkod för att infoga och ta bort anteckningar i filen ODS" offSpacer="" %}}
