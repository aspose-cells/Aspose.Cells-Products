---
title:  Fusionner XLTX à HTM via Python
url: /fr/python-net/merger/merge-xltx-to-htm/ 
description: Fusionnez XLTX avec HTM Online gratuitement. Gratuit en ligne XLTX à la fusion HTM. Fusionnez XLTX vers Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner XLTX en HTM dans Python.
...
{{% cells-merger title="Application gratuite pour fusionner XLTX à HTM en ligne" InputFormat="xltx" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
