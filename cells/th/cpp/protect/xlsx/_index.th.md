---
title: ป้องกันและล็อกเอกสาร XLSX ผ่าน C++ 
weight: 1140
url: /th/cpp/protect/xlsx/ 
description: C++ ตัวอย่างโค้ดสำหรับล็อกไฟล์ XLSX โดยใช้รหัสผ่านบน C++ Runtime Environment สำหรับ Windows 32 บิต, Windows 64 บิต และ Linux 64 บิต
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="เข้ารหัสไฟล์ XLSX ผ่าน C++" h2="สเปรดชีต Excel ที่ป้องกันด้วยรหัสผ่านรวมถึงรูปแบบ XLSX โดยใช้ .NET Library" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการปกป้องไฟล์ XLSX ผ่าน C++" %}}
...
1. โหลดไฟล์ XLSX โดยใช้คลาส IWorkbook1. ใช้วิธี Protect(..) กับ ProtectionType และ Password1. บันทึกไฟล์ XLSX ที่ได้รับการป้องกันโดยวิธีบันทึก ()
