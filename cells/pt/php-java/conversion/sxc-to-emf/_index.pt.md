---
title: Conversor PHP SXC para EMF - SXC para EMF
description: Aspose Excel. Converta SXC em EMF de forma rápida e fácil com Aspose.Cells. PHP SXC em EMF. PHP Salve SXC em EMF. Salve SXC como EMF usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em EMF via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em EMF programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em EMF em apenas algumas linhas de código.
...
1.  Converta SXC em EMF chamando o método save da pasta de trabalho.
