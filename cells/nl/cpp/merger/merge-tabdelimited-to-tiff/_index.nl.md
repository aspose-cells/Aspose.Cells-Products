...
Het volgende voorbeeld laat zien hoe u TABDELLIMITED kunt samenvoegen tot TIFF in Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u TABDELLIMITED programmatisch samenvoegen met TIFF? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om TABDELLIMITED samen te voegen tot TIFF" %}}
