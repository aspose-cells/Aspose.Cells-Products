...
Aşağıdaki örnek, XLTM'in Aspose.Cells for .NET'de XLTM ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 XLTM ile XLTM'i programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="XLTM\'i XLTM ile birleştirmek için .NET kitaplığı" %}}
