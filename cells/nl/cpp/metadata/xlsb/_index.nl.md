---
title:  Bewerk of bekijk XLSB Documentmetadata via C++
weight: 4820
description: C++ voorbeeldcode om XLSB bestandsmetadata te bewerken of te bekijken op C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraheer XLSB Metadata via C++" h2="Bouw uw eigen C++-apps om metadata uit XLSB-bestanden toe te voegen, te bewerken, te verwijderen of te extraheren met behulp van server-side API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u XLSB-metagegevens kunt krijgen met behulp van C++" %}}

Om XLSB-metadata te extraheren, gebruiken we
...
+ Laad XLSB-bestand met behulp van CreateIWorkbookMetadata
