---
title: Java XLSX a XLS - Online XLSX a XLS Convertitore
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Free Online Java Converti XLSX in XLS saveformat. Java XLSX al formato XLS. Salva XLSX al XLS Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converti XLSX in XLS in Java" h2="Libreria Java ad alta velocità per la conversione da XLSX a XLS. Questa è una soluzione software professionale per importare ed esportare XLSX, XLS e molti altri formati utilizzando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salva da XLSX a XLS in Java online gratuitamente" %}}

L'esempio seguente mostra come convertire XLSX in XLS in Java.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per convertire XLSX in XLS. Carica il tuo file XLSX, quindi salvalo semplicemente come file XLS. Sia per la lettura XLSX che per la scrittura XLS è possibile utilizzare nomi di file completi. Il contenuto e la formattazione dell'output XLS saranno identici al documento XLSX originale.
...
Devi convertire i file XLSX in XLS a livello di codice? Java gli sviluppatori possono facilmente convertire XLSX in XLS in poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Java libreria per convertire XLSX in XLS" %}}
{{% blocks/products/pf/agp/text %}}
