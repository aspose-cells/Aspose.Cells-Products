...
description: Aspose Unggul. Konversi XML ke JPG dengan cepat dan mudah dengan Aspose.Cells. C++ XML ke JPG. C++ Simpan XML ke JPG. Simpan XML sebagai JPG menggunakan C++.
...
Contoh berikut menunjukkan cara mengonversi XML ke JPG di C++.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi XML ke JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="jpg" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert XML ke JPG lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XML ke JPG secara terprogram? Pengembang C++ dapat dengan mudah mengonversi XML ke JPG hanya dalam beberapa baris kode.
...
1.  Konversi XML ke JPG dengan memanggil metode Save().
1.  Dapatkan hasil konversi XML ke JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengkonversi XML ke JPG" %}}
