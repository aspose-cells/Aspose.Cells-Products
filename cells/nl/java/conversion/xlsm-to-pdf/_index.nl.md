...
{{% blocks/products/pf/agp/content h2="Sla XLSM op in PDF in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSM omzet naar PDF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSM om naar PDF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSM programmatisch converteren naar PDF? Ontwikkelaars van Java kunnen bestanden met de extensie XLSM eenvoudig converteren naar PDF met slechts een paar regels code.
