---
title: 通过 Java 编辑或查看 ODS 文件元数据 
weight: 2080

description: Java 用于在 Java JSP/JSF 应用程序和桌面应用程序的运行时环境中编辑或查看 ODS 格式元数据的示例代码。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 提取 ODS 元数据" h2="构建您自己的 Java 应用，以使用服务器端 API 添加、编辑、删除或提取 ODS 文件中的元数据。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 提取 ODS 元数据" %}}

 为了获取 ODS 文件元数据，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 提取 ODS 元数据的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="提取 ODS 的元数据 - Java" offSpacer="" %}}
