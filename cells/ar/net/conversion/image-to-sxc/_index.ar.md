---
title: تحويل C# صورة إلى SXC - صورة إلى SXC
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C# نهجًا متكاملًا تمامًا لتحويل IMAGE إلى تنسيق SXC، مما يتيح حفظ بيانات IMAGE بسلاسة في تنسيق SXC باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C# فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في SXC في C#" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى SXC في C#.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى SXC عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى SXC برمجياً؟ يمكن لمطوري .NET تحميل وتحويل IMAGE إلى SXC بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الصورة إلى SXC عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل IMAGE إلى SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل الصورة إلى SXC" %}}
