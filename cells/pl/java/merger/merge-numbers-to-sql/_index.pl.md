---
title: Połącz NUMERY z SQL - Połącz NUMERY z SQL w Java
url: /pl/java/merger/merge-numbers-to-sql/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online NUMBERS do formatu zapisu SQL. Java Połącz NUMERY z formatem SQL. Scal NUMBERS do SQL w Java. NUMBERS Scal.
...
{{% blocks/products/pf/agp/content h2="Scal NUMBERS z SQL w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić NUMBERS z SQL w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić NUMBERS z SQL. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do scalania plików, a następnie zapisz ją w pliku SQL. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy NUMBERS z SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online NUMBERS z SQL w Java" InputFormat="numbers" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić NUMERY z SQL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić NUMBERS z SQL? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do scalania NUMBERS z SQL" %}}
