---
title: Gabung XLT ke WORD - Gabungkan XLT ke WORD di Java
url: /id/java/merger/merge-xlt-to-word/ 
description: Aspose Unggul. Java Aspose.Cells. Gabung Online Gratis XLT ke WORD saveformat. Java Gabungkan XLT ke format WORD. Gabung XLT menjadi WORD di Java. XLT Gabung.
...
Contoh berikut menunjukkan cara menggabungkan XLT ke WORD di Aspose.Cells for Java.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan XLT menjadi WORD di Java" InputFormat="xlt" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLT menjadi WORD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLT ke WORD secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
