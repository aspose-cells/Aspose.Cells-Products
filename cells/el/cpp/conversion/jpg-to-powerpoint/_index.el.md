...
description: Aspose Excel. Μετατρέψτε JPG σε POWERPOINT γρήγορα και εύκολα με Aspose.Cells. C++ JPG σε POWERPOINT. C++ Αποθήκευση JPG στο POWERPOINT. Αποθηκεύστε το JPG ως POWERPOINT χρησιμοποιώντας το C++.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε JPG στο POWERPOINT στο C++" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή JPG σε POWERPOINT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="pptx" IsLandingPage="true" language="cpp" %}}
