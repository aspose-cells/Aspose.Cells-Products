...
{{% blocks/products/pf/agp/content h2="Jak převést ČÍSLA na XLTM pomocí Java" %}}

 K vykreslení NUMBERS do XLTM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu NUMBERS na XLTM přes Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor NUMBERS na XLTM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst NUMBERS soubor s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLTM a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLTM
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze NUMBERS na XLTM Java" offSpacer="" %}}

```cs
// načtěte soubor NUMBERS do instance Workbooku
Workbook book = new Workbook("template.numbers");
// uložit ČÍSLA jako XLTM
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze NUMBERS na XLTM" sectionDescription="[Převeďte ČÍSLA na XLTM](https://products.aspose.app/cells/conversion/numbers-to-xltm) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor NUMBERS, bude okamžitě převeden na XLTM." >}}
