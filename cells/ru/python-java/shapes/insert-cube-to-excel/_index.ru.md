...
{{% blocks/products/pf/agp/content h2="Как вставить куб в файл Excel, используя Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке файла Cube в Excel с использованием Python via Java" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте коллекцию форм[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить куб в выбранный рабочий лист.
...
{{% blocks/products/pf/agp/code-block title="Вставка куба - Python via Java" offSpacer="" %}}
