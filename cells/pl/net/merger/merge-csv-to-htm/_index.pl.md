...
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online CSV do formatu zapisu HTM. C# Połącz CSV do formatu HTM. Połącz CSV z HTM w C#. CSV Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz CSV z HTM w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić CSV z HTM w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć numer CSV z HTM. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją do pliku HTM. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy CSV z HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online CSV z HTM w C#" InputFormat="csv" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić CSV z HTM przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo scalić numer CSV z HTM? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia CSV z HTM" %}}
