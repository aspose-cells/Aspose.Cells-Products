...
{{% blocks/products/pf/agp/content h2="วิธีแทรก ComboBox ลงในไฟล์ Excel โดยใช้ C#" %}}
 ...
 ในการแทรก ComboBox ลงในไฟล์ excel เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกไฟล์ ComboBox ลงในไฟล์ Excel ผ่าน C#" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้[เพิ่มวิธีการ](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcombobox) เพื่อแทรก ComboBox ในเวิร์กชีตที่เลือก
