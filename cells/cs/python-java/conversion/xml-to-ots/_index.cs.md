...
{{% blocks/products/pf/agp/content h2="Převeďte XML na OTS pomocí Python" %}}
...
Následující příklad ukazuje, jak převést XML na OTS v Python.
