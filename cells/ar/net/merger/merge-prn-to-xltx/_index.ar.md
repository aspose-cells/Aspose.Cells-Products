---
title: دمج PRN في XLTX - ادمج PRN مع XLTX في C#
url: /ar/net/merger/merge-prn-to-xltx/ 
description: Aspose إكسل. C# Aspose.Cells. دمج مجاني عبر الإنترنت PRN إلى XLTX saveformat. C# ادمج PRN بتنسيق XLTX. دمج PRN إلى XLTX في C#. PRN Merge.
...
يوضح المثال التالي كيفية دمج PRN مع XLTX في Aspose.Cells for .NET.
...
{{% cells-merger title="مجانًا عبر الإنترنت لدمج PRN في XLTX في C#" InputFormat="prn" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج PRN في XLTX عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج PRN في XLTX برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
