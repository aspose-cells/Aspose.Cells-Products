...
{{< blocks/products/pf/i18n/upper-banner h1="在 C++ 中將 OTS 轉換為 TABDELIMITED" h2="使用 C++ 函式庫進行高效能 OTS 到 TABDELIMITED 轉換，無需安裝 Microsoft Excel、OpenOffice 或 Adobe Acrobat。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
需要以程式設計方式將 OTS 檔案轉換為 TABDELIMITED 格式嗎？ C++ 開發人員只需幾行程式碼即可輕鬆將 OTS 檔案轉換為 TABDELIMITED 格式。
...
1. 使用工作簿載入OTS檔案。
1. 呼叫 Save() 方法將 OTS 轉換為 TABDELIMITED。
