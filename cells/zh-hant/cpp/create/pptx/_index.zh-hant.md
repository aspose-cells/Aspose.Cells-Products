---
title: 創建PPTX - 在C++中創建PPTX文件
description: Aspose Excel。 C++ 創建 PPTX 文件。創建PPTX C++。C++ PPTX創建者。在C++中創建PPTX。使用C++生成PPTX文件。
...
{{< blocks/products/pf/i18n/upper-banner h1="在C++中創建PPTX文件" h2="使用 C++ 庫以編程方式創建本機高性能 PPTX 文件，無需 Microsoft Office。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何在C++中創建PPTX" %}}
...
1. 使用 Save() 方法將工作簿保存為 .pptx 文件。

{{% blocks/products/pf/agp/code-block title="示例代碼展示瞭如何在 C++ 中創建 PPTX 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++庫創建PPTX文件" %}}
