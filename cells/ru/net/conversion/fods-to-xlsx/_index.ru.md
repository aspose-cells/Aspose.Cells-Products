...
{{% blocks/products/pf/agp/content h2="Преобразовать FODS в XLSX, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в XLSX в C#" %}}
...
1.  Преобразуйте значение FODS в XLSX, вызвав метод Workbook.Save.
