...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert GroupBox(Form control) to Excel file via C#" %}}
...
+  Use the [add method](https://apireference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addgroupbox) to insert a GroupBox(Form control) in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert GroupBox(Form control) - C#" offSpacer="" %}}
