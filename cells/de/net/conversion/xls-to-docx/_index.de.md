---
title: C# XLS bis DOCX - XLS bis DOCX Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von XLS in das Format DOCX und ermöglicht das nahtlose Speichern von XLS-Daten im Format DOCX mithilfe der Aspose.Cells-Bibliothek – alles durch effizienten und anpassbaren C#-Code.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bis DOCX in C#" %}}

Das folgende Beispiel zeigt, wie man XLS in C# in DOCX umwandelt.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um XLS in DOCX zu konvertieren. Laden Sie Ihre XLS-Datei hoch und speichern Sie sie dann einfach als DOCX-Datei. Sowohl zum Lesen XLS als auch zum Schreiben DOCX können Sie vollqualifizierte Dateinamen verwenden. Der Inhalt und die Formatierung der Ausgabe DOCX sind identisch mit dem Originaldokument XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Beispielcode zur Umwandlung von XLS in DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="docx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in DOCX" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in DOCX konvertieren? .NET-Entwickler können XLS mit nur wenigen Codezeilen problemlos in DOCX laden und konvertieren.
...
1.  Konvertieren Sie XLS in DOCX durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von XLS in DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLS in DOCX" %}}
