---
title: Konvertera XLT till DIF via Python
url: /sv/python-java/conversion/xlt-to-dif/
description: Exempelkod för xlt till dif Python-konvertering. Använd API-exempelkod för batch-xlt-filer för att ändra konvertering inom Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLT till DIF med Python" %}}

 För att konvertera XLT till DIF kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLT till DIF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera XLT-filer till DIF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLT-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med DIF-förlängning som parameter1. Kontrollera den angivna sökvägen för den resulterande DIF-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera XLT till DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="dif" IsLandingPage="true" language="python" %}}
