...
Вам нужно программно преобразовать XML-файлы в DIF? Разработчики C++ могут легко преобразовать XML в DIF всего за несколько строк кода.
