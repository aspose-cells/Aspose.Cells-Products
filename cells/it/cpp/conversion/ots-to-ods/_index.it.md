...
Hai bisogno di convertire i file OTS in ODS tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire OTS in ODS in poche righe di codice.
...
1.  Convertire OTS in ODS chiamando il metodo Save().
