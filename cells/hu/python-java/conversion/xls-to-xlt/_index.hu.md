---
title: "Konvertálja az XLS-t XLT-vé a következőn keresztül: Python"
url: /hu/python-java/conversion/xls-to-xlt/
description: Mintakód az xls–xlt Python konverzióhoz. Használjon API példakódot a kötegelt xls fájlok xlt konvertálásához a Python alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertálja az XLS-t XLT-vé a következőn keresztül: Python" h2="Exportálja az Excel® táblázatokat XLT formátumba Python API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="XLS konvertálása XLT-vé a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLS XLT-vé konvertálásának lépései a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői könnyedén betölthetnek és konvertálhatnak XLS-fájlokat XLT-vé, mindössze néhány sornyi kóddal.
