...
Follow the easy steps to convert SPREADSHEETML into XLSX. Upload your SPREADSHEETML file, then simply save it as XLSX file. For both SPREADSHEETML reading and XLSX writing you can use fully qualified filenames. The output XLSX content and formatting will be identical to the original SPREADSHEETML document.
