...
description: Aspose Excel. Convert XLS to XLS quickly and easily with Aspose.Cells. C++ XLS to XLS. C++ Save XLS to XLS. Save XLS as XLS using C++.
...
{{% cells-convert title="Sample Code to Convert XLS to XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xls" IsLandingPage="true" language="cpp" %}}
