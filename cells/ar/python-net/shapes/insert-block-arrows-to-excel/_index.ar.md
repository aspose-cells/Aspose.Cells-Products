---
title: أدخل أسهم الكتلة في Excel باستخدام Python via. صافي
weight: 338
description: Python via صافي التعليمات البرمجية المصدر لإدراج أسهم الكتلة في Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="أدخل أسهم الكتلة في Excel باستخدام Python via. صافي" h2="أدخل أسهم بلوك باستخدام Aspose.Cells \'API دون أي برنامج مثل Microsoft أو Open Office ، Adobe PDF ، إلخ." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج أسهم الحظر في ملف Excel باستخدام Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="إدراج أسهم بلوك - Python via. صافي" offSpacer="" %}}
