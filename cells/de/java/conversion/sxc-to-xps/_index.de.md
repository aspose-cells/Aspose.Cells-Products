...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie SXC in XPS mit Java" %}}

 Um SXC in XPS zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von SXC in XPS über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können SXC-Dateien in nur wenigen Codezeilen problemlos in XPS konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die SXC-Datei mit einer Instanz der Workbook-Klasse1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit der XPS-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende XPS-Datei
...
{{% blocks/products/pf/agp/code-block title="Konvertierungsquellcode von SXC zu XPS Java" offSpacer="" %}}

```cs
// Laden Sie die SXC-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.sxc");
// Speichern Sie SXC als XPS
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC-zu-XPS-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie SXC in XPS](https://products.aspose.app/cells/conversion/sxc-to-xps) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API muss nicht heruntergeladen werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Es muss kein Code geschrieben werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach Ihre SXC-Datei hoch, sie wird sofort in XPS konvertiert." >}}
