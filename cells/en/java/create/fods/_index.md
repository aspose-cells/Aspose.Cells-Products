...
description: Java Aspose Cells. Java Create FODS File. Create FODS Java. Java FODS Creater. Create FODS in Java. Generate FODS file using Java.
...
{{% blocks/products/pf/agp/content h2="How to Create FODS in Java" %}}
...
1.  Save the workbook as FODS format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create FODS file in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java library to create FODS file" %}}
{{% blocks/products/pf/agp/text %}}
