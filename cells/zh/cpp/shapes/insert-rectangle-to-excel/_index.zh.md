...
weight: 50
description: C++ 在 C++ 运行时环境（适用于 Windows 32 位、Windows 64 位和 Linux 64 位）上的 Excel 文件中插入矩形的示例代码。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 将矩形插入 Excel" h2="使用服务器端的本机高性能插入对象 Aspose.Cells for C++ API，无需使用任何软件，例如 Microsoft 或 Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用C++将矩形插入Excel文件" %}}
...
+ 通过索引选择工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#ada0b818330196c0f026e4588801feadd)在选定的工作表中插入方程形状
以 XLSX 格式保存工作簿。
