---
title: Conversor PHP XLTX para XLSX - XLTX para XLSX
description: Aspose Excel. Converta XLTX em XLSX de forma rápida e fácil com Aspose.Cells. PHP XLTX em XLSX. PHP Salve XLTX em XLSX. Salve XLTX como XLSX usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX em XLSX via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em XLSX programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em XLSX em apenas algumas linhas de código.
...
1.  Converta XLTX em XLSX chamando o método save da pasta de trabalho.
