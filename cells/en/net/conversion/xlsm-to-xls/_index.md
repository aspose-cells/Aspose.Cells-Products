---
title: C# XLSM to XLS - XLSM to XLS Converter
description: Aspose Excel. C# Aspose.Cells. XLSM to XLS in C#. C# Convert XLSM to XLS saveformat. C# XLSM to XLS format. Save XLSM to XLS C#.
keywords: [Aspose Excel., C# Aspose.Cells., XLSM to XLS in C#., C# XLSM to XLS saveformat., XLSM to XLS C#., C# Convert XLSM to XLS]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XLSM to XLS in C#" h2="High-speed C# library for converting XLSM to XLS. This is a professional software solution to import and export XLSM, XLS, and many other formats on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Save XLSM to XLS in C#" %}}

The following example demonstrates how to convert XLSM to XLS in C#.
...
{{% cells-convert title="Sample Code to Convert XLSM to XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xls" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert XLSM to XLS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert XLSM files to XLS programmatically? .NET developers can easily load & convert XLSM to XLS in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="C# library to convert XLSM to XLS" %}}
