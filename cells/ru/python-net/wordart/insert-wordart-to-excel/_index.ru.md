---
title:  Вставьте WordArt в Excel, используя Python via .Net.
weight: 200
description: Python via Исходный код .Net для вставки WordArt в Excel.
...
{{% blocks/products/pf/agp/content h2="Как вставить WordArt в файл Excel с помощью Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке WordArt в файл Excel с использованием Python via .Net" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте дополнение из коллекции фигур[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_word_art/#PresetWordArtStyle-str-int-int-int-int-int-int) чтобы вставить объект WordArt на выбранный лист.
...
-  Установите Aspose.Cells for Python через .Net via .NET из<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , используйте команду как:<code>$ pip install aspose-cells-python</code>.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Вставить WordArt — Python via.Net" offSpacer="" %}}
