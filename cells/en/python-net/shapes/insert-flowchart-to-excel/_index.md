---
title: Insert/Create a FlowChart into Excel using Python via .Net
weight: 360
...
{{% blocks/products/pf/agp/content h2="How to insert/create a FlowChart into Excel File Using Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert/create a FlowChart to Excel file using Python via .Net" %}}
...
+  Use the shapecollection's add [method](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) to insert FlowChart in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert/Create a FlowChart - Python via .Net" offSpacer="" %}}
