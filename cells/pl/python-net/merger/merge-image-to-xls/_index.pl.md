...
url: /pl/python-net/merger/merge-image-to-xls/ 
...
Poniższy przykład pokazuje, jak połączyć IMAGE z XLS w Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo scalić IMAGE z XLS? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
