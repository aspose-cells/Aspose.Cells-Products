---
title: Unisci ODS a SQL - Combina ODS a SQL in Java
url: /it/java/merger/merge-ods-to-sql/ 
description: Aspose Excel. Java Aspose.Cells. Unisci online gratuito ODS al formato di salvataggio SQL. Java Combina ODS nel formato SQL. Unisci ODS a SQL in Java. ODS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci ODS a SQL in Java online gratuitamente" %}}

L'esempio seguente mostra come unire ODS a SQL in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire ODS a SQL. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file SQL. Se sviluppi il codice in Java, sarà più semplice di quanto sembri. Vedere l'esempio Java che unisce ODS a SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire ODS a SQL in Java" InputFormat="ods" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Come unire ODS a SQL via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Hai bisogno di unire ODS a SQL a livello di programmazione? Un documento di base che si fonde e si concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Java per unire ODS a SQL" %}}
