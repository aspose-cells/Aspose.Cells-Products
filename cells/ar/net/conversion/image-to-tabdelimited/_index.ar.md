---
title: C# صورة إلى TABDELIMITED - صورة لتحويل TABDELIMITED
description: Aspose اكسل. C# Aspose.Cells. الصورة إلى TABDELIMITED في C#. C# تحويل الصورة إلى TABDELIMITED حفظ التنسيق. C# صورة إلى تنسيق TABDELIMITED. احفظ الصورة في TABDELIMITED C#.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في TABDELIMITED في C#" %}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل الصورة إلى TABDELIMITED عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى TABDELIMITED برمجياً؟ يمكن لمطوري .NET تحميل وتحويل IMAGE إلى TABDELIMITED بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل الصورة إلى TABDELIMITED عن طريق استدعاء أسلوب Workbook.Save.
1.  احصل على نتيجة تحويل IMAGE إلى TABDELIMITED.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل IMAGE إلى TABDELIMITED" %}}
