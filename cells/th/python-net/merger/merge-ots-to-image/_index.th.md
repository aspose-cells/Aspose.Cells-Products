...
url: /th/python-net/merger/merge-ots-to-image/ 
...
ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน OTS เข้ากับ IMAGE ใน Aspose.Cells for Python via .NET
...
{{% blocks/products/pf/agp/text %}}
 ...
 ต้องการรวม OTS เข้ากับ IMAGE โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
