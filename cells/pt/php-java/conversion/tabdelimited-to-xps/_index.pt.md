...
{{% blocks/products/pf/agp/content h2="Como converter TABDELIMITED para XPS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos TABDELIMITED para XPS programaticamente? Desenvolvedores PHP podem facilmente carregar e converter arquivos TABDELIMITED para XPS com apenas algumas linhas de código.
...
1.  Converta TABDELIMITED para XPS chamando o método save da Workbook.
1.  Obtenha o resultado da conversão de TABDELIMITED para XPS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TABDELIMITED em XPS" %}}
