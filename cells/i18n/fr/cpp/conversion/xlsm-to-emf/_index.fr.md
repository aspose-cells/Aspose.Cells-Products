---
title: Convertissez XLSM en EMF via l'application C++ 
url: /fr/cpp/conversion/xlsm-to-emf/ 
description: Exemple de code de conversion C++ pour le document XLSM au format EMF. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de XLSM en EMF dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSM en EMF via C++" h2="Conversion XLSM vers EMF haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLSM en EMF à l\'aide de C++" %}}

 Afin de convertir XLSM en EMF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLSM en EMF via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier XLSM en EMF en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier XLSM à l'aide de Factory :: CreateIWorkbook.1. Sélectionnez la première feuille de calcul.1. Définir les options (EMF).1. Parcourez chaque page de la feuille et effectuez le rendu.1. Ouvrez le fichier EMF dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion XLSM vers EMF C++" offSpacer="" %}}
