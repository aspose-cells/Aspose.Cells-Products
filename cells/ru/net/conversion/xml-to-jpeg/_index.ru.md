...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в JPEG в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат JPEG в формате C#.
...
1.  Преобразовать XML в формат JPEG, вызвав метод Workbook.Save.
