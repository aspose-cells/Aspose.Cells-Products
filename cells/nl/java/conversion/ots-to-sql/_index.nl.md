---
title: Java OTS naar SQL - OTS naar SQL-converter
description: Aspose Excel. Converteer OTS snel en eenvoudig naar SQL met Aspose.Cells. Java OTS naar SQL. Java OTS opslaan in SQL. Sla OTS op als SQL met behulp van Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer OTS naar SQL in Java" h2="Snelle Java-bibliotheek voor het converteren van OTS naar SQL. Dit is een professionele softwareoplossing voor het importeren en exporteren van OTS, SQL en vele andere formaten met behulp van Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Sla OTS op in SQL in Java" %}}

In het volgende voorbeeld ziet u hoe u OTS naar SQL converteert in Java.
...
Wilt u OTS-bestanden programmatisch naar SQL converteren? Java-ontwikkelaars kunnen OTS eenvoudig in slechts een paar regels code naar SQL converteren.
...
1.  Converteer OTS naar SQL door de Workbook.save-methode aan te roepen.
