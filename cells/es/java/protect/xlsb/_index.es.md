---
title: Proteja y bloquee el documento XLSB a través de Java 
weight: 6590
url: /es/java/protect/xlsb/ 
description: Java código de muestra para bloquear el archivo XLSB con contraseña en Java Entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Cifrar archivos XLSB a través de Java" h2="Proteja con contraseña las hojas de cálculo de Excel, incluido el formato XLSB, utilizando la biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo proteger un archivo XLSB usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para proteger archivos XLSB a través de Java" %}}
...
1. Cargue el archivo XLSB instanciando la clase Workbook1. Utilice el método protect(..) con ProtectionType y Password1. Guarde el archivo XLSB protegido con el método save()
