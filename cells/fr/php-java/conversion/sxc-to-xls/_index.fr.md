---
title: Convertisseur PHP SXC vers XLS - SXC vers XLS
description: Aspose Excel. Cette solution complète offre aux développeurs PHP une approche entièrement intégrée pour convertir le format SXC au format XLS, permettant ainsi un enregistrement transparent des données SXC au format XLS grâce à la bibliothèque Aspose.Cells, le tout via un code PHP efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Comment convertir SXC en XLS via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers SXC en XLS par programmation ? Les développeurs PHP peuvent facilement charger et convertir des fichiers SXC en XLS en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir SXC en XLS" %}}
