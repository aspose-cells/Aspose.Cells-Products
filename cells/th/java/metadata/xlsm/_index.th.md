...
weight: 9030
description: โค้ดตัวอย่าง Java เพื่อแก้ไขหรือดูข้อมูลเมตาของรูปแบบ XLSM บน Java Runtime Environment สำหรับแอปพลิเคชัน JSP/JSF และแอปพลิเคชันเดสก์ท็อป
...
{{% blocks/products/pf/agp/content h2="วิธีแยกข้อมูลเมตา XLSM โดยใช้ Java" %}}
 ...
 เพื่อที่จะรับข้อมูลเมตาของไฟล์ XLSM เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแยก Metadata ของ XLSM via Java" %}}
