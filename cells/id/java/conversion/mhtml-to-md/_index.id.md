---
title: Konversikan MHTML ke MD melalui Java 
url: /id/java/conversion/mhtml-to-md/ 
description: Contoh Java kode konversi untuk format MHTML ke file MD. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke MD dalam Aplikasi berbasis Web atau Desktop Java apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan MHTML ke MD melalui Java" h2="Konversi MHTML ke MD Java untuk mengonversi satu atau beberapa halaman ke MD menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi MHTML ke MD Menggunakan Java" %}}

 Untuk merender MHTML ke MD, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi MHTML ke MD melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file MHTML ke MD hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file MHTML dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi MD & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file MD yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="MHTML ke MD Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file MHTML dalam instance Workbook
Workbook book = new Workbook("template.mhtml");
// simpan MHTML sebagai MD
