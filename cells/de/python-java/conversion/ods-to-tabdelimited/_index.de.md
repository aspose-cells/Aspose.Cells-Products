...
{{% blocks/products/pf/agp/content h2="Konvertieren Sie ODS mit Python in TABDELIMITED" %}}
...
Das folgende Beispiel zeigt, wie ODS in Python in TABDELIMITED konvertiert wird.
