---
title: Export RDL Reports to Excel XLS XLSX and SpreadsheetML in SQL Server 
weight: 3460

description: SQL Server Reporting Services rendering extension - Export Excel XLS XLSX XLSM XLSB CSV SpreadsheetML HTML ODS and TXT formats
---
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Advanced Reporting Services Features
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Support Tablix Group Page Break
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Collapse or expand Pivot Table fields
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Support performing Minus calculations
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Invoke MS Excel printing format
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     MS Excel 2016 charts supported
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Adjust Page margin settings in Excel Sheets
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Developers can design and deliver reports directly from Microsoft Excel while using Aspose.Cells.Report.Designer - a simple designing tool that uses Microsoft Excel as a report template. This feature allows taking advantage of all the powerful functionality and features available within the Microsoft Excel application including Pivot Tables, interactive Charts, formulas and so on.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Export Reports to Spreadsheet Formats
    </h2>
    <p>
     Aspose.Cells for Reporting Services supports all popular Microsoft Excel (97 - 2016) file formats, including “native” Microsoft Excel formats like XLS, XLSX, XLSM, SpreadsheetML, CSV, Tab Delimited and HTML. Aspose.Cells for Reporting Services also support ODS (OpenDocument Spreadsheet) file format.
    </p>
    <p>
     On top of it, Aspose.Cells for Reporting Services export Excel documents as fully editable spreadsheets, that is; the end user may edit the resultant spreadsheets manually in Microsoft Excel application if required.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Aspose.Cells for Reporting Services export the reports to Microsoft Excel spreadsheets in a way that the result appears identical to the original one as generated by the built-in Reporting Services report designer. All report features are converted to the highest degree of precision to make Microsoft Excel spreadsheets look as similar to the original one as possible.
    </p>
   </div>
   <!--
...
-->
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Cells for Reporting Services support tables with grouped rows and footers whereas the grouping can be set up at design time like other report items. Aspose.Cells for Reporting Services also supports parameters and global variables as report data sources. Developers can also make use of Microsoft Query for creating data sources and queries; this is a widely used tool and familiar to most users.
    </p>
    <p>
     In addition to this, Aspose.Cells for Reporting Services supports both reports specific data sources and shared data sources created on Report Server in advance. Developers can use report specific data sources at design time and specify shared data sources as report data sources while publishing reports.
    </p>
   </div>
   <!-- 
...
-->
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Cells for Reporting Services is built using managed code that never needs Microsoft Office or Microsoft Excel to be installed on the machine to work with Excel document formats. It is a perfect Microsoft Excel automation alternative in terms of supported features, security, stability, scalability, speed and price.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="Why Aspose.Cells for Reporting Services?" tabId="success-stories" >}}
