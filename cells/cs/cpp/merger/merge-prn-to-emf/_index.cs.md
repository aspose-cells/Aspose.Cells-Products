...
description: Aspose Excel. C++ Aspose.Cells. Sloučit PRN do formátu uložení EMF. C++ Zkombinujte PRN do formátu EMF. Sloučit PRN na EMF v C++. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN na EMF v C++" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení PRN s EMF v C++" InputFormat="prn" InputFormat2="emf" outformat="emf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
