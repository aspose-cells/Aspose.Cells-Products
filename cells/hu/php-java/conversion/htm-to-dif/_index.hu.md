...
{{% blocks/products/pf/agp/content h2="Hogyan konvertálhatok HTM-et DIF-re PHP-n keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell HTM fájlokat DIF formátumba konvertálni? A PHP fejlesztők könnyedén betölthetik és konvertálhatják a HTM fájlokat DIF formátumba mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/content h2="PHP könyvtár a HTM DIF-re konvertálásához" %}}
