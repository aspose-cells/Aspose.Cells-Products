...
Behöver du konvertera JSON-filer till TIFF programmatiskt? C++-utvecklare kan enkelt konvertera JSON till TIFF på bara några rader kod.
...
1.  Konvertera JSON till TIFF genom att anropa metoden Save().
