---
title: HTML から XLT を結合 - HTML から XLT を C++ に結合
url: /ja/cpp/merger/merge-html-to-xlt/ 
description: Aspose エクセル。 C++ Aspose.Cells。HTML を XLT の保存形式にマージします。 C++ HTML と XLT の形式を結合します。 HTML から XLT を C++ に結合します。HTML を結合します。
...
次の例は、HTML を Aspose.Cells for C++ の XLT にマージする方法を示しています。
