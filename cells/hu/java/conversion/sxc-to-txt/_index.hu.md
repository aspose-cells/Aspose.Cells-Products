---
title: "SXC konvertálása TXT-re a következőn keresztül: Java "
url: /hu/java/conversion/sxc-to-txt/ 
description: Minta Java konverziós kód az SXC formátumhoz TXT fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására TXT-be bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SXC konvertálása TXT-re a következőn keresztül: Java" h2="SXC–TXT Java konverzió egyetlen vagy több oldal TXT formátumba konvertálásához a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása TXT-re a következővel: Java" %}}

 Ahhoz, hogy az SXC-t TXT-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az SXC konvertálása TXT-re a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak SXC fájlt TXT formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az SXC-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat TXT kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott TXT fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="SXC to TXT Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az SXC fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.sxc");
// mentse az SXC-t TXT-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC-ből TXT-be konvertáló élő bemutatók" sectionDescription="[Az SXC konvertálása TXT-re](https://products.aspose.app/cells/conversion/sxc-to-txt) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel az SXC fájlt, amely azonnal TXT formátumba konvertálódik." >}}
