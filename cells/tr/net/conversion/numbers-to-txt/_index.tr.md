---
title: C# NUMARALAR'dan TXT'e - NUMARALAR'dan TXT'e Dönüştürücü
description: Aspose Excel. Bu kapsamlı çözüm, C# geliştiricilere, sayıları TXT formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, Aspose.Cells kütüphanesini kullanarak sayı verilerinin TXT formatına sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C# kod aracılığıyla gerçekleştirilir.
...
{{% blocks/products/pf/agp/content h2="C# numarasına TXT olarak kaydedin." %}}

Aşağıdaki örnek, sayıları C#'den TXT'e nasıl dönüştüreceğinizi göstermektedir.
...
{{% blocks/products/pf/agp/content h2="NUMBERS\'ı C# aracılığıyla TXT\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS dosyayı programlı olarak TXT'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla NUMBERS'ı kolayca yükleyip TXT'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak NUMBERS'ı TXT'e dönüştürün.
1.  NUMBERS'ın dönüşüm sonucunu TXT'e alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# kütüphanesi, sayıları TXT\'e dönüştürüyor." %}}
