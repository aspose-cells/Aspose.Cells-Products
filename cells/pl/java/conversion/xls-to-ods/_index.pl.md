---
title: Java XLS do ODS - XLS do ODS Konwerter
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji formatu XLS do ODS, umożliwiając bezproblemowe zapisywanie danych XLS do formatu ODS za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do ODS w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na ODS w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować numer XLS na numer ODS. Prześlij plik XLS, a następnie po prostu zapisz go jako plik ODS. Zarówno do odczytu XLS, jak i do zapisu ODS można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego ODS będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLS na ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="ods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLS na ODS? Programiści Java mogą łatwo przekonwertować pliki XLS na ODS za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj numer XLS na numer ODS, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji XLS na ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji XLS na ODS" %}}
{{% blocks/products/pf/agp/text %}}
