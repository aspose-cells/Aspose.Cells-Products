...
description: Aspose เอ็กเซล. แปลง XLS เป็น XLSM อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XLS ถึง XLSM C++ บันทึก XLS ถึง XLSM บันทึก XLS เป็น 07611134 81 ใช้ C++.
...
{{% blocks/products/pf/agp/content h2="บันทึก XLS ถึง XLSM ใน C++" %}}
...
1.  แปลง XLS เป็น XLSM โดยการเรียกเมธอด Save()
1.  รับผลลัพธ์การแปลงจาก XLS เป็น XLSM

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ ไลบรารี่เพื่อแปลง XLS เป็น XLSM" %}}
