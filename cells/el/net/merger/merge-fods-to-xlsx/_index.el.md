---
title:  Συγχώνευση FODS σε XLSX μέσω C#
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το FODS με το XLSX στο C#.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση FODS με XLSX σε απευθείας σύνδεση" InputFormat="fods" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
