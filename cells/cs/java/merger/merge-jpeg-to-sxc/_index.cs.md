...
description: Aspose Excel. Java Aspose.Cells. Sloučit JPEG do SXC uložit formát. Java Kombinujte formát JPEG až SXC. Sloučit JPEG až SXC v Java. JPEG Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPEG až SXC v Java" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení JPEG až SXC v Java" InputFormat="jpg" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
