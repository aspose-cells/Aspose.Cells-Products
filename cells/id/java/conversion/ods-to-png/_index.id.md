---
title: Java ODS hingga PNG - ODS hingga PNG Konverter
description: Aspose Excel. Solusi komprehensif ini menyediakan Java pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi ODS ke format PNG, memungkinkan penyimpanan data ODS ke format PNG dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode Java yang efisien dan dapat disesuaikan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan ODS menjadi PNG di Java" h2="Pustaka berkecepatan tinggi Java untuk mengkonversi ODS ke PNG. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor ODS, PNG, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan ODS ke PNG di Java" %}}

Contoh berikut menunjukkan cara mengkonversi ODS menjadi PNG di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi ODS menjadi PNG. Unggah file ODS Anda, lalu simpan sebagai file PNG. Untuk pembacaan ODS dan penulisan PNG Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format keluaran PNG akan sama dengan dokumen ODS asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi ODS menjadi PNG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ods" outformat="png" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi ODS menjadi PNG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file ODS ke PNG secara terprogram? Pengembang Java dapat dengan mudah mengkonversi ODS ke PNG hanya dengan beberapa baris kode.
...
1.  Ubah ODS menjadi PNG dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi dari ODS menjadi PNG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi ODS menjadi PNG" %}}
{{% blocks/products/pf/agp/text %}}
