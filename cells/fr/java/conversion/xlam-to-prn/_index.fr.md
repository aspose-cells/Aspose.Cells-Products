---
title: XLAM en PRN - Convertir XLAM en fichiers PRN Java
description: Aspose Excel. Convertir gratuitement en ligne XLAM au format de sauvegarde PRN. Java XLAM au format PRN. Enregistrez XLAM comme PRN dans Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLAM à PRN dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLAM en PRN dans Java.
...
Besoin de convertir les fichiers XLAM en PRN par programmation ? Les développeurs de Java peuvent facilement convertir XLAM en PRN en quelques lignes de code seulement.
