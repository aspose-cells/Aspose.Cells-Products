---
title: Convierta FODS a TXT a través de Java 

description: Ejemplo de código de conversión Java de formato FODS a archivo TXT. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a TXT dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta FODS a TXT a través de Java" h2="Conversión de FODS a TXT Java para convertir una o varias páginas a TXT utilizando la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir FODS a TXT usando Java" %}}

 Para convertir FODS en TXT, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir FODS a TXT a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo FODS a TXT con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo FODS con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con la extensión TXT y SaveFormat como parámetros1. Compruebe la ruta especificada para el archivo TXT resultante
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de FODS a TXT Java" offSpacer="" %}}

```cs
// cargar el archivo FODS en una instancia de Workbook
Workbook book = new Workbook("template.fods");
// guardar FODS como TXT
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de FODS a TXT" sectionDescription="[Convertir FODS a TXT](https://products.aspose.app/cells/conversion/fods-to-txt) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo FODS, se convertirá instantáneamente a TXT." >}}
