...
weight: 9810
description: C# kod źródłowy do odblokowania chronionego hasłem pliku XLSM na platformach .NET Framework, .NET Core, Mono lub Xamarin Platforms.
...
{{< blocks/products/pf/i18n/upper-banner h1="Odblokuj arkusz kalkulacyjny XLSM pod numerem C#" h2="Usuń ochronę z XLSM, używając biblioteki .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak odblokować plik XLSM za pomocą C#" %}}
 ...
 Aby usunąć plik zabezpieczający XLSM, użyjemy
