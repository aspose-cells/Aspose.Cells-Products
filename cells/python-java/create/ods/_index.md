...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Generating ODS (Openoffice / Lbreoffice) file dynamically within running application is easy. In order to create ODS documents from scratch without requiring MS Office, we will use
...
{{% blocks/products/pf/agp/feature-section-col title="How to Create ODS via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Following source code shows how to create a ODS (Openoffice / Lbreoffice) file using Python." offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 An Excel Spreadsheet Programming Library capable of building cross-platform applications with the ability to generate, modify, convert, render and print ODS (Openoffice / Lbreoffice) files. Python API not only convert between spreadsheet formats, it can also render Excel files as images, PDF, HTML, ODS and more, thus making it a perfect choice to exchange documents in industry-standard formats.
