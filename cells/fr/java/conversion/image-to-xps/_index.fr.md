---
title: Java IMAGE en XPS - Convertisseur IMAGE en XPS
description: Aspose Exceller. Convertissez IMAGE en XPS rapidement et facilement avec Aspose.Cells. Java IMAGE en XPS. Java Enregistrez IMAGE en XPS. Enregistrez IMAGE sous XPS en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrer l\'IMAGE au XPS dans Java" %}}

L'exemple suivant montre comment convertir IMAGE en XPS en Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir une image en XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers IMAGE en XPS par programme ? Les développeurs Java peuvent facilement convertir IMAGE en XPS en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir IMAGE en XPS" %}}
{{% blocks/products/pf/agp/text %}}
