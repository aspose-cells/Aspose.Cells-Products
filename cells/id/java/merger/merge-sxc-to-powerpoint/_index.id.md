---
title: Gabung SXC ke POWERPOINT - Gabungkan SXC ke POWERPOINT di Java
url: /id/java/merger/merge-sxc-to-powerpoint/ 
description: Aspose Unggul. Java Aspose.Cells. Gabung Online Gratis SXC ke saveformat POWERPOINT. Java Gabungkan SXC ke format POWERPOINT. Gabung SXC ke POWERPOINT di Java. SXC Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan SXC ke POWERPOINT di Java Online Gratis" %}}

Contoh berikut menunjukkan cara menggabungkan SXC ke POWERPOINT di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan SXC ke POWERPOINT. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file POWERPOINT. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan SXC ke POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online Gratis Menggabungkan SXC ke POWERPOINT di Java" InputFormat="sxc" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan SXC ke POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan SXC ke POWERPOINT secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk menggabungkan SXC ke POWERPOINT" %}}
