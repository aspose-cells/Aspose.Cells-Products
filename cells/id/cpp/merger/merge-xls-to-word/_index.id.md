---
title: Gabung XLS ke WORD - Gabungkan XLS ke WORD di C++
url: /id/cpp/merger/merge-xls-to-word/ 
description: Aspose Unggul. C++ Aspose.Cells. Gabung Online Gratis XLS ke WORD saveformat. C++ Gabungkan XLS ke format WORD. Gabung XLS menjadi WORD di C++. XLS Gabung.
...
Contoh berikut menunjukkan cara menggabungkan XLS ke WORD di Aspose.Cells for C++.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan XLS menjadi WORD di C++" InputFormat="xls" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLS ke WORD melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLS ke WORD secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API dapat dilakukan hanya dengan beberapa baris kode.
