---
title: "XLSM-fájlok egyesítése a következőn keresztül: C++ "
url: /hu/cpp/merger/xlsm/ 
description: C++ példakód XLSM-dokumentumok kombinálásához a C++ Runtime Environment for Windows 32 bit, Windows 64 bit és a Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSM formátumok egyesítése itt: C++" h2="XLSM-dokumentumok egyesítése szerveroldali C++ API-kkal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSM-fájlok egyesítésének lépései itt: C++" %}}
...
{{% blocks/products/pf/agp/code-block title="XLSM-fájlok egyesítése – C++" offSpacer="" %}}
