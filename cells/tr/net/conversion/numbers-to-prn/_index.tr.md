---
title: C# NUMBERS'den PRN'ye - NUMBERS'den PRN'ye Dönüştürücü
description: Aspose Excel. Bu kapsamlı çözüm, C# geliştiricilere, sayıları PRN formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, Aspose.Cells kütüphanesini kullanarak sayıların PRN formatına sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C# kod aracılığıyla gerçekleştirilir.
...
{{% blocks/products/pf/agp/content h2="C# numaralı telefonu PRN olarak kaydedin." %}}

Aşağıdaki örnek, C# kodunda sayıların PRN'ye nasıl dönüştürüleceğini göstermektedir.
{{% blocks/products/pf/agp/text %}}

NUMBERS'ı PRN'ye dönüştürmek için kolay adımları izleyin. NUMBERS dosyanızı yükleyin ve ardından PRN dosyası olarak kaydedin. Hem NUMBERS okuma hem de PRN yazma için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı PRN içeriği ve biçimlendirmesi orijinal NUMBERS belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Sayıları PRN\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="numbers" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="NUMBERS\'ı C# aracılığıyla PRN\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS dosyayı program aracılığıyla PRN'ye dönüştürmeniz mi gerekiyor? .NET geliştiriciler, yalnızca birkaç satır kodla NUMBERS'ı kolayca yükleyebilir ve PRN'ye dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak sayıları PRN'ye dönüştürün.
1.  NUMBERS'ın PRN'ye dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# numaralı kütüphane, sayıları PRN\'ye dönüştürüyor." %}}
