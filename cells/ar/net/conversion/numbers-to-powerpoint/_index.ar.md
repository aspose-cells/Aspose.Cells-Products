...
هل تحتاج إلى تحويل ملفات الأرقام إلى برنامج PowerPoint برمجيًا؟ يمكن للمطورين الذين يستخدمون .NET تحميل ملفات الأرقام وتحويلها إلى PowerPoint بسهولة في بضعة أسطر من التعليمات البرمجية فقط.
...
1.  قم بتحويل الأرقام إلى عرض تقديمي باستخدام استدعاء طريقة Workbook.Save.
