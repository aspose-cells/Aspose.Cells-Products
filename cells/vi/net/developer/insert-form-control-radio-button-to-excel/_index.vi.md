---
title:  Chèn RadioButton vào Excel via .NET
weight: 60
description: Mã nguồn C# chèn RadioButton vào Excel trên .NET Framework, .NET Core, Mono hoặc Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn RadioButton vào file Excel qua C#" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng[thêm phương pháp](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addradiobutton) để chèn RadioButton vào bảng tính đã chọn
...
{{% blocks/products/pf/agp/code-block title="Chèn RadioButton - C#" offSpacer="" %}}
