...
url: /hu/python-java/merger/merge-xls-to-sql/ 
...
következő példa bemutatja, hogyan egyesítheti a XLS-et az SQL-lel a Aspose.Cells for Python via Java-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a XLS-et az SQL-be? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Az API-k néhány sornyi kóddal elkészíthetők.
