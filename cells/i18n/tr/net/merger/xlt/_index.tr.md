...
{{% blocks/products/pf/agp/content h2="C# Kullanarak XLT Dosyasını Birleştirme" %}}
 ...
 XLT dosyasını birleştirmek için kullanacağız
...
+ Tüm XLT dosyalarını tam yolla yükleyin.
+ Temel dosya olarak bir belge yapın
+ Dosyaları tek tek birleştirmek ve birleştirmek için ilgili yöntemi çağırın.
+ Save() yöntemini çağırın ve dosya adını (tam yol) ve formatı (XLT) parametre olarak iletin.
+ Artık XLT dosyasını Microsoft Office, Adobe PDF veya diğer uyumlu programlarda açıp kullanabilirsiniz.
