---
title:  Combinar XLT Archivos via Java
weight: 9960
description: Java código de muestra para combinar documentos XLT en Java entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar XLT Formatos en Java" h2="Fusión nativa de documentos XLT utilizando las API Java del lado del servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLT" >}}
...
+ guarde el archivo combinado XLT en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Combinar XLT Archivos - Java" offSpacer="" %}}
