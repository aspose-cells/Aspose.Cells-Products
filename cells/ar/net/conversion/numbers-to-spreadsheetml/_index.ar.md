...
description: Aspose اكسل. قم بتحويل NUMBERS إلى SPREADSHEETML بسرعة وسهولة باستخدام Aspose.Cells. C# NUMBERS إلى SPREADSHEETML. C# حفظ الأرقام في جدول البيانات. احفظ الأرقام بتنسيق SPREADSHEETML باستخدام C#.
...
{{% blocks/products/pf/agp/content h2="تحويل الأرقام إلى جدول بيانات باستخدام C#" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ الأرقام في SPREADSHEETML في C#" %}}

يوضح المثال التالي كيفية تحويل NUMBERS إلى SPREADSHEETML في C#.
