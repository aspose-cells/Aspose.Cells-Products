---
title: تحويل TABDELIMITED إلى PDF عبر Java 
url: /ar/java/conversion/tabdelimited-to-pdf/ 
description: نموذج Java رمز تحويل لتنسيق TABDELIMITED إلى ملف PDF. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel و OpenOffice إلى PDF داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TABDELIMITED إلى PDF عبر Java" h2="TABDELIMITED إلى PDF Java التحويل لتحويل صفحات مفردة أو متعددة إلى PDF باستخدام مكتبة Java في مقر الشركة." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TABDELIMITED إلى PDF باستخدام Java" %}}

 من أجل تقديم TABDELIMITED إلى PDF ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل TABDELIMITED إلى PDF عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف TABDELIMITED إلى PDF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف TABDELIMITED مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد PDF & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف PDF الناتج
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED إلى PDF Java رمز مصدر التحويل" offSpacer="" %}}

```cs
// تحميل ملف TABDELIMITED في مثيل المصنف
Workbook book = new Workbook("template.tabdelimited");
// احفظ TABDELIMITED كملف PDF
...
{{< blocks/products/pf/agp/demobox sectionTitle="TABDELIMITED إلى PDF التحويل العروض التوضيحية الحية" sectionDescription="[تحويل TABDELIMITED إلى PDF](https://products.aspose.app/cells/conversion/tabdelimited-to-pdf) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف TABDELIMITED الخاص بك ، وسيتم تحويله على الفور إلى PDF." >}}
