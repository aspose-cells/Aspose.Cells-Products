...
description: Aspose Excel. Python Aspose.Cells. Merge OTS to XML saveformat. Python Combine OTS to XML format. Merge OTS to XML in Python. OTS Merge.
...
{{% blocks/products/pf/agp/content h2="Merge OTS to XML in Python" %}}
...
{{% cells-merger title="Sample Code to Merge OTS to XML in Python" InputFormat="ots" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
