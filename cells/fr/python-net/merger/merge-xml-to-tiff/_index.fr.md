...
L'exemple suivant montre comment fusionner XML avec TIFF dans Aspose.Cells for Python via .NET.
...
Besoin de fusionner XML avec TIFF par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Les API peuvent être réalisées avec seulement quelques lignes de code.
