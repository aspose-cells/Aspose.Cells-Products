---
title: Python ODS ila TSV - ODS ila TSV Dönüştürücü
description: Aspose Excel'de. Python Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde ODS'i TSV'e dönüştürün. Python ODS'i TSV'e dönüştürün. Python ODS'i TSV'e kaydedin. ODS'i 076112 olarak kaydedin Python Excel Kitaplığı'nı kullanarak 3481.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Python aracılığıyla TSV\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

ODS dosyalarını program aracılığıyla TSV'e dönüştürmeniz mi gerekiyor? Python geliştiricileri, yalnızca birkaç satır kodla ODS'i kolayca yükleyebilir ve TSV'e dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak ODS'i TSV'e dönüştürün.
1.  ODS'den TSV'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python ODS\'i TSV\'e Dönüştürmek için Excel Kitaplığı" %}}
