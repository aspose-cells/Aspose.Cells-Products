---
title: Python MHTML 转 AZW3 - MHTML 转 AZW3 转换器
description: Aspose Excel。此综合解决方案为 Python 开发人员提供了一种完全集成的方法，可将 MHTML 转换为 AZW3 格式，从而能够使用 Aspose.Cells 库将 MHTML 数据无缝保存为 AZW3 格式，所有这些都通过高效且可定制的 Python 代码实现。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 Excel 库中将 MHTML 转换为 AZW3" h2="高速 Python Excel 库，用于将 MHTML 转换为 AZW3。使用我们的 Excel 转换工具 API，以 Python 格式开发高级、平台无关的软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="AZW3" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="在 Excel 库中将 MHTML 转换为 AZW3" %}}

如何将 MHTML 转换为 AZW3？通过 NET 库，使用 Aspose.Cells 和 for Python，只需几行代码即可轻松地以编程方式将 MHTML 转换为 AZW3。[Aspose.Cells for Python 通过 NET](https://pypi.org/project/aspose-cells-python/)能够构建跨平台应用程序，具有生成、修改、转换、呈现和打印所有 Excel 文件的能力。Python Excel API 不仅可以在电子表格格式之间进行转换，还可以将 Excel 文件呈现为图像 PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等等，因此使其成为交换行业标准格式文档的完美选择。

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="将 MHTML 保存到 Python Excel 库中的 AZW3。" %}}

以下示例演示如何在 Python Excel 库中将 MHTML 转换为 AZW3。
...
{{% cells-convert title="将 MHTML 通过 Python 转换为 AZW3 的示例代码（Excel 库）" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mhtml" outformat="azw3" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何将 MHTML 转换为 AZW3" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 MHTML 文件转换为 AZW3 格式吗？Python 开发人员只需几行代码即可轻松加载 MHTML 文件并将其转换为 AZW3 格式。
...
{{% blocks/products/pf/agp/content h2="Python Excel 库，用于将 MHTML 转换为 AZW3" %}}
