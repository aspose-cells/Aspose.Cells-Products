---
title: Combinar MHTML con XML - Combinar MHTML con XML en C#
url: /es/net/merger/merge-mhtml-to-xml/ 
description: AsposeExcel. C# Aspose.Cells. Combinación gratuita en línea MHTML para guardar formato XML. C# Combine MHTML en formato XML. Combinar MHTML con XML en C#. MHTML Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine MHTML con XML en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar MHTML con XML en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar MHTML con XML. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo XML. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que fusiona MHTML con XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar MHTML a XML en C#" InputFormat="mhtml" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar MHTML a XML a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar MHTML con XML mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar MHTML a XML" %}}
