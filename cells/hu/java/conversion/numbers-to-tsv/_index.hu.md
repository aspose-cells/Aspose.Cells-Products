---
title: "NUMBERS konvertálása TSV-vé a következőn keresztül: Java "
url: /hu/java/conversion/numbers-to-tsv/ 
description: Minta Java konverziós kód NUMBERS formátumhoz TSV-fájllá. A programozók ezt a példakódot használhatják Excel és OpenOffice táblázatok exportálására TSV-be bármely web- vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="NUMBERS konvertálása TSV-vé a következőn keresztül: Java" h2="NUMBERS TSV Java konvertálása egyetlen vagy több oldal TSV-vé konvertálásához a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="NUMBERS konvertálása TSV-vé a következővel: Java" %}}

 A NUMBERS TSV-ben való megjelenítéséhez ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a NUMBERS szám TSV-vé konvertálásához a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java fejlesztői könnyedén konvertálhatnak NUMBERS fájlt TSV-vé, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. NUMBERS fájl betöltése a munkafüzet osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat TSV kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott TSV-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="NUMBERS a TSV Java konverziós forráskódjára" offSpacer="" %}}

```cs
// töltse be a NUMBERS fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.numbers");
// NUMBERS mentése TSV-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS TSV-konverziós élő bemutatók" sectionDescription="[NUMBERS konvertálása TSV-re](https://products.aspose.app/cells/conversion/numbers-to-tsv) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel NUMBERS fájlját, amely azonnal TSV formátumba konvertálódik." >}}
