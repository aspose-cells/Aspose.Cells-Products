---
title: Convertisseur C# XLS à XLT - XLS à XLT
description: Aspose Exceller. Convertissez XLS en XLT rapidement et facilement avec Aspose.Cells. C# XLS en XLT. C# Enregistrez XLS en XLT. Enregistrez XLS sous 07611134. 81 en utilisant le C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le XLS au XLT au C#" %}}

L'exemple suivant montre comment convertir XLS en XLT dans C#.
...
{{% cells-convert title="Exemple de code pour convertir XLS en XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xlt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLS en XLT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLS en XLT par programme ? Les développeurs .NET peuvent facilement charger et convertir XLS en XLT en quelques lignes de code seulement.
...
1.  Convertissez XLS en XLT en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de XLS en XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir XLS en XLT" %}}
