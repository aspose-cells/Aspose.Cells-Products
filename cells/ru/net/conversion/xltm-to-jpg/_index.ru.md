...
description: Aspose Эксель. Быстро и легко конвертируйте XLTM в JPG с помощью Aspose.Cells. C# XLTM в JPG. C# Сохраните XLTM в JPG. Сохраните XLTM в формате JPG, используя C#.
...
{{% blocks/products/pf/agp/content h2="Сохранить XLTM в JPG в C#." %}}

В следующем примере показано, как преобразовать XLTM в JPG в C#.
...
{{% cells-convert title="Пример кода для преобразования XLTM в JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="jpg" IsLandingPage="true" %}}
