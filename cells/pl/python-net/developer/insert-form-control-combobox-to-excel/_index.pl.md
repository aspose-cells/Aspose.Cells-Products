---
title: Wstaw ComboBox (kontrolka formularza) do programu Excel przy użyciu Python via .Net
weight: 20
description: Python via Kod źródłowy .Net umożliwiający wstawienie ComboBox (kontrolki formularza) do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić ComboBox (kontrolkę formularza) do pliku Excel przy użyciu Python via .Net" %}}

 Aby wstawić ComboBox (kontrolkę formularza) do pliku Excel, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić ComboBox (kontrolkę formularza) do pliku Excel przy użyciu Python via .Net" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj dodatku do kolekcji kształtów[metoda](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_combo_box/#int-int-int-int-int-int) aby wstawić ComboBox (kontrolkę formularza) do wybranego arkusza.
...
{{% blocks/products/pf/agp/code-block title="Wstaw ComboBox (kontrolka formularza) - Python via .Net" offSpacer="" %}}
