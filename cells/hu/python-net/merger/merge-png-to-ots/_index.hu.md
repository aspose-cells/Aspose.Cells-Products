...
url: /hu/python-net/merger/merge-png-to-ots/ 
description: Aspose Excel. Python Aspose.Cells. Ingyenes online egyesítés PNG OTS mentési formátumba. Python A PNG kombinálása OTS formátumba. A PNG egyesítése az OTS-hez a Python-ben. PNG Egyesítés.
...
{{% cells-merger title="Ingyenes online a PNG egyesítéséhez az OTS-hez a Python-ben" InputFormat="png" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="A PNG egyesítése az OTS-hez a Python számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a PNG-et az OTS-hez? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
