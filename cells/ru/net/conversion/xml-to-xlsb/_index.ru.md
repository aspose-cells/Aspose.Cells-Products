...
Нужно программно преобразовать файлы XML в XLSB? Разработчики .NET могут легко загружать и преобразовывать XML в XLSB всего за несколько строк кода.
