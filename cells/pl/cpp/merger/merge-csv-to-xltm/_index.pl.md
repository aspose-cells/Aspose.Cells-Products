---
title: Scal CSV z XLTM - Połącz CSV z XLTM w C++
url: /pl/cpp/merger/merge-csv-to-xltm/ 
description: Aspose Excel. C++ Aspose.Cells. Scal CSV z XLTM w formacie zapisu. C++ Połącz format CSV z XLTM. Scal CSV z XLTM w C++. CSV Scal.
...
{{% blocks/products/pf/agp/content h2="Scal CSV z XLTM w C++" %}}

Poniższy przykład pokazuje, jak połączyć CSV z XLTM w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć CSV z XLTM. Prześlij swoje pliki, wywołaj metodę Workbook.Combine w celu łączenia plików, a następnie zapisz je w pliku XLTM. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy CSV z XLTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia CSV z XLTM w C++" InputFormat="csv" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć CSV z XLTM przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć CSV z XLTM? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia CSV z XLTM" %}}
