---
title: Konwertuj XLSB na TIFF przez Python
url: /pl/python-java/conversion/xlsb-to-tiff/
description: Przykładowy kod konwersji xlsb do tiff Python. Użyj przykładowego kodu API dla plików wsadowych xlsb do konwersji tiff w aplikacji Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na TIFF za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLSB na TIFF za pomocą Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programiści mogą łatwo ładować i konwertować pliki XLSB do formatu TIFF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSB z instancją Workbook1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem TIFF jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku TIFF
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLSB na TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="tiff" IsLandingPage="true" language="python" %}}
