...
description: Aspose Excel. Python Aspose.Cells. Sloučit FODS do XLSM uložit formát. Python Kombinujte formát FODS až XLSM. Sloučit FODS až XLSM v Python. FODS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit FODS až XLSM v Python" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení FODS až XLSM v Python" InputFormat="fods" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
