---
title: C# XLS na ET - XLS na konwerter ET
description: Aspose Excel. Szybko i łatwo przekonwertuj numer XLS na ET za pomocą Aspose.Cells. C# XLS na ET. C# Zapisz XLS w ET. Zapisz XLS jako ET, używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS w ET w C#" %}}
...
{{% cells-convert title="Przykładowy kod do konwersji XLS na ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na ET poprzez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na ET? Programiści .NET mogą łatwo załadować i przekonwertować XLS na ET w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLS na ET" %}}
