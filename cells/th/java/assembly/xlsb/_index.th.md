---
title:  สร้างรายงานในไฟล์ XLSB via Java
weight: 3560
description: รหัสตัวอย่าง Java เพื่อสร้างรายงานรูปแบบ XLSB บน Java Runtime Environment สำหรับ JSP/JSF Application และ Desktop Applications
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="การสร้างรายงานจำนวนมากในรูปแบบ XLSB via Java" h2="สร้างรายงานในรูปแบบ XLSB โดยใช้แหล่งข้อมูลและเทมเพลต" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีสร้างรายงาน XLSB โดยใช้ Java" %}}
 ...
 เพื่อสร้างรายงานไฟล์ XLSB เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการสร้าง XLSB รายงาน via Java" %}}
...
1.  บันทึกผลลัพธ์ในรูปแบบ XLSB โดยใช้วิธี Worbook.save
