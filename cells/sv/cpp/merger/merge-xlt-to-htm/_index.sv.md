---
title: Slå samman XLT till HTM - Kombinera XLT till HTM i C++
url: /sv/cpp/merger/merge-xlt-to-htm/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis Online Merge XLT till HTM saveformat. C++ Kombinera XLT till HTM-format. Slå samman XLT till HTM i C++. XLT Slå samman.
...
Följande exempel visar hur man slår samman XLT till HTM i Aspose.Cells for C++.
...
{{% cells-merger title="Gratis online för att slå samman XLT till HTM i C++" InputFormat="xlt" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman XLT till HTM via C++" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du slå samman XLT till HTM programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API:er kan göras med bara några rader kod.
