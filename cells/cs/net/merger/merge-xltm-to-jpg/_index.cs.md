...
url: /cs/net/merger/merge-xltm-to-jpg/ 
...
Následující příklad ukazuje, jak sloučit XLTM do JPG v Aspose.Cells for .NET.
...
Potřebujete sloučit XLTM do JPG programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET ke sloučení XLTM do JPG" %}}
