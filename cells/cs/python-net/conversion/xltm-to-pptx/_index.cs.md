...
Následující příklad ukazuje, jak převést XLTM na PPTX v Python via NET.
...
{{% blocks/products/pf/agp/content h2="Jak převést XLTM na PPTX" %}}
