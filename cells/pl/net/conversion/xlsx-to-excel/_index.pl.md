...
description: Aspose Excel. Szybko i łatwo przekonwertuj XLSX na EXCEL za pomocą Aspose.Cells. C# XLSX na EXCEL. C# Zapisz XLSX w programie EXCEL. Zapisz XLSX jako EXCEL, używając C#.
...
{{% blocks/products/pf/agp/content h2="Konwertuj XLSX na EXCEL za pomocą C#" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSX w EXCEL w C#" %}}

Poniższy przykład ilustruje, jak przekonwertować XLSX na EXCEL w C#.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLSX na EXCEL" %}}
