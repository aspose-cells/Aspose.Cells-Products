---
title: C++ HTML na ET - HTML na konwerter ET
description: Aspose Excel. Szybko i łatwo przekonwertuj numer HTML na ET za pomocą Aspose.Cells. C++ HTML na ET. C++ Zapisz HTML w ET. Zapisz HTML jako ET, używając C++.
...
{{% blocks/products/pf/agp/content h2="Zapisz HTML w ET w C++" %}}

Poniższy przykład pokazuje, jak przekonwertować HTML na ET w C++.
...
{{% cells-convert title="Przykładowy kod do konwersji HTML na ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="et" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować HTML na ET poprzez C++" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki HTML na ET? Programiści C++ mogą łatwo przekonwertować HTML na ET w zaledwie kilku linijkach kodu.
...
1. Konwertuj HTML na ET, wywołując metodę Save().
1.  Uzyskaj wynik konwersji HTML na ET.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C++ do konwersji HTML na ET" %}}
