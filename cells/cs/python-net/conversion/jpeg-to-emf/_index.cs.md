...
{{% blocks/products/pf/agp/content h2="Převést JPEG na EMF na Python" %}}
...
Následující příklad ukazuje, jak převést JPEG na EMF v Python via NET.
