---
title: Proteger e bloquear ODS documento via .NET
weight: 5580
description: C# código-fonte para bloquear ODS arquivo usando senha em .NET Framework, .NET Core, Mono ou Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Criptografar ODS Arquivos via C#" h2="Planilhas do Excel protegidas por senha, incluindo o formato ODS usando a Biblioteca .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Proteger ODS via C#" %}}
...
1.  Instancie a classe Workbook com o caminho para o arquivo ODS
