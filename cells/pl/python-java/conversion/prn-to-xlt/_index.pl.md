...
description: Aspose Excel. Konwertuj PRN na XLT szybko i łatwo za pomocą Aspose.Cells. Python PRN na XLT. Python Zapisz PRN na XLT. Zapisz PRN jako XLT używając Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj PRN na XLT za pomocą Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz PRN pod numerem XLT w Python" %}}

Poniższy przykład ilustruje sposób konwersji PRN na XLT w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji PRN na XLT" %}}
