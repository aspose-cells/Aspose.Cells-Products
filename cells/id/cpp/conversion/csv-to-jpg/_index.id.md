---
title: Konversi CSV ke JPG melalui C++ aplikasi 
url: /id/cpp/conversion/csv-to-jpg/ 
description: Contoh C++ kode konversi untuk dokumen CSV ke format JPG. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch CSV ke JPG dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi CSV ke JPG melalui C++" h2="Konversi CSV ke JPG berperforma tinggi menggunakan pustaka C++ tanpa memerlukan instalasi Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file CSV ke JPG hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file CSV menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file output dengan ekstensi file (JPG).1. File JPG akan disimpan di jalur yang ditentukan.1. Buka file JPG di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="CSV ke JPG C++ Kode Sumber Konversi" offSpacer="" %}}
