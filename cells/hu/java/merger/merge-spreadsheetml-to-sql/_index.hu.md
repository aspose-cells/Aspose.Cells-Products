...
Kövesse az egyszerű lépéseket a SPREADSHEETML SQL-be olvasztásához. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el SQL fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java-es példát, amely egyesíti a SPREADSHEETML-t SQL-be.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a SPREADSHEETML SQL-lel való egyesítéséhez" %}}
