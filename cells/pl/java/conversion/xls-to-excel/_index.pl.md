...
{{% blocks/products/pf/agp/content h2="Konwertuj XLS do formatu EXCEL za pomocą Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS w programie EXCEL w formacie Java" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę XLS na format EXCEL w formacie Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na via Java w formacie EXCEL" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLS do formatu EXCEL? Programiści Java mogą łatwo przekonwertować pliki XLS do formatu EXCEL za pomocą zaledwie kilku linijek kodu.
