---
title: Fusionner XML avec EXCEL - Combiner XML avec EXCEL dans Python
url: /fr/python-net/merger/merge-xml-to-excel/ 
description: Aspose Exceller. Python Exceller. Fusionnez XML au format de sauvegarde EXCEL. Python Combinez XML au format EXCEL. Fusionnez XML avec EXCEL dans la bibliothèque Excel Python. Fusion XML.
...
{{% blocks/products/pf/agp/content h2="Fusionner XML avec EXCEL à l\'aide de la bibliothèque Excel Python" %}}

 Comment fusionner XML vers EXCEL ? Avec la bibliothèque Aspose.Cells for Python via .NET, vous pouvez facilement fusionner XML vers EXCEL par programme avec quelques lignes de code.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python) est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. Python Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie. Vous pouvez installer Aspose.Cells for Python via .NET à partir de<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , utilisez la commande comme :<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Fusionner XML avec EXCEL dans la bibliothèque Excel Python" %}}

L'exemple suivant montre comment fusionner XML vers EXCEL dans Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner XML vers EXCEL. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier EXCEL. Si vous développez du code en Python, ce sera plus simple qu'il n'y paraît. Voir l'exemple Python qui fusionne XML avec EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner XML avec EXCEL dans la bibliothèque Excel Python" InputFormat="xml" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XML avec EXCEL via la bibliothèque Excel Python" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XML vers EXCEL par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour fusionner XML vers EXCEL" %}}
