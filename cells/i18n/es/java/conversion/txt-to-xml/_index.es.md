---
title: Convierta TXT a XML a través de Java 
url: /es/java/conversion/txt-to-xml/ 
description: Ejemplo de código de conversión Java de formato TXT a archivo XML. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a XML dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta TXT a XML a través de Java" h2="Conversión de TXT a XML Java para convertir una o varias páginas a XML utilizando la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir TXT a XML usando Java" %}}

 Para convertir TXT a XML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir TXT a XML a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo TXT a XML con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo TXT con una instancia de la clase Workbook1. Llamar al método Workbook.save1. Pase la ruta de salida con extensión XML y SaveFormat como parámetros1. Compruebe la ruta especificada para el archivo XML resultante
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de TXT a XML Java" offSpacer="" %}}

```cs
// cargar el archivo TXT en una instancia de Workbook
Workbook book = new Workbook("template.txt");
// guardar TXT como XML
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de TXT a XML" sectionDescription="[Convertir TXT a XML](https://products.aspose.app/cells/conversion/txt-to-xml) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo TXT, se convertirá instantáneamente a XML." >}}
