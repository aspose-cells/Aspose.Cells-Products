---
title:  ابحث في وثيقة XLSB بدون فتح عن طريق C++
weight: 7020
description: رمز مثال C++ للبحث عن الكلمات ذات النمط في ملف XLSB على C++ بيئة وقت التشغيل لـ Windows 32 بت و Windows 64 بت و Linux 64 بت.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ابحث في XLSB التنسيقات في C++" h2="بحث عن المستندات XLSB أصلي وعالي الأداء باستخدام واجهات برمجة تطبيقات Aspose.Cells for C++ من جانب الخادم ، دون استخدام أي برنامج مثل Microsoft أو Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
قم بتحميل ملف XLSB عن طريق إنشاء فئة IWorkbook.
...
+ حفظ XLSB ملف باستخدام IWorkbook-> طريقة حفظ (.).
