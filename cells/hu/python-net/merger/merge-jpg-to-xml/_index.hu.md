...
url: /hu/python-net/merger/merge-jpg-to-xml/ 
...
A következő példa bemutatja, hogyan lehet a JPG-t XML-be egyesíteni a Aspose.Cells for Python via .NET-ben.
...
Programozottan egyesítenie kell a JPG-t XML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
