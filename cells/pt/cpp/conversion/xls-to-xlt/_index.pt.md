---
title: C++ XLS a XLT - XLS a XLT Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C++ uma abordagem totalmente integrada para converter XLS para o formato XLT, permitindo o salvamento perfeito de dados XLS no formato XLT usando a biblioteca Aspose.Cells, tudo por meio de código C++ eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLS a XLT em C++" %}}

exemplo a seguir demonstra como converter XLS em XLT em C++.
...
{{% blocks/products/pf/agp/content h2="Como converter XLS em XLT por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS para XLT programaticamente? Desenvolvedores que trabalham com C++ podem facilmente converter arquivos XLS para XLT com apenas algumas linhas de código.
...
1.  Converta XLS para XLT chamando o método Save().
1.  Obtenha o resultado da conversão de XLS para XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para converter XLS em XLT" %}}
