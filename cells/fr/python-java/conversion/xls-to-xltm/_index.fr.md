...
{{% blocks/products/pf/agp/content h2="Comment convertir XLS en XLTM en utilisant Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLS en XLTM via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement charger et convertir des fichiers XLS en XLTM en quelques lignes de code seulement.
