---
title: C# PRN naar TIFF - PRN naar TIFF Converter
description: Aspose Excel. Converteer PRN snel en eenvoudig naar TIFF met Aspose.Cells. C# PRN naar TIFF. C# Bewaar PRN naar TIFF. Sla PRN op als TIFF met behulp van C#.
...
{{% blocks/products/pf/agp/content h2="Bewaar PRN op TIFF in C#" %}}

In het volgende voorbeeld ziet u hoe u PRN converteert naar TIFF in C#.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om PRN naar TIFF te converteren. Upload uw PRN-bestand en sla het vervolgens eenvoudig op als TIFF-bestand. Voor zowel PRN-lezen als TIFF-schrijven kunt u volledig gekwalificeerde bestandsnamen gebruiken. De inhoud en opmaak van de uitvoer TIFF zullen identiek zijn aan het originele PRN-document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Voorbeeldcode om PRN naar TIFF te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="tiff" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PRN converteren naar TIFF via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u PRN-bestanden programmatisch naar TIFF converteren? .NET-ontwikkelaars kunnen PRN eenvoudig laden en converteren naar TIFF in slechts een paar regels code.
...
1.  Converteer PRN naar TIFF door de Workbook.Save-methode aan te roepen.
