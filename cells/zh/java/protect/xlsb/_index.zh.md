---
title: 保护和锁定XLSB文档via Java
weight: 6590
description: Java 示例代码，用于在 JSP/JSF 应用程序和桌面应用程序的 Java 运行时环境上使用密码锁定 XLSB 文件。
...
{{< blocks/products/pf/i18n/upper-banner h1="加密 XLSB 文件 via Java" h2="使用 .NET 库对 Excel 电子表格进行密码保护，包括 XLSB 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="保护 XLSB 文件的步骤 via Java" %}}
