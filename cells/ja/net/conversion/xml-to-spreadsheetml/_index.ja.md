---
title: C# XML から SPREADSHEETML - オンライン XML から SPREADSHEETML コンバーター
description: Aspose エクセル。 C# Aspose.Cells. C# Aspose Cells. 無料オンライン C# XML を SPREADSHEETML 保存形式に変換します。 C# XML から SPREADSHEETML 形式。 XML を SPREADSHEETML C# に保存します。
...
{{% blocks/products/pf/agp/content h2="無料でオンラインで XML を C# の SPREADSHEETML に保存" %}}

次の例は、XML を C# の SPREADSHEETML に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って XML を SPREADSHEETML に変換します。 XML ファイルをアップロードし、SPREADSHEETML ファイルとして保存します。 XML の読み取りと SPREADSHEETML の書き込みの両方で、完全修飾ファイル名を使用できます。出力される SPREADSHEETML のコンテンツと形式は、元の XML ドキュメントと同じになります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="オンラインでXMLをSPREADSHEETMLに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C# 経由で XML を SPREADSHEETML に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XML ファイルをプログラムで SPREADSHEETML に変換する必要がありますか? .NET 開発者は、わずか数行のコードで XML を簡単にロードして SPREADSHEETML に変換できます。
...
1.  Workbook.Save メソッドを呼び出して、XML を SPREADSHEETML に変換します。
1.  XMLからSPREADSHEETMLへの変換結果を取得します。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# XML を SPREADSHEETML に変換するライブラリ" %}}
