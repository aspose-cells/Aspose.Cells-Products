---
title: Python JPEG إلى MHT - JPEG إلى MHT محول
description: Aspose اكسل. قم بتحويل JPEG إلى MHT بسرعة وسهولة باستخدام Aspose.Cells. Python JPEG إلى MHT. Python احفظ JPEG إلى MHT. احفظ JPEG كـ MHT باستخدام Python.
...
{{% blocks/products/pf/agp/content h2="احفظ JPEG إلى MHT في Python" %}}
...
هل تحتاج إلى تحويل ملفات JPEG إلى MHT برمجياً؟ يمكن لمطوري Python تحميل وتحويل JPEG بسهولة إلى MHT في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل JPEG إلى MHT عن طريق استدعاء طريقة Workbook.save.
1.  احصل على نتيجة التحويل من JPEG إلى MHT.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل JPEG إلى MHT" %}}
