...
description: Sample Java conversion code for MHTML format to ODS file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to ODS within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert MHTML to ODS Using Java" %}}
 ...
 In order to render MHTML to ODS, we’ll use
