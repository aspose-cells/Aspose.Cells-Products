---
title: Crear ET - Crear archivo ET en C#
description:  Aspose Excel. C# Cree un archivo ET rápida y fácilmente con Aspose.Cells. Genere un archivo ET usando C#. Cree ET en C#. C# ET Creater.
...
{{% blocks/products/pf/agp/content h2="Cómo crear ET en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="El código de muestra muestra cómo crear un archivo ET en C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para crear un archivo ET" %}}
