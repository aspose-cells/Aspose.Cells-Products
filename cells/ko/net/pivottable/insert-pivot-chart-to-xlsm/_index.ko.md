...
{{< blocks/products/pf/i18n/upper-banner h1="C#을 통해 XLSM 문서에 피벗 차트 삽입" h2="기본 및 고성능 Microsoft Excel XLSM 서버 측 API를 사용하여 프로그래밍 방식으로 피벗 차트를 생성하는 스프레드시트 .NET" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 실행 중인 응용 프로그램 내에서 동적으로 피벗 차트를 사용하여 MS Excel XLSM 파일을 생성하는 것은 쉽습니다. MS Office 없이 처음부터 피벗 차트로 XLSM 문서를 생성하려면 다음을 사용합니다.
