---
title: TSV'i XLS'e birleştir - TSV'i Java'de XLS'e birleştir
url: /tr/java/merger/merge-tsv-to-xls/ 
description: Aspose excel. Java Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme TSV ile XLS kaydetme biçimi. Java TSV ile XLS formatını birleştirin. Java içinde TSV'i XLS ile birleştir. TSV Birleştir.
...
{{% blocks/products/pf/agp/content h2="TSV ile XLS\'i Java Çevrimiçinde Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, TSV'in Aspose.Cells for Java'de XLS ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TSV ile XLS'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından XLS dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. TSV'i XLS ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TSV\'i Java\'de XLS ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="tsv" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TSV ile XLS via Java Nasıl Birleştirilir" %}}

{{% blocks/products/pf/agp/text %}}

 TSV ile XLS'i programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="TSV\'i XLS ile birleştirmek için Java kitaplığı" %}}
