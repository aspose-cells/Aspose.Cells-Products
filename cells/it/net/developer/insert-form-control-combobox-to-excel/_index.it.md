...
weight: 20
description: C# codice sorgente per inserire ComboBox in Excel su .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Come inserire ComboBox in un file Excel utilizzando C#" %}}

 Per inserire ComboBox nel file excel, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire ComboBox nel file Excel tramite C#" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa il[aggiungere metodo](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addcombobox) per inserire un ComboBox nel foglio di lavoro selezionato
...
{{% blocks/products/pf/agp/code-block title="Inserire ComboBox - C#" offSpacer="" %}}
