...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować HTML na XLSM za pomocą C++" %}}

 Aby przekonwertować HTML do XLSM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować HTML na XLSM za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik HTML na XLSM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik HTML przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLSM).1. Plik XLSM zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLSM w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="HTML do XLSM C++ Kod źródłowy konwersji" offSpacer="" %}}
