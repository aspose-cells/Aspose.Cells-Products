---
title: C++ HTML เป็น MD - ตัวแปลงออนไลน์ HTML เป็น MD
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง HTML เป็น MD บันทึกรูปแบบ C++ HTML เป็นรูปแบบ MD บันทึก HTML ถึง MD C++
...
{{% blocks/products/pf/agp/content h2="บันทึก HTML เป็น MD ใน C++ ออนไลน์ฟรี" %}}
...
1.  แปลง HTML เป็น MD โดยเรียกเมธอด Save()
