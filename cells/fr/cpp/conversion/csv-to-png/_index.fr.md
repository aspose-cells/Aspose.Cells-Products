---
title: Convertir CSV en PNG via l'application C++ 
weight: 920
url: /fr/cpp/conversion/csv-to-png/ 
description: Exemple de code de conversion C++ pour le document CSV au format PNG. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de CSV en PNG dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir CSV en PNG via C++" h2="Conversion CSV vers PNG haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir CSV en PNG en utilisant C++" %}}

 Pour convertir CSV en PNG, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir CSV en PNG via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier CSV en PNG en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier CSV à l'aide de Factory :: CreateIWorkbook.1. Sélectionnez la première feuille de calcul.1. Définir les options (PNG).1. Parcourez chaque page de la feuille et effectuez le rendu.1. Ouvrez le fichier PNG dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion CSV vers PNG C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Conversion CSV en PNG Démonstrations en direct" sectionDescription="[Convertir CSV en PNG](https://products.aspose.app/cells/conversion/csv-to-png) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier CSV, il sera converti instantanément en PNG." >}}
