...
description: Aspose Excel. Python Criar XLTM Arquivo. Criar XLTM Python. Python XLTM Criador. Crie XLTM em Python. Gere o arquivo XLTM usando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Criar arquivo XLTM em Python" h2="Biblioteca Python de alta velocidade para criar o arquivo XLTM. Esta é uma solução de software profissional para importar e exportar XLSX, PDF e muitos outros formatos usando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1. Use o método Save para salvar a pasta de trabalho como arquivo XLTM.

{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar o arquivo XLTM em Python." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python biblioteca para criar o arquivo XLTM" %}}
