...
description: Aspose اكسل. قم بتحويل HTM إلى XPS بسرعة وسهولة باستخدام Aspose.Cells. Java HTM إلى XPS. Java احفظ HTM إلى XPS. احفظ HTM كـ XPS باستخدام Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل HTM إلى XPS في Java" h2="مكتبة Java عالية السرعة لتحويل HTM إلى XPS. هذا حل برمجي احترافي لاستيراد وتصدير HTM وXPS والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل HTM إلى XPS باستخدام Java" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ HTM في XPS في Java" %}}
...
هل تحتاج إلى تحويل ملفات HTM إلى XPS برمجياً؟ يمكن لمطوري Java تحويل HTM بسهولة إلى XPS في بضعة أسطر من التعليمات البرمجية.
