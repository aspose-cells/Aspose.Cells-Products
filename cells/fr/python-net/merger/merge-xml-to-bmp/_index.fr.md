...
url: /fr/python-net/merger/merge-xml-to-bmp/ 
...
L'exemple suivant montre comment fusionner XML avec BMP dans Aspose.Cells for Python via .NET.
...
Besoin de fusionner XML avec BMP par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Les API peuvent être réalisées avec seulement quelques lignes de code.
