...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan XLSB ke XML secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka .NET untuk menggabungkan XLSB ke XML" %}}
