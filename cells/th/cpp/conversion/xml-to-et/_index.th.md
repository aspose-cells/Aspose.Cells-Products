...
ต้องการแปลงไฟล์ XML เป็น ET โดยใช้โปรแกรมใช่ไหม? นักพัฒนา C++ สามารถแปลง XML เป็น ET ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลง XML เป็น ET โดยเรียกใช้เมธอด Save()
