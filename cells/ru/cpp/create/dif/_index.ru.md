...
description: Aspose Эксель. C++ Создайте файл DIF быстро и легко с помощью Aspose.Cells. Создайте файл DIF с помощью C++. Создайте DIF в C++. C++ DIF Creater.
...
1.  Сохраните книгу как файл .dif, используя метод Save().
