---
title: Konvertera XLSM till XPS via Python
url: /sv/python-java/conversion/xlsm-to-xps/
description: Exempelkod för konvertering av xlsm till xps Python. Använd API exempelkod för batch-xlsm-filer till xps-konvertering i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLSM till XPS med Python" %}}

 För att konvertera XLSM till XPS kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLSM till XPS via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera XLSM-filer till XPS på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLSM-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utdatasökväg med XPS-tillägget som parameter1. Kontrollera den angivna sökvägen för den resulterande XPS-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera XLSM till XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xps" IsLandingPage="true" language="python" %}}
