---
title:  Buscar documento TXT sin abrir via .NET
weight: 8410
description: Código fuente C# para buscar palabras con patrón en el archivo TXT en .NET Framework, .NET Core, Mono o plataformas Xamarin.
