...
weight: 2040
description: .NET फ्रेमवर्क, .NET कोर, Mono या Xamarin प्लेटफार्मों पर पासवर्ड संरक्षित XLSX फ़ाइल को अनलॉक करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSX स्प्रेडशीट को C# के माध्यम से अनलॉक करें" h2=".NET लाइब्रेरी का उपयोग करके XLSX से सुरक्षा हटाएं।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके XLSX फ़ाइल को कैसे अनलॉक करें" %}}
 ...
 सुरक्षा XLSX फ़ाइल को निकालने के लिए, हम उपयोग करेंगे
