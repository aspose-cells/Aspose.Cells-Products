...
weight: 360
description: Группируйте и разгруппируйте объекты, используя Aspose.Cells' Python via .Net API без какого-либо программного обеспечения, такого как Microsoft или Open Office, Adobe PDF и т. д.
...
{{% blocks/products/pf/agp/content h2="Как группировать и разгруппировать фигуры в файле Excel с помощью Python via.Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по группировке и разгруппировке фигур в файле Excel с использованием Python via.Net" %}}
...
+ Выберите рабочий лист по его индексу.
 ...
 + Используйте[разгруппировать метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/ungroup/) чтобы разгруппировать фигуры на выбранном листе
