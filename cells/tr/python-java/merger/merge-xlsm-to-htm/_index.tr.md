...
Aşağıdaki örnek, XLSM'in Aspose.Cells for Python via Java'de HTM ile nasıl birleştirileceğini gösterir.
...
XLSM'i programlı olarak HTM ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
