---
title: C# HTML - XLT - Çevrimiçi HTML - XLT Dönüştürücü
description: Aspose excel. C# Aspose.Cells. C# Aspose Cells. Ücretsiz Çevrimiçi C# HTML'i XLT'e kaydet biçimine dönüştürün. C# HTML - XLT biçimi. HTML'i XLT C#'e kaydedin.
...
{{% blocks/products/pf/agp/content h2="HTML\'i C#\'de XLT\'e Kaydet Çevrimiçi Ücretsiz" %}}

Aşağıdaki örnek, C#'de HTML'in XLT'e nasıl dönüştürüleceğini gösterir.
{{% blocks/products/pf/agp/text %}}

HTML'i XLT'e dönüştürmek için kolay adımları izleyin. HTML dosyanızı yükleyin, ardından XLT dosyası olarak kaydedin. Hem HTML okuması hem de XLT yazması için tam nitelikli dosya adları kullanabilirsiniz. Çıktı XLT içeriği ve biçimlendirmesi orijinal HTML belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="HTML\'i Çevrimiçi Olarak XLT\'e Dönüştürmek İçin Ücretsiz Uygulama ve Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xlt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="HTML\'i C# aracılığıyla XLT\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

HTML dosyalarını programlı olarak XLT'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla HTML'i kolayca yükleyebilir ve XLT'e dönüştürebilir.
...
1.  HTML'in XLT'e dönüştürme sonucunu alın.
