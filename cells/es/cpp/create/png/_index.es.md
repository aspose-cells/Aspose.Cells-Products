...
description: Aspose Excel. C++ Cree un archivo PNG rápida y fácilmente con Aspose.Cells. Genere un archivo PNG usando C++. Cree PNG en C++. C++ PNG Creater.
...
1.  Guarde el libro como archivo .png usando el método Save().
