---
title: C# XLSX ke OTS - XLSX ke OTS Konverter
description: Aspose Unggul. Ubah XLSX menjadi OTS dengan cepat dan mudah dengan Aspose.Cells. C# XLSX menjadi OTS. C# Simpan XLSX ke OTS. Simpan XLSX sebagai OTS menggunakan C#.
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke OTS di C#" %}}

Contoh berikut menunjukkan cara mengonversi XLSX ke OTS di C#.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi XLSX ke OTS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ots" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert XLSX ke OTS lewat C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX ke OTS secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi XLSX ke OTS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan C# untuk mengkonversi XLSX ke OTS" %}}
