...
description: Aspose Excel。 Python Aspose.Cells. 将 JPG 合并为 EXCEL 保存格式。 Python 将JPG合并为EXCEL格式。将JPG合并为EXCEL Python.JPG合并。
...
{{% blocks/products/pf/agp/content h2="使用 Python 将 JPG 合并为 EXCEL" %}}

如何将 JPG 合并到 EXCEL？借助 Aspose.Cells for Python via .NET 库，您可以通过几行代码以编程方式轻松将 JPG 合并到 EXCEL。[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 Python Excel API 不仅可以在电子表格格式之间进行转换，还可以将 Excel 文件呈现为图像, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT等等，从而使其成为以行业标准交换文档的完美选择格式。您可以安装 Aspose.Cells for Python via .NET<a href="https://pypi.org/project/aspose-cells-python/">pypi</a>，使用命令为：<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="将JPG合并为EXCEL Python" %}}

下面的例子演示了如何将JPG合并到EXCEL中Aspose.Cells for Python via .NET。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 JPG 合并到 EXCEL。上传文件，调用Workbook.Combine方法合并文件，然后保存到EXCEL文件。如果您在 Python 中开发代码，这会比听起来更简单。请参阅 Python 将 JPG 合并到 EXCEL 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Python 中 JPG 合并为 EXCEL 的示例代码" InputFormat="jpg" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何将JPG合并为EXCEL通过Python" %}}
...
{{% blocks/products/pf/agp/content h2="Python 合并JPG到EXCEL的库" %}}
