...
{{% blocks/products/pf/agp/content h2="Sla XLSM op in JSON in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSM omzet naar JSON in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSM om naar JSON of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSM programmatisch converteren naar JSON? Ontwikkelaars van Java kunnen bestanden met de extensie XLSM eenvoudig converteren naar JSON met slechts een paar regels code.
