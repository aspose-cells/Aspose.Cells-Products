...
description: Aspose Эксель. Преобразуйте HTML в XLT быстро и легко с помощью Aspose.Cells. Python HTML в XLT. Python Сохранить HTML в XLT. Сохранить HTML как 07611134 81, используя Python.
...
{{% blocks/products/pf/agp/content h2="Преобразовать HTML в XLT в Python" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните с HTML по XLT в Python." %}}

В следующем примере показано, как преобразовать HTML в XLT в Python via NET.
...
{{% cells-convert title="Пример кода для преобразования HTML в XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xlt" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Библиотека Python для преобразования HTML в XLT" %}}
