---
title: Konversikan ODS ke DIF melalui Java 
weight: 6760
url: /id/java/conversion/ods-to-dif/ 
description: Contoh Java kode konversi untuk format ODS ke file DIF. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke DIF dalam Aplikasi berbasis Java Web atau Desktop apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan ODS ke DIF melalui Java" h2="ODS ke DIF Java konversi untuk mengonversi satu atau beberapa halaman ke DIF menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi ODS ke DIF Menggunakan Java" %}}

 Untuk merender ODS ke DIF, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi ODS ke DIF melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file ODS ke DIF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file ODS dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi DIF & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file DIF yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="ODS ke DIF Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file ODS dalam instance Workbook
Workbook book = new Workbook("template.ods");
// simpan ODS sebagai DIF
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi ODS ke DIF" sectionDescription="[Konversikan ODS ke DIF](https://products.aspose.app/cells/conversion/ods-to-dif) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file ODS Anda, itu akan langsung dikonversi ke DIF." >}}
