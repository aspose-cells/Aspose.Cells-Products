...
description: Aspose Excel。Python Excel。Aspose.Cells を使用して、XLS を XLT にすばやく簡単に変換します。Python XLS を XLT に変換します。Python XLS を XLT に保存します。Python Excel ライブラリを使用して、XLS を XLT として保存します。
