---
title:  Найти документ XLSB, не открывая via .NET.
weight: 8880
description: Исходный код C# для поиска слов по шаблону в файле XLSB на платформах .NET Framework, .NET Core, Mono или Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Поиск форматов XLSB в C#" h2="Собственный высокопроизводительный поиск документов XLSB с использованием серверных API Aspose.Cells for .NET без использования какого-либо программного обеспечения, такого как Microsoft или Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
