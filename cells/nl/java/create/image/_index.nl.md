...
description: Aspose Excel. Java Maak snel en eenvoudig een IMAGE-bestand met Aspose.Cells. Genereer een IMAGE-bestand met Java. Maak IMAGE aan in Java. Java IMAGE Creater.
...
{{< blocks/products/pf/i18n/upper-banner h1="Maak een IMAGE-bestand in Java" h2="Snelle Java-bibliotheek voor het maken van IMAGE-bestanden. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, PDF en vele andere formaten met behulp van Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een AFBEELDING kunt maken in Java" %}}
...
1.  Sla de werkmap op als IMAGE-indeling met behulp van de methode save().

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een IMAGE-bestand maakt in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om IMAGE-bestand te maken" %}}
{{% blocks/products/pf/agp/text %}}
