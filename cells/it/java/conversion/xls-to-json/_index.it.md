---
title: Java XLS a JSON - XLS a JSON Convertitore
description: Aspose Excel. Converti XLS in JSON in modo rapido e semplice con Aspose.Cells. Java XLS in JSON. Java Salva XLS in JSON. Salva XLS come 07611134 81 utilizzando lo Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converti XLS in JSON in Java" h2="Libreria Java ad alta velocità per convertire XLS in JSON. Si tratta di una soluzione software professionale per importare ed esportare XLS, JSON e molti altri formati utilizzando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salva da XLS a JSON in Java" %}}
...
È necessario convertire i file XLS in JSON a livello di codice? Gli sviluppatori Java possono convertire facilmente XLS in JSON in poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria Java per convertire XLS in JSON" %}}
{{% blocks/products/pf/agp/text %}}
