...
{{% blocks/products/pf/agp/content h2="XLSB fájlok keresése a következővel: Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az XLSB-fájlok kereséséhez itt: Java" %}}
...
+ XLSB-fájl betöltése munkafüzet-objektum példányosításával.
+ Nyissa meg az első munkalapot az XLSB fájlban.
...
{{% blocks/products/pf/agp/code-block title="XLSB fájlok keresése – Java" offSpacer="" %}}

```cs
// Munkafüzet objektum példányosítása
Workbook workbook = new Workbook(dataDir + "book1.xlsb");

// Az XLSB fájl első munkalapjának elérése
