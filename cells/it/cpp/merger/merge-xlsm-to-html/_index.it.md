---
title: Unisci XLSM a HTML - Combina XLSM a HTML in C++
url: /it/cpp/merger/merge-xlsm-to-html/ 
description: Aspose Excel. C++ Aspose.Cells. Unione online gratuita da XLSM a HTML saveformat. C++ Combina il formato XLSM con HTML. Unisci XLSM a HTML in C++. XLSM Unisci.
...
L'esempio seguente mostra come unire XLSM a HTML in Aspose.Cells for C++.
...
{{% cells-merger title="Online gratuito per unire XLSM a HTML in C++" InputFormat="xlsm" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Come unire XLSM a HTML tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire XLSM a HTML a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Le API possono essere eseguite con poche righe di codice.
