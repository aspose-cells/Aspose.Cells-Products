---
title: Gabung SXC ke DOCX - Gabungkan SXC ke DOCX di Java
url: /id/java/merger/merge-sxc-to-docx/ 
description: Aspose Unggul. Java Aspose.Cells. Free Online Merge SXC to DOCX saveformat. Java Gabungkan format SXC menjadi DOCX. Gabung SXC ke DOCX di Java. SXC Gabung.
...
Contoh berikut menunjukkan cara menggabungkan SXC ke DOCX di Aspose.Cells for Java.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan SXC ke DOCX di Java" InputFormat="sxc" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan SXC ke DOCX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan SXC menjadi DOCX secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
