...
description: Sample Java conversion code for NUMBERS format to XLTM file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to XLTM within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert NUMBERS to XLTM Using Java" %}}

 In order to render NUMBERS to XLTM, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert NUMBERS to XLTM via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="NUMBERS to XLTM Java Conversion Source Code" offSpacer="" %}}

```cs
// load the NUMBERS file in an instance of Workbook
Workbook book = new Workbook("template.numbers");
// save NUMBERS as XLTM
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS to XLTM Conversion Live Demos" sectionDescription="[Convert NUMBERS to XLTM](https://products.aspose.app/cells/conversion/numbers-to-xltm) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your NUMBERS file, it will be converted instantly to XLTM." >}}
