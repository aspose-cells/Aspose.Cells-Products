---
title: Python XLSX tot ODS - XLSX tot ODS Converter
description: Aspose Excel. Python Excel. Converteer XLSX snel en eenvoudig naar ODS met Aspose.Cells. Python XLSX naar ODS. Python Bewaar XLSX naar ODS. Bewaar XLSX als 076112 3481 met behulp van de Excel-bibliotheek Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLSX naar ODS in de Excel-bibliotheek Python" h2="Snelle Python Excel-bibliotheek voor het converteren van XLSX naar ODS. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSX, ODS en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% cells-convert title="Voorbeeldcode om XLSX naar ODS te converteren via de Excel-bibliotheek Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="ods" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLSX naar ODS kunt converteren via Python" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLSX-bestanden programmatisch naar ODS converteren? Python-ontwikkelaars kunnen XLSX eenvoudig in slechts een paar regels code laden en converteren naar ODS.
...
1.  Converteer XLSX naar ODS door de Workbook.save-methode aan te roepen.
1.  Verkrijg het conversieresultaat van XLSX naar ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Excel-bibliotheek om XLSX naar ODS te converteren" %}}
