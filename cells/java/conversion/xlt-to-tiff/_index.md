...
{{% blocks/products/pf/agp/content h2="How to Convert XLT to TIFF Using Java" %}}

 In order to render XLT to TIFF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XLT to TIFF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert XLT file to TIFF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="XLT to TIFF Java Conversion Source Code" offSpacer="" %}}
