---
title: Połącz JPG z XML - Połącz JPG z XML w C#
url: /pl/net/merger/merge-jpg-to-xml/ 
description: Aspose Excel. C# Aspose.Cells. Darmowe łączenie plików JPG do formatu zapisu XML online. C# Połącz JPG z formatem XML. Scal JPG do XML w C#. Scal JPG.
...
{{% blocks/products/pf/agp/content h2="Scal JPG do XML w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić JPG z XML w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić JPG z XML. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją do pliku XML. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który scala JPG z XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Darmowe online do scalania JPG do XML w C#" InputFormat="jpg" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić JPG do XML przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić JPG z XML? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do łączenia JPG z XML" %}}
