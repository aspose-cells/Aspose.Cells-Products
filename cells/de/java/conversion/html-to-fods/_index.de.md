...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie HTML mit Java in FODS" %}}

 Um HTML in FODS zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von HTML in FODS über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können HTML-Dateien in nur wenigen Codezeilen problemlos in FODS konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie eine HTML-Datei mit einer Instanz der Workbook-Klasse1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit der FODS-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende FODS-Datei
...
{{% blocks/products/pf/agp/code-block title="Konvertierungsquellcode von HTML zu FODS Java" offSpacer="" %}}

```cs
// Laden Sie die HTML-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.html");
// Speichern Sie HTML als FODS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Live-Demos für die HTML-zu-FODS-Konvertierung" sectionDescription="[Konvertieren Sie HTML in FODS](https://products.aspose.app/cells/conversion/html-to-fods) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API muss nicht heruntergeladen werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Es muss kein Code geschrieben werden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach Ihre HTML-Datei hoch, sie wird sofort in FODS konvertiert." >}}
