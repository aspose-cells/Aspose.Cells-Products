---
title: Python XLSX a MHT - Convertidor de XLSX a MHT
description: Aspose Excel. Convierta XLSX a MHT rápida y fácilmente con Aspose.Cells. Python XLSX a MHT. Python Guardar XLSX en MHT. Guarde XLSX como MHT usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde XLSX en MHT en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSX a MHT en Python via NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir XLSX a MHT. Cargue su archivo XLSX y luego simplemente guárdelo como archivo MHT. Tanto para la lectura de XLSX como para la escritura MHT, puede utilizar nombres de archivo completos. El contenido y el formato del MHT de salida serán idénticos al documento XLSX original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de muestra para convertir XLSX a MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="mht" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir XLSX a MHT" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos XLSX a MHT mediante programación? Los desarrolladores de Python pueden cargar y convertir fácilmente XLSX a MHT en solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSX a MHT" %}}
