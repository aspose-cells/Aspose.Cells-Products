...
description: Aspose Excel. Konvertieren Sie MHT schnell und einfach in XLSB mit Aspose.Cells. Python MHT in XLSB. Python Speichern Sie MHT in XLSB. Speichern Sie MHT als XLSB mit Python.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie MHT unter XLSB in Python" %}}
...
{{% cells-convert title="Beispielcode zum Konvertieren von MHT in XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xlsb" IsLandingPage="true" language="pythonnet" %}}
