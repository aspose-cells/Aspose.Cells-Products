---
title: C++ XLS から SPREADSHEETML - XLS から SPREADSHEETML コンバータ
description: Aspose エクセル。 Aspose.Cells を使用して、XLS を SPREADSHEETML にすばやく簡単に変換します。 C++ XLS を SPREADSHEETML に変換します。 C++ XLS を SPREADSHEETML に保存します。 C++ を使用して、XLS を SPREADSHEETML として保存します。
...
{{< blocks/products/pf/i18n/upper-banner h1="XLS を C++ の SPREADSHEETML に変換します" h2="Microsoft Excel、OpenOffice、または Adobe Acrobat のインストールを必要とせずに、C++ ライブラリを使用して XLS から SPREADSHEETML への高性能変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="XLS を C++ の SPREADSHEETML に保存" %}}
...
{{% cells-convert title="XLSをSPREADSHEETMLに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xml" IsLandingPage="true" language="cpp" %}}
