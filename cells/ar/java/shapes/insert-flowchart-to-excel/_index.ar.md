---
title: أدخل مخطط انسيابي في Excel via Java
weight: 360
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج مخطط انسيابي في ملف Excel باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج مخطط انسيابي في ملف Excel via Java" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة الإضافة](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) لإدراج مخطط انسيابي في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="أدخل مخطط انسيابي - Java" offSpacer="" %}}
