...
description: Aspose Unggul. Ubah OTS menjadi TSV dengan cepat dan mudah menggunakan Aspose.Cells. C++ OTS menjadi TSV. C++ Simpan OTS ke TSV. Simpan OTS sebagai TSV menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Ubah OTS menjadi TSV Menggunakan C++" %}}
...
Contoh berikut menunjukkan cara mengonversi OTS ke TSV di C++.
...
Perlu mengonversi file OTS ke TSV secara terprogram? Pengembang C++ dapat dengan mudah mengonversi OTS ke TSV hanya dalam beberapa baris kode.
...
1.  Ubah OTS menjadi TSV dengan memanggil metode Save().
1.  Dapatkan hasil konversi OTS menjadi TSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengubah OTS menjadi TSV" %}}
