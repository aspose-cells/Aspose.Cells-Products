...
url: /cs/python-net/merger/merge-xlsb-to-md/ 
...
Následující příklad ukazuje, jak sloučit XLSB do MD v Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit XLSB na MD programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
