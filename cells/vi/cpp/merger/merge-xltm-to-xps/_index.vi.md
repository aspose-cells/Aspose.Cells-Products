---
title: Gộp XLTM vào XPS - Gộp XLTM vào XPS vào C++
url: /vi/cpp/merger/merge-xltm-to-xps/ 
description: Aspose Excel. C++ Aspose.Cells. Hợp nhất XLTM thành XPS saveformat. C++ Kết hợp định dạng XLTM thành XPS. Hợp nhất XLTM thành XPS vào C++. XLTM Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XLTM thành XPS vào C++" %}}

Ví dụ sau đây minh họa cách hợp nhất XLTM với XPS trong Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất XLTM thành XPS. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp XPS. Nếu bạn phát triển mã bằng C++, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C++ hợp nhất XLTM thành XPS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp XLTM thành XPS trong C++" InputFormat="xltm" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp XLTM vào XPS qua C++" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện C++ gộp XLTM thành XPS" %}}
