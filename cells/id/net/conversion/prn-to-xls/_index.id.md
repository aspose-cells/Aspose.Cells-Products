---
title: C# PRN ke XLS - Konverter PRN ke XLS
description: Aspose Excel. Solusi komprehensif ini menyediakan C# pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi PRN ke format XLS, memungkinkan penyimpanan data PRN ke format XLS dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode C# yang efisien dan dapat disesuaikan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan PRN ke XLS di C#" h2="Pustaka berkecepatan tinggi C# untuk mengkonversi PRN ke XLS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor PRN, XLS, dan banyak format lainnya pada Framework .NET, Core .NET, atau Platform Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PRN" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://releases.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Konversikan PRN ke XLS menggunakan C#" %}}
 Bagaimana cara mengubah PRN menjadi XLS? Dengan pustaka Aspose.Cells for .NET, Anda dapat dengan mudah mengonversi PRN ke XLS secara terprogram dengan beberapa baris kode.[Aspose.Cells for .NET](https://products.aspose.com/cells/net) mampu membangun aplikasi lintas platform dengan kemampuan untuk menghasilkan, memodifikasi, mengkonversi, merender dan mencetak semua file Excel. .NET Excel API tidak hanya mengkonversi antar format spreadsheet, tetapi juga dapat merender file Excel sebagai gambar, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT dan banyak lagi, sehingga menjadikannya pilihan sempurna untuk bertukar dokumen dalam format standar industri. Membuka[NuGet](https://www.nuget.org/packages/aspose.cells)manajer paket, cari Aspose.Cells dan instal. Anda juga dapat menggunakan perintah berikut dari Package Manager Console.
...
{{% blocks/products/pf/agp/content h2="Simpan PRN ke XLS di C#" %}}

Contoh berikut menunjukkan cara mengkonversi PRN ke XLS di C#.
...
{{% blocks/products/pf/agp/content h2="Cara Convert PRN ke XLS lewat C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PRN ke XLS secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi PRN ke XLS hanya dalam beberapa baris kode.
...
1.  Konversikan PRN ke XLS dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi PRN menjadi XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# perpustakaan untuk mengkonversi PRN ke XLS" %}}
