...
{{% blocks/products/pf/agp/content h2="XLS konvertálása DIF-re a következővel: Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLS DIF-re konvertálásának lépései a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják az XLS fájlokat DIF formátumba.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLS-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Adja meg a kimeneti útvonalat DIF kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott DIF-fájl megadott elérési útját
