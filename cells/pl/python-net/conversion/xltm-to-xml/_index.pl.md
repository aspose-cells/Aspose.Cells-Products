...
description: Aspose Excel. Szybko i łatwo przekonwertuj XLTM na XML za pomocą Aspose.Cells. Python XLTM na XML. Python Zapisz XLTM w formacie XML. Zapisz XLTM jako XML, używając Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLTM w formacie XML w Python" %}}

Poniższy przykład ilustruje, jak przekonwertować XLTM na XML w Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji XLTM na XML" %}}
