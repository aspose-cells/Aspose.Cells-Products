---
title: Конвертер C# FODS в MD - FODS в MD
description: Aspose Эксель. Преобразуйте FODS в MD быстро и легко с помощью Aspose.Cells. C# FODS в MD. C# Сохраните FODS в MD. Сохраните FODS как MD, используя C#.
...
В следующем примере показано, как преобразовать FODS в MD в C#.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы преобразовать FODS в MD. Загрузите файл FODS, а затем просто сохраните его как файл MD. Как для чтения FODS, так и для записи MD вы можете использовать полные имена файлов. Содержимое и форматирование выходного MD будет идентично исходному документу FODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Пример кода для преобразования FODS в MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Как конвертировать FODS в MD через C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно конвертировать файлы FODS в MD? Разработчики .NET могут легко загрузить и преобразовать FODS в MD всего за несколько строк кода.
