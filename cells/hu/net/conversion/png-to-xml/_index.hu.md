...
{{% blocks/products/pf/agp/content h2="Mentse a PNG-et XML-be a C#-ben" %}}

következő példa bemutatja a PNG konvertálását XML-re a C#-ben.
...
{{% cells-convert title="Mintakód a PNG XML-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A PNG konvertálása XML-re a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

PNG fájlokat programozottan XML-re kell konvertálni? A .NET fejlesztők egyszerűen betölthetik és néhány sornyi kóddal XML-re konvertálhatják a PNG-et.
...
{{% blocks/products/pf/agp/content h2="C# könyvtár a PNG XML-re konvertálásához" %}}
