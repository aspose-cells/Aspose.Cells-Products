---
title: Gộp JPG sang MD - Gộp JPG sang MD theo số Java
url: /vi/java/merger/merge-jpg-to-md/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất định dạng lưu JPG sang MD. Java Kết hợp định dạng JPG sang MD. Hợp nhất JPG thành MD vào năm Java. Hợp nhất JPG.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất JPG thành MD vào Java" %}}

Ví dụ sau đây minh họa cách hợp nhất JPG thành MD trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất JPG với MD. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp và sau đó lưu nó vào tệp MD. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất JPG với MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu ghép JPG sang MD số Java" InputFormat="jpg" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách ghép JPG vào MD via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để ghép JPG sang MD" %}}
