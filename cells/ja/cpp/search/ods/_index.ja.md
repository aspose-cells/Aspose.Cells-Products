...
{{< blocks/products/pf/i18n/upper-banner h1="C++のODS形式を検索" h2="MicrosoftやAdobePDFなどのソフトウェアを使用せずに、サーバー側のAspose.Cells forC++APIを使用したネイティブで高性能なODSドキュメント検索。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++内のODSファイルを検索する手順" %}}
...
+IWorkbookクラスをインスタンス化してODSファイルをロードします。
...
+ IWorkbook-> Save（。）メソッドを使用してODSファイルを保存します。
...
{{% blocks/products/pf/agp/code-block title="ODSファイルの検索-C++" offSpacer="" %}}
