---
title: "SXC konvertálása TXT-re a következőn keresztül: Python"
url: /hu/python-java/conversion/sxc-to-txt/
description: Mintakód az sxc-ből txt-be Python konverzióhoz. Használjon API példakódot a kötegelt sxc fájlok txt konvertálásához a Python alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SXC konvertálása TXT-re a következőn keresztül: Python" h2="Exportáljon Excel® táblázatokat TXT formátumba Python API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása TXT-re a következővel: Python" %}}

 Az SXC TXT-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az SXC konvertálása TXT-re a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják az SXC fájlokat TXT formátumba.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az SXC-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal átadása TXT kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott TXT fájl megadott elérési útját
