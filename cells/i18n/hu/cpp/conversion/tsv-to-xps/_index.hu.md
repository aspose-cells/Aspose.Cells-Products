...
{{< blocks/products/pf/i18n/upper-banner h1="TSV konvertálása XPS-re a következőn keresztül: C++" h2="Nagy teljesítményű TSV konvertálás XPS-be a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztői könnyedén konvertálhatnak TSV-fájlt XPS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a TSV-fájlt a Factory::CreateIWorkbook használatával.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (XPS) fájlkiterjesztéssel.1. Az XPS fájl a megadott elérési útra kerül mentésre.1. Nyissa meg az XPS fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="TSV–XPS C++ konverziós forráskód" offSpacer="" %}}
