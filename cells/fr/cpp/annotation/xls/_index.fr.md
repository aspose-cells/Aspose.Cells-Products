---
title:  Ajouter ou supprimer une annotation de fichier Excel XLS via C++
weight: 10040
description: Exemple de code C++ pour ajouter et supprimer des annotations au format XLS sur l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour ajouter des commentaires au XLS via C++" %}}
