...
url: /hu/python-net/merger/merge-tabdelimited-to-ett/ 
description: Aspose Excel. Python Excel. TABDELIMITED egyesítése ETT mentési formátumba. Python TABDELIMITED kombinálása ETT formátumba. A TABDELIMITED egyesítése az ETT-vel a Python Excel-könyvtárban. TABDELIMITED Egyesítés.
...
{{% cells-merger title="Mintakód a TABDELIMITED ETT-be egyesítéséhez a Python Excel könyvtárban" InputFormat="tsv" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="A TABDELIMITED egyesítése az ETT-be a Python Excel könyvtáron keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a TABDELIMITED-et az ETT-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
