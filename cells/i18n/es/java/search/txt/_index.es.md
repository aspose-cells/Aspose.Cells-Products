---
title: Buscar documento TXT sin abrir a través de Java 
weight: 1200
url: /es/java/search/txt/ 
description: Java código de ejemplo para buscar palabras con patrón en un archivo TXT en Java entorno de tiempo de ejecución para aplicaciones de escritorio y aplicaciones JSP/JSF.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Buscar formatos TXT en Java" h2="Búsqueda de documentos TXT nativa y de alto rendimiento mediante API Aspose.Cells for Java del lado del servidor, sin el uso de ningún software como Microsoft o Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo buscar un archivo TXT usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para buscar archivos TXT en Java" %}}
...
+ Cargue el archivo TXT instanciando un objeto Workbook.
+ Accede a la primera hoja de trabajo en el archivo TXT.
...
{{% blocks/products/pf/agp/code-block title="Buscar archivos TXT - Java" offSpacer="" %}}

```cs
// Crear una instancia de un objeto Workbook
Workbook workbook = new Workbook(dataDir + "book1.txt");

// Acceso a la primera hoja de trabajo en el archivo TXT
