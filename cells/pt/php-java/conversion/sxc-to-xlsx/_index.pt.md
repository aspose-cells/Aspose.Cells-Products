---
title: Conversor PHP SXC para XLSX - SXC para XLSX
description: Aspose Excel. Converta SXC em XLSX de forma rápida e fácil com Aspose.Cells. PHP SXC em XLSX. PHP Salve SXC em XLSX. Salve SXC como XLSX usando PHP.
...
{{% cells-convert title="Exemplo de código para converter SXC em XLSX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="xlsx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Como converter SXC em XLSX via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em XLSX programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em XLSX em apenas algumas linhas de código.
...
1.  Converta SXC em XLSX chamando o método save da pasta de trabalho.
