...
{{% blocks/products/pf/agp/content h2="Sla FODS op in CSV in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar CSV in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar CSV of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar CSV? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar CSV met slechts een paar regels code.
