---
title: Buat XLAM - Buat file XLAM di Java
description: Aspose Excel. Hasilkan dan manipulasi file XLAM dengan mudah menggunakan pustaka Aspose.Cells for Java. Pustaka API yang canggih ini menyediakan solusi yang efisien dan mudah untuk membuat, mengedit, dan mengelola file XLAM langsung di dalam aplikasi Java Anda, memenuhi kebutuhan pengembang tertentu dengan presisi tinggi.
...
{{< blocks/products/pf/i18n/upper-banner h1="Buat File XLAM di Java" h2="Pustaka berkecepatan tinggi Java untuk membuat file XLAM. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLSX, PDF, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLAM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Membuat XLAM di Java" %}}
...
1.  Buat sebuah instance dari[Kelas buku kerja](https://reference.aspose.com/cells/java/com.aspose.cells/Workbook).
...
1.  Simpan buku kerja dalam format XLAM menggunakan metode save().

{{% blocks/products/pf/agp/code-block title="Kode contoh menunjukkan cara membuat file XLAM di Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk membuat file XLAM" %}}
{{% blocks/products/pf/agp/text %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Sebelum menjalankan kode sumber contoh konversi Java, pastikan Anda telah memenuhi prasyarat berikut.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/java/create/html/" name="HTML" description="Bahasa Markup Teks Hiper" >}} 
