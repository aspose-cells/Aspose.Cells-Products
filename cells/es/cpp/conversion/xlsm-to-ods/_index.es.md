---
title: Convierta XLSM a ODS a través de la aplicación C++ 
url: /es/cpp/conversion/xlsm-to-ods/ 
description: Ejemplo de código de conversión C++ para documento XLSM a formato ODS. Los programadores pueden usar este código fuente para la conversión por lotes de XLSM a ODS dentro de cualquier aplicación C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de C++ pueden convertir fácilmente un archivo XLSM a ODS con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLSM usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (ODS).1. El archivo ODS se guardará en la ruta especificada.1. Abra el archivo ODS en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de XLSM a ODS C++" offSpacer="" %}}
