---
title: دمج ODS إلى EMF - دمج ODS إلى EMF في C++
url: /ar/cpp/merger/merge-ods-to-emf/ 
description: Aspose اكسل. C++ Aspose.Cells. دمج ODS إلى EMF حفظ التنسيق. C++ قم بدمج تنسيق ODS إلى EMF. دمج ODS إلى EMF في C++. ODS دمج.
keywords: [Aspose Excel., C++ Aspose.Cells., Merge ODS to EMF in C++., C++ Merge ODS to emf., C++ Combine ODS to EMF., ODS Merge]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="دمج ODS الى EMF عبر C++" h2="مكتبة C++ عالية السرعة لدمج ODS إلى EMF. استخدم تحويل Excel API لتطوير برامج مستقلة عالية المستوى عن النظام الأساسي في C++. هذا حل برمجي احترافي لاستيراد وتصدير Excel, CSV, OpenOffice, PDF, HTML, image والعديد من تنسيقات Excel الأخرى." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="ODS" additionalConversionTag="EMF" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="دمج ODS إلى EMF في C++" %}}

يوضح المثال التالي كيفية دمج ODS إلى EMF في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج ODS إلى EMF. قم بتحميل ملفاتك، واتصل بطريقة Workbook.Combine لدمج الملفات، ثم احفظها في ملف EMF. إذا قمت بتطوير التعليمات البرمجية في C++، فسيكون هذا أبسط مما يبدو. راجع مثال C++ الذي يدمج ODS إلى EMF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="نموذج رمز لدمج ODS إلى EMF في C++" InputFormat="ods" InputFormat2="emf" outformat="emf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج ODS إلى EMF عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج ODS إلى EMF برمجياً؟ وثيقة أساسية دمج وتسلسل مع[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن إنشاء واجهات برمجة التطبيقات باستخدام بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C++ للدمج ODS الى EMF" %}}
