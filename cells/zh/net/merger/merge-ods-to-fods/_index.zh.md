...
description: Aspose Excel。 C# Aspose.Cells。将ODS合并到FODS保存格式。 C# 将 ODS 合并为 FODS 格式。将 ODS 合并到 C# 中的 FODS。 ODS 合并。
...
{{% blocks/products/pf/agp/content h2="将 ODS 合并到 C# 中的 FODS" %}}
...
{{% cells-merger title="将 ODS 合并到 C# 中的 FODS 的示例代码" InputFormat="ods" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
