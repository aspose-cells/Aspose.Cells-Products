...
description: Aspose Excel。 Python Excel。使用 Aspose.Cells 快速輕鬆地將 OTS 轉換為 PNG。Python OTS 為 PNG。Python 將 OTS 儲存為 PNG。Python 將 OTS 儲存為 PNG。Python 將 OTS 儲存為 PNG。
...
{{% blocks/products/pf/agp/content h2="將 Python Excel 庫中的 OTS 轉換為 PNG" %}}
...
{{% blocks/products/pf/agp/content h2="將 OTS 儲存到 Python Excel 庫中的 PNG" %}}

以下範例示範如何將 Python excel 庫中的 OTS 轉換為 PNG。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 OTS 轉換為 PNG。對於 OTS 讀取和 PNG 寫入，您可以使用完全限定的檔案名稱。輸出 PNG 內容和格式將與原始 OTS 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="透過 Python Excel 庫將 OTS 轉換為 PNG 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="png" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Python Excel 庫將 OTS 轉換為 PNG" %}}
