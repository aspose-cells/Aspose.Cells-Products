---
title: Sloučit TXT na MHT - Sloučit TXT na MHT v Java
url: /cs/java/merger/merge-txt-to-mht/ 
description: Aspose Excel. Java Aspose.Cells. Zdarma online sloučení TXT do formátu uložení MHT. Java Zkombinujte TXT do formátu MHT. Sloučit TXT na MHT v Java. TXT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit TXT do MHT pomocí Java" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit TXT na MHT v Java online zdarma" %}}

Následující příklad ukazuje, jak sloučit TXT do MHT v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení TXT s MHT. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru MHT. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí TXT do MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení TXT na MHT v Java" InputFormat="txt" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit TXT na MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit TXT na MHT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna ke sloučení TXT do MHT" %}}
