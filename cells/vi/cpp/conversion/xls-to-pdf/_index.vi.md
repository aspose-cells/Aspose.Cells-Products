---
title: C++ XLS thành PDF - Bộ chuyển đổi XLS thành PDF trực tuyến
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Trực tuyến miễn phí C++ Chuyển đổi XLS thành PDF định dạng lưu. C++ XLS đến PDF định dạng. Lưu XLS thành PDF C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLS thành PDF thành C++" h2="Chuyển đổi XLS sang PDF hiệu suất cao bằng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLS thành PDF trong C++ Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách chuyển đổi XLS thành PDF trong C++.
...
Cần chuyển đổi các tệp XLS thành PDF theo chương trình? C++ nhà phát triển có thể dễ dàng chuyển đổi XLS thành PDF chỉ bằng một vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="C++ thư viện để chuyển đổi XLS thành PDF" %}}
