...
description: Aspose Excel。 Python Aspose.Cells。將 SPREADSHEETML 合併到 XLAM 儲存格式。 Python 將 SPREADSHEETML 合併為 XLAM 格式。將 SPREADSHEETML 合併到 Python 中的 XLAM。SPREADSHEETML 合併。
...
{{< blocks/products/pf/i18n/upper-banner h1="透過 Python 將 SPREADSHEETML 合併到 XLAM" h2="高速 Python 庫，用於將 SPREADSHEETML 合併到 XLAM。使用我們的 Excel 轉換 API 在 Python 中開發高級、平台獨立的軟體。這是導入和匯出 076143 81 和許多其他專業解決方案的專業軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="SPREADSHEETML" additionalConversionTag="XLAM" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="使用 Python 將 SPREADSHEETML 合併到 XLAM" %}}
...
{{% blocks/products/pf/agp/content h2="將 SPREADSHEETML 合併到 Python 中的 XLAM" %}}

以下範例示範如何將 SPREADSHEETML 合併到 Aspose.Cells for Python via .NET 中的 XLAM。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 SPREADSHEETML 合併到 XLAM。上傳文件，呼叫 Workbook.Combine 方法合併文件，然後將其儲存到 XLAM 文件。如果您在 Python 中開發程式碼，這會比聽起來更簡單。請參閱 Python 將 SPREADSHEETML 合併到 XLAM 的範例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="將 SPREADSHEETML 合併到 Python 中的 XLAM 的範例程式碼" InputFormat="xml" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何透過 Python 將 SPREADSHEETML 合併到 XLAM" %}}
