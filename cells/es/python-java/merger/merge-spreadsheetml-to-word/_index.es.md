---
title: Combine SPREADSHEETML con WORD - Combine SPREADSHEETML con WORD en Python
url: /es/python-java/merger/merge-spreadsheetml-to-word/ 
description: AsposeExcel. Python Aspose.Cells. Combinación en línea gratuita de HOJA DE CÁLCULO a formato de guardado de WORD. Python Combine SPREADSHEETML con formato WORD. Combinar HOJA DE CALCULO con WORD en Python. Combinar HOJA DE CALCULO.
...
El siguiente ejemplo muestra cómo combinar SPREADSHEETML con WORD en Aspose.Cells for Python via Java.
...
{{% cells-merger title="Gratis en línea para combinar SPREADSHEETML con WORD en Python" InputFormat="xml" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar SPREADSHEETML a WORD a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar SPREADSHEETML con WORD mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Las API se pueden hacer con solo unas pocas líneas de código.
