---
title: Insert CheckBox(Form control) into Excel using Python via java 
weight: 30
...
{{% blocks/products/pf/agp/content h2="How to Insert CheckBox(Form control) into Excel File Using Python via java" %}}

 In order to insert CheckBox(Form control) into excel file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert CheckBox(Form control) to Excel file using Python via java" %}}
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addCheckBox(int,%20int,%20int,%20int,%20int,%20int)) to insert a CheckBox(Form control) in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert CheckBox(Form control) - Python via java" offSpacer="" %}}
