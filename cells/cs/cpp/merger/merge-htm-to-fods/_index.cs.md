...
url: /cs/cpp/merger/merge-htm-to-fods/ 
...
Následující příklad ukazuje, jak sloučit HTM s FODS v Aspose.Cells for C++.
...
Potřebujete sloučit HTM na FODS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení HTM s FODS" %}}
