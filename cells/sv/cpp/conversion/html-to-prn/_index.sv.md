...
description: Aspose Excel. Denna omfattande lösning ger C++-utvecklare en helt integrerad metod för att konvertera HTML till PRN-format, vilket möjliggör sömlös sparning av HTML-data till PRN-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C++-kod.
...
{{% blocks/products/pf/agp/content h2="Konvertera HTML till PRN med hjälp av C++" %}}
...
{{% blocks/products/pf/agp/content h2="Spara HTML till PRN i C++" %}}
...
Behöver du konvertera HTML-filer till PRN programmatiskt? C++-utvecklare kan enkelt konvertera HTML till PRN med bara några få rader kod.
...
1.  Konvertera HTML till PRN genom att anropa Save()-metoden.
