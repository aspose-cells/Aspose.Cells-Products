...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi JSON ke XLSB Menggunakan Java" %}}

 Untuk merender JSON ke XLSB, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi JSON ke XLSB melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file JSON ke XLSB hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Buat instance baru dari kelas Workbook1. Pilih default atau Lembar Kerja apa pun dari koleksi1. Muat data JSON dari file1. Buat instance JsonLayoutOptions & atur opsi1. Panggil metode JsonUtility.importData dengan mengacu pada Lembar Kerja & data1. Simpan Buku Kerja dalam format XLSB
...
{{% blocks/products/pf/agp/code-block title="JSON ke XLSB Java Kode Sumber Konversi" offSpacer="" %}}
...
// simpan file yang dihasilkan dalam format JSON-TO-XLSB
