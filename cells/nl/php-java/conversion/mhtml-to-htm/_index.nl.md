...
{{% blocks/products/pf/agp/content h2="Hoe converteer je MHTML naar HTML via PHP?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie MHTML programmatisch naar HTML converteren? PHP-ontwikkelaars kunnen bestanden met de extensie MHTML eenvoudig laden en converteren naar HTML met slechts een paar regels code.
