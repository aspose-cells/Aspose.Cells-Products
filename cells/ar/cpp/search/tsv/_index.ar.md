---
title:  ابحث عن مستند TSV بدون فتح عبر C++
weight: 930
description: C++ رمز المثال للبحث عن الكلمات ذات النمط في ملف TSV على C++ Runtime Environment لـ Windows 32 بت وWindows 64 بت ولينكس 64 بت.
...
+ قم بتحميل ملف TSV عن طريق إنشاء فئة Workbook.
...
+ احفظ ملف TSV باستخدام طريقة Workbook::Save(...).
