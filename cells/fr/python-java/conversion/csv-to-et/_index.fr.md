...
description: Aspose Exceller. Convertissez CSV en ET rapidement et facilement avec Aspose.Cells. Python CSV en ET. Python Enregistrez CSV dans ET. Enregistrez CSV sous ET en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Convertir CSV en ET en utilisant Python" %}}

 Comment puis-je convertir CSV en ET ? Avec la bibliothèque Aspose.Cells for Python, vous pouvez facilement convertir CSV en ET par programme avec quelques lignes de code.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. Python Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrer le CSV vers ET dans le Python" %}}

L'exemple suivant montre comment convertir CSV en ET dans Python.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir CSV en ET. Téléchargez votre fichier CSV, puis enregistrez-le simplement en tant que fichier ET. Pour la lecture CSV et l'écriture ET, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de l'ET de sortie seront identiques au document CSV original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir CSV en ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="et" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir CSV en ET via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers CSV en ET par programme ? Les développeurs Python peuvent facilement charger et convertir CSV en ET en quelques lignes de code seulement.
...
1.  Convertissez CSV en ET en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de CSV en ET.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour convertir CSV en ET" %}}
