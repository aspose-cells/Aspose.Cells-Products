---
title: Python SPREADSHEETML sang PRN - Trình chuyển đổi SPREADSHEETML sang PRN trực tuyến
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Trực tuyến miễn phí Python Chuyển đổi SPREADSHEETML sang định dạng lưu PRN. Python SPREADSHEETML sang định dạng PRN. Lưu SPREADSHEETML vào PRN Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển SPREADSHEETML sang PRN bằng Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu SPREADSHEETML vào PRN bằng Python Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách chuyển đổi SPREADSHEETML sang PRN trong Python.
...
Cần chuyển đổi các tệp SPREADSHEETML sang PRN theo chương trình? Python nhà phát triển có thể dễ dàng tải và chuyển đổi SPREADSHEETML sang PRN chỉ bằng một vài dòng mã.
...
1.  Chuyển SPREADSHEETML sang PRN bằng cách gọi phương thức Workbook.save.
1.  Nhận kết quả chuyển đổi từ SPREADSHEETML sang PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python thư viện để chuyển đổi SPREADSHEETML sang PRN" %}}
