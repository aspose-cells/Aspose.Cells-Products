---
title:  XLSB cuadro de documentos via Java
weight: 670
description: Código de muestra Java para dibujar y convertir gráficos o diagramas en un archivo XLSB en el entorno de ejecución Java para aplicaciones JSP/JSF y aplicaciones de escritorio.
...
{{% blocks/products/pf/agp/content h2="Cómo crear gráficos de archivos XLSB utilizando Java" %}}
