...
description: Aspose Excel. Μετατρέψτε το PNG στο ODS γρήγορα και εύκολα με το Aspose.Cells. C# PNG σε ODS. C# Αποθήκευση 076183419 ως 076183419 στο 076183419 στο 076183419 στο PNG. 113481 χρησιμοποιώντας C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή PNG σε ODS στο C#" h2="Βιβλιοθήκη υψηλής ταχύτητας C# για τη μετατροπή του PNG σε ODS. Αυτή είναι μια επαγγελματική λύση λογισμικού για εισαγωγή και εξαγωγή PNG, ODS και πολλών άλλων μορφών σε .NET Πλατφόρμα .NET Core363471, 871." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/content h2="Αποθήκευση PNG έως ODS στο C#" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε το PNG σε ODS στο C#.
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή PNG σε ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="ods" IsLandingPage="true" %}}
...
{{% blocks/products/pf/agp/content h2="C# βιβλιοθήκη για μετατροπή PNG σε ODS" %}}
