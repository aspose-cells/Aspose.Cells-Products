...
Besoin de convertir des fichiers JPG en XLSX par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en XLSX en quelques lignes de code.
...
1.  Convertissez le JPG au format XLSX en appelant la méthode Workbook.Save.
