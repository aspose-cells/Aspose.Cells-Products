...
1. โหลดไฟล์ที่ถูกล็อก XLS โดยใช้ CreateIWorkbook1. เรียกใช้ฟังก์ชัน Unprotect() เพื่อปลดล็อก1. ตั้งรหัสผ่านเป็น NULL โดยใช้ SetPassword1. บันทึกไฟล์ XLS ในตำแหน่งที่ระบุ
