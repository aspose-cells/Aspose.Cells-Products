---
title: C++ ČÍSLA na TXT - ČÍSLA na TXT Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C++ plně integrovaný přístup k převodu čísel NUMBERS do formátu TXT, což umožňuje bezproblémové ukládání dat NUMBERS do formátu TXT pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte ČÍSLA na TXT z C++" h2="Vysoce výkonný převod ČÍSEL na TXT s využitím knihovny C++ bez nutnosti instalace Excelu, OpenOffice nebo Adobe Acrobatu Microsoft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte si ČÍSLA na TXT v C++" %}}

Následující příklad ukazuje, jak převést ČÍSLA na TXT z C++.
...
Potřebujete programově převést soubory NUMBERS na TXT? Vývojáři s C++ mohou snadno převést soubory NUMBERS na TXT pomocí několika řádků kódu.
...
1.  Převeďte ČÍSLA na TXT voláním metody Save().
