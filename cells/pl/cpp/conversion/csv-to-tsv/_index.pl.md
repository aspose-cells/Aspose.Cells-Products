---
title: Konwertuj CSV na TSV za pomocą aplikacji C++ 
weight: 2940

description: Przykładowy kod konwersji C++ dla dokumentu CSV do formatu TSV. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji CSV na TSV w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować CSV na TSV za pomocą C++" %}}

 Aby przekonwertować CSV na TSV, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować CSV na TSV za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik CSV na TSV w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik CSV przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (TSV).1. Plik TSV zostanie zapisany pod określoną ścieżką.1. Otwórz plik TSV w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="CSV do TSV C++ Kod źródłowy konwersji" offSpacer="" %}}
