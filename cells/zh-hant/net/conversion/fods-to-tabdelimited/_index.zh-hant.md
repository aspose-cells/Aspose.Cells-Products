...
description: Aspose Excel。此綜合解決方案為 C# 開發人員提供了一種完全整合的方法，可將 FODS 轉換為 TABDELIMITED 格式，從而能夠使用 Aspose.Cells 庫將 FODS 數據保存為 TABDELIMITED 格式，所有這些程式庫將 FODS 資料保存為 TABDELIMITED 格式，所有這些程式碼可自訂的 07171717138171382193813939072。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 FODS 轉換為 C# 中的 TABDELIMITED" h2="高速 C# 庫，用於將 FODS 格式轉換為 TABDELIMITED 格式。這是一個專業的軟體解決方案，可在 .NET Framework、.NET Core 或 Mono 平台上匯入和匯出 FODS、TABDELIMITED 以及許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="將 FODS 儲存到 C# 中的 TABDELIMITED" %}}
...
1. 使用工作簿實例載入 FODS 檔案。
1. 呼叫 Workbook.Save 方法將 FODS 轉換為 TABDELIMITED。
