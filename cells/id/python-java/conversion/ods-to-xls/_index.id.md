...
description: Aspose Unggul. Ubah ODS menjadi XLS dengan cepat dan mudah dengan Aspose.Cells. Python ODS menjadi XLS. Python Simpan ODS menjadi XLS. Simpan ODS sebagai 07611134 81 menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Ubah ODS menjadi XLS Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan ODS hingga XLS di Python" %}}

Contoh berikut menunjukkan cara mengonversi ODS menjadi XLS di Python.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengubah ODS menjadi XLS" %}}
