---
title: Konverter PHP TXT hingga ODS - TXT hingga ODS
description: Aspose Unggul. Ubah TXT menjadi ODS dengan cepat dan mudah dengan Aspose.Cells. PHP TXT menjadi ODS. PHP Simpan TXT menjadi ODS. Simpan TXT sebagai ODS menggunakan PHP.
...
{{% blocks/products/pf/agp/content h2="Cara Mengubah TXT menjadi ODS melalui PHP" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file TXT ke ODS secara terprogram? Pengembang PHP dapat dengan mudah memuat & mengonversi TXT menjadi ODS hanya dalam beberapa baris kode.
...
1.  Ubah TXT menjadi ODS dengan memanggil metode simpan Buku Kerja.
1.  Dapatkan hasil konversi dari TXT menjadi ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Pustaka PHP untuk mengonversi TXT menjadi ODS" %}}
