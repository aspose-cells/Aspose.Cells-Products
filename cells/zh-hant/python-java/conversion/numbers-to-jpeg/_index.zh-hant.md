---
title: Python 數字到 JPEG - 數字到 JPEG 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 NUMBERS 轉換為 JPEG。將 Python NUMBERS 轉換為 JPEG。Python 將 NUMBERS 儲存為 JPEG863481 將 NUMBERS 儲存為 JPEG863481 。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 Python 中的 NUMBERS 轉換為 JPEG" h2="用於將數字轉換為 JPEG 的高速 Python 庫。這是一個使用 Python 導入和導出數字、JPEG 和許多其他格式的專業軟體解決方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
如何將 NUMBERS 轉換為 JPEG？借助 Aspose.Cells for Python 庫，您可以透過幾行程式碼以程式設計方式輕鬆將 NUMBERS 轉換為 JPEG。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Python Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="將號碼儲存到 Python 中的 JPEG" %}}

以下範例示範如何將 Python 中的 NUMBERS 轉換為 JPEG。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 NUMBERS 轉換為 JPEG。上傳您的 NUMBERS 文件，然後只需將其另存為 JPEG 文件。對於 NUMBERS 讀取和 JPEG 寫入，您可以使用完全限定的檔案名稱。輸出 JPEG 內容和格式將與原始 NUMBERS 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將數字轉換為 JPEG 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="jpg" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何透過 Python 將數字轉換為 JPEG" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 NUMBERS 檔案轉換為 JPEG？ Python 開發人員只需幾行程式碼即可輕鬆載入 NUMBERS 並將其轉換為 JPEG。
...
1. 透過呼叫 Workbook.save 方法將 NUMBERS 轉換為 JPEG。
1. 取得NUMBERS到JPEG的轉換結果。
