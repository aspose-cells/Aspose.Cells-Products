...
Potřebujete převést HTML soubory do POWERPOINT programově? Java vývojáři mohou snadno převést HTML na POWERPOINT v několika řádcích kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovnu pro převod HTML na POWERPOINT" %}}
{{% blocks/products/pf/agp/text %}}
