---
title: XLAM oluştur - Java'de XLAM dosyası oluştur
description: Aspose excel. Java XLAM Dosyası Oluştur. Oluştur XLAM Java. Java XLAM Oluşturan. Java'de XLAM oluşturun. Java'i kullanarak XLAM dosyasını oluşturun.
...
{{% blocks/products/pf/agp/content h2="Java\'de XLAM Nasıl Oluşturulur" %}}
...
1.  Çalışma kitabını save() yöntemini kullanarak XLAM biçiminde kaydedin.

{{% blocks/products/pf/agp/code-block title="Örnek kod, Java\'de XLAM dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="XLAM dosyası oluşturmak için Java kitaplığı" %}}
{{% blocks/products/pf/agp/text %}}
