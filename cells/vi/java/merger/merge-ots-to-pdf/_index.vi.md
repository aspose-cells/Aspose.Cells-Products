---
title: Gộp OTS thành PDF - Gộp OTS thành PDF trong Java
url: /vi/java/merger/merge-ots-to-pdf/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất trực tuyến miễn phí OTS thành PDF định dạng lưu. Java Kết hợp định dạng OTS thành PDF. Hợp nhất OTS thành PDF trong Java. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất OTS với PDF trong Java Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất OTS thành PDF trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất OTS thành PDF. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất tệp, sau đó lưu vào tệp PDF. Nếu bạn phát triển mã trong Java, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ Java hợp nhất OTS thành PDF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất OTS thành PDF trong Java" InputFormat="ots" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất OTS thành PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất OTS với PDF theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện Java để hợp nhất OTS thành PDF" %}}
