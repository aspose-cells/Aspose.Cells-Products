---
title: قم بإدراج / إنشاء مخطط انسيابي في Excel باستخدام Python via Java
weight: 371
description: Python via Java التعليمات البرمجية المصدر لإدراج / إنشاء مخطط انسيابي في Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="قم بإدراج / إنشاء مخطط انسيابي في Excel باستخدام Python via Java" h2="قم بإدراج / إنشاء مخطط انسيابي باستخدام Aspose.Cells \'API بدون أي برنامج مثل Microsoft أو Open Office ، Adobe PDF ، إلخ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج / إنشاء مخطط انسيابي إلى ملف Excel باستخدام Python via Java" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة الإضافة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) لإدراج / إنشاء مخطط انسيابي في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="قم بإدراج / إنشاء مخطط انسيابي - Python via Java" offSpacer="" %}}
