---
title: Převeďte TXT na XLSM pomocí aplikace C++ 
url: /cs/cpp/conversion/txt-to-xlsm/ 
description: Ukázkový konverzní kód C++ pro dokument TXT na formát XLSM. Programátoři mohou použít tento zdrojový kód pro dávkový převod TXT na XLSM v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést TXT na XLSM pomocí C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod TXT na XLSM přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor TXT na XLSM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TXT pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu k výstupnímu souboru s příponou (XLSM).1. Soubor XLSM bude uložen do zadané cesty.1. Otevřete soubor XLSM v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu TXT na XLSM C++" offSpacer="" %}}
