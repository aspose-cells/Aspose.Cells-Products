...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file XLSM ke DIF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLSM menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file output dengan ekstensi file (DIF).1. File DIF akan disimpan di jalur yang ditentukan.1. Buka file DIF di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLSM ke DIF C++ Kode Sumber Konversi" offSpacer="" %}}
