...
{{% blocks/products/pf/agp/content h2="Převést XLAM na WORD na Python" %}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete XLAM až WORD v Python online zdarma" %}}

Následující příklad ukazuje, jak převést XLAM na WORD v Python via NET.
...
{{% blocks/products/pf/agp/content h2="Knihovna Python pro převod XLAM na WORD" %}}
