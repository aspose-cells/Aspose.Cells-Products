---
title: Convertir XLSB en JSON via Java 
weight: 9970
url: /fr/java/conversion/xlsb-to-json/ 
description: Exemple de code de conversion Java pour le format XLSB en fichier JSON. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice vers JSON dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSB en JSON via Java" h2="Conversion XLSB en JSON Java pour convertir une ou plusieurs pages en JSON à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en JSON en utilisant Java" %}}

 Afin de rendre XLSB en JSON, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir XLSB en JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier XLSB en JSON en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier XLSB avec une instance de la classe Workbook1. Créez une plage de données à exporter à l'aide de la méthode Cells.createRange1. Appelez la méthode JsonUtility.exportRangeToJson avec des références de Range & ExportRangeToJsonOptions1. Écrire les données String JSON dans le fichier via la méthode BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion XLSB vers JSON Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion XLSB vers JSON" sectionDescription="[Convertir XLSB en JSON](https://products.aspose.app/cells/conversion/xlsb-to-json) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier XLSB, il sera converti instantanément en JSON." >}}
