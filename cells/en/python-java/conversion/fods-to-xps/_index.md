...
Follow the easy steps to convert FODS into XPS. Upload your FODS file, then simply save it as XPS file. For both FODS reading and XPS writing you can use fully qualified filenames. The output XPS content and formatting will be identical to the original FODS document.
