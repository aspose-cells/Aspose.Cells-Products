...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل FODS إلى XPS عبر Java" h2="تحويل FODS إلى XPS Java لتحويل صفحات مفردة أو متعددة إلى XPS باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل FODS إلى XPS باستخدام Java" %}}

 من أجل تقديم FODS إلى XPS ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل FODS إلى XPS عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java تحويل ملف FODS إلى XPS بسهولة في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف FODS بنسخة من فئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد XPS & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف XPS الناتج
...
{{% blocks/products/pf/agp/code-block title="FODS إلى شفرة مصدر تحويل XPS Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل FODS إلى XPS" sectionDescription="[تحويل FODS إلى XPS](https://products.aspose.app/cells/conversion/fods-to-xps) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف FODS الخاص بك ، وسيتم تحويله على الفور إلى XPS." >}}
