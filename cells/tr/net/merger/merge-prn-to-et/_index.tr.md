---
title: PRN'yi ET ile birleştir - C#'de PRN'yi ET ile birleştir
url: /tr/net/merger/merge-prn-to-et/ 
description: Aspose excel. C# Aspose.Cells. Ücretsiz Çevrimiçi PRN'yi ET kaydetme biçimine birleştirme. C# PRN'yi ET formatına birleştirin. C#'de PRN'yi ET ile birleştirin. PRN Birleştirin.
...
{{% blocks/products/pf/agp/content h2="C#\'de PRN ile ET\'yi Çevrimiçi Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de PRN'nin ET ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

PRN'yi ET'ye birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından ET dosyasına kaydedin. C#'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. PRN ile ET'yi birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C#\'de PRN ile ET\'yi Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="prn" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="C# aracılığıyla PRN ile ET\'yi Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 PRN'yi ET'ye programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
