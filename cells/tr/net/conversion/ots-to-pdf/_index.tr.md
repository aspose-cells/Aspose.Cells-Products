---
title: C# OTS'den PDF'e - Çevrimiçi OTS'den PDF'e Dönüştürücü
description: Aspose excel. C# Aspose.Cells. C# Aspose Cells. Ücretsiz Çevrimiçi C# OTS'yi PDF saveformat'a dönüştürün. C# OTS'den PDF formatına. OTS'yi PDF C#'e kaydedin.
...
{{% blocks/products/pf/agp/content h2="OTS\'yi C# içinde PDF\'e Çevrimiçi olarak Ücretsiz olarak kaydedin" %}}

Aşağıdaki örnek, OTS'nin C#'de PDF'e nasıl dönüştürüleceğini gösterir.
{{% blocks/products/pf/agp/text %}}

OTS'yi PDF'e dönüştürmek için kolay adımları izleyin. OTS dosyanızı yükleyin, ardından PDF dosyası olarak kaydedin. Hem OTS okuması hem de PDF yazması için tam nitelikli dosya adlarını kullanabilirsiniz. Çıktı PDF içeriği ve biçimlendirmesi, orijinal OTS belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="OTS\'yi Çevrimiçi PDF\'e Dönüştürmek için Ücretsiz Uygulama ve Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="pdf" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="OTS\'yi C# aracılığıyla PDF\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

OTS dosyalarını programlı olarak PDF'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, OTS'yi yalnızca birkaç satır kodla kolayca yükleyebilir ve PDF'e dönüştürebilir.
...
1.  OTS'nin PDF'e dönüştürme sonucunu alın.
