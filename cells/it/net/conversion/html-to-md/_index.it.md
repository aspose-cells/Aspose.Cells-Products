---
title: Convertitore da C# a MD - da HTML a MD
description: Aspose Excel. Questa soluzione completa fornisce agli sviluppatori C# un approccio completamente integrato per convertire HTML in formato MD, consentendo il salvataggio senza interruzioni dei dati HTML in formato MD utilizzando la libreria Aspose.Cells, il tutto tramite codice C# efficiente e personalizzabile.
...
{{% blocks/products/pf/agp/content h2="Salva HTML in MD in C#" %}}

L'esempio seguente mostra come convertire HTML in MD in C#.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per convertire HTML in MD. Carica il tuo file HTML e salvalo come file MD. Sia per la lettura del file HTML che per la scrittura del file MD puoi utilizzare nomi di file completi. Il contenuto e la formattazione del file MD di output saranno identici al documento originale HTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Codice di esempio per convertire HTML in MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="html" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Come convertire HTML in MD tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di convertire i file HTML in MD tramite codice? Gli sviluppatori .NET possono caricare e convertire facilmente i file HTML in MD in poche righe di codice.
...
1.  Ottieni il risultato della conversione da HTML a MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria C# per convertire HTML in MD" %}}
