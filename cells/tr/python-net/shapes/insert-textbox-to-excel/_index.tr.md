---
title:  Python via .Net kullanarak TextBox'u Excel'e ekleyin
weight: 10
description: Python via .Net kaynak kodu, TextBox'u Excel'e eklemek için.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python via .Net kullanarak TextBox\'u Excel\'e ekleyin" h2="Aspose.Cells\' API kullanarak, Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım olmadan TextBox ekleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via .Net Kullanarak TextBox\'u Excel Dosyasına Ekleme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .Net kullanarak TextBox\'ı Excel dosyasına ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfası'nı seçin.
 + Shapecollection'ın eklentisini kullanın[yöntem](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_text_box/#int-int-int-int-int-int) seçili çalışma sayfasına bir Metin Kutusu eklemek için.
...
{{% blocks/products/pf/agp/code-block title="Metin Kutusu Ekle - Python via .Net" offSpacer="" %}}
