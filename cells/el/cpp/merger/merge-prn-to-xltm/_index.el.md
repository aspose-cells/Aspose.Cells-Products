---
title:  Συγχώνευση PRN στο XLTM μέσω C++
url: /el/cpp/merger/merge-prn-to-xltm/ 
description: Συγχώνευση PRN στο XLTM Online δωρεάν. Δωρεάν online PRN to XLTM Merger. Συγχώνευση PRN σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το PRN στο XLTM στο C++.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση του PRN με το XLTM σε απευθείας σύνδεση" InputFormat="prn" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
