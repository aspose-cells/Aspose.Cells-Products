---
title: C# FODS 轉 CSV - 在線 FODS 轉 CSV 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 FODS 轉換為 CSV 保存格式。 C# FODS 到 CSV 格式。將 FODS 保存為 CSV C#。
...
{{% blocks/products/pf/agp/content h2="免費在線保存 FODS 至 CSV 於 C#" %}}
...
{{% cells-convert title="免費應用程序和示例代碼可在線將 FODS 轉換為 CSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="csv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 FODS 轉換為 CSV" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 FODS 文件轉換為 CSV 嗎？ .NET 開發人員只需幾行代碼即可輕鬆加載和轉換 FODS 到 CSV。
