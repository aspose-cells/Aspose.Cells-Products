...
description: Aspose Excel. Konwertuj XML na XLAM szybko i łatwo za pomocą Aspose.Cells. Java XML na XLAM. Java Zapisz XML na XLAM. Zapisz XML jako XLAM używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML pod numerem XLAM w Java" %}}

Poniższy przykład ilustruje, jak przekonwertować kod XML na XLAM w Java.
...
Chcesz programowo przekonwertować pliki XML na XLAM? Programiści Java mogą łatwo przekonwertować XML na XLAM w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji XML na XLAM" %}}
{{% blocks/products/pf/agp/text %}}
