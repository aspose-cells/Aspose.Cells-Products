...
{{% blocks/products/pf/agp/content h2="Jak převést TSV na MHTML pomocí Java" %}}

 K vykreslení TSV do MHTML použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TSV na MHTML prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor TSV na MHTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TSV s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením MHTML a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor MHTML
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze TSV na MHTML Java" offSpacer="" %}}

```cs
// načíst soubor TSV v instanci sešitu
Workbook book = new Workbook("template.tsv");
// uložit TSV jako MHTML
