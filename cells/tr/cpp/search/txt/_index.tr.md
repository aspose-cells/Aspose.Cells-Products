---
title:  TXT belgesini C++ üzerinden açmadan ara
weight: 5090
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Çalışma Zamanı Ortamı'ndaki TXT dosyasındaki desenli kelimeleri aramak için örnek kod.
...
+ Bir Çalışma Kitabı sınıfını başlatarak TXT dosyasını yükleyin.
...
+ Workbook::Save(...) yöntemini kullanarak TXT dosyasını kaydedin.
