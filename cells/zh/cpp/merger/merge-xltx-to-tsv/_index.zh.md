---
title: 合并 XLTX 至 TSV - 将 XLTX 至 TSV 合并为 C++
url: /zh/cpp/merger/merge-xltx-to-tsv/ 
description: Aspose Excel。 C++ Aspose.Cells。免费在线合并XLTX到TSV保存格式。 C++ 将 XLTX 合并为 TSV 格式。将 XLTX 合并到 C++ 中的 TSV。 XLTX 合并。
...
{{% blocks/products/pf/agp/content h2="免费在线将 XLTX 合并为 C++ 中的 TSV" %}}

以下示例演示如何将 XLTX 合并到 Aspose.Cells for C++ 中的 TSV。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 XLTX 合并到 TSV。上传文件，调用 Workbook.Combine 方法合并文件，然后将其保存到 TSV 文件。如果您在 C++ 中开发代码，这会比听起来更简单。请参阅将 XLTX 合并到 TSV 的 C++ 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免费在线将 XLTX 合并到 C++ 中的 TSV" InputFormat="xltx" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C++ 将 XLTX 合并到 TSV" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLTX 合并到 TSV 吗？基本文档合并和连接[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2="C++库将XLTX合并到TSV" %}}
