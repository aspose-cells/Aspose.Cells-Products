...
{{% blocks/products/pf/agp/content h2="Folyamatábra beszúrása/létrehozása Excel-fájlba a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Folyamatábra Excel-fájl beszúrásának/létrehozásának lépései a C# számon keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="Folyamatábra beszúrása/készítése - C#" offSpacer="" %}}
