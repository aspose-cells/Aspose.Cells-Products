---
title: XLSX을 NUMBERS에 병합 - XLSX을 C++의 NUMBERS에 결합
url: /ko/cpp/merger/merge-xlsx-to-numbers/ 
description: Aspose 엑셀. C++ Aspose.Cells. 무료 온라인 XLSX을 NUMBERS saveformat에 병합합니다. C++ XLSX을 NUMBERS 형식으로 결합합니다. XLSX을 C++의 NUMBERS에 병합합니다. XLSX 병합합니다.
...
다음 예는 XLSX을 Aspose.Cells for C++의 NUMBERS에 병합하는 방법을 보여줍니다.
...
{{% cells-merger title="XLSX을 C++의 NUMBERS에 병합하는 무료 온라인" InputFormat="xlsx" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="C++을 통해 XLSX을 NUMBERS에 병합하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

 프로그래밍 방식으로 XLSX을 NUMBERS에 병합해야 합니까? 병합 및 연결하는 기본 문서[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) 몇 줄의 코드만으로 API를 수행할 수 있습니다.
