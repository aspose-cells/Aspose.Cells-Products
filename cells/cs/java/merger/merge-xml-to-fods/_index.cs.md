---
title: Sloučit XML s FODS – Zkombinovat XML s FODS v Java
url: /cs/java/merger/merge-xml-to-fods/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit XML do formátu uložení FODS. Java Zkombinujte XML do formátu FODS. Sloučit XML na FODS v Java. Sloučit XML.
...
{{% blocks/products/pf/agp/content h2="Sloučit XML na FODS v Java" %}}

Následující příklad ukazuje, jak sloučit XML do FODS v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XML do FODS. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru FODS. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí XML do FODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení XML do FODS v Java" InputFormat="xml" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XML na FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově sloučit XML s FODS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java pro sloučení XML do FODS" %}}
