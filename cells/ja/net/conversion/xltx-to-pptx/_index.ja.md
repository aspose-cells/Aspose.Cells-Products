...
{{< blocks/products/pf/i18n/upper-banner h1="C# で XLTX を PPTX に変換します" h2="XLTX を PPTX に変換するための高速 C# ライブラリ。これは、.NET Framework、.NET Core、または Mono プラットフォームで XLTX、PPTX、およびその他の多くの形式をインポートおよびエクスポートするための専門的なソフトウェア ソリューションです。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% cells-convert title="XLTX を PPTX に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xltx" outformat="pptx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C# 経由で XLTX を PPTX に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

プログラムで XLTX ファイルを PPTX に変換する必要がありますか? .NET 開発者は、わずか数行のコードで XLTX を簡単にロードして PPTX に変換できます。
