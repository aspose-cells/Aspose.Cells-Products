...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 Excel 파일에 블록 화살표를 삽입하는 방법" %}}
...
+ 색인을 통해 워크시트를 선택합니다.
 +[메소드 추가](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) 선택한 워크시트에 블록 화살표를 삽입하려면
