...
{{% blocks/products/pf/agp/code-block title="NUMBERS to XLSM Java Conversion Source Code" offSpacer="" %}}

```cs
// load the NUMBERS file in an instance of Workbook
Workbook book = new Workbook("template.numbers");
// save NUMBERS as XLSM
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS to XLSM Conversion Live Demos" sectionDescription="[Convert NUMBERS to XLSM](https://products.aspose.app/cells/conversion/numbers-to-xlsm) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your NUMBERS file, it will be converted instantly to XLSM." >}}
