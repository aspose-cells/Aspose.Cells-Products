---
title: HTM egyesítése a PDF számmal – HTM összevonása PDF számmal a Java-ben
url: /hu/java/merger/merge-htm-to-pdf/ 
description: Aspose Excel. Java Aspose.Cells. HTM egyesítése a PDF mentési formátummal. Java HTM kombinálása PDF formátummal. HTM egyesítése a PDF-es számmal a Java-ben. HTM-egyesítés.
...
{{% blocks/products/pf/agp/content h2="A HTM egyesítése a PDF számmal a Java-ben" %}}

A következő példa bemutatja, hogyan egyesítheti a HTM-et a PDF-es számmal a Aspose.Cells for Java-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a HTM és a PDF egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a PDF fájlba. Ha kódot fejleszt a Java-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Java-es példát, amely egyesíti a HTM-et a PDF-gyel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a HTM-nek a PDF-es számmal való egyesítéséhez a Java-ben" InputFormat="htm" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A HTM egyesítése a PDF via Java számmal" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a HTM-et a PDF-es számmal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Java](https://products.aspose.com/cells/java) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Java könyvtár a HTM és a PDF egyesítéséhez" %}}
