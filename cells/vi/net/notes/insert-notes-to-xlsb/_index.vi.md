...
Trong Office 365, ghi chú dành cho chú thích, bạn có thể sử dụng mã C# sau để chèn và xóa ghi chú trong tệp XLSB.

{{% blocks/products/pf/agp/code-block title="Mã mẫu C# để Chèn và xóa ghi chú trong tệp XLSB" offSpacer="" %}}
