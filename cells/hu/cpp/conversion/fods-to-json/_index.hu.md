...
{{< blocks/products/pf/i18n/upper-banner h1="FODS konvertálása JSON-ra a következőn keresztül: C++" h2="Nagy teljesítményű FODS konvertálás JSON-ba a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="FODS konvertálása JSON-ba a következővel: C++" %}}
 ...
 A FODS JSON-ba konvertálásához használjuk
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztői könnyedén konvertálhatják a FODS-fájlt JSON-formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a FODS fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (JSON) fájlkiterjesztéssel.1. A JSON-fájl a megadott elérési útra kerül mentésre.1. Nyissa meg a JSON fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="FODS JSON C++ konverziós forráskód" offSpacer="" %}}
