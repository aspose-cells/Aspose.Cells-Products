...
{{% cells-convert title="Código de muestra para convertir XML a XLAM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xlam" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir XML a XLAM a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos XML a XLAM mediante programación? Los desarrolladores de C++ pueden convertir fácilmente XML a XLAM en tan solo unas pocas líneas de código.
...
1.  Convierta XML a XLAM llamando al método Save().
