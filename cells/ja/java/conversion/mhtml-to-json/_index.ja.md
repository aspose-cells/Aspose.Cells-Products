---
title: Javaを介してMHTMLをJSONに変換する 
weight: 4770
url: /ja/java/conversion/mhtml-to-json/ 
description: MHTML形式からJSONファイルへのサンプルJava変換コード。プログラマーは、このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でExcelおよびOpenOfficeスプレッドシートをJSONにエクスポートできます。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Javaを介してMHTMLをJSONに変換する" h2="オンプレミスJavaライブラリを使用して単一または複数のページをJSONに変換するためのMHTMLからJSONJavaへの変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してMHTMLをJSONに変換する方法" %}}

 MHTMLをJSONにレンダリングするために、
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介してMHTMLをJSONに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Java開発者は、わずか数行のコードでMHTMLファイルをJSONに簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Workbookクラスのインスタンスを含むMHTMLファイルをロードします1. Cells.createRangeメソッドを使用してエクスポートするデータの範囲を作成します1. RangeとExportRangeToJsonOptionsを参照して、JsonUtility.exportRangeToJsonメソッドを呼び出します。1. BufferedWriter.writeメソッドを介して文字列JSONデータをファイルに書き込みます
...
{{% blocks/products/pf/agp/code-block title="MHTMLからJSONJavaへの変換ソースコード" offSpacer="" %}}
