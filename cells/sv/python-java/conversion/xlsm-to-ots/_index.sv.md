...
description: Aspose Excel. Konvertera XLSM till OTS snabbt och enkelt med Aspose.Cells. Python XLSM till OTS. Python Spara XLSM till OTS. Spara XLSM som OTS med Python.
...
{{% blocks/products/pf/agp/content h2="Konvertera XLSM till OTS med Python" %}}
...
{{% blocks/products/pf/agp/content h2="Spara XLSM till OTS på Python" %}}

Följande exempel visar hur man konverterar XLSM till OTS i Python.
...
{{% blocks/products/pf/agp/content h2="Python bibliotek för att konvertera XLSM till OTS" %}}
