...
Postupujte podle jednoduchých kroků pro sloučení XLT do SPREADSHEETML. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru SPREADSHEETML. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí XLT do SPREADSHEETML.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit XLT do SPREADSHEETML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ ke sloučení XLT do SPREADSHEETML" %}}
