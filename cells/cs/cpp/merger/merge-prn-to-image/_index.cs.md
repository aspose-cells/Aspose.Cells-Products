---
title: Sloučit PRN s IMAGE – Zkombinujte PRN s IMAGE v C++
url: /cs/cpp/merger/merge-prn-to-image/ 
description: Aspose Excel. C++ Aspose.Cells. Sloučit PRN do formátu uložení IMAGE. C++ Zkombinujte PRN s formátem IMAGE. Sloučit PRN do IMAGE v C++. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN s IMAGE v C++" %}}

Následující příklad ukazuje, jak sloučit PRN do IMAGE v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN s IMAGE. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru IMAGE. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí PRN do IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení PRN do IMAGE v C++" InputFormat="prn" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN s IMAGE přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově sloučit PRN s IMAGE? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovnu pro sloučení PRN do IMAGE" %}}
