---
title:  ODS belgesini C++ üzerinden açmadan ara
weight: 3300
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Çalışma Zamanı Ortamı'ndaki ODS dosyasındaki desenli kelimeleri aramak için örnek kod.
...
{{% blocks/products/pf/agp/feature-section-col title="ODS Dosyalarını C++\'de Arama Adımları" %}}
...
+ Bir Çalışma Kitabı sınıfını başlatarak ODS dosyasını yükleyin.
...
+ Workbook::Save(...) yöntemini kullanarak ODS dosyasını kaydedin.
...
{{% blocks/products/pf/agp/code-block title="ODS Dosyalarını Ara - C++" offSpacer="" %}}
