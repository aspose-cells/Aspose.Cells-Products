...
{{% blocks/products/pf/agp/text %}}
 ...
 Είναι εύκολο για τους προγραμματιστές να δημιουργούν, να φορτώνουν, να τροποποιούν και να μετατρέπουν αρχεία XML σε εφαρμογές αναφοράς που εκτελούνται για επεξεργασία δεδομένων σε λίγες μόνο γραμμές κώδικα.
