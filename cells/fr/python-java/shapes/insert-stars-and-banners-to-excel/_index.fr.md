...
{{% blocks/products/pf/agp/content h2="Comment insérer une étoile/une bannière dans un fichier Excel à l\'aide de Python via Java" %}}
...
L'exemple de code ci-dessous montre comment insérer un "math plus". Pour plus de types, veuillez vous référer à « Présentation des types d'étoiles et de bannières » ci-dessous.

{{% blocks/products/pf/agp/code-block title="Insérer une étoile/une bannière - Python via Java" offSpacer="" %}}
