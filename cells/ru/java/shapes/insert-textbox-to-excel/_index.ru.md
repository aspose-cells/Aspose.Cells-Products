---
title:  Вставить текстовое поле в Excel via Java
weight: 60
...
{{% blocks/products/pf/agp/content h2="Как вставить текстовое поле в файл Excel с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке TextBox в файл Excel via Java" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addTextBox-int-int-int-int-int-int-) чтобы вставить TextBox в выбранный рабочий лист
...
{{% blocks/products/pf/agp/code-block title="Вставить текстовое поле — Java" offSpacer="" %}}
