---
title: Gộp OTS thành XLT - Gộp OTS thành XLT trong Java
url: /vi/java/merger/merge-ots-to-xlt/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất trực tuyến miễn phí OTS thành XLT định dạng lưu. Java Kết hợp định dạng OTS thành XLT. Hợp nhất OTS thành XLT trong Java. Hợp nhất OTS.
...
Ví dụ sau minh họa cách hợp nhất OTS thành XLT trong Aspose.Cells for Java.
...
{{% cells-merger title="Trực tuyến miễn phí để hợp nhất OTS thành XLT trong Java" InputFormat="ots" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất OTS thành XLT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất OTS với XLT theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
