---
title: Gabungkan JSON ke MHT - Gabungkan JSON ke MHT di C#
url: /id/net/merger/merge-json-to-mht/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan JSON ke format simpan MHT. C# Gabungkan JSON ke format MHT. Gabung JSON menjadi MHT di C#. JSON Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan JSON menjadi MHT di C#" %}}

Contoh berikut menunjukkan cara menggabungkan JSON ke MHT di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan JSON ke MHT. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file MHT. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan JSON ke MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan JSON menjadi MHT di C#" InputFormat="json" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan JSON ke MHT lewat C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan JSON ke MHT secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan .NET untuk menggabungkan JSON ke MHT" %}}
