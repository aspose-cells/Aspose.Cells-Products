---
title: C# XLSB na SQL - XLSB na konwerter SQL
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLSB do formatu SQL, umożliwiając bezproblemowe zapisywanie XLSB danych w formacie SQL za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSB do SQL w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę XLSB na kod SQL C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLSB na SQL. Prześlij plik XLSB, a następnie po prostu zapisz go jako plik SQL. Zarówno do odczytu XLSB, jak i do zapisu SQL, można używać w pełni kwalifikowanych nazw plików. Wyjściowa treść i formatowanie SQL będą identyczne z oryginalnym dokumentem XLSB.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLSB na SQL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsb" outformat="sql" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na SQL przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSB na SQL? Programiści .NET mogą łatwo załadować i przekonwertować XLSB na SQL w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XLSB na SQL wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XLSB na SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLSB na SQL" %}}
