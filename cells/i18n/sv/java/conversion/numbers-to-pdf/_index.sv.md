---
title: Konvertera NUMBERS till PDF via Java 
url: /sv/java/conversion/numbers-to-pdf/ 
description: Exempel på konverteringskod för Java för NUMBERS-format till PDF-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till PDF inom alla webb- eller skrivbordsbaserade program Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera NUMBERS till PDF via Java" h2="NUMBERS till PDF Java-konvertering för att konvertera enstaka eller flera sidor till PDF med hjälp av lokalt Java-bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar TAL till PDF med Java" %}}

 För att rendera NUMBERS till PDF kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera NUMBERS till PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera NUMBERS-filen till PDF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda NUMBERS-filen med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med PDF-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande PDF-filen
...
{{% blocks/products/pf/agp/code-block title="NUMBERS till PDF Java Källkod för konvertering" offSpacer="" %}}

```cs
// ladda NUMBERS-filen i en instans av Workbook
Workbook book = new Workbook("template.numbers");
// spara NUMBERS som PDF
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS till PDF-konvertering livedemonstrationer" sectionDescription="[Konvertera NUMBERS till PDF](https://products.aspose.app/cells/conversion/numbers-to-pdf) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din NUMBERS-fil, den kommer omedelbart att konverteras till PDF." >}}
