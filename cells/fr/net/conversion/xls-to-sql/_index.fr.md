...
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir XLS au format SQL, permettant un enregistrement transparent des données XLS au format SQL à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer XLS dans SQL dans C#" %}}

L'exemple suivant montre comment convertir XLS en SQL en C#.
