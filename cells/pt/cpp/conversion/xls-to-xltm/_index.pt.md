...
description: Aspose Excel. Converta XLS em XLTM de forma rápida e fácil com Aspose.Cells. C++ XLS em XLTM. C++ Salve XLS em XLTM. Salve XLS como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Converta XLS em XLTM usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve XLS para XLTM em C++" %}}

O exemplo a seguir demonstra como converter XLS em XLTM em C++.
...
{{% cells-convert title="Exemplo de código para converter XLS em XLTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xltm" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS em XLTM por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS em XLTM programaticamente? Os desenvolvedores do C++ podem converter facilmente XLS em XLTM em apenas algumas linhas de código.
...
1.  Converta XLS em XLTM chamando o método Save().
