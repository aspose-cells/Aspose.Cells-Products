...
description: Aspose Excel. Μετατρέψτε το OTS σε JPEG γρήγορα και εύκολα με το Aspose.Cells. Python OTS σε JPEG. Python Αποθήκευση OTS σε JPEG. Αποθηκεύστε το OTS ως 07617837481 χρησιμοποιώντας 3.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το OTS στο JPEG στο Python" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή OTS σε JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="jpg" IsLandingPage="true" language="pythonnet" %}}
