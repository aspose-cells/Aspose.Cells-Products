---
title: FODS mit XLS zusammenführen - FODS mit XLS in Java kombinieren
url: /de/java/merger/merge-fods-to-xls/ 
description: Aspose Excel. Java Aspose.Cells. FODS mit XLS Saveformat zusammenführen. Java Kombinieren Sie das Format FODS mit dem Format XLS. FODS zu XLS in Java zusammenführen. FODS Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="FODS mit XLS in Java zusammenführen" %}}

Das folgende Beispiel zeigt, wie FODS mit XLS in Aspose.Cells for Java zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um FODS mit XLS zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in der Datei XLS. Wenn Sie Code in Java entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel Java, das FODS mit XLS zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Beispielcode zum Zusammenführen von FODS mit XLS in Java" InputFormat="fods" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie FODS mit XLS via Java zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie FODS programmgesteuert mit XLS zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for Java](https://products.aspose.com/cells/java) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="Java-Bibliothek zum Zusammenführen von FODS mit XLS" %}}
