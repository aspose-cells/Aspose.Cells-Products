...
{{< blocks/products/pf/i18n/upper-banner h1="XLS souborové grafy k obrázkům v C#" h2="Konverze nativních a vysoce výkonných grafů dokumentů XLS na obrázky pomocí rozhraní API na straně serveru bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/code-block title="Převést graf souborů XLS – C#" offSpacer="" %}}
