...
weight: 10
description: Python via Java kod źródłowy umożliwiający wstawienie formantu ActiveX do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić formant ActiveX do pliku Excel przy użyciu numeru Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić formant ActiveX do pliku Excel przy użyciu Python via Java" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addActiveXControl(int,%20int,%20int,%20int,%20int,%20int,%20int)), aby wstawić formant ActiveX do wybranego arkusza.
...
{{% blocks/products/pf/agp/code-block title="Wstaw formant ActiveX — Python via java" offSpacer="" %}}
