---
title: Dela XLS-filer via .NET 
weight: 1340
url: /sv/net/splitter/xls/ 
description: C# källkod för att dela XLS-dokument på .NET Framework, .NET Core, Mono eller Xamarin-plattformar.
---
...
{{% blocks/products/pf/agp/content h2="Så här delar du en XLS-fil med C#" %}}
...
+ Ladda XLS-filen med fullständig sökväg för delning.
...
{{% blocks/products/pf/agp/code-block title="Dela XLS-fil – C#" offSpacer="" %}}
