...
description: Aspose Excel. Szybko i łatwo przekonwertuj MHT na WORD za pomocą Aspose.Cells. Python MHT na WORD. Python Zapisz MHT na WORD. Zapisz MHT jako WORD, używając Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz MHT pod numerem WORD w Python" %}}

Poniższy przykład ilustruje sposób konwersji MHT na WORD w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji MHT na WORD" %}}
