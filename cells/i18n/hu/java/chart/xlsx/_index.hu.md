...
{{% blocks/products/pf/agp/content h2="XLSX fájldiagramok létrehozása a következővel: Java" %}}

 Az XLSX fájldiagramok létrehozásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az XLSX fájldiagramok létrehozásához itt: Java" %}}
...
{{% blocks/products/pf/agp/code-block title="XLSX fájlok diagram létrehozása – Java" offSpacer="" %}}
