...
{{< blocks/products/pf/i18n/upper-banner h1="Đổi XLS sang ET trong C++" h2="Chuyển đổi XLS sang ET hiệu suất cao bằng cách sử dụng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Cần chuyển đổi các tệp XLS sang ET theo chương trình? C++ nhà phát triển có thể dễ dàng chuyển đổi XLS sang ET chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi XLS thành ET bằng cách gọi phương thức Save().
