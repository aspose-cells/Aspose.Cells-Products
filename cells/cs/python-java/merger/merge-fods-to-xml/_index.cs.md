...
url: /cs/python-java/merger/merge-fods-to-xml/ 
...
Následující příklad ukazuje, jak sloučit FODS do XML v Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit FODS do XML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
