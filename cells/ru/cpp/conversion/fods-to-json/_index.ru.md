...
Нужно программно конвертировать файлы FODS в JSON? Разработчики C++ могут легко преобразовать FODS в JSON всего за несколько строк кода.
