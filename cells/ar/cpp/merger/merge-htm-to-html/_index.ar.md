...
يوضح المثال التالي كيفية دمج HTM إلى HTML في C++.
...
{{% cells-merger title="تطبيق مجاني لدمج HTM إلى HTML على الإنترنت" InputFormat="htm" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
