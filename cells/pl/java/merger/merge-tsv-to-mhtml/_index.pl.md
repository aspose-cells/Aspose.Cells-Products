---
title:  Połącz TSV z MHTML via Java
url: /pl/java/merger/merge-tsv-to-mhtml/ 
description: Połącz TSV z MHTML Online za darmo. Bezpłatnie online TSV do MHTML Fuzja. Połącz TSV z Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS i więcej.
---
...
Poniższy przykład pokazuje, jak połączyć TSV z MHTML w Java.
...
{{% cells-merger title="Darmowa aplikacja do łączenia TSV z MHTML on-line" InputFormat="tsv" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
