---
title: Mesclar MHTML a PDF - Combinar MHTML a PDF em Java
url: /pt/java/merger/merge-mhtml-to-pdf/ 
description: Aspose Excel. Java Aspose.Cells. Mesclagem online gratuita MHTML para PDF saveformat. Java Combine o formato MHTML a PDF. Mesclar MHTML a PDF em Java. MHTML Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar MHTML a PDF em Java Online Gratuitamente" %}}

O exemplo a seguir demonstra como mesclar MHTML a PDF em Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar MHTML a PDF. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo PDF. Se você desenvolver o código em Java, isso será mais simples do que parece. Consulte o exemplo Java que mescla MHTML a PDF.
...
{{% blocks/products/pf/agp/content h2="Como mesclar MHTML com PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar MHTML a PDF programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Java](https://products.aspose.com/cells/java) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para mesclar MHTML a PDF" %}}
