---
title: Объединить XLSB с EXCEL — Объединить XLSB с EXCEL в C++
url: /ru/cpp/merger/merge-xlsb-to-excel/ 
description: Aspose Эксель. C++ Aspose.Cells. Объедините XLSB в формат сохранения EXCEL. C++ Объедините XLSB в формат EXCEL. Объедините XLSB с EXCEL в C++. XLSB Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините XLSB с EXCEL в C++." %}}

В следующем примере показано, как объединить XLSB с EXCEL в Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить XLSB с EXCEL. Загрузите свои файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файл EXCEL. Если вы разработаете код C++, это будет проще, чем кажется. См. пример C++, который объединяет XLSB с EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Пример кода для объединения XLSB с EXCEL в C++" InputFormat="xlsb" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Как объединить XLSB с EXCEL через C++" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить XLSB с EXCEL? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API можно создать с помощью всего нескольких строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C++ для объединения XLSB с EXCEL" %}}
