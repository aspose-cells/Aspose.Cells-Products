---
title: PHP XLTX para XML - XLTX para conversor XML
description: Aspose Excel. Converta XLTX para XML de forma rápida e fácil com Aspose.Cells. PHP XLTX para XML. PHP Salve XLTX em XML. Salve XLTX como XML usando PHP.
...
Precisa converter arquivos XLTX em XML programaticamente? Os desenvolvedores de PHP podem facilmente carregar e converter XLTX em XML em apenas algumas linhas de código.
...
1.  Converta XLTX em XML chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de XLTX para XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter XLTX para XML" %}}
