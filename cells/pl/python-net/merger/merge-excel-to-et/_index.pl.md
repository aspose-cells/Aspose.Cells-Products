...
description: Aspose Excel. Python Aspose.Cells. Połącz plik EXCEL z formatem zapisu ET. Python Połącz format EXCEL z formatem ET. Połącz EXCEL z ET w Python. Połącz EXCEL.
...
{{% blocks/products/pf/agp/content h2="Połącz EXCEL z ET w Python" %}}
...
{{% cells-merger title="Przykładowy kod do połączenia programu EXCEL z ET w Python" InputFormat="xlsx" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć EXCEL z ET poprzez Python" %}}
