---
title:  Combinar XLSB Archivos via .NET
weight: 2970
description: Código fuente C# para combinar documentos XLSB en .NET Framework, .NET Core, Mono o Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar XLSB Formatos en C#" h2="Fusión de documentos nativa y de alto rendimiento XLSB utilizando las API del lado del servidor Aspose.Cells for .NET, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
+ Ahora puede abrir y usar el archivo XLSB en Office Microsoft, Adobe PDF o cualquier otro programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Combinar XLSB Archivos - C#" offSpacer="" %}}
