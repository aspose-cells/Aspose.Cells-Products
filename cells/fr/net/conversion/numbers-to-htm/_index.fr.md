---
title: C# Convertisseur de numéros en HTM
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir les NUMBERS au format HTM, permettant un enregistrement transparent des données NUMBERS au format HTM à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez les NUMÉROS dans HTM dans C#" %}}

L'exemple suivant montre comment convertir des NUMÉROS en HTM dans C#.
...
{{% blocks/products/pf/agp/content h2="Comment convertir des NOMBRES en HTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers NUMBERS en HTM par programmation ? Les développeurs de .NET peuvent facilement charger et convertir des fichiers NUMBERS en HTM en quelques lignes de code seulement.
...
1.  Convertissez les NUMÉROS en HTM en appelant la méthode Workbook.Save.
