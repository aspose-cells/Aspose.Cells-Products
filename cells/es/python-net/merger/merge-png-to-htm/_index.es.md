...
url: /es/python-net/merger/merge-png-to-htm/ 
...
El siguiente ejemplo demuestra cómo fusionar PNG con HTM en Aspose.Cells for Python via .NET.
...
¿Necesita fusionar PNG con HTM mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Las API se pueden crear con solo unas pocas líneas de código.
