---
title:  أدخل البيضاوي في Excel عبر C++
weight: 40
description: C++ رمز المثال لإدراج شكل بيضاوي في ملف Excel على C++ Runtime Environment لـ Windows 32 بت وWindows 64 بت وLinux 64 بت.
keywords: [C++ Aspose.Cells., C++ add Oval shape., C++ insert Oval shape., C++ create Oval shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="أدخل البيضاوي في Excel عبر C++" h2="قم بإدراج الكائنات باستخدام الأداء الأصلي والعالي من جانب الخادم Aspose.Cells for C++ API دون استخدام أي برنامج مثل Microsoft أو Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addoval/) لإدراج أشكال المعادلات في ورقة العمل المحددة
