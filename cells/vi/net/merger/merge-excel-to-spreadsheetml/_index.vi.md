---
title: Gộp EXCEL vào SPREADSHEETML - Gộp EXCEL vào SPREADSHEETML trong C#
url: /vi/net/merger/merge-excel-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất EXCEL thành định dạng lưu SPREADSHEETML. C# Kết hợp EXCEL với định dạng SPREADSHEETML. Hợp nhất EXCEL với SPREADSHEETML trong C#. Hợp nhất EXCEL.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất EXCEL vào SPREADSHEETML trong C#" %}}

Ví dụ sau đây minh họa cách hợp nhất EXCEL với SPREADSHEETML trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Hãy làm theo các bước đơn giản để hợp nhất EXCEL với SPREADSHEETML. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp SPREADSHEETML. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất EXCEL với SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp EXCEL vào SPREADSHEETML trong C#" InputFormat="xlsx" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp EXCEL vào SPREADSHEETML qua C#" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để hợp nhất EXCEL vào SPREADSHEETML" %}}
