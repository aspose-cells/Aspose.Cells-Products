---
title: C# PRN ke EXCEL - Konverter PRN ke EXCEL Online
description: Aspose Unggul. C# Aspose.Cells. C# Aspose Cells. Online Gratis C# Convert PRN to EXCEL saveformat. C# format PRN ke EXCEL. Simpan PRN ke EXCEL C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan PRN ke EXCEL di C#" h2="Pustaka C# berkecepatan tinggi untuk mengonversi PRN ke EXCEL. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor PRN, EXCEL, dan banyak format lainnya pada .NET Framework, .NET Core atau Mono Platform." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PRN" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan PRN ke EXCEL di C# Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi PRN ke EXCEL di C#.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah-langkah mudah untuk mengonversi PRN ke EXCEL. Unggah file PRN Anda, lalu simpan sebagai file EXCEL. Untuk pembacaan PRN dan penulisan EXCEL, Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan pemformatan EXCEL keluaran akan identik dengan dokumen PRN asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi PRN ke EXCEL Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cara Konversi PRN ke EXCEL melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PRN ke EXCEL secara terprogram? .NET pengembang dapat dengan mudah memuat & mengonversi PRN ke EXCEL hanya dalam beberapa baris kode.
...
1.  Ubah PRN menjadi EXCEL dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi PRN ke EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# perpustakaan untuk mengonversi PRN ke EXCEL" %}}
