---
title: Java MHT en XPS - Convertisseur MHT en XPS
description: Aspose Exceller. Convertissez MHT en XPS rapidement et facilement avec Aspose.Cells. Java MHT en XPS. Java Enregistrez MHT en XPS. Enregistrez MHT sous XPS en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrer MHT au XPS au Java" %}}

L'exemple suivant montre comment convertir MHT en XPS en Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir MHT en XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers MHT en XPS par programme ? Les développeurs Java peuvent facilement convertir MHT en XPS en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir MHT en XPS" %}}
{{% blocks/products/pf/agp/text %}}
