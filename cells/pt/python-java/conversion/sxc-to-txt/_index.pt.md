...
{{% blocks/products/pf/agp/content h2="Como converter SXC para TXT usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter SXC para TXT via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos SXC para TXT em apenas algumas linhas de código.
