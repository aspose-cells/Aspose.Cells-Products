---
title:  Bölünmüş XLSB Dosyalar via .NET
weight: 7370
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLSB belgeyi bölmek için C# kaynak kodu.
...
{{% blocks/products/pf/agp/feature-section-col title="XLSB Dosyalarını C#\'e Bölme Adımları" %}}
...
+ Bölme için XLSB dosyasını tam yolla yükleyin.
...
{{% blocks/products/pf/agp/code-block title="Bölünmüş XLSB Dosya - C#" offSpacer="" %}}
