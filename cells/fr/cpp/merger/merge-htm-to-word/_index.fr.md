---
title: Fusionner HTM avec WORD - Combiner HTM avec WORD dans C++
url: /fr/cpp/merger/merge-htm-to-word/ 
description: Aspose Exceller. C++ Aspose.Cells. Fusionner HTM avec le format de sauvegarde WORD. C++ Combinez HTM au format WORD. Fusionner HTM avec WORD dans C++. Fusion HTM.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTM avec WORD dans C++" %}}

L'exemple suivant montre comment fusionner HTM avec WORD dans Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner HTM avec WORD. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-le dans le fichier WORD. Si vous développez du code en C++, ce sera plus simple qu'il n'y paraît. Voir l'exemple C++ qui fusionne HTM avec WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner HTM avec WORD dans C++" InputFormat="htm" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTM avec WORD via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner HTM avec WORD par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour fusionner HTM avec WORD" %}}
