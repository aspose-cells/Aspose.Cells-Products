...
{{% blocks/products/pf/agp/feature-section-col title="Megjegyzések hozzáadásának lépései a XLSM-es számon a C++-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1.  Töltse be a XLSM Excel-fájlt az IWorkbook osztályobjektum használatával.
