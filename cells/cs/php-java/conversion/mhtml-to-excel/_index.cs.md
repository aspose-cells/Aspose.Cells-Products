---
title: Převodník PHP MHTML do EXCEL - MHTML do EXCEL
description: Aspose Excel. Převeďte MHTML do EXCELu rychle a snadno pomocí Aspose.Cells. PHP MHTML do EXCELu. PHP Uložit MHTML do EXCELu. Uložte MHTML jako EXCEL pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML do EXCEL přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést MHTML soubory do EXCELu programově? Vývojáři PHP mohou snadno načíst a převést MHTML na EXCEL v několika řádcích kódu.
...
1.  Převeďte MHTML na EXCEL voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na EXCEL" %}}
