---
title: C# HTML a XML - Convertidor de HTML a XML
description: Aspose Excel. Esta solución integral proporciona a los desarrolladores de C# un enfoque totalmente integrado para convertir HTML a formato XML, lo que permite guardar sin problemas los datos de HTML en formato XML mediante la biblioteca Aspose.Cells, todo mediante código C# eficiente y personalizable.
...
{{% blocks/products/pf/agp/content h2="Guardar HTML en XML en C#" %}}

El siguiente ejemplo demuestra cómo convertir HTML a XML en C#.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir HTML a XML a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos HTML a XML mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente HTML a XML en tan solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para convertir HTML a XML" %}}
