---
title: PHP HTML ～ MARKDOWN - HTML ～ MARKDOWN コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、HTML を MARKDOWN にすばやく簡単に変換します。PHP HTML から MARKDOWN。PHP HTML から MARKDOWN に保存します。PHP を使用して、HTML を MARKDOWN として保存します。
...
{{% blocks/products/pf/agp/content h2="HTML を PHP で MARKDOWN に保存します" %}}

次の例は、PHP で HTML を MARKDOWN に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、HTML を MARKDOWN に変換します。HTML ファイルをアップロードし、MARKDOWN ファイルとして保存するだけです。 HTML 読み取りと MARKDOWN 書き込みの両方で、完全修飾ファイル名を使用できます。出力 MARKDOWN のコンテンツと形式は、元の HTML ドキュメントと同じになります。
...
{{% blocks/products/pf/agp/content h2="PHP 経由で HTML を MARKDOWN に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

HTML ファイルをプログラムで MARKDOWN に変換する必要がありますか? PHP 開発者は、わずか数行のコードで HTML を簡単にロードして MARKDOWN に変換できます。
