---
title: Gộp MHTML vào JPEG - Gộp MHTML vào JPEG vào C#
url: /vi/net/merger/merge-mhtml-to-jpeg/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất MHTML thành JPEG saveformat. C# Kết hợp định dạng MHTML thành JPEG. Hợp nhất MHTML thành JPEG vào C#. MHTML Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất MHTML thành JPEG vào C#" %}}

Ví dụ sau đây minh họa cách hợp nhất MHTML với JPEG trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất MHTML thành JPEG. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp JPEG. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất MHTML thành JPEG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp MHTML thành JPEG trong C#" InputFormat="mhtml" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp MHTML vào JPEG qua C#" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET gộp MHTML thành JPEG" %}}
