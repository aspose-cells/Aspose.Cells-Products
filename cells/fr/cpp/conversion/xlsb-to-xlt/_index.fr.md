---
title: C++ XLSB à XLT - Convertisseur en ligne XLSB à XLT
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Gratuit en ligne C++ Convertir XLSB en format de sauvegarde XLT. Format C++ XLSB à XLT. Enregistrez XLSB à XLT C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à XLT dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en XLT en C++.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en XLT via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en XLT par programmation ? Les développeurs de C++ peuvent facilement convertir XLSB en XLT en seulement quelques lignes de code.
...
1.  Convertissez XLSB en XLT en appelant la méthode Save().
1.  Obtenez le résultat de la conversion de XLSB en XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour convertir XLSB en XLT" %}}
