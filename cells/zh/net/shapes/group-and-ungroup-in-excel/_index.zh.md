...
weight: 340
description: C# 在 .NET 框架、.NET 核心、Mono 或 Xamarin 平台上对 Excel 中的形状进行分组和取消分组的源代码。
---
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 在 Excel 文件中对形状进行分组和取消分组" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C# 在 Excel 文件中对形状进行分组和取消分组的步骤" %}}
...
+ 通过索引选择工作表。
 + 使用[组法](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/group/)对所选工作表中的形状进行分组
 + 使用[解组方法](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/ungroup/)取消组合所选工作表中的形状
以 XLSX 格式保存工作簿。
...
{{% blocks/products/pf/agp/code-block title="组合和取消组合形状 - C#" offSpacer="" %}}
