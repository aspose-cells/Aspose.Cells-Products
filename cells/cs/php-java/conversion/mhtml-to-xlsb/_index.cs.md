---
title: Konvertor PHP MHTML až XLSB - MHTML až XLSB
description: Aspose Excel. Převeďte MHTML na XLSB rychle a snadno pomocí Aspose.Cells. PHP MHTML na XLSB. PHP Uložte MHTML na XLSB. Uložte XLSB jako MHTML jako 81 PHP.07481 jako
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na XLSB přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na XLSB programově? Vývojáři PHP mohou snadno načíst a převést MHTML na XLSB v několika řádcích kódu.
...
1.  Převeďte MHTML na XLSB voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na XLSB" %}}
