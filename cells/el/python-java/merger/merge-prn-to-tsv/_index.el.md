---
title:  Συγχώνευση PRN στο TSV μέσω Python
url: /el/python-java/merger/merge-prn-to-tsv/ 
description: Συγχώνευση PRN στο TSV Online δωρεάν. Δωρεάν online PRN to TSV Merger. Συγχώνευση PRN σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το PRN στο TSV στο Python.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση του PRN με το TSV σε απευθείας σύνδεση" InputFormat="prn" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
