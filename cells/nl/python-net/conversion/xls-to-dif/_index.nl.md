...
description: Aspose Excel. Converteer XLS snel en eenvoudig naar DIF met Aspose.Cells. Python XLS naar DIF. Python Bewaar XLS in DIF. Bewaar XLS als 07611134 81 via Python.
...
{{% blocks/products/pf/agp/content h2="Converteer XLS naar DIF in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar XLS t/m DIF in Python" %}}

Het volgende voorbeeld laat zien hoe u XLS converteert naar DIF in Python via NET.
