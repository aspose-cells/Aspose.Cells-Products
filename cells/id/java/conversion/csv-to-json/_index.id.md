---
title: Java CSV ke JSON - Online CSV ke JSON Konverter
description: Aspose Unggul. Java Aspose.Cells. Java Aspose Cells. Gratis Online Java Ubah CSV menjadi JSON saveformat. Java CSV ke format JSON. Simpan CSV ke JSON Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah CSV menjadi JSON di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi CSV menjadi JSON. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor CSV, JSON, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan CSV ke JSON di Java Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi CSV menjadi JSON di Java.
...
{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi CSV menjadi JSON Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="json" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah CSV menjadi JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file CSV menjadi JSON secara terprogram? Pengembang Java dapat dengan mudah mengonversi CSV menjadi JSON hanya dalam beberapa baris kode.
...
1.  Ubah CSV menjadi JSON dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi dari CSV menjadi JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengonversi CSV menjadi JSON" %}}
{{% blocks/products/pf/agp/text %}}
