...
url: /nl/python-java/merger/merge-html-to-mht/ 
...
Het volgende voorbeeld laat zien hoe u HTML kunt samenvoegen met MHT in Aspose.Cells for Python via Java.
...
Wilt u HTML programmatisch samenvoegen met MHT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
