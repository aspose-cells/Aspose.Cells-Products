...
description: Aspose Excel. Szybko i łatwo przekonwertuj FODS na XML za pomocą Aspose.Cells. Python FODS na XML. Python Zapisz FODS w formacie XML. Zapisz FODS jako XML, używając Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz FODS w formacie XML w Python" %}}

Poniższy przykład ilustruje, jak przekonwertować FODS na XML w Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji FODS na XML" %}}
