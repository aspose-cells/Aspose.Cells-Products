---
title: Hợp nhất JPG sang IMAGE - Kết hợp JPG thành IMAGE trong Java
url: /vi/java/merger/merge-jpg-to-image/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất trực tuyến miễn phí định dạng lưu trữ JPG sang IMAGE. Java Gộp định dạng JPG sang IMAGE. Hợp nhất JPG thành IMAGE trong Java. Hợp nhất JPG.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất JPG thành IMAGE trong Java Trực tuyến miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất JPG thành IMAGE trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất JPG thành IMAGE. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp rồi lưu tệp đó vào tệp IMAGE. Nếu bạn phát triển mã trong Java, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ Java hợp nhất JPG thành IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất JPG thành IMAGE trong Java" InputFormat="jpg" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất JPG thành IMAGE via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất JPG sang IMAGE theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Java thư viện để hợp nhất JPG thành IMAGE" %}}
