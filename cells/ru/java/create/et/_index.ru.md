---
title: Создать ET — создать файл ET по номеру Java.
description:  Aspose Эксель. Java Создайте файл ET быстро и легко с помощью Aspose.Cells. Создайте файл ET с помощью Java. Создайте ET в Java. Java ET Creater.
...
{{% blocks/products/pf/agp/content h2="Как создать ET в Java" %}}
...
1.  Сохраните книгу в формате ET, используя метод save().

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл ET по номеру Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java библиотека для создания файла ET" %}}
{{% blocks/products/pf/agp/text %}}
