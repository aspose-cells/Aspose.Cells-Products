...
url: /hu/python-net/merger/merge-spreadsheetml-to-ett/ 
...
A következő példa bemutatja, hogyan egyesítheti a SPREADSHEETML-t az ETT-vel a Aspose.Cells for Python via .NET számon.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a SPREADSHEETML-t az ETT-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
