---
title: C# XLSB en PRN - Convertisseur en ligne XLSB en PRN
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertir XLSB au format de sauvegarde PRN. C# XLSB au format PRN. Enregistrez XLSB au PRN C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à PRN dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en PRN dans C#.
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir XLSB en PRN en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en PRN via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en PRN par programmation ? Les développeurs .NET peuvent facilement charger et convertir XLSB en PRN en quelques lignes de code.
