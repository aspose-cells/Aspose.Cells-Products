...
description: Aspose エクセル。 C++ Aspose.Cells。XLS を XLT の保存形式にマージします。 C++ XLS と XLT の形式を結合します。 XLS から XLT を C++ に結合します。XLS を結合します。
...
{{% cells-merger title="XLS から XLT を C++ にマージするサンプルコード" InputFormat="xls" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
