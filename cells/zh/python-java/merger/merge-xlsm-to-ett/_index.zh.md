---
title: 将 XLSM 合并到 ETT - 将 XLSM 合并到 Python 中的 ETT
url: /zh/python-java/merger/merge-xlsm-to-ett/ 
description: Aspose Excel。 Python Aspose.Cells。免费在线合并 XLSM 到 ETT 保存格式。 Python 将 XLSM 合并为 ETT 格式。将 XLSM 合并到 Python 中的 ETT。 XLSM 合并。
...
{{% blocks/products/pf/agp/content h2="使用 Python 将 XLSM 合并到 ETT" %}}

如何将 XLSM 合并到 ETT？借助 Aspose.Cells for Python via Java 库，您可以通过几行代码以编程方式轻松将 XLSM 合并到 ETT。[Aspose.Cells for Python via Java](https://pypi.org/project/aspose-cells)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 Python Excel API不仅可以在电子表格格式之间进行转换，还可以将Excel文件渲染为图像，PDF、HTML、ODS、CSV、SVG、JSON、WORD、PPT等，从而使其成为行业交换文档的完美选择-标准格式。您可以安装 Aspose.Cells for Python via Java<a href="https://pypi.org/project/aspose-cells/">pypi</a>，使用命令为：<code>$ pip install aspose-cells</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="免费在线合并 XLSM 到 Python 中的 ETT" %}}

以下示例演示如何将 XLSM 合并到 Aspose.Cells for Python via Java 中的 ETT。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 XLSM 合并到 ETT。上传文件，调用Workbook.Combine方法合并文件，然后保存到ETT文件。如果您在 Python 中开发代码，这会比听起来更简单。请参阅将 XLSM 合并到 ETT 的 Python 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免费在线将 XLSM 合并到 Python 中的 ETT" InputFormat="xlsm" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何通过 Python 将 XLSM 合并到 ETT" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLSM 合并到 ETT？基本文档合并和连接[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2="Python库将XLSM合并到ETT" %}}
