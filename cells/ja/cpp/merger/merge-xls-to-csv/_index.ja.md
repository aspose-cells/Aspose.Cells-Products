...
url: /ja/cpp/merger/merge-xls-to-csv/ 
description: Aspose エクセル。 C++ Aspose.Cells。XLS を CSV の保存形式にマージします。 C++ XLS と CSV の形式を結合します。 XLS から CSV を C++ に結合します。XLS を結合します。
...
次の例は、XLS を Aspose.Cells for C++ の CSV にマージする方法を示しています。
...
{{% cells-merger title="XLS から CSV を C++ にマージするサンプルコード" InputFormat="xls" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="XLS を C++ 経由で CSV に結合する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLS をプログラムで CSV にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2="C++ XLS を CSV にマージするライブラリ" %}}
