...
Chcesz programowo przekonwertować pliki JSON na ET? Programiści C++ mogą łatwo przekonwertować JSON na ET w zaledwie kilku wierszach kodu.
...
1.  Konwertuj JSON na ET, wywołując metodę Save().
