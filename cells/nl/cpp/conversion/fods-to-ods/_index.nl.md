...
{{% blocks/products/pf/agp/content h2="Sla FODS op in ODS in C++" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar ODS in C++.
...
Moet je bestanden met de extensie FODS programmatisch converteren naar ODS? Ontwikkelaars van C++ kunnen bestanden met de extensie FODS eenvoudig converteren naar ODS met slechts een paar regels code.
