---
title: Konwerter C++ XLSB na LICZBY - XLSB na LICZBY
...
{{% blocks/products/pf/agp/content h2="Zapisz XLSB w NUMERACH w C++" %}}

Poniższy przykład pokazuje, jak przekonwertować XLSB na LICZBY w formacie C++.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na LICZBY za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLSB na LICZBY? Programiści C++ mogą łatwo przekonwertować XLSB na LICZBY za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C++ do konwersji XLSB na LICZBY" %}}
