---
title: Συγχώνευση FODS σε PPTX - Συνδυάστε FODS σε PPTX στο C#
url: /el/net/merger/merge-fods-to-pptx/ 
description: Aspose Excel. C# Aspose.Cells. Συγχώνευση FODS σε μορφή αποθήκευσης PPTX. C# Συνδυάστε τη μορφή FODS με PPTX. Συγχώνευση FODS σε PPTX στο C#. FODS Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχώνευση FODS με PPTX στο C#" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το FODS με το PPTX στο Aspose.Cells for .NET.
...
{{% cells-merger title="Δείγμα κωδικού για συγχώνευση FODS έως PPTX στο C#" InputFormat="fods" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Πώς να συγχωνεύσετε το FODS στο PPTX μέσω του C#" %}}

{{% blocks/products/pf/agp/text %}}

 Θέλετε να συγχωνεύσετε το FODS με το PPTX μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
