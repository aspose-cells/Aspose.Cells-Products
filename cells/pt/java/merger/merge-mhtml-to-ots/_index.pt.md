---
title: Mesclar MHTML para OTS - Combine MHTML para OTS em Java
url: /pt/java/merger/merge-mhtml-to-ots/ 
description: Aspose Excel. Java Aspose.Cells. Mesclagem on-line gratuita MHTML para OTS saveformat. Java Combine MHTML para o formato OTS. Mesclar MHTML para OTS em Java. MHTML Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar MHTML para OTS em Java online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar MHTML com OTS em Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar MHTML com OTS. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo OTS. Se você desenvolver código em Java, isso será mais simples do que parece. Consulte o exemplo Java que mescla MHTML com OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar MHTML para OTS em Java" InputFormat="mhtml" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar MHTML para OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa mesclar MHTML para OTS programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Java](https://products.aspose.com/cells/java) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para mesclar MHTML para OTS" %}}
