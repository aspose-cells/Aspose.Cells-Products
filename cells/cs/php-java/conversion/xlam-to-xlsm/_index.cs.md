---
title: Konvertor PHP XLAM až XLSM - XLAM až XLSM
description: Aspose Excel. Převeďte XLAM na XLSM rychle a snadno pomocí Aspose.Cells. PHP XLAM na XLSM. PHP Uložte XLAM na XLSM. Uložte XLSM jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na XLSM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="xlsm" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na XLSM přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na XLSM programově? Vývojáři PHP mohou snadno načíst a převést XLAM na XLSM v několika řádcích kódu.
...
1.  Převeďte XLAM na XLSM voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na XLSM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na XLSM" %}}
