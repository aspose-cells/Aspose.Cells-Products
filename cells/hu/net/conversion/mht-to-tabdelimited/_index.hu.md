...
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a C# fejlesztők számára az MHT TABDELIMITED formátumba konvertálásához, lehetővé téve az MHT adatok zökkenőmentes mentését TABDELIMITED formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható C# kódon keresztül.
...
{{< blocks/products/pf/i18n/upper-banner h1="MHT konvertálása TABDELIMITED-re a C#-ben" h2="Nagysebességű C# könyvtár MHT TABDELIMITED formátumra konvertálásához. Ez egy professzionális szoftvermegoldás MHT, TABDELIMITED és sok más formátum importálására és exportálására .NET Framework, .NET Core vagy Mono platformokon." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHT" >}}
...
{{% blocks/products/pf/agp/content h2="MHT mentése TABDELIMITED karakterekkel a C#-es számban" %}}

A következő példa bemutatja, hogyan lehet az MHT-t TABDELIMITED-re konvertálni a C#-es számban.
...
1.  Az MHT-t TABDELIMITED formátumra konvertálhatja a Workbook.Save metódus meghívásával.
1.  Az MHT konvertálási eredményének lekérése TAB-raDELIMITED.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár az MHT tabulátorral elválasztott karakterekké konvertálásához" %}}
