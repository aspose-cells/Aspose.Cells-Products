...
{{% blocks/products/pf/agp/content h2="Převeďte XML na SVG pomocí Python" %}}
...
Následující příklad ukazuje, jak převést XML na SVG v Python.
