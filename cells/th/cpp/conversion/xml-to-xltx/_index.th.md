...
description: Aspose เอ็กเซล. แปลง XML เป็น XLTX อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XML เป็น XLTX C++ บันทึก XML เป็น XLTX บันทึก XML เป็น XLTX โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึก XML เป็น XLTX ใน C++" %}}
...
1.  แปลง XML เป็น XLTX โดยการเรียกเมธอด Save()
