---
title:  Dodaj lub usuń XLSX Adnotacja via .NET
weight: 2010
description: Kod źródłowy C# do dodawania i usuwania adnotacji w formacie XLSX na platformach .NET Framework, .NET Core, Mono lub platformach Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Dodaj lub usuń adnotację od XLSX do C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Usuń adnotacje z numerów XLSX–C#" offSpacer="" %}}
