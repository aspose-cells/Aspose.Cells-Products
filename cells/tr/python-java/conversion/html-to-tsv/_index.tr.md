...
{{% blocks/products/pf/agp/content h2="Python Kullanarak HTML\'yi TSV\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python aracılığıyla HTML\'yi TSV\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Python geliştiricileri, HTML dosyalarını yalnızca birkaç satır kodla kolayca yükleyebilir ve TSV'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Bir Çalışma Kitabı örneğiyle HTML dosyasını yükleyin1. Workbook.Save yöntemini çağırın1. Parametre olarak TSV uzantılı çıktı yolunu iletin1. Ortaya çıkan TSV dosyası için belirtilen yolu kontrol edin
