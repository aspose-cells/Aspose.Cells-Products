...
description: Aspose Excel. Konwertuj XLSM na XLS szybko i łatwo za pomocą Aspose.Cells. PHP XLSM na XLS. PHP Zapisz XLSM na XLS. Zapisz XLSM jako XLS używając PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSM na XLS w PHP" h2="Szybka biblioteka PHP do konwersji XLSM na XLS. Jest to profesjonalne oprogramowanie do importowania i eksportowania XLSM, XLS i wielu innych formatów przy użyciu PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Chcesz programowo przekonwertować pliki XLSM na XLS? Programiści PHP mogą łatwo załadować i przekonwertować XLSM na XLS w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLSM na numer XLS, wywołując metodę zapisu skoroszytu.
