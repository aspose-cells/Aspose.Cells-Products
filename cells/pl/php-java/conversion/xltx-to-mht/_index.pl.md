...
description: Aspose Excel. Szybko i łatwo przekonwertuj XLTX na MHT za pomocą Aspose.Cells. PHP XLTX na MHT. PHP Zapisz XLTX w MHT. Zapisz XLTX jako MHT przy użyciu PHP.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLTX na MHT przez PHP" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLTX na MHT? Programiści PHP mogą łatwo załadować i przekonwertować XLTX na MHT w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XLTX na MHT, wywołując metodę zapisu skoroszytu.
