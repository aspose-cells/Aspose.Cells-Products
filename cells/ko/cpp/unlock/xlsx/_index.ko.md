...
{{% blocks/products/pf/agp/content h2="C++을 사용하여 XLSX 파일의 보호를 제거하는 방법" %}}
...
1.  CreateIWorkbook을 사용하여 XLSX 잠긴 파일을 로드합니다.
1.  Unprotect() 함수를 호출하여 잠금을 해제합니다.
1.  SetPassword를 사용하여 암호를 NULL로 설정합니다.
1.  XLSX 파일을 지정된 위치에 저장합니다.
