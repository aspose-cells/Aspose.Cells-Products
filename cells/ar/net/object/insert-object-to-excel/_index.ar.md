...
weight: 170
description: كود المصدر C# لإدراج كائن OLE في Excel على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addoleobject) لإدراج كائن OLE في ورقة العمل المحددة
