...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в XLS в C++" %}}

Следующий пример демонстрирует, как преобразовать XML в формат XLS в формате C++.
...
Нужно программно преобразовать XML-файлы в формат XLS? Разработчики, использующие формат C++, могут легко преобразовать XML в формат XLS всего несколькими строками кода.
...
1.  Преобразовать XML в формат XLS, вызвав метод Save().
