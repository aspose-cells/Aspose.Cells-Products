---
title: Konvertera MHTML till EMF via Python
url: /sv/python-java/conversion/mhtml-to-emf/
description: Exempelkod för konvertering från mhtml till emf Python. Använd API exempelkod för batch-mhtml-filer för att emf-konvertera i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du MHTML till EMF med Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera MHTML till EMF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera MHTML-filer till EMF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda MHTML-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med EMF-förlängning som parameter1. Kontrollera den angivna sökvägen för den resulterande EMF-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera MHTML till EMF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="emf" IsLandingPage="true" language="python" %}}
