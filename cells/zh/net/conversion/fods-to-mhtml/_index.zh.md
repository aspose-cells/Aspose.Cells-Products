---
title: 将 FODS 转换为 MHTML C#
description: 免费在线将 FODS 转换为 MHTML。免费在线 FODS 到 MHTML 转换器。 C# FODS 至 MHTML。FODS 至 MHTML 通过 C#。
keywords: Convert FODS, FODS Converter, FODS to PDF, FODS to Word, FODS to PPT, FODS to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 将 FODS 转换为 MHTML" h2="用于将 FODS 转换为 MHTML 的高速 C# 库。在 .NET 框架、.NET 核心或 Mono 平台上将 Excel 电子表格导出为 MHTML 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="免费在线保存FODS至MHTML至C#" %}}
...
{{% cells-convert title="在线将 FODS 转换为 MHTML 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="mhtml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过C#将FODS转换为MHTML" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 开发人员只需几行代码即可轻松加载和转换 FODS 为 MHTML。
...
{{% blocks/products/pf/agp/content h2="C# 库将 FODS 转换为 MHTML" %}}
