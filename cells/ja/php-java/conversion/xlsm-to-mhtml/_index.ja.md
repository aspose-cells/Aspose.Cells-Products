---
title: PHP XLSM ～ MHTML - XLSM ～ MHTML コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、XLSM を MHTML にすばやく簡単に変換します。PHP XLSM から MHTML。PHP XLSM から MHTML に保存します。PHP を使用して、XLSM を MHTML として保存します。
...
{{% blocks/products/pf/agp/content h2="PHP 経由で XLSM を MHTML に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSM ファイルをプログラムで MHTML に変換する必要がありますか? PHP 開発者は、わずか数行のコードで XLSM を簡単にロードして MHTML に変換できます。
