---
title:  Sloučit MHTML na HTML přes Python
...
Následující příklad ukazuje, jak sloučit MHTML až HTML v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení MHTML až HTML online" InputFormat="mhtml" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
