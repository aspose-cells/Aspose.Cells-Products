---
title: Połącz XLTM z DIF - Połącz XLTM z DIF w C#
url: /pl/net/merger/merge-xltm-to-dif/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLTM do DIF w formacie zapisu. C# Połącz format XLTM z DIF. Połącz XLTM z DIF w C#. XLTM Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLTM z DIF w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLTM z DIF w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLTM z DIF. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku DIF. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy numery XLTM z DIF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLTM z DIF w C#" InputFormat="xltm" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLTM z DIF za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić XLTM z DIF programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
