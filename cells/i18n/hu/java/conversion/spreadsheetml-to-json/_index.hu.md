---
title: "SPREADSHEETML konvertálása JSON formátumba a következőn keresztül: Java "
url: /hu/java/conversion/spreadsheetml-to-json/ 
description: Minta Java konverziós kód a SPREADSHEETML formátumhoz JSON-fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására JSON-ba bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SPREADSHEETML konvertálása JSON formátumba a következőn keresztül: Java" h2="A SPREADSHEETML-ből JSON-ba Java konverzió egyetlen vagy több oldal konvertálásához JSON-ba a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="A SPREADSHEETML konvertálása JSON-ba a következővel: Java" %}}

 Ahhoz, hogy a SPREADSHEETML-t JSON-ba rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A SPREADSHEETML konvertálása JSON formátumba a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják a SPREADSHEETML fájlt JSON formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a SPREADSHEETML-fájlt a Workbook osztály egy példányával1. Hozzon létre egy exportálandó adattartományt a Cells.createRange metódussal1. Hívja a JsonUtility.exportRangeToJson metódust a Range és az ExportRangeToJsonOptions hivatkozásokkal1. Írja be a karakterlánc JSON-adatait a fájlba a BufferedWriter.write metódussal
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML JSON Java konverziós forráskódra" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SPREADSHEETML JSON-konverziós élő bemutatók" sectionDescription="[Konvertálja a SPREADSHEETML-t JSON-ba](https://products.aspose.app/cells/conversion/spreadsheetml-to-json) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a SPREADSHEETML-fájlt, amely azonnal JSON-ba konvertálódik." >}}
