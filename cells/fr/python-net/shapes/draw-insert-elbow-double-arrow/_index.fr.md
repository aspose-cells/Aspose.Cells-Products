---
title: Comment dessiner ou insérer la forme d'une double flèche de coude dans Excel en utilisant Python via .Net
weight: 10
description: Python via .Net code source pour insérer la forme de double flèche du coude dans Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Insérez la forme de double flèche du coude dans Excel en utilisant Python via .Net" h2="Insérez la double flèche du coude en utilisant Aspose.Cells\' API sans aucun logiciel comme Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment insérer la forme d\'une double flèche de coude dans un fichier Excel à l\'aide de Python via .Net" %}}

 Afin d'insérer la forme de la double flèche du coude dans le fichier Excel, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer la forme de la double flèche du coude dans le fichier Excel à l\'aide de Python via .Net" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez l'ajout de la collection de formes[méthode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) pour insérer une forme de double flèche coudée dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Insert coude double flèche - Python via .Net" offSpacer="" %}}
