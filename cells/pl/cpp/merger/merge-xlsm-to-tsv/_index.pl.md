...
url: /pl/cpp/merger/merge-xlsm-to-tsv/ 
...
Poniższy przykład pokazuje, jak połączyć XLSM z TSV w Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo połączyć XLSM z TSV? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia XLSM z TSV" %}}
