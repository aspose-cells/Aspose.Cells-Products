...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل HTM إلى أرقام عبر C++" h2="تحويل HTM إلى أرقام عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن للمطورين C++ بسهولة تحويل HTM إلى أرقام في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف HTM باستخدام Factory :: CreateIWorkbook.
1. تحويل HTM إلى أرقام عن طريق استدعاء طريقة Save ().
