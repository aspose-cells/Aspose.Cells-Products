...
description: Aspose Excel. Python Aspose.Cells. PRN to DIF in Python. Python Convert PRN to DIF saveformat. Python PRN to DIF format. Save PRN to DIF Python.
keywords: [Aspose Excel., Python Aspose.Cells., PRN to DIF in Python., Python PRN to DIF saveformat., PRN to DIF Python., Python Convert PRN to DIF]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert PRN to DIF in Python" h2="High-speed Python library for converting PRN to DIF. Use our excel conversion API to develop high-level, platform independent software in Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convert PRN to DIF in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Save PRN to DIF in Python" %}}

The following example demonstrates how to convert PRN to DIF in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Python library to convert PRN to DIF" %}}
