...
{{% blocks/products/pf/agp/text %}}
 ...
 Geliştiricilerin, veri işleme için farklı raporlama uygulamalarını çalıştıran TSV dosyalarını yalnızca birkaç satır kodla oluşturması, yüklemesi, değiştirmesi ve dönüştürmesi kolaydır.
...
{{% blocks/products/pf/agp/content h2="TSV dosyası oluşturmak için C# kitaplığı" %}}
