---
title: Konwertuj TXT na CSV za pomocą aplikacji C++ 
url: /pl/cpp/conversion/txt-to-csv/ 
description: Przykładowy kod konwersji C++ dla dokumentu TXT do formatu CSV. Programiści mogą używać tego kodu źródłowego do zbiorczej konwersji TXT na CSV w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik TXT na CSV w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik TXT przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (CSV).1. Plik CSV zostanie zapisany pod określoną ścieżką.1. Otwórz plik CSV w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="TXT do CSV C++ Kod źródłowy konwersji" offSpacer="" %}}
