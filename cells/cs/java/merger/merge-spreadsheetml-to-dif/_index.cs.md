...
description: Aspose Excel. Java Aspose.Cells. Sloučit SPREADSHEETML do DIF saveformat. Java Zkombinujte SPREADSHEETML do formátu DIF. Sloučit SPREADSHEETML na DIF v Java. SPREADSHEETML Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit SPREADSHEETML na DIF v Java" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení SPREADSHEETML do DIF v Java" InputFormat="xml" InputFormat2="dif" outformat="dif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
