...
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các Định dạng XLTX trong Java" h2="Hợp nhất tài liệu XLTX gốc bằng cách sử dụng Java API phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất các tệp XLTX bằng cách sử dụng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để hợp nhất các tệp XLTX trong Java" %}}
...
+ Tải tệp XLTX đầu tiên với một thể hiện của lớp Workbook.
+ Tải tài liệu XLTX thứ hai với một thể hiện của lớp Workbook.
+ Hợp nhất các tệp tin bằng phương thức kết hợp ().
+ lưu tệp XLTX đã hợp nhất theo đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất các tệp XLTX - Java" offSpacer="" %}}

```cs
// Mở tệp XLTX đầu tiên.
