---
title:  Ver o editar metadatos de archivos XLSM via .NET
weight: 5590
description: Código fuente C# para editar o ver metadatos en formato XLSM en plataformas .NET Framework, .NET Core, Mono o Xamarin.
...
+ Cargue XLSM con una instancia de Workbook
