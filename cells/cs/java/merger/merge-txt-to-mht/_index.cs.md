---
title:  Sloučit TXT na MHT via Java
...
Následující příklad ukazuje, jak sloučit TXT do MHT v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení TXT s MHT online" InputFormat="txt" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
