...
weight: 5410
description: Código-fonte C# para adicionar ou remover marca d'água do arquivo XLSB no .NET Framework, .NET Core, Mono ou plataformas Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Adicionar marca d\'água de texto a XLSB via C#" h2="Crie seus próprios aplicativos .NET para marcar arquivos XLSB com marca d’água usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Como colocar marca d\'água no arquivo XLSB usando C#" %}}
 ...
 Para colocar marca d'água no arquivo XLSB, usaremos
