...
{{% blocks/products/pf/agp/content h2="Konwertuj EXCEL na SXC używając Java" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz EXCEL do SXC w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę z programu EXCEL na SXC w formacie Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik EXCEL na SXC via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki EXCEL do formatu SXC? Programiści Java mogą łatwo przekonwertować pliki EXCEL do formatu SXC za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji EXCELA na SXC" %}}
{{% blocks/products/pf/agp/text %}}
