---
title:  Объединить SPREADSHETML в XLTX через Python
...
В следующем примере показано, как объединить SPREADSHEETML с XLTX в Python.
