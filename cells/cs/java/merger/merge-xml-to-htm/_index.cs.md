---
title: Sloučit XML do HTM – Zkombinujte XML do HTM v Java
url: /cs/java/merger/merge-xml-to-htm/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit XML do formátu uložení HTM. Java Zkombinujte formát XML s formátem HTM. Sloučit XML do HTM v Java. Sloučit XML.
...
{{% blocks/products/pf/agp/content h2="Sloučit XML do HTM v Java" %}}

Následující příklad ukazuje, jak sloučit XML do HTM v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XML do HTM. Nahrajte soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru HTM. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí XML do HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení XML do HTM v Java" InputFormat="xml" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XML do HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XML do HTM? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna pro sloučení XML do HTM" %}}
