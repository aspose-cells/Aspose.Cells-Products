...
description: Sample code for FODS to TSV C# conversion. Use API example code for batch FODS files to TSV conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert FODS files to TSV in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows FODS to TSV C# Conversion" offSpacer="" %}}
