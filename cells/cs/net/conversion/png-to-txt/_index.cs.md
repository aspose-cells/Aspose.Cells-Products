...
{{% blocks/products/pf/agp/content h2="Uložit PNG až TXT v C#" %}}

Následující příklad ukazuje, jak převést PNG na TXT v C#.
...
{{% cells-convert title="Ukázkový kód pro převod PNG na TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="txt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak převést PNG na TXT přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na TXT programově? Vývojáři .NET mohou snadno načíst a převést PNG na TXT v několika řádcích kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod PNG na TXT" %}}
