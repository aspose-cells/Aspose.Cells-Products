---
title: C++ XML a JSON - Convertidor de XML a JSON
description: Aspose Excel. Esta solución integral proporciona a los desarrolladores de C++ un enfoque totalmente integrado para convertir XML al formato JSON, lo que permite guardar datos XML sin problemas en formato JSON mediante la biblioteca Aspose.Cells, todo mediante código C++ eficiente y personalizable.
...
{{% blocks/products/pf/agp/content h2="Guardar XML en JSON en C++" %}}

El siguiente ejemplo demuestra cómo convertir XML a JSON en C++.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir XML a JSON. Cargue su archivo XML y luego simplemente guárdelo como archivo JSON. Tanto para la lectura XML como para la escritura JSON, puede utilizar nombres de archivo completos. El contenido y el formato de salida JSON serán idénticos al documento XML original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de ejemplo para convertir XML a JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xml" outformat="json" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir XML a JSON a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos XML a JSON mediante programación? Los desarrolladores de C++ pueden convertir fácilmente XML a JSON con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1.  Instalar 'Aspose.Cells for C++'.
1.  Agregue una referencia de biblioteca (importe la biblioteca) a su proyecto C++.
1.  Cargar archivo XML usando Libro de trabajo.
1.  Convierta XML a JSON llamando al método Save().
1.  Obtenga el resultado de la conversión de XML a JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ biblioteca para convertir XML a JSON" %}}
