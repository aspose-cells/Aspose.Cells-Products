---
title:  TABDELIMITED を C# 経由で XLSM にマージします
url: /ja/net/merger/merge-tabdelimited-to-xlsm/ 
description: TABDELIMITED をオンラインで無料で XLSM にマージします。無料オンライン TABDELIMITED から XLSM 合併。 TABDELIMITED を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、TABDELIMITED を C# の XLSM にマージする方法を示しています。
...
{{% cells-merger title="TABDELIMITEDをオンラインでXLSMにマージする無料アプリ" InputFormat="tsv" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
