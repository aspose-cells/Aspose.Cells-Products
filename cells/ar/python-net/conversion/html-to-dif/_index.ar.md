...
description: Aspose اكسل. تحويل HTML إلى DIF بسرعة وسهولة مع Aspose.Cells. Python HTML إلى DIF. Python احفظ HTML إلى DIF. احفظ HTML كـ 07611134 81 باستخدام Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل HTML إلى DIF في Python" h2="مكتبة Python عالية السرعة لتحويل HTML إلى DIF. استخدم تحويل Excel API لتطوير برنامج مستقل عالي المستوى في النظام الأساسي في Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل HTML إلى DIF في Python" %}}
...
{{% blocks/products/pf/agp/content h2="حفظ HTML إلى DIF في Python" %}}

يوضح المثال التالي كيفية تحويل HTML إلى DIF في Python via NET.
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل HTML إلى DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="dif" IsLandingPage="true" language="pythonnet" %}}
