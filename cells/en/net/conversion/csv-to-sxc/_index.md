...
{{% blocks/products/pf/agp/content h2="Save CSV to SXC in C# Online for Free" %}}

The following example demonstrates how to convert CSV to SXC document format in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert CSV file into SXC format. Upload your CSV file, then simply save it as SXC file. For both CSV reading and SXC writing you can use fully qualified filenames. The output SXC content and formatting will be identical to the original CSV document.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Free App and Sample Code to Convert CSV to SXC" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="sxc" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert CSV to SXC via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert CSV files to SXC in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="C# library to convert CSV to SXC" %}}
