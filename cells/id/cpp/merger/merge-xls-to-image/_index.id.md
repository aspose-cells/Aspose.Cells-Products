---
title: Gabungkan XLS ke IMAGE - Gabungkan XLS ke IMAGE di C++
url: /id/cpp/merger/merge-xls-to-image/ 
description: Aspose Unggul. C++ Aspose.Cells. Gabungkan XLS ke format penyimpanan GAMBAR. C++ Gabungkan XLS ke format GAMBAR. Gabungkan XLS menjadi IMAGE di C++. XLS Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLS ke IMAGE di C++" %}}

Contoh berikut menunjukkan cara menggabungkan XLS ke IMAGE di Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan XLS ke IMAGE. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file IMAGE. Jika Anda mengembangkan kode di C++, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C++ yang menggabungkan XLS ke IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan XLS ke IMAGE di C++" InputFormat="xls" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLS ke IMAGE lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLS ke IMAGE secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka C++ untuk menggabungkan XLS ke IMAGE" %}}
