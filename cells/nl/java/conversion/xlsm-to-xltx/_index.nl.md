...
{{% blocks/products/pf/agp/content h2="Sla XLSM op in XLTX in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSM omzet naar XLTX in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSM om naar XLTX of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSM programmatisch converteren naar XLTX? Ontwikkelaars van Java kunnen bestanden met de extensie XLSM eenvoudig converteren naar XLTX met slechts een paar regels code.
