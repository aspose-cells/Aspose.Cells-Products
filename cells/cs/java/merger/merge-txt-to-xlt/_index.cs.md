---
title:  Sloučit TXT až XLT via Java
...
Následující příklad ukazuje, jak sloučit TXT až XLT v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení TXT až XLT online" InputFormat="txt" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
