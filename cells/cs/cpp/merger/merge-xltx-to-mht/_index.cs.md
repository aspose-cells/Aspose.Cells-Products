...
description: Aspose Excel. C++ Aspose.Cells. Sloučit XLTX do formátu uložení MHT. C++ Zkombinujte XLTX do formátu MHT. Sloučit XLTX na MHT v C++. XLTX Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTX na MHT v C++" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLTX do MHT v C++" InputFormat="xltx" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
