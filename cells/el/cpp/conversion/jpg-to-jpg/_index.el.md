...
Θέλετε να μετατρέψετε αρχεία JPG σε JPG μέσω προγραμματισμού; C++ οι προγραμματιστές μπορούν εύκολα να μετατρέψουν JPG σε JPG σε λίγες μόνο γραμμές κώδικα.
...
1.  Μετατρέψτε το JPG σε JPG καλώντας τη μέθοδο Save().
