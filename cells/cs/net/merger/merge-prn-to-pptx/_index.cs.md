...
description: Aspose Excel. C# Aspose.Cells. Sloučit PRN do formátu uložení PPTX. C# Zkombinujte PRN do formátu PPTX. Sloučit PRN na PPTX v C#. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN na PPTX v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení PRN s PPTX v C#" InputFormat="prn" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
