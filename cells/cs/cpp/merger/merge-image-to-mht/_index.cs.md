...
url: /cs/cpp/merger/merge-image-to-mht/ 
...
Následující příklad ukazuje, jak sloučit IMAGE do MHT v Aspose.Cells for C++.
...
Potřebujete sloučit IMAGE do MHT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovna pro sloučení IMAGE do MHT" %}}
