---
title: Converter SXC para SPREADSHEETML via Python
url: /pt/python-java/conversion/sxc-to-spreadsheetml/
description: Código de exemplo para conversão de sxc para planilhaml Python. Use API código de exemplo para arquivos sxc em lote para conversão de planilhaml no aplicativo Python.
---
...
{{% blocks/products/pf/agp/content h2="Como converter SXC para SPREADSHEETML usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter SXC em SPREADSHEETML via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos SXC para SPREADSHEETML em apenas algumas linhas de código.
