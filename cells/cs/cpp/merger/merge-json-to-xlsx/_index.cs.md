...
url: /cs/cpp/merger/merge-json-to-xlsx/ 
...
Následující příklad ukazuje, jak sloučit JSON až XLSX v Aspose.Cells for C++.
...
{{% cells-merger title="Ukázkový kód pro sloučení JSON až XLSX v C++" InputFormat="json" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JSON na XLSX přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit JSON až XLSX? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ ke sloučení JSON až XLSX" %}}
