...
description: Aspose Эксель. Быстро и легко конвертируйте JPG в ODS с помощью Aspose.Cells. Python JPG в ODS. Python Сохраните JPG в ODS. Сохраните JPG как ODS, используя Python.
...
{{% blocks/products/pf/agp/content h2="Конвертируйте JPG в ODS, используя Python" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните JPG в ODS в Python." %}}

В следующем примере показано, как преобразовать JPG в ODS в Python.
...
{{% blocks/products/pf/agp/content h2="Библиотека Python для преобразования JPG в ODS" %}}
