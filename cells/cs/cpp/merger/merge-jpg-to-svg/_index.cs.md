...
url: /cs/cpp/merger/merge-jpg-to-svg/ 
...
Následující příklad ukazuje, jak sloučit JPG s SVG v Aspose.Cells for C++.
...
Potřebujete sloučit JPG na SVG programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení JPG do SVG" %}}
