---
title: 無需透過 C++ 開啟即可搜尋 ODS 文檔
weight: 3300
description: C++ 範例程式碼，用於在 ODS 檔案中使用模式搜尋單字，適用於 C++ 運行時環境，支援 Windows 32 位元、Windows 64 位元和 Linux 64 位元。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 C++ 中搜尋 ODS 格式" h2="使用伺服器端 API 實現原生和高效能的文檔搜索，無需使用任何軟體，例如 Adobe 或 Microsoft 或 PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 C++ 中搜尋 ODS 文件的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="搜尋文件 ODS - C++" offSpacer="" %}}
