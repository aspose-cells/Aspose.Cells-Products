---
title: Fusionner PRN à HTM - Combiner PRN à HTM dans Java
url: /fr/java/merger/merge-prn-to-htm/ 
description: Aspose Excel. Java Aspose.Cells. Fusion gratuite en ligne PRN au format de sauvegarde HTM. Java Combinez le format PRN au format HTM. Fusionner PRN à HTM en Java. Fusion PRN.
...
{{% blocks/products/pf/agp/content h2="Fusionner PRN à HTM en Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner PRN avec HTM dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner PRN en HTM. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier HTM. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne PRN en HTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner PRN à HTM en Java" InputFormat="prn" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner PRN à HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner PRN à HTM par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Java bibliothèque pour fusionner PRN à HTM" %}}
