---
title:  Extraiga texto e imágenes del documento ODS via Java
weight: 4740
description: Código de muestra Java para extraer texto e imágenes del archivo ODS en el entorno de ejecución Java para aplicaciones JSP/JSF y aplicaciones de escritorio.
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para analizar archivos ODS en Java" %}}
...
+ Cargue el documento ODS usando la clase Libro de trabajo.
...
{{% blocks/products/pf/agp/code-block title="Analizar archivos ODS - Java" offSpacer="" %}}
