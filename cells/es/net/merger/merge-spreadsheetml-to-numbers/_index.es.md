---
title: Combine SPREADSHEETML a NUMBERS - Combine SPREADSHEETML a NUMBERS en C#
url: /es/net/merger/merge-spreadsheetml-to-numbers/ 
description: AsposeExcel. C# Aspose.Cells. Combinación gratuita en línea SPREADSHEETML to NUMBERS saveformat. C# Combinar HOJA DE CÁLCULO con el formato de NÚMEROS. Combinar HOJA DE CALCULO con NÚMEROS en C#. Combinar HOJA DE CALCULO.
...
{{% blocks/products/pf/agp/content h2="Combine SPREADSHEETML con NUMBERS en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar SPREADSHEETML con NUMBERS en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para combinar SPREADSHEETML con NUMBERS. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo NUMBERS. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que fusiona SPREADSHEETML con NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar SPREADSHEETML a NUMBERS en C#" InputFormat="xml" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar SPREADSHEETML a NUMBERS a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar SPREADSHEETML con NUMBERS mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar SPREADSHEETML a NUMBERS" %}}
