...
description: Aspose Excel. Chuyển đổi XLS sang ET nhanh chóng và dễ dàng với Aspose.Cells. Java XLS sang ET. Java Lưu XLS vào ET. Lưu XLS dưới dạng ET bằng cách sử dụng Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi XLS sang ET trong Java" h2="Thư viện Java tốc độ cao để chuyển đổi XLS sang ET. Đây là giải pháp phần mềm chuyên nghiệp nhập xuất XLS, ET và nhiều định dạng khác sử dụng Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLS sang ET bằng Java" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLS vào ET vào Java" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLS sang ET trong Java.
...
Cần chuyển đổi tập tin XLS sang ET theo chương trình? Các nhà phát triển Java có thể dễ dàng chuyển đổi XLS sang ET chỉ bằng một vài dòng mã.
