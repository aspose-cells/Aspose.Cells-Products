---
title: Gabungkan XLTM ke PRN - Gabungkan XLTM ke PRN di Java
url: /id/java/merger/merge-xltm-to-prn/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan XLTM ke format simpan PRN. Java Gabungkan XLTM ke format PRN. Gabungkan XLTM ke PRN di Java. XLTM Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLTM ke PRN di Java" %}}
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan XLTM ke PRN di Java" InputFormat="xltm" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLTM menjadi PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLTM ke PRN secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
