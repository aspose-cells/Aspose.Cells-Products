...
هل تحتاج إلى تحويل ملفات MHT إلى XLSM برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل MHT إلى XLSM في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XLSM باستدعاء طريقة Save ().
