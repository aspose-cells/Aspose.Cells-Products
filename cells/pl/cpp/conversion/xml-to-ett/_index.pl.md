...
Trzeba programowo przekonwertować pliki XML do formatu ETT? Programiści C++ mogą łatwo przekonwertować pliki XML do formatu ETT za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XML do ETT wywołując metodę Save().
