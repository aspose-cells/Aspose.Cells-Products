---
title: C# XML na TXT - Konwerter online XML na TXT
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Bezpłatnie online C# Konwersja XML do formatu zapisu TXT. C# Format XML do TXT. Zapisz XML pod numerem TXT C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML do TXT w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować XML na TXT w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XML na TXT. Prześlij swój plik XML, a następnie po prostu zapisz go jako plik TXT. Zarówno do odczytu XML, jak i zapisu TXT można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie TXT będą identyczne z oryginalnym dokumentem XML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji XML na TXT online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="txt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XML na TXT przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XML na TXT? .NET programiści mogą łatwo załadować i przekonwertować XML na TXT w zaledwie kilku wierszach kodu.
...
1.  Konwertuj kod XML na TXT, wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji XML na TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteka do konwersji XML na TXT" %}}
