...
weight: 10
description: Python via Código fonte .Net para inserir Cubo no Excel.
...
{{% blocks/products/pf/agp/content h2="Como inserir um cubo em um arquivo Excel usando Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir o cubo no arquivo Excel usando Python via .Net" %}}
...
+ Selecione Planilha por meio de seu índice.
 + Use o add do shapecollection[método](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) para inserir um cubo na planilha selecionada.
