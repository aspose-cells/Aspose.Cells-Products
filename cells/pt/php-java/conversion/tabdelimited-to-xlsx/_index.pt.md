...
description: Aspose Excel. Converta TABDELIMITED em XLSX de forma rápida e fácil com Aspose.Cells. PHP TABDELIMITED em XLSX. PHP Salve TABDELIMITED em XLSX. Salve TABDELIMITED como XLSX usando PHP.
...
Precisa converter arquivos TABDELIMITED para XLSX programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TABDELIMITED em XLSX em apenas algumas linhas de código.
...
1.  Converta TABDELIMITED em XLSX chamando o método save da pasta de trabalho.
1.  Obtenha o resultado da conversão de TABDELIMITED para XLSX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TABDELIMITED para XLSX" %}}
