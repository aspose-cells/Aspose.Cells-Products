---
title: Konvertera XLTM till JPEG via C#
url: /sv/net/conversion/xltm-to-jpeg/
description: Exempelkod för konvertering av xltm till jpeg C#. Använd API exempelkod för batch-xltm-filer till jpeg-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLTM till JPEG via C#" h2="Exportera Excel®-kalkylark till JPEG-format på .NET Framework, .NET Core, Mono eller Xamarin-plattformar." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Så här konverterar du XLTM till JPEG med C#" %}}

 För att konvertera XLTM till JPEG kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLTM till JPEG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-utvecklare kan enkelt ladda och konvertera XLTM-filer till JPEG på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLTM-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utdatasökväg med JPG-tillägg som parameter1. Kontrollera den angivna sökvägen för den resulterande JPEG-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera XLTM till JPEG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="jpg" IsLandingPage="true" %}}
