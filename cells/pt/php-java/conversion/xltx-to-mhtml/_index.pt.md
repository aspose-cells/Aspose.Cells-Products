---
title: Conversor PHP XLTX para MHTML - XLTX para MHTML
description: Aspose Excel. Converta XLTX em MHTML de forma rápida e fácil com Aspose.Cells. PHP XLTX em MHTML. PHP Salve XLTX em MHTML. Salve XLTX como MHTML usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX em MHTML via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em MHTML programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em MHTML em apenas algumas linhas de código.
...
1.  Converta XLTX em MHTML chamando o método save da pasta de trabalho.
