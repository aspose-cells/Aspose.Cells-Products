---
title: "MHTML konvertálása XLSM-re a következőn keresztül: Java "

description: Minta Java konverziós kód MHTML formátumhoz XLSM fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok XLSM-be exportálására bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="MHTML konvertálása XLSM-re a következőn keresztül: Java" h2="MHTML-ből XLSM-be Java konverzió, amellyel egyetlen vagy több oldalt konvertálhat XLSM-re a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="MHTML konvertálása XLSM-re a következővel: Java" %}}

 Ahhoz, hogy az MHTML-t XLSM-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az MHTML XLSM-re konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak MHTML fájlt XLSM-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be egy MHTML-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XLSM kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XLSM-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="MHTML-ből XLSM-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az MHTML fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.mhtml");
// mentse az MHTML-t XLSM-ként
