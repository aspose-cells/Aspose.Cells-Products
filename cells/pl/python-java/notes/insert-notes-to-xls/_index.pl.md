---
title: Wstaw notatki do pliku XLS pod numerem Python
url: /pl/python-java/notes/insert-notes-to-xls/ 
description: Wstaw notatki do numeru XLS, używając numeru Python. Użyj przykładowego kodu API, aby wstawić notatki w aplikacji Python.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić notatki do pliku XLS poprzez Python" %}}
...
W Office 365 notatki służą do adnotacji, możesz użyć następującego kodu Python, aby wstawiać i usuwać notatki w pliku XLS.

{{% blocks/products/pf/agp/code-block title="Python przykładowy kod do wstawiania i usuwania notatek w pliku XLS" offSpacer="" %}}
