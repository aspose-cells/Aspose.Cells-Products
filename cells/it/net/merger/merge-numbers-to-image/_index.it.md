---
title: Unisci i NUMERI all'IMMAGINE - Combina i NUMERI all'IMMAGINE in C#
url: /it/net/merger/merge-numbers-to-image/ 
description: Aspose Excel. C# Aspose.Cells. Unisci i NUMERI online gratuiti nel formato di salvataggio dell'IMMAGINE. C# Combina NUMERI in formato IMMAGINE. Unisci NUMBERS a IMAGE in C#. NUMBERS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci i NUMERI all\'IMMAGINE in C# online gratuitamente" %}}

L'esempio seguente mostra come unire NUMBERS a IMAGE in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire i NUMERI all'IMMAGINE. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file IMAGE. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedi l'esempio C# che unisce NUMBERS a IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuito online per unire i NUMERI all\'IMMAGINE in C#" InputFormat="numbers" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire i NUMERI all\'IMMAGINE tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

Devi unire NUMBERS a IMAGE in modo programmatico? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET libreria per unire i NUMERI all\'IMMAGINE" %}}
