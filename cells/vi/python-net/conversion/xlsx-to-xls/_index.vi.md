...
description: Aspose Excel. Chuyển đổi XLSX sang XLS nhanh chóng và dễ dàng với Aspose.Cells. Python XLSX sang XLS. Python Lưu XLSX thành XLS. Lưu XLSX thành 07611134 81 sử dụng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLSX thành XLS thành Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLSX vào XLS trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLSX thành XLS trong Python via NET.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi XLSX thành XLS" %}}
