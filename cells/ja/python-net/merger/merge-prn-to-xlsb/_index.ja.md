---
title: PRN を Python 経由で XLSB に結合
url: /ja/python-net/merger/merge-prn-to-xlsb/ 
description: PRN をオンラインで無料で XLSB に結合します。無料のオンライン PRN XLSB 合併。 PRN を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、PRN を Python の XLSB にマージする方法を示しています。
...
{{% cells-merger title="PRNをオンラインでXLSBにマージする無料アプリ" InputFormat="prn" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
