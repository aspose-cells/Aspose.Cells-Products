...
description: Aspose Excel. C++ Aspose.Cells. Sloučit XLTX do XLT uložit formát. C++ Kombinujte formát XLTX až XLT. Sloučit XLTX až XLT v C++. XLTX Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTX až XLT v C++" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLTX až XLT v C++" InputFormat="xltx" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
