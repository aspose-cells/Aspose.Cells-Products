...
ต้องการแปลงไฟล์ TABDELIMITED เป็น TABDELIMITED โดยอัตโนมัติหรือไม่? นักพัฒนาสามารถแปลงไฟล์ TABDELIMITED เป็น TABDELIMITED ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด (รหัส C++)
...
1.  แปลงรูปแบบ TABDELIMITED เป็น TABDELIMITED โดยเรียกใช้เมธอด Save()
