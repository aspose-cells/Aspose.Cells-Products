---
title: A XLS egyesítése a NUMBERS-szel – a XLS-es szám egyesítése a NUMBERS-szel a Python-ben
url: /hu/python-net/merger/merge-xls-to-numbers/ 
description: Aspose Excel. Python Aspose.Cells. Ingyenes online egyesítés XLS NUMBERS mentési formátumba. Python Kombinálja a XLS számot NUMBERS formátumba. A XLS egyesítése a NUMBERS számmal a Python-ben. XLS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Egyesítse a XLS-et a NUMBERS-szel a Python-es szám használatával" %}}

Hogyan egyesíthetem a XLS számot a NUMBERS számmal? A Aspose.Cells for Python via .NET könyvtárral egyszerűen egyesítheti a XLS számot a NUMBERS számmal néhány sornyi kóddal.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python)képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. Python Excel API nem csak a táblázatformátumok között konvertál, hanem Excel fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, CSV, CSV, CSV, CSV, CSV, SVG, és így tovább, SVG P, 8 PT a választás,3,8 ipari szabvány szerinti dokumentumok cseréjére formátumok. A Aspose.Cells for Python via .NET számot innen telepítheti.<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , használja a parancsot a következőképpen:<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Csatlakoztassa a XLS-es számot a NUMBERS-hez a Python-ben online ingyen" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a XLS-et a NUMBERS-szel a Aspose.Cells-es for Python-es via .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLS és a NUMBERS számok egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el NUMBERS fájlba. Ha kódot fejleszt a Python-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Python-es példát, amely egyesíti a XLS-et a NUMBERS-szel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online összevonás a XLS számmal a NUMBERS számmal a Python-ben" InputFormat="xls" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="A XLS és a NUMBERS egyesítése a Python számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLS-es számot a NUMBERS számmal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="Python könyvtár a XLS és a NUMBERS egyesítéséhez" %}}
