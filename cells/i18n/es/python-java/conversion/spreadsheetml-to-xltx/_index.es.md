---
title: Convierta SPREADSHEETML a XLTX a través de Python
url: /es/python-java/conversion/spreadsheetml-to-xltx/
description: Código de muestra para la conversión de hoja de cálculo a xltx Python. Utilice el código de ejemplo API para la conversión de archivos de hoja de cálculo ml por lotes a xltx dentro de la aplicación Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta SPREADSHEETML a XLTX a través de Python" h2="Exporte hojas de cálculo de Excel® a formato XLTX utilizando Python API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir SPREADSHEETML a XLTX usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir SPREADSHEETML a XLTX a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Python pueden cargar y convertir fácilmente archivos SPREADSHEETML a XLTX con solo unas pocas líneas de código.
