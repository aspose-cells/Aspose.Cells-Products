---
title:  แทรกปุ่มหมุน (การควบคุมแบบฟอร์ม) ลงใน Excel โดยใช้ Python via java
weight: 40
description: Python via ซอร์สโค้ด Java เพื่อแทรกปุ่มหมุน (การควบคุมแบบฟอร์ม) ลงใน Excel
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกปุ่มหมุน (การควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via java" %}}

 เพื่อที่จะแทรกปุ่มหมุน (การควบคุมแบบฟอร์ม) ลงในไฟล์ Excel เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรกปุ่มหมุน (การควบคุมฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python via java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้รูปทรงของคอลเลกชัน[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addSpinner(int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกปุ่มหมุน (ตัวควบคุมแบบฟอร์ม) ในแผ่นงานที่เลือก
...
{{% blocks/products/pf/agp/code-block title="ใส่ปุ่มหมุน(การควบคุมแบบฟอร์ม) - Python via java" offSpacer="" %}}
