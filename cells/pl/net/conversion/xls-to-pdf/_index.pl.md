---
title: C# XLS do PDF - XLS do PDF Konwerter
description: Aspose Excel. Konwertuj XLS na PDF szybko i łatwo za pomocą Aspose.Cells. C# XLS na PDF. C# Zapisz XLS na PDF. Zapisz XLS jako 0761113 481 pod numerem C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do PDF w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na PDF w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować numer XLS na numer PDF. Prześlij plik XLS, a następnie po prostu zapisz go jako plik PDF. Zarówno do odczytu XLS, jak i do zapisu PDF można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego PDF będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLS na PDF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="pdf" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na PDF przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na PDF? Programiści .NET mogą łatwo załadować i przekonwertować XLS na PDF w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLS na PDF" %}}
