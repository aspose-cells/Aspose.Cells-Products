...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل الأرقام إلى صيغة TABDELIMITED في C#" h2="مكتبة C# عالية السرعة لتحويل الأرقام إلى تنسيق TABDELIMITED. هذا حل برمجي احترافي لاستيراد وتصدير الأرقام، وتنسيق TABDELIMITED، والعديد من التنسيقات الأخرى على منصات .NET Framework، و.NET Core، وMono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
هل تحتاج إلى تحويل NUMBERS من الملفات إلى TABDELIMITED برمجيًا؟ يمكن لمطوري .NET تحميل وتحويل الأرقام بسهولة إلى TABDELIMITED في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الأرقام إلى TABDELIMITED عن طريق استدعاء طريقة Workbook.Save.
