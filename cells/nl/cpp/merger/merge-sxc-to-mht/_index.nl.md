...
description: Aspose Excel. C++ Aspose.Cells. Voeg SXC samen naar MHT-opslagformaat. C++ Combineer SXC naar MHT-formaat. Voeg SXC samen met MHT in C++. SXC Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg SXC samen met MHT in C++" %}}

Het volgende voorbeeld laat zien hoe u SXC samenvoegt met MHT in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om SXC samen te voegen met MHT. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een MHT-bestand. Als u code ontwikkelt in C++, zal dit eenvoudiger zijn dan het klinkt. Zie voorbeeld C++ waarin SXC wordt samengevoegd met MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om SXC samen te voegen met MHT in C++" InputFormat="sxc" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe u SXC samenvoegt met MHT via C++" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u SXC programmatisch samenvoegen met MHT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
