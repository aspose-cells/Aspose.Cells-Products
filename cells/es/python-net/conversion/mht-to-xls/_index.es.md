...
description: Aspose Excel. Convierta MHT a XLS rápida y fácilmente con Aspose.Cells. Python MHT a XLS. Python Guarde MHT en XLS. Guarde MHT como XLS usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde MHT en XLS en Python" %}}

El siguiente ejemplo demuestra cómo convertir MHT a XLS en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir MHT a XLS" %}}
