...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in ODS mit Aspose.Cells. PHP OTS in ODS. PHP Speichern Sie OTS in ODS. Speichern Sie OTS mit PHP als ODS.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über PHP in ODS" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in ODS konvertieren? PHP-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in ODS konvertieren.
...
1.  Konvertieren Sie OTS in ODS, indem Sie die Save-Methode von Workbook aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von OTS in ODS" %}}
