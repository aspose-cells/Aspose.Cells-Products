...
description: Aspose Excel. Questa soluzione completa fornisce agli sviluppatori C++ un approccio completamente integrato per convertire OTS nel formato PDF, consentendo il salvataggio senza interruzioni dei dati OTS nel formato PDF utilizzando la libreria Aspose.Cells, il tutto tramite codice C++ efficiente e personalizzabile.
...
{{% blocks/products/pf/agp/content h2="Salva OTS a PDF in C++" %}}
...
Hai bisogno di convertire i file OTS in PDF tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire OTS in PDF in poche righe di codice.
...
1.  Convertire OTS in PDF chiamando il metodo Save().
