...
Ví dụ sau minh họa cách hợp nhất HTML thành SỐ trong Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Cần hợp nhất HTML thành SỐ theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API có thể được thực hiện chỉ với vài dòng mã.
