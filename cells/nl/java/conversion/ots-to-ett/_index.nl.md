...
{{% blocks/products/pf/agp/content h2="OTS omzetten naar ETT met behulp van Java" %}}
...
Het volgende voorbeeld laat zien hoe je OTS naar ETT converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar ETT via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u OTS-bestanden programmatisch naar ETT converteren? Ontwikkelaars van Java kunnen OTS-bestanden eenvoudig naar ETT converteren met slechts een paar regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek voor het converteren van OTS naar ETT" %}}
{{% blocks/products/pf/agp/text %}}
