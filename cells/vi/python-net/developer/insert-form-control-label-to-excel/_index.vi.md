---
title:  Chèn Nhãn (Điều khiển biểu mẫu) vào Excel bằng Python via .Net
weight: 80
description: Python via Mã nguồn .Net để chèn Nhãn(Điều khiển biểu mẫu) vào Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn Nhãn (Điều khiển biểu mẫu) vào Excel bằng Python via .Net" h2="Chèn các đối tượng bằng API phía máy chủ mà không cần bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF, v.v." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chèn Nhãn (Điều khiển biểu mẫu) vào Tệp Excel Bằng Python via .Net" %}}

 Để chèn Nhãn (Điều khiển biểu mẫu) vào tệp excel, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn Label(Form control) vào file Excel bằng Python via .Net" %}}
...
+ Chọn Worksheet qua chỉ mục của nó.
 + Sử dụng add của shapecollection[phương pháp](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_label/#int-int-int-int-int-int) để chèn Nhãn (Điều khiển biểu mẫu) trong trang tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn nhãn(Form control) - Python via .Net" offSpacer="" %}}
