...
El siguiente ejemplo demuestra cómo fusionar PNG con MHT en Aspose.Cells for Python via .NET.
...
¿Necesita fusionar PNG con MHT mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Las API se pueden crear con solo unas pocas líneas de código.
