---
title: Làm cách nào để vẽ hoặc chèn mũi tên thẳng kép vào Excel bằng Python via .Net
weight: 10
description: Python via. Mã nguồn .Net vẽ hoặc chèn mũi tên thẳng kép vào Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chèn mũi tên thẳng kép vào Excel dùng Python via .Net" h2="Chèn mũi tên thẳng kép dùng Aspose.Cells\' API không cần phần mềm nào như Microsoft hay Open Office, Adobe PDF..." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chèn mũi tên thẳng kép vào file Excel bằng Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn mũi tên thẳng kép vào file Excel dùng Python via .Net" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng phần bổ sung của bộ sưu tập hình dạng[phương pháp](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) để chèn một mũi tên thẳng kép vào bảng tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn mũi tên thẳng kép - Python via .Net" offSpacer="" %}}
