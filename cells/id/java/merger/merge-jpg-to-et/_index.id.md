...
description: Aspose Unggul. Java Aspose.Cells. Gabungkan format penyimpanan JPG ke ET. Java Gabungkan format JPG ke ET. Gabungkan JPG ke ET di Java. Gabungkan JPG.
...
{{% blocks/products/pf/agp/content h2="Gabungkan JPG ke ET di Java" %}}

Contoh berikut menunjukkan cara menggabungkan JPG ke ET di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan JPG ke ET. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file ET. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan JPG ke ET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan JPG ke ET secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk menggabungkan JPG ke ET" %}}
