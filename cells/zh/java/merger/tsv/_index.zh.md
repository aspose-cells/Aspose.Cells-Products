---
title: 合并 TSV 文件 via Java
weight: 9260
description: Java 示例代码，用于组合 Java JSP/JSF 应用程序和桌面应用程序运行时环境上的 TSV 文档。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="合并 Java 中的 TSV 格式" h2="使用服务器端 Java API 进行本机 TSV 文档合并。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 合并 TSV 文件" %}}

为了合并 TSV 文件，我们将使用[Aspose.Cells for Java](https://products.aspose.com/cells/java)API这是一个功能丰富、功能强大且易于使用的合并API for Java平台。您可以直接从以下位置下载其最新版本[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells)并通过将以下配置添加到 pom.xml 将其安装在基于 Maven 的项目中。
...
{{% blocks/products/pf/agp/feature-section-col title="合并 Java 中的 TSV 文件的步骤" %}}
...
使用 Workbook 类的实例加载第一个 TSV 文件。
+ 使用 Workbook 类的实例加载第二个 TSV 文档。
+ 使用combine() 方法合并文件。
+ 将合并后的TSV文件保存在指定路径
...
{{% blocks/products/pf/agp/code-block title="合并 TSV 文件 - Java" offSpacer="" %}}
