---
title: تحويل TABDELIMITED إلى TXT عبر Java 
url: /ar/java/conversion/tabdelimited-to-txt/ 
description: نموذج Java رمز التحويل لتنسيق TABDELIMITED إلى ملف TXT. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى TXT داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TABDELIMITED إلى TXT عبر Java" h2="TABDELIMITED لتحويل TXT Java لتحويل صفحات مفردة أو صفحات متعددة إلى TXT باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TABDELIMITED إلى TXT باستخدام Java" %}}

 من أجل تقديم TABDELIMITED إلى TXT ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل TABDELIMITED إلى TXT عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف TABDELIMITED إلى TXT في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف TABDELIMITED مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد TXT و SaveFormat كمعلمات1. تحقق من المسار المحدد لملف TXT الناتج
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED إلى TXT Java رمز مصدر التحويل" offSpacer="" %}}

```cs
// تحميل ملف TABDELIMITED في مثيل المصنف
Workbook book = new Workbook("template.tabdelimited");
// احفظ TABDELIMITED كـ TXT
...
{{< blocks/products/pf/agp/demobox sectionTitle="TABDELIMITED إلى TXT Conversion Live Demos" sectionDescription="[تحويل TABDELIMITED إلى TXT](https://products.aspose.app/cells/conversion/tabdelimited-to-txt) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف TABDELIMITED الخاص بك ، وسيتم تحويله على الفور إلى TXT." >}}
