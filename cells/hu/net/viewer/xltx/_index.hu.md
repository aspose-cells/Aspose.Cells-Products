---
title: " Tekintse meg a XLTX fájlformátumokat: via .NET"
weight: 7870
description: C# forráskód XLTX dokumentum betöltéséhez, megjelenítéséhez és megjelenítéséhez a .NET Framework, .NET Core, Mono vagy Xamarin platformokon.
...
{{% blocks/products/pf/agp/feature-section-col title="A XLTX-es szám megtekintésének lépései a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 A Aspose.Cells egyszerűvé teszi a fejlesztők számára a XLTX fájl megtekintését néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1.  Töltse be a XLTX fájlt a munkafüzet egy példányába
1.  Hozzon létre egy HtmlSaveOptions példányt, és állítsa igazra az ExportHeadings tulajdonságot
1. Mentse a XLTX-es fájlt HTML-es formátumban a munkafüzet használatával. Mentés módszere
...
{{% blocks/products/pf/agp/code-block title="C# példakód a XLTX fájl megtekintéséhez" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API használható Microsoft Excel formátumok létrehozására, szerkesztésére, konvertálására és renderelésére különböző formátumokba. Ezen túlmenően használható átfogó diagramok készítésére, skálázható jelentésekre és megbízható számításokra a szoftveralkalmazásokon belül. A Aspose.Cells egy önálló API, és nem igényel olyan szoftvert, mint a Microsoft vagy az OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a XLTX szám megtekintéséhez" sectionDescription=" Tekintse meg élő bemutatóinkat[Tekintse meg: XLTX](https://products.aspose.app/cells/viewer/xltx) a következő előnyökkel." >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nem kell letölteni vagy beállítani semmit" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni vagy fordítani" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a XLTX fájlt, és nyomja meg a \"Nézet\" gombot" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Ha szükséges, töltse le a XLTX-es fájlt a hivatkozásról" >}}

        {{< blocks/products/pf/agp/i18n/about-file-text fileFormat="XLTX" readMoreLink="https://docs.fileformat.com/spreadsheet/xltx/" >}}
XLTX kiterjesztésű fájlok a Microsoft Excel-sablonfájlokat jelentik, amelyek az Office OpenXML fájlformátum-specifikációkon alapulnak. Egy szabványos sablonfájl létrehozására szolgál, amely felhasználható XLSX fájlok létrehozására, amelyek a XLTX fájlban megadott beállításokkal megegyező beállításokat mutatnak.
