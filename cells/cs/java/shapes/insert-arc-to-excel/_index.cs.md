---
title:  Vložte Arc do Excelu via Java
weight: 10
...
{{< blocks/products/pf/i18n/upper-banner h1="Vložte Arc do Excelu via Java" h2="Vkládejte objekty pomocí rozhraní API na straně serveru bez jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF atd." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak vložit oblouk do souboru aplikace Excel pomocí Java" %}}

 Abychom mohli Arc vložit do excelového souboru, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vložení Arc do souboru Excel via Java" %}}
...
+ Vyberte List přes jeho index.
 + Použijte[přidat metodu](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addArc-int-int-int-int-int-int-) pro vložení Arc do vybraného listu
...
{{% blocks/products/pf/agp/code-block title="Vložit oblouk - Java" offSpacer="" %}}
