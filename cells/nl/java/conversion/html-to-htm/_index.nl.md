...
{{% blocks/products/pf/agp/content h2="Sla HTML op in HTM in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML naar HTM kunt converteren in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je HTML naar HTM via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u HTML-bestanden programmatisch naar HTML converteren? Ontwikkelaars van Java-bestanden kunnen HTML-bestanden eenvoudig in een paar regels code naar HTML converteren.
