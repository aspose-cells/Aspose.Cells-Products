...
{{% blocks/products/pf/agp/code-block title="Following source code shows how to create a Word ODS file using C++." offSpacer="" %}}
...
A Document Processing Library to perform a wide range of document creation, management and manipulation tasks including ODS generation, editing, conversion, rendering and printing. C++ Word library supports all of word-processing formats as well as allows exporting or converting ODS to PDF, HTML, fixed-layout and most commonly used image & multimedia formats.
