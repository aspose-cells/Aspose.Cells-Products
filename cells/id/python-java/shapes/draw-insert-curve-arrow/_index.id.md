---
title: Cara menggambar atau menyisipkan bentuk panah melengkung ke dalam excel menggunakan Python via Java
weight: 10
...
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan bentuk panah melengkung ke dalam Excel menggunakan Python via Java" h2="Masukkan bentuk panah melengkung menggunakan Aspose.Cells\' API tanpa software seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Memasukkan Bentuk Panah Melengkung Ke File Excel Menggunakan Python via Java" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan koleksi bentuk[menambahkan metode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) untuk menyisipkan bentuk panah melengkung di lembar kerja yang dipilih.
