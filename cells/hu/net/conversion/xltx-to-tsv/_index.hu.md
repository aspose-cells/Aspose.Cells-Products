...
description: Aspose Excel. A XLTX-es számot TSV-re gyorsan és egyszerűen a Aspose.Cells-es számmal alakíthatja át. C# XLTX-TSV-re. 13481 a C# számon.
...
{{% blocks/products/pf/agp/content h2="Mentse a XLTX-TSV számot a C#-es számon" %}}

A következő példa bemutatja, hogyan lehet a XLTX-et TSV-re konvertálni a C#-ben.
...
{{% cells-convert title="Mintakód a XLTX TSV-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="tsv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="A XLTX konvertálása TSV-re a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A XLTX fájlt programozottan TSV-re kell konvertálni? A .NET fejlesztők néhány sornyi kóddal könnyedén betölthetik és konvertálhatják a XLTX-et TSV-re.
...
1.  Konvertálja a XLTX-et TSV-re a Workbook.Save metódus meghívásával.
1.  Szerezze meg a XLTX-es konverziós eredményt TSV-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a XLTX konvertálásához TSV-re" %}}
