---
title: Creëer TIFF - Creëer TIFF bestand in C#
description: Aspose Excel. C# Creëer TIFF-bestand. Creëer TIFF C#. C# TIFF Maker. Maak TIFF in C#. Genereer TIFF-bestand met C#.
...
{{% blocks/products/pf/agp/content h2="Hoe TIFF te maken in C#" %}}

{{% blocks/products/pf/agp/text %}}

 Het is gemakkelijk voor de ontwikkelaars om TIFF-bestanden te maken, laden, wijzigen en converteren binnen verschillende rapportagetoepassingen voor gegevensverwerking in slechts een paar regels code.
...
1. Gebruik de methode Save om de werkmap op te slaan als TIFF-bestand.

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u een TIFF-bestand maakt in C#." offSpacer="" %}}
