---
title:  通過 .NET 將 XLSB 文檔圖表轉換為圖像 
weight: 8560

description: C# 用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上繪製和轉換 XLSB 文件中的圖表或圖表的源代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB 文件圖表到 C# 中的圖像" h2="使用服務器端 API 將本機和高性能 XLSB 文檔圖表轉換為圖像，無需使用任何軟件，如 Microsoft 或 Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中轉換 XLSB 文件圖表的步驟" %}}
