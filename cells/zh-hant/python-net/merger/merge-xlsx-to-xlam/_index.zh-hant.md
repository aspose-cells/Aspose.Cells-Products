...
description: Aspose Excel。 Python Excel。將 XLSX 合併到 XLAM 儲存格式。 Python 將 XLSX 合併為 XLAM 格式。將 Python Excel 庫中的 XLSX 合併到 XLAM。 XLSX 合併。
...
{{% blocks/products/pf/agp/content h2="使用 Python Excel 庫將 XLSX 合併到 XLAM" %}}

如何將 XLSX 合併到 XLAM？使用 Aspose.Cells for Python via .NET 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆地將 XLSX 合併到 XLAM。[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Python Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。您可以安裝 Aspose.Cells for Python via .NET<a href="https://pypi.org/project/aspose-cells-python/">pypi</a>，使用指令為：<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="將 XLSX 合併到 Python Excel 庫中的 XLAM" %}}

以下範例示範如何將 Aspose.Cells for Python via .NET 中的 XLSX 合併到 XLAM。
{{% blocks/products/pf/agp/text %}}

依照簡單的步驟將 XLSX 合併到 XLAM。如果您在 Python 中開發程式碼，這會比聽起來更簡單。請參閱將 XLSX 合併到 XLAM 的 Python 範例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="將 Python Excel 庫中的 XLSX 合併到 XLAM 的範例程式碼" InputFormat="xlsx" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何透過 Python Excel 庫合併 XLSX 到 XLAM" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 XLSX 合併到 XLAM 嗎？基本文檔合併和連接[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2="Python庫將XLSX合併至XLAM" %}}
