---
title: Połącz MHT z TIFF - Połącz MHT z TIFF w Java
url: /pl/java/merger/merge-mht-to-tiff/ 
description: Aspose Excel. Java Aspose.Cells. Połącz MHT z formatem zapisu TIFF. Java Połącz format MHT z formatem TIFF. Połącz MHT z TIFF w Java. Połącz MHT.
...
{{< blocks/products/pf/i18n/upper-banner h1="Połącz MHT z numerem TIFF via Java" h2="Szybka biblioteka Java do łączenia MHT z TIFF. Skorzystaj z naszej konwersji Excela API, aby opracować zaawansowane, niezależne od platformy oprogramowanie w Java. Jest to profesjonalne rozwiązanie do importowania i eksportowania Excel, CSV, OpenOffice, PDF, HTML, image i wielu innych formatów Excela." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="MHT" additionalConversionTag="TIFF" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Połącz MHT z TIFF w Java" %}}

Poniższy przykład pokazuje, jak połączyć MHT z TIFF w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć MHT z numerem TIFF. Prześlij pliki, wywołaj metodę Workbook.Combine w celu łączenia plików, a następnie zapisz je w pliku TIFF. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy MHT z TIFF.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia MHT z TIFF w Java" InputFormat="mht" InputFormat2="tiff" outformat="tiff" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć MHT z numerem TIFF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo połączyć MHT z TIFF? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do połączenia MHT z TIFF" %}}
