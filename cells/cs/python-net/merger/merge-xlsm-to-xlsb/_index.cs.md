---
title:  Sloučit XLSM na XLSB přes Python
...
Následující příklad ukazuje, jak sloučit XLSM až XLSB v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM až XLSB online" InputFormat="xlsm" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
