---
title: Gộp MHTML vào ETT - Gộp MHTML vào ETT vào C#
url: /vi/net/merger/merge-mhtml-to-ett/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất MHTML thành định dạng lưu ETT. C# Kết hợp MHTML thành định dạng ETT. Hợp nhất MHTML với ETT vào C#. MHTML Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất MHTML vào ETT vào C#" %}}

Ví dụ sau đây minh họa cách hợp nhất MHTML với ETT trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất MHTML với ETT. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp ETT. Nếu bạn phát triển mã theo số C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất MHTML với ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp MHTML vào ETT năm C#" InputFormat="mhtml" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất MHTML với ETT qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất MHTML với ETT theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để hợp nhất MHTML vào ETT" %}}
