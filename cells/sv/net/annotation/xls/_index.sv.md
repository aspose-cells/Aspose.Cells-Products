---
title:  Lägg till eller ta bort XLS Anteckning via .NET
weight: 9270
description: C# källkod för att lägga till och ta bort XLS formatkommentarer på .NET Framework, .NET Core, Mono eller Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="Lägg till eller ta bort anteckning från XLS via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ta bort kommentarer från XLS - C#" offSpacer="" %}}
