...
Office 365 में, नोट्स एनोटेशन के लिए हैं, आप XLSM फ़ाइल में नोट्स डालने और हटाने के लिए निम्नलिखित Python कोड का उपयोग कर सकते हैं।
...
{{% cells-annotation title="XLSM फ़ाइल से एनोटेशन हटाने के लिए निःशुल्क ऐप" InputFormat="xlsm" IsLandingPage="true" language="python" %}}
