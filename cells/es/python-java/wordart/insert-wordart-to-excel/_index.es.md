...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar un archivo de WordArt a Excel usando Python via Java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa la colección de formas[agregar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addWordArt(int,%20java.lang.String,%20int,%20int,%20int,%20int,%20int,%20int)) para insertar un WordArt en la hoja de trabajo seleccionada.
