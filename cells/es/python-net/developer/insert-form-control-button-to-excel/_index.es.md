...
{{% blocks/products/pf/agp/content h2="Cómo insertar un botón (control de formulario) en un archivo de Excel usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar el botón (control de formulario) en un archivo de Excel a través de Python" %}}
...
+ Utilice el método de adición de la colección de formas para insertar un botón (control de formulario) en la hoja de trabajo seleccionada.
...
{{% blocks/products/pf/agp/code-block title="Insertar botón (control de formulario) - Python" offSpacer="" %}}
