---
title: Python XLS naar ODS - Online XLS naar ODS Converter
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Gratis online Python Converteer XLS naar ODS saveformat. Python XLS tot ODS formaat. Bewaar XLS tot ODS Python.
...
1.  Converteer XLS naar ODS door de methode Workbook.save aan te roepen.
1.  Verkrijg het conversieresultaat van XLS naar ODS.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python bibliotheek om XLS naar ODS te converteren" %}}
