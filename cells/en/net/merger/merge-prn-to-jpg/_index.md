...
url: /net/merger/merge-prn-to-jpg/ 
...
The following example demonstrates how to merge PRN to JPG in Aspose.Cells for .NET.
...
Need to merge PRN to JPG programmatically? A basic document merging and concatenating with [Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs can be done with just few lines of code.
...
{{% blocks/products/pf/agp/content h2=".NET library to merge PRN to JPG" %}}
