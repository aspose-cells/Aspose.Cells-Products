...
{{% cells-convert title="تطبيق مجاني ورمز عينة لتحويل XLT إلى XLSX عبر الإنترنت" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل XLT إلى XLSX عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن للمطورين .NET تحميل وتحويل XLT إلى XLSX بسهولة في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1.  قم بتحميل ملف XLT بنسخة المصنف
1.  حول XLT إلى XLSX عن طريق استدعاء Workbook.Save method
