...
weight: 7690
description: C# Código de muestra para la conversión de XLSM a Byte Array. Use este código para la conversión de Excel XLSM a Byte Array dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta XLSM en una matriz de bytes a través de C#" h2="Nativo y de alto rendimiento Microsoft Excel XLSM a conversión de matriz de bytes o viceversa para el procesamiento de datos de hojas de cálculo utilizando las API del lado del servidor .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array es útil para el procesamiento o almacenamiento de datos. Puede convertir el archivo XLSM a Byte Array, así como un**Matriz de bytes a XLSM** documento utilizando el idioma C#. Para convertir XLSM en una matriz de bytes, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 Es fácil para los desarrolladores cargar y convertir archivos XLSM en una matriz de bytes para realizar más tareas de manipulación en solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1.  Incluya el espacio de nombres en su archivo de clase
1.  Cargar entrada XLSM Archivo usando Workbook
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra XLSM a la matriz de bytes C# Conversión" offSpacer="" %}}
