...
{{% blocks/products/pf/agp/content h2="Enregistrez les numéros chez TABDELIMITED au C#" %}}

L'exemple suivant montre comment convertir des NUMÉROS en TABDELIMITED dans C#.
...
Besoin de convertir des fichiers NUMBERS en TABDELIMITED par programme ? Les développeurs .NET peuvent facilement charger et convertir NUMBERS en TABDELIMITED en quelques lignes de code.
...
1.  Convertissez les nombres en format TABDELIMITED en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de NUMBERS en TABDELIMITED.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir les nombres en format à tabulation." %}}
