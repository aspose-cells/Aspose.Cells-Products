...
{{% blocks/products/pf/agp/content h2="Преобразовать HTML в XPS, используя Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTML в XPS в Java" %}}
...
Нужно программно преобразовать файлы HTML в XPS? Разработчики, работающие с файлами Java, могут легко преобразовать файлы HTML в XPS всего несколькими строками кода.
