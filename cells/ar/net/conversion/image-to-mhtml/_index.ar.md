---
title: تحويل C# صورة إلى MHTML - صورة إلى MHTML
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C# نهجًا متكاملًا تمامًا لتحويل IMAGE إلى تنسيق MHTML، مما يتيح حفظ بيانات IMAGE بسلاسة في تنسيق MHTML باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C# فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في MHTML في C#" %}}
...
هل تحتاج إلى تحويل ملفات IMAGE إلى MHTML برمجياً؟ يمكن لمطوري .NET تحميل وتحويل IMAGE إلى MHTML بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الصورة إلى MHTML عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل IMAGE إلى MHTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل الصورة إلى MHTML" %}}
