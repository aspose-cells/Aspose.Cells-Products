---
title: Połącz NUMBERS z POWERPOINT - Połącz NUMBERS z POWERPOINT w Java
url: /pl/java/merger/merge-numbers-to-powerpoint/ 
description: Aspose Excel. Java Aspose.Cells. Scal NUMBERS do formatu zapisu POWERPOINT. Java Połącz LICZBY do formatu POWERPOINT. Scal NUMBERS z POWERPOINT w Java. NUMBERS Scal.
...
{{% blocks/products/pf/agp/content h2="Połącz NUMBERS z POWERPOINT w Java" %}}

Poniższy przykład ilustruje, jak połączyć NUMBERS z POWERPOINT w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć NUMBERS z POWERPOINT. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku POWERPOINT. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy NUMBERS z POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia NUMBERS z POWERPOINT w Java" InputFormat="numbers" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć NUMERY z POWERPOINT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć NUMBERS z POWERPOINT? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do łączenia NUMBERS z POWERPOINT" %}}
