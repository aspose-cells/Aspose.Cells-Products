...
description: Aspose Excel. Konwertuj PRN na XLTX szybko i łatwo za pomocą Aspose.Cells. Python PRN na XLTX. Python Zapisz PRN na XLTX. Zapisz PRN jako XLTX używając Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj PRN na XLTX za pomocą Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz PRN pod numerem XLTX w Python" %}}

Poniższy przykład ilustruje sposób konwersji PRN na XLTX w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji PRN na XLTX" %}}
