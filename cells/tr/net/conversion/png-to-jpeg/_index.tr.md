---
title: C# PNG ila JPEG - PNG ila JPEG Dönüştürücü
description: Aspose Excel. Bu kapsamlı çözüm, C# geliştiricilerine PNG'i JPEG formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, PNG verilerinin JPEG formatına Aspose.Cells kütüphanesi kullanılarak sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C# kod aracılığıyla gerçekleştirilir.
...
{{% blocks/products/pf/agp/content h2="PNG\'i JPEG olarak C#\'e kaydedin." %}}

Aşağıdaki örnek, C#'de PNG'i JPEG'e nasıl dönüştüreceğinizi göstermektedir.
{{% blocks/products/pf/agp/text %}}

PNG'i JPEG'e dönüştürmek için kolay adımları izleyin. PNG dosyanızı yükleyin, ardından JPEG dosyası olarak kaydedin. Hem PNG okuma hem de JPEG yazma için tam nitelikli dosya adlarını kullanabilirsiniz. JPEG çıktısının içeriği ve biçimlendirmesi, orijinal PNG belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="PNG sayısını JPEG sayısına dönüştürmek için örnek kod." formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="png" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PNG\'i C# aracılığıyla JPEG\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PNG dosyalarını program aracılığıyla JPEG'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PNG'i kolayca yükleyebilir ve JPEG'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak PNG değerini JPEG değerine dönüştürün.
1.  PNG'den JPEG'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PNG\'i JPEG\'e dönüştürmek için C# kütüphanesi" %}}
