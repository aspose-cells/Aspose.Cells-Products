---
title: Comment dessiner ou insérer une double flèche droite dans Excel à l'aide de Python via .Net
weight: 10
description: Python via Code source .Net pour dessiner ou insérer une double flèche droite dans Excel.
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez l'ajout de shapecollection[méthode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) pour insérer une double flèche droite dans la feuille de calcul sélectionnée.
