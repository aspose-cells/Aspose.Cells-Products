---
title: Conversor PHP SXC para XLSM - SXC para XLSM
description: Aspose Excel. Converta SXC em XLSM de forma rápida e fácil com Aspose.Cells. PHP SXC em XLSM. PHP Salve SXC em XLSM. Salve SXC como XLSM usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em XLSM via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em XLSM programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em XLSM em apenas algumas linhas de código.
...
1.  Converta SXC em XLSM chamando o método save da pasta de trabalho.
