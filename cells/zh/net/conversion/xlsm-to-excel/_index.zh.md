...
{{% blocks/products/pf/agp/content h2="免费在线保存XLSM到C#中的EXCEL" %}}

以下示例演示如何将XLSM转换为C#中的EXCEL。
...
{{% cells-convert title="将 XLSM 在线转换为 EXCEL 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过C#将XLSM转换成EXCEL" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 开发人员只需几行代码即可轻松加载 XLSM 并将其转换为 EXCEL。

{{% /blocks/products/pf/agp/text %}}

1. 使用工作簿实例加载 XLSM 文件
1. 通过调用Workbook.Save方法将XLSM转换成EXCEL

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#库将XLSM转EXCEL" %}}
