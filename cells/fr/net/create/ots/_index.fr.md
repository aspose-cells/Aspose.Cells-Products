---
title: Créer OTS - Créer un fichier OTS dans C#
description: Aspose Excel. Générez et manipulez facilement des fichiers OTS grâce à la bibliothèque Aspose.Cells for .NET. Cette puissante bibliothèque API offre une solution simplifiée et efficace pour créer, modifier et gérer des fichiers OTS directement dans vos applications C#, répondant ainsi avec une grande précision aux besoins spécifiques des développeurs.
...
{{% blocks/products/pf/agp/content h2="Comment créer un OTS dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="L\'exemple de code montre comment créer un fichier OTS en C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour créer un fichier OTS" %}}
