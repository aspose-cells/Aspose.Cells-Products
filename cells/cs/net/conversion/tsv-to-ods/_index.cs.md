...
{{% blocks/products/pf/agp/content h2="Jak převést TSV na ODS pomocí C#" %}}
 ...
 K převodu TSV na ODS použijeme
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři .NET mohou snadno načíst a převést soubory TSV na ODS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TSV s instancí sešitu1. Zavolejte metodu Workbook.Save1. Předejte výstupní cestu s rozšířením ODS jako parametrem1. Zkontrolujte zadanou cestu pro výsledný soubor ODS
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod TSV na ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="ods" IsLandingPage="true" %}}
