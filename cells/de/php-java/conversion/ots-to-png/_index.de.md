...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in PNG mit Aspose.Cells. PHP OTS in PNG. PHP Speichern Sie OTS in PNG. Speichern Sie OTS mit PHP als PNG.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über PHP in PNG" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in PNG konvertieren? PHP-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in PNG konvertieren.
...
1.  Konvertieren Sie OTS in PNG, indem Sie die Save-Methode von Workbook aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in PNG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von OTS in PNG" %}}
