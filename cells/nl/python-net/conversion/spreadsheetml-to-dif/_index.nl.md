...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML converteren naar DIF in Python" %}}
...
In het volgende voorbeeld ziet u hoe u SPREADSHEETML converteert naar DIF in Python via NET.
