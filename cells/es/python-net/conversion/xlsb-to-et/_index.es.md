...
description: Aspose Excel. Convierta XLSB a ET rápida y fácilmente con Aspose.Cells. Python XLSB a ET. Python Guardar XLSB en ET. Guarde XLSB como ET usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde XLSB en ET en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSB a ET en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir XLSB a ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="et" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSB a ET" %}}
