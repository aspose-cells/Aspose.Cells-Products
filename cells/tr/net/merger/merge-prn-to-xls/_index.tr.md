---
title: PRN'yi XLS ile birleştir - PRN'yi XLS ile C# olarak birleştir
url: /tr/net/merger/merge-prn-to-xls/ 
description: Aspose excel. C# Aspose.Cells. PRN'yi XLS kaydetme biçimine Ücretsiz Çevrimiçi Birleştirme. C# PRN'yi XLS biçiminde birleştirin. PRN'yi C#'de XLS ile birleştirin. PRN Birleştirin.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi XLS\'de C# Online\'da Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de PRN'nin XLS ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

PRN'yi XLS'de birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından XLS dosyasına kaydedin. C#'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. PRN'yi XLS ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="PRN\'yi C#\'de XLS ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="prn" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="PRN\'yi C# aracılığıyla XLS ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

PRN'yi programlı olarak XLS ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi XLS ile birleştirmek için .NET kitaplığı" %}}
