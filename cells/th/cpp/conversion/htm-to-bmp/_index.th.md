---
title: C++ HTM เป็น BMP - แปลง HTM เป็น BMP ออนไลน์
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง HTM เป็น BMP saveformat รูปแบบ C++ HTM เป็น BMP บันทึก HTM ไปที่ BMP C++
...
{{% blocks/products/pf/agp/content h2="บันทึก HTM เป็น BMP ใน C++ ออนไลน์ฟรี" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีแปลง HTM เป็น BMP ใน C++
...
1.  แปลง HTM เป็น BMP โดยเรียกเมธอด Save()
