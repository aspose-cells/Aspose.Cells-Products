...
url: /zh-hant/net/merger/merge-xltm-to-md/ 
...
以下範例示範如何將 XLTM 合併到 Aspose.Cells for .NET 中的 MD。
...
{{% cells-merger title="將 XLTM 合併到 C# 中的 MD 的範例程式碼" InputFormat="xltm" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 XLTM 合併到 MD" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 XLTM 合併到 MD 嗎？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET庫將XLTM合併到MD" %}}
