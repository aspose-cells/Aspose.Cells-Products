---
title: XLSX-bestanden samenvoegen via Java 
weight: 8930
url: /nl/java/merger/xlsx/ 
description: Java voorbeeldcode om XLSX-documenten te combineren in Java Runtime Environment voor JSP/JSF-applicaties en desktopapplicaties.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSX-indelingen samenvoegen in Java" h2="Native XLSX-documentfusie met server-side Java API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="XLSX-bestanden samenvoegen met Java" %}}

 Om het XLSX-bestand samen te voegen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het samenvoegen van XLSX-bestanden in Java" %}}
...
+ Laad het eerste XLSX-bestand met een instantie van de Workbook-klasse.
+ Laad het tweede XLSX-document met een instantie van de Workbook-klasse.
+ Voeg bestanden samen met de combine()-methode.
+ sla het samengevoegde XLSX-bestand op het opgegeven pad op
...
{{% blocks/products/pf/agp/code-block title="XLSX-bestanden samenvoegen - Java" offSpacer="" %}}

```cs
// Open het eerste XLSX-bestand.
Workbook xlsxFile1 = new Workbook("chartsFileWithPath.xlsx");

// Definieer het tweede bronboek.
// Open het tweede XLSX-bestand.
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API kan worden gebruikt voor het maken, bewerken, converteren en weergeven van Microsoft Excel-indelingen naar verschillende indelingen. Bovendien kan het worden gebruikt voor uitgebreide grafieken, schaalbare rapportage en betrouwbare berekeningen binnen softwaretoepassingen. Aspose.Cells is een zelfstandige API en vereist geen software zoals Microsoft of OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online XLSX Fusie Live-demo\'s" sectionDescription="Voeg nu XLSX-documenten samen door naar onze [Live demo\'s website](https://products.aspose.app/cells/merger). De live demo heeft de volgende voordelen:" >}}
