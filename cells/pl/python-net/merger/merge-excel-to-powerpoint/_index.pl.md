...
Poniższy przykład pokazuje, jak scalić EXCEL z POWERPOINT w Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo połączyć EXCEL z POWERPOINT? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
