---
title: Converter TXT para TIFF por meio do aplicativo C++ 
url: /pt/cpp/conversion/txt-to-tiff/ 
description: Exemplo de código de conversão C++ de documento TXT para formato TIFF. Os programadores podem usar esse código-fonte para conversão em lote de TXT para TIFF em qualquer aplicativo C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem converter facilmente arquivos TXT para TIFF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo TXT usando Factory::CreateIWorkbook.1. Selecione a primeira planilha.1. Definir opções (TIFF).1. Itere através de cada página da planilha e renderize.1. Abra o arquivo TIFF em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de TXT para TIFF C++" offSpacer="" %}}
