...
{{% blocks/products/pf/agp/content h2="Konversikan XLTX ke MHTML menggunakan C++" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTX ke MHTML di C++" %}}

Contoh berikut menunjukkan cara mengkonversi XLTX menjadi MHTML di C++.
...
Perlu mengkonversi file XLTX ke MHTML secara terprogram? Pengembang C++ dapat dengan mudah mengkonversi XLTX ke MHTML hanya dengan beberapa baris kode.
...
1.  Konversikan XLTX menjadi MHTML dengan memanggil metode Save().
1.  Dapatkan hasil konversi dari XLTX menjadi MHTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ perpustakaan untuk mengkonversi XLTX menjadi MHTML" %}}
