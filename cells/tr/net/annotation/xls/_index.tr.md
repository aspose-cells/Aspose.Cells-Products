---
title:  XLS Ek Açıklamasını Kaldır via .NET
weight: 9270
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLS biçim notlarını eklemek ve silmek için C# kaynak kodu.
---
...
{{% blocks/products/pf/agp/feature-section-col title="XLS\'den C#\'e Açıklama Ekleyin veya Silin" %}}
...
{{% blocks/products/pf/agp/code-block title="XLS - C#\'den Açıklamaları Sil" offSpacer="" %}}
