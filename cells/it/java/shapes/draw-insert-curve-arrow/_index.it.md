---
title:  Come disegnare o inserire la forma di una freccia curva in Excel via Java
weight: 30
description: Disegna o inserisci la forma di una freccia curva utilizzando Aspose.Cells' Java API senza alcun software come Microsoft o Open Office, Adobe PDF, ecc.
...
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci la forma della freccia curva in Excel via Java" h2="Inserisci la forma di una freccia curva utilizzando Aspose.Cells\' API senza alcun software come Microsoft o Open Office, Adobe PDF, ecc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Come inserire la forma di una freccia curva nel file Excel utilizzando Java" %}}

 Per inserire la forma di una freccia curva nel file Excel, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire la forma di una freccia curva nel file Excel via Java" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa il[aggiungi metodo](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) per inserire la forma di una freccia curva nel foglio di lavoro selezionato
...
{{% blocks/products/pf/agp/code-block title="Inserisci la forma di freccia curva - Java" offSpacer="" %}}
