---
title: A XLS-XLSM-es számok egyesítése – a XLS-es és a XLSM-es számok egyesítése a Python-ben
url: /hu/python-net/merger/merge-xls-to-xlsm/ 
description: Aspose Excel. Python Aspose.Cells. Ingyenes online egyesítés XLS XLSM mentési formátumba. Python A XLS és a XLSM formátum kombinálása. Egyesítse a XLS-XLSM-et a Python-ben. XLS Egyesítse.
...
{{% blocks/products/pf/agp/content h2="A XLS és a XLSM egyesítése a Python használatával" %}}
 ...
 Hogyan egyesíthetem a XLS és a XLSM számokat? A Aspose.Cells for Python via .NET könyvtárral könnyedén egyesítheti a XLS-et a XLSM-es számokkal programozottan néhány sornyi kóddal.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python)képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. Python Excel API nem csak a táblázatformátumok között konvertál, hanem Excel fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, CSV, CSV, CSV, CSV, CSV, SVG, és így tovább, SVG P, 8 PT a választás,3,8 ipari szabvány szerinti dokumentumok cseréjére formátumok. A Aspose.Cells for Python via .NET számot innen telepítheti.<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , használja a parancsot a következőképpen:<code>$ pip install aspose-cells-python</code>.
...
A következő példa bemutatja a XLS és XLSM egyesítését a Aspose.Cells for Python via .NET számban.
...
{{% cells-merger title="Ingyenes online a XLS-XLSM-es számok egyesítéséhez a Python-ben" InputFormat="xls" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="A XLS és a XLSM egyesítése a Python számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLS-et a XLSM-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
