---
title: Połącz XLSB z TABDELIMITED - Połącz XLSB z TABDELIMITED w C#
url: /pl/net/merger/merge-xlsb-to-tabdelimited/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLSB do formatu zapisu TABDELIMITED. C# Połącz XLSB w formacie TABDELIMITED. Połącz XLSB z TABDELIMITED w C#. XLSB Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLSB z TABDELIMITED w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić XLSB z TABDELIMITED w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLSB z TABDELIMITED. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku TABDELIMITED. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy XLSB z TABDELIMITED.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo scalić XLSB z TABDELIMITED? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
