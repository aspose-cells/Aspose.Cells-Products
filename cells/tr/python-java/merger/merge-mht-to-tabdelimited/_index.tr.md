...
Aşağıdaki örnek, Aspose.Cells for Python via Java'de MHT'nin TABDELIMITED ile nasıl birleştirileceğini göstermektedir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 MHT'yi TABDELIMITED ile programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
