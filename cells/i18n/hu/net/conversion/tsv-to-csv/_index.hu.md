---
title: "TSV konvertálása CSV-vé a következőn keresztül: C#"
url: /hu/net/conversion/tsv-to-csv/
description: Mintakód a tsv–csv C# konverzióhoz. Használjon API példakódot a tsv-fájlok kötegelt csv-vé konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása CSV-vé a következővel: C#" %}}

 A TSV CSV-vé konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TSV-ből CSV-vé konvertálás lépései a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a TSV-fájlokat CSV-formátumba.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TSV-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal megadása CSV-kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott CSV-fájl megadott elérési útját
...
{{% cells-convert title="Ingyenes alkalmazás és mintakód a TSV CSV-vé konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="tsv" outformat="csv" IsLandingPage="true" %}}
