---
title: Gộp JPG sang JPG - Gộp JPG sang JPG theo số Java
url: /vi/java/merger/merge-jpg-to-jpg/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất định dạng lưu JPG sang JPG. Java Kết hợp định dạng JPG sang JPG. Hợp nhất JPG thành JPG vào năm Java. Hợp nhất JPG.
...
{{% blocks/products/pf/agp/content h2="Gộp JPG sang JPG theo số Java" %}}

Ví dụ sau đây minh họa cách hợp nhất JPG thành JPG trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất JPG sang JPG. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp và sau đó lưu nó vào tệp JPG. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất JPG thành JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu ghép JPG sang JPG năm Java" InputFormat="jpg" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách ghép JPG thành JPG via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Java ghép JPG sang JPG" %}}
