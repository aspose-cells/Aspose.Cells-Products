...
description: Aspose Excel. Python Aspose.Cells. Unione online gratuita da XLS a MHTML saveformat. Python Combina il formato XLS con MHTML. Unisci XLS a MHTML in Python. XLS Unisci.
...
L'esempio seguente mostra come unire XLS a MHTML in Aspose.Cells for Python via Java.
...
{{% cells-merger title="Online gratuito per unire XLS a MHTML in Python" InputFormat="xls" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Come unire XLS a MHTML tramite Python" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire XLS a MHTML a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Le API possono essere eseguite con poche righe di codice.
