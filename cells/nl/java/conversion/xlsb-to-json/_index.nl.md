...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in JSON in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar JSON in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar JSON of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar JSON? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar JSON met slechts een paar regels code.
