---
title: Συγχώνευση PRN σε IMAGE - Συνδυάστε το PRN σε IMAGE στο C++
url: /el/cpp/merger/merge-prn-to-image/ 
description: Aspose Excel. C++ Aspose.Cells. Δωρεάν Διαδικτυακή συγχώνευση PRN σε μορφή αποθήκευσης IMAGE. C++ Συνδυάστε τη μορφή PRN σε IMAGE. Συγχώνευση PRN σε IMAGE στο C++. PRN Συγχώνευση.
...
{{% blocks/products/pf/agp/content h2="Συγχωνεύστε το PRN στο IMAGE στο C++ Online δωρεάν" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το PRN με το IMAGE στο Aspose.Cells for C++.
...
{{% cells-merger title="Δωρεάν online για συγχώνευση PRN με IMAGE στο C++" InputFormat="prn" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Πώς να συγχωνεύσετε το PRN με το IMAGE μέσω του C++" %}}

{{% blocks/products/pf/agp/text %}}

 Θέλετε να συγχωνεύσετε το PRN με το IMAGE μέσω προγραμματισμού; Ένα βασικό έγγραφο που συγχωνεύεται και συνενώνεται με[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Τα API μπορούν να γίνουν με λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/content h2="C++ βιβλιοθήκη για συγχώνευση PRN με IMAGE" %}}
