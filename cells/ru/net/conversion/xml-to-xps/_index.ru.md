...
Нужно программно преобразовать файлы XML в XPS? Разработчики .NET могут легко загружать и преобразовывать XML в XPS всего за несколько строк кода.
