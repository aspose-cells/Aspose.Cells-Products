...
description: Aspose Excel. Szybko i łatwo konwertuj JPG na OTS za pomocą Aspose.Cells. Python JPG na OTS. Python Zapisz JPG w OTS. Zapisz JPG jako OTS, używając numeru Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj JPG na OTS za pomocą Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz JPG w OTS pod numerem Python" %}}

Poniższy przykład pokazuje, jak przekonwertować JPG na OTS w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji JPG na OTS" %}}
