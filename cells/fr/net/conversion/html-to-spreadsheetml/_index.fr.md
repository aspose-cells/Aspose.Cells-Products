---
title: Convertir HTML en SPREADSHEETML via C#
url: /fr/net/conversion/html-to-spreadsheetml/
description: Exemple de code pour la conversion html vers tableurml C#. Utilisez un exemple de code API pour la conversion de fichiers html par lots en feuille de calcul dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir HTML en SPREADSHEETML via C#" h2="Exportez des feuilles de calcul Excel® au format SPREADSHEETML sur .NET Framework, .NET Core, Mono ou Xamarin Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs .NET peuvent facilement charger et convertir des fichiers HTML au format SPREADSHEETML en quelques lignes de code seulement.
