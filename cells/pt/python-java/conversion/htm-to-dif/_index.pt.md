...
description: Aspose Excel. Converta HTM em DIF de forma rápida e fácil com Aspose.Cells. Python HTM em DIF. Python Salve HTM em DIF. Salve HTM como DIF usando Python.
...
{{% blocks/products/pf/agp/content h2="Converter HTM em DIF usando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Salve HTM em DIF em Python" %}}

O exemplo a seguir demonstra como converter HTM em DIF em Python.
...
{{% cells-convert title="Exemplo de código para converter HTM em DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="dif" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para converter HTM em DIF" %}}
