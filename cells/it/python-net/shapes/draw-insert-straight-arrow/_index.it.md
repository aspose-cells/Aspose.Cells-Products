...
{{% blocks/products/pf/agp/content h2="Come inserire una freccia dritta nel file Excel utilizzando Python via .Net" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa l'aggiunta di shapecollection[metodo](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) per inserire una freccia dritta nel foglio di lavoro selezionato.
