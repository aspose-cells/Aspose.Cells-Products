...
description: Aspose เอ็กเซล. แปลง XLS เป็น IMAGE อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XLS เป็น IMAGE C++ บันทึก XLS ไปที่ IMAGE. บันทึก XLS เป็น IMAGE โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="แปลง XLS เป็น IMAGE โดยใช้ C++" %}}
...
{{% blocks/products/pf/agp/content h2="บันทึก XLS ลงใน IMAGE ใน C++" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง XLS เป็น IMAGE ใน C++
...
ต้องการแปลงไฟล์ XLS เป็น IMAGE โดยทางโปรแกรมหรือไม่ นักพัฒนา C++ สามารถแปลง XLS เป็น IMAGE ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลง XLS เป็น IMAGE โดยการเรียกเมธอด Save()
1.  รับผลลัพธ์การแปลง XLS เป็น IMAGE

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ไลบรารี C++ เพื่อแปลง XLS เป็น IMAGE" %}}
