---
title: Java PRN ke SQL - Konverter PRN ke SQL
description: Aspose Excel. Solusi komprehensif ini menyediakan Java pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi PRN ke format SQL, memungkinkan penyimpanan data PRN ke format SQL dengan mudah menggunakan pustaka Aspose.Cells, semuanya melalui kode Java yang efisien dan dapat disesuaikan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversi PRN ke SQL di Java" h2="Pustaka berkecepatan tinggi Java untuk mengkonversi PRN ke SQL. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor PRN, SQL, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan PRN ke SQL di Java" %}}

Contoh berikut menunjukkan cara mengkonversi PRN ke SQL di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi PRN ke SQL via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file PRN ke SQL secara terprogram? Pengembang Java dapat dengan mudah mengkonversi PRN ke SQL hanya dalam beberapa baris kode.
...
1.  Konversikan PRN ke SQL dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi PRN ke SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java pustaka untuk mengkonversi PRN ke SQL" %}}
{{% blocks/products/pf/agp/text %}}
