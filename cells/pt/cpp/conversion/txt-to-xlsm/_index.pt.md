---
title: Converter TXT para XLSM por meio do aplicativo C++ 
url: /pt/cpp/conversion/txt-to-xlsm/ 
description: Exemplo de código de conversão C++ de documento TXT para formato XLSM. Os programadores podem usar esse código-fonte para conversão em lote de TXT para XLSM em qualquer aplicativo C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter TXT para XLSM via C++" h2="Conversão de TXT para XLSM de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ os desenvolvedores podem facilmente converter arquivos TXT para XLSM em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregue o arquivo TXT usando Factory::CreateIWorkbook.1. Chame o método Save().1. Passe o caminho do arquivo de saída com extensão de arquivo (XLSM).1. arquivo XLSM será salvo no caminho especificado.1. Abra o arquivo XLSM em um programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de TXT para XLSM C++" offSpacer="" %}}
