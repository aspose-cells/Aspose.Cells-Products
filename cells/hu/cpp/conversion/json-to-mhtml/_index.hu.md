---
title: Konvertálja a JSON-t MHTML-re a(z) C++ alkalmazáson keresztül 
url: /hu/cpp/conversion/json-to-mhtml/ 
description: Minta C++ konverziós kód a JSON-dokumentumhoz MHTML formátumba. A programozók ezt a forráskódot használhatják a JSON-ból MHTML-be történő kötegelt konvertáláshoz bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JSON konvertálása MHTML-re a következőn keresztül: C++" h2="Nagy teljesítményű JSON-MHTML konvertálás a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="JSON konvertálása MHTML-re a következővel: C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A JSON MHTML-re konvertálásának lépései a következőn keresztül: C++" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztői könnyedén konvertálhatják a JSON-fájlt MHTML-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a JSON-fájlt a Factory::CreateIWorkbook használatával.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (MHTML) fájlkiterjesztéssel.1. Az MHTML fájl a megadott elérési útra kerül mentésre.1. Nyissa meg az MHTML fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="JSON-ból MHTML C++ konverziós forráskód" offSpacer="" %}}
