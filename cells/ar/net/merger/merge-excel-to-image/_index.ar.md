---
title: دمج EXCEL إلى IMAGE - ادمج EXCEL مع IMAGE في C#
url: /ar/net/merger/merge-excel-to-image/ 
description: Aspose إكسل. C# Aspose.Cells. دمج مجاني عبر الإنترنت EXCEL إلى IMAGE saveformat. C# قم بدمج EXCEL إلى تنسيق IMAGE. دمج EXCEL إلى IMAGE في C#. EXCEL Merge.
...
{{% blocks/products/pf/agp/content h2="دمج EXCEL مع IMAGE في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج EXCEL مع IMAGE في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج EXCEL في IMAGE. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف IMAGE. إذا قمت بتطوير رمز في C# ، فسيكون هذا أبسط مما يبدو. راجع C# المثال الذي يدمج EXCEL مع IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج EXCEL مع IMAGE في C#" InputFormat="xlsx" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج EXCEL مع IMAGE عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج EXCEL مع IMAGE برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة .NET لدمج EXCEL إلى IMAGE" %}}
