...
description: Aspose Excel. Converti TXT in EXCEL in modo rapido e semplice con Aspose.Cells. PHP TXT in EXCEL. PHP Salva TXT in EXCEL. Salva TXT come EXCEL utilizzando PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converti TXT in EXCEL in PHP" h2="Libreria PHP ad alta velocità per la conversione di TXT in EXCEL. Questa è una soluzione software professionale per importare ed esportare TXT, EXCEL e molti altri formati utilizzando PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
È necessario convertire i file TXT in EXCEL a livello di codice? Gli sviluppatori PHP possono caricare e convertire facilmente TXT in EXCEL in poche righe di codice.
...
1.  Converti TXT in EXCEL chiamando il metodo di salvataggio della cartella di lavoro.
