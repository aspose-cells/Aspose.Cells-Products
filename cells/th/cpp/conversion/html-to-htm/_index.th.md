---
title: C++ HTML เป็น HTM - HTML เป็น HTM Converter
description: Aspose เอ็กเซล. แปลง HTML เป็น HTM อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ HTML เป็น HTM C++ บันทึก HTML ไปที่ HTM บันทึก HTML เป็น HTM โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึก HTML ไปที่ HTM ใน C++" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง HTML เป็น HTM ใน C++
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง HTML เป็น HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="htm" IsLandingPage="true" language="cpp" %}}
...
1.  แปลง HTML เป็น HTM โดยการเรียกเมธอด Save()
