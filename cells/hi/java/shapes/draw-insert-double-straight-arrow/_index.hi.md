---
title:  मैं एक्सेल via Java में दोहरा सीधा तीर कैसे बनाऊं या डालूं
weight: 20
description: Aspose.Cells' Java API का उपयोग करके बिना किसी सॉफ्टवेयर जैसे Microsoft या ओपन ऑफिस, एडोब PDF आदि के बिना डबल स्ट्रेट एरो ऑब्जेक्ट बनाएं या डालें।
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके एक्सेल फ़ाइल में डबल स्ट्रेट एरो कैसे डालें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="एक्सेल फ़ाइल via Java में डबल सीधा तीर डालने के चरण" %}}
...
+ इसके सूचकांक के माध्यम से वर्कशीट का चयन करें।
 + का प्रयोग करें[विधि जोड़ें](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addLine-int-int-int-int-int-int-) चयनित वर्कशीट में दोहरा सीधा तीर डालने के लिए
...
{{% blocks/products/pf/agp/code-block title="दोहरा सीधा तीर डालें - Java" offSpacer="" %}}
