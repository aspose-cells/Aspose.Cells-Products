---
title: PHP XLTM إلى OTS - XLTM إلى OTS المحول
description: Aspose اكسل. قم بتحويل XLTM إلى OTS بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى OTS. PHP احفظ XLTM في OTS. احفظ XLTM كـ OTS باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى OTS عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى OTS برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى OTS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى OTS عن طريق استدعاء طريقة حفظ المصنف.
