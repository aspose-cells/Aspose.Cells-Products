...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file FODS ke JSON hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file FODS menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file output dengan ekstensi file (JSON).1. File JSON akan disimpan di jalur yang ditentukan.1. Buka file JSON di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="FODS ke JSON C++ Kode Sumber Konversi" offSpacer="" %}}
