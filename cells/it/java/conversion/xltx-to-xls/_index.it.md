---
title: Java XLTX a XLS - XLTX a XLS Convertitore
description: Aspose Excel. Questa soluzione completa fornisce agli sviluppatori Java un approccio completamente integrato per convertire il formato XLTX nel formato XLS, consentendo il salvataggio senza interruzioni dei dati XLTX nel formato XLS utilizzando la libreria Aspose.Cells, il tutto tramite codice Java efficiente e personalizzabile.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converti XLTX in XLS in Java" h2="Libreria Java ad alta velocità per convertire XLTX in XLS. Si tratta di una soluzione software professionale per importare ed esportare XLTX, XLS e molti altri formati utilizzando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salva XLTX a XLS in Java" %}}

L'esempio seguente mostra come convertire XLTX in XLS in Java.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per convertire XLTX in XLS. Carica il tuo file XLTX, quindi salvalo semplicemente come file XLS. Sia per la lettura XLTX che per la scrittura XLS è possibile utilizzare nomi di file completi. Il contenuto e la formattazione dell'output XLS saranno identici al documento originale XLTX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Codice di esempio per convertire XLTX in XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xltx" outformat="xls" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Come convertire XLTX in XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di convertire i file XLTX in XLS tramite codice? Gli sviluppatori che usano Java possono facilmente convertire XLTX in XLS in poche righe di codice.
...
1.  Converti XLTX in XLS chiamando il metodo Workbook.save.
1.  Ottieni il risultato della conversione da XLTX a XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria Java per convertire XLTX in XLS" %}}
{{% blocks/products/pf/agp/text %}}
