---
title: Java XLS na HTM - XLS na konwerter HTM
description: Aspose Excel. Szybko i łatwo przekonwertuj XLS na HTM za pomocą Aspose.Cells. Java XLS na HTM. Java Zapisz XLS w HTM. Zapisz XLS jako HTM, używając Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLS na HTM w Java" h2="Szybka biblioteka Java do konwersji XLS do HTM. Jest to profesjonalne oprogramowanie do importowania i eksportowania XLS, HTM i wielu innych formatów przy użyciu Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS w HTM w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na HTM w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować XLS na HTM. Prześlij plik XLS, a następnie po prostu zapisz go jako plik HTM. Zarówno do odczytu XLS, jak i do zapisu HTM, można używać w pełni kwalifikowanych nazw plików. Wyjściowa zawartość i formatowanie HTM będą identyczne z oryginalnym dokumentem XLS.
...
Chcesz programowo przekonwertować pliki XLS na HTM? Programiści Java mogą z łatwością przekonwertować XLS na HTM w zaledwie kilku linijkach kodu.
...
1.  Przekonwertuj XLS na HTM, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji XLS na HTM.
