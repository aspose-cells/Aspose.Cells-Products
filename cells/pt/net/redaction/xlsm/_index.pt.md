---
title:  Pesquise e substitua texto no documento XLSM via .NET
weight: 2370
description: Código-fonte C# para editar informações confidenciais no arquivo XLSM em .NET Framework, .NET Core, Mono ou plataformas Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Editar formatos XLSM em C#" h2="Informações de redação confidenciais de documentos XLSM nativos e de alto desempenho usando APIs Aspose.Cells for .NET do lado do servidor, sem o uso de qualquer software como Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
