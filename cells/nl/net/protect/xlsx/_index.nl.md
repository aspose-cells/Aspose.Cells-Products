...
weight: 90
description: C# broncode om XLSX-bestand te vergrendelen met een wachtwoord op .NET Framework, .NET Core, Mono of Xamarin Platforms.
...
1.  Instantieer de werkmapklasse met het pad naar het bestand XLSX
