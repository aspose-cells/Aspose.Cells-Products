---
title: TXT'i SQL ile birleştir - TXT'i Java'de SQL ile birleştir
url: /tr/java/merger/merge-txt-to-sql/ 
description: Aspose Excel'de. Java Aspose.Cells. TXT'i SQL kaydetme biçimiyle birleştirin. Java TXT'i SQL biçimiyle birleştirin. TXT'i Java'deki SQL ile birleştirin. TXT Birleştir.
...
{{% blocks/products/pf/agp/content h2="TXT\'i Java\'deki SQL ile birleştir" %}}

Aşağıdaki örnek, TXT'in Aspose.Cells for Java'deki SQL ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TXT'i SQL ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından bunu SQL dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TXT'i SQL ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="TXT\'i Java\'de SQL ile Birleştirmek için Örnek Kod" InputFormat="txt" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="TXT\'i SQL via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 TXT'i programlı olarak SQL ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kütüphanesini SQL ile birleştirmek için TXT kütüphanesi" %}}
