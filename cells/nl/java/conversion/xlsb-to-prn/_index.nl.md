---
title: Java XLSB naar PRN - XLSB naar PRN-converter
description: Aspose Excel. Converteer XLSB snel en eenvoudig naar PRN met Aspose.Cells. Java XLSB naar PRN. Java Bewaar XLSB in PRN. Sla XLSB op als PRN met behulp van Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLSB naar PRN in Java" h2="Snelle Java-bibliotheek voor het converteren van XLSB naar PRN. Dit is een professionele softwareoplossing voor het importeren en exporteren van XLSB, PRN en vele andere formaten met behulp van Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PRN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in PRN in Java" %}}

Het volgende voorbeeld laat zien hoe u XLSB naar PRN converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe XLSB naar PRN via Java te converteren" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLSB-bestanden programmatisch naar PRN converteren? Java-ontwikkelaars kunnen XLSB eenvoudig met slechts een paar regels code naar PRN converteren.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om XLSB naar PRN te converteren" %}}
{{% blocks/products/pf/agp/text %}}
