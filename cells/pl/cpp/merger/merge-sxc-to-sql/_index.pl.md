---
title: Połącz SXC z SQL - Połącz SXC z SQL w C++
url: /pl/cpp/merger/merge-sxc-to-sql/ 
description: Aspose Excel. C++ Aspose.Cells. Bezpłatne scalanie online SXC do formatu zapisu SQL. C++ Połącz SXC z formatem SQL. Scal SXC do SQL w C++. SXC Scal.
...
{{% blocks/products/pf/agp/content h2="Połącz SXC z SQL w C++ Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić SXC z SQL w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić SXC z SQL. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do scalania plików, a następnie zapisz ją w pliku SQL. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy SXC z SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online SXC z SQL w C++" InputFormat="sxc" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić SXC z SQL przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić SXC z SQL? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do scalania SXC z SQL" %}}
