...
Hai bisogno di convertire i file MHT in XPS tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire MHT in XPS in poche righe di codice.
...
1.  Convertire MHT in XPS chiamando il metodo Save().
