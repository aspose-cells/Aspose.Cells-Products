...
url: /tr/net/merger/merge-mht-to-spreadsheetml/ 
...
Aşağıdaki örnek, Aspose.Cells for .NET'de MHT'nin SPREADSHEETML ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 MHT'yi SPREADSHEETML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi SPREADSHEETML ile birleştirmek için .NET kitaplığı" %}}
