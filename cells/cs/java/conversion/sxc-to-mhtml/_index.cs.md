---
title: Převést SXC na MHTML přes Java 
url: /cs/java/conversion/sxc-to-mhtml/ 
description: Ukázka převodního kódu Java pro formát SXC na soubor MHTML. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do MHTML v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést SXC na MHTML přes Java" h2="Převod SXC na MHTML Java pro převod jedné nebo více stránek na MHTML pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na MHTML pomocí Java" %}}

 K vykreslení SXC do MHTML použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na MHTML prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor SXC na MHTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením MHTML a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor MHTML
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze SXC na MHTML Java" offSpacer="" %}}

```cs
// načtěte soubor SXC v instanci sešitu
Workbook book = new Workbook("template.sxc");
// uložit SXC jako MHTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze SXC na MHTML" sectionDescription="[Převést SXC na MHTML](https://products.aspose.app/cells/conversion/sxc-to-mhtml) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor SXC, bude okamžitě převeden do MHTML." >}}
