...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar XLSM met Aspose.Cells. PHP OTS naar XLSM. PHP Bewaar OTS naar XLSM. Sla OTS op als XLSM met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar XLSM te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar XLSM converteren? PHP-ontwikkelaars kunnen OTS eenvoudig laden en converteren naar XLSM in slechts een paar regels code.
...
1.  Converteer OTS naar XLSM door de opslagmethode van Workbook aan te roepen.
