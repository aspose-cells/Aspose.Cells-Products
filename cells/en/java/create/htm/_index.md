...
{{% blocks/products/pf/agp/content h2="How to Create HTM in Java" %}}
...
1.  Save the workbook as HTM format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create HTM file in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java library to create HTM file" %}}
{{% blocks/products/pf/agp/text %}}
