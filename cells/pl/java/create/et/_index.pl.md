---
title: Utwórz ET — utwórz plik ET pod numerem Java
description: Aspose Excel. Bezproblemowo generuj i manipuluj plikami ET dzięki bibliotece Aspose.Cells for Java. Ta wydajna biblioteka API zapewnia usprawnione i wydajne rozwiązanie do tworzenia, edycji i zarządzania plikami ET bezpośrednio w aplikacjach Java, spełniając specyficzne potrzeby programistów z wysoką precyzją.
...
{{% blocks/products/pf/agp/content h2="Jak utworzyć ET w Java" %}}
...
1.  Zapisz skoroszyt w formacie ET, używając metody save().

{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik ET w Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do tworzenia pliku ET" %}}
{{% blocks/products/pf/agp/text %}}
