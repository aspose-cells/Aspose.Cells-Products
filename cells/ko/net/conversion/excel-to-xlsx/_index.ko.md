...
{{< blocks/products/pf/i18n/upper-banner h1="엑셀 파일을 XLSX로 변환하여 C# 형식으로 변환합니다." h2="고속 C# 라이브러리를 사용하여 Excel 파일을 XLSX 형식으로 변환합니다. 이 전문 소프트웨어 솔루션은 .NET 프레임워크, .NET 코어 또는 Mono 플랫폼에서 Excel, XLSX 및 기타 여러 형식의 파일을 가져오고 내보낼 수 있습니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EXCEL" >}}
...
{{% cells-convert title="엑셀 파일을 XLSX로 변환하는 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#을 통해 EXCEL을 XLSX로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 EXCEL 파일을 XLSX로 변환해야 합니까? .NET 개발자는 단 몇 줄의 코드만으로 EXCEL을 XLSX로 쉽게 로드하고 변환할 수 있습니다.
...
1.  Workbook.Save 메서드를 호출하여 Excel 파일을 XLSX 형식으로 변환합니다.
