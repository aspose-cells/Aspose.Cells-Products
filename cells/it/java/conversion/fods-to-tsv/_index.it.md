---
title: Converti FODS in TSV tramite Java 

description: Esempio di codice di conversione Java per il formato FODS in file TSV. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in TSV all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti FODS in TSV tramite Java" h2="Conversione da FODS a TSV Java per convertire pagine singole o multiple in TSV utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire FODS in TSV utilizzando Java" %}}

 Per rendere FODS a TSV, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire FODS in TSV tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente i file FODS in TSV in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file FODS con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con l'estensione TSV e SaveFormat come parametri1. Controllare il percorso specificato per il file TSV risultante
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da FODS a TSV Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo dal vivo di conversione da FODS a TSV" sectionDescription="[Converti FODS in TSV](https://products.aspose.app/cells/conversion/fods-to-tsv) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file FODS, verrà convertito istantaneamente in TSV." >}}
