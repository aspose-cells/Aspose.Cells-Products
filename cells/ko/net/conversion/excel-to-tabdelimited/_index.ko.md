...
{{< blocks/products/pf/i18n/upper-banner h1="C#에서 엑셀 파일을 탭 구분자로 변환합니다." h2="고속 C# 라이브러리를 사용하여 Excel 파일을 탭 구분 형식으로 변환합니다. 이 전문 소프트웨어 솔루션은 .NET 프레임워크, .NET 코어 또는 Mono 플랫폼에서 Excel, 탭 구분 및 기타 여러 형식을 가져오고 내보낼 수 있습니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EXCEL" >}}
...
1.  Workbook.Save 메서드를 호출하여 Excel 파일을 탭으로 구분된 파일로 변환합니다.
