---
title: C# JPG 转 MD - JPG 转 MD 转换器
description: Aspose Excel。此综合解决方案为 C# 开发人员提供了一种完全集成的将 JPG 转换为 MD 格式的方法，从而能够使用 Aspose.Cells 库将 JPG 数据无缝保存为 MD 格式，所有这些都通过高效且可定制的 C# 代码实现。
...
{{% blocks/products/pf/agp/content h2="将 JPG 保存为 MD 文件（C#）。" %}}

以下示例演示了如何在 C# 中将 JPG 转换为 MD。
...
{{% cells-convert title="将 JPG 转换为 MD 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 JPG 转换为 MD" %}}

{{% blocks/products/pf/agp/text %}}

需要通过编程方式将 JPG 文件转换为 MD 格式吗？.NET 开发人员只需几行代码即可轻松加载 JPG 文件并将其转换为 MD 格式。
...
{{% blocks/products/pf/agp/content h2="C# 库用于将 JPG 转换为 MD" %}}
