---
title: تحويل Java HTM إلى CSV - تحويل HTM إلى CSV
description: Aspose إكسل. يوفر هذا الحل الشامل للمطورين Java نهجًا متكاملًا تمامًا لتحويل HTM إلى تنسيق CSV، مما يتيح حفظ بيانات HTM بسلاسة في تنسيق CSV باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود Java فعال وقابل للتخصيص.
...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل HTM إلى CSV في Java" h2="مكتبة Java عالية السرعة لتحويل ملفات HTM إلى CSV. هذا حل برمجي احترافي لاستيراد وتصدير ملفات HTM وCSV والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ HTM إلى CSV في Java" %}}

يوضح المثال التالي كيفية تحويل HTM إلى CSV في Java.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل HTM إلى CSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات HTM إلى CSV برمجيًا؟ يمكن لمطوري Java تحويل ملفات HTM إلى CSV بسهولة في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1.  قم بتثبيت 'Aspose.Cells for Java'.
1.  أضف مرجع مكتبة (استيراد المكتبة) إلى مشروعك Java.
1.  قم بتحميل ملف HTM باستخدام نسخة من فئة Workbook.
1.  تحويل HTM إلى CSV عن طريق استدعاء أسلوب Workbook.save.
1.  احصل على نتيجة تحويل HTM إلى CSV.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة Java لتحويل HTM إلى CSV" %}}
{{% blocks/products/pf/agp/text %}}
