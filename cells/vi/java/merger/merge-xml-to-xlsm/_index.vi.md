---
title: Gộp XML thành XLSM - Gộp XML thành XLSM trong Java
url: /vi/java/merger/merge-xml-to-xlsm/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất XML thành định dạng lưu XLSM. Java Kết hợp XML thành định dạng XLSM. Hợp nhất XML thành XLSM trong Java. Hợp nhất XML.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XML thành XLSM trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất XML thành XLSM trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất XML thành XLSM. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp và sau đó lưu nó vào tệp XLSM. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất XML thành XLSM.
