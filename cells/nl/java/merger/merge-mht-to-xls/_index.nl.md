---
title: Voeg MHT samen met XLS - Combineer MHT met XLS in Java
url: /nl/java/merger/merge-mht-to-xls/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online MHT samenvoegen naar XLS saveformat. Java Combineer MHT tot formaat XLS. MHT samenvoegen naar XLS in Java. MHT samenvoegen.
...
Het volgende voorbeeld laat zien hoe u MHT kunt samenvoegen tot XLS in Aspose.Cells for Java.
...
{{% cells-merger title="Gratis online om MHT samen te voegen tot XLS in Java" InputFormat="mht" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe MHT samen te voegen tot XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHT programmatisch samenvoegen met XLS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
