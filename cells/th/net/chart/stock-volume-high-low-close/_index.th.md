---
title: สร้างกราฟหุ้น Volume-สูง-ต่ำ-ปิด ผ่านทาง C#
description: C# ตัวอย่างโค้ดสำหรับสร้างแผนภูมิหุ้น Volume-สูง-ต่ำ-ปิด ไปยัง Excel โดยใช้ไลบรารี .NET ใช้โค้ดนี้เพื่อสร้างแผนภูมิหุ้น Volume-สูง-ต่ำ-ปิดไปยัง MS Excel ภายใน VB.NET, Asp.NET หรือแอปพลิเคชันที่ใช้ .NET ใดๆ
...
{{< blocks/products/pf/i18n/upper-banner h1="สร้างกราฟหุ้น Volume-สูง-ต่ำ-ปิด ผ่านทาง C#" h2="การสร้างแผนภูมิ MS Excel ประสิทธิภาพสูงและเนทีฟโดยทางโปรแกรมโดยใช้ API ฝั่งเซิร์ฟเวอร์ .NET" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
แผนภูมิหุ้นที่สามที่เราจะดูคือแผนภูมิ Volume High Low Close สิ่งสำคัญคือต้องทำซ้ำอีกครั้งว่าคุณต้องมีข้อมูลในลำดับที่ถูกต้อง หากคุณต้องการจัดเรียงตารางข้อมูลใหม่ คุณควรดำเนินการก่อนที่จะตั้งค่าแผนภูมิ แผนภูมินี้ประกอบด้วยคอลัมน์สำหรับปริมาณที่อยู่ต่อจากคอลัมน์แรก (หมวดหมู่) และแผนภูมิจะมีแผนภูมิคอลัมน์บนแกนหลักที่แสดงปริมาณนี้ ในขณะที่ราคาจะถูกย้ายไปยังแกนรอง
{{% /blocks/products/pf/agp/content %}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="วิธีสร้างกราฟหุ้น Volume-สูง-ต่ำ-ปิด ผ่านทาง C#" %}}

{{% blocks/products/pf/agp/text %}}

เป็นเรื่องง่ายสำหรับนักพัฒนาในการสร้างแผนภูมิหุ้นปริมาณ-สูง-ต่ำ-ปิดภายในการเรียกใช้แอปพลิเคชันการรายงานต่างๆ สำหรับการประมวลผลข้อมูลด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="ซอร์สโค้ดต่อไปนี้แสดงวิธีสร้างแผนภูมิหุ้นแบบ Volume-สูง-ต่ำ-ปิดเป็นไฟล์ MS Excel XLSX โดยใช้ C#" offSpacer="" %}}
