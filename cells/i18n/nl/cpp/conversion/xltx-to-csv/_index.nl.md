---
title: Converteer XLTX naar CSV via C++ applicatie 
url: /nl/cpp/conversion/xltx-to-csv/ 
description: Voorbeeld C++-conversiecode voor XLTX-document naar CSV-indeling. Programmeurs kunnen deze broncode gebruiken voor batch-XLTX naar CSV-conversie binnen elke C++-toepassing.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLTX naar CSV via C++" h2="Hoogwaardige XLTX naar CSV-conversie met behulp van de C++-bibliotheek zonder de noodzaak van Microsoft Excel, OpenOffice of Adobe Acrobat-installatie." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ ontwikkelaars kunnen XLTX-bestanden eenvoudig in slechts een paar regels code naar CSV converteren.

{{% /blocks/products/pf/agp/text %}}

1. Laad XLTX-bestand met Factory::CreateIWorkbook.1. Roep de methode Save() aan.1. Geef het uitvoerbestandspad door met de (CSV) bestandsextensie.1. CSV-bestand wordt opgeslagen op het opgegeven pad.1. Open het CSV-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="XLTX naar CSV C++ Conversiebroncode" offSpacer="" %}}
