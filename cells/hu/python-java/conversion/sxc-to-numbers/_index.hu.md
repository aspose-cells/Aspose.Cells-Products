---
title: Python SXC számokká alakítása - SXC számokká alakítása
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a Python fejlesztők számára a SXC számok NUMBERS formátumba konvertálásához, lehetővé téve a SXC adatok zökkenőmentes mentését NUMBERS formátumba a Aspose.Cells könyvtár használatával, mindezt hatékony és testreszabható Python kódon keresztül.
...
{{< blocks/products/pf/i18n/upper-banner h1="Alakítsa át a SXC számot SZÁMOKKÉNT a Python Excel könyvtárban" h2="Nagy sebességű Python Excel könyvtár a SXC számok SZÁMOKKÁ konvertálásához. Ez egy professzionális szoftvermegoldás a SXC, SZÁMOK és sok más formátum importálására és exportálására a Python használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% cells-convert title="Mintakód a SXC szám SZÁMOKKÉNT történő konvertálásához a Python Excel könyvtár segítségével" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="sxc" outformat="numbers" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hogyan lehet a SXC-et SZÁMOKKÁ konvertálni a Python-en keresztül?" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell SXC fájlokat NUMBERS formátumba konvertálni? A Python fejlesztők könnyedén betölthetik és konvertálhatják a SXC fájlokat NUMBERS formátumba mindössze néhány sor kóddal.
...
1.  Alakítsd át a SXC számot SZÁMOKKÉNT a Workbook.save metódus meghívásával.
1.  Szerezd meg a SXC SZÁMOKKÉNT történő átváltási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Excel könyvtár a SXC számokká konvertálásához" %}}
