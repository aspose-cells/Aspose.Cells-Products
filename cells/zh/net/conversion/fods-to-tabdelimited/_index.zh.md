...
description: Aspose Excel。此综合解决方案为 C# 开发人员提供了一种完全集成的方法，可将 FODS 转换为 TABDELIMITED 格式，从而能够使用 Aspose.Cells 库将 FODS 数据无缝保存为 TABDELIMITED 格式，所有这些都通过高效且可定制的 C# 代码实现。
...
{{< blocks/products/pf/i18n/upper-banner h1="将 FODS 转换为 C# 中的 TABDELIMITED" h2="高速 C# 库，用于将 FODS 格式转换为 TABDELIMITED 格式。这是一个专业的软件解决方案，可在 .NET Framework、.NET Core 或 Mono 平台上导入和导出 FODS、TABDELIMITED 以及许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="将 FODS 保存到 C# 中的 TABDELIMITED" %}}
...
是否需要以编程方式将 FODS 文件转换为 TABDELIMITED？.NET 开发人员只需几行代码即可轻松加载并将 FODS 转换为 TABDELIMITED。
...
1. 向您的 C# 项目添加库引用（导入库）。
1. 使用工作簿实例加载 FODS 文件。
1. 调用 Workbook.Save 方法将 FODS 转换为 TABDELIMITED。
