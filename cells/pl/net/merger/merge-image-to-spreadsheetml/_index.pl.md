---
title: Scal OBRAZ z ARKUSZEM KALKULACYJNYM - Połącz OBRAZ z ARKUSZEM KALKULACYJNYM w C#
url: /pl/net/merger/merge-image-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Scal OBRAZ do formatu zapisu SPREADSHEETML. C# Połącz OBRAZ z formatem SPREADSHEETML. Scal OBRAZ z SPREADSHEETML w C#. Scal OBRAZ.
...
{{% blocks/products/pf/agp/content h2="Scal OBRAZ z SPREADSHEETML w C#" %}}

Poniższy przykład ilustruje, jak scalić OBRAZ z SPREADSHEETML w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić OBRAZ z SPREADSHEETML. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku SPREADSHEETML. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy IMAGE z SPREADSHEETML.
...
{{% blocks/products/pf/agp/content h2="Jak scalić OBRAZ z arkuszem kalkulacyjnym pod numerem C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić OBRAZ z SPREADSHEETML? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do scalania OBRAZU z SPREADSHEETML" %}}
