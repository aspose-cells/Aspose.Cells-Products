---
title: 合并 ODS 至 JPEG - 将 ODS 至 JPEG 合并为 C#
url: /zh/net/merger/merge-ods-to-jpeg/ 
description: Aspose Excel。 C# Aspose.Cells。免费在线合并ODS到JPEG保存格式。 C# 将 ODS 合并为 JPEG 格式。将 ODS 合并到 C# 中的 JPEG。 ODS 合并。
...
{{% blocks/products/pf/agp/content h2="免费在线将 ODS 合并为 C# 中的 JPEG" %}}

以下示例演示如何将 ODS 合并到 Aspose.Cells for .NET 中的 JPEG。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 ODS 合并到 JPEG。上传文件，调用 Workbook.Combine 方法合并文件，然后将其保存到 JPEG 文件。如果您在 C# 中开发代码，这会比听起来更简单。请参阅将 ODS 合并到 JPEG 的 C# 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免费在线将 ODS 合并到 C# 中的 JPEG" InputFormat="ods" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 ODS 合并到 JPEG" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 ODS 合并到 JPEG 吗？基本文档合并和连接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET库将ODS合并到JPEG" %}}
