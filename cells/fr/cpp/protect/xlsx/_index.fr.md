...
1. Charger le fichier XLSX à l'aide de la classe IWorkbook1. Utiliser la méthode Protect(..) avec ProtectionType et Password1. Enregistrez le fichier XLSX protégé par la méthode Save ()
