...
description: Aspose Excel。 C# Aspose.Cells。C#中的JPEG到JSON。C#將JPEG轉換為JSON儲存格式。 C# JPEG 到 JSON 格式。將 JPEG 儲存為 JSON C#。
...
{{% cells-convert title="將 JPEG 轉換為 JSON 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="json" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 JPEG 轉換為 JSON" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 JPEG 檔案轉換為 JSON 嗎？ .NET 開發人員只需幾行程式碼即可輕鬆載入和轉換 JPEG 到 JSON。
