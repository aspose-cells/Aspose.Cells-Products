---
title: Μετατροπή MHTML σε XPS μέσω Java 
weight: 6220
url: /el/java/conversion/mhtml-to-xps/ 
description: Δείγμα κώδικα μετατροπής Java για μορφή MHTML σε αρχείο XPS. Οι προγραμματιστές μπορούν να χρησιμοποιήσουν αυτό το παράδειγμα κώδικα για να εξάγουν υπολογιστικά φύλλα Excel και OpenOffice σε XPS σε οποιαδήποτε εφαρμογή που βασίζεται στον Ιστό ή στην επιφάνεια εργασίας Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή MHTML σε XPS μέσω Java" h2="Μετατροπή MHTML σε XPS Java για μετατροπή μεμονωμένων ή πολλαπλών σελίδων σε XPS χρησιμοποιώντας εσωτερική βιβλιοθήκη Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε MHTML σε XPS χρησιμοποιώντας το Java" %}}

 Για να αποδώσουμε το MHTML σε XPS, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή MHTML σε XPS μέσω Java" %}}

{{% blocks/products/pf/agp/text %}}

 Οι προγραμματιστές του Java μπορούν εύκολα να μετατρέψουν το αρχείο MHTML σε XPS σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φόρτωση αρχείου MHTML με μια παρουσία της κλάσης Βιβλίο εργασίας1. Καλέστε τη μέθοδο Workbook.save1. Περάστε τη διαδρομή εξόδου με την επέκταση XPS & SaveFormat ως παραμέτρους1. Ελέγξτε την καθορισμένη διαδρομή για το αρχείο XPS που προκύπτει
...
{{% blocks/products/pf/agp/code-block title="Πηγαίος κώδικας μετατροπής MHTML σε XPS Java" offSpacer="" %}}

```cs
// φορτώστε το αρχείο MHTML σε μια παρουσία του βιβλίου εργασίας
Workbook book = new Workbook("template.mhtml");
// αποθήκευση MHTML ως XPS
