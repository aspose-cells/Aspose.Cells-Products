---
title: Voeg TXT samen met PRN - Combineer TXT met PRN in C++
url: /nl/cpp/merger/merge-txt-to-prn/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online samenvoegen TXT naar PRN-opslagformaat. C++ Combineer TXT naar PRN-formaat. Samenvoegen TXT naar PRN in C++. TXT Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis TXT samen met PRN in C++ online" %}}

Het volgende voorbeeld laat zien hoe u TXT kunt samenvoegen met PRN in Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TXT samen te voegen met PRN. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het PRN-bestand. Als u code ontwikkelt in C++, is dit eenvoudiger dan het klinkt. Zie voorbeeld C++ dat TXT samenvoegt met PRN.
...
{{% blocks/products/pf/agp/content h2="Hoe TXT samen te voegen met PRN via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TXT programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om TXT samen te voegen met PRN" %}}
