...
{{< blocks/products/pf/upper-banner h1="Convert XLS to SPREADSHEETML via Java" h2="Native Java library to export Excel & OpenOffice spreadsheets to SPREADSHEETML." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/cells/272x272/aspose_cells-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert XLS to SPREADSHEETML Using Java" %}}
 ...
 In order to render XLS to SPREADSHEETML, we’ll use
...
{{% blocks/products/pf/agp/code-block title="Convert XLS to SPREADSHEETML - Java‎" offSpacer="" %}}

```cs
// load the XLS file in an instance of Workbook
Workbook book = new Workbook("template.xls");
// save XLS as SPREADSHEETML
