...
url: /tr/python-java/merger/merge-jpg-to-jpg/ 
...
Aşağıdaki örnek, Aspose.Cells for Python via Java'de JPG'nin JPG ile nasıl birleştirileceğini gösterir.
...
JPG'yi programlı olarak JPG ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
