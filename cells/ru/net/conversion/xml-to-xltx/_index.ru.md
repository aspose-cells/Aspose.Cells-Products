...
description: Aspose Эксель. Быстро и легко конвертируйте XML в XLTX с помощью Aspose.Cells. C# XML в XLTX. C# Сохраните XML в XLTX. Сохраните XML как XLTX, используя C#.
...
{{% blocks/products/pf/agp/content h2="Преобразование XML в XLTX с помощью C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XML в XLTX в C#." %}}

В следующем примере показано, как преобразовать XML в XLTX в C#.
...
{{% cells-convert title="Пример кода для преобразования XML в XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xltx" IsLandingPage="true" %}}
