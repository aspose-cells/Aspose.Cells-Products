---
title: Jak narysować lub wstawić zakrzywiony kształt strzałki do Excela za pomocą Python via Java
weight: 10
...
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw zakrzywiony kształt strzałki do Excela, używając Python via Java" h2="Wstaw zakrzywiony kształt strzałki, używając Aspose.Cells\' API bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wstawić zakrzywiony kształt strzałki do pliku Excel przy użyciu Python via Java" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)), aby wstawić zakrzywioną strzałkę w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw zakrzywiony kształt strzałki - Python via Java" offSpacer="" %}}
