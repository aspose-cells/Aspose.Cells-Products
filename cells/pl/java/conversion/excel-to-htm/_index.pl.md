...
{{% blocks/products/pf/agp/content h2="Zapisz plik EXCEL w formacie HTM w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować plik EXCEL na format HTM w formacie Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik EXCEL do formatu HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki EXCEL do formatu HTM? Programiści Java mogą łatwo przekonwertować pliki EXCEL do formatu HTM za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj program EXCEL do formatu HTM wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji z pliku EXCEL do HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji EXCELA do HTM" %}}
{{% blocks/products/pf/agp/text %}}
