---
title: Java ODS ke JPG - ODS ke Konverter JPG
description: Aspose Excel. Solusi komprehensif ini menyediakan Java pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi ODS ke format JPG, memungkinkan penyimpanan data ODS ke format JPG dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode Java yang efisien dan dapat disesuaikan.
keywords: [Aspose Excel., Java Aspose.Cells., Smart ODS files to JPG Converter for Java., Convert ODS to JPG in Java., ODS files to JPG Conversion in Java., Leverage intelligent data processing to automatically parse and save ODS into JPG format with high fidelity and code efficiency]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi ODS ke JPG di Java" h2="Pustaka berkecepatan tinggi Java untuk mengkonversi ODS ke JPG. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor ODS, JPG, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan ODS ke JPG di Java" %}}

Contoh berikut menunjukkan cara mengkonversi ODS ke JPG di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengubah ODS ke JPG. Unggah file ODS Anda, lalu simpan sebagai file JPG. Untuk pembacaan ODS dan penulisan JPG Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format JPG keluaran akan sama dengan dokumen ODS asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi ODS ke JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ods" outformat="jpg" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi ODS ke JPG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file ODS ke JPG secara terprogram? Pengembang Java dapat dengan mudah mengkonversi ODS ke JPG hanya dengan beberapa baris kode.
...
1.  Konversikan ODS ke JPG dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi ODS ke JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi ODS ke JPG" %}}
{{% blocks/products/pf/agp/text %}}
