...
url: /tr/python-java/merger/merge-tabdelimited-to-ett/ 
...
Aşağıdaki örnek, Aspose.Cells for Python via Java'de TABDELIMITED'in ETT ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 TABDELIMITED'ı ETT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
