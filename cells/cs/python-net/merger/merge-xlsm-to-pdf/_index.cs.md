---
title:  Sloučit XLSM na PDF přes Python
url: /cs/python-net/merger/merge-xlsm-to-pdf/ 
description: Sloučit XLSM až PDF online zdarma. Online zdarma XLSM až PDF Fúze. Sloučit XLSM do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit XLSM až PDF v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení XLSM až PDF online" InputFormat="xlsm" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
