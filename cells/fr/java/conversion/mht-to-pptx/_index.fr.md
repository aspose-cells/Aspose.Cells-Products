---
title: Java MHT en PPTX - Convertisseur MHT en PPTX
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le MHT au format PPTX, permettant un enregistrement transparent des données MHT au format PPTX à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrez MHT au PPTX dans Java" %}}

L'exemple suivant montre comment convertir MHT en PPTX en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir MHT en PPTX. Téléchargez votre fichier MHT, puis enregistrez-le simplement sous le nom de fichier PPTX. Pour la lecture MHT et l'écriture PPTX, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la sortie PPTX seront identiques au document MHT original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir MHT en PPTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="pptx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir MHT en PPTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers MHT au format PPTX par programmation ? Les développeurs spécialisés peuvent facilement convertir les fichiers MHT au format PPTX en quelques lignes de code seulement.
...
1.  Convertissez MHT en PPTX en appelant la méthode Workbook.save.
1. Obtenez le résultat de la conversion de MHT en PPTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir MHT en PPTX" %}}
{{% blocks/products/pf/agp/text %}}
