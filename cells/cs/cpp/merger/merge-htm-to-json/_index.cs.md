---
title: Sloučit HTM s JSON - Sloučit HTM s JSON v C++
url: /cs/cpp/merger/merge-htm-to-json/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma sloučit HTM do JSON saveformat. C++ Zkombinujte HTM do formátu JSON. Sloučit HTM na JSON v C++. HTM Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit HTM na JSON v C++ online zdarma" %}}

Následující příklad ukazuje, jak sloučit HTM s JSON v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení HTM do JSON. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru JSON. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí HTM do JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení HTM na JSON v C++" InputFormat="htm" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit HTM na JSON přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit HTM na JSON programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení HTM s JSON" %}}
