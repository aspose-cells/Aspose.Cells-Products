...
description: Aspose เอ็กเซล. แปลง NUMBERS เป็น XLTX อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ NUMBERS เป็น XLTX C++ บันทึก NUMBERS เป็น XLTX บันทึก NUMBERS เป็น XLTX โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึกหมายเลขไปที่ XLTX ใน C++" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการแปลง NUMBERS เป็น XLTX ใน C++
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลงตัวเลขเป็น XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="xltx" IsLandingPage="true" language="cpp" %}}
...
1.  แปลง NUMBERS เป็น XLTX โดยการเรียกเมธอด Save()
1.  รับผลลัพธ์การแปลงจาก NUMBERS เป็น XLTX

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ ไลบรารี่เพื่อแปลง NUMBERS เป็น XLTX" %}}
