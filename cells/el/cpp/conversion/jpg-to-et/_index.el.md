...
description: Aspose Excel. Μετατρέψτε JPG σε ET γρήγορα και εύκολα με Aspose.Cells. C++ JPG σε ET. C++ Αποθήκευση JPG στο ET. Αποθηκεύστε το JPG ως ET χρησιμοποιώντας το C++.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε JPG στο ET στο C++" %}}

Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε JPG σε ET στο C++.
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή JPG σε ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="et" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε JPG σε ET μέσω C++" %}}

{{% blocks/products/pf/agp/text %}}

Θέλετε να μετατρέψετε αρχεία JPG σε ET μέσω προγραμματισμού; C++ προγραμματιστές μπορούν εύκολα να μετατρέψουν JPG σε ET σε λίγες μόνο γραμμές κώδικα.
...
1.  Μετατρέψτε το JPG σε ET καλώντας τη μέθοδο Save().
