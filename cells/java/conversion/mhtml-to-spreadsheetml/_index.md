...
description: Sample Java conversion code for MHTML format to SPREADSHEETML file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to SPREADSHEETML within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MHTML to SPREADSHEETML via Java" h2="MHTML to SPREADSHEETML Java conversion to convert single or multiple pages to SPREADSHEETML using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MHTML to SPREADSHEETML Using Java" %}}

 In order to render MHTML to SPREADSHEETML, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MHTML to SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert MHTML file to SPREADSHEETML in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="MHTML to SPREADSHEETML Java Conversion Source Code" offSpacer="" %}}

```cs
// load the MHTML file in an instance of Workbook
Workbook book = new Workbook("template.mhtml");
// save MHTML as SPREADSHEETML
