---
title: 合併 TXT 到 WORD - 將 TXT 合併到 Python 中的 WORD
url: /zh-hant/python-net/merger/merge-txt-to-word/ 
description: Aspose Excel。 Python Aspose.Cells。免費在線合併TXT到WORD保存格式。 Python 將TXT合併為WORD格式。將 TXT 合併到 Python 中的 WORD。 TXT 合併。
...
以下示例演示如何將TXT合併到WORD中的Aspose.Cells for Python via .NET。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 TXT 合併到 WORD。上傳文件，調用Workbook.Combine方法合併文件，然後保存為WORD文件。如果您在 Python 中開發代碼，這會比聽起來更簡單。請參閱 Python 將 TXT 合併到 WORD 的示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免費在線將TXT合併到Python中的WORD" InputFormat="txt" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="如何通過Python將TXT合併到WORD" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 TXT 合併到 WORD 嗎？基本文檔合併和連接[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)只需幾行代碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2="Python庫將TXT合併到WORD" %}}
