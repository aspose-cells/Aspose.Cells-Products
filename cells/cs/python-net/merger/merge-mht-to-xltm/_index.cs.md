...
description: Aspose Excel. Python Aspose.Cells. Sloučit MHT do formátu uložení XLTM. Python Zkombinujte MHT do formátu XLTM. Sloučit MHT na XLTM v Python. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT na XLTM v Python" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení MHT s XLTM v Python" InputFormat="mht" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
