...
description: Sample code for xls to spreadsheetml C# conversion. Use API example code for batch xls files to spreadsheetml conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/code-block title="This sample code shows xls to spreadsheetml C# Conversion" offSpacer="" %}}

{{< gist "aspose-cells-gists" "88c9872508ec3150c552eb5155edf06e" "Convert-xls-to-spreadsheetml.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert XLS to SPREADSHEETML" sectionDescription="Check our live demos for [XLS to SPREADSHEETML conversion](https://products.aspose.app/cells/conversion/xls-to-spreadsheetml) with following benefits." >}}
