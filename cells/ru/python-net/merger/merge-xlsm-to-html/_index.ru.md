...
description: Aspose Эксель. Python Aspose.Cells. Объедините XLSM и HTML в формате сохранения. Python Объедините форматы XLSM и HTML. Объедините XLSM и HTML в Python. XLSM Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините XLSM с HTML, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините XLSM и HTML в Python." %}}

В следующем примере показано, как объединить XLSM и HTML в Aspose.Cells for Python via .NET.
