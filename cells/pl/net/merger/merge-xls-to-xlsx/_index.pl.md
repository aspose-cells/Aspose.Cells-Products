---
title: Połącz XLS z XLSX - Połącz XLS z XLSX w C#
url: /pl/net/merger/merge-xls-to-xlsx/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online XLS do XLSX w formacie zapisu. C# Połącz format XLS z XLSX. Połącz XLS z XLSX w C#. XLS Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz XLS z XLSX w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLS z XLSX w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLS z XLSX. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku XLSX. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy numery XLS z XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLS z XLSX w C#" InputFormat="xls" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLS z XLSX za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić XLS z XLSX programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia XLS z XLSX" %}}
