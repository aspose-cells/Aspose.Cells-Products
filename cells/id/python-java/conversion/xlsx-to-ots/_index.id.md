...
description: Aspose Unggul. Ubah XLSX menjadi OTS dengan cepat dan mudah dengan Aspose.Cells. Python XLSX menjadi OTS. Python Simpan XLSX ke OTS. Simpan XLSX sebagai OTS menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke OTS di Python" %}}

Contoh berikut menunjukkan cara mengonversi XLSX ke OTS di Python.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengkonversi XLSX ke OTS" %}}
