---
title: Unisci JPEG a XLAM - Combina JPEG a XLAM in C#
url: /it/net/merger/merge-jpeg-to-xlam/ 
description: Aspose Excel. C# Aspose.Cells. Unione online gratuita da JPEG a XLAM saveformat. C# Combina il formato JPEG con XLAM. Unisci JPEG a XLAM in C#. JPEG Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci JPEG a XLAM in C# online gratuitamente" %}}

L'esempio seguente mostra come unire JPEG a XLAM in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire JPEG a XLAM. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file XLAM. Se sviluppi il codice in C#, sarà più semplice di quanto sembri. Vedere l'esempio C# che unisce JPEG a XLAM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online gratuito per unire JPEG a XLAM in C#" InputFormat="jpg" InputFormat2="xlam" outformat="xlam" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire JPEG a XLAM tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire JPEG a XLAM a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca da unire JPEG a XLAM" %}}
