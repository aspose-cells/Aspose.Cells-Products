---
title:  TABDELIMITED を C# 経由で XPS にマージします
url: /ja/net/merger/merge-tabdelimited-to-xps/ 
description: TABDELIMITED をオンラインで無料で XPS にマージします。無料オンライン TABDELIMITED から XPS 合併。 TABDELIMITED を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、TABDELIMITED を C# の XPS にマージする方法を示しています。
...
{{% cells-merger title="TABDELIMITEDをオンラインでXPSにマージする無料アプリ" InputFormat="tsv" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
