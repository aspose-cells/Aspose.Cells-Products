---
title: Converteer FODS naar TABDELIMITED via Python

description: Voorbeeldcode voor conversie van fods naar tabdelimited Python. Gebruik API voorbeeldcode voor batch-fods-bestanden naar door tabs gescheiden conversie binnen de Python-toepassing.
---
...
{{% blocks/products/pf/agp/content h2="Hoe FODS naar TABDELIMITED te converteren met Python" %}}

 Om FODS naar TABDELIMITED te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om FODS om te zetten naar TABDELIMITED via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python ontwikkelaars kunnen FODS-bestanden gemakkelijk laden en converteren naar TABDELIMITED in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad FODS-bestand met een exemplaar van Workbook1. Roep de methode Workbook.Save aan1. Geef uitvoerpad door met TSV-extensie als parameter1. Controleer het opgegeven pad voor het resulterende TABDELIMITED-bestand
