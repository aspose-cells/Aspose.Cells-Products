...
{{% blocks/products/pf/agp/content h2="Преобразовать FODS в TIFF, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в TIFF в C#" %}}
...
1.  Преобразуйте значение FODS в TIFF, вызвав метод Workbook.Save.
