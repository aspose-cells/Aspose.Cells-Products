---
title: Convertir ODS en JPG via l'application C++ 
url: /fr/cpp/conversion/ods-to-jpg/ 
description: Exemple de code de conversion C++ pour le document ODS au format JPG. Les programmeurs peuvent utiliser ce code source pour la conversion par lots d'ODS en JPG dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir ODS en JPG via C++" h2="Conversion ODS en JPG haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir ODS en JPG en utilisant C++" %}}

 Afin de convertir ODS en JPG, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir ODS en JPG via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs C++ peuvent facilement convertir un fichier ODS en JPG en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier ODS à l'aide de Factory :: CreateIWorkbook.1. Appelez la méthode Save().1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (JPG).1. Le fichier JPG sera enregistré dans le chemin spécifié.1. Ouvrez le fichier JPG dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion ODS en JPG C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de conversion ODS en JPG" sectionDescription="[Convertir ODS en JPG](https://products.aspose.app/cells/conversion/ods-to-jpg) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier ODS, il sera converti instantanément en JPG." >}}
