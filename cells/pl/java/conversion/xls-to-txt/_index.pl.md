---
title: Java XLS do TXT - XLS do TXT Konwerter
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji formatu XLS do TXT, umożliwiając bezproblemowe zapisywanie danych XLS do formatu TXT za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi Java.
keywords: [Aspose Excel., Java Aspose.Cells., Smart XLS files to TXT Converter for Java., Convert XLS to TXT in Java., XLS files to TXT Conversion in Java., Leverage intelligent data processing to automatically parse and save XLS into TXT format with high fidelity and code efficiency]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLS na TXT w Java" h2="Szybka biblioteka Java do konwersji XLS na TXT. Profesjonalne rozwiązanie programowe do importowania i eksportowania formatów XLS, TXT i wielu innych formatów przy użyciu Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do TXT w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na TXT w Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować numer XLS na numer TXT. Prześlij plik XLS, a następnie po prostu zapisz go jako plik TXT. Zarówno do odczytu XLS, jak i do zapisu TXT można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego TXT będą identyczne z oryginalnym dokumentem XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji XLS na TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="txt" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na TXT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLS na TXT? Programiści Java mogą łatwo przekonwertować pliki XLS na TXT za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj numer XLS na numer TXT, wywołując metodę Workbook.save.
1.  Uzyskaj wynik konwersji XLS na TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji XLS na TXT" %}}
{{% blocks/products/pf/agp/text %}}
