---
title: Konwertuj XLSM na XLT za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xlsm-to-xlt/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLSM do formatu XLT. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLSM na XLT w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLSM na XLT w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSM przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLT).1. Plik XLT zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLT w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLSM do XLT C++ Kod źródłowy konwersji" offSpacer="" %}}
