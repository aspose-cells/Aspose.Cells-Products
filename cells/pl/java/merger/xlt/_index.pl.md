---
title:  Połącz XLT Pliki via Java
weight: 9960
description: Java przykładowy kod do łączenia dokumentów XLT w środowisku wykonawczym Java dla aplikacji JSP/JSF i aplikacji komputerowych.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Połącz formaty XLT w Java" h2="Natywne połączenie dokumentów XLT przy użyciu interfejsów API Java po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/content h2="Jak scalić pliki XLT za pomocą Java" %}}
 ...
 Aby scalić plik XLT, użyjemy[Aspose.Cells for Java](https://products.aspose.com/cells/java) API, która jest bogatą w funkcje, wydajną i łatwą w obsłudze platformą łączącą API for Java. Możesz pobrać jego najnowszą wersję bezpośrednio z[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) i zainstaluj go w swoim projekcie opartym na Maven, dodając następujące konfiguracje do pliku pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki łączenia plików XLT w Java" %}}
...
+ zapisz połączony plik XLT w określonej ścieżce
...
{{% blocks/products/pf/agp/code-block title="Połącz pliki XLT - Java" offSpacer="" %}}
