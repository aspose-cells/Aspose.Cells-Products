...
{{% blocks/products/pf/agp/text %}}
 ...
 من السهل على المطورين إنشاء وتحميل وتعديل وتحويل ملفات NUMBERS ضمن تطبيقات التقارير قيد التشغيل لمعالجة البيانات في بضعة أسطر من التعليمات البرمجية.
...
1.  احفظ المصنف كملف أرقام باستخدام طريقة Save ().
