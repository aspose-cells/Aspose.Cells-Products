---
title:  Pesquisar documento TXT sem abrir via C++
weight: 5090
description: C++ código de exemplo para pesquisar palavras com padrão no arquivo TXT em C++ Runtime Environment para Windows 32 bits, Windows 64 bits e Linux 64 bits.
...
{{< blocks/products/pf/i18n/upper-banner h1="Pesquise formatos TXT em C++" h2="Pesquisa de documentos TXT nativa e de alto desempenho usando APIs Aspose.Cells for C++ do lado do servidor, sem o uso de qualquer software como Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
+ Carregue o arquivo TXT instanciando uma classe Workbook.
...
+ Salve o arquivo TXT usando o método Workbook::Save(...) .
