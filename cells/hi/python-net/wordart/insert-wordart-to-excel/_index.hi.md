...
+ चयनित वर्कशीट में वर्डआर्ट सम्मिलित करने के लिए शेपकलेक्शन की ऐड विधि का उपयोग करें।
...
-  से स्थापित करें Aspose.Cells for Python via .NET<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> कमांड का उपयोग इस रूप में करें:<code>$ pip install aspose-cells-python</code>.
