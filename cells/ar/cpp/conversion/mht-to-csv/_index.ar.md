---
title: C++ MHT إلى CSV - محول MHT عبر الإنترنت إلى CSV
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ تحويل MHT إلى CSV saveformat. C++ MHT إلى تنسيق CSV. احفظ MHT في CSV C++.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT في CSV في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات MHT إلى CSV برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل MHT إلى CSV في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى CSV باستدعاء طريقة Save ().
