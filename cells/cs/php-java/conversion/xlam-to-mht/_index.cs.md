---
title: Převodník PHP XLAM na MHT – XLAM na MHT
description: Aspose Excel. Převeďte XLAM na MHT rychle a snadno pomocí Aspose.Cells. PHP XLAM na MHT. PHP Uložit XLAM do MHT. Uložte XLAM jako MHT pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést XLAM na MHT přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést XLAM soubory na MHT programově? Vývojáři PHP mohou snadno načíst a převést XLAM na MHT v několika řádcích kódu.
...
1.  Převeďte XLAM na MHT voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na MHT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na MHT" %}}
