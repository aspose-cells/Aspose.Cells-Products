---
title:  Combinar TXT a MHT a través de Python
url: /es/python-net/merger/merge-txt-to-mht/ 
description: Combine TXT con MHT en línea de forma gratuita. Gratis en línea TXT para la fusión de MHT. Combine TXT con Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo combinar TXT con MHT en Python.
...
{{% cells-merger title="Aplicación gratuita para fusionar TXT a MHT en línea" InputFormat="txt" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
