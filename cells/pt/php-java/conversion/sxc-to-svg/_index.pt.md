---
title: Conversor PHP SXC para SVG - SXC para SVG
description: Aspose Excel. Converta SXC em SVG de forma rápida e fácil com Aspose.Cells. PHP SXC em SVG. PHP Salve SXC em SVG. Salve SXC como SVG usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em SVG via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em SVG programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em SVG em apenas algumas linhas de código.
...
1.  Converta SXC em SVG chamando o método save da pasta de trabalho.
