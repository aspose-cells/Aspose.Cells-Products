...
{{% blocks/products/pf/agp/content h2="HTM\'yi DIF\'e C++\'e kaydedin." %}}

Aşağıdaki örnek, HTM'nin C++'den DIF'e nasıl dönüştürüleceğini göstermektedir.
...
HTML dosyalarını programatik olarak DIF formatına dönüştürmeniz mi gerekiyor? C++ geliştiricileri, sadece birkaç satır kodla HTML dosyalarını kolayca DIF formatına dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="C++ kütüphanesi, HTM\'yi DIF\'e dönüştürür." %}}
