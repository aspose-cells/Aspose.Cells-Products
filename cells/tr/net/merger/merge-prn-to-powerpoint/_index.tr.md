---
title: PRN'yi POWERPOINT ile birleştir - C#'de PRN'yi POWERPOINT ile birleştir
url: /tr/net/merger/merge-prn-to-powerpoint/ 
description: Aspose excel. C# Aspose.Cells. Ücretsiz Çevrimiçi PRN'yi POWERPOINT kaydetme biçiminde birleştirin. C# PRN'yi POWERPOINT biçiminde birleştirin. C#'de PRN'yi POWERPOINT ile birleştirin. PRN Birleştirin.
...
{{% blocks/products/pf/agp/content h2="C# Online\'da PRN\'yi POWERPOINT ile Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, Aspose.Cells for .NET'de PRN'nin POWERPOINT ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

PRN'yi POWERPOINT ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından POWERPOINT dosyasına kaydedin. C#'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. PRN'yi POWERPOINT ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C#\'de PRN\'yi POWERPOINT ile Birleştirmek İçin Ücretsiz Çevrimiçi" InputFormat="prn" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="PRN\'yi C# üzerinden POWERPOINT ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 Programlı olarak PRN'yi POWERPOINT ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi POWERPOINT ile birleştirmek için .NET kitaplığı" %}}
