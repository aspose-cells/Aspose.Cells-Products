---
title: Gộp OTS vào POWERPOINT - Gộp OTS vào POWERPOINT trong C#
url: /vi/net/merger/merge-ots-to-powerpoint/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất OTS thành định dạng lưu POWERPOINT. C# Kết hợp định dạng OTS thành POWERPOINT. Hợp nhất OTS thành POWERPOINT theo số C#. Hợp nhất OTS.
...
{{% blocks/products/pf/agp/content h2="Gộp OTS vào POWERPOINT theo số C#" %}}

Ví dụ sau minh họa cách hợp nhất OTS thành POWERPOINT trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất OTS với POWERPOINT. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp POWERPOINT. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất OTS với POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp OTS vào POWERPOINT trong C#" InputFormat="ots" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp OTS vào POWERPOINT qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất OTS vào POWERPOINT theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để gộp OTS vào POWERPOINT" %}}
