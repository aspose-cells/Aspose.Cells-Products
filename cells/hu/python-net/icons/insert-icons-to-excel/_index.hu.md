---
title:  Szúrjon be SVG képet/ikont az Excelbe a Python számon keresztül
weight: 200
description: Python forráskód SVG kép/ikon beillesztéséhez az Excelbe.
---
...
{{% blocks/products/pf/agp/content h2="SVG képek/ikonok beszúrása Excel fájlba a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A SVG kép/ikon beszúrásának lépései az Excel-fájlba a Python számon keresztül" %}}
...
+ Használja a shapecollection hozzáadási módszerét egy ikon beszúrásához a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="SVG kép/ikon beszúrása - Python" offSpacer="" %}}
