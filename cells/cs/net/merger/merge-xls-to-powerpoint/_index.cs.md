...
description: Aspose Excel. C# Aspose.Cells. Sloučit XLS do formátu uložení POWERPOINT. C# Spojte XLS do formátu POWERPOINT. Sloučit XLS do POWERPOINT v C#. XLS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLS do POWERPOINT v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLS do POWERPOINT v C#" InputFormat="xls" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
