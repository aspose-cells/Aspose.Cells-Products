---
title:  Połącz XLT z JSON via Java
...
Poniższy przykład pokazuje, jak połączyć XLT z JSON w Java.
...
{{% cells-merger title="Darmowa aplikacja do łączenia XLT z JSON on-line" InputFormat="xlt" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
