...
description: Aspose Exceller. Convertissez XML en DIF rapidement et facilement avec Aspose.Cells. Java XML en DIF. Java Enregistrez XML en DIF. Enregistrez XML sous DIF en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Convertir XML en DIF à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer XML au DIF dans Java" %}}

L'exemple suivant montre comment convertir XML en DIF en Java.
...
{{% cells-convert title="Exemple de code pour convertir XML en DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="dif" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XML en DIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML en DIF par programme ? Les développeurs Java peuvent facilement convertir XML en DIF en quelques lignes de code seulement.
