...
url: /hu/net/merger/merge-jpg-to-spreadsheetml/ 
...
A következő példa bemutatja, hogyan egyesítheti a JPG-t a SPREADSHEETML-be a Aspose.Cells for .NET-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a JPG-t a SPREADSHEETML-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a JPG és a SPREADSHEETML egyesítéséhez" %}}
