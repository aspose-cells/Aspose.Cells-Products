---
title:  Gộp MHT sang POWERPOINT qua Python
...
Ví dụ sau minh họa cách hợp nhất MHT với POWERPOINT trong Python.
...
{{% cells-merger title="Ứng dụng miễn phí để hợp nhất MHT với POWERPOINT trực tuyến" InputFormat="mht" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
