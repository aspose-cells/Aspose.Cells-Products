---
title: "XLTX konvertálása XLS-re a következőn keresztül: Java "
weight: 2220

description: Minta Java konverziós kód az XLTX formátumhoz XLS fájllá. A programozók ezt a példakódot használhatják Excel és OpenOffice táblázatok XLS formátumba exportálására bármely web- vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLTX konvertálása XLS-re a következőn keresztül: Java" h2="XLTX-ből XLS-be Java konverzió, amellyel egyetlen vagy több oldalt konvertálhat XLS-vé a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="XLTX konvertálása XLS-re a következővel: Java" %}}

 Az XLTX XLS-re történő rendereléséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLTX XLS-re konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak XLTX fájlt XLS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLTX fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XLS kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XLS-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="XLTX-ből XLS-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az XLTX fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.xltx");
// mentse az XLTX-et XLS-ként
