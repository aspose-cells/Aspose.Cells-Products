---
title:  Insertar llamadas en Excel via Java
weight: 360
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar llamadas al archivo de Excel via Java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[añadir método](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-)para insertar llamadas en la hoja de cálculo seleccionada
...
El siguiente código de ejemplo muestra cómo insertar una "burbuja de pensamiento: nube". Para obtener más tipos, consulte "Descripción general de los tipos de llamadas en bloque" a continuación.
