...
{{% blocks/products/pf/agp/content h2="Sla OTS op in WORD in Java" %}}

Het volgende voorbeeld laat zien hoe je OTS naar WORD converteert in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je OTS naar WORD via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u OTS-bestanden programmatisch converteren naar WORD? Ontwikkelaars van Java kunnen OTS-bestanden eenvoudig converteren naar WORD met slechts een paar regels code.
