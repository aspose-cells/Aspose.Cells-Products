...
O exemplo a seguir demonstra como mesclar PRN para PPTX em Aspose.Cells for C++.
...
Precisa mesclar PRN para PPTX programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para mesclar PRN para PPTX" %}}
