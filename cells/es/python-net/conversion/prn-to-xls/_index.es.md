...
description: Aspose Excel. Convierta PRN a XLS rápida y fácilmente con Aspose.Cells. Python PRN a XLS. Python Guarde PRN en XLS. Guarde PRN como XLS usando Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PRN a XLS en Python" h2="Biblioteca Python de alta velocidad para convertir PRN a XLS. Utilice nuestra conversión de Excel API para desarrollar software independiente de plataforma de alto nivel en Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convertir PRN a XLS en Python" %}}
...
{{% blocks/products/pf/agp/content h2="Guardar PRN al XLS en Python" %}}

El siguiente ejemplo demuestra cómo convertir PRN a XLS en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir PRN a XLS" %}}
