---
title: Unisci NUMBERS a ODS - Combina NUMBERS a ODS in Python
url: /it/python-net/merger/merge-numbers-to-ods/ 
description: Aspose Excel. Python Aspose.Cells. Unisci NUMERI online gratuiti in ODS saveformat. Python Combina i NUMERI nel formato ODS. Unisci NUMBERS a ODS in Python. NUMBERS Unisci.
...
L'esempio seguente mostra come unire NUMBERS a ODS in Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Online gratuito per unire NUMERI a ODS in Python" InputFormat="numbers" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Come unire i NUMERI a ODS tramite Python" %}}

{{% blocks/products/pf/agp/text %}}

 Hai bisogno di unire NUMBERS a ODS a livello di programmazione? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Le API possono essere eseguite con poche righe di codice.
