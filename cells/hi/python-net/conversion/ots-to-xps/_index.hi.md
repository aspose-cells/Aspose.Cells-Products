---
title: Python ओटीएस से XPS - ओटीएस से XPS कन्वर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ OTS को XPS में जल्दी और आसानी से बदलें। Python OTS को XPS पर बदलें। Python OTS को XPS पर सहेजें। Python का उपयोग करके OTS को XPS के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="OTS को Python में XPS पर सेव करें" %}}
...
{{% cells-convert title="ओटीएस को XPS में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="xps" IsLandingPage="true" language="pythonnet" %}}
