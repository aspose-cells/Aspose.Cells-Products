---
title: "SXC konvertálása XLS-re a következőn keresztül: Java "
url: /hu/java/conversion/sxc-to-xls/ 
description: Minta Java konverziós kód az SXC formátumhoz XLS fájllá. A programozók ezt a példakódot használhatják Excel és OpenOffice táblázatok XLS formátumba exportálására bármely web- vagy asztali Java alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SXC konvertálása XLS-re a következőn keresztül: Java" h2="SXC-ből XLS-be Java konverzió, amellyel egyetlen vagy több oldalt konvertálhat XLS-vé a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása XLS-re a következővel: Java" %}}

 Ahhoz, hogy az SXC-t XLS-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az SXC XLS-vé konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatnak SXC fájlt XLS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az SXC-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XLS kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XLS-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="SXC–XLS Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az SXC fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.sxc");
// mentse az SXC-t XLS-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC-ből XLS-be konvertáló élő bemutatók" sectionDescription="[Az SXC konvertálása XLS-re](https://products.aspose.app/cells/conversion/sxc-to-xls) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel az SXC fájlt, és azonnal XLS-re konvertálódik." >}}
