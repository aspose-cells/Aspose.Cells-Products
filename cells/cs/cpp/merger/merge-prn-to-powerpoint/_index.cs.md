...
url: /cs/cpp/merger/merge-prn-to-powerpoint/ 
description: Aspose Excel. C++ Aspose.Cells. Bezplatné online sloučení PRN do formátu uložení POWERPOINT. C++ Kombinujte PRN s formátem POWERPOINT. Sloučit PRN do POWERPOINT na C++. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN do POWERPOINT na C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit PRN do POWERPOINT v Aspose.Cells for C++.
...
{{% cells-merger title="Online zdarma ke sloučení PRN do POWERPOINT na C++" InputFormat="prn" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN do POWERPOINT přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit PRN do POWERPOINT programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovnu pro sloučení PRN do POWERPOINT" %}}
