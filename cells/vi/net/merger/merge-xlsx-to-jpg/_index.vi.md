---
title: Gộp XLSX thành JPG - Gộp XLSX sang JPG trong C#
url: /vi/net/merger/merge-xlsx-to-jpg/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất XLSX thành định dạng lưu JPG. C# Kết hợp XLSX sang định dạng JPG. Hợp nhất XLSX thành JPG vào C#. XLSX Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất XLSX thành JPG vào C#" %}}

Ví dụ sau đây minh họa cách hợp nhất XLSX thành JPG trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất XLSX sang JPG. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp và sau đó lưu nó vào tệp JPG. Nếu bạn phát triển mã theo số C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất XLSX thành JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu ghép XLSX sang JPG năm C#" InputFormat="xlsx" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp XLSX sang JPG qua C#" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để ghép XLSX sang JPG" %}}
