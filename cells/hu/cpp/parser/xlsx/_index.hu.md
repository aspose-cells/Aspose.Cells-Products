---
title: Szöveg és képek kibontása a XLSX dokumentumból a C++ számon keresztül
weight: 570
description: C++ példakód szövegek és képek kinyerésére a C++ C++ C++ számú XLSX fájlból a Windows 32 bites, Windows 64 bites és a 64 bites Linux futásidejű környezethez.
