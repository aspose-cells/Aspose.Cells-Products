---
title:  Dodaj lub usuń XLS Adnotacja via .NET
weight: 9270
description: Kod źródłowy C# do dodawania i usuwania adnotacji w formacie XLS na platformach .NET Framework, .NET Core, Mono lub platformach Xamarin.
...
{{% blocks/products/pf/agp/feature-section-col title="Dodaj lub usuń adnotację od XLS do C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Usuń adnotacje z numerów XLS–C#" offSpacer="" %}}
