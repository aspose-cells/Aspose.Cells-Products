...
description: Aspose Excel。 Python Aspose.Cells。將 PRN 合併至 OTS 儲存格式。 Python 將 PRN 合併為 OTS 格式。將 PRN 合併到 Python 中的 OTS。PRN 合併。
...
{{% blocks/products/pf/agp/content h2="使用 Python 將 PRN 合併到 OTS" %}}
...
{{% blocks/products/pf/agp/content h2="將 PRN 合併到 Python 中的 OTS" %}}
...
{{% cells-merger title="將 PRN 合併到 OTS 的範例程式碼（Python）" InputFormat="prn" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何透過 Python 將 PRN 合併到 OTS" %}}
