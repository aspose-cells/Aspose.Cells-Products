...
description: TSV créateur. Créez des fichiers TSV dans le code C#. Générez des fichiers TSV à l'aide de VB.NET, Asp.NET ou de toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier TSV via C#" h2="Création native et haute performance TSV (valeurs séparées par des tabulations) par programme à l\'aide des API .NET côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer TSV via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code pour créer un fichier TSV en utilisant C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="bibliothèque C# pour créer le fichier TSV" %}}
