---
title:  Fusionner MHT avec XPS via Java
...
L'exemple suivant montre comment fusionner MHT avec XPS dans Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner MHT avec XPS. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier XPS. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne MHT en XPS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Application gratuite pour fusionner MHT avec XPS en ligne" InputFormat="mht" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
