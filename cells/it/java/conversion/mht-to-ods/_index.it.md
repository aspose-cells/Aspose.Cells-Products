---
title: Convertitore da Java MHT a ODS - Convertitore da MHT a ODS
description: Aspose Excel. Converti MHT in ODS in modo rapido e semplice con Aspose.Cells. Java MHT in ODS. Java Salva MHT in ODS. Salva MHT come ODS utilizzando Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converti MHT in ODS in Java" h2="Libreria Java ad alta velocità per convertire MHT in ODS. Si tratta di una soluzione software professionale per importare ed esportare MHT, ODS e molti altri formati utilizzando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salva MHT allo ODS in Java" %}}

L'esempio seguente mostra come convertire MHT in ODS in Java.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per convertire MHT in ODS. Carica il tuo file MHT, quindi salvalo semplicemente come file ODS. Sia per la lettura MHT che per la scrittura ODS è possibile utilizzare nomi di file completi. Il contenuto e la formattazione dell'output ODS saranno identici al documento MHT originale.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Codice di esempio per convertire MHT in ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="ods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Come convertire MHT in ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

È necessario convertire i file MHT in ODS a livello di codice? Gli sviluppatori di Java possono convertire facilmente MHT in ODS in poche righe di codice.
...
1.  Converti MHT in ODS chiamando il metodo Workbook.save.
1.  Ottieni il risultato della conversione da MHT a ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Libreria Java per convertire MHT in ODS" %}}
{{% blocks/products/pf/agp/text %}}
