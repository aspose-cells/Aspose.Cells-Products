---
title: XLSM दस्तावेज़ को Java के माध्यम से सुरक्षित और लॉक करें 
weight: 9620
url: /hi/java/protect/xlsm/ 
description: Java JSP/JSF एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए रनटाइम एनवायरनमेंट पर पासवर्ड का उपयोग करके XLSM फ़ाइल को लॉक करने के लिए Java नमूना कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSM फ़ाइलें Java के माध्यम से एन्क्रिप्ट करें" h2=".NET लाइब्रेरी का उपयोग करके एक्सएलएसएम प्रारूप सहित एक्सेल स्प्रेडशीट को पासवर्ड से सुरक्षित रखें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके XLSM फ़ाइल को कैसे सुरक्षित करें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java के माध्यम से XLSM फ़ाइलों को सुरक्षित रखने के चरण" %}}
...
1. वर्कबुक क्लास को इंस्टेंट करके XLSM फाइल लोड करें1. प्रोटेक्शन टाइप और पासवर्ड के साथ प्रोटेक्ट (..) मेथड का इस्तेमाल करें1. सुरक्षित XLSM फ़ाइल को सेव () विधि द्वारा सहेजें
