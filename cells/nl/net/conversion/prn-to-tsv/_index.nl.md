...
description: Aspose Excel. Converteer PRN snel en eenvoudig naar TSV met Aspose.Cells. C# PRN naar TSV. C# Bewaar PRN naar TSV. Sla PRN op als TSV met behulp van C#.
...
{{% blocks/products/pf/agp/content h2="Bewaar PRN op TSV in C#" %}}

In het volgende voorbeeld ziet u hoe u PRN converteert naar TSV in C#.
