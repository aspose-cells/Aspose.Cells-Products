...
{{% blocks/products/pf/agp/content h2="How to Create PNG in PHP" %}}
...
1.  Save the workbook as PNG format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create PNG file in PHP." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="PHP library to create PNG file" %}}
