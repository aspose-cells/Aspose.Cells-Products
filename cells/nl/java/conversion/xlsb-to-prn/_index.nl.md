...
{{% blocks/products/pf/agp/content h2="Sla XLSB op als PRN in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar PRN in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar PRN via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u XLSB-bestanden programmatisch naar PRN converteren? Ontwikkelaars van Java kunnen XLSB-bestanden eenvoudig in een paar regels code naar PRN converteren.
