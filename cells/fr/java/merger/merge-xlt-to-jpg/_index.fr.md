---
title: Fusionner XLT en JPG - Combiner XLT en JPG en Java
url: /fr/java/merger/merge-xlt-to-jpg/ 
description: Aspose Exceller. Java Aspose.Cells. Fusionner XLT au format de sauvegarde JPG. Java Combinez XLT au format JPG. Fusionner XLT en JPG dans Java. XLT Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLT en JPG dans Java" %}}

L'exemple suivant montre comment fusionner XLT en JPG dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner XLT en JPG. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-le dans un fichier JPG. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne XLT en JPG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemple de code pour fusionner XLT en JPG dans Java" InputFormat="xlt" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLT en JPG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner XLT en JPG par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour fusionner XLT en JPG" %}}
