...
description: Aspose Excel. Python Aspose.Cells. Gratis online Samenvoegen XLT naar TXT saveformat. Python Combineer het formaat XLT tot TXT. Samenvoegen XLT tot TXT in Python. XLT Samenvoegen.
...
Het volgende voorbeeld laat zien hoe u XLT kunt samenvoegen met TXT in Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Gratis online om XLT samen te voegen tot TXT in Python" InputFormat="xlt" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLT samen te voegen met TXT via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLT programmatisch samenvoegen tot TXT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen worden gedaan met slechts enkele regels code.
