---
title: Convertir XLSB en PNG via C#
url: /fr/net/conversion/xlsb-to-png/
description: Exemple de code pour la conversion de xlsb en png C#. Utilisez l'exemple de code API pour la conversion par lots de fichiers xlsb en png dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSB en PNG via C#" h2="Exportez des feuilles de calcul Excel® au format PNG sur .NET Framework, .NET Core, Mono ou Xamarin Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs .NET peuvent facilement charger et convertir des fichiers XLSB au format PNG en quelques lignes de code seulement.
