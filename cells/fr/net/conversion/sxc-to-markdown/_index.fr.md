...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SXC en MARKDOWN via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers SXC en MARKDOWN en quelques lignes de code seulement.
