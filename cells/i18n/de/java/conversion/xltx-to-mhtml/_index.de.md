---
title: Konvertieren Sie XLTX in MHTML über Java 
weight: 4920
url: /de/java/conversion/xltx-to-mhtml/ 
description: Beispiel-Umwandlungscode Java für das XLTX-Format in eine MHTML-Datei. Programmierer können diesen Beispielcode verwenden, um Excel- und OpenOffice-Tabellen in MHTML in jeder Web- oder Desktop-Java-basierten Anwendung zu exportieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLTX in MHTML über Java" h2="XLTX-zu-MHTML-Java-Konvertierung zum Konvertieren einzelner oder mehrerer Seiten in MHTML mithilfe der lokalen Java-Bibliothek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLTX in MHTML mit Java" %}}

 Um XLTX in MHTML zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von XLTX in MHTML über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können XLTX-Dateien in nur wenigen Codezeilen ganz einfach in MHTML konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. XLTX-Datei mit einer Instanz der Workbook-Klasse laden1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit MHTML-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende MHTML-Datei
...
{{% blocks/products/pf/agp/code-block title="XLTX-zu-MHTML-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die XLTX-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.xltx");
// XLTX als MHTML speichern
