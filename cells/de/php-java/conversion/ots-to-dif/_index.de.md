...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in DIF mit Aspose.Cells. PHP OTS in DIF. PHP Speichern Sie OTS in DIF. Speichern Sie OTS mit PHP als DIF.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über PHP in DIF" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in DIF konvertieren? PHP-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in DIF konvertieren.
...
1.  Konvertieren Sie OTS in DIF, indem Sie die Save-Methode von Workbook aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von OTS in DIF" %}}
