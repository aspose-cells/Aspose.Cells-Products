---
title: Połącz FODS z IMAGE - Połącz FODS z IMAGE w C++
url: /pl/cpp/merger/merge-fods-to-image/ 
description: Aspose Excel. C++ Aspose.Cells. Bezpłatne scalanie online FODS do formatu zapisu IMAGE. C++ Połącz FODS z formatem IMAGE. Połącz FODS z IMAGE w C++. FODS Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz FODS z IMAGE w C++ Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć FODS z IMAGE w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić FODS z IMAGE. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku IMAGE. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy FODS z IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online FODS z IMAGE w C++" InputFormat="fods" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć FODS z IMAGE przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić FODS z IMAGE? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia FODS z IMAGE" %}}
