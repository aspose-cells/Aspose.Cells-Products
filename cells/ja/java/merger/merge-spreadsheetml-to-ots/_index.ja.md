...
description: Aspose エクセル。 Java Aspose.Cells。SPREADSHEETML を OTS 保存形式にマージします。 Java SPREADSHEETML を OTS 形式に結合します。 SPREADSHEETML を Java の OTS にマージします。SPREADSHEETML をマージします。
...
{{% blocks/products/pf/agp/content h2="Java で SPREADSHEETML を OTS にマージします" %}}
...
{{% cells-merger title="Java で SPREADSHEETML を OTS にマージするサンプル コード" InputFormat="xml" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
