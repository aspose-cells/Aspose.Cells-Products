...
description: Aspose エクセル。 Java Aspose.Cells。EXCEL を FODS 保存形式にマージします。 Java EXCEL を FODS 形式に結合します。 EXCEL を Java の FODS に結合します。EXCEL を結合します。
...
{{% blocks/products/pf/agp/content h2="EXCEL を FODS に Java に結合" %}}
...
{{% cells-merger title="EXCELをFODSにJavaにマージするサンプルコード" InputFormat="xlsx" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
