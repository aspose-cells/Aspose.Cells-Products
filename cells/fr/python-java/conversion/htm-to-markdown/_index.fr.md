---
title: Python HTM à MARKDOWN - Convertisseur HTM à MARKDOWN
description: Aspose Excel. Cette solution complète offre aux développeurs Python une approche entièrement intégrée pour convertir le format HTM au format MARKDOWN, permettant un enregistrement transparent des données HTM au format MARKDOWN à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Python efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Convertir HTM en MARKDOWN à l\'aide de la bibliothèque Excel Python" %}}

 Comment convertir HTM en MARKDOWN ? Avec la bibliothèque Aspose.Cells for Python, vous pouvez facilement convertir HTM en MARKDOWN par programme avec quelques lignes de code.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. Python Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrer HTM au MARKDOWN dans la bibliothèque Excel Python" %}}

L'exemple suivant montre comment convertir HTM en MARKDOWN dans la bibliothèque Excel Python.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir HTM en MARKDOWN. Téléchargez votre fichier HTM, puis enregistrez-le simplement sous le nom de fichier MARKDOWN. Pour la lecture HTM et l'écriture MARKDOWN, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la sortie MARKDOWN seront identiques au document HTM original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir HTM en MARKDOWN via la bibliothèque Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="md" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en MARKDOWN via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers HTM en MARKDOWN par programme ? Les développeurs Python peuvent facilement charger et convertir HTM en MARKDOWN en quelques lignes de code seulement.
...
1.  Convertissez HTM en MARKDOWN en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de HTM en MARKDOWN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Bibliothèque Excel pour convertir HTM en MARKDOWN" %}}
