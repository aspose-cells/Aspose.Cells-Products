---
title: C++ XLSB en NUMBERS - Convertisseur en ligne XLSB en NUMBERS
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Gratuit en ligne C++ Convertissez XLSB en format de sauvegarde NUMBERS. C++ XLSB au format CHIFFRES. Enregistrez XLSB aux NUMÉROS C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB en NUMBERS dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en NUMBERS dans C++.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir XLSB en NUMBERS. Téléchargez votre fichier XLSB, puis enregistrez-le simplement en tant que fichier NUMBERS. Pour la lecture de XLSB et l'écriture de NUMBERS, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage des NUMBERS en sortie seront identiques à ceux du document XLSB d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir XLSB en NUMBERS en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="numbers" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en NUMBERS via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers XLSB en NUMBERS par programmation ? Les développeurs de C++ peuvent facilement convertir XLSB en NUMBERS en quelques lignes de code seulement.
...
1.  Convertissez XLSB en NUMBERS en appelant la méthode Save().
1.  Obtenez le résultat de la conversion de XLSB en NUMBERS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ bibliothèque pour convertir XLSB en NUMBERS" %}}
