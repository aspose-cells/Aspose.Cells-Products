---
title: 搜尋並取代 ODS 文件 via Java 中的文本
weight: 9210
description: Java 範例程式碼，用於編輯 JSP/JSF 應用程式和桌面應用程式的 Java 執行時間環境中的 ODS 檔案中的敏感資訊。
...
為了編輯 ODS 文件，我們將使用[Aspose.Cells for Java](https://products.aspose.com/cells/java) API這是一個功能豐富、功能強大且易於使用的編輯API for Java平台。您可以直接從以下位置下載其最新版本[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells)並透過將以下配置新增至 pom.xml 將其安裝在基於 Maven 的專案中。
