---
title: C++ XLTX ke PRN - XLTX ke PRN Konverter
description: Aspose Unggul. Ubah XLTX menjadi PRN dengan cepat dan mudah dengan Aspose.Cells. C++ XLTX menjadi PRN. C++ Simpan XLTX ke PRN. Simpan XLTX sebagai PRN menggunakan C++.
...
{{% blocks/products/pf/agp/content h2="Simpan XLTX ke PRN di C++" %}}

Contoh berikut menunjukkan cara mengonversi XLTX ke PRN di C++.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi XLTX ke PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="prn" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Convert XLTX ke PRN lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLTX ke PRN secara terprogram? Pengembang C++ dapat dengan mudah mengonversi XLTX ke PRN hanya dalam beberapa baris kode.
...
1.  Ubah XLTX menjadi PRN dengan memanggil metode Save().
1.  Dapatkan hasil konversi XLTX ke PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk mengonversi XLTX ke PRN" %}}
