...
다음 예에서는 SXC을 Aspose.Cells for .NET의 MD에 병합하는 방법을 보여줍니다.
...
{{% cells-merger title="SXC을 C#의 MD에 병합하는 샘플 코드" InputFormat="sxc" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="C#을 통해 SXC을 MD에 병합하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

 프로그래밍 방식으로 SXC을 MD에 병합해야 합니까? 병합하고 연결하는 기본 문서[Aspose.Cells for .NET](https://products.aspose.com/cells/net) 단 몇 줄의 코드만으로 API를 구현할 수 있습니다.
