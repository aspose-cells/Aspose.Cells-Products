---
title: C# JPG en SVG - Convertisseur en ligne JPG en SVG
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertir JPG en format de sauvegarde SVG. C# JPG au format SVG. Enregistrez JPG au SVG C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez JPG au SVG en C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir JPG en SVG en C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir JPG en SVG. Téléchargez votre fichier JPG, puis enregistrez-le simplement en tant que fichier SVG. Pour la lecture JPG et l'écriture SVG, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie SVG seront identiques au document JPG d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir JPG en SVG en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="svg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir JPG en SVG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en SVG par programmation ? Les développeurs .NET peuvent facilement charger et convertir JPG en SVG en quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="C# bibliothèque pour convertir JPG en SVG" %}}
