...
{{< blocks/products/pf/i18n/upper-banner h1="XLS-Formate in C++ schwärzen" h2="Natives und leistungsstarkes XLS dokumentiert vertrauliche Schwärzungsinformationen mit serverseitigen Aspose.Cells für C++-APIs, ohne die Verwendung von Software wie Microsoft oder Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="So schwärzen Sie eine XLS-Datei mit C++" %}}
 ...
 API, eine funktionsreiche, leistungsstarke und benutzerfreundliche Dokumentschwärzung API für die C++-Plattform. Sie können die neueste Version direkt herunterladen, einfach öffnen
...
{{< blocks/products/pf/agp/other-supported-section title="Andere unterstützte Schwärzungsdokumente" subTitle="Mit C++ kann man verschiedene Formate leicht redigieren, einschließlich." >}}
