---
title: C# OTS zu PDF - OTS zu PDF Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von OTS in das Format PDF und ermöglicht das nahtlose Speichern von OTS-Daten im Format PDF mithilfe der Bibliothek Aspose.Cells – alles durch effizienten und anpassbaren Code C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie OTS unter PDF in C#" %}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über C# in PDF" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in PDF konvertieren? .NET-Entwickler können OTS mit nur wenigen Codezeilen problemlos in PDF laden und konvertieren.
...
1.  Konvertieren Sie OTS in PDF durch Aufruf der Workbook.Save-Methode.
1.  Erhalten Sie das Konvertierungsergebnis von OTS zu PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von OTS nach PDF" %}}
