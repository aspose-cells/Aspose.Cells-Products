...
{{% blocks/products/pf/agp/content h2="كيفية إدراج المكعب في ملف إكسل باستخدام Python via.نت" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) لإدراج مكعب في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل المكعب - Python via .نت" offSpacer="" %}}
