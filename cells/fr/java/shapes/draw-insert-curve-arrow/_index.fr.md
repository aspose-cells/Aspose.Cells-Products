---
title:  Comment dessiner ou insérer une forme de flèche incurvée dans Excel via Java
weight: 30
description: Dessinez ou insérez une forme de flèche incurvée en utilisant Aspose.Cells' Java API sans aucun logiciel tel que Microsoft ou Open Office, Adobe PDF, etc.
...
{{% blocks/products/pf/agp/content h2="Comment insérer une forme de flèche incurvée dans un fichier Excel à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer une forme de flèche incurvée dans un fichier Excel via Java" %}}
...
+ Sélectionnez Feuille de calcul via son index.
 + Utilisez le[ajouter une méthode](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) pour insérer une forme de flèche incurvée dans la feuille de calcul sélectionnée
...
{{% blocks/products/pf/agp/code-block title="Insérer une forme de flèche incurvée - Java" offSpacer="" %}}
