...
{{< blocks/products/pf/i18n/upper-banner h1="Diviser ODS Fichiers via Java" h2="ODS fractionnement à l\'aide de la bibliothèque côté serveur Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
+ Charger le fichier ODS en utilisant la classe Workbook.
+ Parcourir chaque feuille
+ Créer un nouvel objet de classe Workbook
+ Copier la feuille sélectionnée dans un nouvel objet
+ Appelez la méthode save avec le nouveau chemin de fichier ODS.
...
{{% blocks/products/pf/agp/code-block title="Séparer ODS Fichier - Java" offSpacer="" %}}
