---
title: XML Oluştur - C++'de XML dosyası oluşturun
description: Aspose Excel. Aspose.Cells for C++ kütüphanesi ile XML dosyalarını zahmetsizce oluşturun ve işleyin. Bu güçlü API, XML dosyalarını doğrudan C++ uygulamalarınız içinde oluşturmak, düzenlemek ve yönetmek için akıcı ve verimli bir çözüm sunarak, geliştiricilerin özel ihtiyaçlarını yüksek hassasiyetle karşılar.
...
{{< blocks/products/pf/i18n/upper-banner h1="C++ numaralı işlemde XML dosyası oluşturun." h2="C++ kütüphanesini kullanarak Microsoft Office\'e ihtiyaç duymadan, yerel ve yüksek performanslı XML dosyalarını programatik olarak oluşturma." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="C++\'de XML Nasıl Oluşturulur?" %}}
...
1.  Çalışma kitabını Save() yöntemini kullanarak .xml dosyası olarak kaydedin.

{{% blocks/products/pf/agp/code-block title="Örnek kod, C++ numaralı cihazda XML dosyasının nasıl oluşturulacağını göstermektedir." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++ XML dosyası oluşturmak için kütüphane" %}}
