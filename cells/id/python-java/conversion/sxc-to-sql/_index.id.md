---
title: Python SXC ke SQL - Online SXC ke Konverter SQL
description: Aspose Unggul. Python Aspose.Cells. Python Aspose Cells. Online Gratis Python Ubah SXC menjadi format penyimpanan SQL. Python SXC ke format SQL. Simpan SXC ke SQL Python.
...
{{% blocks/products/pf/agp/content h2="Ubah SXC menjadi SQL Menggunakan Python" %}}
 ...
 Bagaimana cara mengonversi SXC ke SQL? Dengan perpustakaan Aspose.Cells for Python, Anda dapat dengan mudah mengonversi SXC ke SQL secara terprogram dengan beberapa baris kode.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)mampu membangun aplikasi lintas platform dengan kemampuan untuk menghasilkan, memodifikasi, mengonversi, merender, dan mencetak semua file Excel. Python Excel API tidak hanya mengkonversi antara format spreadsheet, tetapi juga dapat membuat file Excel sebagai gambar, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT dan lainnya, sehingga menjadikannya pilihan yang sempurna untuk bertukar dokumen dalam industri -standar format.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Simpan SXC ke SQL di Python Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi SXC ke SQL di Python.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah-langkah mudah untuk mengonversi SXC ke SQL. Unggah file SXC Anda, lalu simpan sebagai file SQL. Untuk pembacaan SXC dan penulisan SQL, Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan pemformatan SQL keluaran akan identik dengan dokumen SXC asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi SXC ke SQL Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="sql" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Bagaimana Mengkonversi SXC ke SQL melalui Python" %}}
...
1.  Ubah SXC menjadi SQL dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi SXC ke SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Pustaka Python untuk mengonversi SXC menjadi SQL" %}}
