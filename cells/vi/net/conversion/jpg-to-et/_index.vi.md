...
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi JPG sang ET trong C#" h2="Thư viện tốc độ cao C# dùng để chuyển đổi JPG sang ET. Đây là giải pháp phần mềm chuyên nghiệp để nhập và xuất JPG, ET và nhiều định dạng khác trên Khung .NET, Lõi .NET hoặc Nền tảng Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPG" >}}
...
1. Chuyển đổi định dạng JPG sang ET bằng cách gọi phương thức Workbook.Save.
