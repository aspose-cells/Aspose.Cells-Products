...
Poniższy przykład pokazuje, jak przekonwertować XLSX na MHT w Python via NET.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSX na MHT" %}}
