...
description: Aspose Excel. Konwertuj XML na JPG szybko i łatwo za pomocą Aspose.Cells. Python XML na JPG. Python Zapisz XML w formacie JPG. Zapisz XML jako JPG, używając numeru Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML w formacie JPG pod numerem Python" %}}

Poniższy przykład ilustruje konwersję XML na JPG w Python.
...
{{% cells-convert title="Przykładowy kod do konwersji XML na JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="jpg" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji XML na JPG" %}}
