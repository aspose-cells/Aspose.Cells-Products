---
title: C# FODS в ETT - FODS в ETT Конвертер
description: Aspose Эксель. Преобразуйте FODS в ETT быстро и легко с помощью Aspose.Cells. C# FODS в ETT. C# Сохраните FODS в ETT. Сохраните FODS как ETT, используя C#.
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в ETT в C#." %}}

В следующем примере показано, как преобразовать FODS в ETT в C#.
...
{{% cells-convert title="Пример кода для преобразования FODS в ETT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="ett" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Как конвертировать FODS в ETT через C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно конвертировать файлы FODS в ETT? Разработчики .NET могут легко загрузить и преобразовать FODS в ETT всего за несколько строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования FODS в ETT" %}}
