---
title: Sloučit PRN s PDF – Sloučit PRN s PDF v C++
url: /cs/cpp/merger/merge-prn-to-pdf/ 
description: Aspose Excel. C++ Aspose.Cells. Zdarma online sloučit PRN do formátu uložení PDF. C++ Zkombinujte PRN do formátu PDF. Sloučit PRN na PDF v C++. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN na PDF v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit PRN s PDF v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN do PDF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru PDF. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí PRN do PDF.
...
{{% blocks/products/pf/agp/content h2="Jak sloučit PRN na PDF přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit PRN s PDF programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení PRN s PDF" %}}
