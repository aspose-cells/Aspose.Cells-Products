...
description: Aspose Excel. C++ Tạo file SXC nhanh chóng và dễ dàng với Aspose.Cells. Tạo file SXC bằng C++. Tạo SXC trong C++. C++ SXC Creator.
...
1.  Lưu sổ làm việc dưới dạng tệp .sxc bằng phương thức Save().
