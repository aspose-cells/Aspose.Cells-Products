---
title: Převést TSV na XLTX přes Java 
weight: 6680
url: /cs/java/conversion/tsv-to-xltx/ 
description: Ukázkový konverzní kód Java pro formát TSV na soubor XLTX. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do XLTX v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést TSV na XLTX přes Java" h2="Převod TSV na XLTX Java pro převod jedné nebo více stránek na XLTX pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést TSV na XLTX pomocí Java" %}}

 K vykreslení TSV do XLTX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod TSV na XLTX prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor TSV na XLTX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TSV s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLTX a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLTX
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu TSV na XLTX Java" offSpacer="" %}}

```cs
// načíst soubor TSV v instanci sešitu
Workbook book = new Workbook("template.tsv");
// uložit TSV jako XLTX
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze TSV na XLTX" sectionDescription="[Převést TSV na XLTX](https://products.aspose.app/cells/conversion/tsv-to-xltx) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor TSV, bude okamžitě převeden na XLTX." >}}
