---
title: XLS दस्तावेज़ में टेक्स्ट को C++ के माध्यम से खोजें और बदलें
weight: 380
description: Windows 32 बिट, Windows 64 बिट और लिनक्स 64 बिट के लिए C++ रनटाइम एनवायरनमेंट पर XLS फ़ाइल में संवेदनशील जानकारी को संशोधित करने के लिए C++ उदाहरण कोड।
...
{{< blocks/products/pf/i18n/upper-banner h1="C++ में XLS प्रारूप को संशोधित करें" h2="मूल और उच्च प्रदर्शन XLS, Microsoft या एडोब PDF जैसे किसी भी सॉफ्टवेयर के उपयोग के बिना, सर्वर-साइड Aspose.Cells for C++ एपीआई का उपयोग करके संवेदनशील संपादन जानकारी को दस्तावेज़ित करता है।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
