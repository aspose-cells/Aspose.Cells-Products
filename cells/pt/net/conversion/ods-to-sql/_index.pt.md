...
{{< blocks/products/pf/i18n/upper-banner h1="Converter ODS para SQL em C#" h2="Biblioteca de alta velocidade C# para conversão de ODS para SQL. Esta é uma solução de software profissional para importar e exportar ODS, SQL e muitos outros formatos nas plataformas .NET Framework, .NET Core ou Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SQL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
Precisa converter arquivos ODS para SQL programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em SQL em apenas algumas linhas de código.
...
1.  Converta ODS para SQL chamando o método Workbook.Save.
