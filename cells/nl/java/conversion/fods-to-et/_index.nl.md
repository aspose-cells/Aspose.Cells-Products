---
title: Java FODS naar ET - FODS naar ET-converter
description: Aspose Excel. Converteer FODS snel en eenvoudig naar ET met Aspose.Cells. Java FODS naar ET. Java Bewaar FODS naar ET. Bewaar FODS als ET met Java.
...
{{% blocks/products/pf/agp/content h2="Bewaar FODS naar ET in Java" %}}

Het volgende voorbeeld laat zien hoe u FODS naar ET in Java converteert.
...
{{% blocks/products/pf/agp/content h2="Hoe FODS naar ET via Java te converteren" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u FODS-bestanden programmatisch naar ET converteren? Java-ontwikkelaars kunnen FODS eenvoudig in slechts een paar regels code naar ET converteren.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om FODS naar ET te converteren" %}}
{{% blocks/products/pf/agp/text %}}
