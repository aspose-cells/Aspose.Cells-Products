...
{{% cells-convert title="Sample Code to Convert TXT to ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="txt" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert TXT to ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert TXT files to ODS programmatically? .NET developers can easily load & convert TXT to ODS in just a few lines of code.
...
1.  Convert TXT to ODS by calling Workbook.Save method.
