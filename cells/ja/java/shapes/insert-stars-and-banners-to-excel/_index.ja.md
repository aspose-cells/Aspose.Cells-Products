...
{{% blocks/products/pf/agp/content h2="Java を使用して Excel ファイルにスターとバナーを挿入する方法" %}}

Insert Stars And Banners を Excel ファイルに挿入するには、次を使用します。
...
{{% blocks/products/pf/agp/feature-section-col title="Excel ファイルにスターとバナーを挿入する手順 via Java" %}}
...
+ インデックスからワークシートを選択します。
 + を使用してください[メソッドの追加](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-)選択したワークシートに「スターとバナーを挿入」を挿入するには
...
{{% blocks/products/pf/agp/code-block title="挿入 スターとバナーを挿入 - Java" offSpacer="" %}}
