---
title: EXCEL'i OTS ile Birleştirin - Java'de EXCEL'i OTS ile Birleştirin
url: /tr/java/merger/merge-excel-to-ots/ 
description: Aspose Excel'de. Java Aspose.Cells. EXCEL'i OTS kaydetme biçimiyle birleştirin. Java EXCEL'i OTS formatıyla birleştirin. Java'de EXCEL'i OTS ile birleştir. EXCEL Birleştir.
keywords: [Aspose Excel., Java Aspose.Cells., Merge EXCEL to OTS in Java., Java Merge EXCEL to ots., Java Combine EXCEL to OTS., EXCEL Merge]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="EXCEL\'i OTS via Java ile birleştir" h2="EXCEL\'i OTS ile birleştirmek için yüksek hızlı Java kitaplığı. Java\'de üst düzey, platformdan bağımsız yazılım geliştirmek için API excel dönüşümümüzü kullanın. Bu, Excel, CSV, OpenOffice, PDF, HTML, image\'i ve diğer birçok excel formatını içe ve dışa aktarmak için profesyonel bir yazılım çözümüdür." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="EXCEL" additionalConversionTag="OTS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Java\'de EXCEL\'i OTS ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de EXCEL'in OTS ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

EXCEL'i OTS ile birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından OTS dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. EXCEL'i OTS ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Java\'de EXCEL\'i OTS ile Birleştirmek için Örnek Kod" InputFormat="xlsx" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i OTS via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 EXCEL'i OTS ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i OTS ile birleştirmek için Java kütüphane" %}}
