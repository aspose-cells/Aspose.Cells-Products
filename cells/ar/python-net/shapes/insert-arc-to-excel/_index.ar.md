...
{{% blocks/products/pf/agp/content h2="كيفية إدراج القوس في ملف Excel باستخدام Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج ملف Arc to Excel باستخدام Python via .Net" %}}
...
+ استخدم طريقة الإضافة الخاصة بمجموعة الأشكال لإدراج قوس في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل القوس - Python via .نت" offSpacer="" %}}
