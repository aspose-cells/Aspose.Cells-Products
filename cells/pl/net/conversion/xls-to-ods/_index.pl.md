---
title: C# XLS do ODS - XLS do ODS Konwerter
description: Aspose Excel. Konwertuj XLS na ODS szybko i łatwo za pomocą Aspose.Cells. C# XLS na ODS. C# Zapisz XLS na ODS. Zapisz XLS jako 0761113 481 pod numerem C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do ODS w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować XLS na ODS w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XLS na ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na ODS przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na ODS? Programiści .NET mogą łatwo załadować i przekonwertować XLS na ODS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XLS na ODS" %}}
