...
{{< blocks/products/pf/i18n/upper-banner h1="將 FODS 轉換為 TSV，其中 C#" h2="高速 C# 庫，用於將 FODS 轉換為 TSV。這是一個專業的軟體解決方案，可在 .NET 框架、.NET 核心或 Mono 平台上匯入和匯出 FODS、TSV 和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% cells-convert title="將 FODS 轉換為 TSV 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="tsv" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 FODS 轉換為 TSV" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 FODS 檔案轉換為 TSV 嗎？ .NET 開發人員只需幾行程式碼即可輕鬆載入和轉換 FODS 到 TSV。
...
1. 使用工作簿實例載入 FODS 檔案。
1. 透過呼叫 Workbook.Save 方法將 FODS 轉換為 TSV。
1. 取得FODS到TSV的轉換結果。
