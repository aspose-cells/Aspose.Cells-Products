---
title:  Rechercher le document XLS sans ouvrir via le C++
weight: 4560
description: Exemple de code C++ pour rechercher des mots avec un motif dans le fichier XLS sur l'environnement d'exécution C++ pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
...
{{% blocks/products/pf/agp/content h2="Comment rechercher le fichier XLS à l\'aide de C++" %}}
...
+ Chargez le fichier XLS en instanciant une classe Workbook.
...
+ Enregistrez le fichier XLS en utilisant la méthode Workbook::Save(...).
...
{{% blocks/products/pf/agp/code-block title="Recherche XLS Fichiers - C++" offSpacer="" %}}
