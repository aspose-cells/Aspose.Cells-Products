...
description: Aspose Excel. Převeďte XML na ET rychle a snadno pomocí Aspose.Cells. Python XML na ET. Python Uložit XML do ET. Uložit XML jako ET pomocí Python.
...
{{% blocks/products/pf/agp/content h2="Uložit XML do ET na Python" %}}
...
{{% cells-convert title="Ukázkový kód pro převod XML na ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="et" IsLandingPage="true" language="pythonjava" %}}
