---
title: Convertisseur MHT vers MD Java
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le format MHT au format MD, permettant un enregistrement transparent des données MHT au format MD à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Sauvegarder MHT à MD dans Java" %}}

L'exemple suivant montre comment convertir MHT en MD dans Java.
{{% blocks/products/pf/agp/text %}}

Suivez ces étapes simples pour convertir un fichier MHT en MD. Téléchargez votre fichier MHT, puis enregistrez-le au format MD. Vous pouvez utiliser des noms de fichiers complets pour la lecture des fichiers MHT et l'écriture des fichiers MD. Le contenu et la mise en forme du fichier MD généré seront identiques à ceux du document MHT original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir MHT en MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mht" outformat="md" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir MHT en MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers MHT en MD par programmation ? Les développeurs de Java peuvent facilement convertir des fichiers MHT en MD en quelques lignes de code seulement.
...
1.  Convertissez le format MHT en MD en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de MHT en MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir MHT en MD" %}}
{{% blocks/products/pf/agp/text %}}
