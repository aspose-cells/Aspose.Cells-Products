---
title:  Edytuj lub wyświetl XLSX Metadane plików via Java
weight: 1240
description: Java przykładowy kod do edycji lub przeglądania metadanych w formacie XLSX w środowisku wykonawczym Java dla aplikacji JSP/JSF i aplikacji komputerowych.
...
{{< blocks/products/pf/i18n/upper-banner h1="Wyciąg XLSX Metadane via Java" h2="Twórz własne aplikacje Java, aby dodawać, edytować, usuwać lub wyodrębniać metadane z plików XLSX za pomocą interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak wyodrębnić metadane XLSX przy użyciu Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wyodrębnić metadane z numeru XLSX via Java" %}}
