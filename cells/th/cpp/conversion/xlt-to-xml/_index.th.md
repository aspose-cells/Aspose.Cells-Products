---
title: C++ XLT เป็น XML - XLT เป็น XML Converter
description: Aspose เอ็กเซล. แปลง XLT เป็น XML อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XLT เป็น XML C++ บันทึก XLT ลงใน XML บันทึก XLT เป็น XML โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึก XLT ลงใน XML ใน C++" %}}
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง XLT เป็น XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="xml" IsLandingPage="true" language="cpp" %}}
...
1.  แปลง XLT เป็น XML โดยการเรียกเมธอด Save()
