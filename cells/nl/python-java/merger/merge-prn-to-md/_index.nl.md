...
url: /nl/python-java/merger/merge-prn-to-md/ 
...
Het volgende voorbeeld laat zien hoe u PRN kunt samenvoegen met MD in Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u PRN programmatisch samenvoegen met MD? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
