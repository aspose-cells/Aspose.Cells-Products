---
title: تحويل ODS إلى PDF عبر Java 
weight: 4170
url: /ar/java/conversion/ods-to-pdf/ 
description: نموذج Java رمز تحويل لتنسيق ODS إلى ملف PDF. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel و OpenOffice إلى PDF داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل ODS إلى PDF عبر Java" h2="ODS إلى PDF Java لتحويل صفحات مفردة أو متعددة إلى PDF باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل ODS إلى PDF باستخدام Java" %}}

 من أجل تحويل ODS إلى PDF ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل ODS إلى PDF عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف ODS إلى PDF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف ODS مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد PDF & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف PDF الناتج
...
{{% blocks/products/pf/agp/code-block title="ODS to PDF Java كود مصدر التحويل" offSpacer="" %}}

```cs
// تحميل ملف ODS في مثيل مصنف
Workbook book = new Workbook("template.ods");
// حفظ نظام الوثائق الرسمية بصيغة PDF
