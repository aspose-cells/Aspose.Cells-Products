---
title: Convertidor PHP MHTML a JSON - MHTML a JSON
description: Aspose Excel. Convierta MHTML a JSON rápida y fácilmente con Aspose.Cells. PHP MHTML a JSON. PHP Guarde MHTML a JSON. Guarde MHTML como JSON usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir MHTML a JSON mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos MHTML a JSON mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente MHTML a JSON en tan solo unas pocas líneas de código.
...
1.  Convierta MHTML a JSON llamando al método guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de MHTML a JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir MHTML a JSON" %}}
