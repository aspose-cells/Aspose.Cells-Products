---
title:  A SPREADSHEETML egyesítése a TSV-gyel a Python-en keresztül
url: /hu/python-net/merger/merge-spreadsheetml-to-tsv/ 
description: Ingyenesen egyesítse a SPREADSHEETML-t a TSV online számmal. Ingyenes online SPREADSHEETML a TSV egyesüléshez. Egyesítse a SPREADSHEETML fájlokat a Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS és más fájlokkal.
---
...
{{% blocks/products/pf/agp/content h2="A SPREADSHEETML egyesítése a TSV-gyel a Python használatával" %}}
 ...
 Hogyan lehet egyesíteni a SPREADSHEETML-t a TSV-gyel? A Aspose.Cells for Python könyvtárral egyszerűen egyesítheti a SPREADSHEETML-t a TSV-gyel programozottan, néhány sornyi kóddal.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells-python) képes többplatformos alkalmazásokat létrehozni, módosítani, konvertálni, renderelni és kinyomtatni az összes Excel fájlt. Python Excel API nem csak a táblázatformátumok között konvertál, hanem Excel fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, CSV, CSV, CSV, CSV, CSV, SVG, és így tovább, SVG P, 8 PT a választás,3,8 ipari szabvány szerinti dokumentumok cseréjére formátumok. A Aspose.Cells for Python címet innen telepítheti<a href="https://pypi.org/project/aspose-cells/">pypi</a> , használja a parancsot a következőképpen:<code>$ pip install aspose-cells-python</code>.
...
A következő példa bemutatja, hogyan egyesítheti a SPREADSHEETML-t a TSV-es számmal a Python-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a SPREADSHEETML TSV-es egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a TSV fájlba. Ha kódot fejleszt a Python-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a Python példát, amely egyesíti a SPREADSHEETML-t a TSV-gyel.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes alkalmazás a SPREADSHEETML és a TSV online egyesítéséhez" InputFormat="xml" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
