---
title: C# XML na XLTX - Konwerter XML na XLTX
description: Aspose Excel. Konwertuj XML na XLTX szybko i łatwo za pomocą Aspose.Cells. C# XML na XLTX. C# Zapisz XML na XLTX. Zapisz XML jako XLTX używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML pod numerem XLTX w C#" %}}

Poniższy przykład ilustruje, jak przekonwertować kod XML na XLTX w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XML na XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xltx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XML na XLTX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XML na XLTX? Programiści .NET mogą łatwo załadować i przekonwertować XML na XLTX w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XML na XLTX" %}}
