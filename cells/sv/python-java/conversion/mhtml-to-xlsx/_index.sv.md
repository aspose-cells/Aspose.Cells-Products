---
title: Konvertera MHTML till XLSX via Python
url: /sv/python-java/conversion/mhtml-to-xlsx/
description: Exempelkod för konvertering från mhtml till xlsx Python. Använd API exempelkod för batch-mhtml-filer till xlsx-konvertering i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar MHTML till XLSX med Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera MHTML till XLSX via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera MHTML-filer till XLSX på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda MHTML-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med XLSX-tillägg som parameter1. Kontrollera den angivna sökvägen för den resulterande XLSX-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera MHTML till XLSX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="xlsx" IsLandingPage="true" language="python" %}}
