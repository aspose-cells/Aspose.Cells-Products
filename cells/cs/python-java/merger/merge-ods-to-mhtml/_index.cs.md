---
title: Sloučit ODS až MHTML - Sloučit ODS až MHTML v Python
url: /cs/python-java/merger/merge-ods-to-mhtml/ 
description: Aspose Excel. Python Aspose.Cells. Online sloučení zdarma ODS do formátu uložení MHTML. Python Kombinujte formát ODS až MHTML. Sloučit ODS až MHTML v Python. ODS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit ODS až MHTML pomocí Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit ODS až MHTML v Python Online zdarma" %}}

Následující příklad ukazuje, jak sloučit ODS až MHTML v Aspose.Cells for Python via Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení ODS do MHTML. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru MHTML. Pokud vytvoříte kód v Python, bude to jednodušší, než to zní. Viz příklad Python, který sloučí ODS do MHTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení ODS až MHTML v Python" InputFormat="ods" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit ODS na MHTML přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit ODS až MHTML? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Python ke sloučení ODS až MHTML" %}}
