---
title: Mesclar PRN para XLT - Combine PRN para XLT em C++
url: /pt/cpp/merger/merge-prn-to-xlt/ 
description: Aspose Excel. C++ Aspose.Cells. Mesclar PRN online grátis para XLT saveformat. C++ Combine PRN para o formato XLT. Mesclar PRN para XLT em C++. Mesclar PRN.
...
O exemplo a seguir demonstra como mesclar PRN para XLT em Aspose.Cells for C++.
...
{{% cells-merger title="Online grátis para mesclar PRN para XLT em C++" InputFormat="prn" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar PRN para XLT via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa mesclar PRN para XLT programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) As APIs podem ser feitas com apenas algumas linhas de código.
