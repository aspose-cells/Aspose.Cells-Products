---
title: Convertisseur Python XLSM vers AZW3 - XLSM vers AZW3
description: Aspose Excel. Cette solution complète offre aux développeurs Python une approche entièrement intégrée pour convertir XLSM au format AZW3, permettant un enregistrement transparent des données XLSM au format AZW3 à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Python efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Convertir XLSM en AZW3 à l\'aide de la bibliothèque Excel Python" %}}

 Comment convertir XLSM en AZW3 ? Grâce à la bibliothèque Aspose.Cells for Python, vous pouvez facilement convertir XLSM en AZW3 par programmation en quelques lignes de code.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. Python Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrez XLSM au format AZW3 dans la bibliothèque Excel Python" %}}

L'exemple suivant montre comment convertir XLSM en AZW3 dans la bibliothèque Excel Python.
{{% blocks/products/pf/agp/text %}}

Suivez ces étapes simples pour convertir un fichier XLSM en AZW3. Téléchargez votre fichier XLSM, puis enregistrez-le au format AZW3. Vous pouvez utiliser des noms de fichiers complets pour la lecture du fichier XLSM et l'écriture au format AZW3. Le contenu et la mise en forme du fichier AZW3 généré seront identiques à ceux du document XLSM d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir XLSM en AZW3 via la bibliothèque Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsm" outformat="azw3" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLSM en AZW3 via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XLSM en AZW3 par programmation ? Les développeurs peuvent facilement charger et convertir des fichiers XLSM en AZW3 en quelques lignes de code seulement.
...
1.  Convertissez XLSM en AZW3 en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de XLSM en AZW3.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Excel Python pour convertir XLSM en AZW3" %}}
