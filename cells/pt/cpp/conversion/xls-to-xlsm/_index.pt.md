...
description: Aspose Excel. Converta XLS em XLSM de forma rápida e fácil com Aspose.Cells. C++ XLS em XLSM. C++ Salve XLS em XLSM. Salve XLS como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Converta XLS em XLSM usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve XLS para XLSM em C++" %}}

O exemplo a seguir demonstra como converter XLS em XLSM em C++.
...
{{% cells-convert title="Exemplo de código para converter XLS em XLSM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xlsm" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS em XLSM por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS em XLSM programaticamente? Os desenvolvedores do C++ podem converter facilmente XLS em XLSM em apenas algumas linhas de código.
...
1.  Converta XLS em XLSM chamando o método Save().
