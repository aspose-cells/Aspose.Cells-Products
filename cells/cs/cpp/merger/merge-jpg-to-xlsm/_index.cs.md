---
title: Sloučit JPG s XLSM - Sloučit JPG s XLSM v C++
url: /cs/cpp/merger/merge-jpg-to-xlsm/ 
description: Aspose Excel. C++ Aspose.Cells. Sloučit JPG do formátu uložení XLSM. C++ Zkombinujte JPG do formátu XLSM. Sloučit JPG na XLSM v C++. Sloučit JPG.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPG na XLSM v C++" %}}

Následující příklad ukazuje, jak sloučit JPG s XLSM v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JPG do XLSM. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XLSM. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí JPG do XLSM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení JPG do XLSM v C++" InputFormat="jpg" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JPG na XLSM přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit JPG na XLSM programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení JPG do XLSM" %}}
