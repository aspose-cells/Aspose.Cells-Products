---
title: C# PNG a JPG - Convertidor PNG a JPG en línea
description: AsposeExcel. C# Aspose.Cells. C# Aspose Cells. Gratis en línea C# Convertir PNG a formato de guardado JPG. C# PNG en formato JPG. Guardar PNG a JPG C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PNG a JPG en C#" h2="Biblioteca C# de alta velocidad para convertir PNG a JPG. Esta es una solución de software profesional para importar y exportar PNG, JPG y muchos otros formatos en .NET Framework, .NET Core o Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/content h2="Guarde PNG en JPG en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo convertir PNG a JPG en C#.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir PNG a JPG a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos PNG a JPG mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente PNG a JPG con solo unas pocas líneas de código.
