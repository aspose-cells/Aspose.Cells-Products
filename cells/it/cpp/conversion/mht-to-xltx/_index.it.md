...
Hai bisogno di convertire i file MHT in XLTX tramite codice? Gli sviluppatori che usano C++ possono facilmente convertire MHT in XLTX in poche righe di codice.
...
1.  Convertire MHT in XLTX chiamando il metodo Save().
