---
title: Crea grafici a colonne 3D tramite Python
url: /it/python-java/create-column3d-chart/
description: Python Codice di esempio per la creazione di grafici a colonne 3D in Excel utilizzando Python Libreria. Utilizzare questo codice per creare un grafico Column3D in MS Excel all'interno di un'applicazione basata su Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}

{{< blocks/products/pf/i18n/upper-banner h1="Crea grafici a colonne 3D tramite Python" h2="Creazione di grafici MS Excel nativi e ad alte prestazioni in modo programmatico utilizzando le API di Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
La creazione dinamica di grafici Column3D all'interno dell'applicazione in esecuzione è facile. Per creare una varietà di grafici su fogli di calcolo da zero senza richiedere MS Office, utilizzeremo [Aspose.Cells per Python](https://pypi.org/project/aspose.cells)  API che offre diverse funzionalità per la creazione, la manipolazione e la conversione di fogli di lavoro sulla piattaforma Python. Aspose.Cells fornisce molti oggetti grafici flessibili.
{{% /blocks/products/pf/agp/content %}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Come creare grafici a colonne 3D tramite Python" %}}

{{% blocks/products/pf/agp/text %}}

È facile per gli sviluppatori creare un grafico Column3D all'interno dell'esecuzione di diverse applicazioni di reporting per l'elaborazione dei dati in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Importa asposecells nel tuo file di codice.1. Crea un'istanza della classe della cartella di lavoro.1. Aggiungi alcuni dati al foglio di lavoro.1. Aggiungi un grafico Column3D al foglio di lavoro1. Accedi al nuovo oggetto grafico dalla raccolta Charts passandone l'indice.1. Imposta l'origine dati del grafico con il metodo Chart.setChartDataRange.1. Salva come file Excel o ODS.
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="Il codice sorgente seguente mostra come creare un grafico Column3D in un file XLSX di MS Excel utilizzando Python." offSpacer="" %}}
