...
description: Aspose Excel. C++ Aspose.Cells. Merge SPREADSHEETML to MHT saveformat. C++ Combine SPREADSHEETML to MHT format. Merge SPREADSHEETML to MHT in C++. SPREADSHEETML Merge.
...
{{% blocks/products/pf/agp/content h2="Merge SPREADSHEETML to MHT in C++" %}}
...
{{% cells-merger title="Sample Code to Merge SPREADSHEETML to MHT in C++" InputFormat="xml" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
