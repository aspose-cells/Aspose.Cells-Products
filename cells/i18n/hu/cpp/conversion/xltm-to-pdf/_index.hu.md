---
title: Az XLTM konvertálása PDF-be a C++ alkalmazással 
url: /hu/cpp/conversion/xltm-to-pdf/ 
description: Minta C++ konverziós kód XLTM dokumentumhoz PDF formátumba. A programozók ezt a forráskódot használhatják az XLTM-ből PDF-be történő kötegelt konvertáláshoz bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLTM konvertálása PDF-be a következőn keresztül: C++" h2="Nagy teljesítményű XLTM konvertálás PDF-be a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="XLTM konvertálása PDF-be a következővel: C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLTM PDF-be konvertálásának lépései a következőn keresztül: C++" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztői könnyedén konvertálhatnak XLTM fájlt PDF-be, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLTM fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (PDF) fájlkiterjesztéssel.1. A PDF fájl a megadott elérési útra kerül mentésre.1. Nyissa meg a PDF fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="XLTM-ből PDF-be C++ konverziós forráskód" offSpacer="" %}}
