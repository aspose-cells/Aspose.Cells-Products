---
title:  إضافة أو إزالة XLSM حاشية via .NET
weight: 9890
description: كود المصدر C# لإضافة وحذف التعليقات التوضيحية بتنسيق XLSM على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
...
{{% blocks/products/pf/agp/feature-section-col title="إضافة أو حذف ملاحظة من XLSM عبر C#" %}}
