...
{{% blocks/products/pf/agp/content h2="Convert FODS to MHT in Python" %}}
...
The following example demonstrates how to convert FODS to MHT in Python via NET.
