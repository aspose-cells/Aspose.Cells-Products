---
title: "SPREADSHEETML egyesítése a következővel: NUMBERS – SPREADSHEETML egyesítése a NUMBERS fájllal a Python-ben"
url: /hu/python-net/merger/merge-spreadsheetml-to-numbers/ 
description: "Aspose Excel. Python Aspose.Cells. Ingyenes online egyesítése SPREADSHEETML NUMBERS mentési formátumba. Python A SPREADSHEETML egyesítése NUMBERS formátumba. SPREADSHEETML egyesítése a következővel: NUMBERS itt: Python. SPREADSHEETML Egyesítés."
...
következő példa bemutatja, hogyan egyesítheti a SPREADSHEETML-t a NUMBERS-szel a Aspose.Cells for Python via .NET számon.
...
{{% cells-merger title="Ingyenes online SPREADSHEETML egyesítése a NUMBERS számmal a Python számon" InputFormat="xml" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="A SPREADSHEETML egyesítése a NUMBERS fájllal a Python számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a SPREADSHEETML-t a NUMBERS fájllal? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
