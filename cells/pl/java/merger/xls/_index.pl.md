---
title:  Połącz pliki XLS via Java
weight: 5140
description: Java przykładowy kod do łączenia dokumentów XLS w środowisku wykonawczym Java dla aplikacji JSP/JSF i aplikacji komputerowych.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Scal formaty XLS w Java" h2="Natywne łączenie dokumentów XLS przy użyciu interfejsów API Java po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak połączyć pliki XLS przy użyciu Java" %}}

 Aby połączyć plik XLS, użyjemy[Aspose.Cells for Java](https://products.aspose.com/cells/java) API, która jest bogatą w funkcje, wydajną i łatwą w użyciu platformą fuzji API for Java. Możesz pobrać jego najnowszą wersję bezpośrednio ze strony[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) i zainstaluj go w projekcie opartym na Maven, dodając następujące konfiguracje do pliku pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki łączenia plików XLS w Java" %}}
...
+ Załaduj pierwszy plik XLS z instancją klasy Workbook.
+ Załaduj drugi dokument XLS z instancją klasy Workbook.
+ Scal pliki za pomocą metody Combine().
+ zapisz połączony plik XLS w określonej ścieżce
...
{{% blocks/products/pf/agp/code-block title="Scal pliki XLS - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Online XLS Pokazy fuzji na żywo" sectionDescription=" Połącz dokumenty XLS już teraz, odwiedzając naszą stronę[Witryna internetowa z prezentacjami na żywo](https://products.aspose.app/cells/merger). Demo na żywo ma następujące zalety" >}}
