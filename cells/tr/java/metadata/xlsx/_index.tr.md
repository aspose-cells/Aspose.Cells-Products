---
title:  XLSX Dosyalarının Meta Verilerini Düzenleyin veya Görüntüleyin via Java
weight: 1240
description: Java JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Çalışma Zamanı Ortamı'ndaki XLSX biçim meta verilerini düzenlemek veya görüntülemek için örnek kod.
...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak XLSX Meta Verisi Nasıl Çıkarılır" %}}

 XLSX dosya meta verisini almak için şunu kullanacağız:
...
{{% blocks/products/pf/agp/feature-section-col title="XLSX via Java Meta Verilerini Çıkarma Adımları" %}}
...
+ WorkbookMetadata'ya XLSX dosyasını yükleyin
...
{{% blocks/products/pf/agp/code-block title="XLSX - Java\'in Meta Verilerini Çıkarın" offSpacer="" %}}
