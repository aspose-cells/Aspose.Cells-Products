...
Hai bisogno di convertire i file MHT in MHT tramite codice? Gli sviluppatori di C++ possono facilmente convertire MHT in MHT in poche righe di codice.
...
1.  Convertire MHT in MHT chiamando il metodo Save().
