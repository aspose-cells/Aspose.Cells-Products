---
title:  XLS 문서 via Java 보호 및 잠금
weight: 5070
description: Java JSP/JSF 애플리케이션 및 데스크탑 애플리케이션용 Java 런타임 환경에서 비밀번호를 사용하여 XLS 파일을 잠그는 샘플 코드입니다.
...
{{% blocks/products/pf/agp/feature-section-col title="XLS 파일 via Java을 보호하는 단계" %}}
...
1.  Workbook 클래스를 인스턴스화하여 XLS 파일 로드
1.  ProtectionType 및 Password와 함께 protected(..) 메소드를 사용하십시오.
1.  save() 메소드를 사용하여 보호된 XLS 파일을 저장합니다.
