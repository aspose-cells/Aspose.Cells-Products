...
description: Aspose Excel. Μετατρέψτε το XLTM σε ET γρήγορα και εύκολα με το Aspose.Cells. Python XLTM σε ET. Python Αποθήκευση XLTM στο ET. Αποθηκεύστε το XLTM ως ET χρησιμοποιώντας το Python.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε XLTM στο ET στο Python" %}}
