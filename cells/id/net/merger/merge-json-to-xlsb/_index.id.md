---
title: Gabung JSON ke XLSB - Gabungkan JSON ke XLSB di C#
url: /id/net/merger/merge-json-to-xlsb/ 
description: Aspose Unggul. C# Aspose.Cells. Free Online Merge JSON to XLSB saveformat. C# Gabungkan format JSON menjadi XLSB. Gabung JSON ke XLSB di C#. JSON Gabung.
keywords: [Aspose Excel., C# Aspose.Cells., Merge JSON to XLSB in C#., Free Online C# Merge JSON to xlsb., C# Combine JSON to XLSB Online for Free., JSON Merge]
---
...
Contoh berikut menunjukkan cara menggabungkan JSON ke XLSB di Aspose.Cells for .NET.
...
{{% cells-merger title="Online Gratis untuk Menggabungkan JSON ke XLSB di C#" InputFormat="json" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan JSON ke XLSB via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan JSON menjadi XLSB secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
