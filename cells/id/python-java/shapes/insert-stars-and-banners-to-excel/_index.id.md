---
title: Masukkan Bintang/Banner ke Excel menggunakan Python via Java
weight: 381
description: Python via Java source code untuk memasukkan Bintang/Banner ke dalam Excel.
keywords: [Python Aspose.Cells., Python add Star/Banner., Python insert Star/Banner., Python create Star/Banner]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan Bintang/Banner ke Excel menggunakan Python via Java" h2="Masukkan Bintang/Banner menggunakan Aspose.Cells\' API tanpa software apa pun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Memasukkan Bintang/Banner ke File Excel Menggunakan Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah memasukkan Star/Banner ke file Excel menggunakan Python via Java" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan[tambahkan metode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) untuk menyisipkan Bintang/Banner di lembar kerja yang dipilih
...
Contoh kode di bawah ini menunjukkan cara menyisipkan "matematika plus". Untuk jenis lainnya, silakan lihat "Ikhtisar Jenis Bintang dan Spanduk" di bawah.

{{% blocks/products/pf/agp/code-block title="Sisipkan Bintang/Spanduk - Python via Java" offSpacer="" %}}
...
<div class="container-fluid features-section bg-gray">
 ...
 Tipe BentukOtomatis.GELOMBANG
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 Tipe BentukOtomatis.DOUBLE_WAVE
    </p>
   </div>
  </div>
 </div>
