---
title: Pesquise e substitua texto no documento ODS por meio de .NET 
weight: 6100
url: /pt/net/redaction/ods/ 
description: C# código-fonte para redigir informações confidenciais no arquivo ODS nas plataformas .NET Framework, .NET Core, Mono ou Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Redigir Formatos ODS em C#" h2="ODS nativo e de alto desempenho documentam informações de redação confidenciais usando APIs Aspose.Cells for .NET do lado do servidor, sem o uso de qualquer software como Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/code-block title="Redigir arquivos ODS - C#" offSpacer="" %}}
