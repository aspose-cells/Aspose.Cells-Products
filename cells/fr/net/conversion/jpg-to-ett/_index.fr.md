---
title: Convertir JPG en ETT C#
description: Convertissez JPG en ETT en ligne gratuitement. Convertisseur JPG en ETT en ligne gratuit. C# JPG à ETT. JPG à ETT via C#.
keywords: Convert JPG, JPG Converter, JPG to PDF, JPG to Word, JPG to PPT, JPG to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir JPG en ETT via C#" h2="Bibliothèque C# haute vitesse pour convertir JPG en ETT. Exportez des feuilles de calcul Excel au format ETT sur .NET Framework, .NET Core ou Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ETT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JPG" >}}
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir JPG en ETT en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="ett" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir JPG en ETT via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir JPG en ETT en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier JPG avec une instance de Workbook
1.  Convertir JPG en ETT en appelant la méthode Workbook.Save
