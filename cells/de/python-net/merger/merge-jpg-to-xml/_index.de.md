...
Das folgende Beispiel zeigt, wie JPG in Aspose.Cells for Python via .NET mit XML zusammengeführt wird.
...
Müssen Sie JPG programmgesteuert in XML umwandeln? Ein einfaches Dokument, das zusammengeführt und verknüpft wird mit[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) APIs können mit nur wenigen Codezeilen erstellt werden.
