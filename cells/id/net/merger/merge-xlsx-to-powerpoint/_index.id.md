---
title: Gabungkan XLSX ke POWERPOINT - Gabungkan XLSX ke POWERPOINT di C#
url: /id/net/merger/merge-xlsx-to-powerpoint/ 
description: Aspose Unggul. C# Aspose.Cells. Gabungkan XLSX ke format penyimpanan POWERPOINT. C# Gabungkan XLSX ke format POWERPOINT. Gabungkan XLSX menjadi POWERPOINT di C#. XLSX Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan XLSX ke POWERPOINT di C#" %}}

Contoh berikut menunjukkan cara menggabungkan XLSX ke POWERPOINT di Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan XLSX ke POWERPOINT. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file POWERPOINT. Jika Anda mengembangkan kode di C#, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C# yang menggabungkan XLSX menjadi POWERPOINT.
...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan XLSX ke POWERPOINT melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan XLSX ke POWERPOINT secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan .NET untuk digabungkan XLSX ke POWERPOINT" %}}
