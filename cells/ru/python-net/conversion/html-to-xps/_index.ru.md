...
description: Aspose Эксель. Преобразуйте HTML в XPS быстро и легко с помощью Aspose.Cells. Python HTML в XPS. Python Сохранить HTML в XPS. Сохранить HTML как 07611134 81, используя Python.
...
{{% blocks/products/pf/agp/content h2="Преобразовать HTML в XPS в Python" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните с HTML по XPS в Python." %}}
...
{{% cells-convert title="Пример кода для преобразования HTML в XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xps" IsLandingPage="true" language="pythonnet" %}}
