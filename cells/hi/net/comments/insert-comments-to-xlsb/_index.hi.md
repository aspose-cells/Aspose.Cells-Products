---
title: XLSB फ़ाइल via .NET पर टिप्पणियां डालें
url: /hi/net/comments/insert-comments-to-xlsb/ 
description: C# का उपयोग करके XLSB पर टिप्पणियां डालें। .NET एप्लिकेशन के भीतर टिप्पणियां डालने के लिए API उदाहरण कोड का उपयोग करें।
---
...
{{% blocks/products/pf/agp/content h2="XLSB फ़ाइल में C# के माध्यम से टिप्पणियां कैसे डालें" %}}
...
Office 365 में, टिप्पणियाँ बातचीत के लिए हैं, आप XLSB फ़ाइल में टिप्पणियाँ सम्मिलित करने और निकालने के लिए निम्न C# कोड का उपयोग कर सकते हैं।

{{% blocks/products/pf/agp/code-block title="XLSB फ़ाइल में टिप्पणियां डालने और निकालने के लिए C# नमूना कोड" offSpacer="" %}}
...
{{% cells-annotation title="XLSB फ़ाइल से एनोटेशन हटाने के लिए फ्री ऐप" InputFormat="xlsb" IsLandingPage="true" language="net" %}}
