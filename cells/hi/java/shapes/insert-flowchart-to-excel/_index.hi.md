---
title: Excel via Java में फ़्लोचार्ट डालें
weight: 360
...
{{< blocks/products/pf/i18n/upper-banner h1="Excel via Java में फ़्लोचार्ट डालें" h2="बिना किसी सॉफ़्टवेयर जैसे Microsoft या Open Office, Adobe PDF, आदि के बिना सर्वर-साइड API का उपयोग करके ऑब्जेक्ट डालें।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके एक्सेल फाइल में फ़्लोचार्ट कैसे डालें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="एक्सेल फ़ाइल via Java में फ़्लोचार्ट सम्मिलित करने के चरण" %}}
...
+ इसके सूचकांक के माध्यम से कार्यपत्रक का चयन करें।
 + का प्रयोग करें[विधि जोड़ें](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) चयनित वर्कशीट में फ़्लोचार्ट डालने के लिए
...
नीचे दिया गया नमूना कोड दर्शाता है कि "बहु-दस्तावेज़" कैसे सम्मिलित करें। अधिक प्रकारों के लिए, कृपया नीचे "ब्लॉक एरो शेप टाइप्स ओवरव्यू" देखें।

{{% blocks/products/pf/agp/code-block title="फ़्लोचार्ट डालें - Java" offSpacer="" %}}
