...
Hai bisogno di convertire i file MHT in XML tramite codice? Gli sviluppatori di C++ possono convertire facilmente i file MHT in XML in poche righe di codice.
...
1.  Convertire MHT in XML chiamando il metodo Save().
