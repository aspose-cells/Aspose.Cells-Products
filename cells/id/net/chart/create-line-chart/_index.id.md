...
description: C# Contoh kode membuat diagram garis ke Excel menggunakan Library .NET. Gunakan kode ini untuk membuat diagram garis ke MS Excel dalam VB.NET, Asp.NET atau aplikasi berbasis .NET.
...
{{% blocks/products/pf/agp/feature-section-col title="Cara Membuat Line Chart melalui C#" %}}
...
1.  Tambah sebuah[**Garis**](https://reference.aspose.com/cells/net/aspose.cells.charts/charttype) Bagan ke lembar kerja.
1.  Akses yang baru[**Bagan**](https://reference.aspose.com/cells/net/aspose.cells.charts/chart)obyek.
1.  Tentukan sumber data diagram dengan[**Bagan.SetChartDataRange**](https://https://reference.aspose.com/cells/net/aspose.cells.charts/chart/methods/setchartdatarange) metode.
