---
title:  Wstaw Oval do Excela przez C++
weight: 40
description: C++ przykładowy kod do wstawienia Oval w pliku Excel w C++ Runtime Environment dla Windows 32-bitowy, Windows 64-bitowy i Linux 64-bitowy.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw Oval do Excela przez C++" h2="Wstawiaj obiekty przy użyciu natywnej i wysokiej wydajności serwera Aspose.Cells for C++ API bez użycia oprogramowania, takiego jak Microsoft lub Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wstawić owal do pliku Excel za pomocą C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić plik owalny do programu Excel za pośrednictwem C++" %}}
...
+ Wybierz arkusz roboczy za pomocą jego indeksu.
 + Użyj[dodaj metodę](https://reference.aspose.com/cells/cpp/class/aspose.cells.drawing.i_shape_collection#a90bc960de1b4a6d6beaf6c7cc4651bc2) , aby wstawić kształty równań w wybranym arkuszu
...
{{% blocks/products/pf/agp/code-block title="Wstaw Owal - C++" offSpacer="" %}}
