---
title: Convierta XLSB a MHTML a través de la aplicación C++ 
weight: 1250
url: /es/cpp/conversion/xlsb-to-mhtml/ 
description: Ejemplo de código de conversión C++ para documento XLSB a formato MHTML. Los programadores pueden usar este código fuente para la conversión por lotes de XLSB a MHTML dentro de cualquier aplicación C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de C++ pueden convertir fácilmente un archivo XLSB a MHTML con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLSB usando Factory::CreateIWorkbook.1. Llame al método Guardar().1. Pase la ruta del archivo de salida con la extensión de archivo (MHTML).1. El archivo MHTML se guardará en la ruta especificada.1. Abra el archivo MHTML en un programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de XLSB a MHTML C++" offSpacer="" %}}
