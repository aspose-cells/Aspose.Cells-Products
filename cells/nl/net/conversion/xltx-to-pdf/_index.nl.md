---
title: C# XLTX tot PDF - XLTX tot PDF Converter
description: Aspose Excel. Deze uitgebreide oplossing biedt ontwikkelaars een volledig geïntegreerde aanpak voor het converteren van gegevens van het formaat XLTX naar PDF, waardoor naadloos opslaan van gegevens in het formaat XLTX mogelijk is met behulp van de bibliotheek Aspose.Cells, allemaal via efficiënte en aanpasbare code C#.
...
{{% blocks/products/pf/agp/content h2="Sla XLTX op in PDF in C#" %}}

Het volgende voorbeeld laat zien hoe je XLTX omzet naar PDF in C#.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLTX naar PDF te converteren. Upload uw XLTX-bestand en sla het vervolgens eenvoudig op als PDF-bestand. Voor zowel XLTX lezen als PDF schrijven kunt u volledig gekwalificeerde bestandsnamen gebruiken. De inhoud en opmaak van de uitvoer PDF zullen identiek zijn aan het originele document XLTX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Voorbeeldcode om XLTX naar PDF te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xltx" outformat="pdf" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLTX naar PDF kunt converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u XLTX-bestanden programmatisch naar PDF converteren? .NET-ontwikkelaars kunnen XLTX eenvoudig in slechts een paar regels code laden en converteren naar PDF.
...
1.  Converteer XLTX naar PDF door de Workbook.Save-methode aan te roepen.
