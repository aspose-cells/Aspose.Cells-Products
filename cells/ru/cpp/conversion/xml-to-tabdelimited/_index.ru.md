...
Нужно программно преобразовать XML-файлы в TABDELIMITED? C++ разработчики могут легко преобразовать XML в TABDELIMITED, написав всего несколько строк кода.
