...
url: /tr/net/merger/merge-mht-to-excel/ 
...
Aşağıdaki örnek, Aspose.Cells for .NET'de MHT'nin EXCEL ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 MHT'yi programlı olarak EXCEL ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="MHT\'yi EXCEL ile birleştirmek için .NET kitaplığı" %}}
