...
description: Aspose Excel. Gere e manipule arquivos TIFF sem esforço com a biblioteca Aspose.Cells for Python via .NET. Esta poderosa biblioteca API oferece uma solução simplificada e eficiente para criar, editar e gerenciar arquivos TIFF diretamente em seus aplicativos Python, atendendo às necessidades específicas dos desenvolvedores com alta precisão.
...
1.  Use o método Salvar para salvar a pasta de trabalho como arquivo TIFF.

{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar o arquivo TIFF na biblioteca Excel Python." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python Biblioteca Excel para criar arquivo TIFF" %}}
