...
{{% blocks/products/pf/agp/content h2="Převeďte XML na JPEG pomocí Python" %}}
...
Následující příklad ukazuje, jak převést XML na JPEG v Python.
