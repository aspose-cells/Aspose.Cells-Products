---
title: Python OTS から PRN - OTS から PRN コンバータ
description: Aspose エクセル。 Aspose.Cells を使用して、OTS を PRN にすばやく簡単に変換します。 Python OTS から PRN。 Python OTS を PRN に保存します。 Python を使用して OTS を PRN として保存します。
...
{{% blocks/products/pf/agp/content h2="Pythonを使用してOTSをPRNに変換します" %}}

OTS を PRN に変換するにはどうすればよいですか? Aspose.Cells for Python ライブラリを使用すると、数行のコードでプログラム的に OTS を PRN に簡単に変換できます。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)すべての Excel ファイルを生成、変更、変換、レンダリング、印刷できるクロスプラットフォーム アプリケーションを構築できます。 Python Excel API は、スプレッドシート形式間で変換するだけでなく、Excel ファイルを画像 PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT などとしてレンダリングすることもできるため、業界標準形式でドキュメントを交換するのに最適です。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="OTS を Python の PRN に保存" %}}

次の例は、Python で OTS を PRN に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

簡単な手順に従って、OTS を PRN に変換します。 OTS ファイルをアップロードし、PRN ファイルとして保存します。 OTS 読み取りと PRN 書き込みの両方で、完全修飾ファイル名を使用できます。出力 PRN コンテンツと形式は、元の OTS ドキュメントと同じになります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="OTS を PRN に変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="prn" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python経由でOTSをPRNに変換する方法" %}}
...
1.  OTSからPRNへの変換結果を取得します。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python OTS を PRN に変換するライブラリ" %}}
