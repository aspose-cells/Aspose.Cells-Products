---
title:  Chèn CheckBox (Điều khiển biểu mẫu) vào Excel qua Python
weight: 30
description: Python mã nguồn để chèn CheckBox(Điều khiển biểu mẫu) vào Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn CheckBox (Điều khiển biểu mẫu) vào Excel qua Python" h2="Chèn các đối tượng bằng API phía máy chủ mà không cần bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF, v.v." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chèn CheckBox(Form control) vào File Excel Sử Dụng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn CheckBox(Form control) vào file Excel qua Python" %}}
...
+ Sử dụng phương thức add của shapecollection để chèn CheckBox(Form control) vào bảng tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Insert CheckBox(Form điều khiển) - Python" offSpacer="" %}}
