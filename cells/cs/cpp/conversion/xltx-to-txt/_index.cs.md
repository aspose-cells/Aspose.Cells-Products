---
title: Převeďte XLTX na TXT pomocí aplikace C++ 
url: /cs/cpp/conversion/xltx-to-txt/ 
description: Ukázka převodního kódu C++ pro dokument XLTX na formát TXT. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi XLTX na TXT v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést XLTX na TXT pomocí C++" %}}

 K převodu XLTX na TXT použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod XLTX na TXT přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor XLTX na TXT pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLTX pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou (TXT).1. Soubor TXT bude uložen do zadané cesty.1. Otevřete soubor TXT v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu XLTX na TXT C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze XLTX na TXT" sectionDescription="[Převést XLTX na TXT](https://products.aspose.app/cells/conversion/xltx-to-txt) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor XLTX, bude okamžitě převeden na TXT." >}}
