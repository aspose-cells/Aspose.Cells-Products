...
{{% blocks/products/pf/agp/content h2="Enregistrer EXCEL sous DOCX dans C#" %}}
...
Besoin de convertir des fichiers EXCEL en DOCX par programme ? Les développeurs .NET peuvent facilement charger et convertir EXCEL en DOCX en quelques lignes de code seulement.
...
1.  Convertissez le fichier EXCEL au format DOCX en appelant la méthode Workbook.Save.
