...
{{% blocks/products/pf/agp/content h2="MD maken in C++" %}}

{{% blocks/products/pf/agp/text %}}

 Het is gemakkelijk voor de ontwikkelaars om MD-bestanden te maken, laden, wijzigen en converteren binnen lopende rapportagetoepassingen voor gegevensverwerking in slechts enkele regels code.
...
1.  Sla de werkmap op als .md-bestand met de methode Save().
...
{{% blocks/products/pf/agp/content h2="C++ bibliotheek om een MD-bestand te maken" %}}
