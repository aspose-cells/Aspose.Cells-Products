...
url: /cs/python-net/merger/merge-mht-to-mhtml/ 
...
Následující příklad ukazuje, jak sloučit MHT s MHTML v Aspose.Cells for Python via .NET.
...
Potřebujete sloučit MHT na MHTML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
