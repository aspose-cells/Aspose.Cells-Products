---
title: A ODS-XLTX-es számok egyesítése – a ODS-es és a XLTX-es számok egyesítése a C++-ben
url: /hu/cpp/merger/merge-ods-to-xltx/ 
description: Aspose Excel. C++ Aspose.Cells. Ingyenes online egyesítés ODS XLTX mentési formátumba. C++ A ODS és a XLTX formátum kombinálása. Egyesítse a ODS-XLTX-et a C++-ben. ODS Egyesítse.
...
{{< blocks/products/pf/i18n/upper-banner h1="A ODS-es szám egyesítése a XLTX-es számmal a C++-es számon keresztül" h2="Nagysebességű C++ könyvtár a ODS és XLTX egyesítéséhez. Használja a API-es excel konverziónkat magas szintű, platformfüggetlen szoftver fejlesztésére a C++-ben. Ez egy professzionális szoftvermegoldás Excel, CSV, OpenOffice, PDF, HTML, image és sok más excel formátum importálásához és exportálásához." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="ODS" additionalConversionTag="XLTX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a ODS-es számokat a XLTX-es számokhoz a C++-ben online ingyen" %}}

A következő példa bemutatja a ODS és a XLTX egyesítését a Aspose.Cells for C++ számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a ODS-es és a XLTX-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a XLTX fájlba. Ha kódot fejleszt a C++-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C++-es példát, amely egyesíti a ODS és XLTX számokat.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a ODS-XLTX-es számok egyesítéséhez a C++-ben" InputFormat="ods" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="A ODS és a XLTX egyesítése a C++ számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a ODS-et a XLTX-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a ODS és XLTX egyesítéséhez" %}}
