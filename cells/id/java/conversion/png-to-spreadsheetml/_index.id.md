---
title: Java PNG ke SPREADSHEETML - PNG ke SPREADSHEETML Konverter
description: Aspose Unggul. Java Aspose.Cells. PNG menjadi SPREADSHEETML di Java. Java Ubah PNG menjadi format simpan SPREADSHEETML. Java PNG ke format SPREADSHEETML. Simpan PNG ke SPREADSHEETML Java.
...
{{% blocks/products/pf/agp/content h2="Simpan PNG ke SPREADSHEETML di Java" %}}

Contoh berikut menunjukkan cara mengonversi PNG menjadi SPREADSHEETML di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengkonversi PNG ke SPREADSHEETML. Unggah file PNG Anda, lalu simpan sebagai file SPREADSHEETML. Untuk pembacaan PNG dan penulisan SPREADSHEETML Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format SPREADSHEETML keluaran akan sama dengan dokumen PNG asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi PNG menjadi SPREADSHEETML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="xml" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi PNG ke SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file PNG ke SPREADSHEETML secara terprogram? Pengembang Java dapat dengan mudah mengonversi PNG menjadi SPREADSHEETML hanya dalam beberapa baris kode.
...
1.  Ubah PNG menjadi SPREADSHEETML dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi PNG ke SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Pustaka Java untuk mengonversi PNG ke SPREADSHEETML" %}}
{{% blocks/products/pf/agp/text %}}
