---
title: 通過 C++ 應用程序將 MHTML 轉換為 XLSB 
weight: 7450
url: /zh-hant/cpp/conversion/mhtml-to-xlsb/ 
description: MHTML 文檔到 XLSB 格式的示例 C++ 轉換代碼。程序員可以使用此源代碼在任何 C++ 應用程序中將 MHTML 批量轉換為 XLSB。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C++ 將 MHTML 轉換為 XLSB" h2="使用 C++ 庫的高性能 MHTML 到 XLSB 轉換，無需安裝 Microsoft Excel、OpenOffice 或 Adobe Acrobat。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 將 MHTML 轉換為 XLSB" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通過 C++ 將 MHTML 轉換為 XLSB 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 C++ 開發人員只需幾行代碼即可輕鬆地將 MHTML 文件轉換為 XLSB。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加載 MHTML 文件。1. 調用 Save() 方法。1. 使用 (XLSB) 文件擴展名傳遞輸出文件路徑。1. XLSB 文件將保存在指定路徑。1. 在兼容程序中打開 XLSB 文件。
...
{{% blocks/products/pf/agp/code-block title="MHTML 到 XLSB C++ 轉換源代碼" offSpacer="" %}}
