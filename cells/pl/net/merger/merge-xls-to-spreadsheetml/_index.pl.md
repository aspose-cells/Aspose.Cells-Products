---
title: Scal XLS do SPREADSHEETML - Połącz XLS do SPREADSHEETML w C#
url: /pl/net/merger/merge-xls-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie online numeru XLS do formatu zapisu SPREADSHEETML. C# Połącz XLS do formatu SPREADSHEETML. Scal XLS do SPREADSHEETML w C#. XLS Scal.
...
{{% blocks/products/pf/agp/content h2="Scal XLS w SPREADSHEETML w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLS z SPREADSHEETML w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLS z SPREADSHEETML. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do scalania plików, a następnie zapisz ją w pliku SPREADSHEETML. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy XLS z SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLS z SPREADSHEETML w C#" InputFormat="xls" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLS z SPREADSHEETML przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić numer XLS ze SPREADSHEETML? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do połączenia XLS z SPREADSHEETML" %}}
