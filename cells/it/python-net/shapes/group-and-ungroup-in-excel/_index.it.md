...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per raggruppare e separare le forme nel file Excel utilizzando Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="Raggruppa e separa le forme - Python via .Net via .NET" offSpacer="" %}}
