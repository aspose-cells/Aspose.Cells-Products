---
title: Преобразователь C# XLTM в SVG - XLTM в SVG
...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в SVG в C#" %}}
...
Нужно программно преобразовать файлы XLTM в SVG? Разработчики .NET могут легко загрузить и преобразовать XLTM в SVG всего за несколько строк кода.
...
1.  Преобразуйте значение XLTM в SVG, вызвав метод Workbook.Save.
1.  Получите результат преобразования XLTM в SVG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования XLTM в SVG" %}}
