...
description: Sample Java conversion code for XLS format to SPREADSHEETML file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to SPREADSHEETML within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/code-block title="XLS to SPREADSHEETML Java Conversion Source Code" offSpacer="" %}}
