...
{{% cells-convert title="Przykładowy kod do konwersji XLS na PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować numer XLS na PRN poprzez numer C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLS na PRN? Programiści .NET mogą łatwo załadować i przekonwertować XLS na PRN w zaledwie kilku linijkach kodu.
...
1.  Konwertuj numer XLS na PRN, wywołując metodę Workbook.Save.
