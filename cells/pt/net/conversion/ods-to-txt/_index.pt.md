---
title: C# ODS a TXT - ODS a TXT Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter ODS para o formato TXT, permitindo o salvamento perfeito de dados ODS no formato TXT usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve ODS a TXT em C#" %}}

exemplo a seguir demonstra como converter ODS em TXT em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter ODS em TXT. Carregue seu arquivo ODS e simplesmente salve-o como arquivo TXT. Para leitura de ODS e gravação de TXT, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação da saída TXT serão idênticos ao documento ODS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de exemplo para converter ODS em TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ods" outformat="txt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter ODS em TXT por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS em TXT programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em TXT em apenas algumas linhas de código.
...
1.  Converta ODS para TXT chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter ODS em TXT" %}}
