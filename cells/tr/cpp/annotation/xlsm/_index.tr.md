---
title:  XLSM Ek Açıklamasını C++ aracılığıyla Ekle veya Kaldır
weight: 2860
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Çalışma Zamanı Ortamı'ndaki XLSM biçim açıklamalarını silmek için örnek kod.
...
{{% blocks/products/pf/agp/content h2="C++ Kullanılarak XLSM Dosyasına Açıklama Nasıl Eklenir?" %}}

XLSM dosyasına açıklama eklemek için şunu kullanacağız:
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM\'e C++ aracılığıyla Yorum Ekleme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1.  IWorkbook sınıfı nesnesini kullanarak XLSM Excel dosyasını yükleyin.
...
{{% blocks/products/pf/agp/code-block title="XLSM - C++\'e Yorum Ekle" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API, Microsoft Excel formatlarını oluşturmak, düzenlemek, dönüştürmek ve farklı formatlara dönüştürmek için kullanılabilir. Ayrıca yazılım uygulamalarında kapsamlı grafik oluşturma, ölçeklenebilir raporlama ve güvenilir hesaplamalar için de kullanılabilir. Aspose.Cells bağımsız bir API'dir ve Microsoft veya OpenOffice gibi herhangi bir yazılım gerektirmez.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi Uygulama aracılığıyla XLSM\'e Açıklama Ekleme/Kaldırma" sectionDescription=" XLSM belge ek açıklamasını hemen şimdi ziyaret ederek silin.[Canlı Demolar web sitesi](https://products.aspose.app/cells/annotation). Canlı demo aşağıdaki avantajlara sahiptir" >}}
