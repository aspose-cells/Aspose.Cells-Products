...
{{% blocks/products/pf/agp/content h2="How to Insert a Line into Excel File Using C#" %}}

 In order to insert a Line into excel file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert a Line to Excel file via C#" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addline) to insert a Line in the selected worksheet
...
{{% blocks/products/pf/agp/code-block title="Insert a Line - C#" offSpacer="" %}}
