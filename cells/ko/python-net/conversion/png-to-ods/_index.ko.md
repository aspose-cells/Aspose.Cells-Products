---
title: PNG을 ODS로 변환 Python via Python
description: PNG을 ODS로 온라인에서 무료로 변환하십시오. 무료 온라인 PNG to ODS 변환기. Python PNG에서 ODS로. PNG에서 ODS로 Python을 통해.
...
{{% cells-convert title="온라인에서 PNG을 ODS로 변환하는 무료 앱 및 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="ods" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="PNG을 ODS로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

 Python 개발자는 단 몇 줄의 코드로 PNG을 ODS로 쉽게 로드하고 변환할 수 있습니다.
...
1.  Workbook.save 메서드를 호출하여 PNG을 ODS로 변환
