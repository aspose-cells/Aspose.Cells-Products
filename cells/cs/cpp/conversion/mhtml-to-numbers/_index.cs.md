---
title: C++ MHTML na ČÍSLA - MHTML na ČÍSLA Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C++ plně integrovaný přístup k převodu MHTML do formátu NUMBERS, což umožňuje bezproblémové ukládání dat MHTML do formátu NUMBERS pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte MHTML na ČÍSLA v C++" h2="Vysoce výkonný převod MHTML na ČÍSLA s využitím knihovny C++ bez nutnosti instalace Excelu, OpenOffice nebo Adobe Acrobatu Microsoft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte si MHTML na ČÍSLA v čísle C++" %}}

Následující příklad ukazuje, jak převést číslo MHTML na ČÍSLA v souřadnici C++.
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na ČÍSLA pomocí C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory MHTML na ČÍSLA? Vývojáři C++ mohou snadno převést MHTML na ČÍSLA pomocí několika řádků kódu.
...
1.  Převeďte číslo MHTML na ČÍSLA voláním metody Save().
1.  Získejte výsledek převodu MHTML na ČÍSLA.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C++ pro převod MHTML na ČÍSLA" %}}
