...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása FODS-re a következővel: Java" %}}

 Ahhoz, hogy az SXC-t FODS-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az SXC konvertálásához FODS-vé a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják az SXC fájlt FODS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az SXC-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat FODS kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott FODS-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="SXC – FODS Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az SXC fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.sxc");
// mentse az SXC-t FODS-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="SXC-ről FODS-re konvertáló élő bemutatók" sectionDescription="[Az SXC konvertálása FODS-re](https://products.aspose.app/cells/conversion/sxc-to-fods) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel az SXC fájlt, és azonnal FODS formátumba konvertálódik." >}}
