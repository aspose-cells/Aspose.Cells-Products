---
title: SPREADSHEETML mit XLSM zusammenführen – SPREADSHEETML mit XLSM in C# kombinieren
url: /de/net/merger/merge-spreadsheetml-to-xlsm/ 
description: Aspose Excel. C# Aspose.Cells. Kostenlose Online-Zusammenführung von SPREADSHEETML in das XLSM-Speicherformat. C# Kombinieren Sie SPREADSHEETML mit dem Format XLSM. Führen Sie SPREADSHEETML zu XLSM in C# zusammen. SPREADSHEETML Zusammenführen.
...
Das folgende Beispiel zeigt, wie SPREADSHEETML mit XLSM in Aspose.Cells for .NET zusammengeführt wird.
...
{{% cells-merger title="Kostenlos online zum Zusammenführen von SPREADSHEETML mit XLSM in C#" InputFormat="xml" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie SPREADSHEETML über C# mit XLSM zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie SPREADSHEETML programmgesteuert mit XLSM zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
