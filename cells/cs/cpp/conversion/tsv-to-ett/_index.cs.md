...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte TSV na ETT v C++" h2="Vysoce výkonná konverze TSV na ETT s využitím knihovny C++ bez nutnosti instalace Microsoft Excelu, OpenOffice nebo Adobe Acrobatu." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ETT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Potřebujete programově převést soubory TSV na ETT? Vývojáři C++ mohou snadno převést soubory TSV na ETT pomocí několika řádků kódu.
...
1.  Převeďte číslo TSV na ETT voláním metody Save().
