---
title:  Combinar XLS a TSV via Java
...
El siguiente ejemplo muestra cómo combinar XLS con TSV en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar XLS a TSV en línea" InputFormat="xls" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
