---
title:  أدخل RadioButton (التحكم في النموذج) في Excel باستخدام Python via java
weight: 60
description: Python via كود مصدر جافا لإدراج RadioButton (التحكم في النموذج) في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج زر الراديو (التحكم في النموذج) في ملف Excel باستخدام Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج RadioButton (التحكم في النموذج) في ملف Excel باستخدام Python via java" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم مجموعة الأشكال[إضافة طريقة](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addRadioButton(int,%20int,%20int,%20int,%20int,%20int)) لإدراج زر راديو (عنصر تحكم النموذج) في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="أدخل زر راديو (التحكم في النموذج) - Python via java" offSpacer="" %}}
