...
{{% blocks/products/pf/agp/content h2="Převést MHTML na XPS pomocí knihovny Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit MHTML až XPS v knihovně Excel Python" %}}

Následující příklad ukazuje, jak převést MHTML na XPS v knihovně Excel Python.
...
{{% blocks/products/pf/agp/content h2="Python Knihovna Excel pro převod MHTML na XPS" %}}
