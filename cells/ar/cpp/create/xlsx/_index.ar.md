...
description: XLSX مبتكر. إنشاء XLSX ملفات في C++ كود. قم بإنشاء ملفات MS Excel XLSX باستخدام تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="إنشاء XLSX ملف عن طريق C++" h2="إنشاء جداول بيانات MS Excel XLSX أصلي وعالي الأداء برمجيًا بدون برنامج Micorsoft Office باستخدام مكتبة C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 من السهل على المطورين إنشاء ملفات XLSX وتحميلها وتعديلها وتحويلها ضمن تطبيقات التقارير قيد التشغيل لمعالجة البيانات في سطور قليلة من التعليمات البرمجية.
...
1.  احفظ المصنف كملف .xlsx باستخدام طريقة Save ().
