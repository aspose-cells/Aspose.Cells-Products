---
title:  Como faço para desenhar ou inserir seta dupla reta no Excel usando Python via java
weight: 10
...
{{< blocks/products/pf/i18n/upper-banner h1="Insira seta dupla reta no Excel usando Python via java" h2="Insira seta reta dupla usando Aspose.Cells\' API sem nenhum software como Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como inserir seta dupla reta em arquivo Excel usando Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir seta dupla reta em arquivo Excel usando Python via java" %}}
...
+ Selecione Planilha por meio de seu índice.
 + Use o shapecollection[adicionar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) para inserir uma seta reta dupla na planilha selecionada.
...
{{% blocks/products/pf/agp/code-block title="Insira seta reta dupla - Python via java" offSpacer="" %}}
