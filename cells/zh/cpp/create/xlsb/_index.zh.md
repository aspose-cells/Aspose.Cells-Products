...
url: /zh/cpp/create-xlsb/ 
description: C++ 用于生成 MS Excel XLSB 文件的示例代码。使用此代码在基于 C++ 的应用程序中创建 MS Excel XLSB 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 创建 XLSB 文件" h2="本机和高性能 MS Excel XLSB 电子表格以编程方式创建，无需 Micorsoft Office 使用 C++ 库。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 开发人员只需几行代码即可在运行的报告应用程序中轻松创建、加载、修改和转换 XLSB 文件以进行数据处理。

{{% /blocks/products/pf/agp/text %}}

1. 创建 IWorkbook 类的对象。1. 将第一张工作表放入 IWorksheet 对象。1. 使用 IWorksheet->GetICells() 方法将工作表的单元格放入 ICells 对象中。1. 使用 ICells->GetObjectByIndex() 方法将工作表的所需单元格访问到 ICell 对象中。1. 使用 ICell->PutValue() 方法将值输入到单元格中。1. 使用 Save() 方法将工作簿保存为 .xlsb 文件。
...
一个 Excel 电子表格编程库，能够构建跨平台应用程序，能够生成、修改、转换、呈现和打印 MS Excel XLSB 文件。 C++ Excel API 不仅可以在电子表格格式之间进行转换，它还可以将 Excel 文件呈现为图像、PDF、HTML、ODS 等，从而使其成为以行业标准格式交换文档的完美选择。
