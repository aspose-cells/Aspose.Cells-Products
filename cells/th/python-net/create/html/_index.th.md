...
{{% blocks/products/pf/agp/content h2="วิธีสร้าง HTML ผ่าน Python" %}}
...
{{% blocks/products/pf/agp/code-block title="ซอร์สโค้ดต่อไปนี้แสดงวิธีสร้างไฟล์ HTML โดยใช้ Python" offSpacer="" %}}
