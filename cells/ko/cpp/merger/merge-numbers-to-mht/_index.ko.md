...
다음 예는 C++에서 NUMBERS를 MHT에 병합하는 방법을 보여줍니다.
...
{{% cells-merger title="온라인에서 NUMBERS를 MHT에 병합하는 무료 앱" InputFormat="numbers" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
