...
description: Aspose اكسل. قم بتحويل IMAGE إلى PDF بسرعة وسهولة باستخدام Aspose.Cells. C++ IMAGE إلى PDF. C++ احفظ IMAGE إلى PDF. احفظ IMAGE كـ PDF باستخدام C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الصورة إلى PDF في C++" h2="تحويل IMAGE عالي الأداء إلى PDF باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل الصورة إلى PDF باستخدام C++" %}}
...
هل تحتاج إلى تحويل ملفات IMAGE إلى PDF برمجياً؟ يمكن لمطوري C++ تحويل IMAGE إلى PDF بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى PDF عن طريق استدعاء طريقة Save().
