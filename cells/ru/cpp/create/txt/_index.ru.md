...
description: Aspose Эксель. C++ Создайте файл TXT быстро и легко с помощью Aspose.Cells. Создайте файл TXT с помощью C++. Создайте TXT в C++. C++ TXT Creater.
...
1.  Сохраните книгу как файл .txt, используя метод Save().
