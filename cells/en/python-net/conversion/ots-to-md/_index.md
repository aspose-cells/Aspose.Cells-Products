...
{{% blocks/products/pf/agp/content h2="Convert OTS to MD in Python" %}}
...
The following example demonstrates how to convert OTS to MD in Python via NET.
