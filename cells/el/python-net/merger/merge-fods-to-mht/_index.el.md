---
title:  Συγχώνευση FODS στο MHT μέσω Python
url: /el/python-net/merger/merge-fods-to-mht/ 
description: Συγχώνευση FODS στο MHT Online δωρεάν. Δωρεάν Online FODS to MHT Merger. Συγχώνευση FODS σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το FODS με το MHT στο Python.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση FODS με MHT σε απευθείας σύνδεση" InputFormat="fods" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
