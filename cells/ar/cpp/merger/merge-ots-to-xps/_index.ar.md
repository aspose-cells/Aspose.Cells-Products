---
title: دمج OTS في XPS - ادمج OTS إلى XPS في C++
url: /ar/cpp/merger/merge-ots-to-xps/ 
description: Aspose إكسل. C++ Aspose.Cells. دمج OTS مجانًا عبر الإنترنت إلى تنسيق حفظ XPS. C++ ادمج OTS بتنسيق XPS. دمج OTS في XPS في C++. OTS Merge.
...
{{% blocks/products/pf/agp/content h2="قم بدمج OTS في XPS في C++ عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج OTS مع XPS في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج OTS في XPS. قم بتحميل ملفاتك ، واتصل بطريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف XPS. إذا قمت بتطوير رمز في C++ ، فسيكون هذا أبسط مما يبدو. راجع C++ المثال الذي يدمج OTS مع XPS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجانًا عبر الإنترنت لدمج OTS في XPS في C++" InputFormat="ots" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج OTS في XPS عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج OTS في XPS برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
