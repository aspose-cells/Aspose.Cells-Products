...
{{% blocks/products/pf/agp/content h2="How to Create PPTX in Java" %}}
...
1.  Save the workbook as PPTX format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create PPTX file in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java library to create PPTX file" %}}
{{% blocks/products/pf/agp/text %}}
