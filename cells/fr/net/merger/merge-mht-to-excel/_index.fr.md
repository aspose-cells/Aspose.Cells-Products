---
title: Fusionner MHT vers EXCEL - Combiner MHT vers EXCEL dans C#
url: /fr/net/merger/merge-mht-to-excel/ 
description: Aspose Excel. C# Aspose.Cells. Fusion en ligne gratuite MHT vers format de sauvegarde EXCEL. C# Combinez le format MHT au format EXCEL. Fusionner MHT vers EXCEL en C#. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT vers EXCEL en C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner MHT vers EXCEL dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner MHT vers EXCEL. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier EXCEL. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne MHT en EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner MHT vers EXCEL en C#" InputFormat="mht" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner MHT vers EXCEL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner MHT vers EXCEL par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner MHT vers EXCEL" %}}
