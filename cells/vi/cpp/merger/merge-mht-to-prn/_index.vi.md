---
title: Gộp MHT sang PRN - Gộp MHT sang PRN trong C++
url: /vi/cpp/merger/merge-mht-to-prn/ 
description: Aspose Excel. C++ Aspose.Cells. Hợp nhất trực tuyến miễn phí định dạng lưu MHT sang PRN. C++ Gộp định dạng MHT sang PRN. Hợp nhất MHT với PRN theo số C++. Hợp nhất MHT.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất MHT với PRN trong C++ Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất MHT với PRN trong Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất MHT với PRN. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp rồi lưu vào tệp PRN. Nếu bạn phát triển mã trong C++, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ C++ hợp nhất MHT với PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất MHT với PRN trong C++" InputFormat="mht" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất MHT với PRN qua C++" %}}

{{% blocks/products/pf/agp/text %}}

Cần hợp nhất MHT với PRN theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="C++ thư viện để hợp nhất MHT với PRN" %}}
