---
title: Převést SPREADSHEETML na XLT přes Java 
url: /cs/java/conversion/spreadsheetml-to-xlt/ 
description: Ukázkový konverzní kód Java pro formát SPREADSHEETML na soubor XLT. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do XLT v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést SPREADSHEETML na XLT přes Java" h2="Převod SPREADSHEETML na XLT Java pro převod jedné nebo více stránek na XLT pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést SPREADSHEETML na XLT pomocí Java" %}}

 K vykreslení SPREADSHEETML do XLT použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SPREADSHEETML na XLT prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor SPREADSHEETML na XLT pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SPREADSHEETML s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLT a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLT
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze SPREADSHEETML na XLT Java" offSpacer="" %}}

```cs
// načtěte soubor SPREADSHEETML do instance Workbooku
Workbook book = new Workbook("template.spreadsheetml");
// uložit SPREADSHEETML jako XLT
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze SPREADSHEETML na XLT" sectionDescription="[Převést SPREADSHEETML na XLT](https://products.aspose.app/cells/conversion/spreadsheetml-to-xlt) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor SPREADSHEETML a bude okamžitě převeden na XLT." >}}
