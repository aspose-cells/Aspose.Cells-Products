...
{{% blocks/products/pf/agp/content h2="Konversikan XLTX ke ANGKA Menggunakan C++" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLTX ke NUMBERS di C++" %}}

Contoh berikut menunjukkan cara mengkonversi XLTX menjadi ANGKA di C++.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah-langkah mudah untuk mengkonversi XLTX ke NUMBERS. Unggah file XLTX Anda, lalu simpan saja sebagai file NUMBERS. Untuk membaca XLTX dan menulis ke NUMBERS, Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format NUMBERS yang dihasilkan akan identik dengan dokumen XLTX asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi XLTX ke ANGKA" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xltx" outformat="numbers" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLTX ke ANGKA melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file XLTX ke NUMBERS secara terprogram? Pengembang C++ dapat dengan mudah mengkonversi XLTX ke NUMBERS hanya dengan beberapa baris kode.
...
1.  Konversikan XLTX ke ANGKA dengan memanggil metode Save().
1.  Dapatkan hasil konversi dari XLTX ke ANGKA.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ perpustakaan untuk mengkonversi XLTX menjadi ANGKA" %}}
