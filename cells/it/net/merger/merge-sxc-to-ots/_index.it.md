...
L'esempio seguente dimostra come unire SXC a OTS in Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 È necessario unire SXC a OTS a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria .NET per unire SXC a OTS" %}}
