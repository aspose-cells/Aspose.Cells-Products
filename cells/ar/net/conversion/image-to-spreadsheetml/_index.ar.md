---
title: C# IMAGE to SPREADSHEETML - تحويل الصورة عبر الإنترنت إلى SPREADSHEETML
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل الصورة إلى SPREADSHEETML saveformat. C# IMAGE إلى تنسيق SPREADSHEETML. حفظ الصورة في SPREADSHEETML C#.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في SPREADSHEETML في C# عبر الإنترنت مجانًا" %}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل الصورة إلى SPREADSHEETML عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى SPREADSHEETML برمجيًا؟ يمكن للمطورين .NET تحميل وتحويل IMAGE إلى SPREADSHEETML بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى SPREADSHEETML عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل IMAGE إلى SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# مكتبة لتحويل IMAGE إلى SPREADSHEETML" %}}
