...
description: Aspose Excel. Converteer MHTML snel en eenvoudig naar PDF met Aspose.Cells. PHP MHTML naar PDF. PHP Bewaar MHTML naar PDF. Sla MHTML op als PDF met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe MHTML naar PDF te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u MHTML-bestanden programmatisch naar PDF converteren? PHP-ontwikkelaars kunnen MHTML eenvoudig in slechts een paar regels code laden en converteren naar PDF.
...
1.  Converteer MHTML naar PDF door de opslagmethode van Workbook aan te roepen.
1.  Verkrijg het conversieresultaat van MHTML naar PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-bibliotheek om MHTML naar PDF te converteren" %}}
