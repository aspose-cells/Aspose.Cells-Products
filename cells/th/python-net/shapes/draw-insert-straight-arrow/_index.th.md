...
weight: 10
description: Python via ซอร์สโค้ด .Net เพื่อวาดหรือแทรกลูกศรตรงลงใน Excel
---
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการใส่ลูกศรตรงไฟล์ Excel โดยใช้ Python via .Net" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้การเพิ่มของ shapecollection[วิธี](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) เพื่อแทรกลูกศรตรงในเวิร์กชีตที่เลือก
