---
title: Inserte formas de ecuaciones en Excel usando Python via Java
weight: 360
description: Python via Java código fuente para insertar formas de ecuaciones en Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Inserte formas de ecuaciones en Excel usando Python via Java" h2="Inserte formas de ecuaciones usando Aspose.Cells\' API sin ningún software como Microsoft u Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo insertar formas de ecuaciones en un archivo de Excel usando Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar formas de ecuaciones en un archivo de Excel usando Python via Java" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Usa el[agregar método](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) para insertar formas de ecuaciones en la hoja de trabajo seleccionada
...
{{% blocks/products/pf/agp/code-block title="Insertar formas de ecuaciones - Python via Java" offSpacer="" %}}
