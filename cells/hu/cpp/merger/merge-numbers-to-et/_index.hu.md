---
title: A NUMBERS egyesítése az ET-vel – a NUMBERS egyesítése az ET-vel a C++ számon
url: /hu/cpp/merger/merge-numbers-to-et/ 
description: Aspose Excel. C++ Aspose.Cells. Ingyenes online egyesítése NUMBERS ET mentési formátumba. C++ A NUMBERS kombinálása ET formátumba. NUMBERS egyesítése ET-be a C++-ben. NUMBERS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a NUMBERS-t az ET-hez a C++-es online számon ingyen" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a NUMBERS-t az ET-vel a Aspose.Cells for C++ számon.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a NUMBERS és az ET egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el ET fájlba. Ha kódot fejleszt a C++-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C++-es példát, amely egyesíti a NUMBERS-t az ET-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online NUMBERS egyesítése ET-be a C++ számon" InputFormat="numbers" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="A NUMBERS egyesítése az ET-be a C++ számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell NUMBERS számot ET-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a NUMBERS és az ET egyesítéséhez" %}}
