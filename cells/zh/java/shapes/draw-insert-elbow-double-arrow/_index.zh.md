...
{{% blocks/products/pf/agp/content h2="如何使用Java将弯头双箭头形状插入Excel文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="将弯头双箭头形状插入Excel文件via Java的步骤" %}}
...
+ 通过索引选择工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-)在选定的工作表中插入弯头双箭头形状
以 XLSX 格式保存工作簿。
...
{{% blocks/products/pf/agp/code-block title="插入弯头双箭头形状 - Java" offSpacer="" %}}
