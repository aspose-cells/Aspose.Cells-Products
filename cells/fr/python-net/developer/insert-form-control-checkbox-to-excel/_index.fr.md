---
title:  Insérez CheckBox (contrôle de formulaire) dans Excel via Python
weight: 30
description: Python code source pour insérer CheckBox (contrôle de formulaire) dans Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Insérez CheckBox (contrôle de formulaire) dans Excel via Python" h2="Insérez des objets à l\'aide d\'API côté serveur sans aucun logiciel comme Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment insérer une case à cocher (contrôle de formulaire) dans un fichier Excel à l\'aide de Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer CheckBox (contrôle de formulaire) dans un fichier Excel via Python" %}}
...
+ Utilisez la méthode add de la collection de formes pour insérer une case à cocher (contrôle de formulaire) dans la feuille de calcul sélectionnée.
...
{{% blocks/products/pf/agp/code-block title="Insérer une case à cocher (contrôle de formulaire) - Python" offSpacer="" %}}
