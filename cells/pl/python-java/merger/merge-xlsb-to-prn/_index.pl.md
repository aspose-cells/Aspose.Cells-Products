...
description: Aspose Excel. Python Aspose.Cells. Scal XLSB do formatu zapisu PRN. Python Połącz XLSB w formacie PRN. Połącz XLSB z PRN w Python. XLSB Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz numer XLSB z PRN, używając numeru Python" %}}
...
{{% blocks/products/pf/agp/content h2="Połącz numer XLSB z PRN w numerze Python" %}}
...
{{% cells-merger title="Przykładowy kod do połączenia XLSB z PRN w Python" InputFormat="xlsb" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć numer XLSB z PRN poprzez numer Python" %}}
