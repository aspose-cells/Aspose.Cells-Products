---
title:  Desbloquear documento XLSB via Java
weight: 5860
description: Código de exemplo Java para desbloquear o arquivo XLSB protegido por senha no Java Runtime Environment para aplicativos JSP/JSF e aplicativos de desktop.
...
{{% blocks/products/pf/agp/content h2="Como remover a proteção do arquivo XLSB usando Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Desbloquear XLSB Arquivos via Java" offSpacer="" %}}
