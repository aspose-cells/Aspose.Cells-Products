---
title: محول PHP JPG إلى MHTML - محول JPG إلى MHTML
description: Aspose Excel. يوفر هذا الحل الشامل لمطوري PHP نهجًا متكاملًا تمامًا لتحويل JPG إلى تنسيق MHTML، مما يتيح حفظ بيانات JPG بسلاسة بتنسيق MHTML باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود PHP فعال وقابل للتخصيص.
...
{{% cells-convert title="نموذج كود لتحويل صورة JPG إلى MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="mhtml" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل ملف JPG إلى MHTML باستخدام PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات JPG إلى صيغة MHTML برمجيًا؟ يمكن لمطوري PHP تحميل ملفات JPG وتحويلها إلى صيغة MHTML بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل ملف JPG إلى MHTML عن طريق استدعاء دالة الحفظ الخاصة بـ Workbook.
1.  احصل على نتيجة تحويل JPG إلى MHTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة PHP لتحويل صور JPG إلى MHTML" %}}
