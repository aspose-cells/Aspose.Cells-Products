...
description: Aspose Excel'de. Aspose.Cells ile EXCEL'i hızlı ve kolay bir şekilde MD'ye dönüştürün. C# EXCEL'i MD'ye dönüştürün. C# EXCEL'i MD'ye kaydedin. C#'i kullanarak EXCEL'i MD olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i C#\'de MD\'ye kaydedin" %}}

Aşağıdaki örnek, C#'de EXCEL'in MD'ye nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="EXCEL\'i MD\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="md" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i C# aracılığıyla MD\'ye dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

EXCEL dosyalarını programlı olarak MD'ye dönüştürmeniz mi gerekiyor? .NET geliştiriciler EXCEL'i yalnızca birkaç satır kodla kolayca yükleyebilir ve MD'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL\'i MD\'ye dönüştürmek için C# kütüphane" %}}
