---
title: PHP OTS إلى ODS - OTS إلى ODS محول
description: Aspose اكسل. قم بتحويل OTS إلى ODS بسرعة وسهولة باستخدام Aspose.Cells. PHP OTS إلى ODS. PHP احفظ OTS إلى ODS. احفظ OTS كـ ODS باستخدام PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل OTS إلى ODS في PHP" h2="مكتبة PHP عالية السرعة لتحويل OTS إلى ODS. هذا حل برمجي احترافي لاستيراد وتصدير OTS وODS والعديد من التنسيقات الأخرى باستخدام PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل OTS إلى ODS عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات OTS إلى ODS برمجياً؟ يمكن لمطوري PHP تحميل OTS وتحويله بسهولة إلى ODS في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  تحويل OTS إلى ODS عن طريق استدعاء طريقة حفظ المصنف.
