...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng[thêm phương pháp](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addautoshape/) để chèn Tổng quan về các loại mũi tên khối vào bảng tính đã chọn
...
Mã mẫu bên dưới minh họa cách chèn "mũi tên phải". Để biết thêm các loại, vui lòng tham khảo "Tổng quan về các loại mũi tên khối" bên dưới.
