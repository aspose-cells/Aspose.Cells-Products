---
title: Convierta XLSB a JSON a través de Java 
weight: 9970
url: /es/java/conversion/xlsb-to-json/ 
description: Ejemplo de código de conversión Java para formato XLSB a archivo JSON. Los programadores pueden usar este código de ejemplo para exportar hojas de cálculo de Excel y OpenOffice a JSON dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta XLSB a JSON a través de Java" h2="Conversión de XLSB a JSON Java para convertir una o varias páginas a JSON mediante la biblioteca Java local." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir XLSB a JSON usando Java" %}}

 Para convertir XLSB a JSON, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir XLSB a JSON a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente un archivo XLSB a JSON con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo XLSB con una instancia de la clase Workbook1. Cree un rango de datos para exportar usando el método Cells.createRange1. Llame al método JsonUtility.exportRangeToJson con referencias de Range y ExportRangeToJsonOptions1. Escriba datos de String JSON en un archivo a través del método BufferedWriter.write
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de XLSB a JSON Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de XLSB a JSON" sectionDescription="[Convertir XLSB a JSON](https://products.aspose.app/cells/conversion/xlsb-to-json) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo XLSB, se convertirá instantáneamente a JSON." >}}
