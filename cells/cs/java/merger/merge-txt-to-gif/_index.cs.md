---
title: Sloučit TXT až GIF - Sloučit TXT až GIF v Java
url: /cs/java/merger/merge-txt-to-gif/ 
description: Aspose Excel. Java Aspose.Cells. Online sloučení zdarma TXT do formátu uložení GIF. Java Kombinujte formát TXT až GIF. Sloučit TXT až GIF v Java. TXT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit TXT až GIF v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit TXT až GIF v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení TXT do GIF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru GIF. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí TXT do GIF.
...
{{% blocks/products/pf/agp/content h2="Jak sloučit TXT do GIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit TXT až GIF? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java ke sloučení TXT až GIF" %}}
