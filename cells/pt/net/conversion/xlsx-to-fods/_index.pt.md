---
title: C# XLSX a FODS - XLSX a FODS Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter XLSX para o formato FODS, permitindo o salvamento perfeito de dados XLSX no formato FODS usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX a FODS em C#" %}}

exemplo a seguir demonstra como converter XLSX em FODS em C#.
...
{{% cells-convert title="Código de exemplo para converter XLSX em FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="fods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX em FODS por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX em FODS programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter XLSX em FODS em apenas algumas linhas de código.
...
1.  Converta XLSX para FODS chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de XLSX para FODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter XLSX em FODS" %}}
