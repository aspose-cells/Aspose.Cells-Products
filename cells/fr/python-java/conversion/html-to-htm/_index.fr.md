...
{{% blocks/products/pf/agp/content h2="Convertir HTML en HTM en utilisant Python" %}}
...
L'exemple suivant montre comment convertir HTML en HTM dans Python.
...
{{% blocks/products/pf/agp/content h2="Comment convertir HTML en HTM via Python" %}}
