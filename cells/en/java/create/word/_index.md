...
{{% blocks/products/pf/agp/content h2="How to Create WORD in Java" %}}
...
1.  Save the workbook as WORD format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create WORD file in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java library to create WORD file" %}}
{{% blocks/products/pf/agp/text %}}
