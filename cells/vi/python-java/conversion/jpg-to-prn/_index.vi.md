...
description: Aspose Excel. Chuyển đổi JPG sang PRN nhanh chóng và dễ dàng với Aspose.Cells. Python JPG sang PRN. Python Lưu JPG vào PRN. Lưu JPG dưới dạng PRN bằng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi JPG sang PRN bằng Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu JPG vào PRN theo số Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi JPG sang PRN trong Python.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển JPG sang PRN" %}}
