---
title:  Sloučit PRN do MHT přes C++
...
Následující příklad ukazuje, jak sloučit PRN s MHT v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení PRN do MHT online" InputFormat="prn" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
