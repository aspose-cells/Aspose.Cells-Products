---
title: تحويل C++ MHT إلى XLSM - تحويل MHT إلى XLSM
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C++ نهجًا متكاملًا تمامًا لتحويل MHT إلى تنسيق XLSM، مما يتيح حفظ بيانات MHT بسلاسة في تنسيق XLSM باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C++ فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="احفظ MHT إلى XLSM في C++" %}}
...
هل تحتاج إلى تحويل ملفات MHT إلى XLSM برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى XLSM بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XLSM عن طريق استدعاء دالة Save().
