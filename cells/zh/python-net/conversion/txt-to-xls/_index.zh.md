---
title: Python TXT 转 XLS - 在线 TXT 转 XLS 转换器
description: Aspose Excel。 Python Aspose.Cells。Python Aspose Cells。免费在线 Python 将 TXT 转换为 XLS 保存格式。 Python TXT 到 XLS 格式。将 TXT 保存为 XLS Python。
...
{{% blocks/products/pf/agp/content h2="免费在线保存 TXT 至 XLS 于 Python" %}}
...
{{% cells-convert title="免费应用程序和示例代码可在线将 TXT 转换为 XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="txt" outformat="xls" IsLandingPage="true" language="pythonnet" %}}
