---
title: PHP HTM na XLS - Konwerter HTM na XLS
description: Aspose Excel. Konwertuj HTM na XLS szybko i łatwo za pomocą Aspose.Cells. PHP HTM na XLS. PHP Zapisz HTM na XLS. Zapisz HTM jako XLS używając PHP.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj HTM na XLS w PHP" h2="Szybka biblioteka PHP do konwersji HTM na XLS. Jest to profesjonalne oprogramowanie do importowania i eksportowania HTM, XLS i wielu innych formatów przy użyciu PHP." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-php-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować HTM na XLS przez PHP" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki HTM na XLS? Programiści PHP mogą łatwo załadować i przekonwertować HTM na XLS w zaledwie kilku linijkach kodu.
...
1.  Konwertuj HTM na XLS, wywołując metodę zapisu skoroszytu.
