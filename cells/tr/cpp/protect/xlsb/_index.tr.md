...
weight: 4860
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Runtime Environment üzerinde parola kullanarak XLSB dosyasını kilitlemek için örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB Dosyalarını C++ aracılığıyla şifrele" h2=".NET Kitaplığı kullanılarak XLSB formatı dahil olmak üzere Excel elektronik tablolarını parolayla koruyun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="XLSB Dosyasını C++ Kullanarak Nasıl Güvenli Hale Getirirsiniz?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLSB Dosyalarını C++ Yoluyla Koruma Adımları" %}}
...
1.  IWorkbook sınıfını kullanarak XLSB dosyasını yükleyin
