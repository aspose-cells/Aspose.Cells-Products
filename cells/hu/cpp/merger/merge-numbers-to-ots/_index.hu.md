...
url: /hu/cpp/merger/merge-numbers-to-ots/ 
...
következő példa bemutatja, hogyan egyesítheti a NUMBERS-t az OTS-be a Aspose.Cells for C++ számon.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a NUMBERS számot az OTS-sel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a NUMBERS és az OTS egyesítéséhez" %}}
