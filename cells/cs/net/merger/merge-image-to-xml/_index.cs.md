...
url: /cs/net/merger/merge-image-to-xml/ 
...
Následující příklad ukazuje, jak sloučit IMAGE do XML v Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit IMAGE do XML? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna pro sloučení IMAGE do XML" %}}
