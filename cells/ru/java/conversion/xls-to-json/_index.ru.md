...
{{< blocks/products/pf/i18n/upper-banner h1="Преобразование XLS в JSON через Java" h2="Преобразование XLS в JSON Java для преобразования одной или нескольких страниц в JSON с использованием локальной библиотеки Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать XLS в JSON с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию XLS в JSON через Java" %}}

{{% blocks/products/pf/agp/text %}}

Разработчики могут легко преобразовать файл XLS в JSON всего за несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузите файл XLS с экземпляром класса Workbook1. Создайте диапазон данных для экспорта с помощью метода Cells.createRange.1. Вызовите метод JsonUtility.exportRangeToJson со ссылками на Range и ExportRangeToJsonOptions.1. Запишите данные String JSON в файл с помощью метода BufferedWriter.write.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Прежде чем использовать пример кода, убедитесь, что у вас выполнены следующие предварительные условия.
...
{{% blocks/products/pf/agp/code-block title="Исходный код преобразования XLS в JSON Java" offSpacer="" %}}
