---
title: PHP XLTM إلى EXCEL - XLTM إلى محول EXCEL
description: Aspose اكسل. تحويل XLTM إلى EXCEL بسرعة وسهولة مع Aspose.Cells. PHP XLTM إلى EXCEL. PHP احفظ XLTM في ملف EXCEL. احفظ XLTM كـ EXCEL باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى EXCEL عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى EXCEL برمجياً؟ يمكن لمطوري PHP تحميل XLTM وتحويله بسهولة إلى EXCEL في بضعة أسطر فقط من التعليمات البرمجية.
...
1.  تحويل XLTM إلى EXCEL عن طريق استدعاء طريقة حفظ المصنف.
1.  احصل على نتيجة التحويل من XLTM إلى EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة PHP لتحويل XLTM إلى EXCEL" %}}
