---
title: Convert XLS to ODS via C++ application 
url: /cpp/conversion/xls-to-ods/
description: Sample C++ conversion code for XLS to ODS format. Programmers can use this source code for batch XLS to ODS conversion within any C++ Application.
---
