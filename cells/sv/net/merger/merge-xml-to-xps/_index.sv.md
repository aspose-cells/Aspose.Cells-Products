...
url: /sv/net/merger/merge-xml-to-xps/ 
...
{{< blocks/products/pf/i18n/upper-banner h1="Slå samman XML till XPS via C#" h2="Höghastighetsbibliotek C# för sammanslagning av XML till XPS. Använd vår excel-konvertering API för att utveckla högnivå, plattformsoberoende programvara i C#. Detta är en professionell mjukvarulösning för att importera och exportera Excel, CSV, OpenOffice, PDF, HTML, image och många andra Excel-format." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="XML" additionalConversionTag="XPS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
Följande exempel visar hur man slår samman XML till XPS i Aspose.Cells for .NET.
...
{{% cells-merger title="Exempelkod för att slå samman XML till XPS i C#" InputFormat="xml" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man sammanfogar XML till XPS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du slå samman XML till XPS programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman XML till XPS" %}}
