...
description: Sample Java conversion code for XLS format to XPS file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to XPS within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert XLS to XPS Using Java" %}}

 In order to render XLS to XPS, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XLS to XPS via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="XLS to XPS Java Conversion Source Code" offSpacer="" %}}
