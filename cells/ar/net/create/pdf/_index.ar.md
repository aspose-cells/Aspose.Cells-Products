...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء PDF عبر C#" %}}
...
{{% blocks/products/pf/agp/code-block title="نموذج التعليمات البرمجية لإنشاء ملف PDF باستخدام C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة C# لإنشاء ملف PDF" %}}
