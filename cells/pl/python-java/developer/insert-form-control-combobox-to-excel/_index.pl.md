---
title:  Wstaw ComboBox (kontrolka formularza) do Excela, używając Python via Java
weight: 20
description: Python via kod źródłowy Java umożliwiający wstawienie ComboBox (kontrolki formularza) do programu Excel.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić ComboBox (kontrolkę formularza) do pliku Excel przy użyciu Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić ComboBox (kontrolkę formularza) do pliku Excel przy użyciu Java Python via" %}}
...
+ Wybierz Arkusz poprzez jego indeks.
 + Użyj kolekcji kształtów[dodaj metodę](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addComboBox(int,%20int,%20int,%20int,%20int,%20int)), aby wstawić ComboBox (kontrolkę formularza) do wybranego arkusza.
...
{{% blocks/products/pf/agp/code-block title="Wstaw ComboBox (kontrolka formularza) - Python via java" offSpacer="" %}}
