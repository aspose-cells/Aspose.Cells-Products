---
title: C# MHTML tới PRN - MHTML sang PRN Chuyển đổi
description: Aspose Excel. Chuyển đổi MHTML sang PRN nhanh chóng và dễ dàng với Aspose.Cells. C# MHTML sang PRN. C# Lưu MHTML vào PRN. Lưu MHTML dưới dạng PRN bằng C#.
...
{{% blocks/products/pf/agp/content h2="Lưu MHTML vào PRN vào C#" %}}

Ví dụ sau đây minh họa cách chuyển đổi MHTML sang PRN trong C#.
...
{{% cells-convert title="Mã mẫu để chuyển đổi MHTML sang PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="prn" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi MHTML sang PRN qua C#" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin MHTML sang PRN theo chương trình? Các nhà phát triển .NET có thể dễ dàng tải và chuyển đổi MHTML sang PRN chỉ bằng một vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Thư viện C# để chuyển đổi MHTML sang PRN" %}}
