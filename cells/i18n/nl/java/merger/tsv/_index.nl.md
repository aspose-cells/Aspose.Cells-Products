---
title: TSV-bestanden samenvoegen via Java 
weight: 9260
url: /nl/java/merger/tsv/ 
description: Java voorbeeldcode om TSV-documenten te combineren in Java Runtime Environment voor JSP/JSF-applicaties en desktopapplicaties.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TSV-indelingen samenvoegen in Java" h2="Native TSV-documentfusie met server-side Java API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="TSV-bestanden samenvoegen met Java" %}}
...
+ Laad het eerste TSV-bestand met een exemplaar van de Workbook-klasse.
+ Laad het tweede TSV-document met een exemplaar van de Workbook-klasse.
+ Voeg bestanden samen met de combine()-methode.
+ sla het samengevoegde TSV-bestand op op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="TSV-bestanden samenvoegen - Java" offSpacer="" %}}

```cs
// Open het eerste TSV-bestand.
Workbook tsvFile1 = new Workbook("chartsFileWithPath.tsv");

// Definieer het tweede bronboek.
// Open het tweede TSV-bestand.
