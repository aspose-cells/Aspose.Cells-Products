...
description: Aspose Exceller. Python Exceller. Fusionnez MHT avec le format de sauvegarde DOCX. Python Combinez MHT au format DOCX. Fusionnez MHT avec DOCX dans la bibliothèque Excel Python. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT avec DOCX à l\'aide de la bibliothèque Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT avec DOCX dans la bibliothèque Excel Python" %}}
...
{{% cells-merger title="Exemple de code pour fusionner MHT avec DOCX dans la bibliothèque Excel Python" InputFormat="mht" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner MHT avec DOCX via la bibliothèque Excel Python" %}}
