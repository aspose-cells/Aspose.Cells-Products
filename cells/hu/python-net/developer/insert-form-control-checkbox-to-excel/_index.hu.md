---
title:  Illessze be a CheckBoxot (Űrlapvezérlőt) az Excelbe a Python via .Net használatával
weight: 30
description: Python via .Net forráskód a CheckBox (Űrlapvezérlő) beillesztéséhez az Excelbe.
...
{{% blocks/products/pf/agp/content h2="CheckBox (űrlapvezérlő) beszúrása Excel fájlba a Python via .Net használatával" %}}

 A CheckBox (Űrlapvezérlő) excel fájlba való beillesztéséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A CheckBox (űrlapvezérlő) Excel-fájlba való beszúrásának lépései a Python via .Net használatával" %}}
...
+ Válassza ki a munkalapot az indexén keresztül.
 + Használja az alakgyűjtemény hozzáadását[módszer](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_check_box/#int-int-int-int-int-int) egy CheckBox (Űrlapvezérlő) beillesztéséhez a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="Jelölőnégyzet beszúrása (Űrlapvezérlő) - Python via .Net" offSpacer="" %}}
