---
title: تحويل XLTX إلى PDF عبر تطبيق C++ 
url: /ar/cpp/conversion/xltx-to-pdf/ 
description: نموذج C++ رمز تحويل لمستند XLTX إلى تنسيق PDF. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل XLTX إلى PDF دفعة داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLTX إلى PDF عبر C++" h2="تحويل XLTX إلى PDF عالي الأداء باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوّري برامج C++ تحويل ملف XLTX إلى PDF بسهولة في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLTX باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد ملف (PDF).1. سيتم حفظ ملف PDF في المسار المحدد.1. افتح ملف PDF في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLTX إلى PDF C++ شفرة مصدر التحويل" offSpacer="" %}}
