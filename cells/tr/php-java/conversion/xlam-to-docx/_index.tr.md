---
title: PHP XLAM ila DOCX - XLAM ila DOCX Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde XLAM'i DOCX'e dönüştürün. PHP XLAM'i DOCX'e dönüştürün. PHP XLAM'i DOCX'e kaydedin. PHP kullanarak XLAM'i DOCX olarak kaydedin.
...
{{% cells-convert title="XLAM\'i DOCX\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="docx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="PHP aracılığıyla XLAM\'i DOCX\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

XLAM dosyalarını program aracılığıyla DOCX'e dönüştürmeniz mi gerekiyor? PHP geliştiricileri sadece birkaç satır kodla XLAM'i DOCX'e kolayca yükleyebilir ve dönüştürebilir.
...
1.  Çalışma Kitabının kaydetme yöntemini çağırarak XLAM'i DOCX'e dönüştürün.
1.  XLAM'den DOCX'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="XLAM\'i DOCX\'e dönüştürmek için PHP kütüphanesi" %}}
