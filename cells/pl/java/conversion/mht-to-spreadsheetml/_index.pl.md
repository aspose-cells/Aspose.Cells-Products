...
{{% blocks/products/pf/agp/content h2="Zapisz MHT w SPREADSHEETML w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować format MHT na SPREADSHEETML w formacie Java.
...
Trzeba programowo przekonwertować pliki MHT na SPREADSHEETML? Programiści Java mogą łatwo przekonwertować pliki MHT na SPREADSHEETML za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji MHT na SPREADSHEETML" %}}
{{% blocks/products/pf/agp/text %}}
