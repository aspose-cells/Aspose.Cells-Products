...
description: Aspose Excel. Convierta XLSB a XLTM rápida y fácilmente con Aspose.Cells. Python XLSB a XLTM. Python Guarde XLSB en XLTM. Guarde XLSB como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLSB al XLTM en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSB a XLTM en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSB en XLTM" %}}
