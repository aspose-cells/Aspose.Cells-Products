...
{{% blocks/products/pf/agp/content h2="C# Kullanarak XLS Dosyasını Birleştirme" %}}
 ...
 XLS dosyasını birleştirmek için kullanacağız
...
+ Tüm XLS dosyalarını tam yolla yükleyin.
+ Temel dosya olarak bir belge yapın
+ Dosyaları tek tek birleştirmek ve birleştirmek için ilgili yöntemi çağırın.
+ Save() yöntemini çağırın ve dosya adını (tam yol) ve formatı (XLS) parametre olarak iletin.
+ Artık XLS dosyasını Microsoft Office, Adobe PDF veya diğer uyumlu programlarda açıp kullanabilirsiniz.
