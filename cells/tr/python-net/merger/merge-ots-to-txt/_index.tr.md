---
title:  OTS'yi TXT aracılığıyla Python ile birleştirin
url: /tr/python-net/merger/merge-ots-to-txt/ 
description: OTS'yi TXT Online ile Ücretsiz Olarak Birleştirin. Ücretsiz Online OTS'den TXT'e Birleşme. OTS'yi Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS ve daha fazlasıyla birleştirin.
---
...
Aşağıdaki örnek, OTS'nin Python'de TXT ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="OTS\'yi hatta TXT ile birleştirmek için Ücretsiz Uygulama" InputFormat="ots" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
