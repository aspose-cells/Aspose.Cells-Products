---
title: Convertir XLSB en EXCEL C#
description: Convertissez XLSB en EXCEL Online gratuitement. Convertisseur en ligne gratuit XLSB vers EXCEL. C# XLSB à EXCEL. XLSB à EXCEL via C#.
keywords: Convert XLSB, XLSB Converter, XLSB to PDF, XLSB to Word, XLSB to PPT, XLSB to Image
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir XLSB en EXCEL via C#" h2="Bibliothèque C# haute vitesse pour convertir XLSB en EXCEL. Exportez des feuilles de calcul Excel au format EXCEL sur .NET Framework, .NET Core ou Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir XLSB en EXCEL en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir XLSB en EXCEL via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs de .NET peuvent facilement charger et convertir XLSB en EXCEL en quelques lignes de code.

{{% /blocks/products/pf/agp/text %}}

1.  Charger le fichier XLSB avec une instance de Workbook
1.  Convertir XLSB en EXCEL en appelant la méthode Workbook.Save
