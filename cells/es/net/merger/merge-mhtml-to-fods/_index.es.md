---
title: Combinar MHTML a FODS - Combinar MHTML a FODS en C#
url: /es/net/merger/merge-mhtml-to-fods/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea MHTML a FODS guardar formato. C# Combina el formato MHTML con el FODS. Combinar MHTML a FODS en C#. MHTML Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine MHTML a FODS en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar MHTML con FODS en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar MHTML a FODS. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo FODS. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que combina MHTML con FODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar MHTML a FODS en C#" InputFormat="mhtml" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar MHTML a FODS a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar MHTML con FODS mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar MHTML a FODS" %}}
