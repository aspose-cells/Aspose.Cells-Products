---
title: 建立ODS - 在C#中建立ODS文件
description: Aspose Excel。使用 Aspose.Cells for .NET 函式庫，輕鬆產生和操作 ODS 檔案。這款強大的 API 庫提供了一種簡化高效的解決方案，可直接在您的 C# 應用程式中建立、編輯和管理 ODS 文件，從而高精度地滿足開發人員的特定需求。
...
{{% blocks/products/pf/agp/content h2="如何在C#中建立ODS" %}}

{{% blocks/products/pf/agp/text %}}

開發人員只需幾行程式碼即可輕鬆地在運行不同的報告應用程式中建立、載入、修改和轉換 ODS 檔案以進行資料處理。
...
1. 使用 Save 方法將工作簿另存為 ODS 檔案。

{{% blocks/products/pf/agp/code-block title="範例程式碼展示如何在 C# 中建立 ODS 檔案。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C#庫建立ODS文件" %}}
