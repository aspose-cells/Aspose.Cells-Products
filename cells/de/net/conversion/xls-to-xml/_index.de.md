---
title: C# XLS zu XML - XLS zu XML Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von XLS in das XML-Format und ermöglicht das nahtlose Speichern von XLS-Daten im XML-Format mithilfe der Aspose.Cells-Bibliothek, alles durch effizienten und anpassbaren C#-Code.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS als XML in C#" %}}

Das folgende Beispiel zeigt, wie man XLS in XML in C# konvertiert.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in XML" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in XML konvertieren? .NET-Entwickler können XLS mit nur wenigen Codezeilen problemlos laden und in XML konvertieren.
...
1.  Konvertieren Sie XLS in XML, indem Sie die Methode Workbook.Save aufrufen.
1.  Holen Sie sich das Konvertierungsergebnis von XLS nach XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLS in XML" %}}
