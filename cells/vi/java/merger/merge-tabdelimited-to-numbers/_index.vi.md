---
title: Hợp nhất TABDELIMITED thành SỐ - Kết hợp TABDELIMITED thành SỐ trong Java
url: /vi/java/merger/merge-tabdelimited-to-numbers/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất trực tuyến miễn phí TABDELIMITED thành định dạng lưu NUMBERS. Java Kết hợp TABDELIMITED thành định dạng SỐ. Hợp nhất TABDELIMITED thành NUMBERS trong Java. Hợp nhất TABDELIMITED.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất TABDELIMITED thành SỐ trong Java Trực tuyến miễn phí" %}}

Ví dụ sau đây minh họa cách hợp nhất TABDELIMITED thành SỐ trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất TABDELIMITED với NUMBERS. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp rồi lưu vào tệp NUMBERS. Nếu bạn phát triển mã trong Java, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ Java hợp nhất TABDELIMITED thành NUMBERS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất TABDELIMITED thành SỐ trong Java" InputFormat="tsv" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất TABDELIMITED thành SỐ via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Cần hợp nhất TABDELIMITED với NUMBERS theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Java](https://products.aspose.com/cells/java) API có thể được thực hiện chỉ với vài dòng mã.
...
{{% blocks/products/pf/agp/content h2="Java thư viện để hợp nhất TABDELIMITED thành NUMBERS" %}}
