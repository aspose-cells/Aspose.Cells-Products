...
{{% cells-convert title="将 XLT 转换为 PDF 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="pdf" IsLandingPage="true" %}}
...
1. 使用工作簿实例加载 XLT 文件。
1. 通过调用Workbook.Save方法将XLT转换为PDF。
1. 获取XLT到PDF的转换结果。
