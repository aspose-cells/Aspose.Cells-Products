...
{{% blocks/products/pf/agp/content h2="Sla HTML op in JPEG in Java" %}}

Het volgende voorbeeld laat zien hoe je HTML omzet naar JPEG in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik HTML om naar JPEG of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie HTML programmatisch converteren naar JPEG? Ontwikkelaars van Java kunnen bestanden met de extensie HTML eenvoudig converteren naar JPEG met slechts een paar regels code.
