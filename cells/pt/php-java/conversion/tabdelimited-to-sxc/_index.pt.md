...
{{% blocks/products/pf/agp/content h2="Como converter TABDELIMITED para SXC via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos TABDELIMITED para SXC programaticamente? Desenvolvedores PHP podem facilmente carregar e converter arquivos TABDELIMITED para SXC com apenas algumas linhas de código.
...
1.  Converta TABDELIMITED para SXC chamando o método save da Workbook.
1.  Obtenha o resultado da conversão de TABDELIMITED para SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para converter TABDELIMITED em SXC" %}}
