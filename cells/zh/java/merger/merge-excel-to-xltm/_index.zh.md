---
title: 合并EXCEL为XLTM via Java
url: /zh/java/merger/merge-excel-to-xltm/ 
description: 免费在线合并 EXCEL 到 XLTM。免费在线 EXCEL 到 XLTM 合并。将 EXCEL 合并到 Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS 等。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="合并EXCEL为XLTM via Java" h2="高速Java库，用于合并EXCEL到XLTM。使用我们的excel转换API在Java开发高级、平台独立的软件。这是导入和导出Excel、CSV、OpenOffice、PDF、HTML、图像、和许多其他 excel 格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="EXCEL" additionalConversionTag="XLTM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Java在线免费合并EXCEL到XLTM" %}}

下面的例子演示如何将EXCEL合并到Java中的XLTM。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将EXCEL合并到XLTM。上传你的文件，调用Workbook.Combine方法合并文件，然后保存到XLTM文件。如果您在 Java 中开发代码，这将比听起来更简单。参见将 EXCEL 合并到 XLTM 的 Java 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免费应用程序在线将 EXCEL 合并到 XLTM" InputFormat="xlsx" InputFormat2="xltm" outformat="xltm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何合并EXCEL到XLTM via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Java库合并EXCEL到XLTM" %}}
