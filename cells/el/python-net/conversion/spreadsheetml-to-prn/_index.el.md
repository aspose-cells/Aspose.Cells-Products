...
{{% blocks/products/pf/agp/content h2="Μετατρέψτε το SPREADSHEETML σε PRN στο Python" %}}
...
Το ακόλουθο παράδειγμα δείχνει πώς να μετατρέψετε SPREADSHEETML σε PRN στο Python via NET.
