---
title: 在 XLS 文件中生成報告 via .NET
weight: 1700
description: C# 在 .NET 框架、.NET 核心、Mono 或 Xamarin 平台上生成 XLS 格式報告的源代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 生成 XLS 格式的批量報告" h2="使用數據源和模板生成 XLS 格式的報告。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
1. 通過 WorkbookDesigner.Worbook.Save 方法以 XLS 格式保存結果
