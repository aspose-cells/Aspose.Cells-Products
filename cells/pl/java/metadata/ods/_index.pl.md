---
title: Edytuj lub wyświetl metadane plików ODS za pomocą Java 
weight: 2080
url: /pl/java/metadata/ods/ 
description: Java przykładowy kod do edycji lub przeglądania metadanych formatu ODS w Java środowisku wykonawczym dla aplikacji JSP/JSF i aplikacji komputerowych.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wyodrębnij metadane ODS za pomocą Java" h2="Twórz własne Java aplikacje, aby dodawać, edytować, usuwać lub wyodrębniać metadane z plików ODS przy użyciu interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak wyodrębnić metadane ODS za pomocą Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki wyodrębniania metadanych ODS za pomocą Java" %}}
