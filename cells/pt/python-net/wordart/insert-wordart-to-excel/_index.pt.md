...
{{% blocks/products/pf/agp/content h2="Como inserir WordArt no arquivo do Excel usando Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir WordArt no arquivo Excel usando Python via .Net" %}}
...
+ Selecione a planilha por meio de seu índice.
 + Use o add da coleção de formas[método](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_word_art/#PresetWordArtStyle-str-int-int-int-int-int-int) para inserir um WordArt na planilha selecionada.
