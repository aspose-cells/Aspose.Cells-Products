---
title: Java Napraw xls — odzyskaj i napraw uszkodzony plik xls
url: /pl/java/recovery/repair-xls/ 
description: Java Aspose.Cells. Naprawa xls. Napraw plik xls. narzędzie do odzyskiwania xls. uszkodzenie xls. Przywróć dane xls. odzyskiwanie plików xls. Odzyskaj uszkodzony plik xls.
...
Chcesz programowo naprawić plik xls? Programiści Java mogą łatwo załadować i naprawić plik xls w zaledwie kilku linijkach kodu.
...
{{% cells-recovery title="Przykładowy kod do naprawy pliku XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xls" outformat="xls" IsLandingPage="true" language="java" %}}    
