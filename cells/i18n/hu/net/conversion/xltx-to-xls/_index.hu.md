...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET fejlesztői könnyedén betölthetnek és konvertálhatnak XLTX fájlokat XLS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLTX fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal megadása XLS kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott XLS-fájl megadott elérési útját
...
{{% cells-convert title="Ingyenes alkalmazás és mintakód az XLTX XLS-re konvertálásához" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="xls" IsLandingPage="true" %}}
