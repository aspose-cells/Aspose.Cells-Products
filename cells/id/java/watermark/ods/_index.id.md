---
title:  Watermark ODS dokumen via Java
weight: 1040
description: Java contoh kode untuk menambah atau menghapus tanda air ke file ODS pada Java Runtime Environment untuk Aplikasi JSP/JSF dan Aplikasi Desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tambahkan Text Watermark ke ODS via Java" h2="Bangun aplikasi Java Anda sendiri untuk memberi tanda air pada file ODS menggunakan API sisi server." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cara Watermark File ODS Menggunakan Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Menambahkan Watermark ke ODS via Java" %}}
...
1.  Simpan buku kerja dalam format ODS
...
{{% blocks/products/pf/agp/code-block title="Tambahkan Watermark ke ODS - Java" offSpacer="" %}}
