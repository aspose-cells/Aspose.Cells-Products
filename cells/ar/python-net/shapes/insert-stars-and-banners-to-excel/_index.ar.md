---
title:  أدخل النجوم والرايات في Excel Python via .NET
weight: 381
description: Python via .NET كود المصدر لإدراج Stars And Banners في Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="أدخل النجوم والرايات في Excel Python via .NET" h2="أدخل كائنات باستخدام واجهات برمجة التطبيقات من جانب الخادم بدون أي برنامج مثل Microsoft أو Open Office ، Adobe PDF ، إلخ." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج النجوم والرايات في ملف Excel باستخدام Python via .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج Stars And Banners في ملف Excel عبر Python" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم إضافة الشكل[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) لإدراج نجوم وشعارات في ورقة العمل المحددة.
...
{{% blocks/products/pf/agp/code-block title="إدراج النجوم والرايات - Python via .NET" offSpacer="" %}}
