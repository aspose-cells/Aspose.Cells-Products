---
title:  Fügen Sie ComboBox (Formularsteuerelement) mit Python via Java in Excel ein
weight: 20
description: Python via Java-Quellcode zum Einfügen von ComboBox (Formularsteuerelement) in Excel.
---
...
{{% blocks/products/pf/agp/content h2="So fügen Sie ComboBox (Formularsteuerelement) mit Python via Java in eine Excel-Datei ein" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Einfügen einer ComboBox (Formularsteuerung) in eine Excel-Datei mit Python via Java" %}}
...
+ Wählen Sie Arbeitsblatt über seinen Index aus.
 + Verwenden Sie die Formsammlungen[Methode hinzufügen](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addComboBox(int,%20int,%20int,%20int,%20int,%20int)), um eine ComboBox (Formularsteuerelement) in das ausgewählte Arbeitsblatt einzufügen.
...
{{% blocks/products/pf/agp/code-block title="ComboBox einfügen (Formularsteuerung) – Python via Java" offSpacer="" %}}
