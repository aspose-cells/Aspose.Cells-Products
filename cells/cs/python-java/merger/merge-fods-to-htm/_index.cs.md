---
title: Sloučit FODS na HTM – Sloučit FODS na HTM v Python
url: /cs/python-java/merger/merge-fods-to-htm/ 
description: Aspose Excel. Python Aspose.Cells. Sloučit FODS do formátu uložení HTM. Python Zkombinujte FODS do formátu HTM. Sloučit FODS na HTM v Python. FODS Sloučit.
...
{{% cells-merger title="Ukázkový kód pro sloučení FODS do HTM v Python" InputFormat="fods" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit FODS do HTM přes Python" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit FODS do HTM programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
