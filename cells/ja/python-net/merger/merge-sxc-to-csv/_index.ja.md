---
title:  SXC を Python 経由で CSV に結合
url: /ja/python-net/merger/merge-sxc-to-csv/ 
description: SXC を CSV にオンラインで無料で結合します。無料オンラインSXCからCSV合併。 SXC を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、SXC を Python の CSV にマージする方法を示しています。
...
{{% cells-merger title="オンラインでSXCをCSVにマージする無料アプリ" InputFormat="sxc" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
