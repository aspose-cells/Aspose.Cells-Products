...
L'esempio seguente mostra come unire XLSX a JPG in Aspose.Cells for Python via .NET.
...
Devi unire XLSX a JPG a livello di programmazione? Un documento di base che si fonde e si concatena con[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Le API possono essere eseguite con poche righe di codice.
