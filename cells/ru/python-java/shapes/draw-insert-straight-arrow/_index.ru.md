...
{{% blocks/products/pf/agp/content h2="Как вставить прямую стрелку в файл Excel, используя Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги, чтобы вставить прямую стрелку в файл Excel, используя Python via Java" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте коллекцию форм[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить прямую стрелку в выбранный рабочий лист.
...
{{% blocks/products/pf/agp/code-block title="Вставка прямая стрелка - Python via Java" offSpacer="" %}}
