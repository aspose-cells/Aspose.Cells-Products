---
title: C# FODS в MHT - FODS в MHT Конвертер
description: Aspose Эксель. Преобразуйте FODS в MHT быстро и легко с помощью Aspose.Cells. C# FODS в MHT. C# Сохраните FODS в MHT. Сохраните FODS как MHT, используя C#.
...
В следующем примере показано, как преобразовать FODS в MHT в C#.
...
{{% cells-convert title="Пример кода для преобразования FODS в MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Как конвертировать FODS в MHT через C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы FODS в MHT? Разработчики .NET могут легко загрузить и преобразовать FODS в MHT всего за несколько строк кода.
