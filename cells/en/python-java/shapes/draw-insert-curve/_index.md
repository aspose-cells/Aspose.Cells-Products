---
title: How to draw or insert curved shape into Excel using Python via Java
weight: 10
...
{{% blocks/products/pf/agp/content h2="How to Insert curved shape into Excel File Using Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert curved shape to Excel file using Python via Java" %}}
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) to insert a curved shape in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert curved shape - Python via Java" offSpacer="" %}}
