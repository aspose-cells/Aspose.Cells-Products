---
title: C# صورة إلى صورة - صورة لتحويل صورة
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C# نهجًا متكاملًا تمامًا لتحويل تنسيق IMAGE إلى تنسيق IMAGE، مما يتيح حفظ بيانات IMAGE بسلاسة في تنسيق IMAGE باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C# فعال وقابل للتخصيص.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في C#" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى IMAGE في C#.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى IMAGE عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى IMAGE برمجياً؟ يمكن للمطورين .NET تحميل وتحويل IMAGE إلى IMAGE بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الصورة إلى صورة عن طريق استدعاء طريقة Workbook.Save.
1.  احصل على نتيجة تحويل IMAGE إلى IMAGE.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة رقم C# لتحويل الصور إلى صور" %}}
