---
title: Wstaw komentarze do pliku ODS pod numerem Python
url: /pl/python-java/comments/insert-comments-to-ods/ 
description: Wstaw komentarze pod numerem ODS, używając numeru Python. Użyj przykładowego kodu API, aby wstawić komentarze w aplikacji Python.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić komentarze w pliku ODS poprzez Python" %}}
...
Office 365 komentarze służą do rozmów, możesz użyć następującego kodu Python, aby wstawiać i usuwać komentarze w pliku ODS.
...
{{% cells-annotation title="Bezpłatna aplikacja do usuwania adnotacji z pliku ODS" InputFormat="ods" IsLandingPage="true" language="python" %}}
