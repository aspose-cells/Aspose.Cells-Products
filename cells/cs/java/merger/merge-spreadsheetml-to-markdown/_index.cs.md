---
title: Sloučit SPREADSHEETML s MARKDOWN - Sloučit SPREADSHEETML s MARKDOWN v Java
url: /cs/java/merger/merge-spreadsheetml-to-markdown/ 
description: Aspose Excel. Java Aspose.Cells. Zdarma online sloučit SPREADSHEETML do formátu uložení MARKDOWN. Java Zkombinujte SPREADSHEETML do formátu MARKDOWN. Sloučit SPREADSHEETML na MARKDOWN v Java. SPREADSHEETML Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit SPREADSHEETML na MARKDOWN v Java online zdarma" %}}

Následující příklad ukazuje, jak sloučit SPREADSHEETML do MARKDOWN v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení SPREADSHEETML do MARKDOWN. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru MARKDOWN. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí SPREADSHEETML do MARKDOWN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení SPREADSHEETML na MARKDOWN v Java" InputFormat="xml" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit SPREADSHEETML do MARKDOWN via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit SPREADSHEETML do MARKDOWN? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java ke sloučení SPREADSHEETML do MARKDOWN" %}}
