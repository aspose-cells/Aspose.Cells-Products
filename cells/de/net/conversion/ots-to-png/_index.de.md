---
title: C# OTS zu PNG - Online OTS zu PNG Konverter
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# OTS in PNG Saveformat konvertieren. C# OTS zum PNG-Format. Speichern Sie OTS unter PNG C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie OTS unter PNG in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie OTS in C# in PNG konvertiert wird.
...
Müssen Sie OTS-Dateien programmgesteuert in PNG konvertieren? .NET-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in PNG konvertieren.
...
1.  Konvertieren Sie OTS in PNG, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in PNG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von OTS in PNG" %}}
