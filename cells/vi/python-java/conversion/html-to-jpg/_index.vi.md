---
title: Chuyển đổi HTML sang JPG qua Python

description: Mã mẫu để chuyển đổi html sang jpg Python. Sử dụng API mã mẫu cho hàng loạt tệp html sang chuyển đổi jpg trong ứng dụng Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi HTML sang JPG qua Python" h2="Xuất bảng tính Excel® sang định dạng JPG bằng Python API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi HTML sang JPG bằng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi HTML sang JPG qua Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python các nhà phát triển có thể dễ dàng tải và chuyển đổi các tệp HTML sang JPG chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp HTML với một phiên bản của Workbook1. Gọi phương thức Workbook.Save1. Chuyển đường dẫn đầu ra với phần mở rộng JPG làm tham số1. Kiểm tra đường dẫn được chỉ định cho tệp JPG kết quả
...
{{% cells-convert title="Ứng dụng miễn phí và mã mẫu để chuyển đổi HTML sang JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="jpg" IsLandingPage="true" language="python" %}}
