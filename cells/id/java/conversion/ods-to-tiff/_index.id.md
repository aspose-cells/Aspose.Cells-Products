...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi ODS ke TIFF Menggunakan Java" %}}

 Untuk merender ODS ke TIFF, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi ODS ke TIFF melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file ODS ke TIFF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file ODS dengan instance Workbook1. Pilih default atau Lembar Kerja apa pun dari koleksi1. Buat & atur objek ImageOrPrintOptions1. Buat SheetRender dengan objek Worksheet & ImageOrPrintOptions1. Panggil metode SheetRender.toImage untuk menyimpan hasil dalam format TIFF
...
{{% blocks/products/pf/agp/code-block title="ODS ke TIFF Java Kode Sumber Konversi" offSpacer="" %}}
