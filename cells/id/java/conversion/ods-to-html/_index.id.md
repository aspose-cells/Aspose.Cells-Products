---
title: Konversikan ODS ke HTML melalui Java 
weight: 1560
url: /id/java/conversion/ods-to-html/ 
description: Contoh Java kode konversi untuk format ODS ke file HTML. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke HTML dalam Aplikasi berbasis Web atau Desktop Java apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan ODS ke HTML melalui Java" h2="ODS ke HTML Java konversi untuk mengonversi satu atau beberapa laman ke HTML menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi ODS ke HTML Menggunakan Java" %}}

 Untuk merender ODS ke HTML, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi ODS ke HTML melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file ODS ke HTML hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file ODS dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi HTML & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file HTML yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="ODS ke HTML Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file ODS dalam instance Workbook
Workbook book = new Workbook("template.ods");
// simpan ODS sebagai HTML
