...
weight: 90
description: C# kod źródłowy umożliwiający wstawienie paska przewijania do programu Excel w platformie .NET Framework, .NET Core, Mono lub platformach Xamarin.
...
{{% blocks/products/pf/agp/content h2="Jak wstawić pasek przewijania do pliku Excel przy użyciu numeru C#" %}}

 Aby wstawić ScrollBar do pliku Excel, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić pasek przewijania do pliku Excel za pomocą C#" %}}
