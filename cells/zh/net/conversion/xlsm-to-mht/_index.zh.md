---
title: C# XLSM 转 MHT - 在线 XLSM 转 MHT 转换器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免费在线 C# 将 XLSM 转换为 MHT 保存格式。 C# XLSM 为 MHT 格式。将 XLSM 保存到 MHT C#。
...
{{% blocks/products/pf/agp/content h2="免费在线将 XLSM 保存到 C# 中的 MHT" %}}
...
{{% cells-convert title="免费应用程序和示例代码可在线将 XLSM 转换为 MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="mht" IsLandingPage="true" %}}
