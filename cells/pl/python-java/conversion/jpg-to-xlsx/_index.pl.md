...
description: Aspose Excel. Konwertuj JPG na XLSX szybko i łatwo za pomocą Aspose.Cells. Python JPG na XLSX. Python Zapisz JPG na XLSX. Zapisz JPG jako XLSX używając Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj JPG na XLSX w Python" h2="Szybka biblioteka Python do konwersji JPG na XLSX. Jest to profesjonalne oprogramowanie do importowania i eksportowania JPG, XLSX i wielu innych formatów przy użyciu Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Konwertuj JPG na XLSX za pomocą Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz JPG pod numerem XLSX w Python" %}}

Poniższy przykład pokazuje, jak przekonwertować JPG na XLSX w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji JPG na XLSX" %}}
