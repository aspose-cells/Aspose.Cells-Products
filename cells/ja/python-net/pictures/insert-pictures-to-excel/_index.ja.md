---
title:  Python via .Net を使用して Excel に画像を挿入します
weight: 200
description: Python via Excel に画像を挿入するための .Net ソース コード。
...
{{% blocks/products/pf/agp/content h2="Python via .Net を使用して Excel ファイルに画像を挿入する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .Net を使用して Excel ファイルに画像を挿入する手順" %}}
...
+ インデックスからワークシートを選択します。
 画像コレクションの追加を使用します[方法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/picturecollection/)選択したワークシートに画像を挿入します。
...
{{% blocks/products/pf/agp/code-block title="画像を挿入 - Python via .Net" offSpacer="" %}}
