...
url: /it/net/merger/merge-numbers-to-jpg/ 
...
L'esempio seguente dimostra come unire NUMBERS in JPG in Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Hai bisogno di unire NUMBERS in JPG a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Libreria .NET per unire i NUMERI in JPG" %}}
