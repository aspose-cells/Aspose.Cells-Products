---
title: Δημιουργία MHT - Δημιουργία αρχείου MHT στο Java
description:  Aspose Excel. Java Δημιουργήστε αρχείο MHT γρήγορα και εύκολα με το Aspose.Cells. Δημιουργήστε αρχείο MHT χρησιμοποιώντας το Java. Δημιουργήστε MHT στο Java. Java MHT Creater.
...
{{< blocks/products/pf/i18n/upper-banner h1="Δημιουργήστε αρχείο MHT στο Java" h2="Βιβλιοθήκη υψηλής ταχύτητας Java για τη δημιουργία αρχείου MHT. Αυτή είναι μια επαγγελματική λύση λογισμικού για εισαγωγή και εξαγωγή XLSX, PDF και πολλών άλλων μορφών χρησιμοποιώντας το Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να δημιουργήσετε MHT στο Java" %}}
...
1.  Αποθηκεύστε το βιβλίο εργασίας ως μορφή MHT χρησιμοποιώντας τη μέθοδο save().

{{% blocks/products/pf/agp/code-block title="Το δείγμα κώδικα δείχνει πώς να δημιουργήσετε αρχείο MHT στο Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java βιβλιοθήκη για τη δημιουργία αρχείου MHT" %}}
{{% blocks/products/pf/agp/text %}}
