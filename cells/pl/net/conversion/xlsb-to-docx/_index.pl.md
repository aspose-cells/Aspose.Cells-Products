---
title: Konwertuj XLSB na DOCX przez C#
url: /pl/net/conversion/xlsb-to-docx/
description: Przykładowy kod konwersji xlsb do docx C#. Użyj przykładowego kodu API dla plików wsadowych xlsb do konwersji docx w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na DOCX za pomocą C#" %}}

 Aby przekonwertować XLSB na DOCX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLSB na DOCX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki XLSB do formatu DOCX w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSB z instancją Workbook1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem DOCX jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku DOCX
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLSB na DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="docx" IsLandingPage="true" %}}
