---
title: Combinar XLSM a PPTX - Combinar XLSM a PPTX en Java
url: /es/java/merger/merge-xlsm-to-pptx/ 
description: AsposeExcel. Java Aspose.Cells. Combinar gratis en línea XLSM a PPTX guardar formato. Java Combina el formato XLSM con el PPTX. Combinar XLSM a PPTX en Java. XLSM Combinar.
...
El siguiente ejemplo muestra cómo combinar XLSM con PPTX en Aspose.Cells for Java.
...
{{% cells-merger title="Gratis en línea para fusionar XLSM a PPTX en Java" InputFormat="xlsm" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLSM a PPTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLSM con PPTX mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
