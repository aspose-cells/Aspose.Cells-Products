---
title: Odblokuj dokument XLSX przez C++ 
weight: 3680
url: /pl/cpp/unlock/xlsx/ 
description: C++ przykładowy kod odblokowujący chroniony hasłem plik XLSX w C++ środowisku wykonawczym dla 32-bitowego systemu Windows, 64-bitowego systemu Windows i 64-bitowego systemu Linux.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Odblokuj pliki XLSX przez C++" h2="Usuń ochronę z arkuszy kalkulacyjnych Excel, w tym z pliku XLSX, korzystając z C++Biblioteki." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1. Załaduj zablokowany plik XLSX za pomocą CreateIWorkbook.1. Wywołaj funkcję Unprotect(), aby odblokować.1. Ustaw hasło na NULL za pomocą SetPassword.1. Zapisz plik XLSX w określonej lokalizacji.
