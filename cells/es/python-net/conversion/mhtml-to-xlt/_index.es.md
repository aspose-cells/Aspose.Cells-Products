...
description: Aspose Excel. Convierta MHTML a XLT rápida y fácilmente con Aspose.Cells. Python MHTML a XLT. Python Guarde MHTML en XLT. Guarde MHTML como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar MHTML al XLT en Python" %}}

El siguiente ejemplo demuestra cómo convertir MHTML a XLT en Python via NET.
...
{{% cells-convert title="Código de muestra para convertir MHTML a XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="xlt" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir MHTML en XLT" %}}
