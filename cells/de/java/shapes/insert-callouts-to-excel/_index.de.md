...
{{< blocks/products/pf/i18n/upper-banner h1="Callouts in Excel einfügen via Java" h2="Fügen Sie Objekte über serverseitige APIs ohne Software wie Microsoft oder Open Office, Adobe PDF usw. ein." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="So fügen Sie Callouts mithilfe von Java in eine Excel-Datei ein" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Einfügen von Callouts in die Excel-Datei via Java" %}}
...
Der folgende Beispielcode zeigt, wie eine „Gedankenblase: Wolke“ eingefügt wird. Weitere Typen finden Sie unten im Abschnitt „Übersicht über Block-Callout-Typen“.

{{% blocks/products/pf/agp/code-block title="Callouts einfügen – Java" offSpacer="" %}}
