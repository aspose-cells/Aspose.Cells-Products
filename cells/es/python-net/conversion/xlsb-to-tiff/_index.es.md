...
description: Aspose Excel. Convierta XLSB a TIFF rápida y fácilmente con Aspose.Cells. Python XLSB a TIFF. Python Guarde XLSB en TIFF. Guarde XLSB como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLSB al TIFF en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSB a TIFF en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSB en TIFF" %}}
