...
{{% blocks/products/pf/agp/content h2="如何通過Python在XLSB文件中插入註釋" %}}
...
在 Office 365 中，評論是用於對話的，您可以使用以下 Python 代碼在 XLSB 文件中插入和刪除評論。
...
{{% cells-annotation title="從 XLSB 文件中刪除註釋的免費應用程序" InputFormat="xlsb" IsLandingPage="true" language="python" %}}
