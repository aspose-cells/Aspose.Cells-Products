---
title: XLSB을 OTS에 병합 - Java에서 XLSB을 OTS에 결합
url: /ko/java/merger/merge-xlsb-to-ots/ 
description: Aspose 엑셀. Java Aspose.Cells. XLSB을 OTS 저장 형식에 병합합니다. Java XLSB을 OTS 형식으로 결합합니다. Java에서 XLSB을 OTS에 병합합니다. XLSB 병합.
keywords: [Aspose Excel., Java Aspose.Cells., Merge XLSB to OTS in Java., Java Merge XLSB to ots., Java Combine XLSB to OTS., XLSB Merge]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB을 OTS via Java에 병합" h2="XLSB을 OTS에 병합하기 위한 고속 Java 라이브러리입니다. Excel 변환 API을 사용하여 Java에서 플랫폼 독립적인 높은 수준의 소프트웨어를 개발하십시오. 이는 Excel, CSV, OpenOffice, PDF, HTML, image 및 기타 여러 Excel 형식을 가져오고 내보내는 전문 소프트웨어 솔루션입니다." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="XLSB" additionalConversionTag="OTS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 XLSB을 OTS에 병합" %}}
...
{{% blocks/products/pf/agp/content h2="Java에서 XLSB을 OTS에 병합" %}}

다음 예에서는 XLSB을 Aspose.Cells for Java의 OTS에 병합하는 방법을 보여줍니다.
{{% blocks/products/pf/agp/text %}}

XLSB을 OTS에 병합하는 쉬운 단계를 따르세요. 파일을 업로드하고 파일 병합을 위해 Workbook.Combine 메서드를 호출한 다음 OTS 파일에 저장합니다. Java에서 코드를 개발하면 생각보다 간단해질 것입니다. XLSB을 OTS에 병합하는 Java 예를 참조하세요.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="XLSB을 Java의 OTS에 병합하는 샘플 코드" InputFormat="xlsb" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="XLSB을 OTS via Java에 병합하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

 프로그래밍 방식으로 XLSB을 OTS에 병합해야 합니까? 병합하고 연결하는 기본 문서[Aspose.Cells for Java](https://products.aspose.com/cells/java) 단 몇 줄의 코드만으로 API를 구현할 수 있습니다.
...
{{% blocks/products/pf/agp/content h2="Java 라이브러리를 OTS에 병합하기 위한 XLSB" %}}
