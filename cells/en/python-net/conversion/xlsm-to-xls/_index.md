...
url: /python-net/conversion/xlsm-to-xls/
description: Sample code for xlsm to xls Python conversion. Use API example code for batch xlsm files to xls conversion within Python application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XLSM to XLS via Python" h2="Export Excel spreadsheets to XLS format using Python APIs." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert XLSM to XLS Using Python" %}}

 In order to convert XLSM to XLS, we will use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XLSM to XLS via Python" %}}
...
{{% cells-convert title="Free App and Sample Code to Convert XLSM to XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xls" IsLandingPage="true" language="python" %}}
