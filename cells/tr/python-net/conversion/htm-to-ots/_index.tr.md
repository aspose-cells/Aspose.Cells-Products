...
description: Aspose Excel'de. Aspose.Cells ile HTM'yi hızlı ve kolay bir şekilde OTS'ye dönüştürün. Python HTM'den OTS'ye. Python HTM'yi OTS'ye kaydedin. Python'i kullanarak HTM'yi OTS olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="Python\'de HTM\'yi OTS\'ye dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="HTM\'yi Python\'de OTS\'ye kaydedin" %}}

Aşağıdaki örnek, Python via NET'de HTM'nin OTS'ye nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="HTM\'yi OTS\'ye Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="ots" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="HTM\'yi OTS\'ye dönüştürmek için Python kitaplığı" %}}
