...
{{% blocks/products/pf/agp/content h2="Sla FODS op in XLTX in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar XLTX in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar XLTX of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar XLTX? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar XLTX met slechts een paar regels code.
