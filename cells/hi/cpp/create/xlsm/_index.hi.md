...
{{% blocks/products/pf/agp/text %}}
 ...
 डेवलपर्स के लिए कोड की कुछ पंक्तियों में डेटा प्रोसेसिंग के लिए चल रहे रिपोर्टिंग एप्लिकेशन के भीतर XLSM फ़ाइलों को बनाना, लोड करना, संशोधित करना और परिवर्तित करना आसान है।
...
1.  Save() विधि का उपयोग करके कार्यपुस्तिका को .xlsm फ़ाइल के रूप में सहेजें।
