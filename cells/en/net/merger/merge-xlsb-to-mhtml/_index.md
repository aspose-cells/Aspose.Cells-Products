...
description: C# source code to combine XLSB to MHTML file on .NET, .NET Core, Mono or Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/code-block title="Merge XLSB to MHTML Files - C#" offSpacer="" %}}
