---
title: Преобразователь C# FODS в ODS - FODS в ODS
description: Aspose Эксель. Преобразуйте FODS в ODS быстро и легко с помощью Aspose.Cells. C# FODS в ODS. C# Сохранить FODS в ODS. Сохранить FODS как 07611134 81, используя C#.
...
{{% blocks/products/pf/agp/content h2="Сохраните с FODS по ODS в C#." %}}
...
{{% cells-convert title="Пример кода для преобразования FODS в ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Как преобразовать FODS в ODS через C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы FODS в ODS? Разработчики .NET могут легко загрузить и преобразовать FODS в ODS всего за несколько строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования FODS в ODS" %}}
