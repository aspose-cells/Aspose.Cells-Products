...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الصورة إلى MHT في C#" h2="مكتبة C# عالية السرعة لتحويل الصور إلى صيغة MHT. هذا حل برمجي احترافي لاستيراد وتصدير الصور وصيغ MHT والعديد من الصيغ الأخرى على منصات .NET Framework و.NET Core وMono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="IMAGE" >}}
...
{{% cells-convert title="نموذج كود لتحويل صورة إلى MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="png" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل الصورة إلى صيغة MHT عبر الرقم C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات الصور إلى صيغة MHT برمجيًا؟ يمكن للمطورين (.NET) تحميل ملفات الصور وتحويلها إلى صيغة MHT بسهولة في بضعة أسطر من التعليمات البرمجية فقط.
...
1.  قم بتحويل الصورة إلى MHT عن طريق استدعاء طريقة Workbook.Save.
