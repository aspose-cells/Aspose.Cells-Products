---
title: C# XLSX a ODS - XLSX a ODS Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter XLSX para o formato ODS, permitindo o salvamento perfeito de dados XLSX no formato ODS usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve XLSX a ODS em C#" %}}

exemplo a seguir demonstra como converter XLSX em ODS em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter XLSX em ODS. Carregue seu arquivo XLSX e simplesmente salve-o como arquivo ODS. Para leitura de XLSX e gravação de ODS, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação da saída ODS serão idênticos ao documento XLSX original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de exemplo para converter XLSX em ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLSX em ODS por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLSX em ODS programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter XLSX em ODS em apenas algumas linhas de código.
...
1.  Converta XLSX para ODS chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de XLSX para ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter XLSX em ODS" %}}
