...
description: Aspose Эксель. Python Aspose.Cells. Объедините HTML и XLSX в формате сохранения. Python Объедините форматы HTML и XLSX. Объедините HTML и XLSX в Python. HTML Объедините.
...
{{% blocks/products/pf/agp/content h2="Объедините HTML с XLSX, используя Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объедините HTML и XLSX в Python." %}}

В следующем примере показано, как объединить HTML и XLSX в Aspose.Cells for Python via Java.
