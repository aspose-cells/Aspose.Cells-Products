---
title: Insert Oval into Excel via Java 
weight: 40
...
{{% blocks/products/pf/agp/content h2="How to Insert Oval into Excel File Using Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Oval to Excel file via Java" %}}
...
+  Use the [add method](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addOval-int-int-int-int-int-int-) to insert Oval in the selected worksheet
