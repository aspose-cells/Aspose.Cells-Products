---
title: Połącz CSV z ETT - Połącz CSV z ETT w Java
url: /pl/java/merger/merge-csv-to-ett/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online CSV do formatu zapisu ETT. Java Połącz CSV z formatem ETT. Połącz CSV z ETT w Java. CSV Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz CSV z ETT w Java online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć CSV z ETT w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć numer CSV z ETT. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku ETT. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy CSV z ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online CSV z ETT w Java" InputFormat="csv" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć CSV z ETT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo połączyć numer CSV z ETT? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do połączenia CSV z ETT" %}}
