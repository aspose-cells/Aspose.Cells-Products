---
title:  Combinar TSV a MHT via Java
url: /es/java/merger/merge-tsv-to-mht/ 
description: Combine TSV con MHT en línea de forma gratuita. Gratis en línea TSV para la fusión de MHT. Combine TSV con Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo combinar TSV con MHT en Java.
...
{{% cells-merger title="Aplicación gratuita para fusionar TSV a MHT en línea" InputFormat="tsv" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
