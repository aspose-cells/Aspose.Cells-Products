...
Het volgende voorbeeld laat zien hoe u XLTM converteert naar DOCX in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Hoe XLTM naar DOCX te converteren" %}}
