...
description: Aspose Excel. Converta XLS em ODS de forma rápida e fácil com Aspose.Cells. C++ XLS em ODS. C++ Salve XLS em ODS. Salve XLS como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Converta XLS em ODS usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve XLS para ODS em C++" %}}

O exemplo a seguir demonstra como converter XLS em ODS em C++.
...
{{% cells-convert title="Exemplo de código para converter XLS em ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="ods" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS em ODS por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS em ODS programaticamente? Os desenvolvedores do C++ podem converter facilmente XLS em ODS em apenas algumas linhas de código.
...
1.  Converta XLS em ODS chamando o método Save().
