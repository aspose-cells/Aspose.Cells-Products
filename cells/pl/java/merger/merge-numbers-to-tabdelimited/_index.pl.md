---
title: Scal NUMBERS do TABDELIMITED - Połącz NUMBERS do TABDELIMITED w Java
url: /pl/java/merger/merge-numbers-to-tabdelimited/ 
description: Aspose Excel. Java Aspose.Cells. Scal NUMBERS do formatu zapisu TABDELIMITED. Java Połącz NUMBERS do formatu TABDELIMITED. Scal NUMBERS do TABDELIMITED w Java. NUMBERS Scal.
...
{{% blocks/products/pf/agp/content h2="Scal NUMBERS do TABDELIMITED w Java" %}}

Poniższy przykład ilustruje sposób scalania NUMBERS z TABDELIMITED w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić NUMBERS z TABDELIMITED. Prześlij swoje pliki, wywołaj metodę Workbook.Combine w celu łączenia plików, a następnie zapisz je w pliku TABDELIMITED. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy NUMBERS z TABDELIMITED.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia NUMBERS do TABDELIMITED w Java" InputFormat="numbers" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić NUMBERS do TABDELIMITED via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić NUMBERS z TABDELIMITED? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do scalania NUMBERS z TABDELIMITED" %}}
