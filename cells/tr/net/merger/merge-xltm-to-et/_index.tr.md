...
{{% blocks/products/pf/agp/content h2="XLTM\'i C#\'deki ET ile birleştir" %}}

Aşağıdaki örnek, XLTM'in Aspose.Cells for .NET'deki ET ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="XLTM\'i C#\'de ET ile Birleştirmek için Örnek Kod" InputFormat="xltm" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="XLTM\'i C# aracılığıyla ET\'ye nasıl birleştiririm?" %}}

{{% blocks/products/pf/agp/text %}}

 XLTM'i programlı olarak ET ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET kütüphanesi, XLTM\'i ET ile birleştirecek" %}}
