...
description: Aspose Excel. C++ Utwórz plik SVG szybko i łatwo za pomocą Aspose.Cells. Wygeneruj plik SVG za pomocą C++. Utwórz SVG w C++. C++ SVG Kreator.
...
1.  Zapisz skoroszyt jako plik .svg, korzystając z metody Save().
