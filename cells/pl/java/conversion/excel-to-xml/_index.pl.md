...
{{% blocks/products/pf/agp/content h2="Zapisz plik EXCEL do pliku XML w Java" %}}

Poniższy przykład pokazuje, jak przekonwertować plik EXCEL na XML w formacie Java.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować plik EXCEL na XML via Java" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki EXCEL na XML? Programiści Java mogą łatwo przekonwertować pliki EXCEL na XML za pomocą zaledwie kilku linijek kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do konwersji EXCELA do XML" %}}
{{% blocks/products/pf/agp/text %}}
