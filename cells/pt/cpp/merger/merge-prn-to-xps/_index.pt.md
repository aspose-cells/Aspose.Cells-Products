---
title: Mesclar PRN para XPS - Combine PRN para XPS em C++
url: /pt/cpp/merger/merge-prn-to-xps/ 
description: Aspose Excel. C++ Aspose.Cells. Mesclar PRN online grátis para XPS saveformat. C++ Combine PRN para o formato XPS. Mesclar PRN para XPS em C++. Mesclar PRN.
...
{{% blocks/products/pf/agp/content h2="Mesclar PRN para XPS em C++ online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar PRN para XPS em Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar o PRN em XPS. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo XPS. Se você desenvolver o código em C++, isso será mais simples do que parece. Consulte o exemplo C++ que mescla PRN com XPS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar PRN para XPS em C++" InputFormat="prn" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar PRN para XPS via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa mesclar PRN para XPS programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para mesclar PRN para XPS" %}}
