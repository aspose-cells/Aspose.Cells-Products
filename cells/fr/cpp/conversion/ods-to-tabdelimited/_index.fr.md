---
title: Convertir ODS en TABDELIMITED via l'application C++ 

description: Exemple de code de conversion C++ pour le document ODS au format TABDELIMITED. Les programmeurs peuvent utiliser ce code source pour la conversion par lots d'ODS en TABDELIMITED dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir ODS en TABDELIMITED via C++" h2="Conversion ODS vers TABDELIMITED haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir ODS en TABDELIMITED en utilisant C++" %}}
 ...
 Pour convertir ODS en TABDELIMITED, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs C++ peuvent facilement convertir le fichier ODS en TABDELIMITED en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier ODS à l'aide de Factory :: CreateIWorkbook.1. Appelez la méthode Save().1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (TABDELIMITED).1. Le fichier TABDELIMITED sera enregistré dans le chemin spécifié.1. Ouvrez le fichier TABDELIMITED dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="ODS à TABDELIMITED C++ code source de conversion" offSpacer="" %}}
