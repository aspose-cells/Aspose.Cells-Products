...
{{% blocks/products/pf/agp/content h2="Comment débloquer un fichier XLSX à l\'aide de C#" %}}
...
// instancier un objet Workbook avec un fichier XLSX protégé
...
// enregistrer le résultat au format XLSX
