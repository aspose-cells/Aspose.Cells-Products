...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells makes it easy for the developers to load & convert FODS files to PNG in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows FODS to PNG C# Conversion" offSpacer="" %}}

```cs
// load the FODS file to be rendered
var workbook = new Aspose.Cells.Workbook("sourceFile.fods");
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert FODS to PNG" sectionDescription="Check our live demos for [FODS to PNG conversion](https://products.aspose.app/cells/conversion/fods-to-png) with following benefits." >}}
