...
description: Aspose Excel. Python Aspose.Cells. Mesclar HTML com XLS salvar formato. Python Combine o formato HTML com XLS. Mesclar HTML a XLS em Python. HTML Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar HTML com XLS usando Python" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar HTML com XLS em Python" %}}

O exemplo a seguir demonstra como mesclar HTML com XLS em Aspose.Cells for Python via Java.
