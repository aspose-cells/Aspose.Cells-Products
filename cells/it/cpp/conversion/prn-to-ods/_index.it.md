...
È necessario convertire i file PRN in ODS a livello di codice? Gli sviluppatori di C++ possono convertire facilmente il PRN in ODS in poche righe di codice.
...
1.  Converti PRN in ODS chiamando il metodo Save().
