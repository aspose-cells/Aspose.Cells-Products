---
title: PHP EXCEL en JPG - Convertisseur EXCEL en JPG
description: Aspose Exceller. Convertissez EXCEL en JPG rapidement et facilement avec Aspose.Cells. PHP EXCEL en JPG. PHP Enregistrez EXCEL au format JPG. Enregistrez EXCEL au format JPG en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en JPG via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en JPG par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en JPG en quelques lignes de code.
...
1. Convertissez EXCEL en JPG en appelant la méthode de sauvegarde du classeur.
1. Obtenez le résultat de la conversion d’EXCEL en JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir EXCEL en JPG" %}}
