---
title: Gộp MHTML vào XLTX - Gộp MHTML vào XLTX vào C#
url: /vi/net/merger/merge-mhtml-to-xltx/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất MHTML thành XLTX saveformat. C# Kết hợp định dạng MHTML thành XLTX. Hợp nhất MHTML thành XLTX vào C#. MHTML Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất MHTML thành XLTX vào C#" %}}

Ví dụ sau đây minh họa cách hợp nhất MHTML với XLTX trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất MHTML thành XLTX. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu nó vào tệp XLTX. Nếu bạn phát triển mã bằng C#, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất MHTML thành XLTX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu gộp MHTML thành XLTX trong C#" InputFormat="mhtml" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách gộp MHTML vào XLTX qua C#" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET gộp MHTML thành XLTX" %}}
