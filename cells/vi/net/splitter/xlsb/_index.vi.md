...
weight: 7370
description: Mã nguồn C# để phân chia XLSB tài liệu trên .NET Framework, .NET Core, Mono hoặc Xamarin Platforms.
...
{{< blocks/products/pf/i18n/upper-banner h1="Chia XLSB Định dạng C#" h2="Bộ chia XLSB gốc và hiệu suất cao sử dụng API phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước tách file XLSB trong C#" %}}
...
+ Load file XLSB đầy đủ đường dẫn chia tách.
...
+ Gọi phương thức Save() và truyền tên file (đường dẫn đầy đủ) và tham số SaveFormat.Xlsb.
...
{{% blocks/products/pf/agp/code-block title="Tách XLSB File - C#" offSpacer="" %}}
