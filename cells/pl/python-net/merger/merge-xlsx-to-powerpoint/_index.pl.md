---
title:  Połącz XLSX z POWERPOINT przez Python
...
Poniższy przykład pokazuje, jak scalić XLSX z POWERPOINT w Python.
...
{{% cells-merger title="Bezpłatna aplikacja do łączenia XLSX z POWERPOINT on-line" InputFormat="xlsx" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
