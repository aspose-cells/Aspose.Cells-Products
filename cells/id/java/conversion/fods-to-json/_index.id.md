...
description: Aspose Excel. Solusi komprehensif ini menyediakan Java pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi FODS ke format JSON, memungkinkan penyimpanan data FODS ke format JSON dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode Java yang efisien dan dapat disesuaikan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan FODS menjadi JSON di Java" h2="Pustaka berkecepatan tinggi Java untuk mengkonversi FODS ke JSON. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor FODS, JSON, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Konversikan FODS ke JSON menggunakan Java" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan FODS ke JSON di Java" %}}

Contoh berikut menunjukkan cara mengkonversi FODS menjadi JSON di Java.
...
Perlu mengkonversi file FODS ke JSON secara terprogram? Pengembang Java dapat dengan mudah mengkonversi FODS ke JSON hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi FODS menjadi JSON" %}}
{{% blocks/products/pf/agp/text %}}
