...
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online XLT do formatu zapisu HTM. Java Połącz XLT do formatu HTM. Połącz XLT z HTM w Java. XLT Połącz.
...
Poniższy przykład pokazuje, jak scalić XLT z HTM w Aspose.Cells for Java.
...
{{% cells-merger title="Bezpłatne połączenie online XLT z HTM w Java" InputFormat="xlt" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić XLT z HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo scalić numer XLT z HTM? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/java/merger/merge-xlt-to-svg/" name="Połącz XLT z SVG" description="Skalowalna Grafika wektorowa" >}}
