---
title:  Sisipkan Gambar ke dalam Excel melalui Python
weight: 200
description: Python kode sumber untuk menyisipkan Gambar ke dalam Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Sisipkan Gambar ke dalam Excel melalui Python" h2="Sisipkan objek menggunakan API sisi server tanpa perangkat lunak apa pun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Memasukkan Gambar ke File Excel Menggunakan Python" %}}

 Untuk menyisipkan Gambar ke dalam file excel, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah memasukkan file Gambar ke Excel melalui Python" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan koleksi gambar[menambahkan metode](https://reference.aspose.com/cells/java/com.aspose.cells/picturecollection#add(int,%20int,%20int,%20int,%20java.lang.String)) untuk menyisipkan Gambar di lembar kerja yang dipilih.
...
{{% blocks/products/pf/agp/code-block title="Sisipkan Gambar - Python" offSpacer="" %}}
