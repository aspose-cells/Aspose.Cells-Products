...
+ الآن يمكنك فتح واستخدام ملف TSV في Microsoft Office أو Adobe PDF أو أي برنامج آخر متوافق.
...
{{% blocks/products/pf/agp/code-block title="دمج TSV الملفات - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "d7c757e7471bd38006ac0d35d221b2e2" "merge-tsv-files.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{< blocks/products/pf/agp/demobox sectionTitle="عبر الإنترنت TSV عروض توضيحية مباشرة للاندماج" sectionDescription=" دمج وثائق TSV الآن من خلال زيارة موقعنا[موقع تجريبي مباشر](https://products.aspose.app/cells/merger). يحتوي العرض التوضيحي المباشر على الفوائد التالية" >}}
