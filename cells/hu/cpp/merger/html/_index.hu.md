---
title:  Egyesítse a HTML fájlokat a C++ számon keresztül
description: C++ példakód a HTML dokumentum kombinálásához a C++ futásidejű környezet Windows 32 bites, Windows 64 bites és Linux 64 bites számára.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="A HTML formátumok egyesítése a C++-ben" h2="HTML dokumentum-egyesítés kiszolgálóoldali C++ API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="HTML" >}}
...
{{% cells-merger title="Ingyenes alkalmazás Excel-fájlok online egyesítéséhez" InputFormat="html" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;ods;csv;tsv;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
