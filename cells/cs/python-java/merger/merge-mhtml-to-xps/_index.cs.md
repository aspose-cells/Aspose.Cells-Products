---
title:  Sloučit MHTML na XPS přes Python
url: /cs/python-java/merger/merge-mhtml-to-xps/ 
description: Sloučit MHTML až XPS online zdarma. Online zdarma MHTML až XPS Fúze. Sloučit MHTML do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit MHTML až XPS v Python.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení MHTML až XPS online" InputFormat="mhtml" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
