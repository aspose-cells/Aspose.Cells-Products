---
title: Java FODS hingga XLS - FODS hingga XLS Konverter
description: Aspose Unggul. Ubah FODS menjadi XLS dengan cepat dan mudah dengan Aspose.Cells. Java FODS menjadi XLS. Java Simpan FODS menjadi XLS. Simpan FODS sebagai 07611134 81 menggunakan Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah FODS menjadi XLS di Java" h2="Pustaka Java berkecepatan tinggi untuk mengonversi FODS menjadi XLS. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor FODS, XLS, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan FODS hingga XLS di Java" %}}

Contoh berikut menunjukkan cara mengonversi FODS menjadi XLS di Java.
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi FODS menjadi XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file FODS ke XLS secara terprogram? Pengembang Java dapat dengan mudah mengonversi FODS menjadi XLS hanya dalam beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk mengubah FODS menjadi XLS" %}}
{{% blocks/products/pf/agp/text %}}
