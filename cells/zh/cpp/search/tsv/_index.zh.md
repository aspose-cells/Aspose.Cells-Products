---
title: 通过 C++ 搜索 TSV 文档，无需打开
weight: 930
description: C++ 示例代码，用于在 C++ 运行时环境中搜索 TSV 文件中具有模式的单词，适用于 Windows 32 位、Windows 64 位和 Linux 64 位。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="搜索 TSV C++ 中的格式" h2="使用服务器端 Aspose.Cells for C++ API 进行本机高性能 TSV 文档搜索，无需使用 Microsoft 或 Adobe PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="搜索 C++ 中的 TSV 文件的步骤" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="在线 TSV 搜索现场演示" sectionDescription="立即访问我们的 TSV 文档中搜索文本、单词、短语[现场演示网站](https://products.aspose.app/cells/search)。现场演示有以下好处" >}}
