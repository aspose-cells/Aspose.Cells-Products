---
title: Python XLTM až MHTML - XLTM až MHTML Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Python plně integrovaný přístup k převodu formátu XLTM do formátu MHTML, což umožňuje bezproblémové ukládání dat XLTM do formátu MHTML pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Python.
...
{{% blocks/products/pf/agp/content h2="Převeďte XLTM na MHTML v knihovně Excel Python" %}}

 Jak převedu XLTM na MHTML? S Aspose.Cells for Python prostřednictvím knihovny NET můžete snadno převést XLTM na MHTML programově pomocí několika řádků kódu.[Aspose.Cells for Python přes NET](https://pypi.org/project/aspose-cells-python/)je schopen vytvářet multiplatformní aplikace se schopností generovat, upravovat, konvertovat, vykreslovat a tisknout všechny soubory aplikace Excel. Python Excel API nejen převádí mezi tabulkovými formáty, ale umí také vykreslovat soubory Excel jako obrázky, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT a další, takže je perfektní volbou pro výměnu dokumentů ve standardních průmyslových formátech.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Uložit XLTM až MHTML v knihovně Excel Python" %}}

Následující příklad ukazuje, jak převést XLTM na MHTML v knihovně Excel Python.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro převod XLTM na MHTML. Nahrajte svůj soubor XLTM a poté jej jednoduše uložte jako soubor MHTML. Pro čtení XLTM i zápis MHTML můžete použít plně kvalifikované názvy souborů. Výstupní MHTML obsah a formátování bude shodné s původním dokumentem XLTM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Ukázkový kód pro převod XLTM na MHTML prostřednictvím knihovny Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xltm" outformat="mhtml" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLTM na MHTML" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLTM na MHTML programově? Vývojáři Python mohou snadno načíst a převést XLTM na MHTML v několika řádcích kódu.
...
1.  Převeďte XLTM na MHTML voláním metody Workbook.save.
1.  Získejte výsledek převodu XLTM na MHTML.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Python Knihovna Excel pro převod XLTM na MHTML" %}}
