...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte MHTML na ET v C++" h2="Vysoce výkonná konverze MHTML na ET s využitím knihovny C++ bez nutnosti instalace Excelu Microsoft, OpenOffice nebo Adobe Acrobatu." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Potřebujete programově převést soubory MHTML na ET? Vývojáři C++ mohou snadno převést soubory MHTML na ET pomocí několika řádků kódu.
...
1.  Převeďte číslo MHTML na ET voláním metody Save().
