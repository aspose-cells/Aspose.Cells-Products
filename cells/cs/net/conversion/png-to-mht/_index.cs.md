...
description: Aspose Excel. Převeďte PNG na MHT rychle a snadno pomocí Aspose.Cells. C# PNG na MHT. C# Uložte PNG na MHT. Uložte PNG jako MHT pomocí C#.
...
{{% blocks/products/pf/agp/content h2="Uložte PNG na MHT v C#" %}}

Následující příklad ukazuje, jak převést PNG na MHT v C#.
...
{{% cells-convert title="Ukázkový kód pro převod PNG na MHT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="mht" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak převést PNG na MHT přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést PNG soubory na MHT programově? .NET vývojáři mohou snadno načíst a převést PNG na MHT v několika řádcích kódu.
