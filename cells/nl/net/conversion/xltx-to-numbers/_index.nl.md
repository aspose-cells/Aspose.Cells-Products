---
title: C# XLTX naar CIJFERS - XLTX naar CIJFERS Omzetter
...
{{% blocks/products/pf/agp/content h2="Sla XLTX op in de lijst met nummers in C#" %}}

Het volgende voorbeeld laat zien hoe je XLTX omzet naar cijfers in C#.
...
{{% blocks/products/pf/agp/content h2="Hoe zet je XLTX om naar cijfers via C#?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden van het type XLTX programmatisch converteren naar NUMBERS? Ontwikkelaars van .NET kunnen bestanden van het type XLTX eenvoudig laden en converteren naar NUMBERS met slechts een paar regels code.
...
{{% blocks/products/pf/agp/content h2="C# bibliotheek om XLTX naar getallen te converteren" %}}
