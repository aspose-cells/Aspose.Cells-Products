...
{{% blocks/products/pf/agp/content h2="Jak utworzyć XLTM za pośrednictwem C#" %}}
...
1.  Użyj metody Zapisz, aby zapisać skoroszyt jako plik XLTM.

{{% blocks/products/pf/agp/code-block title="Przykładowy kod do tworzenia pliku MS Excel XLTM przy użyciu C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# biblioteka do utworzenia pliku XLTM" %}}
