...
{{% blocks/products/pf/agp/content h2="Преобразовать FODS в XLTX, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в XLTX в C#" %}}
...
1.  Преобразуйте значение FODS в XLTX, вызвав метод Workbook.Save.
