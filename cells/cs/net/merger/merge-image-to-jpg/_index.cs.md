...
url: /cs/net/merger/merge-image-to-jpg/ 
...
Následující příklad ukazuje, jak sloučit IMAGE do JPG v Aspose.Cells for .NET.
...
Potřebujete sloučit IMAGE do JPG programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna pro sloučení IMAGE do JPG" %}}
