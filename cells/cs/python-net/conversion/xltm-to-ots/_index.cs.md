...
description: Aspose Excel. Python Excel. Převeďte XLTM na OTS rychle a snadno pomocí Aspose.Cells. Python XLTM na OTS. Python Uložte XLTM do OTS. Uložte XLTM jako OTS pomocí knihovny Excel Python.
