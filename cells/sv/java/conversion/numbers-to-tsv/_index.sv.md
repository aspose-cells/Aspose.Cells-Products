---
title: Konvertera NUMBERS till TSV via Java 

description: Exempel på Java-konverteringskod för NUMBERS-format till TSV-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till TSV inom alla webb- eller skrivbordsbaserade Javaapplikationer.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du TAL till TSV med Java" %}}

 För att rendera NUMBERS till TSV kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera NUMBERS till TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera NUMBERS-filen till TSV på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda NUMBERS-filen med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med TSV-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande TSV-filen
...
{{% blocks/products/pf/agp/code-block title="NUMBERS till TSV Java omvandlingskällkod" offSpacer="" %}}

```cs
// ladda NUMBERS-filen i en instans av Workbook
Workbook book = new Workbook("template.numbers");
// spara NUMBERS som TSV
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS till TSV Conversion Live Demos" sectionDescription="[Konvertera NUMBERS till TSV](https://products.aspose.app/cells/conversion/numbers-to-tsv) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din NUMBERS-fil, den konverteras omedelbart till TSV." >}}
