---
title: PHP SPREADSHEETML na PRN - Konwerter arkusza kalkulacyjnego na PRN
description: Aspose Excel. Szybko i łatwo przekonwertuj SPREADSHEETML na PRN za pomocą Aspose.Cells. PHP SPREADSHEETML na PRN. PHP Zapisz SPREADSHEETML w PRN. Zapisz SPREADSHEETML jako PRN, używając PHP.
...
{{% cells-convert title="Przykładowy kod do konwersji arkusza kalkulacyjnego na PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="prn" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować arkusz kalkulacyjny na PRN za pomocą PHP" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki SPREADSHEETML na PRN? Programiści PHP mogą łatwo załadować i przekonwertować SPREADSHEETML na PRN w zaledwie kilku linijkach kodu.
...
1. Konwertuj SPREADSHEETML na PRN, wywołując metodę zapisu skoroszytu.
