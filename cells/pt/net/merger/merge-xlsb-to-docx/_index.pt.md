...
description: Aspose Excel. C# Aspose.Cells. Mesclagem online gratuita XLSB para DOCX saveformat. C# Combine o formato XLSB a DOCX. Mesclar XLSB a DOCX em C#. XLSB Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar XLSB a DOCX em C# Online Gratuitamente" %}}

O exemplo a seguir demonstra como mesclar XLSB a DOCX em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XLSB a DOCX. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo DOCX. Se você desenvolver o código em C#, isso será mais simples do que parece. Consulte o exemplo C# que mescla XLSB a DOCX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar XLSB a DOCX em C#" InputFormat="xlsb" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XLSB a DOCX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XLSB a DOCX programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar XLSB a DOCX" %}}
