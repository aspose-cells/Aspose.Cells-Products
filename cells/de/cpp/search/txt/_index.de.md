---
title:  Durchsuchen Sie das Dokument TXT, ohne es über C++ zu öffnen
weight: 5090
description: C++ Beispielcode zum Suchen von Wörtern mit Muster in der Datei TXT in der Laufzeitumgebung C++ für Windows 32 Bit, Windows 64 Bit und Linux 64 Bit.
...
{{< blocks/products/pf/i18n/upper-banner h1="Suchen Sie nach TXT-Formaten in C++" h2="Native und leistungsstarke TXT Dokumentensuche mit serverseitigen Aspose.Cells for C++ APIs, ohne den Einsatz von Software wie Microsoft oder Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="So durchsuchen Sie die Datei TXT mit C++" %}}

 Um die Datei TXT zu durchsuchen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Durchsuchen von TXT-Dateien in C++" %}}
...
+ Laden Sie die Datei TXT, indem Sie eine Arbeitsmappenklasse instanziieren.
...
+ Speichern Sie die Datei TXT mit der Methode Workbook::Save(...).
...
{{% blocks/products/pf/agp/code-block title="Suche TXT Dateien – C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online TXT Live-Demos durchsuchen" sectionDescription=" Suchen Sie jetzt nach Text, Wörtern und Phrasen in TXT-Dokumenten, indem Sie unsere besuchen[Live-Demos-Website](https://products.aspose.app/cells/search). Die Live-Demo bietet folgende Vorteile" >}}
