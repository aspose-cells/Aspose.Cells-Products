---
title: Convertisseur PHP SXC vers XLSM - SXC vers XLSM
description: Aspose Excel. Cette solution complète offre aux développeurs PHP une approche entièrement intégrée pour convertir le format SXC au format XLSM, permettant ainsi un enregistrement transparent des données SXC au format XLSM grâce à la bibliothèque Aspose.Cells, le tout via un code PHP efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Comment convertir SXC en XLSM via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers SXC en XLSM par programmation ? Les développeurs PHP peuvent facilement charger et convertir des fichiers SXC en XLSM en quelques lignes de code seulement.
...
1.  Convertissez SXC en XLSM en appelant la méthode save de Workbook.
1.  Obtenez le résultat de la conversion de SXC en XLSM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir SXC en XLSM" %}}
