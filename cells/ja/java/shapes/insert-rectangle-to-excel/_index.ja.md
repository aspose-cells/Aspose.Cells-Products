...
{{% blocks/products/pf/agp/content h2="Java を使用して Excel ファイルに四角形を挿入する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Excel ファイルに四角形を挿入する手順 via Java" %}}
...
+ インデックスからワークシートを選択します。
 + を使用してください[メソッドの追加](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addRectangle-int-int-int-int-int-int-)選択したワークシートに長方形を挿入するには
...
{{% blocks/products/pf/agp/code-block title="長方形の挿入 - Java" offSpacer="" %}}
