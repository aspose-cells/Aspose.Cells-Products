---
title: C# XLSX ke POWERPOINT - XLSX ke POWERPOINT Konverter
description: Aspose Unggul. Ubah XLSX menjadi POWERPOINT dengan cepat dan mudah dengan Aspose.Cells. C# XLSX menjadi POWERPOINT. C# Simpan XLSX ke POWERPOINT. Simpan XLSX sebagai POWERPOINT menggunakan C#.
...
Ikuti langkah mudah untuk mengkonversi XLSX ke POWERPOINT. Unggah file XLSX Anda, lalu simpan sebagai file POWERPOINT. Untuk pembacaan XLSX dan penulisan POWERPOINT Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format POWERPOINT keluaran akan sama dengan dokumen XLSX asli.
...
{{% blocks/products/pf/agp/content h2="Cara Mengubah XLSX ke POWERPOINT melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX ke POWERPOINT secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi XLSX ke POWERPOINT hanya dalam beberapa baris kode.
...
1.  Ubah XLSX menjadi POWERPOINT dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi XLSX ke POWERPOINT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan C# untuk mengkonversi XLSX ke POWERPOINT" %}}
