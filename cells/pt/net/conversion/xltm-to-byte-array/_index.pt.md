...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array é útil para processamento ou armazenamento de dados. Você pode converter um arquivo XLTM para Byte Array, bem como um documento **Byte Array para XLTM** usando a linguagem C#. Para converter XLTM em array de bytes, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 É fácil para os desenvolvedores carregar e converter arquivos XLTM para matriz de bytes para outras tarefas de manipulação em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Inclua o namespace em seu arquivo de classe1. Carregar arquivo XLTM de entrada usando a pasta de trabalho1. Inicialize o objeto MemoryStream1. Converter dados de fluxo em matriz de bytes1. Processe dados conforme sua exigência
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra XLTM para matriz de bytes C# Conversão" offSpacer="" %}}
