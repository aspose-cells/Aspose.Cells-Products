---
title: 建立JPEG - 在Java中建立JPEG文件
description: Aspose Excel。 Java 使用 Aspose.Cells 快速輕鬆地建立 JPEG 檔案。使用 Java 產生 JPEG 檔案。在 Java 中建立 JPEG。在 Java 中建立 JPEG。
...
{{< blocks/products/pf/i18n/upper-banner h1="在Java中建立JPEG文件" h2="用於建立 JPEG 檔案的高速 Java 庫。這是一個專業的軟體解決方案，用於導入和導出XLSX、PDF以及使用Java的許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何在Java中建立JPEG" %}}
...
1. 使用 save() 方法將工作簿儲存為 JPEG 格式。

{{% blocks/products/pf/agp/code-block title="範例程式碼展示如何在 Java 中建立 JPEG 檔案。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java庫建立JPEG文件" %}}
{{% blocks/products/pf/agp/text %}}
