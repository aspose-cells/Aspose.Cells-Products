---
title: Sloučit TABDELIMITED na XLSB - Sloučit TABDELIMITED na XLSB v C#
url: /cs/net/merger/merge-tabdelimited-to-xlsb/ 
description: Aspose Excel. C# Aspose.Cells. Zdarma online sloučení TABDELIMITED do formátu uložení XLSB. C# Kombinujte TABDELIMITED do formátu XLSB. Sloučit TABDELIMITED na XLSB v C#. TABDELIMITED Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit TABDELIMITED na XLSB v C# online zdarma" %}}

Následující příklad ukazuje, jak sloučit TABDELIMITED do XLSB v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení TABDELIMITED do XLSB. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru XLSB. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí TABDELIMITED do XLSB.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení TABDELIMITED na XLSB v C#" InputFormat="tsv" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit TABDELIMITED na XLSB přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit TABDELIMITED na XLSB programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET ke sloučení TABDELIMITED do XLSB" %}}
