---
title: Konversikan MHTML ke MARKDOWN melalui Java 
url: /id/java/conversion/mhtml-to-markdown/ 
description: Contoh Java kode konversi untuk format MHTML ke file MARKDOWN. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke MARKDOWN dalam Aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan MHTML ke MARKDOWN melalui Java" h2="Konversi MHTML ke MARKDOWN Java untuk mengonversi satu atau beberapa halaman menjadi MARKDOWN menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MARKDOWN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi MHTML ke MARKDOWN Menggunakan Java" %}}

 Untuk merender MHTML ke MARKDOWN, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi MHTML ke MARKDOWN melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file MHTML ke MARKDOWN hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file MHTML dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi MARKDOWN & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file MARKDOWN yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="MHTML ke MARKDOWN Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file MHTML dalam instance Workbook
Workbook book = new Workbook("template.mhtml");
// simpan MHTML sebagai MARKDOWN
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi MHTML ke MARKDOWN" sectionDescription="[Konversikan MHTML ke MARKDOWN](https://products.aspose.app/cells/conversion/mhtml-to-markdown) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file MHTML Anda, itu akan langsung dikonversi ke MARKDOWN." >}}
