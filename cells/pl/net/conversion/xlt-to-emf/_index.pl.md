---
title: Konwertuj XLT na EMF przez C#

description: Przykładowy kod konwersji xlt na emf C#. Użyj przykładowego kodu API dla wsadowych plików xlt do konwersji emf w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programiści mogą łatwo ładować i konwertować pliki XLT na EMF w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLT z instancją Workbook1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem EMF jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku EMF
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLT na EMF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="emf" IsLandingPage="true" %}}
