...
description: Aspose Excel. Convierta MHT a PPTX rápida y fácilmente con Aspose.Cells. Python MHT a PPTX. Python Guarde MHT en PPTX. Guarde MHT como PPTX usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde MHT en PPTX en Python" %}}

El siguiente ejemplo demuestra cómo convertir MHT a PPTX en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir MHT a PPTX" %}}
