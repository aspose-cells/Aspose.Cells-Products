---
title: C# ODS para SVG - Online ODS para SVG Conversor
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converter ODS para SVG saveformat. C# ODS a SVG formato. Salve ODS a SVG C#.
...
{{% blocks/products/pf/agp/content h2="Salve ODS a SVG em C# online gratuitamente" %}}

O exemplo a seguir demonstra como converter ODS em SVG em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter ODS em SVG. Carregue seu arquivo ODS e salve-o como arquivo SVG. Tanto para a leitura ODS quanto para a escrita SVG, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação de saída SVG serão idênticos ao documento ODS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de amostra para converter ODS em SVG online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="svg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter ODS para SVG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS para SVG programaticamente? Os desenvolvedores .NET podem facilmente carregar e converter ODS em SVG em apenas algumas linhas de código.
...
1.  Converta ODS em SVG chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para SVG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteca para converter ODS em SVG" %}}
