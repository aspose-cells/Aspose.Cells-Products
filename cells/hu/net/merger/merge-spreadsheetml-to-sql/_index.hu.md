---
title: SPREADSHEETML egyesítése SQL-be – SPREADSHEETML egyesítése SQL-be a C#-ben
url: /hu/net/merger/merge-spreadsheetml-to-sql/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítése SPREADSHEETML SQL mentési formátumba. C# A SPREADSHEETML egyesítése SQL formátummal. A SPREADSHEETML egyesítése SQL-be a C#-ben. SPREADSHEETML egyesítése.
...
{{% blocks/products/pf/agp/content h2="Ingyenesen egyesítse a SPREADSHEETML-t SQL-lel a C# Online számban" %}}

A következő példa bemutatja, hogyan egyesítheti a SPREADSHEETML-t SQL-lel a Aspose.Cells for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a SPREADSHEETML SQL-be olvasztásához. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el SQL fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a SPREADSHEETML-t SQL-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a SPREADSHEETML és az SQL egyesítése a C#-ben" InputFormat="xml" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="SPREADSHEETML egyesítése SQL-be a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a SPREADSHEETML-t SQL-lel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a SPREADSHEETML SQL-lel való egyesítéséhez" %}}
