...
url: /nl/cpp/merger/merge-txt-to-xml/ 
...
Het volgende voorbeeld laat zien hoe u TXT samenvoegt met XML in Aspose.Cells for C++.
...
Wilt u TXT programmatisch samenvoegen met XML? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="C++-bibliotheek om TXT samen te voegen met XML" %}}
