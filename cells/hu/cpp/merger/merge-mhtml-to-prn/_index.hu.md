---
title: A MHTML egyesítése PRN-nel - A MHTML-es szám egyesítése PRN-vel a C++-ben
url: /hu/cpp/merger/merge-mhtml-to-prn/ 
description: Aspose Excel. C++ Aspose.Cells. Ingyenes online egyesítés MHTML PRN mentési formátumba. C++ Kombinálja a MHTML-et PRN formátumba. Egyesítse a MHTML-et a PRN-vel a C++-es számon. MHTML Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a MHTML-es számot a PRN-hez a C++-es online számmal ingyen" %}}

A következő példa bemutatja, hogyan egyesítheti a MHTML-et a PRN-vel a Aspose.Cells-es for C++-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a MHTML és a PRN egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el PRN fájlba. Ha kódot fejleszt a C++-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C++ példát, amely egyesíti a MHTML-et a PRN-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a MHTML és a PRN egyesítéséhez a C++-ben" InputFormat="mhtml" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="MHTML és a PRN egyesítése a C++ számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a MHTML-et a PRN-nel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a MHTML és a PRN egyesítéséhez" %}}
