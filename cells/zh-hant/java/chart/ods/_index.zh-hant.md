---
title:  ODS 文件圖表 via Java
weight: 2240
description: Java 用於在 JSP/JSF 應用程式和桌面應用程式的 Java 運行時環境中繪製和轉換 ODS 檔案中的圖表或圖表的範例程式碼。
...
{{< blocks/products/pf/i18n/upper-banner h1="ODS 格式化 Java 中的圖表" h2="使用伺服器端 Aspose.Cells for Java API 的本機高效能 ODS 文件圖表，無需使用 Microsoft 或 Adobe PDF 等任何軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 建立 ODS 檔案圖表" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 Java 中建立 ODS 檔案圖表的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="建立 ODS 檔案圖表 - Java" offSpacer="" %}}
