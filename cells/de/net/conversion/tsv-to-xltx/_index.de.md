---
title: C# TSV bis XLTX - TSV bis XLTX Konverter
...
{{% blocks/products/pf/agp/content h2="Speichern Sie TSV bis XLTX in C#" %}}

Das folgende Beispiel zeigt, wie man TSV in C# in XLTX umwandelt.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie TSV über C# in XLTX" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie TSV-Dateien programmgesteuert in XLTX konvertieren? .NET-Entwickler können TSV mit nur wenigen Codezeilen problemlos in XLTX laden und konvertieren.
...
1.  Konvertieren Sie TSV in XLTX durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von TSV in XLTX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von TSV in XLTX" %}}
