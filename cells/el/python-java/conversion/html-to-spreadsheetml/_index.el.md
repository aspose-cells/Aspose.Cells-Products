---
title: Μετατροπή HTML σε SPREADSHEETML μέσω Python
url: /el/python-java/conversion/html-to-spreadsheetml/
description: Δείγμα κώδικα για μετατροπή Python html σε υπολογιστικό φύλλο. Χρησιμοποιήστε API παράδειγμα κώδικα για ομαδικά αρχεία html για μετατροπή υπολογιστικού φύλλου εντός της εφαρμογής Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή HTML σε SPREADSHEETML μέσω Python" h2="Εξαγωγή υπολογιστικών φύλλων Excel® σε μορφή SPREADSHEETML χρησιμοποιώντας Python API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Τρόπος μετατροπής HTML σε SPREADSHEETML χρησιμοποιώντας το Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή HTML σε SPREADSHEETML μέσω Python" %}}

{{% blocks/products/pf/agp/text %}}

 Οι προγραμματιστές του Python μπορούν εύκολα να φορτώσουν και να μετατρέψουν αρχεία HTML σε SPREADSHEETML σε λίγες μόνο γραμμές κώδικα.
