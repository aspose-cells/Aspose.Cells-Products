---
title:  Dokument XLSM suchen, ohne es über C++ zu öffnen
weight: 9280
description: C++ Beispielcode zum Suchen von Wörtern mit einem Muster in der Datei XLSM auf der Laufzeitumgebung C++ für Windows 32 Bit, Windows 64 Bit und Linux 64 Bit.
...
{{% blocks/products/pf/agp/content h2="So suchen Sie die Datei XLSM mithilfe der Nummer C++" %}}

 Um die Datei XLSM zu suchen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Suchen von Dateien mit der Kennung XLSM in C++" %}}
...
+ Datei XLSM mithilfe der Workbook-Klasse laden.
...
{{% blocks/products/pf/agp/code-block title="Suche nach Dateien mit der Nummer XLSM - C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online XLSM Live-Demos suchen" sectionDescription=" Durchsuchen Sie jetzt Texte, Wörter und Phrasen in den Dokumenten mit der Nummer XLSM, indem Sie unsere Website besuchen.[Live-Demos-Website](https://products.aspose.app/cells/search)Die Live-Demo bietet folgende Vorteile" >}}
