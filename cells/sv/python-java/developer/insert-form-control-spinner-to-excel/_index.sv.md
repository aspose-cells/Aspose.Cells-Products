---
title:  Infoga snurrknappen (formulärkontroll) i Excel med Python via java
weight: 40
description: Python via java källkod för att infoga Spin Button (formulärkontroll) i Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Infoga snurrknappen (formulärkontroll) i Excel med Python via java" h2="Infoga objekt med hjälp av API:er på serversidan utan någon programvara som Microsoft eller Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man infogar spin-knappen (formulärkontroll) i Excel-fil med Python via java" %}}

 För att infoga Spin Button (formulärkontroll) i excel-filen kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga Spin Button (formulärkontroll) i Excel-fil med Python via java" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens[lägga till metod](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addSpinner(int,%20int,%20int,%20int,%20int,%20int)) för att infoga en snurrknapp (formulärkontroll) i det valda kalkylbladet.
...
{{% blocks/products/pf/agp/code-block title="Infoga snurrknapp (formulärkontroll) - Python via java" offSpacer="" %}}
