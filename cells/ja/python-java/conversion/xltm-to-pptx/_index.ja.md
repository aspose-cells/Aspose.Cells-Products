...
{{% blocks/products/pf/agp/content h2="Python を使用して XLTM を PPTX に変換します" %}}
...
次の例は、XLTM を Python の PPTX に変換する方法を示しています。
...
{{% blocks/products/pf/agp/content h2="Python経由でXLTMをPPTXに変換する方法" %}}
