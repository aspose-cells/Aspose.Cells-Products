...
L'exemple suivant montre comment fusionner XLS à ET dans Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Besoin de fusionner XLS à ET par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner XLS à ET" %}}
