...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLAM bis DIF in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie XLAM in DIF in C# konvertiert wird.
...
Müssen Sie XLAM-Dateien programmgesteuert in DIF konvertieren? .NET-Entwickler können XLAM problemlos in nur wenigen Codezeilen laden und in DIF konvertieren.
...
1.  Konvertieren Sie XLAM in DIF, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLAM in DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLAM in DIF" %}}
