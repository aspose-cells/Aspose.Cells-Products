...
{{% blocks/products/pf/agp/content h2="Hur man infogar oval i Excel-fil med Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att infoga Oval till Excel-fil med Python via Java" %}}
...
+ Välj kalkylblad via dess index.
 + Använd formkollektionens[lägga till metod](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addOval(int,%20int,%20int,%20int,%20int,%20int)) för att infoga en oval i det valda arbetsbladet.
...
{{% blocks/products/pf/agp/code-block title="Insats Oval - Python via Java" offSpacer="" %}}
