---
title:  Nhóm và tách nhóm các hình dạng trong Excel via .NET
weight: 340
description: C# Mã mẫu để nhóm và rã nhóm các hình vào Excel bằng Thư viện .NET. Sử dụng mã này để nhóm hoặc rã nhóm các hình dạng trong MS Excel trong VB.NET, Asp.NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
...
{{% blocks/products/pf/agp/content h2="Cách nhóm và tách nhóm các hình dạng trong tệp Excel bằng C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước nhóm và tách các hình dạng trong file Excel qua C#" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng[phương pháp nhóm](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/group/) để nhóm các hình dạng trong bảng tính đã chọn
 + Sử dụng[phương pháp tách nhóm](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/ungroup/) để rã nhóm các hình dạng trong bảng tính đã chọn
