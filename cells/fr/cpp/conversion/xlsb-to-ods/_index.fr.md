...
Besoin de convertir les fichiers XLSB en ODS par programmation ? Les développeurs de C++ peuvent facilement convertir XLSB en ODS en seulement quelques lignes de code.
...
1.  Convertissez XLSB en ODS en appelant la méthode Save().
