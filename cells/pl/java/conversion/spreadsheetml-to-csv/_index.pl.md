---
title: Konwertuj SPREADSHEETML na CSV przez Java 
url: /pl/java/conversion/spreadsheetml-to-csv/ 
description: Przykładowy kod konwersji Java dla formatu SPREADSHEETML do pliku CSV. Programiści mogą użyć tego przykładowego kodu, aby wyeksportować arkusze kalkulacyjne Excel i OpenOffice do CSV w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj SPREADSHEETML na CSV przez Java" h2="Konwersja SPREADSHEETML do CSV Java w celu konwersji jednej lub wielu stron do CSV przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować SPREADSHEETML na CSV za pomocą Java" %}}

 Aby renderować SPREADSHEETML do CSV, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować arkusz SPREADSHEETML na CSV za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik SPREADSHEETML na CSV w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik SPREADSHEETML z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem CSV i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę wynikowego pliku CSV
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML do CSV Java Kod źródłowy konwersji" offSpacer="" %}}

```cs
// załaduj plik SPREADSHEETML w instancji Workbook
Workbook book = new Workbook("template.spreadsheetml");
// zapisz arkusz kalkulacyjny jako CSV
