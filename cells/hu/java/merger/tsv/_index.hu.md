---
title: "TSV-fájlok egyesítése a következőn keresztül: Java "
weight: 9260
url: /hu/java/merger/tsv/ 
description: Java mintakód a TSV-dokumentumok kombinálásához a Java Futókörnyezetben JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TSV-formátumok egyesítése itt: Java" h2="Natív TSV-dokumentum-egyesítés szerveroldali Java API-kkal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="TSV-fájlok egyesítése a következővel: Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A TSV-fájlok egyesítésének lépései itt: Java" %}}
...
{{% blocks/products/pf/agp/code-block title="TSV-fájlok egyesítése – Java" offSpacer="" %}}

```cs
// Nyissa meg az első TSV-fájlt.
Workbook tsvFile1 = new Workbook("chartsFileWithPath.tsv");

// Határozza meg a második forráskönyvet.
// Nyissa meg a második TSV-fájlt.
