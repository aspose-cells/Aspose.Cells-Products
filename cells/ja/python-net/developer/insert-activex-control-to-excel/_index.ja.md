...
{{% blocks/products/pf/agp/content h2="Python via .Net を使用して ActiveX コントロールを Excel ファイルに挿入する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .Net を使用して ActiveX コントロールを Excel ファイルに挿入する手順" %}}
...
+ インデックスからワークシートを選択します。
 シェイプコレクションの追加を使用します[方法](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_active_x_control/#aspose.cells.drawing.activexcontrols.ControlType-int-int-int-int-int-int)選択したワークシートに ActiveX コントロールを挿入します。
...
{{% blocks/products/pf/agp/code-block title="ActiveX コントロールの挿入 - Python via .Net" offSpacer="" %}}
