---
title: Visualizza i formati di file XLSB tramite .NET 
weight: 6260

description: C# codice sorgente per caricare, eseguire il rendering e visualizzare documenti XLSB su piattaforme .NET Framework, .NET Core, Mono o Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Visualizzatore file XLSB for .NET" h2="Visualizza fogli di calcolo Excel e OpenOffice come XLSB senza richiedere Microsoft Excel o Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
1. Carica il file XLSB in un'istanza di Workbook1. Crea un'istanza di HtmlSaveOptions e imposta la proprietà ExportHeadings su true1. Salva il file XLSB in formato HTML utilizzando il metodo Workbook.Save1. Carica l'HTML risultante nel browser predefinito con Process.Start
...
// salva il file XLSB in formato HTML
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API può essere utilizzato per creare, modificare, convertire ed eseguire il rendering di formati Microsoft Excel in formati diversi. Inoltre, può essere utilizzato per grafici completi, report scalabili e calcoli affidabili all'interno di applicazioni software. Aspose.Cells è un API autonomo e non richiede alcun software come Microsoft o OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per visualizzare XLSB" sectionDescription="Controlla le nostre demo dal vivo su [Visualizza XLSB](https://products.aspose.app/cells/viewer/xlsb) con i seguenti vantaggi." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Scarica il file XLSB dal link, se necessario" >}}
