...
1. Načtěte zamčený soubor XLSX pomocí CreateIWorkbook.1. Pro odemknutí zavolejte funkci Unprotect().1. Nastavte heslo na NULL pomocí SetPassword.1. Uložte soubor XLSX na určené místo.
