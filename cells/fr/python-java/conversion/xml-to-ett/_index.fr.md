...
description: Aspose Exceller. Convertissez XML en ETT rapidement et facilement avec Aspose.Cells. Python XML en ETT. Python Enregistrer XML dans ETT. Enregistrez XML au format ETT en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Convertir XML en ETT à l\'aide de Python" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer XML dans ETT au Python" %}}

L'exemple suivant montre comment convertir XML en ETT dans Python.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour convertir XML en ETT" %}}
