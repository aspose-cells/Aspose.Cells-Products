---
title: Crear MHT - Crear archivo MHT en C#
description: Aspose Excel. Genere y manipule archivos MHT fácilmente con la biblioteca Aspose.Cells for .NET. Esta potente biblioteca API ofrece una solución optimizada y eficiente para crear, editar y administrar archivos MHT directamente en sus aplicaciones C#, satisfaciendo las necesidades específicas de los desarrolladores con alta precisión.
...
{{% blocks/products/pf/agp/content h2="Cómo crear MHT en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="El código de muestra muestra cómo crear un archivo MHT en C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C# biblioteca para crear archivo MHT" %}}
