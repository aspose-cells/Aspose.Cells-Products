...
url: /pl/cpp/merger/merge-fods-to-jpg/ 
...
Poniższy przykład pokazuje, jak połączyć FODS z JPG w Aspose.Cells for C++.
...
Chcesz programowo scalić FODS z JPG? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia FODS do JPG" %}}
