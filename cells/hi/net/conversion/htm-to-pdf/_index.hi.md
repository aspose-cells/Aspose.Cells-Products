---
title: C# एचटीएम से PDF - एचटीएम से PDF कनवर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ HTM को जल्दी और आसानी से PDF में बदलें। C# HTM को PDF पर। C# HTM को PDF पर सहेजें। C# का उपयोग करके HTM को PDF के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="C# में HTM को PDF पर सेव करें" %}}

निम्नलिखित उदाहरण दर्शाता है कि HTM को C# में PDF में कैसे परिवर्तित किया जाए।
...
{{% cells-convert title="एचटीएम को PDF में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="pdf" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C# के माध्यम से एचटीएम को PDF में कैसे परिवर्तित करें" %}}

{{% blocks/products/pf/agp/text %}}

HTM फ़ाइलों को प्रोग्रामेटिक रूप से PDF में कनवर्ट करने की आवश्यकता है? .NET डेवलपर्स कोड की कुछ पंक्तियों में आसानी से एचटीएम को PDF में लोड और परिवर्तित कर सकते हैं।
...
{{% blocks/products/pf/agp/content h2="एचटीएम को PDF में बदलने के लिए C# लाइब्रेरी" %}}
