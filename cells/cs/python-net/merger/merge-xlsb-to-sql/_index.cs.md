...
description: Aspose Excel. Python Aspose.Cells. Sloučit XLSB do SQL saveformat. Python Zkombinujte XLSB do formátu SQL. Sloučit XLSB do SQL v Python. XLSB Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB do SQL v Python" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLSB do SQL v Python" InputFormat="xlsb" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
