---
title: PRN'yi FODS ile birleştir - PRN'yi C#'de FODS ile birleştir
url: /tr/net/merger/merge-prn-to-fods/ 
description: Aspose Excel'de. C# Aspose.Cells. PRN'yi FODS kaydetme biçimiyle birleştirin. C# PRN'yi FODS biçimiyle birleştirin. PRN'yi C#'de FODS ile birleştirin. PRN Birleştir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi C#\'de FODS ile birleştir" %}}

Aşağıdaki örnek, PRN'nin Aspose.Cells for .NET'deki FODS ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

PRN'yi FODS'e birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından FODS dosyasına kaydedin. C#'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. PRN'yi FODS ile birleştiren C# örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="PRN\'yi C#\'de FODS ile Birleştirmek için Örnek Kod" InputFormat="prn" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="PRN\'yi C# aracılığıyla FODS ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

PRN'yi programlı olarak FODS ile birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
