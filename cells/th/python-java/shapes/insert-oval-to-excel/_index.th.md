...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการใส่วงรีลงในไฟล์ Excel โดยใช้ Python via Java" %}}
...
+ เลือกแผ่นงานผ่านดัชนี
 + ใช้คอลเลกชันรูปร่างของ[เพิ่มวิธีการ](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addOval(int,%20int,%20int,%20int,%20int,%20int)) เพื่อแทรกวงรีในเวิร์กชีตที่เลือก
