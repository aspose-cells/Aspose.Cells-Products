---
title: Konversi XLSM ke XLSB melalui C++ aplikasi 
url: /id/cpp/conversion/xlsm-to-xlsb/ 
description: Contoh C++ kode konversi untuk dokumen XLSM ke format XLSB. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch XLSM ke XLSB dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi XLSM ke XLSB melalui C++" h2="Konversi XLSM ke XLSB berperforma tinggi menggunakan pustaka C++ tanpa memerlukan penginstalan Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi XLSM ke XLSB Menggunakan C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi XLSM ke XLSB melalui C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ pengembang dapat dengan mudah mengonversi file XLSM ke XLSB hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLSM menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file output dengan ekstensi file (XLSB).1. File XLSB akan disimpan di jalur yang ditentukan.1. Buka file XLSB di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLSM ke XLSB C++ Kode Sumber Konversi" offSpacer="" %}}
