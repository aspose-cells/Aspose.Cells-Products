...
{{% blocks/products/pf/agp/content h2="Převeďte XLAM na ET v Python" %}}
...
{{% blocks/products/pf/agp/content h2="Ušetřete XLAM na ET v Python online zdarma" %}}

Následující příklad ukazuje, jak převést XLAM na ET v Python via NET.
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod XLAM na ET Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="et" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna Python pro převod XLAM na ET" %}}
