---
title: Voeg HTML samen met DOCX - Combineer HTML met DOCX in C++
url: /nl/cpp/merger/merge-html-to-docx/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis online Samenvoegen HTML naar DOCX saveformat. C++ Combineer het formaat HTML tot DOCX. Samenvoegen HTML tot DOCX in C++. HTML Samenvoegen.
...
Het volgende voorbeeld laat zien hoe u HTML samenvoegt met DOCX in Aspose.Cells for C++.
...
{{% cells-merger title="Gratis online om HTML samen te voegen tot DOCX in C++" InputFormat="html" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hoe HTML samen te voegen met DOCX via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u HTML programmatisch samenvoegen tot DOCX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen worden gedaan met slechts enkele regels code.
