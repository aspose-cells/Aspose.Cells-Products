...
description: Aspose Excel. A FODS-es számot XLT-re gyorsan és egyszerűen a Aspose.Cells-es számmal alakíthatja át. C++ FODS-XLT-re. 13481 a C++ számon.
...
{{% blocks/products/pf/agp/content h2="Mentse a FODS-XLT számot a C++-es számon" %}}
