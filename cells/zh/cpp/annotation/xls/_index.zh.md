...
1. 使用 IWorkbook 类对象加载 XLS Excel 文件。1. 选择相关工作表1. 使用 Add 方法添加评论1. 使用 SetNote 方法设置注释的注释。1. 使用保存工作簿 [节省](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a77072cfb929787df9ad1f38b02f58349) 方法
