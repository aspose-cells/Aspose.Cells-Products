---
title: Konwertuj SXC na SPREADSHEETML za pomocą Java 

description: Przykładowy kod konwersji Java dla formatu SXC do pliku SPREADSHEETML. Programiści mogą użyć tego przykładowego kodu, aby wyeksportować arkusze kalkulacyjne Excel i OpenOffice do SPREADSHEETML w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj SXC na SPREADSHEETML za pomocą Java" h2="Konwersja SXC do SPREADSHEETML Java w celu konwersji jednej lub wielu stron na SPREADSHEETML przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować SXC na SPREADSHEETML za pomocą Java" %}}

 Aby wyrenderować SXC do SPREADSHEETML, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Jak przekonwertować SXC na SPREADSHEETML za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik SXC na SPREADSHEETML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik SXC z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem SPREADSHEETML i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku SPREADSHEETML
...
{{% blocks/products/pf/agp/code-block title="SXC do SPREADSHEETML Java Kod źródłowy konwersji" offSpacer="" %}}

```cs
// załaduj plik SXC w instancji Workbook
Workbook book = new Workbook("template.sxc");
// zapisz SXC jako SPREADSHEETML
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja SXC do SPREADSHEETML Prezentacje na żywo" sectionDescription="[Konwertuj SXC na SPREADSHEETML](https://products.aspose.app/cells/conversion/sxc-to-spreadsheetml) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik SXC, zostanie on natychmiast przekonwertowany na SPREADSHEETML." >}}
