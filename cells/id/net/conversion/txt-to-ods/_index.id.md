...
description: Aspose Excel. Solusi komprehensif ini menyediakan C# pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi TXT ke format ODS, memungkinkan penyimpanan data TXT ke format ODS dengan lancar menggunakan pustaka Aspose.Cells, semuanya melalui kode C# yang efisien dan dapat disesuaikan.
...
{{% blocks/products/pf/agp/content h2="Simpan TXT ke ODS di C#" %}}

Contoh berikut menunjukkan cara mengkonversi TXT menjadi ODS di C#.
...
1.  Konversikan TXT menjadi ODS dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi dari TXT menjadi ODS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# perpustakaan untuk mengkonversi TXT menjadi ODS" %}}
