---
title:  Insira SVG imagens/ícones no Excel via .NET
weight: 110
description: Código-fonte C# para inserir imagens/ícones SVG no Excel em plataformas .NET Framework, .NET Core, Mono ou Xamarin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Insira SVG imagens/ícones no Excel via .NET" h2="Insira SVG imagens/ícones usando Aspose.Cells\' API sem nenhum software como Microsoft ou Open Office, Adobe PDF, etc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como inserir imagens/ícones SVG em arquivo Excel usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir imagens/ícones SVG em arquivo Excel via C#" %}}
...
+ Selecione Planilha por meio de seu índice.
 + Utilize o[adicionar método](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addicons)para inserir um ícone na planilha selecionada
