---
title: C# FODS в MHT - FODS в конвертер MHT
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в MHT в C#" %}}

Следующий пример демонстрирует, как преобразовать FODS в MHT в C#.
...
{{% blocks/products/pf/agp/content h2="Как конвертировать FODS в MHT через C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы FODS в формат MHT? Разработчики .NET могут легко загрузить и преобразовать FODS в MHT всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека C# для преобразования FODS в MHT" %}}
