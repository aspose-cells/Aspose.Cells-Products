...
Potrzebujesz programowo przekonwertować pliki XML do formatu ET? Programiści C++ mogą łatwo przekonwertować pliki XML do formatu ET za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj XML do ET wywołując metodę Save().
