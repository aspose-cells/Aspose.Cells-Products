---
title: Połącz TSV z OTS - Połącz TSV z OTS w Java
url: /pl/java/merger/merge-tsv-to-ots/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online TSV do formatu zapisu OTS. Java Połącz TSV do formatu OTS. Połącz TSV z OTS w Java. TSV Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz TSV z OTS w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć TSV z OTS w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć numer TSV z OTS. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku OTS. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy TSV z OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online TSV z OTS w Java" InputFormat="tsv" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić TSV z OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo połączyć numer TSV z OTS? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do połączenia TSV z OTS" %}}
