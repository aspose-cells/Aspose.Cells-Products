---
title: PHP TABDELIMITED na XLTM - TABDELIMITED na XLTM Converter
description: Aspose Excel. Převeďte TABDELIMITED na XLTM rychle a snadno pomocí Aspose.Cells. PHP TABDELIMITED na XLTM. PHP Uložte TABDELIMITED na XLTM. Uložte TABDELIMITED jako XLTM pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést TABDELIMITED na XLTM přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory TABDELIMITED na XLTM programově? Vývojáři PHP mohou snadno načíst a převést TABDELIMITED na XLTM v několika řádcích kódu.
...
1.  Převeďte TABDELIMITED na XLTM voláním metody uložení sešitu.
