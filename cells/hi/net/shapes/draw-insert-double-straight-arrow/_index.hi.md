---
title:  मैं एक्सेल via .NET में दोहरा सीधा तीर कैसे बनाऊं या डालूं
weight: 10
description: C# .NET लाइब्रेरी का उपयोग करके एक्सेल में डबल स्ट्रेट एरो जोड़ने या डालने के लिए नमूना कोड। VB.NET, Asp.NET या किसी .NET आधारित एप्लिकेशन के भीतर MS Excel में डबल स्ट्रेट एरो बनाने के लिए इस कोड का उपयोग करें।
...
{{% blocks/products/pf/agp/feature-section-col title="C# के माध्यम से एक्सेल फ़ाइल में डबल स्ट्रेट एरो डालने के चरण" %}}
...
+ इसके सूचकांक के माध्यम से वर्कशीट का चयन करें।
 + का प्रयोग करें[विधि जोड़ें](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addline)चयनित वर्कशीट में दोहरा सीधा तीर डालने के लिए
...
{{% blocks/products/pf/agp/code-block title="दोहरा सीधा तीर डालें - C#" offSpacer="" %}}
