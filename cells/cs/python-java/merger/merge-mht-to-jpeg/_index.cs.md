...
url: /cs/python-java/merger/merge-mht-to-jpeg/ 
...
Následující příklad ukazuje, jak sloučit MHT s JPEG v Aspose.Cells for Python via Java.
...
Potřebujete sloučit MHT na JPEG programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
