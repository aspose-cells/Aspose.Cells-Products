---
title: Converti FODS in JSON tramite l'applicazione C++ 
url: /it/cpp/conversion/fods-to-json/ 
description: Esempio di codice di conversione C++ per il documento FODS in formato JSON. I programmatori possono utilizzare questo codice sorgente per la conversione batch da FODS a JSON all'interno di qualsiasi applicazione C++.
---
...
{{% blocks/products/pf/agp/content h2="Come convertire FODS in JSON utilizzando C++" %}}

 Per convertire FODS in JSON, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire FODS in JSON tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ gli sviluppatori possono convertire facilmente i file FODS in JSON in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file FODS usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (JSON).1. Il file JSON verrà salvato nel percorso specificato.1. Apri il file JSON nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da FODS a JSON C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live di conversione da FODS a JSON" sectionDescription="[Converti FODS in JSON](https://products.aspose.app/cells/conversion/fods-to-json) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file FODS, verrà convertito istantaneamente in JSON." >}}
