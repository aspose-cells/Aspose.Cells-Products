---
title: HTM'yi EXCEL ile birleştir - Python'de HTM'yi EXCEL ile birleştir
url: /tr/python-net/merger/merge-htm-to-excel/ 
description: Aspose Excel'de. Python Excel'de. HTM'yi EXCEL kaydetme biçimiyle birleştirin. Python HTM'yi EXCEL formatıyla birleştirin. Python Excel Kitaplığı'nda HTM'yi EXCEL ile birleştirin. HTM Birleştirme.
...
{{% cells-merger title="Python Excel Kitaplığında HTM\'yi EXCEL ile Birleştirmek için Örnek Kod" InputFormat="htm" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Python Excel Kitaplığı aracılığıyla HTM\'yi EXCEL ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 HTM'yi EXCEL ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
