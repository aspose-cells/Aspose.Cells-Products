---
title: Konvertálja a JSON-t XLS-re a(z) C++ alkalmazáson keresztül 
url: /hu/cpp/conversion/json-to-xls/ 
description: Minta C++ konverziós kód a JSON-dokumentumhoz XLS formátumba. A programozók ezt a forráskódot használhatják a JSON-ból XLS-be kötegelt konvertáláshoz bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JSON konvertálása XLS-re a következőn keresztül: C++" h2="Nagy teljesítményű JSON-XLS konvertálás a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="JSON konvertálása XLS-re a következővel: C++" %}}
 ...
 JSON XLS-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztői könnyedén konvertálhatnak JSON-fájlt XLS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a JSON-fájlt a Factory::CreateIWorkbook használatával.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (XLS) fájlkiterjesztéssel.1. Az XLS fájl a megadott elérési útra kerül mentésre.1. Nyissa meg az XLS fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/text %}}
 ...
 A példaforráskód használata előtt győződjön meg arról, hogy rendelkezik a következő előfeltételekkel.
...
{{% blocks/products/pf/agp/code-block title="JSON–XLS C++ konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="JSON-ból XLS-be konvertáló élő bemutatók" sectionDescription="[Konvertálja a JSON-t XLS-re](https://products.aspose.app/cells/conversion/json-to-xls) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a JSON-fájlt, és azonnal XLS-re konvertálódik." >}}
