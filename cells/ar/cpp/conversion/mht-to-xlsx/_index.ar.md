...
هل تحتاج إلى تحويل ملفات MHT إلى XLSX برمجيًا؟ يمكن لمطوري C++ تحويل ملفات MHT إلى XLSX بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XLSX عن طريق استدعاء دالة Save().
