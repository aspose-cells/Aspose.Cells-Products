---
title: C# ODS to XLS - ODS to XLS Converter
description: Aspose Excel. C# Aspose.Cells. ODS to XLS in C#. C# Convert ODS to XLS saveformat. C# ODS to XLS format. Save ODS to XLS C#.
keywords: [Aspose Excel., C# Aspose.Cells., ODS to XLS in C#., C# ODS to XLS saveformat., ODS to XLS C#., C# Convert ODS to XLS]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert ODS to XLS in C#" h2="High-speed C# library for converting ODS to XLS. This is a professional software solution to import and export ODS, XLS, and many other formats on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="Save ODS to XLS in C#" %}}
...
{{% cells-convert title="Sample Code to Convert ODS to XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="xls" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert ODS to XLS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert ODS files to XLS programmatically? .NET developers can easily load & convert ODS to XLS in just a few lines of code.
