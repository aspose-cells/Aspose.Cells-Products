---
title: TXT को Python के माध्यम से MARKDOWN में बदलें
url: /hi/python-java/conversion/txt-to-markdown/
description: txt के लिए नमूना कोड मार्कडाउन Python रूपांतरण के लिए। Python एप्लिकेशन के भीतर रूपांतरण को मार्कडाउन करने के लिए बैच txt फ़ाइलों के लिए API उदाहरण कोड का उपयोग करें।
---
...
{{% blocks/products/pf/agp/content h2="Python का उपयोग करके TXT को मार्कडाउन में कैसे बदलें" %}}

 TXT को MARKDOWN में बदलने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="TXT को Python के माध्यम से MARKDOWN में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 Python डेवलपर कोड की कुछ ही पंक्तियों में आसानी से TXT फ़ाइलों को MARKDOWN में लोड और परिवर्तित कर सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1. कार्यपुस्तिका के उदाहरण के साथ TXT फ़ाइल लोड करें1. कार्यपुस्तिका को कॉल करें। विधि सहेजें1. पैरामीटर के रूप में एमडी एक्सटेंशन के साथ आउटपुट पथ पास करें1. परिणामी MARKDOWN फ़ाइल के लिए निर्दिष्ट पथ की जाँच करें
...
{{% cells-convert title="TXT को MARKDOWN में बदलने के लिए मुफ्त ऐप और नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="txt" outformat="md" IsLandingPage="true" language="python" %}}
