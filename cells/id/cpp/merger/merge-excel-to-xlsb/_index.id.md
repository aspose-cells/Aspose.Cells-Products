...
description: Aspose Unggul. C++ Aspose.Cells. Gabungkan EXCEL ke format simpan XLSB. C++ Gabungkan format EXCEL ke XLSB. Gabungkan EXCEL ke XLSB di C++. Gabungkan EXCEL.
keywords: [Aspose Excel., C++ Aspose.Cells., Merge EXCEL to XLSB in C++., C++ Merge EXCEL to xlsb., C++ Combine EXCEL to XLSB., EXCEL Merge]
---
...
{{% blocks/products/pf/agp/content h2="Gabungkan EXCEL ke XLSB di C++" %}}

Contoh berikut menunjukkan cara menggabungkan EXCEL ke XLSB di Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk menggabungkan EXCEL ke XLSB. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file XLSB. Jika Anda mengembangkan kode di C++, ini akan lebih sederhana daripada kedengarannya. Lihat contoh C++ yang menggabungkan EXCEL menjadi XLSB.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Contoh Kode untuk Menggabungkan EXCEL ke XLSB di C++" InputFormat="xlsx" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan EXCEL ke XLSB lewat C++" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan EXCEL ke XLSB secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka C++ untuk menggabungkan EXCEL menjadi XLSB" %}}
