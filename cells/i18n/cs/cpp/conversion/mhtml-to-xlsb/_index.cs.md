---
title: Převeďte MHTML na XLSB pomocí aplikace C++ 
weight: 7450
url: /cs/cpp/conversion/mhtml-to-xlsb/ 
description: Ukázka převodního kódu C++ pro dokument MHTML na formát XLSB. Programátoři mohou použít tento zdrojový kód pro dávkovou konverzi MHTML na XLSB v jakékoli C++ aplikaci.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést MHTML na XLSB přes C++" h2="Vysoce výkonný převod MHTML na XLSB pomocí knihovny C++ bez nutnosti instalace Microsoft Excel, OpenOffice nebo Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést MHTML na XLSB pomocí C++" %}}

 K převodu MHTML na XLSB použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu MHTML na XLSB prostřednictvím C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor MHTML na XLSB pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor MHTML pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu k výstupnímu souboru s příponou (XLSB).1. Soubor XLSB bude uložen do zadané cesty.1. Otevřete soubor XLSB v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze MHTML na XLSB C++" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze MHTML na XLSB" sectionDescription="[Převést MHTML na XLSB](https://products.aspose.app/cells/conversion/mhtml-to-xlsb) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj MHTML soubor, bude okamžitě převeden na XLSB." >}}
