...
description: Aspose Excel. Python Aspose.Cells. A XLS egyesítése SQL mentési formátumba. Python Kombinálja a XLS-et SQL formátumba. A XLS egyesítése SQL-be a Python-ben. XLS Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A XLS egyesítése SQL-lel a Python-ben" %}}

következő példa bemutatja, hogyan egyesítheti a XLS-et az SQL-lel a Aspose.Cells for Python via .NET-ben.
...
{{% cells-merger title="Mintakód a XLS SQL-hez való egyesítéséhez a Python-ben" InputFormat="xls" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
