---
title:  دمج XLSM ملفات via .NET
weight: 660
description: كود المصدر C# لدمج XLSM مستندًا على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="دمج XLSM التنسيقات في C#" h2="دمج المستندات XLSM أصلي وعالي الأداء باستخدام واجهات برمجة التطبيقات Aspose.Cells for .NET من جانب الخادم، دون استخدام أي برنامج مثل Microsoft أو Open Office، Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
+ تحميل جميع ملفات XLSM بالمسار الكامل.
+ قم بعمل مستند واحد كملف أساسي
+ استدعاء الطريقة ذات الصلة لتسلسل ودمج الملفات واحدًا تلو الآخر.
+ استدعاء طريقة Save () وتمرير اسم الملف (المسار الكامل) والتنسيق (XLSM) كمعلمة.
+ الآن يمكنك فتح واستخدام الملف XLSM في Microsoft Office أو Adobe PDF أو أي برنامج آخر متوافق.
...
{{% blocks/products/pf/agp/code-block title="دمج XLSM ملفات - C#" offSpacer="" %}}
