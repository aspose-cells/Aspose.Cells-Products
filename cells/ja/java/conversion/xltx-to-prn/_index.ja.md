---
title: Java XLTX から PRN - XLTX から PRN コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、XLTXをPRNにすばやく簡単に変換します。Java XLTXをPRNに変換します。 Java XLTX を PRN に保存します。 Java を使用して、XLTX を PRN として保存します。
...
{{% cells-convert title="XLTXをPRNに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="prn" IsLandingPage="true" language="java" %}}
