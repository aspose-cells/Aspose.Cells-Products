---
title: Chuyển đổi XLTX sang XLT qua C#
url: /vi/net/conversion/xltx-to-xlt/
description: Mã mẫu cho chuyển đổi xltx sang xlt C#. Sử dụng API mã ví dụ cho hàng loạt tệp xltx sang chuyển đổi xlt trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET các nhà phát triển có thể dễ dàng tải và chuyển đổi tệp XLTX sang XLT chỉ trong một vài dòng mã.
...
{{% cells-convert title="Ứng dụng miễn phí và mã mẫu để chuyển đổi XLTX sang XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="xlt" IsLandingPage="true" %}}
