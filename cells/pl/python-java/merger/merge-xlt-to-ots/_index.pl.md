...
description: Aspose Excel. Python Aspose.Cells. Scal XLT do formatu zapisu OTS. Python Połącz XLT w formacie OTS. Połącz XLT z OTS w Python. XLT Połącz.
...
{{% blocks/products/pf/agp/content h2="Scal XLT z OTS przy użyciu Python" %}}
...
{{% blocks/products/pf/agp/content h2="Połącz XLT z OTS w Python" %}}
...
{{% cells-merger title="Przykładowy kod do połączenia XLT z OTS w Python" InputFormat="xlt" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLT z OTS poprzez Python" %}}
