...
{{< blocks/products/pf/i18n/upper-banner h1="XLSX konvertálása XLS-re a következőn keresztül: C++" h2="Nagy teljesítményű XLSX-XLS konvertálás a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="XLSX konvertálása XLS-re a következővel: C++" %}}

 Az XLSX XLS-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSX XLS-vé konvertálásának lépései a következőn keresztül: C++" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztői könnyedén konvertálhatnak XLSX fájlt XLS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLSX fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (XLS) fájlkiterjesztéssel.1. Az XLS fájl a megadott elérési útra kerül mentésre.1. Nyissa meg az XLS fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="XLSX–XLS C++ konverziós forráskód" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLSX-ből XLS-be konvertáló élő bemutatók" sectionDescription="[Az XLSX konvertálása XLS-re](https://products.aspose.app/cells/conversion/xlsx-to-xls) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel XLSX fájlját, amely azonnal XLS formátumba konvertálódik." >}}
