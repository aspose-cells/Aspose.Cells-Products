---
title: Konwertuj XLSB na JPEG za pomocą aplikacji C++ 
weight: 6990
url: /pl/cpp/conversion/xlsb-to-jpeg/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLSB do formatu JPEG. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji plików XLSB na JPEG w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSB na JPEG przez C++" h2="Wysoce wydajna konwersja XLSB do JPEG przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLSB na JPEG w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSB przy użyciu Factory::CreateIWorkbook.1. Wybierz pierwszy arkusz.1. Ustaw opcje (JPEG).1. Iteruj przez każdą stronę arkusza i renderuj.1. Otwórz plik JPEG w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLSB do JPEG C++ Kod źródłowy konwersji" offSpacer="" %}}
