---
title: Java MHT en XML - Convertisseur MHT en XML
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le format MHT en XML, permettant un enregistrement transparent des données MHT au format XML à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer MHT au format XML dans Java" %}}

L'exemple suivant montre comment convertir du MHT en XML en Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir un fichier MHT en XML via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers MHT en XML par programmation ? Les développeurs Java peuvent facilement convertir des fichiers MHT en XML en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir MHT en XML" %}}
{{% blocks/products/pf/agp/text %}}
