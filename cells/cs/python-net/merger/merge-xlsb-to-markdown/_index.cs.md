...
url: /cs/python-net/merger/merge-xlsb-to-markdown/ 
...
Následující příklad ukazuje, jak sloučit XLSB až MARKDOWN v Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit XLSB až MARKDOWN? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
