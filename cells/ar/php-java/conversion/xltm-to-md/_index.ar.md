---
title: PHP XLTM إلى MD - XLTM إلى MD محول
description: Aspose اكسل. قم بتحويل XLTM إلى MD بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى MD. PHP احفظ XLTM في MD. احفظ XLTM كـ MD باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى MD عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى MD برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى MD بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى MD عن طريق استدعاء طريقة حفظ المصنف.
