...
description: PDF creatore. Crea file PDF nel codice C++. Genera file PDF utilizzando l'applicazione C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crea file PDF tramite C++" h2="Creazione nativa e ad alte prestazioni di PDF (Portable Document Format) a livello di programmazione senza Micorsoft Office utilizzando la libreria C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come creare PDF tramite C++" %}}
...
1.  Salva la cartella di lavoro come file .pdf usando il metodo Save().

{{% blocks/products/pf/agp/code-block title="Il seguente codice sorgente mostra come creare un file PDF utilizzando C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++ libreria per creare il file PDF" %}}
