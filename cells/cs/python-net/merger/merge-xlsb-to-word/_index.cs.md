---
title: Sloučit XLSB až WORD - Sloučit XLSB až WORD v Python
url: /cs/python-net/merger/merge-xlsb-to-word/ 
description: Aspose Excel. Python Aspose.Cells. Sloučit XLSB do WORD uložit formát. Python Kombinujte formát XLSB až WORD. Sloučit XLSB až WORD v Python. XLSB Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB až WORD pomocí Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB až WORD v Python" %}}

Následující příklad ukazuje, jak sloučit XLSB až WORD v Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XLSB do WORD. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru WORD. Pokud vytvoříte kód v Python, bude to jednodušší, než to zní. Viz příklad Python, který sloučí XLSB do WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení XLSB až WORD v Python" InputFormat="xlsb" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLSB na WORD přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLSB až WORD? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Python ke sloučení XLSB až WORD" %}}
