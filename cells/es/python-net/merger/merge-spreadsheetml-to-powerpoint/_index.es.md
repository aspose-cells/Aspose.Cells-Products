---
title:  Combine SPREADSHEETML con POWERPOINT a través de Python
url: /es/python-net/merger/merge-spreadsheetml-to-powerpoint/ 
description: Combine SPREADSHEETML con POWERPOINT en línea de forma gratuita. Fusión en línea gratuita de SPREADSHEETML a POWERPOINT. Combine SPREADSHEETML con Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo combinar SPREADSHEETML con POWERPOINT en Python.
...
{{% cells-merger title="Aplicación gratuita para fusionar SPREADSHEETML a POWERPOINT en línea" InputFormat="xml" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
