---
title:  FODS zu JSON via Java zusammenführen
url: /de/java/merger/merge-fods-to-json/ 
description: Führen Sie FODS mit JSON kostenlos online zusammen. Kostenlos online FODS bis JSON Fusion. FODS mit Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS und mehr zusammenführen.
---
...
Das folgende Beispiel zeigt, wie FODS mit JSON in Java zusammengeführt wird.
...
{{% cells-merger title="Kostenlose App zum Online-Zusammenführen von FODS mit JSON" InputFormat="fods" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
