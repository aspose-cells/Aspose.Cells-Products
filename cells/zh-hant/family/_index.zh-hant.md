---
title:  .NET Java Python C++ PHP 與 Android Excel 試算表解析 API
weight: 10
description: 用於讀寫和操作 .NET Java C++ Android 和 SharePoint 應用程式中的 Microsoft Excel 檔案的庫。在 SSRS 和 JasperReports 中匯出工作表
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="在多個平台上處理 Excel 電子表格" h2="用於建立、編輯、轉換和呈現 Excel 檔案的本機 API。在任何平台上將電子表格匯出為多種格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells.svg" pfName="Aspose.Cells" downloadUrl="https://downloads.aspose.com/cells" tryOnlineUrl="" >}}

{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/product-card-row title="Aspose.Cells 高程式碼 API 包括" >}}

{{< blocks/products/pf/product pfName="Aspose.Cells for" title=".NET" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" productLink="/cells/net/" >}}
目標 .NET 框架、.NET 核心和 Xamarin 平台，為 Windows、iOS、macOS 和 Android 開發應用程式。
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.Cells for" title="Java" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" productLink="/cells/java/" >}}
用於桌面、Web 或基於 Java SE 或 EE 的任何類型應用程式的本機 Java API。
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.Cells for" title="C++" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" productLink="/cells/cpp/" >}}
從 C++ 應用程式建立、讀取、編輯、轉換或呈現 Excel 電子表格格式。
{{< /blocks/products/pf/product >}}
...
在您的 Android 行動應用程式中新增 Excel 電子表格操作功能。
{{< /blocks/products/pf/product >}}
...
從 SQL Server Reporting Services 將 RDL 和 RDLC 報表匯出為 Excel 檔案格式。
{{< /blocks/products/pf/product >}}

{{< blocks/products/pf/product pfName="Aspose.Cells for" title="賈斯柏報告" imgSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-jasperreports.svg" productLink="/cells/jasperreports/" >}}
從 JasperReports 或 JasperServer 將報告匯出為 Excel 文件格式和 PDF。
{{< /blocks/products/pf/product >}}
...
透過 Node.js 建立、操作、轉換和渲染 Excel 電子表格。
{{< /blocks/products/pf/product >}}
...
透過 JavaBridge 在 PHP 應用程式中建立、操作、轉換和呈現 Excel 電子表格。
{{< /blocks/products/pf/product >}}
...
使用 Python 載入、建立、操作和渲染 Excel 文件。
{{< /blocks/products/pf/product >}}
...
{{< blocks/products/pf/slr-element name="文件" href="https://docs.aspose.com/cells/" >}}
