...
Het volgende voorbeeld laat zien hoe u XLS samenvoegt met MHT in Aspose.Cells for Python via Java.
...
Wilt u XLS programmatisch samenvoegen met MHT? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
