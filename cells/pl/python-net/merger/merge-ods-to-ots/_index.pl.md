...
Poniższy przykład pokazuje, jak scalić ODS z OTS w Aspose.Cells for Python via .NET.
...
Chcesz programowo połączyć numer ODS z OTS? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
