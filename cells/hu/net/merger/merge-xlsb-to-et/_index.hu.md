---
title: A XLSB összevonása ET-vel - XLSB egyesítése ET-vel a C#-ben
url: /hu/net/merger/merge-xlsb-to-et/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés XLSB ET mentési formátumba. C# Kombinálja a XLSB-et ET formátumba. Egyesítse a XLSB-et ET-vel a C#-es számon. XLSB Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a XLSB-es számot ET-hez a C#-es számon online ingyen" %}}

következő példa bemutatja, hogyan lehet egyesíteni a XLSB-et a Aspose.Cells-es for .NET-es ET-vel.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLSB és az ET egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el ET fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a XLSB-et az ET-be.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ingyenes online a XLSB és az ET egyesítése a C#-ben" InputFormat="xlsb" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A XLSB és az ET egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLSB-et az ET-be? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLSB ET-vel való egyesítéséhez" %}}
