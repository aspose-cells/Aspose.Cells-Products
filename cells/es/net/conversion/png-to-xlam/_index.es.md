---
title: C# PNG a XLAM - En línea PNG a XLAM Convertidor
description: AsposeExcel. C# Aspose.Cells. C# Aspose Cells. Gratis en línea C# Convertir PNG a XLAM guardar formato. Formato C# PNG al XLAM. Aparta del PNG al XLAM C#.
...
{{% blocks/products/pf/agp/content h2="Guarde PNG a XLAM en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo convertir PNG a XLAM en C#.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir PNG a XLAM. Cargue su archivo PNG, luego simplemente guárdelo como archivo XLAM. Tanto para la lectura PNG como para la escritura XLAM, puede utilizar nombres de archivo completos. El contenido y el formato de la salida XLAM serán idénticos al documento original PNG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicación gratuita y código de muestra para convertir PNG a XLAM en línea" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="xlam" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir PNG a XLAM a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos PNG a XLAM mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente PNG a XLAM en solo unas pocas líneas de código.
...
1.  Convierta PNG a XLAM llamando al método Workbook.Save.
1.  Obtenga el resultado de la conversión de PNG a XLAM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteca para convertir PNG a XLAM" %}}
