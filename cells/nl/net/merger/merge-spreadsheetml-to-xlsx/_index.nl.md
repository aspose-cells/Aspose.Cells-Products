---
title: Voeg SPREADSHEETML samen met XLSX - Combineer SPREADSHEETML met XLSX in C#
url: /nl/net/merger/merge-spreadsheetml-to-xlsx/ 
description: Aspose Excel. C# Aspose.Cells. Gratis online Samenvoegen SPREADSHEETML naar XLSX saveformat. C# Combineer SPREADSHEETML tot formaat XLSX. Samenvoegen SPREADSHEETML naar XLSX in C#. SPREADSHEETML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg SPREADSHEETML samen met XLSX in C# Online gratis" %}}

Het volgende voorbeeld laat zien hoe SPREADSHEETML kan worden samengevoegd tot XLSX in Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om SPREADSHEETML samen te voegen tot XLSX. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand XLSX. Als u code ontwikkelt in C#, is dit eenvoudiger dan het klinkt. Zie voorbeeld C# dat SPREADSHEETML samenvoegt tot XLSX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om SPREADSHEETML samen te voegen tot XLSX in C#" InputFormat="xml" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hoe SPREADSHEETML samen te voegen tot XLSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u SPREADSHEETML programmatisch samenvoegen met XLSX? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotheek om SPREADSHEETML samen te voegen tot XLSX" %}}
