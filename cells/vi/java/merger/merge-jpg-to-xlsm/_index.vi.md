---
title: Gộp JPG thành XLSM - Gộp JPG thành XLSM vào Java
url: /vi/java/merger/merge-jpg-to-xlsm/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất JPG thành XLSM saveformat. Java Kết hợp JPG thành định dạng XLSM. Hợp nhất JPG thành XLSM trong Java. Hợp nhất JPG.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất JPG thành XLSM trong Java" %}}

Ví dụ sau đây minh họa cách hợp nhất JPG thành XLSM trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để hợp nhất JPG thành XLSM. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp và sau đó lưu vào tệp XLSM. Nếu bạn phát triển mã bằng Java, việc này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Java hợp nhất JPG thành XLSM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mã mẫu ghép JPG thành XLSM trong Java" InputFormat="jpg" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách ghép JPG thành XLSM via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện Java ghép JPG thành XLSM" %}}
