---
title: C# XLT a DIF - XLT a DIF Convertidor
description: Aspose Excel. Convierta XLT a DIF rápida y fácilmente con Aspose.Cells. C# XLT a DIF. C# Guarde XLT en DIF. Guarde XLT como 07611134 81 usando C#.
...
{{% blocks/products/pf/agp/content h2="Guardar XLT al DIF en C#" %}}

El siguiente ejemplo demuestra cómo convertir XLT a DIF en C#.
...
{{% cells-convert title="Código de muestra para convertir XLT a DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="dif" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir XLT a DIF a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos XLT a DIF mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente XLT a DIF en solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para convertir XLT en DIF" %}}
