...
{{% blocks/products/pf/agp/content h2="Convertir HTM en DIF en utilisant Python" %}}
...
L'exemple suivant montre comment convertir HTM en DIF en Python.
