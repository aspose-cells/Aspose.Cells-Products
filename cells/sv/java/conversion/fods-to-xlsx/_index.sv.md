---
title: Konvertera FODS till XLSX via Java 
url: /sv/java/conversion/fods-to-xlsx/ 
description: Exempel på Java-konverteringskod för FODS-format till XLSX-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till XLSX inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar FODS till XLSX med Java" %}}

 För att rendera FODS till XLSX kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera FODS till XLSX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera FODS-fil till XLSX på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda FODS-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med XLSX-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande XLSX-filen
...
{{% blocks/products/pf/agp/code-block title="FODS till XLSX Java omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="FODS till XLSX Conversion Live Demos" sectionDescription="[Konvertera FODS till XLSX](https://products.aspose.app/cells/conversion/fods-to-xlsx) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din FODS-fil, den kommer omedelbart att konverteras till XLSX." >}}
