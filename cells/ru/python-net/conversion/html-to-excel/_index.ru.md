...
description: Aspose Эксель. Преобразуйте HTML в EXCEL быстро и легко с помощью Aspose.Cells. Python HTML в EXCEL. Python Сохраните HTML в EXCEL. Сохраните HTML как EXCEL, используя Python.
...
{{% blocks/products/pf/agp/content h2="Преобразовать HTML в EXCEL в Python" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTML в EXCEL в Python." %}}

В следующем примере показано, как преобразовать HTML в EXCEL в Python via NET.
...
{{% cells-convert title="Пример кода для преобразования HTML в EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="xlsx" IsLandingPage="true" language="pythonnet" %}}
...
{{% blocks/products/pf/agp/content h2="Библиотека Python для преобразования HTML в EXCEL" %}}
