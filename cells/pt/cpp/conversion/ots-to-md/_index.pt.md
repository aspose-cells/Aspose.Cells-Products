...
{{% cells-convert title="Exemplo de código para converter OTS em MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="md" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter OTS em MD via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos OTS em MD programaticamente? Os desenvolvedores do C++ podem converter facilmente OTS em MD em apenas algumas linhas de código.
...
1.  Converta OTS em MD chamando o método Save().
