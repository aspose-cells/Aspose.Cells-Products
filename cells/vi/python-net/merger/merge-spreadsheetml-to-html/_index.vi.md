...
description: Aspose Excel. Python Aspose.Cells. Hợp nhất bảng tính thành định dạng lưu HTML. Python Kết hợp BẢNG TÍNH sang định dạng HTML. Hợp nhất BẢNG TÍNH với HTML trong Python. Hợp nhất BẢNG TÍNH. Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất BẢNG TÍNH vào HTML Sử dụng Python" %}}
...
{{% blocks/products/pf/agp/content h2="Hợp nhất BẢNG TÍNH vào HTML trong Python" %}}

Ví dụ sau đây minh họa cách hợp nhất SPREADSHEETML với HTML trong Aspose.Cells for Python via .NET.
...
{{% cells-merger title="Mã mẫu để hợp nhất SPREADSHEETML thành HTML trong Python" InputFormat="xml" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
