---
title: Java EXCEL в FODS - Онлайн конвертер EXCEL в FODS
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Бесплатно онлайн Java Конвертировать EXCEL в формат сохранения FODS. Java EXCEL в формате FODS. Сохраните EXCEL в FODS Java.
...
{{% blocks/products/pf/agp/content h2="Сохранить EXCEL в FODS в Java онлайн бесплатно" %}}
...
{{% cells-convert title="Бесплатное приложение и пример кода для преобразования EXCEL в FODS онлайн" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="fods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Как преобразовать EXCEL в FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы EXCEL в FODS? Разработчики Java могут легко преобразовать EXCEL в FODS всего за несколько строк кода.
