---
title: Fusionar XLSM con XLAM - Combinar XLSM con XLAM en Java
url: /es/java/merger/merge-xlsm-to-xlam/ 
description: Aspose Excel. Java Aspose.Cells. Fusionar XLSM con XLAM guardar formato. Java Combina el formato XLSM con XLAM. Fusionar XLSM con XLAM en Java. XLSM Fusionar.
...
{{% blocks/products/pf/agp/content h2="Fusionar XLSM con XLAM en Java" %}}

El siguiente ejemplo demuestra cómo fusionar XLSM con XLAM en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLSM con XLAM. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo XLAM. Si desarrolla código en Java, esto será más simple de lo que parece. Vea el ejemplo de Java que fusiona XLSM con XLAM.
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar XLSM con XLAM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLSM con XLAM mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden crear con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Java para fusionar XLSM con XLAM" %}}
