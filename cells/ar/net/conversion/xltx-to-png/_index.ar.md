---
title: C# XLTX إلى PNG - عبر الإنترنت من XLTX إلى PNG
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل XLTX إلى PNG saveformat. C# XLTX إلى تنسيق PNG. وفر XLTX إلى PNG C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="حوّل XLTX إلى PNG في C#" h2="مكتبة C# عالية السرعة لتحويل XLTX إلى PNG. هذا حل برمجي احترافي لاستيراد وتصدير XLTX و PNG والعديد من التنسيقات الأخرى على .NET Framework أو .NET Core أو Mono الأنظمة الأساسية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
تحتاج إلى تحويل XLTX ملفات إلى PNG برمجيا؟ يمكن للمطورين .NET تحميل وتحويل XLTX إلى PNG بسهولة في بضعة أسطر من التعليمات البرمجية.
