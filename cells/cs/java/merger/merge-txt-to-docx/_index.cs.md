---
title:  Sloučit TXT až DOCX via Java
...
Následující příklad ukazuje, jak sloučit TXT až DOCX v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení TXT až DOCX online" InputFormat="txt" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
