---
title:  Combinar TXT a XLT vía Python
url: /es/python-net/merger/merge-txt-to-xlt/ 
description: Combine TXT a XLT en línea de forma gratuita. Gratis Online TXT a XLT Fusión. Combine TXT con Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo combinar TXT con XLT en Python.
...
{{% cells-merger title="Aplicación gratuita para fusionar TXT a XLT en línea" InputFormat="txt" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
