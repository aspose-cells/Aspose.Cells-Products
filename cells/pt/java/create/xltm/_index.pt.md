---
title: Criar XLTM - Criar arquivo XLTM em Java
description: Aspose Excel. Java Criar XLTM Arquivo. Criar XLTM Java. Java XLTM Criador. Crie XLTM em Java. Gere o arquivo XLTM usando Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Criar arquivo XLTM em Java" h2="Biblioteca Java de alta velocidade para criar o arquivo XLTM. Esta é uma solução de software profissional para importar e exportar XLSX, PDF e muitos outros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como criar XLTM em Java" %}}
...
1.  Salve a pasta de trabalho no formato XLTM usando o método save().

{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar o arquivo XLTM em Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para criar o arquivo XLTM" %}}
{{% blocks/products/pf/agp/text %}}
