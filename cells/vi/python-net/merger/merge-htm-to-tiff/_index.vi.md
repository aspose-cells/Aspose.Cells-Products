...
url: /vi/python-net/merger/merge-htm-to-tiff/ 
...
Ví dụ sau đây minh họa cách hợp nhất HTM thành TIFF trong Aspose.Cells for Python via .NET.
...
Cần hợp nhất HTM vào TIFF theo chương trình? Một tài liệu cơ bản hợp nhất và nối với[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API có thể được thực hiện chỉ với vài dòng mã.
