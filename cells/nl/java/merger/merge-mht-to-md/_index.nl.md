---
title: Voeg MHT samen met MD - Combineer MHT met MD in Java
url: /nl/java/merger/merge-mht-to-md/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online MHT samenvoegen naar MD-opslagformaat. Java Combineer MHT naar MD-formaat. MHT samenvoegen naar MD in Java. MHT samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg gratis MHT samen met MD in Java online" %}}

Het volgende voorbeeld laat zien hoe u MHT kunt samenvoegen met MD in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om MHT samen te voegen met MD. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in een MD-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat MHT samenvoegt met MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om MHT samen te voegen met MD in Java" InputFormat="mht" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="MHT samenvoegen met MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u MHT programmatisch samenvoegen met MD? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om MHT naar MD samen te voegen" %}}
