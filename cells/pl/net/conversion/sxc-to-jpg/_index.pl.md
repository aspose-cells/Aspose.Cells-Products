...
description: Aspose Excel. Szybko i łatwo przekonwertuj SXC na JPG za pomocą Aspose.Cells. C# SXC na JPG. C# Zapisz SXC w formacie JPG. Zapisz SXC jako JPG, używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz SXC w JPG w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować SXC na JPG w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji SXC na JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="jpg" IsLandingPage="true" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji SXC do formatu JPG" %}}
