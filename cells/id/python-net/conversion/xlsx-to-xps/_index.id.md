...
description: Aspose Unggul. Ubah XLSX menjadi XPS dengan cepat dan mudah dengan Aspose.Cells. Python XLSX menjadi XPS. Python Simpan XLSX menjadi XPS. Simpan XLSX sebagai 07611134 81 menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Ubah XLSX menjadi XPS di Python" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX hingga XPS di Python" %}}

Contoh berikut menunjukkan cara mengonversi XLSX menjadi XPS di Python via NET.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengubah XLSX menjadi XPS" %}}
