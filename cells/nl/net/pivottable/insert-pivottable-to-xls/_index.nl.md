---
title:  Draaitabel invoegen in Microsoft Excel XLS-bestanden via C#
weight: 7690
description: C# Voorbeeldcode voor het toevoegen van draaitabel aan XLS met behulp van bibliotheek .NET. Gebruik deze code voor het invoegen van de draaitabel in het XLS-bestand binnen VB.NET, Asp.NET of een op .NET gebaseerde toepassing.
...
{{< blocks/products/pf/i18n/upper-banner h1="Draaitabel invoegen in XLS Documenten via C#" h2="Systeemeigen en krachtige Microsoft Excel XLS-spreadsheet waarbij draaitabel programmatisch kan worden gemaakt met behulp van .NET-API\'s aan de serverzijde." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Het dynamisch genereren van een MS Excel XLS-bestand met draaitabel binnen een actieve applicatie is eenvoudig. Om vanuit het niets XLS-documenten met draaitabel te maken zonder dat we MS Office nodig hebben, gebruiken we[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dat verschillende functies biedt voor het maken, manipuleren en converteren van spreadsheets met behulp van het .NET-platform. Ontwikkelaars kunnen eenvoudig de code verbeteren voor het schrijven van gegevens, het genereren van diagrammen of grafieken en het maken van tabellen in spreadsheets.
{{% /blocks/products/pf/agp/content %}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Draaitabel invoegen in XLS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Het is voor de ontwikkelaars gemakkelijk om een draaitabel in een spreadsheet in XLS-indeling in te voegen in verschillende rapportagetoepassingen voor gegevensverwerking in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="Draaitabel invoegen in XLS - C#" offSpacer="" %}}
