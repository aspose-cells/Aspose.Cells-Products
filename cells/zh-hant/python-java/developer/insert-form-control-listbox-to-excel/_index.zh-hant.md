---
title: 通過 Python 將 ListBox(Form 控件)插入 Excel
weight: 50
description: Python 將 ListBox（表單控件）插入 Excel 的源代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Python 將 ListBox(Form 控件)插入 Excel" h2="使用服務器端 API 插入對象，無需任何軟件，如 Microsoft 或 Open Office、Adobe PDF 等。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Python 將列錶框（表單控件）插入 Excel 文件" %}}

為了將 ListBox（表單控件）插入到 excel 文件中，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過Python將ListBox（表單控件）插入Excel文件的步驟" %}}
...
+ 通過索引選擇工作表。
 + 使用 shapecollection 的[添加方法](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addListBox(int,%20int,%20int,%20int,%20int,%20int)) 在選定的工作表中插入一個 ListBox（窗體控件）。
以 XLSX 格式保存工作簿。
...
{{% blocks/products/pf/agp/code-block title="插入列錶框（表單控件）- Python" offSpacer="" %}}
