---
title: Insert Spin Button(Form control) into Excel using Python via java 
weight: 40
...
{{% blocks/products/pf/agp/content h2="How to Insert Spin Button(Form control) into Excel File Using Python via java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Spin Button(Form control) to Excel file using Python via java" %}}
...
+  Use the shapecollection's [add method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addSpinner(int,%20int,%20int,%20int,%20int,%20int)) to insert a Spin Button(Form control) in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert Spin Button(Form control) - Python via java" offSpacer="" %}}
