---
title: Conversor PHP TSV para XLT - TSV para XLT
description: Aspose Excel. Converta TSV em XLT de forma rápida e fácil com Aspose.Cells. PHP TSV em XLT. PHP Salve TSV em XLT. Salve TSV como XLT usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter TSV em XLT via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos TSV em XLT programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter TSV em XLT em apenas algumas linhas de código.
...
1.  Converta TSV em XLT chamando o método save da pasta de trabalho.
