...
description: Aspose Excel. C++ Aspose.Cells. Sloučit PRN do formátu uložení MHTML. C++ Zkombinujte PRN do formátu MHTML. Sloučit PRN na MHTML v C++. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN na MHTML v C++" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení PRN s MHTML v C++" InputFormat="prn" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
