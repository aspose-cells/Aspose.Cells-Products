---
title: C# XML do MHT - Převodník XML do MHT
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C# plně integrovaný přístup k převodu XML do formátu MHT, což umožňuje bezproblémové ukládání XML dat do formátu MHT pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C#.
...
Následující příklad ukazuje, jak převést XML na MHT v adresáři C#.
...
{{% blocks/products/pf/agp/content h2="Jak převést XML do MHT přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově převést soubory XML do formátu MHT? Vývojáři na webu .NET mohou snadno načíst a převést XML do formátu MHT pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod XML do MHT" %}}
