---
title: C# SXC à XPS - Convertisseur en ligne SXC à XPS
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Gratuit en ligne C# Convertir SXC en format de sauvegarde XPS. Format C# SXC à XPS. Enregistrez SXC à XPS C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrez SXC à XPS dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment convertir SXC en XPS en C#.
...
Besoin de convertir les fichiers SXC en XPS par programmation ? Les développeurs .NET peuvent facilement charger et convertir SXC en XPS en quelques lignes de code.
