...
url: /ja/python-net/merger/merge-png-to-numbers/ 
...
次の例は、PNG を Aspose.Cells for Python via .NET の NUMBERS にマージする方法を示しています。
...
PNG をプログラムで NUMBERS にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)API はわずか数行のコードで実行できます。
