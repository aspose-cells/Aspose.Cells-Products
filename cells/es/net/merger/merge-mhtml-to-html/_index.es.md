---
title:  Combinar MHTML a HTML vía C#
url: /es/net/merger/merge-mhtml-to-html/ 
description: Combine MHTML a HTML en línea de forma gratuita. Gratis Online MHTML a HTML Fusión. Combine MHTML con Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS y más.
---
...
El siguiente ejemplo muestra cómo combinar MHTML con HTML en C#.
...
{{% cells-merger title="Aplicación gratuita para fusionar MHTML a HTML en línea" InputFormat="mhtml" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
