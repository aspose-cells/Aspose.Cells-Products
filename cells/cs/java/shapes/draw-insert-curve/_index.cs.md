...
{{% blocks/products/pf/agp/content h2="Jak vložit zakřivený tvar do souboru aplikace Excel pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Postup vložení zakřiveného tvaru do souboru aplikace Excel via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Vložte zakřivený tvar - Java" offSpacer="" %}}
