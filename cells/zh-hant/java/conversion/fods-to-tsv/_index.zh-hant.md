...
{{% blocks/products/pf/agp/content h2="免費在線保存FODS至TSV至Java" %}}

以下示例演示如何將 Java 中的 FODS 轉換為 TSV。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 FODS 轉換為 TSV。上傳您的 FODS 文件，然後將其另存為 TSV 文件。對於 FODS 讀取和 TSV 寫入，您可以使用完全限定的文件名。輸出 TSV 內容和格式將與原始 FODS 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="在線將 FODS 轉換為 TSV 的免費應用程序和示例代碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="tsv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何將 FODS 轉換為 TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java 開發人員只需幾行代碼就可以輕鬆地將 FODS 轉換為 TSV。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Workbook 類的實例加載 FODS 文件
1. 通過調用 Workbook.save 方法將 FODS 轉換為 TSV

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Java 庫將 FODS 轉換為 TSV" %}}
{{% blocks/products/pf/agp/text %}}
