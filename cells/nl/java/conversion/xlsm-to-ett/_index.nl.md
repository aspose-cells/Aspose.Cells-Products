...
Het volgende voorbeeld laat zien hoe je XLSM omzet naar ETT in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSM om naar ETT via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u XLSM-bestanden programmatisch naar ETT converteren? Ontwikkelaars van Java kunnen XLSM-bestanden eenvoudig in een paar regels code naar ETT converteren.
