...
Ví dụ sau đây minh họa cách hợp nhất XLTM với JPEG trong Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/content h2="Thư viện C++ gộp XLTM thành JPEG" %}}
