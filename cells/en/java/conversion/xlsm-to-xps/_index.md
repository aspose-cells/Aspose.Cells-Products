...
The following example demonstrates how to convert XLSM to XPS document format in Java.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert XLSM file into XPS format. Upload your XLSM file, then simply save it as XPS file. For both XLSM reading and XPS writing you can use fully qualified filenames. The output XPS content and formatting will be identical to the original XLSM document.
