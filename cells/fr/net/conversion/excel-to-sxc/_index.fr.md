...
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir EXCEL au format SXC, permettant un enregistrement transparent des données EXCEL au format SXC à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer EXCEL sous SXC dans C#" %}}
...
1.  Convertissez le fichier EXCEL au format SXC en appelant la méthode Workbook.Save.
