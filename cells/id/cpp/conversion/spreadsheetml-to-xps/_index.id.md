---
title: Konversi SPREADSHEETML ke XPS melalui C++ aplikasi 
url: /id/cpp/conversion/spreadsheetml-to-xps/ 
description: Contoh C++ kode konversi untuk dokumen SPREADSHEETML ke format XPS. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch SPREADSHEETML ke XPS dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan SPREADSHEETML ke XPS melalui C++" h2="Konversi SPREADSHEETML ke XPS kinerja tinggi menggunakan pustaka C++ tanpa memerlukan instalasi Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file SPREADSHEETML ke XPS hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file SPREADSHEETML menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file keluaran dengan ekstensi file (XPS).1. File XPS akan disimpan di jalur yang ditentukan.1. Buka file XPS di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML ke XPS C++ Kode Sumber Konversi" offSpacer="" %}}
