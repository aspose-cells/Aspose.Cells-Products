...
url: /hu/cpp/merger/merge-prn-to-sql/ 
...
A következő példa bemutatja, hogyan egyesítheti a PRN-t SQL-be a Aspose.Cells for C++-ben.
...
Programozottan egyesítenie kell a PRN-t SQL-be? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a PRN és az SQL egyesítéséhez" %}}
