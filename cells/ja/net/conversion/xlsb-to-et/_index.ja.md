---
title: C# XLSB から ET - オンライン XLSB から ET コンバータ
description: Aspose エクセル。 C# Aspose.Cells. C# Aspose Cells. 無料オンライン C# XLSB を ET 保存形式に変換します。 C# XLSB を ET 形式に変換します。 XLSB を ET C# に保存します。
...
{{% blocks/products/pf/agp/content h2="XLSBをオンラインでETのXLSBに無料で保存" %}}
...
{{% cells-convert title="XLSBをETオンラインに変換する無料アプリとサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="XLSBを経由してXLSBをETに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSB ファイルをプログラムで ET に変換する必要がありますか? .NET 開発者は、わずか数行のコードで XLSB を簡単にロードして ET に変換できます。
...
{{% blocks/products/pf/agp/content h2="XLSB を ET に変換するための C# ライブラリ" %}}
