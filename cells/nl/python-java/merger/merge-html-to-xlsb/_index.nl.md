---
title: Voeg HTML samen met XLSB - Combineer HTML met XLSB in Python
url: /nl/python-java/merger/merge-html-to-xlsb/ 
description: Aspose Excel. Python Excel. Voeg HTML samen met het opslagformaat XLSB. Python Combineer het formaat HTML met XLSB. Voeg HTML samen met XLSB in de Excel-bibliotheek Python. HTML Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Hoe u HTML samenvoegt met XLSB via de Excel-bibliotheek Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u HTML programmatisch samenvoegen met XLSB? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om HTML samen te voegen met XLSB" %}}
