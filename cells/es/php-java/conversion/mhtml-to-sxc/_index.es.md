---
title: Convertidor PHP MHTML a SXC - MHTML a SXC
description: Aspose Excel. Convierta MHTML a SXC rápida y fácilmente con Aspose.Cells. PHP MHTML a SXC. PHP Guarde MHTML a SXC. Guarde MHTML como SXC usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir MHTML a SXC mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos MHTML a SXC mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente MHTML a SXC en tan solo unas pocas líneas de código.
...
1.  Convierta MHTML a SXC llamando al método guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de MHTML a SXC.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir MHTML a SXC" %}}
