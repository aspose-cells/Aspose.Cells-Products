...
description: Aspose Excel. C++ Aspose.Cells. Merge OTS to XPS saveformat. C++ Combine OTS to XPS format. Merge OTS to XPS in C++. OTS Merge.
...
{{% blocks/products/pf/agp/content h2="Merge OTS to XPS in C++" %}}
...
{{% cells-merger title="Sample Code to Merge OTS to XPS in C++" InputFormat="ots" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
