...
description: Sample Java conversion code for NUMBERS format to XLSX file. Programmers can use this example code to export Excel & OpenOffice spreadsheets to XLSX within any Web or Desktop Java based Application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert NUMBERS to XLSX Using Java" %}}

 In order to render NUMBERS to XLSX, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert NUMBERS to XLSX via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="NUMBERS to XLSX Java Conversion Source Code" offSpacer="" %}}

```cs
// load the NUMBERS file in an instance of Workbook
Workbook book = new Workbook("template.numbers");
// save NUMBERS as XLSX
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS to XLSX Conversion Live Demos" sectionDescription="[Convert NUMBERS to XLSX](https://products.aspose.app/cells/conversion/numbers-to-xlsx) right now by visiting our Live Demos website.The live demo has the following benefits" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Just upload your NUMBERS file, it will be converted instantly to XLSX." >}}
