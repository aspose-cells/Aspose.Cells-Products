...
{{% blocks/products/pf/agp/content h2="Python via .नेट का उपयोग करके एक्सेल फ़ाइल में लिस्टबॉक्स (फॉर्म नियंत्रण) कैसे डालें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via .नेट का उपयोग करके एक्सेल फ़ाइल में लिस्टबॉक्स (फॉर्म नियंत्रण) सम्मिलित करने के चरण" %}}
...
+ इसके सूचकांक के माध्यम से वर्कशीट का चयन करें।
 + शेपकलेक्शन के ऐड का उपयोग करें[तरीका](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_list_box/#int-int-int-int-int-int) चयनित वर्कशीट में एक लिस्टबॉक्स (फॉर्म नियंत्रण) सम्मिलित करने के लिए।
...
{{% blocks/products/pf/agp/code-block title="लिस्टबॉक्स डालें (फॉर्म नियंत्रण) - Python via .नेट" offSpacer="" %}}
