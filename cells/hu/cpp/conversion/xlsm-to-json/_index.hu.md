---
title: Konvertálja az XLSM-et JSON-ba a(z) C++ alkalmazáson keresztül 
url: /hu/cpp/conversion/xlsm-to-json/ 
description: Minta C++ konverziós kód az XLSM dokumentumhoz JSON formátumba. A programozók ezt a forráskódot használhatják az XLSM-ből JSON-ba kötegelt konvertáláshoz bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSM konvertálása JSON-ra a következőn keresztül: C++" h2="Nagy teljesítményű XLSM–JSON konvertálás a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Az XLSM konvertálása JSON-ba a következővel: C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSM konvertálása JSON-ra a következőn keresztül: C++" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztői könnyedén konvertálhatják az XLSM fájlt JSON formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLSM fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (JSON) fájlkiterjesztéssel.1. A JSON-fájl a megadott elérési útra kerül mentésre.1. Nyissa meg a JSON fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="Az XLSM-ből JSON-ba C++ konverziós forráskód" offSpacer="" %}}
