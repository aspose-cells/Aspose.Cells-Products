...
{{< blocks/products/pf/i18n/upper-banner h1="Chèn chú thích vào Excel via Java" h2="Chèn chú thích bằng Aspose.Cells\' API không cần phần mềm nào như Microsoft hay Open Office, Adobe PDF,.." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chèn Chú Thích Vào File Excel Sử Dụng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn Callout vào file Excel via Java" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng[thêm phương pháp](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) để chèn chú thích vào bảng tính đã chọn
...
Mã mẫu bên dưới minh họa cách chèn "Bong bóng suy nghĩ: Đám mây". Để biết thêm các loại, vui lòng tham khảo "Tổng quan về các loại chú thích chặn" bên dưới.
