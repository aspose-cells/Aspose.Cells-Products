...
description: Aspose Excel. Python Aspose.Cells. Gratis online Samenvoegen XLSM naar XLS saveformat. Python Combineer het formaat XLSM tot XLS. Samenvoegen XLSM tot XLS in Python. XLSM Samenvoegen.
...
Het volgende voorbeeld laat zien hoe u XLSM kunt samenvoegen met XLS in Aspose.Cells for Python via Java.
...
{{% cells-merger title="Gratis online om XLSM samen te voegen tot XLS in Python" InputFormat="xlsm" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hoe XLSM samen te voegen met XLS via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSM programmatisch samenvoegen tot XLS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API's kunnen worden gedaan met slechts enkele regels code.
