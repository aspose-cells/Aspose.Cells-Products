---
title: Fusionar XML con EXCEL - Combinar XML con EXCEL en C++
url: /es/cpp/merger/merge-xml-to-excel/ 
description: Aspose Excel. C++ Aspose.Cells. Fusionar XML con el formato guardado de EXCEL. C++ Combina formato XML a EXCEL. Fusionar XML con EXCEL en C++. Fusionar XML.
...
{{% blocks/products/pf/agp/content h2="Fusionar XML con EXCEL en C++" %}}

El siguiente ejemplo demuestra cómo fusionar XML con EXCEL en Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XML con EXCEL. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo EXCEL. Si desarrolla código en C++, esto será más simple de lo que parece. Vea el ejemplo C++ que combina XML con EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Código de muestra para fusionar XML con EXCEL en C++" InputFormat="xml" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XML con EXCEL a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XML con EXCEL mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Las API se pueden crear con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para fusionar XML con EXCEL" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/merger/merge-xml-to-tsv/" name="Fusionar XML con TSV" description="Valores separados por tabulaciones" >}}
