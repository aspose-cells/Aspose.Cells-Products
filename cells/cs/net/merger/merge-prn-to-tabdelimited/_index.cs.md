---
title: Sloučit PRN s TABDELIMITED – Kombinovat PRN s TABDELIMITED v C#
url: /cs/net/merger/merge-prn-to-tabdelimited/ 
description: Aspose Excel. C# Aspose.Cells. Sloučit PRN do formátu uložení TABDELIMITED. C# Zkombinujte PRN do formátu TABDELIMITED. Sloučit PRN do TABDELIMITED v C#. PRN Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit PRN s TABDELIMITED v C#" %}}

Následující příklad ukazuje, jak sloučit PRN do TABDELIMITED v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení PRN do TABDELIMITED. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru TABDELIMITED. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí PRN do TABDELIMITED.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení PRN do TABDELIMITED v C#" InputFormat="prn" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit PRN do TABDELIMITED přes C#" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit PRN do TABDELIMITED programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovnu pro sloučení PRN do TABDELIMITED" %}}
