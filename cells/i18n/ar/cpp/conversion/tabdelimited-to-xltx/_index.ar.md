---
title: تحويل TABDELIMITED إلى XLTX عبر تطبيق C++ 
url: /ar/cpp/conversion/tabdelimited-to-xltx/ 
description: نموذج C++ رمز تحويل لمستند TABDELIMITED إلى تنسيق XLTX. يمكن للمبرمجين استخدام رمز المصدر هذا للتحويل الدفعي من TABDELIMITED إلى XLTX داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TABDELIMITED إلى XLTX عبر C++" h2="عالية الأداء TABDELIMITED لتحويل XLTX باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ تحويل ملف TABDELIMITED بسهولة إلى XLTX في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف TABDELIMITED باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (XLTX).1. سيتم حفظ ملف XLTX في المسار المحدد.1. افتح ملف XLTX في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED إلى XLTX C++ رمز مصدر التحويل" offSpacer="" %}}
