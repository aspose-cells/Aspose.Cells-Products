---
title:  Python via Java'yı kullanarak Excel'e nasıl çift düz ok çizerim veya eklerim?
weight: 10
description: Python via Excel'e çift düz ok çizmek veya eklemek için Java kaynak kodu.
...
{{< blocks/products/pf/i18n/upper-banner h1="Python via java kullanarak Excel\'e çift düz ok ekleyin" h2="Aspose.Cells\' API\'i kullanarak, Microsoft veya Open Office, Adobe PDF vb. herhangi bir yazılım olmadan çift düz ok ekleyin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python via java kullanarak Excel Dosyasına çift düz ok nasıl eklenir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python via java kullanarak Excel dosyasına çift düz ok ekleme adımları" %}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Şekil koleksiyonunu kullanın[yöntem ekle](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) seçili çalışma sayfasına çift düz ok eklemek için.
...
{{% blocks/products/pf/agp/code-block title="Çift düz ok ekle - Python via java" offSpacer="" %}}
