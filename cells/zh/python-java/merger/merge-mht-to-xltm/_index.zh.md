...
下面的示例演示如何将 MHT 合并到 Aspose.Cells for Python via Java 中的 XLTM。
...
需要以编程方式将 MHT 合并到 XLTM 吗？合并和连接的基本文档[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)只需几行代码即可完成 API。
