---
title: Объединить ЧИСЛА в СЛОВО - Объединить ЧИСЛА в СЛОВО в C#
url: /ru/net/merger/merge-numbers-to-word/ 
description: Aspose Excel. C# Aspose.Cells. Бесплатное онлайн слияние NUMBERS в WORD в сохраненном формате. C# Объедините ЧИСЛА в формат СЛОВА. Объединить ЧИСЛА в СЛОВО в C#. Объединить ЧИСЛА.
...
{{% blocks/products/pf/agp/content h2="Соедините ЦИФРЫ в СЛОВО в C# онлайн бесплатно" %}}

В следующем примере показано, как объединить NUMBERS в WORD в Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить ЧИСЛА в СЛОВО. Загрузите свои файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файле WORD. Если вы разрабатываете код в C#, это будет проще, чем кажется. См. пример C#, объединяющий NUMBERS в WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Бесплатно онлайн объединить ЦИФРЫ в СЛОВО в C#" InputFormat="numbers" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Как объединить ЦИФРЫ в СЛОВО через C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно объединить NUMBERS в WORD? Базовый документ сливается и объединяется с[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API можно реализовать всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2=".NET библиотека для слияния NUMBERS в WORD" %}}
