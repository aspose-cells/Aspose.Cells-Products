...
{{% blocks/products/pf/agp/feature-section-col title="Java ile HTML Nasıl Oluşturulur" %}}
...
{{% blocks/products/pf/agp/code-block title="Aşağıdaki kaynak kod, Java kullanarak bir HTML dosyasının nasıl oluşturulacağını gösterir." offSpacer="" %}}
