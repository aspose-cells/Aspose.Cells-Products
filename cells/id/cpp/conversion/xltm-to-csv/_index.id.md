---
title: Konversi XLTM ke CSV melalui C++ aplikasi 
url: /id/cpp/conversion/xltm-to-csv/ 
description: Contoh C++ kode konversi untuk dokumen XLTM ke format CSV. Pemrogram dapat menggunakan kode sumber ini untuk konversi batch XLTM ke CSV dalam C++ Aplikasi apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan XLTM ke CSV melalui C++" h2="Konversi XLTM ke CSV berperforma tinggi menggunakan pustaka C++ tanpa memerlukan penginstalan Microsoft Excel, OpenOffice, atau Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ pengembang dapat dengan mudah mengonversi file XLTM ke CSV hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file XLTM menggunakan Factory::CreateIWorkbook.1. Panggil metode Simpan().1. Lewati jalur file output dengan ekstensi file (CSV).1. File CSV akan disimpan di jalur yang ditentukan.1. Buka file CSV di program yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="XLTM ke CSV C++ Kode Sumber Konversi" offSpacer="" %}}
