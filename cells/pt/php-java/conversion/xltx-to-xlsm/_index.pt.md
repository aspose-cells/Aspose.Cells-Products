---
title: Conversor PHP XLTX para XLSM - XLTX para XLSM
description: Aspose Excel. Converta XLTX em XLSM de forma rápida e fácil com Aspose.Cells. PHP XLTX em XLSM. PHP Salve XLTX em XLSM. Salve XLTX como XLSM usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter XLTX em XLSM via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLTX em XLSM programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter XLTX em XLSM em apenas algumas linhas de código.
...
1.  Converta XLTX em XLSM chamando o método save da pasta de trabalho.
