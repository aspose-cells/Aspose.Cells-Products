...
{{% blocks/products/pf/agp/content h2="Zaoszczędź SXC na ETT w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak przekonwertować SXC na ETT w C#.
...
{{% cells-convert title="Bezpłatna aplikacja i przykładowy kod do konwersji SXC na ETT Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="ett" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować SXC na ETT przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Programiści .NET mogą łatwo załadować i przekonwertować SXC na ETT w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1.  Załaduj plik SXC z instancją skoroszytu
1.  Przekonwertuj SXC na ETT, wywołując metodę Workbook.Save

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteka do konwersji SXC na ETT" %}}
