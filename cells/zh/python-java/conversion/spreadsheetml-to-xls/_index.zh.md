---
title: 通过 Python 将 SPREADSHEETML 转换为 XLS
url: /zh/python-java/conversion/spreadsheetml-to-xls/
description: 电子表格到 xls Python 转换的示例代码。在 Python 应用程序中使用 API 示例代码将电子表格ml 文件批量转换为 xls。
---
...
{{% blocks/products/pf/agp/content h2="如何使用 Python 将 SPREADSHEETML 转换为 XLS" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Python 将 SPREADSHEETML 转换为 XLS 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 Python 开发人员只需几行代码即可轻松加载 SPREADSHEETML 文件并将其转换为 XLS。
...
{{% cells-convert title="将 SPREADSHEETML 转换为 XLS 的免费应用程序和示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="xls" IsLandingPage="true" language="python" %}}
