---
title:  حماية وقفل XLS مستند via Java
weight: 5070
description: نموذج التعليمات البرمجية Java لقفل ملف XLS باستخدام كلمة المرور في بيئة تشغيل Java لتطبيقات JSP/JSF وتطبيقات سطح المكتب.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات حماية XLS ملفات via Java" %}}
...
1.  قم بتحميل الملف XLS عن طريق إنشاء فئة المصنف
