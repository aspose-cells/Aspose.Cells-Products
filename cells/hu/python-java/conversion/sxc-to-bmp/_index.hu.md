---
title: "SXC konvertálása BMP-vé a következőn keresztül: Python"

description: Mintakód az sxc–bmp Python konverzióhoz. Használjon API példakódot kötegelt sxc fájlok bmp konvertálásához a Python alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SXC konvertálása BMP-vé a következőn keresztül: Python" h2="Exportáljon Excel® táblázatokat BMP formátumba Python API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása BMP-vé a következővel: Python" %}}

 Az SXC BMP-vé konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések az SXC konvertálásához BMP-vé a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői könnyedén betölthetnek és konvertálhatnak SXC fájlokat BMP-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az SXC-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal átadása BMP kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott BMP-fájl megadott elérési útját
