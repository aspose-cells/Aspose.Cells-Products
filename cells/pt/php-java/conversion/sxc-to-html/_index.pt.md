---
title: Conversor PHP SXC para HTML - SXC para HTML
description: Aspose Excel. Converta SXC em HTML de forma rápida e fácil com Aspose.Cells. PHP SXC em HTML. PHP Salve SXC em HTML. Salve SXC como HTML usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em HTML via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em HTML programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em HTML em apenas algumas linhas de código.
...
1.  Converta SXC em HTML chamando o método save da pasta de trabalho.
