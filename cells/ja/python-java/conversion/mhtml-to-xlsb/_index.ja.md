---
title: Python MHTML から XLSB - MHTML から XLSB へのコンバータ
description: Aspose Excel。この包括的なソリューションは、Python開発者に、MHTMLをXLSB形式に変換するための完全に統合されたアプローチを提供し、Aspose.Cellsライブラリを使用してMHTMLデータをXLSB形式にシームレスに保存することを可能にします。これらはすべて、効率的でカスタマイズ可能なPythonコードを通じて行われます。
...
{{% blocks/products/pf/agp/content h2="Python Excel ライブラリを使用して MHTML を XLSB に変換する" %}}
...
{{% blocks/products/pf/agp/content h2="MHTML から XLSB を Python Excel ライブラリに保存します" %}}

次の例は、Python Excel ライブラリで MHTML を XLSB に変換する方法を示しています。
{{% blocks/products/pf/agp/text %}}

MHTML を XLSB に変換するには、簡単な手順に従ってください。MHTML ファイルをアップロードし、XLSB ファイルとして保存するだけです。MHTML の読み取りと XLSB の書き込みの両方で、完全修飾ファイル名を使用できます。出力される XLSB の内容とフォーマットは、元の MHTML ドキュメントと同一になります。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Python Excel ライブラリを使用して MHTML を XLSB に変換するサンプル コード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="mhtml" outformat="xlsb" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Python 経由で MHTML を XLSB に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

プログラムで MHTML ファイルを XLSB に変換する必要がありますか? Python 開発者は、わずか数行のコードで MHTML を簡単にロードして XLSB に変換できます。
