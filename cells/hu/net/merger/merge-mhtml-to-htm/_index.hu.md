---
title: A MHTML egyesítése a HTM-mel – a MHTML-es szám egyesítése a HTM-mel a C#-ben
url: /hu/net/merger/merge-mhtml-to-htm/ 
description: Aspose Excel. C# Aspose.Cells. A MHTML egyesítése HTM mentési formátumba. C# A MHTML kombinálása HTM formátumba. Egyesítse a MHTML-et a HTM-mel a C#-ben. MHTML Egyesítés.
...
{{% blocks/products/pf/agp/content h2="A MHTML-es szám egyesítése a C#-es HTM-mel" %}}

A következő példa bemutatja, hogyan egyesítheti a MHTML-es számot a HTM-mel a Aspose.Cells for .NET-ben.
...
{{% cells-merger title="Mintakód a MHTML egyesítéséhez a C#-es HTM-hez" InputFormat="mhtml" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A MHTML és a HTM egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan egyesítenie kell a MHTML-et a HTM-mel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
