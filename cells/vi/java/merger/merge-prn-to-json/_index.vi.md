---
title:  Hợp nhất PRN thành JSON via Java
url: /vi/java/merger/merge-prn-to-json/ 
description: Hợp nhất PRN thành JSON Trực tuyến miễn phí. PRN trực tuyến miễn phí tới JSON Sáp nhập. Hợp nhất PRN thành Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS, v.v.
---
...
Ví dụ sau minh họa cách hợp nhất PRN thành JSON trong Java.
...
{{% cells-merger title="Ứng dụng miễn phí để hợp nhất PRN thành JSON trực tuyến" InputFormat="prn" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
