...
description: Aspose Exceller. Python Exceller. Fusionnez HTM avec le format de sauvegarde PNG. Python Combinez HTM au format PNG. Fusionnez HTM avec PNG dans la bibliothèque Excel Python. Fusion HTM.
...
{{% blocks/products/pf/agp/content h2="Fusionner HTM avec PNG à l\'aide de la bibliothèque Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Fusionner HTM avec PNG dans la bibliothèque Excel Python" %}}
...
{{% cells-merger title="Exemple de code pour fusionner HTM avec PNG dans la bibliothèque Excel Python" InputFormat="htm" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner HTM avec PNG via la bibliothèque Excel Python" %}}
