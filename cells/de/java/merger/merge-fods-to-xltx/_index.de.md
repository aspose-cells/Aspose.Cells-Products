---
title: FODS mit XLTX zusammenführen - FODS mit XLTX in Java kombinieren
url: /de/java/merger/merge-fods-to-xltx/ 
description: Aspose Excel. Java Aspose.Cells. Kostenlose Online-Zusammenführung von FODS zu XLTX im Speicherformat. Java Kombinieren Sie das Format FODS mit dem Format XLTX. FODS zu XLTX in Java zusammenführen. FODS Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="Führen Sie FODS mit XLTX in Java kostenlos online zusammen" %}}

Das folgende Beispiel zeigt, wie FODS mit XLTX in Aspose.Cells for Java zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um FODS mit XLTX zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in der Datei XLTX. Wenn Sie Code in Java entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel Java, das FODS mit XLTX zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Kostenlos online, um FODS mit XLTX in Java zusammenzuführen" InputFormat="fods" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie FODS mit XLTX via Java zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie FODS programmgesteuert mit XLTX zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for Java](https://products.aspose.com/cells/java) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2="Java-Bibliothek zum Zusammenführen von FODS mit XLTX" %}}
