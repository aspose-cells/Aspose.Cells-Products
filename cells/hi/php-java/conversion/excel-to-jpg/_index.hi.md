...
description: Aspose एक्सेल। Aspose.Cells के साथ EXCEL को JPG में जल्दी और आसानी से बदलें। PHP EXCEL को JPG में बदलें। PHP एक्सेल को JPG में सेव करें। PHP का उपयोग करके EXCEL को JPG के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="PHP के माध्यम से EXCEL को JPG में कैसे बदलें" %}}

{{% blocks/products/pf/agp/text %}}

प्रोग्रामेटिक रूप से EXCEL फ़ाइलों को JPG में कनवर्ट करने की आवश्यकता है? PHP डेवलपर्स कोड की कुछ पंक्तियों में आसानी से EXCEL को JPG में लोड और परिवर्तित कर सकते हैं।
...
1. वर्कबुक की सेव विधि को कॉल करके EXCEL को JPG में बदलें।
