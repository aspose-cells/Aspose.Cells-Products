...
url: /hu/python-net/merger/merge-jpg-to-tabdelimited/ 
...
következő példa bemutatja, hogyan egyesítheti a JPG-t a TABDELIMITED-gel a Aspose.Cells for Python via .NET-ben.
...
Programozottan egyesítenie kell a JPG-t a TABDELIMITED-el? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
