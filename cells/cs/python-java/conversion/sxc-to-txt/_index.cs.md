---
title: Převést SXC na TXT přes Python
url: /cs/python-java/conversion/sxc-to-txt/
description: Ukázkový kód pro převod sxc na txt Python. Použijte API ukázkový kód pro dávkový převod souborů sxc na txt v aplikaci Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na TXT pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na TXT přes Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory SXC na TXT pomocí několika řádků kódu.
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod SXC na TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="txt" IsLandingPage="true" language="python" %}}
