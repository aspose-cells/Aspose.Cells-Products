---
title: TXT'i HTML'e birleştir - TXT'i Java'de HTML'e birleştir
url: /tr/java/merger/merge-txt-to-html/ 
description: Aspose Excel'de. Java Aspose.Cells. TXT'i HTML kaydetme biçimiyle birleştirin. Java TXT'i HTML biçimiyle birleştirin. Java'de TXT'i HTML ile birleştirin. TXT Birleştir.
...
{{% blocks/products/pf/agp/content h2="TXT\'i Java\'de HTML ile birleştir" %}}

Aşağıdaki örnek, Aspose.Cells for Java'de TXT ile HTML'in nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

TXT ile HTML'i birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından HTML dosyasına kaydedin. Java'de kod geliştirirseniz bu, göründüğünden daha basit olacaktır. TXT ile HTML'i birleştiren Java örneğine bakın.
...
{{% blocks/products/pf/agp/content h2="TXT ile HTML via Java Nasıl Birleştirilir?" %}}

{{% blocks/products/pf/agp/text %}}

 TXT ile HTML'i programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Java kitaplığı, TXT ile HTML arasında birleştirilecek" %}}
