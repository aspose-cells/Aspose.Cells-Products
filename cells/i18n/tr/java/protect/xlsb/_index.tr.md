...
{{< blocks/products/pf/i18n/upper-banner h1="XLSB Dosyalarını Java aracılığıyla şifreleyin" h2=".NET Kitaplığı kullanarak XLSB biçimi de dahil olmak üzere Excel elektronik tablolarını parolayla koruyun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLSB Dosyalarını Java aracılığıyla Koruma Adımları" %}}
...
1. Workbook sınıfını başlatarak XLSB dosyasını yükleyin1. ProtectionType ve Password ile koruma(..) yöntemini kullanın1. Korunan XLSB dosyasını save() yöntemiyle kaydedin
