---
title: C++ ODS ila PDF - ODS ila PDF Dönüştürücü
description: Aspose Excel. Bu kapsamlı çözüm, C++ geliştiricilerine ODS'i PDF formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, ODS verilerinin PDF formatına Aspose.Cells kütüphanesi kullanılarak sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C++ kod aracılığıyla gerçekleştirilir.
...
{{< blocks/products/pf/i18n/upper-banner h1="C++ sayısını ODS\'den PDF\'e dönüştürün." h2="C++ kütüphanesini kullanarak, Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna gerek kalmadan yüksek performanslı ODS\'den PDF\'e dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="ODS\'i PDF olarak C++\'e kaydedin." %}}

Aşağıdaki örnek, C++'de ODS'i PDF'e nasıl dönüştüreceğinizi göstermektedir.
{{% blocks/products/pf/agp/text %}}

ODS'i PDF'e dönüştürmek için kolay adımları izleyin. ODS dosyanızı yükleyin, ardından PDF dosyası olarak kaydedin. Hem ODS okuma hem de PDF yazma için tam nitelikli dosya adlarını kullanabilirsiniz. PDF çıktısının içeriği ve biçimlendirmesi, orijinal ODS belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="ODS sayısını PDF sayısına dönüştürmek için örnek kod." formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="ods" outformat="pdf" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="ODS\'i C++ aracılığıyla PDF\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

ODS dosyalarını programatik olarak PDF'e dönüştürmeniz mi gerekiyor? C++ geliştiricileri, sadece birkaç satır kodla ODS'i PDF'e kolayca dönüştürebilir.
...
1.  Save() yöntemini çağırarak ODS sayısını PDF sayısına dönüştürün.
1.  ODS'den PDF'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="ODS\'i PDF\'e dönüştürmek için C++ kütüphanesi" %}}
