---
title: C++ MHT إلى MD - محول MHT إلى MD
description: Aspose Excel. يوفر هذا الحل الشامل للمطورين C++ نهجًا متكاملًا تمامًا لتحويل تنسيق MHT إلى تنسيق MD، مما يتيح حفظ بيانات MHT بسلاسة في تنسيق MD باستخدام مكتبة Aspose.Cells، كل ذلك من خلال كود C++ فعال وقابل للتخصيص.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MHT إلى MD في C++" h2="تحويل عالي الأداء من MHT إلى MD باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ MHT إلى MD في C++" %}}

يوضح المثال التالي كيفية تحويل MHT إلى MD في C++.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل MHT إلى MD عبر الرقم C++" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات MHT إلى MD برمجيًا؟ يمكن للمطورين (C++) تحويل ملفات MHT إلى MD بسهولة في بضعة أسطر من التعليمات البرمجية فقط.
...
1.  قم بتحويل MHT إلى MD عن طريق استدعاء دالة Save().
1.  احصل على نتيجة تحويل MHT إلى MD.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة رقم C++ لتحويل MHT إلى MD" %}}
