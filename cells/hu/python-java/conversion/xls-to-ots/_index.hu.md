---
title: Python XLS az OTS-hez - XLS az OTS átalakítóhoz
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a Python fejlesztők számára a XLS OTS formátumba konvertálásához, lehetővé téve a XLS adatok zökkenőmentes mentését OTS formátumba a Aspose.Cells könyvtár segítségével, mindezt hatékony és testreszabható Python kódon keresztül.
...
{{< blocks/products/pf/i18n/upper-banner h1="A XLS konvertálása OTS-re a Python Excel könyvtárban" h2="Nagy sebességű Python excel könyvtár a XLS OTS-re konvertálásához. Ez egy professzionális szoftvermegoldás a XLS, OTS és sok más formátum importálásához és exportálásához a Python használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="A XLS konvertálása OTS-re a Python Excel könyvtár használatával" %}}

 Hogyan konvertálhatom át a XLS-et OTS-re? A Aspose.Cells for Python könyvtárral egyszerűen konvertálhatja a XLS-et OTS-re néhány soros kóddal, programozottan.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)képes többplatformos alkalmazások létrehozására, amelyek képesek az összes Excel fájl generálására, módosítására, konvertálására, renderelésére és nyomtatására. Python Az Excel API nemcsak a táblázatformátumok között konvertál, hanem Excel-fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT és egyebekként, így tökéletes választás a szabványos formátumú dokumentumok cseréjéhez.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Mentse el a XLS számot az OTS-be a Python Excel könyvtárban" %}}

A következő példa bemutatja, hogyan konvertálható a XLS OTS-re a Python Excel könyvtárban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a XLS OTS-re konvertálásához. Töltse fel a XLS fájlt, majd egyszerűen mentse el OTS-fájlként. Mind a XLS olvasáshoz, mind az OTS íráshoz használhat teljesen minősített fájlneveket. A kimeneti OTS-tartalom és formázás megegyezik az eredeti XLS számú dokumentuméval.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Mintakód a XLS OTS-re konvertálásához a Python Excel Library segítségével" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="ots" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="A XLS konvertálása OTS-re a Python-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

XLS fájlokat programozottan OTS-re kell konvertálnia? A Python fejlesztők egyszerűen betölthetik és néhány sornyi kóddal OTS-re konvertálhatják a XLS-et.
...
1.  Konvertálja a XLS-et OTS-re a Workbook.save metódus hívásával.
1.  Szerezze meg a XLS konverziós eredményt OTS-re.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Excel-könyvtár a XLS OTS-re konvertálásához" %}}
