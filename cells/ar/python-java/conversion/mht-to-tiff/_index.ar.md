---
title: Python MHT إلى TIFF - محول MHT عبر الإنترنت إلى TIFF
description: Aspose إكسل. Python Aspose.Cells. Python Aspose Cells. مجاني على الإنترنت Python تحويل MHT إلى TIFF saveformat. Python MHT إلى تنسيق TIFF. احفظ MHT في TIFF Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MHT إلى TIFF في Python" h2="مكتبة Python عالية السرعة لتحويل MHT إلى TIFF. هذا حل برمجي احترافي لاستيراد وتصدير MHT ، TIFF ، والعديد من التنسيقات الأخرى باستخدام Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
1.  قم بتحويل MHT إلى TIFF عن طريق استدعاء طريقة Workbook.save.
