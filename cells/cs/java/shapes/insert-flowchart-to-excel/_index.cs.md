---
title: Vložte vývojový diagram do Excelu via Java
weight: 360
...
{{% blocks/products/pf/agp/content h2="Jak vložit vývojový diagram do souboru aplikace Excel pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Postup vložení vývojového diagramu do souboru aplikace Excel via Java" %}}
...
+ Vyberte List přes jeho index.
 + Použijte[přidat metodu](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) pro vložení vývojového diagramu do vybraného listu
...
{{% blocks/products/pf/agp/code-block title="Vložte vývojový diagram – Java" offSpacer="" %}}
