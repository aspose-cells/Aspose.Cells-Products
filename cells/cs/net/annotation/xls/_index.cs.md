...
{{% blocks/products/pf/agp/feature-section-col title="Přidat nebo smazat anotaci z XLS přes C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Smazat anotace od XLS - C#" offSpacer="" %}}
