---
title: C# EXCEL en ETT - Convertisseur EXCEL en ETT
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir EXCEL au format ETT, permettant un enregistrement transparent des données EXCEL au format ETT à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer EXCEL au format ETT dans C#" %}}

L'exemple suivant montre comment convertir EXCEL en ETT dans C#.
...
Besoin de convertir des fichiers EXCEL en ETT par programme ? Les développeurs .NET peuvent facilement charger et convertir EXCEL en ETT en quelques lignes de code seulement.
...
1.  Convertissez un fichier EXCEL au format ETT en appelant la méthode Workbook.Save.
