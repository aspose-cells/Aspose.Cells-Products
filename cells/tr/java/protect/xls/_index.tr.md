...
{{< blocks/products/pf/i18n/upper-banner h1="XLS Dosyalarını Java aracılığıyla şifreleyin" h2=".NET Kitaplığı kullanarak XLS biçimi de dahil olmak üzere Excel elektronik tablolarını parolayla koruyun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java üzerinden XLS Dosyalarını Koruma Adımları" %}}
...
1. Workbook sınıfını başlatarak XLS dosyasını yükleyin1. ProtectionType ve Password ile koruma(..) yöntemini kullanın1. Korunan XLS dosyasını save() yöntemiyle kaydedin
