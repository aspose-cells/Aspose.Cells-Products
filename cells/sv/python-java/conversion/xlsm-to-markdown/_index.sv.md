---
title: Konvertera XLSM till MARKDOWN via Python
url: /sv/python-java/conversion/xlsm-to-markdown/
description: Exempelkod för xlsm till markdown Python-omvandling. Använd API-exempelkod för batch-xlsm-filer för att markera nedkonvertering i Python-applikationen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLSM till MARKDOWN via Python" h2="Exportera Excel®-kalkylark till MARKDOWN-format med Python API:er." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MARKDOWN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLSM till MARKDOWN med Python" %}}

 För att konvertera XLSM till MARKDOWN kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLSM till MARKDOWN via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera XLSM-filer till MARKDOWN på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLSM-fil med en instans av Workbook1. Anropa Workbook.Save-metoden1. Passera utgångsväg med MD-förlängning som parameter1. Kontrollera den angivna sökvägen för den resulterande MARKDOWN-filen
...
{{% cells-convert title="Gratis app och provkod för att konvertera XLSM till MARKDOWN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="md" IsLandingPage="true" language="python" %}}
