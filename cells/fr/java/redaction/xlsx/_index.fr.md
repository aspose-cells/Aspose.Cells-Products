---
title:  Rechercher et remplacer le texte dans le document XLSX via Java
weight: 1590
description: Exemple de code Java pour supprimer les informations sensibles dans le fichier XLSX sur l'environnement d'exécution Java pour les applications JSP/JSF et les applications de bureau.
...
{{% blocks/products/pf/agp/content h2="Comment expurger le fichier XLSX à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour expurger les fichiers XLSX dans Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Rédiger les dossiers XLSX - Java" offSpacer="" %}}
