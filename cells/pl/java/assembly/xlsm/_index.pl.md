---
title:  Generuj raporty w XLSM Pliki via Java
weight: 270
description: Java przykładowy kod do tworzenia raportów w formacie XLSM w Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masowe generowanie raportów w formacie XLSM via Java" h2="Generuj raporty w formacie XLSM, korzystając ze źródła danych i szablonu." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak generować raporty XLSM za pomocą Java" %}}
 ...
 Aby utworzyć raporty plików XLSM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki do wygenerowania XLSM Raporty via Java" %}}
...
1.  Zapisz wynik w formacie XLSM za pomocą metody Workbook.save
