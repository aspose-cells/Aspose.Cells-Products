...
{{% blocks/products/pf/agp/content h2="Comment insérer une zone de texte dans un fichier Excel à l\'aide de Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer TextBox dans un fichier Excel en utilisant Python via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Insérer une zone de texte - Python via Java" offSpacer="" %}}
