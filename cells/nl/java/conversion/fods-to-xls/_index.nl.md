...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer FODS naar XLS via Java" h2="FODS naar XLS Java conversie om enkele of meerdere pagina\'s naar XLS te converteren met behulp van een lokale Java bibliotheek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe FODS naar XLS te converteren met Java" %}}

 Om FODS naar XLS te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om FODS naar XLS te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen FODS-bestanden gemakkelijk converteren naar XLS in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad FODS-bestand met een exemplaar van de Workbook-klasse1. Bel de methode Workbook.save1. Geef uitvoerpad door met XLS-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende XLS-bestand
...
{{% blocks/products/pf/agp/code-block title="FODS naar XLS Java conversiebroncode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="FODS naar XLS conversie Live demo\'s" sectionDescription="[Converteer FODS naar XLS](https://products.aspose.app/cells/conversion/fods-to-xls) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw FODS-bestand, het wordt direct geconverteerd naar XLS." >}}
