...
description: Aspose Excel. Cette solution complète offre aux développeurs PHP une approche entièrement intégrée pour convertir EXCEL au format HTM, permettant un enregistrement transparent des données EXCEL au format HTM grâce à la bibliothèque Aspose.Cells, le tout via un code PHP efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer un fichier Excel au format HTML en PHP" %}}

L'exemple suivant montre comment convertir un fichier EXCEL en HTM en PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir un fichier Excel en HTML via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en HTM par programmation ? Les développeurs PHP peuvent facilement charger et convertir des fichiers EXCEL en HTM en quelques lignes de code seulement.
...
1.  Convertissez un fichier EXCEL en HTM en appelant la méthode save du classeur.
1.  Obtenez le résultat de la conversion d'Excel en HTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque PHP pour convertir EXCEL en HTM" %}}
