...
{{% blocks/products/pf/agp/content h2="Jak převést FODS na MHTML pomocí Java" %}}

 K vykreslení FODS do MHTML použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu FODS na MHTML prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor FODS na MHTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor FODS s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením MHTML a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor MHTML
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze FODS na MHTML Java" offSpacer="" %}}

```cs
// načtěte soubor FODS do instance Workbooku
Workbook book = new Workbook("template.fods");
// uložit FODS jako MHTML
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze FODS na MHTML" sectionDescription="[Převést FODS na MHTML](https://products.aspose.app/cells/conversion/fods-to-mhtml) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor FODS, bude okamžitě převeden do MHTML." >}}
