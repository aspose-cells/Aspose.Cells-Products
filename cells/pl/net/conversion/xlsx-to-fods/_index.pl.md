---
title: Konwertuj XLSX na FODS przez C#

description: Przykładowy kod konwersji xlsx do fods C#. Użyj przykładowego kodu API dla plików wsadowych xlsx do konwersji fods w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSX na FODS za pomocą C#" %}}

 Aby przekonwertować XLSX na FODS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLSX na FODS za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki XLSX na FODS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSX z instancją Workbook1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem FODS jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku FODS
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLSX na FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="fods" IsLandingPage="true" %}}
