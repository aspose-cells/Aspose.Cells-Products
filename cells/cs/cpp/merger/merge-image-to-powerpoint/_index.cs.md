...
url: /cs/cpp/merger/merge-image-to-powerpoint/ 
...
Následující příklad ukazuje, jak sloučit IMAGE do POWERPOINT v Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit IMAGE do POWERPOINT? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="C++ knihovnu pro sloučení IMAGE do POWERPOINT" %}}
