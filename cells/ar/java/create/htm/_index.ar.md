...
description: Aspose إكسل. Java تكوين ملف HTM. قم بإنشاء HTM Java. Java HTM Craduate. قم بإنشاء HTM في Java. قم بإنشاء ملف HTM باستخدام Java.
...
1.  احفظ المصنف بتنسيق HTM باستخدام طريقة الحفظ ().
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لتكوين ملف HTM" %}}
{{% blocks/products/pf/agp/text %}}
