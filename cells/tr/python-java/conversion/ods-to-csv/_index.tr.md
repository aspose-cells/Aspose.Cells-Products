...
{{% blocks/products/pf/agp/content h2="Python\'i kullanarak ODS\'i CSV\'e dönüştürün" %}}
...
Aşağıdaki örnek, ODS'in Python'de CSV'e nasıl dönüştürüleceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="ODS\'i Python aracılığıyla CSV\'e dönüştürme" %}}
