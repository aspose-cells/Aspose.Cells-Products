...
{{% blocks/products/pf/agp/content h2="Cara Membuat Laporan XLSM Menggunakan Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Membuat Laporan XLSM melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Buat instance kelas WorkbookDesigner1. Tambahkan objek Datasouce dalam ArrayList1. Atur sumber data dan Proses untuk objek WorkbookDesigner1. Simpan hasil dalam format XLSM melalui metode Worbook.save
...
{{% blocks/products/pf/agp/code-block title="Membuat Laporan Excel dalam Format XLSM - C#" offSpacer="" %}}
