---
title: Chuyển đổi HTML sang XLSX qua ứng dụng C++ 
weight: 9770
url: /vi/cpp/conversion/html-to-xlsx/ 
description: Mã chuyển đổi C++ mẫu cho tài liệu HTML sang định dạng XLSX. Các lập trình viên có thể sử dụng mã nguồn này để chuyển đổi hàng loạt HTML sang XLSX trong bất kỳ Ứng dụng C++ nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi HTML sang XLSX qua C++" h2="Chuyển đổi HTML sang XLSX hiệu suất cao bằng cách sử dụng thư viện C++ mà không cần cài đặt Microsoft Excel, OpenOffice hoặc Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ các nhà phát triển có thể dễ dàng chuyển đổi tệp HTML sang XLSX chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp HTML bằng Factory :: CreateIWorkbook.1. Gọi phương thức Save ().1. Chuyển đường dẫn tệp đầu ra với phần mở rộng tệp (XLSX).1. Tập tin XLSX sẽ được lưu theo đường dẫn được chỉ định.1. Mở tệp XLSX trong chương trình tương thích.
...
{{% blocks/products/pf/agp/code-block title="HTML sang XLSX C++ Mã nguồn chuyển đổi" offSpacer="" %}}
