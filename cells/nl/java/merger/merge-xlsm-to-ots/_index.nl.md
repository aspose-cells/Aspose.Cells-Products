...
description: Aspose Excel. Java Aspose.Cells. Voeg XLSM samen naar OTS-opslagformaat. Java Combineer XLSM naar OTS-formaat. Voeg XLSM samen met OTS in Java. XLSM Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLSM samen met OTS in Java" %}}

Het volgende voorbeeld laat zien hoe u XLSM samenvoegt met OTS in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLSM samen te voegen met OTS. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een OTS-bestand. Als u code ontwikkelt in Java, zal dit eenvoudiger zijn dan het klinkt. Zie voorbeeld Java waarin XLSM wordt samengevoegd met OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om XLSM samen te voegen met OTS in Java" InputFormat="xlsm" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe u XLSM samenvoegt met OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLSM programmatisch samenvoegen met OTS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen met slechts enkele regels code worden uitgevoerd.
