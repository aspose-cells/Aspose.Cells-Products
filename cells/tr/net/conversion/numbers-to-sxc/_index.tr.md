---
title: C# NUMARALAR'dan SXC'e - NUMARALAR'dan SXC'e Dönüştürücü
description: Aspose Excel. Bu kapsamlı çözüm, C# geliştiricilere, sayıları SXC formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, Aspose.Cells kütüphanesini kullanarak sayı verilerinin SXC formatına sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C# kod aracılığıyla gerçekleştirilir.
...
{{% blocks/products/pf/agp/content h2="C# numarasına SXC olarak kaydedin." %}}

Aşağıdaki örnek, sayıları C#'den SXC'e nasıl dönüştüreceğinizi göstermektedir.
{{% blocks/products/pf/agp/text %}}

NUMBERS'ı SXC'e dönüştürmek için kolay adımları izleyin. NUMBERS dosyanızı yükleyin ve ardından SXC dosyası olarak kaydedin. Hem NUMBERS okuma hem de SXC yazma için tam nitelikli dosya adlarını kullanabilirsiniz. SXC çıktısının içeriği ve biçimlendirmesi orijinal NUMBERS belgesiyle aynı olacaktır.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Sayıları SXC\'e Dönüştürmek İçin Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="numbers" outformat="sxc" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="NUMBERS\'ı C# aracılığıyla SXC\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS dosyayı programlı olarak SXC'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla NUMBERS'ı kolayca yükleyip SXC'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak NUMBERS'ı SXC'e dönüştürün.
1.  NUMBERS'ın dönüşüm sonucunu SXC'e alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# kütüphanesi, sayıları SXC\'e dönüştürüyor." %}}
