---
title: PHP EXCEL en EXCEL - Convertisseur EXCEL en EXCEL
description: Aspose Exceller. Convertissez EXCEL en EXCEL rapidement et facilement avec Aspose.Cells. PHP EXCEL en EXCEL. PHP Enregistrez EXCEL dans EXCEL. Enregistrez EXCEL sous EXCEL en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en EXCEL via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en EXCEL par programme ? Les développeurs PHP peuvent facilement charger et convertir EXCEL en EXCEL en quelques lignes de code seulement.
...
1.  Convertissez EXCEL en EXCEL en appelant la méthode de sauvegarde du classeur.
