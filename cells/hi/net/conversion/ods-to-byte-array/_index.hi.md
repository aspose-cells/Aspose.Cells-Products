...
weight: 7690
description: C# ODS से बाइट ऐरे रूपांतरण के लिए नमूना कोड। VB.NET, Asp.NET या किसी .NET आधारित एप्लिकेशन के भीतर बाइट ऐरे रूपांतरण के लिए एक्सेल ODS के लिए इस कोड का उपयोग करें।
---
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 बाइट ऐरे डेटा प्रोसेसिंग या स्टोरेज के लिए मददगार है। आप ODS फ़ाइल को बाइट ऐरे के साथ-साथ a**बाइट ऐरे को ODS पर**दस्तावेज़ C# भाषा का उपयोग कर। ODS को बाइट ऐरे में बदलने के लिए, हम उपयोग करेंगे
...
1.  कार्यपुस्तिका का उपयोग करके इनपुट ODS फ़ाइल लोड करें
...
{{% blocks/products/pf/agp/code-block title="यह नमूना कोड ODS को बाइट सरणी C# रूपांतरण में दिखाता है" offSpacer="" %}}
...
एक एक्सेल स्प्रेडशीट प्रोग्रामिंग लाइब्रेरी जो सभी एक्सेल फाइलों को जनरेट, संशोधित, कन्वर्ट, रेंडर और प्रिंट करने की क्षमता के साथ क्रॉस-प्लेटफॉर्म एप्लिकेशन बनाने में सक्षम है। .NET एक्सेल API न केवल स्प्रेडशीट प्रारूपों के बीच परिवर्तित होता है, बल्कि यह ODS को छवियों के रूप में, PDF, HTML, ODS और अधिक सहित एक्सेल फाइलों को भी प्रस्तुत कर सकता है, इस प्रकार यह उद्योग-मानक प्रारूपों में दस्तावेजों का आदान-प्रदान करने के लिए एक सही विकल्प बनाता है।
