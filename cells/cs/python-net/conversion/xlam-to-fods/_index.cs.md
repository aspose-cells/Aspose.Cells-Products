---
title: XLAM až FODS - Převést soubory XLAM na FODS Python via Python
...
Následující příklad ukazuje, jak převést XLAM na FODS v Python via NET.
...
{{% blocks/products/pf/agp/content h2="Jak převést XLAM na FODS" %}}
