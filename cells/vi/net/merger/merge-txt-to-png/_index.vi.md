---
title: Hợp nhất TXT thành PNG - Hợp nhất TXT thành PNG thành C#
url: /vi/net/merger/merge-txt-to-png/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí TXT thành PNG saveformat. C# Kết hợp định dạng TXT thành PNG. Hợp nhất TXT thành PNG thành C#. TXT Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất TXT thành PNG trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất TXT thành PNG trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất TXT thành PNG. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp rồi lưu vào tệp PNG. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất TXT thành PNG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Hợp nhất trực tuyến miễn phí TXT thành PNG trong C#" InputFormat="txt" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất TXT thành PNG qua C#" %}}
...
{{% blocks/products/pf/agp/content h2=".NET thư viện để hợp nhất TXT thành PNG" %}}
