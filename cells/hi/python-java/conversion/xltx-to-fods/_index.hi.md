...
{{% blocks/products/pf/agp/content h2="कैसे XLTX को FODS से Python में बदलें" %}}

{{% blocks/products/pf/agp/text %}}

 Python डेवलपर्स आसानी से कोड की कुछ पंक्तियों में XLTX को FODS में लोड और परिवर्तित कर सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1.  कार्यपुस्तिका के उदाहरण के साथ XLTX फ़ाइल लोड करें
1.  Workbook.save विधि को कॉल करके XLTX को FODS में बदलें

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python पुस्तकालय XLTX को FODS में बदलने के लिए" %}}
