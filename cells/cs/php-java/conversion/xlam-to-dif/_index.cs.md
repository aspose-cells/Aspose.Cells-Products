---
title: Konvertor PHP XLAM až DIF - XLAM až DIF
description: Aspose Excel. Převeďte XLAM na DIF rychle a snadno pomocí Aspose.Cells. PHP XLAM na DIF. PHP Uložte XLAM na DIF. Uložte DIF jako XLAM jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod XLAM na DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="dif" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést XLAM na DIF přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory XLAM na DIF programově? Vývojáři PHP mohou snadno načíst a převést XLAM na DIF v několika řádcích kódu.
...
1.  Převeďte XLAM na DIF voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na DIF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na DIF" %}}
