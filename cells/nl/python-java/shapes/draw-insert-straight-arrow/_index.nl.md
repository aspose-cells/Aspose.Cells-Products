---
title:  Hoe teken of voeg ik een rechte pijl in Excel in met Python via Java
weight: 10
description: Python via Java broncode om een rechte pijl in Excel te tekenen of in te voegen.
...
{{< blocks/products/pf/i18n/upper-banner h1="Voeg een rechte pijl in Excel in met Python via Java" h2="Voeg een rechte pijl in met Aspose.Cells\' API zonder software zoals Microsoft of Open Office, Adobe PDF, enz." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een rechte pijl in een Excel-bestand kunt invoegen met behulp van Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om een rechte pijl in een Excel-bestand in te voegen met behulp van Python via Java" %}}
...
+ Selecteer Werkblad via de index.
 + Gebruik de vormcollecties[methode toevoegen](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addLine(int,%20int,%20int,%20int,%20int,%20int)) om een rechte pijl in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="Rechte pijl invoegen - Python via Java" offSpacer="" %}}
