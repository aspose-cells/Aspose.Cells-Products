---
title: Converter SXC para TIFF via Python

description: Código de exemplo para conversão de sxc para tiff Python. Use o código de exemplo API para arquivos sxc em lote para conversão tiff no aplicativo Python.
---
...
{{% blocks/products/pf/agp/content h2="Como converter SXC para TIFF usando Python" %}}

 Para converter SXC para TIFF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter SXC para TIFF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem facilmente carregar e converter arquivos SXC para TIFF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo SXC com uma instância da pasta de trabalho1. Chame o método Workbook.Save1. Passe o caminho de saída com a extensão TIFF como parâmetro1. Verifique o caminho especificado para o arquivo TIFF resultante
