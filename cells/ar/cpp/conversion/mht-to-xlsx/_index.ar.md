...
هل تحتاج إلى تحويل ملفات MHT إلى XLSX برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل MHT إلى XLSX في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XLSX باستدعاء طريقة Save ().
