---
title: 将 RDL 报告导出到 SQL Server 中的 Excel XLS XLSX 和 SpreadsheetML
weight: 3460
description: SQL Server Reporting Services 呈现扩展插件 - 导出 Excel XLS XLSX XLSM XLSB CSV SpreadsheetML HTML ODS 和 TXT 格式
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Reporting Services 扩展以 Excel 文件形式提供报表" h2="轻松将 RDL 和 RDLC 报告导出为 Excel 电子表格文件格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/headers/aspose_cells-for-reporting-services.svg" pfName="Aspose.Cells" subTitlepfName="for Reporting Services" downloadUrl="https://downloads.aspose.com/cells/reportingservices" >}}
...
<p>
 Aspose.Cells for Reporting Services 允许您从 Microsoft SQL Server Reporting Services 和 Microsoft 报表查看器中提供 Excel 报表。与基于 Excel 的报告的本机导出器不同 - Aspose.Cells for Reporting Services 允许 RDL 和 RDL 的转换RDLC 以多种 Excel 电子表格文件格式进行报告。
</p>
...
{{< blocks/products/pf/carousel-item h3="乍看上去" description="Aspose.Cells for Reporting Services 概述。" >}}
...
Aspose.Cells' 报告设计器工具
    ...
    <p>
开发人员可以直接从 Microsoft Excel 设计和交付报告，同时使用 Aspose.Cells.Report.Designer - 一个使用 Microsoft Excel 作为报告模板的简单设计工具。此功能允许利用 Microsoft Excel 应用程序中提供的所有强大功能和特性，包括数据透视表、交互式图表、公式等。
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
...
高保真度 - 与报告设计相同
    ...
    <p>
Aspose.Cells for Reporting Services 将报表导出到 Microsoft Excel 电子表格，其结果与内置 Reporting Services 报表设计器生成的原始报表相同。所有报告功能均转换为最高精度，以使 Microsoft Excel 电子表格看起来尽可能与原始电子表格相似。
    </p>
   </div>
   <!--
...
各种数据处理选项
    ...
    <p>
Aspose.Cells for Reporting Services 支持具有分组行和页脚的表格，而分组可以像其他报表项目一样在设计时设置。 Aspose.Cells for Reporting Services 还支持参数和全局变量作为报表数据源。开发者还可以利用Microsoft Query来创建数据源和查询；这是一种广泛使用的工具，大多数用户都熟悉。
    </p>
    <p>
除此之外，Aspose.Cells for Reporting Services既支持报表特定数据源，也支持预先在报表服务器上创建的共享数据源。开发人员可以在设计时使用报表特定数据源，并在发布报表时指定共享数据源作为报表数据源。
    </p>
   </div>
   <!-- 
...
-->
 ...
 Microsoft 办公自动化 – 不需要
    ...
    <p>
 Aspose.Cells for Reporting Services 使用托管代码构建，无需在计算机上安装 Microsoft Office 或 Microsoft Excel 即可使用 Excel 文档格式。就支持的功能、安全性、稳定性、可扩展性、速度和价格而言，它是完美的 Microsoft Excel 自动化替代品。
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="为什么是Aspose.Cells for Reporting Services？" tabId="success-stories" >}}
