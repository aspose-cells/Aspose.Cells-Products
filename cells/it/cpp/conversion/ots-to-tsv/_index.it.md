...
{{% cells-convert title="Codice di esempio per convertire OTS in TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="tsv" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Come convertire OTS in TSV tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

È necessario convertire i file OTS in TSV a livello di codice? Gli sviluppatori C++ possono convertire facilmente OTS in TSV in poche righe di codice.
...
1.  Converti OTS in TSV chiamando il metodo Save().
