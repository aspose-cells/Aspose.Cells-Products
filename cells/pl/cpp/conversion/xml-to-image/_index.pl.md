...
description: Aspose Excel. Konwertuj XML na IMAGE szybko i łatwo za pomocą Aspose.Cells. C++ XML na IMAGE. C++ Zapisz XML w OBRAZIE. Zapisz XML jako OBRAZ, używając numeru C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XML na OBRAZ w C++" h2="Wysokowydajna konwersja XML na OBRAZ przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Zapisz XML w OBRAZIE pod numerem C++" %}}

Poniższy przykład ilustruje sposób konwersji XML na IMAGE w C++.
...
Chcesz programowo przekonwertować pliki XML na IMAGE? Programiści C++ mogą łatwo przekonwertować XML na IMAGE w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XML na IMAGE, wywołując metodę Save().
