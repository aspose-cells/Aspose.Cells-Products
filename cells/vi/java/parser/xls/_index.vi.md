---
title:  Trích xuất văn bản và hình ảnh từ tài liệu XLS via Java
weight: 3700
...
{{< blocks/products/pf/i18n/upper-banner h1="Phân tích cú pháp XLS Định dạng trong Java" h2="Phân tích cú pháp tài liệu gốc và hiệu suất cao XLS bằng API Aspose.Cells for Java phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách phân tích tệp XLS bằng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để phân tích tệp XLS trong Java" %}}
...
+ Nạp tài liệu XLS sử dụng lớp Workbook.
...
{{% blocks/products/pf/agp/code-block title="Phân tích tệp XLS - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Trực tuyến XLS Trình phân tích cú pháp trực tiếp" sectionDescription=" Trích xuất văn bản và hình ảnh từ tài liệu XLS ngay bây giờ bằng cách truy cập trang web của chúng tôi[Trang web Demo trực tiếp](https://products.aspose.app/cells/parser). Bản demo trực tiếp có những lợi ích sau" >}}
