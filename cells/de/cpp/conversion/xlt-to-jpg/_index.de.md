...
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie XLT in JPG über C++" h2="Leistungsstarke XLT-zu-JPG-Konvertierung mit der C++-Bibliothek ohne die Notwendigkeit einer Installation von Microsoft Excel, OpenOffice oder Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLT" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-Entwickler können XLT-Dateien in nur wenigen Codezeilen ganz einfach in JPG konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die XLT-Datei mit Factory::CreateIWorkbook.1. Rufen Sie die Save()-Methode auf.1. Übergeben Sie den Ausgabedateipfad mit der Dateierweiterung (JPG).1. Die JPG-Datei wird unter dem angegebenen Pfad gespeichert.1. Öffnen Sie die JPG-Datei in einem kompatiblen Programm.
...
{{% blocks/products/pf/agp/code-block title="Umwandlungsquellcode von XLT in JPG C++" offSpacer="" %}}
