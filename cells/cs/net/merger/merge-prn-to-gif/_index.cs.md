...
url: /cs/net/merger/merge-prn-to-gif/ 
...
Následující příklad ukazuje, jak sloučit PRN s GIF v Aspose.Cells for .NET.
...
Potřebujete sloučit PRN s GIF programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET pro sloučení PRN s GIF" %}}
