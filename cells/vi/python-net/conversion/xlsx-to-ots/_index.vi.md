...
description: Aspose Excel. Chuyển đổi XLSX sang OTS nhanh chóng và dễ dàng với Aspose.Cells. Python XLSX sang OTS. Python Lưu XLSX vào OTS. Lưu XLSX dưới dạng OTS bằng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLSX sang OTS trong Python" %}}
...
{{% blocks/products/pf/agp/content h2="Lưu XLSX vào OTS ở Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLSX sang OTS trong Python via NET.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi XLSX sang OTS" %}}
