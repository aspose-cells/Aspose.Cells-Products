...
url: /hu/cpp/merger/merge-xltm-to-et/ 
...
következő példa bemutatja, hogyan lehet egyesíteni a XLTM-et a Aspose.Cells-es for C++-es ET-vel.
...
{{% cells-merger title="Mintakód a XLTM egyesítéséhez ET-hez a C++-ben" InputFormat="xltm" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="A XLTM és az ET egyesítése a C++ számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLTM-et az ET-be? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár a XLTM ET-vel való egyesítéséhez" %}}
