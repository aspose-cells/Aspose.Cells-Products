---
title: TABDELIMITED'i MHT ile birleştir - Python'de TABDELIMITED'ı MHT ile birleştir
url: /tr/python-java/merger/merge-tabdelimited-to-mht/ 
description: Aspose Excel'de. Python Aspose.Cells. TABDELIMITED'ı MHT kaydetme biçimiyle birleştir. Python TABDELIMITED'ı MHT formatıyla birleştirin. TABDELIMITED'ı Python'de MHT ile birleştir. TABDELIMITED Birleştir.
...
{{% cells-merger title="Python\'de TABDELIMITED\'ı MHT ile Birleştirmek için Örnek Kod" InputFormat="tsv" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="TABDELIMITED\'ı Python aracılığıyla MHT ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 TABDELIMITED'ı MHT ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="Python kütüphane, TABDELIMITED\'ı MHT ile birleştirmek için" %}}
