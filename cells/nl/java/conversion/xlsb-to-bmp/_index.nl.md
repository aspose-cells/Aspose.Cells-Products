...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in BMP in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar BMP in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar BMP of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar BMP? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar BMP met slechts een paar regels code.
