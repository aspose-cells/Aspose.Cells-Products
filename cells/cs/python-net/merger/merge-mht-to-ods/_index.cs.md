...
url: /cs/python-net/merger/merge-mht-to-ods/ 
...
Následující příklad ukazuje, jak sloučit MHT s ODS v Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit MHT na ODS programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
