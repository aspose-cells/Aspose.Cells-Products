---
title: Sloučit XML s JSON – Zkombinovat XML s JSON v Java
url: /cs/java/merger/merge-xml-to-json/ 
description: Aspose Excel. Java Aspose.Cells. Online zdarma Sloučit XML do formátu uložení JSON. Java Zkombinujte XML do formátu JSON. Sloučit XML na JSON v Java. Sloučit XML.
...
{{% blocks/products/pf/agp/content h2="Sloučit XML na JSON v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit XML do JSON v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XML do JSON. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru JSON. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí XML do JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení XML na JSON v Java" InputFormat="xml" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XML na JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XML s JSON? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java pro sloučení XML do JSON" %}}
