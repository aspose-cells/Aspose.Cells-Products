---
title: C# JPEG a WORD-hoz – Online JPEG a WORD konverterhez
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Ingyenes online C# A JPEG konvertálása WORD mentési formátumba. C# JPEG WORD formátumba. Mentse el a JPEG számot a C# WORD-ba.
...
{{% blocks/products/pf/agp/content h2="Mentse el a JPEG-et a WORD-ba a C#-ben online ingyen" %}}

A következő példa bemutatja, hogyan lehet a JPEG-et WORD-ra konvertálni a C#-ben.
...
{{% blocks/products/pf/agp/content h2="A JPEG konvertálása WORD-ra a C#-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A JPEG fájlt programozottan WORD-ba kell konvertálni? A .NET fejlesztők egyszerűen betölthetik és konvertálhatják a JPEG-et WORD-ra, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a JPEG-et WORD-ba a Workbook.Save metódus meghívásával.
1.  Szerezze meg a JPEG konvertálási eredményt WORD-ra.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# könyvtár a JPEG konvertálásához WORD-ba" %}}
