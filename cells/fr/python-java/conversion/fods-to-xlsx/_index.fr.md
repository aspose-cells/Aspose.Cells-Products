...
description: Aspose Exceller. Convertissez FODS en XLSX rapidement et facilement avec Aspose.Cells. Python FODS en XLSX. Python Enregistrez FODS en XLSX. Enregistrez FODS sous 07611134. 81 en utilisant le Python.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le FODS au XLSX au Python" %}}

L'exemple suivant montre comment convertir FODS en XLSX dans Python.
