...
description: Aspose Excel. Konvertieren Sie HTM schnell und einfach in XLTX mit Aspose.Cells. C++ HTM in XLTX. C++ Speichern Sie HTM in XLTX. Speichern Sie HTM als XLTX mit C++.
...
{{% cells-convert title="Beispielcode zum Konvertieren von HTM in XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="xltx" IsLandingPage="true" language="cpp" %}}
