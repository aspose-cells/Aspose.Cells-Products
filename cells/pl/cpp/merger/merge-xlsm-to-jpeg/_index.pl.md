---
title: Scal XLSM z JPEG - Połącz XLSM z JPEG w C++
url: /pl/cpp/merger/merge-xlsm-to-jpeg/ 
description: Aspose Excel. C++ Aspose.Cells. Scal XLSM z JPEG w formacie zapisu. C++ Połącz format XLSM z JPEG. Scal XLSM z JPEG w C++. XLSM Scal.
...
{{% blocks/products/pf/agp/content h2="Scal XLSM z JPEG w C++" %}}

Poniższy przykład pokazuje, jak połączyć XLSM z JPEG w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLSM z JPEG. Prześlij swoje pliki, wywołaj metodę Workbook.Combine w celu łączenia plików, a następnie zapisz je w pliku JPEG. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy XLSM z JPEG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia XLSM z JPEG w C++" InputFormat="xlsm" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLSM z JPEG przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć XLSM z JPEG? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia XLSM z JPEG" %}}
