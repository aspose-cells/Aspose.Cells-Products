...
{{% blocks/products/pf/agp/content h2="Converteer OTS naar TABDELLIMITED met behulp van Python" %}}
...
Het volgende voorbeeld laat zien hoe u OTS naar TABDELLIMITED converteert in Python.
