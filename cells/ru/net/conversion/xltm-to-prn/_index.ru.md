...
Нужно программно преобразовать файлы XLTM в PRN? Разработчики .NET могут легко загрузить и преобразовать XLTM в PRN всего за несколько строк кода.
...
1. Преобразуйте значение XLTM в PRN, вызвав метод Workbook.Save.
