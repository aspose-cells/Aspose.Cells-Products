...
description: Aspose Excel. Converta OTS para PNG de forma rápida e fácil com Aspose.Cells. C++ OTS para PNG. C++ Salve OTS em PNG. Salve OTS como PNG usando C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter OTS em PNG em C++" h2="Conversão de OTS para PNG de alto desempenho usando a biblioteca C++ sem a necessidade de instalação do Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Converter OTS em PNG usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve OTS em PNG em C++" %}}

O exemplo a seguir demonstra como converter OTS em PNG em C++.
...
{{% cells-convert title="Exemplo de código para converter OTS em PNG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="png" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter OTS para PNG via C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos OTS para PNG programaticamente? Os desenvolvedores C++ podem facilmente converter OTS em PNG em apenas algumas linhas de código.
...
1.  Converta OTS em PNG chamando o método Save().
