---
title: SPREADSHEETML'yi JSON ile birleştir - SPREADSHEETML'yi Java'de JSON ile birleştir
url: /tr/java/merger/merge-spreadsheetml-to-json/ 
description: Aspose excel. Java Aspose.Cells. SPREADSHEETML'yi JSON kaydetme biçimine Ücretsiz Çevrimiçi Birleştirme. Java SPREADSHEETML'yi JSON biçimiyle birleştirin. SPREADSHEETML'yi Java'de JSON ile birleştirin. SPREADSHEETML Birleştirin.
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML\'yi Java\'de JSON ile Çevrimiçi Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, SPREADSHEETML'nin Aspose.Cells for Java'de JSON ile nasıl birleştirileceğini gösterir.
{{% blocks/products/pf/agp/text %}}

SPREADSHEETML'yi JSON'de birleştirmek için kolay adımları izleyin. Dosyalarınızı yükleyin, dosyaları birleştirmek için Workbook.Combine yöntemini çağırın ve ardından JSON dosyasına kaydedin. Java'de kod geliştirirseniz, bu göründüğünden daha basit olacaktır. SPREADSHEETML'yi JSON ile birleştiren Java örneğine bakın.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="SPREADSHEETML\'yi Java\'de JSON ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="xml" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="SPREADSHEETML\'yi JSON via Java ile Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 SPREADSHEETML'yi programlı olarak JSON ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Java](https://products.aspose.com/cells/java) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="SPREADSHEETML\'yi JSON ile birleştirmek için Java kitaplığı" %}}
