...
description: Aspose Exceller. Python Aspose.Cells. Fusionner MHT avec le format de sauvegarde GIF. Python Combinez MHT au format GIF. Fusionner MHT avec GIF dans Python. Fusion MHT.
...
{{% blocks/products/pf/agp/content h2="Fusionner MHT avec GIF dans Python" %}}
...
{{% cells-merger title="Exemple de code pour fusionner MHT avec GIF dans Python" InputFormat="mht" InputFormat2="gif" outformat="gif" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
