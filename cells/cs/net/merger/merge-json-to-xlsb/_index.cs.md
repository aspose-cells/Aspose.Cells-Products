---
title:  Sloučit JSON na XLSB přes C#
url: /cs/net/merger/merge-json-to-xlsb/ 
description: Sloučit JSON až XLSB online zdarma. Online zdarma JSON až XLSB Fúze. Sloučit JSON do Wordu, Excelu, PPTX, PDF, JPG, HTML, ODS, SVG, XPS a dalších.
---
...
Následující příklad ukazuje, jak sloučit JSON až XLSB v C#.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení JSON až XLSB online" InputFormat="json" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
