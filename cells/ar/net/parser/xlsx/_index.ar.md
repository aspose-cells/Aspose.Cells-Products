---
title:  استخراج النص والصور من XLSX وثيقة via .NET
weight: 4010
description: C# الكود المصدري لاستخراج النصوص والصور من ملف XLSX على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
...
{{% blocks/products/pf/agp/content h2="كيفية تحليل ملف XLSX باستخدام C#" %}}
 ...
 من أجل تحليل الملف XLSX، سنستخدم[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API وهي منصة غنية بالميزات وقوية وسهلة الاستخدام لمعالجة المستندات API لمنصة C#. يفتح[NuGet](https://www.nuget.org/packages/aspose.cells) مدير الحزم، ابحث عن
