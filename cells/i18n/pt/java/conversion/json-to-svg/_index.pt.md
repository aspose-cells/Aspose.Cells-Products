---
title: Converter JSON para SVG via Java 
weight: 6900
url: /pt/java/conversion/json-to-svg/ 
description: Exemplo de código de conversão Java do formato JSON para arquivo SVG. Os programadores podem usar este código de exemplo para exportar planilhas do Excel e OpenOffice para SVG em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter JSON para SVG via Java" h2="Exporte o formato JSON para SVG via Java sem precisar de ferramentas ou bibliotecas adicionais." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter JSON para SVG usando Java" %}}

 Para renderizar JSON para SVG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter JSON em SVG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java os desenvolvedores podem facilmente converter arquivos JSON em SVG em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Criar uma nova instância da classe Workbook1. Selecione o padrão ou qualquer planilha da coleção1. Carregar dados JSON do arquivo1. Crie uma instância de JsonLayoutOptions e defina opções1. Chame o método JsonUtility.importData para importar dados JSON1. Crie e defina o objeto de ImageOrPrintOptions para renderização SVG1. Criar SheetRender para renderização1. Chame o método SheetRender.toImage para salvar o resultado no formato SVG
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão JSON para SVG Java" offSpacer="" %}}
