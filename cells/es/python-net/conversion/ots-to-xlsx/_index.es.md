...
description: Aspose Excel. Convierta OTS a XLSX rápida y fácilmente con Aspose.Cells. Python OTS a XLSX. Python Guarde OTS en XLSX. Guarde OTS como XLSX usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar OTS al XLSX en Python" %}}

El siguiente ejemplo demuestra cómo convertir OTS a XLSX en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir OTS a XLSX" %}}
