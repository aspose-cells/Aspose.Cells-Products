...
description: Sample C++ conversion code for XLSM document to BMP format. Programmers can use this source code for batch XLSM to BMP conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="XLSM to BMP C++ Conversion Source Code" offSpacer="" %}}
