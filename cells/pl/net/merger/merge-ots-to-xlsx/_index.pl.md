...
Poniższy przykład pokazuje, jak scalić OTS z XLSX w Aspose.Cells for .NET.
...
Chcesz programowo połączyć OTS z numerem XLSX? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
