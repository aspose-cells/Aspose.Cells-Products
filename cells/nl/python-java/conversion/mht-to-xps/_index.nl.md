...
description: Aspose Excel. Converteer MHT snel en eenvoudig naar XPS met Aspose.Cells. Python MHT naar XPS. Python Bewaar MHT naar XPS. Sla MHT op als XPS met Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer MHT naar XPS in Python" h2="Snelle Python-bibliotheek voor het converteren van MHT naar XPS. Dit is een professionele softwareoplossing voor het importeren en exporteren van MHT, XPS en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Bewaar MHT op XPS in Python" %}}

In het volgende voorbeeld ziet u hoe u MHT converteert naar XPS in Python.
