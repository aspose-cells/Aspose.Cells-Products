...
هل تحتاج إلى تحويل ملفات MHT إلى XLT برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل MHT إلى XLT في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل MHT إلى XLT باستدعاء طريقة Save ().
