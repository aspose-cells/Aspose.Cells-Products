---
title: دمج FODS في PRN - اجمع FODS إلى PRN في C#
url: /ar/net/merger/merge-fods-to-prn/ 
description: Aspose إكسل. C# Aspose.Cells. الدمج المجاني عبر الإنترنت FODS إلى تنسيق حفظ PRN. C# اجمع FODS إلى تنسيق PRN. دمج FODS إلى PRN في C#. FODS دمج.
...
{{% blocks/products/pf/agp/content h2="قم بدمج FODS إلى PRN في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج FODS مع PRN في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج FODS في PRN. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف PRN. إذا قمت بتطوير رمز في C# ، فسيكون هذا أبسط مما يبدو. راجع C# المثال الذي يدمج FODS إلى PRN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="مجاني عبر الإنترنت لدمج FODS مع PRN في C#" InputFormat="fods" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج FODS مع PRN عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج FODS مع PRN برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2=".NET مكتبة لدمج FODS إلى PRN" %}}
