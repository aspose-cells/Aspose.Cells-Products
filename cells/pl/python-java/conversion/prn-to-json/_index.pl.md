...
description: Aspose Excel. Konwertuj PRN na JSON szybko i łatwo za pomocą Aspose.Cells. Python PRN na JSON. Python Zapisz PRN na JSON. Zapisz PRN jako JSON używając Python.
...
{{% blocks/products/pf/agp/content h2="Zapisz PRN pod numerem JSON w Python" %}}

Poniższy przykład ilustruje sposób konwersji PRN na JSON w Python.
...
{{% cells-convert title="Przykładowy kod do konwersji PRN na JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="json" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji PRN na JSON" %}}
