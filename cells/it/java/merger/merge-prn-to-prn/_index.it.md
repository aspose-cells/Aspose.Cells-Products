---
title: Unisci PRN a PRN - Combina PRN a PRN in Java
url: /it/java/merger/merge-prn-to-prn/ 
description: Aspose Excel. Java Aspose.Cells. Unisci PRN online gratuito al formato di salvataggio PRN. Java Combina il formato PRN con PRN. Unisci PRN a PRN in Java. PRN Merge.
...
{{% blocks/products/pf/agp/content h2="Unisci PRN a PRN in Java online gratuitamente" %}}

L'esempio seguente mostra come unire PRN a PRN in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Segui i semplici passaggi per unire PRN a PRN. Carica i tuoi file, chiama il metodo Workbook.Combine per unire i file, quindi salvalo nel file PRN. Se sviluppi il codice in Java, sarà più semplice di quanto sembri. Vedere l'esempio Java che unisce PRN a PRN.
...
{{% blocks/products/pf/agp/content h2="Come unire PRN a PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Hai bisogno di unire PRN a PRN a livello di programmazione? Un documento di base che si fonde e si concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2="Java libreria per unire PRN a PRN" %}}
