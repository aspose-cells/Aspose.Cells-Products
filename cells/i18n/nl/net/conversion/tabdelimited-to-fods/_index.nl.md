---
title: Converteer TABDELIMITED naar FODS via C#
url: /nl/net/conversion/tabdelimited-to-fods/
description: Voorbeeldcode voor door tabs gescheiden tot fods C# conversie. Gebruik API voorbeeldcode voor batch-tabdelimited-bestanden naar fods-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
...
{{% blocks/products/pf/agp/content h2="Hoe TABDELIMITED naar FODS te converteren met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om TABDELIMITED naar FODS te converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET ontwikkelaars kunnen TABDELIMITED-bestanden gemakkelijk laden en converteren naar FODS in slechts een paar regels code.
