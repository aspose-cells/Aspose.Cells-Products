...
{{% blocks/products/pf/agp/content h2="Så här genererar du XLS-baserade rapporter med C#" %}}
...
1. Instantiera WorkbookDesigner-klassen1. Sätt en markör i någon av cellerna i ett kalkylblad1. Ställ in datakälla för WorkbookDesigner-objektet1. Ring WorkbookDesigner. Process-metod för att fylla mallen med data1. Spara resultatet i XLS-format via WorkbookDesigner.Worbook.Save-metoden
