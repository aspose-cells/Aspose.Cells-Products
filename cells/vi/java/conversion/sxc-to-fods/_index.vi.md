---
title: Chuyển đổi SXC sang FODS qua Java 
url: /vi/java/conversion/sxc-to-fods/ 
description: Mã chuyển đổi Java mẫu cho định dạng SXC thành tệp FODS. Lập trình viên có thể sử dụng mã ví dụ này để xuất bảng tính Excel & OpenOffice sang FODS trong bất kỳ Ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi SXC sang FODS qua Java" h2="Chuyển đổi SXC sang FODS Java để chuyển đổi một hoặc nhiều trang sang FODS bằng cách sử dụng thư viện tại chỗ Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SXC" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi SXC sang FODS bằng cách sử dụng Java" %}}

 Để kết xuất SXC sang FODS, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi SXC sang FODS qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp SXC sang FODS chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp SXC với một phiên bản của lớp Workbook1. Gọi phương thức Workbook.save1. Chuyển đường dẫn đầu ra với phần mở rộng FODS & SaveFormat dưới dạng tham số1. Kiểm tra đường dẫn được chỉ định cho tệp FODS kết quả
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi từ SXC sang FODS Java" offSpacer="" %}}

```cs
// tải tệp SXC trong một phiên bản của Workbook
Workbook book = new Workbook("template.sxc");
// lưu SXC dưới dạng FODS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi SXC sang FODS" sectionDescription="[Chuyển đổi SXC sang FODS](https://products.aspose.app/cells/conversion/sxc-to-fods) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp SXC của bạn, nó sẽ được chuyển đổi ngay lập tức sang FODS." >}}
