---
title: Python NUMARALAR'dan CSV'e - NUMARALAR'dan CSV'e Dönüştürücü
description: Aspose Excel'de. NUMBERS'ı Aspose.Cells ile hızlı ve kolay bir şekilde CSV'e dönüştürün. Python NUMBERS'ı CSV'e dönüştürün. Python NUMBERS'ı CSV'e kaydedin. NUMBERS'ı Python'i kullanarak CSV olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="Python\'i kullanarak NUMBERS\'ı CSV\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="NUMBERS\'ı Python\'de CSV\'e kaydedin" %}}

Aşağıdaki örnekte NUMBERS'ın Python'de CSV'e nasıl dönüştürüleceği gösterilmektedir.
...
{{% cells-convert title="NUMBERS\'ı CSV\'e Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="csv" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="NUMBERS\'ı Python aracılığıyla CSV\'e dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS dosyayı programlı olarak CSV'e dönüştürmeniz mi gerekiyor? Python geliştiricileri, yalnızca birkaç satır kodla NUMBERS'ı kolayca yükleyip CSV'e dönüştürebilir.
...
1.  Workbook.save yöntemini çağırarak NUMBERS'ı CSV'e dönüştürün.
1.  NUMBERS'ın dönüşüm sonucunu CSV'e alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="NUMBERS\'ı CSV\'e dönüştürmek için Python kitaplığı" %}}
