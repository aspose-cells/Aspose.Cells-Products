...
{{% blocks/products/pf/agp/content h2="How to Insert Line into Excel File Using Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert Line to Excel file using Python via .Net" %}}
...
+  Use the shapecollection's add [method](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_line/) to insert a Line in the selected worksheet.
