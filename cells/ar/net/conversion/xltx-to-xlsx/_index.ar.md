---
title: C# XLTX إلى XLSX - عبر الإنترنت من XLTX إلى XLSX
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل XLTX إلى XLSX saveformat. C# XLTX إلى تنسيق XLSX. وفر XLTX إلى XLSX C#.
...
{{% blocks/products/pf/agp/content h2="وفر XLTX إلى XLSX في C# عبر الإنترنت مجانًا" %}}
...
تحتاج إلى تحويل XLTX ملفات إلى XLSX برمجيا؟ يمكن للمطورين .NET تحميل وتحويل XLTX إلى XLSX بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  حول XLTX إلى XLSX عن طريق استدعاء Workbook.Save method.
