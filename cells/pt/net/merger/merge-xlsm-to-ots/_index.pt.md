---
title: Mesclar XLSM com OTS - Combinar XLSM com OTS em C#
url: /pt/net/merger/merge-xlsm-to-ots/ 
description: Aspose Excel. C# Aspose.Cells. Mesclar XLSM para salvar o formato OTS. C# Combine XLSM para o formato OTS. Mesclar XLSM com OTS em C#. XLSM Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar XLSM com OTS em C#" %}}

exemplo a seguir demonstra como mesclar XLSM com OTS em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XLSM com OTS. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-os no arquivo OTS. Se você desenvolver código em C#, será mais simples do que parece. Veja o exemplo C# que mescla XLSM com OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemplo de código para mesclar XLSM com OTS em C#" InputFormat="xlsm" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XLSM com OTS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XLSM com OTS programaticamente? Um documento básico mesclado e concatenado com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca .NET para mesclar XLSM com OTS" %}}
