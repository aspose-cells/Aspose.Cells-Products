---
title:  ค้นหาเอกสารหมายเลข XLSB โดยไม่ต้องเปิดผ่านหมายเลข C++
weight: 7020
description: C++ ตัวอย่างโค้ดสำหรับค้นหาคำที่มีรูปแบบในไฟล์ XLSB บนสภาพแวดล้อมรันไทม์ C++ สำหรับ Windows 32 บิต, Windows 64 บิต และ Linux 64 บิต
...
{{< blocks/products/pf/i18n/upper-banner h1="ค้นหารูปแบบ XLSB ใน C++" h2="การค้นหาเอกสารแบบเนทีฟและประสิทธิภาพสูง XLSB โดยใช้ API ฝั่งเซิร์ฟเวอร์ Aspose.Cells for C++ โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Adobe PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีการค้นหาไฟล์หมายเลข XLSB โดยใช้รหัส C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการค้นหาไฟล์หมายเลข XLSB ในรหัสไปรษณีย์ C++" %}}
