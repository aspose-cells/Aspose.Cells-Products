---
title: Edytuj lub wyświetl metadane dokumentu XLSX za pomocą C++ 
weight: 8970
url: /pl/cpp/metadata/xlsx/ 
description: C++ przykładowy kod do edycji lub przeglądania metadanych pliku XLSX w C++ środowisku wykonawczym dla 32-bitowego systemu Windows, 64-bitowego systemu Windows i 64-bitowego systemu Linux.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wyodrębnij metadane XLSX przez C++" h2="Twórz własne C++ aplikacje, aby dodawać, edytować, usuwać lub wyodrębniać metadane z plików XLSX przy użyciu interfejsów API po stronie serwera." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
