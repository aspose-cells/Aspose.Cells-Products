---
title: Extrahujte text a obrázky z dokumentu XLS prostřednictvím Java 
weight: 3700
url: /cs/java/parser/xls/ 
description: Java ukázkový kód pro extrahování textu a obrázků ze souboru XLS v Java Runtime Environment pro JSP/JSF aplikace a desktopové aplikace.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Analyzovat formáty XLS v Java" h2="Nativní a vysoce výkonná analýza dokumentů XLS pomocí rozhraní API Aspose.Cells for Java na straně serveru bez použití jakéhokoli softwaru, jako je Microsoft nebo Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
+ Načíst dokument XLS pomocí třídy Workbook.
...
{{% blocks/products/pf/agp/code-block title="Analyzovat soubory XLS – Java" offSpacer="" %}}
