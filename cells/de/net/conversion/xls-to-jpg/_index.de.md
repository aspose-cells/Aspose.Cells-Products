---
title: C# XLS zu JPG - XLS zu JPG Konverter
description: Aspose Excel. Diese umfassende Lösung bietet Entwicklern einen vollständig integrierten Ansatz zur Konvertierung von XLS in das JPG-Format und ermöglicht das nahtlose Speichern von XLS-Daten im JPG-Format mithilfe der Aspose.Cells-Bibliothek, alles durch effizienten und anpassbaren C#-Code.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS als JPG in C#" %}}

Das folgende Beispiel zeigt, wie man XLS in JPG in C# konvertiert.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um XLS in JPG zu konvertieren. Laden Sie Ihre XLS-Datei hoch und speichern Sie sie dann einfach als JPG-Datei. Sowohl zum Lesen von XLS als auch zum Schreiben von JPG können Sie vollqualifizierte Dateinamen verwenden. Der ausgegebene JPG-Inhalt und die Formatierung sind identisch mit dem ursprünglichen XLS-Dokument.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Beispielcode zur Konvertierung von XLS in JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="jpg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in JPG" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in JPG konvertieren? .NET-Entwickler können XLS mit nur wenigen Codezeilen problemlos in JPG laden und konvertieren.
...
1.  Konvertieren Sie XLS in das JPG-Format, indem Sie die Methode Workbook.Save aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLS in JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLS in JPG" %}}
