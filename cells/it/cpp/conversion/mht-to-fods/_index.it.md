...
{{% cells-convert title="Codice di esempio per convertire MHT in FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="fods" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Come convertire MHT in FODS tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

È necessario convertire i file MHT in FODS a livello di codice? Gli sviluppatori di C++ possono convertire facilmente MHT in FODS in poche righe di codice.
...
1.  Converti MHT in FODS chiamando il metodo Save().
