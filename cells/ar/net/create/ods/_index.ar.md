...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء ODS عبر C#" %}}
...
{{% blocks/products/pf/agp/code-block title="نموذج التعليمات البرمجية لإنشاء ملف ODS (Openoffice / Lbreoffice) باستخدام C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة C# لإنشاء ملف ODS" %}}
