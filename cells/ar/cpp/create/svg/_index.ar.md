...
description: Aspose اكسل. C++ أنشئ ملف SVG بسرعة وسهولة باستخدام Aspose.Cells. أنشئ ملف SVG باستخدام C++. أنشئ SVG في C++. C++ SVG Creator.
...
1.  احفظ المصنف كملف .svg باستخدام طريقة Save().
