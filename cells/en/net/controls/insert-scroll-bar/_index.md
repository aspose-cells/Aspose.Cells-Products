...
+  Use the [add method](https://apireference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addscrollbar) to insert a ScrollBar in the selected worksheet
