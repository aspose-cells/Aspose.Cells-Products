---
title: XLSX을 PRN Python via Python로 변환
description: 무료로 XLSX을 PRN 온라인으로 변환하십시오. 무료 온라인 XLSX을 PRN 변환기로 변환합니다. Python XLSX을 PRN으로. XLSX에서 Python을 통해 PRN으로.
...
{{% cells-convert title="XLSX을 PRN 온라인으로 변환하는 무료 앱 및 샘플 코드" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="prn" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="XLSX을 PRN으로 변환하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

 Python 개발자는 단 몇 줄의 코드로 XLSX을 PRN으로 쉽게 로드 및 변환할 수 있습니다.
...
1.  Workbook.save 메서드를 호출하여 XLSX을 PRN으로 변환
