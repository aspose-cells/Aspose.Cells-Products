---
title: PRN을 XLSX에 병합 - C++에서 PRN을 XLSX에 결합
url: /ko/cpp/merger/merge-prn-to-xlsx/ 
description: Aspose 엑셀. C++ Aspose.Cells. PRN을 XLSX 저장 형식에 병합합니다. C++ PRN을 XLSX 형식으로 결합합니다. C++에서 PRN을 XLSX로 병합합니다. PRN 병합.
...
{{% blocks/products/pf/agp/content h2="C++에서 PRN을 XLSX에 병합" %}}

다음 예에서는 PRN을 Aspose.Cells for C++의 XLSX에 병합하는 방법을 보여줍니다.
{{% blocks/products/pf/agp/text %}}

간단한 단계에 따라 PRN을 XLSX에 병합하세요. 파일을 업로드하고 파일 병합을 위해 Workbook.Combine 메서드를 호출한 다음 XLSX 파일에 저장하세요. C++에서 코드를 개발하면 생각보다 간단해질 것입니다. PRN을 XLSX에 병합하는 C++ 예를 참조하세요.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="C++에서 PRN을 XLSX에 병합하는 샘플 코드" InputFormat="prn" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="C++을 통해 PRN을 XLSX에 병합하는 방법" %}}

{{% blocks/products/pf/agp/text %}}

프로그래밍 방식으로 PRN을 XLSX에 병합해야 합니까? 병합하고 연결하는 기본 문서[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) 단 몇 줄의 코드만으로 API를 구현할 수 있습니다.
