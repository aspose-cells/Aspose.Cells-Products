---
title: Konvertera MHTML till JPG via programmet C++ 
url: /sv/cpp/conversion/mhtml-to-jpg/ 
description: Exempel på konverteringskod för C++ för MHTML-dokument till JPG-format. Programmerare kan använda den här källkoden för batchkonvertering av MHTML till JPG inom alla C++-program.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera MHTML till JPG via C++" h2="Högpresterande MHTML till JPG-konvertering med hjälp av C++-biblioteket utan behov av Microsoft Excel, OpenOffice eller Adobe Acrobat-installation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++-utvecklare kan enkelt konvertera MHTML-fil till JPG på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda MHTML-fil med Factory::CreateIWorkbook.1. Anropa metoden Save().1. Skicka utdatafilens sökväg med (JPG) filtillägg.1. JPG-filen kommer att sparas på den angivna sökvägen.1. Öppna JPG-filen i ett kompatibelt program.
...
{{% blocks/products/pf/agp/code-block title="MHTML till JPG C++ Källkod för omvandling" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="MHTML till JPG Conversion Live Demos" sectionDescription="[Konvertera MHTML till JPG](https://products.aspose.app/cells/conversion/mhtml-to-jpg) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din MHTML-fil, den konverteras omedelbart till JPG." >}}
