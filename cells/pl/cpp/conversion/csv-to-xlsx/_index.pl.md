---
title: Konwertuj CSV na XLSX za pomocą aplikacji C++ 
weight: 4030
url: /pl/cpp/conversion/csv-to-xlsx/ 
description: Przykładowy kod konwersji C++ dla dokumentu CSV do formatu XLSX. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji CSV do XLSX w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik CSV na XLSX w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik CSV przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLSX).1. Plik XLSX zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLSX w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="CSV do XLSX C++ Kod źródłowy konwersji" offSpacer="" %}}
