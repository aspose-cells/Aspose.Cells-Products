---
title: PHP MHTML a OTS - Convertidor de MHTML a OTS
description: Aspose Excel. Convierta MHTML a OTS rápida y fácilmente con Aspose.Cells. PHP MHTML a OTS. PHP Guarde MHTML en OTS. Guarde MHTML como OTS usando PHP.
...
{{% blocks/products/pf/agp/content h2="Cómo convertir MHTML a OTS mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos MHTML a OTS mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente MHTML a OTS en tan solo unas pocas líneas de código.
...
1.  Convierta MHTML a OTS llamando al método de guardar del libro de trabajo.
1.  Obtenga el resultado de la conversión de MHTML a OTS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca PHP para convertir MHTML a OTS" %}}
