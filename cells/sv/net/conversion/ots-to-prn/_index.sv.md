---
title: C# OTS till PRN - OTS till PRN-omvandlare
description: Aspose Excel. Denna omfattande lösning ger C#-utvecklare en helt integrerad metod för att konvertera OTS till PRN-format, vilket möjliggör sömlös sparning av OTS-data till PRN-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C#-kod.
...
{{% blocks/products/pf/agp/content h2="Spara OTS till PRN i C#" %}}

Följande exempel visar hur man konverterar OTS till PRN i C#.
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar OTS till PRN via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera OTS-filer till PRN programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera OTS till PRN på bara några rader kod.
...
1.  Konvertera OTS till PRN genom att anropa Workbook.Save-metoden.
1.  Få konverteringsresultatet från OTS till PRN.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-bibliotek för att konvertera OTS till PRN" %}}
