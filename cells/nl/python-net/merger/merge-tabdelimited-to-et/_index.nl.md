---
title: Voeg TABDELLIMITED samen met ET - Combineer TABDELLIMITED met ET in Python
url: /nl/python-net/merger/merge-tabdelimited-to-et/ 
description: Aspose Excel. Python Aspose.Cells. TABDELIMITED samenvoegen naar ET-opslagformaat. Python Combineer TABDELIMITED naar ET-formaat. TABDELLIMITED samenvoegen met ET in Python. TABDELLIMITED Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg TABDELIMITED samen met ET in Python" %}}

Het volgende voorbeeld laat zien hoe u TABDELLIMITED kunt samenvoegen met ET in Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om TABDELLIMITED samen te voegen met ET. Upload uw bestanden, roep de Workbook.Combine-methode aan voor het samenvoegen van bestanden en sla deze vervolgens op in een ET-bestand. Als u code ontwikkelt in Python, is dit eenvoudiger dan het klinkt. Zie voorbeeld Python waarin TABDELLIMITED wordt samengevoegd met ET.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Voorbeeldcode om TABDELIMITED samen te voegen met ET in Python" InputFormat="tsv" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Hoe TABDELLIMITED samen te voegen naar ET via Python" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u TABDELLIMITED programmatisch samenvoegen met ET? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen met slechts enkele regels code worden uitgevoerd.
...
{{% blocks/products/pf/agp/content h2="Python bibliotheek om TABDELLIMITED samen te voegen met ET" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="Andere ondersteunde samenvoegformaten" subTitle="Met behulp van Python kan men ook tabgescheiden samenvoegen met vele andere bestandsformaten, waaronder." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/python-net/merger/merge-tabdelimited-to-md/" name="TABDELIMITED samenvoegen tot MD" description="Markdown-taal" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/python-net/merger/merge-tabdelimited-to-mhtml/" name="TABDELIMITED samenvoegen tot MHTML" description="Archiefformaat webpagina" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/python-net/merger/merge-tabdelimited-to-ods/" name="TABDELIMITED samenvoegen tot ODS" description="OpenDocument-spreadsheetbestand" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/python-net/merger/merge-tabdelimited-to-tiff/" name="TABDELIMITED samenvoegen tot TIFF" description="Getagd beeldformaat" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/python-net/merger/merge-tabdelimited-to-xltm/" name="TABDELIMITED samenvoegen tot XLTM" description="Excel-sjabloon met macro\'s" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/python-net/merger/merge-tabdelimited-to-xml/" name="TABDELIMITED samenvoegen naar XML" description="Uitbreidbare opmaaktaal" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/python-net/merger/merge-tabdelimited-to-jpeg/" name="TABDELIMITED samenvoegen tot JPEG" description="JPEG Afb" >}}
