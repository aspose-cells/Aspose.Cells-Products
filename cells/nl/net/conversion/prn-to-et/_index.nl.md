---
title: C# PRN naar ET - PRN naar ET-omzetter
description: Aspose Excel. Converteer PRN snel en eenvoudig naar ET met Aspose.Cells. C# PRN naar ET. C# PRN opslaan in ET. Sla PRN op als ET via C#.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer PRN naar ET in C#" h2="Snelle C#-bibliotheek voor het converteren van PRN naar ET. Dit is een professionele softwareoplossing voor het importeren en exporteren van PRN, ET en vele andere formaten op .NET Framework, .NET Core of Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ET" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PRN" >}}
...
{{% blocks/products/pf/agp/content h2="Sla PRN op in ET in C#" %}}

Het volgende voorbeeld laat zien hoe u PRN naar ET converteert in C#.
...
{{% cells-convert title="Voorbeeldcode om PRN naar ET te converteren" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="prn" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hoe PRN naar ET te converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u PRN-bestanden programmatisch naar ET converteren? .NET-ontwikkelaars kunnen PRN eenvoudig in slechts een paar regels code laden en converteren naar ET.
