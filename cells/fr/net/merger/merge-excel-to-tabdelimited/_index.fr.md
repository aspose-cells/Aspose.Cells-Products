---
title: Fusionner EXCEL avec TABDELIMITED - Combiner EXCEL avec TABDELIMITED dans C#
url: /fr/net/merger/merge-excel-to-tabdelimited/ 
description: Aspose Exceller. C# Aspose.Cells. Fusionner EXCEL avec le format de sauvegarde TABDELIMITED. C# Combinez EXCEL au format TABDELIMITED. Fusionner EXCEL avec TABDELIMITED dans C#. EXCEL Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner EXCEL avec TABDELIMITED dans C#" %}}
...
{{% cells-merger title="Exemple de code pour fusionner EXCEL avec TABDELIMITED dans C#" InputFormat="xlsx" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner EXCEL avec TABDELIMITED via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner EXCEL avec TABDELIMITED par programme ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque .NET pour fusionner EXCEL avec TABDELIMITED" %}}
