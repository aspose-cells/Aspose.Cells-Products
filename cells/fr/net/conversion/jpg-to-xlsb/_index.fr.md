---
title: C# JPG en XLSB - Convertisseur JPG en XLSB
description: Aspose Excel. Cette solution complète offre aux développeurs C# une approche entièrement intégrée pour convertir le format JPG au format XLSB, permettant un enregistrement transparent des données JPG au format XLSB à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C# efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer le JPG sous XLSB dans C#" %}}

L'exemple suivant montre comment convertir un fichier JPG en XLSB en C#.
...
{{% cells-convert title="Exemple de code pour convertir un fichier JPG en XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="jpg" outformat="xlsb" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir JPG en XLSB via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en XLSB par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en XLSB en quelques lignes de code.
...
1.  Convertissez le JPG au format XLSB en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de JPG en XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en XLSB" %}}
