---
title: Combinar XLTX a BMP - Combinar XLTX a BMP en C#
url: /es/net/merger/merge-xltx-to-bmp/ 
description: AsposeExcel. C# Aspose.Cells. Combinar gratis en línea XLTX a BMP guardar formato. C# Combina el formato XLTX con el BMP. Combinar XLTX a BMP en C#. XLTX Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine XLTX a BMP en C# en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar XLTX con BMP en Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLTX a BMP. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo BMP. Si desarrolla código en C#, esto será más simple de lo que parece. Consulte el ejemplo C# que combina XLTX con BMP.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar XLTX a BMP en C#" InputFormat="xltx" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLTX a BMP a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLTX con BMP mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para fusionar XLTX a BMP" %}}
