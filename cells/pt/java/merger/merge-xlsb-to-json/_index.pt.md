...
description: Aspose Excel. Java Aspose.Cells. Mesclagem online gratuita XLSB para JSON saveformat. Java Combine o formato XLSB a JSON. Mesclar XLSB a JSON em Java. XLSB Mesclar.
...
O exemplo a seguir demonstra como mesclar XLSB a JSON em Aspose.Cells for Java.
...
{{% cells-merger title="Online grátis para mesclar XLSB a JSON em Java" InputFormat="xlsb" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XLSB com JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar XLSB a JSON programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Java](https://products.aspose.com/cells/java) As APIs podem ser feitas com apenas algumas linhas de código.
