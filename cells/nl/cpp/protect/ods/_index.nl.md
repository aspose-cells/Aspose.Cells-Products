---
title:  Bescherm en vergrendel document ODS via C++
weight: 10010
...
{{% blocks/products/pf/agp/content h2="Hoe ODS-bestanden te beveiligen met C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om ODS-bestanden te beschermen via C++" %}}
...
1.  Laad het bestand ODS met behulp van de IWorkbook-klasse
1.  Gebruik Protect(..) methode met ProtectionType en Password
1.  Sla het beveiligde bestand ODS op met de methode Save().
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Gratis app om ODS te beschermen" sectionDescription=" Bekijk onze live demo\'s om[versleutelen ODS bestanden](https://products.aspose.app/cells/protect/ods) met volgende voordelen." >}}
