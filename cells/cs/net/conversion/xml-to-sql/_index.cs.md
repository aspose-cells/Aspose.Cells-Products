...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C# plně integrovaný přístup k převodu XML do formátu SQL, což umožňuje bezproblémové ukládání XML dat do formátu SQL pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C#.
...
{{% blocks/products/pf/agp/content h2="Uložení XML do SQL v C#" %}}

Následující příklad ukazuje, jak převést XML na SQL v adresáři C#.
...
1.  Převeďte XML do SQL voláním metody Workbook.Save.
1.  Získejte výsledek převodu XML na SQL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna C# pro převod XML do SQL" %}}
