...
以下示例演示如何將 XLSB 合併到 SQL 中 Aspose.Cells for Python via Java。
...
需要以編程方式將 XLSB 合併到 SQL 嗎？基本文檔合併和連接[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)只需幾行代碼即可完成 API。
