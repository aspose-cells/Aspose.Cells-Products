---
title: Μετατροπή SPREADSHEETML σε BMP μέσω της εφαρμογής C++ 
url: /el/cpp/conversion/spreadsheetml-to-bmp/ 
description: Δείγμα κώδικα μετατροπής C++ για έγγραφο SPREADSHEETML σε μορφή BMP. Οι προγραμματιστές μπορούν να χρησιμοποιήσουν αυτόν τον πηγαίο κώδικα για μαζική μετατροπή SPREADSHEETML σε BMP σε οποιαδήποτε εφαρμογή C++.
---
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε SPREADSHEETML σε BMP χρησιμοποιώντας το C++" %}}
 ...
 Για να μετατρέψουμε SPREADSHEETML σε BMP, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/text %}}
 ...
 Οι προγραμματιστές του C++ μπορούν εύκολα να μετατρέψουν το αρχείο SPREADSHEETML σε BMP σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φορτώστε το αρχείο SPREADSHEETML χρησιμοποιώντας το Factory::CreateIWorkbook.1. Επιλέξτε το πρώτο φύλλο εργασίας.1. Ορισμός επιλογών (BMP).1. Επανάληψη σε κάθε σελίδα του φύλλου και απόδοση.1. Ανοίξτε το αρχείο BMP σε συμβατό πρόγραμμα.
...
{{% blocks/products/pf/agp/code-block title="Πηγαίος κώδικας μετατροπής SPREADSHEETML σε BMP C++" offSpacer="" %}}
