---
title: Sloučit SPREADSHEETML s CSV - Sloučit SPREADSHEETML s CSV v Java
url: /cs/java/merger/merge-spreadsheetml-to-csv/ 
description: Aspose Excel. Java Aspose.Cells. Zdarma online sloučit SPREADSHEETML do formátu uložení CSV. Java Zkombinujte SPREADSHEETML do formátu CSV. Sloučit SPREADSHEETML na CSV v Java. SPREADSHEETML Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit SPREADSHEETML na CSV v Java online zdarma" %}}

Následující příklad ukazuje, jak sloučit SPREADSHEETML do CSV v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení SPREADSHEETML do CSV. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru CSV. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí SPREADSHEETML do CSV.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení SPREADSHEETML na CSV v Java" InputFormat="xml" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit SPREADSHEETML do CSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit SPREADSHEETML do CSV? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java ke sloučení SPREADSHEETML do CSV" %}}
