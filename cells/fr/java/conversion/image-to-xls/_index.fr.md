---
title: Java IMAGE en XLS - Convertisseur IMAGE en XLS
description: Aspose Exceller. Convertissez IMAGE en XLS rapidement et facilement avec Aspose.Cells. Java IMAGE en XLS. Java Enregistrez IMAGE en XLS. Enregistrez IMAGE sous XLS en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrer l\'IMAGE au XLS dans Java" %}}
...
{{% cells-convert title="Exemple de code pour convertir IMAGE en XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="xls" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir une image en XLS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers IMAGE en XLS par programme ? Les développeurs Java peuvent facilement convertir IMAGE en XLS en quelques lignes de code seulement.
