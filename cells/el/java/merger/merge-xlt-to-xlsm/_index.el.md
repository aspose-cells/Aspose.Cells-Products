---
title:  Συγχώνευση XLT σε XLSM via Java
url: /el/java/merger/merge-xlt-to-xlsm/ 
description: Συγχώνευση XLT σε XLSM Online δωρεάν. Δωρεάν Online XLT έως XLSM Συγχώνευση. Συγχώνευση XLT σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLT με το XLSM στο Java.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση XLT με XLSM σε απευθείας σύνδεση" InputFormat="xlt" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
