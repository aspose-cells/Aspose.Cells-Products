...
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 XLS 轉換為 EXCEL。Python XLS 轉換為 EXCEL。 Python 將 XLS 儲存到 EXCEL。使用 Python 將 XLS 另存為 EXCEL。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 XLS 轉換為 EXCEL Python" h2="高速Python庫，用於將XLS轉換為EXCEL。這是一個使用Python導入和匯出XLS、EXCEL和許多其他格式的專業軟體解決方案。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EXCEL" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="將 XLS 儲存到 EXCEL 中 Python" %}}

下面的範例示範如何將XLS轉換為EXCEL中的Python。
