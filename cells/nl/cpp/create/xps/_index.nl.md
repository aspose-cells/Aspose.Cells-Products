---
title: Maak XPS aan - Maak XPS-bestand aan in C++
description: Aspose Excel. Genereer en bewerk moeiteloos XPS-bestanden met de Aspose.Cells for C++-bibliotheek. Deze krachtige API biedt een gestroomlijnde en efficiënte oplossing voor het maken, bewerken en beheren van XPS-bestanden rechtstreeks binnen uw C++-toepassingen, waarmee met hoge precisie aan specifieke ontwikkelaarsbehoeften wordt voldaan.
...
{{% blocks/products/pf/agp/content h2="Hoe u XPS aanmaakt in C++" %}}
...
1. Sla het werkblad op als een .xps-bestand met behulp van de Save()-methode.

{{% blocks/products/pf/agp/code-block title="Voorbeeldcode laat zien hoe u het bestand XPS maakt in C++." offSpacer="" %}}
