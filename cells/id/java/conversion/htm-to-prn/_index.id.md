---
title: Java HTM ke PRN - Konverter HTM ke PRN
description: Aspose Excel. Solusi komprehensif ini menyediakan Java pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi format HTM ke PRN, memungkinkan penyimpanan data HTM ke format PRN dengan mudah menggunakan pustaka Aspose.Cells, semuanya melalui kode Java yang efisien dan dapat disesuaikan.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan HTM ke PRN di Java" h2="Pustaka berkecepatan tinggi Java untuk mengkonversi HTM ke PRN. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor HTM, PRN, dan banyak format lainnya menggunakan Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PRN" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Simpan HTM ke PRN di Java" %}}

Contoh berikut menunjukkan cara mengkonversi HTM ke PRN di Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi HTM ke PRN. Unggah file HTM Anda, lalu simpan sebagai file PRN. Untuk pembacaan HTM dan penulisan PRN, Anda dapat menggunakan nama file yang sepenuhnya memenuhi syarat. Konten dan format PRN keluaran akan sama dengan dokumen HTM asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Contoh Kode untuk Mengonversi HTM ke PRN" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="prn" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi HTM ke PRN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengkonversi file HTM ke PRN secara terprogram? Pengembang Java dapat dengan mudah mengkonversi HTM ke PRN hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk mengkonversi HTM ke PRN" %}}
{{% blocks/products/pf/agp/text %}}
