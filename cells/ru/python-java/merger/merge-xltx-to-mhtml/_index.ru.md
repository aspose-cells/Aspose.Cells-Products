---
title: Объединить XLTX в MHTML - Объединить XLTX в MHTML в Python
url: /ru/python-java/merger/merge-xltx-to-mhtml/ 
description: Aspose Excel. Python Aspose.Cells. Бесплатное онлайн объединение XLTX в формат сохранения MHTML. Python Объединить формат XLTX в формат MHTML. Объединить XLTX с MHTML в Python. XLTX Объединить.
...
{{% cells-merger title="Бесплатно онлайн объединить XLTX с MHTML в Python" InputFormat="xltx" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Как объединить XLTX с MHTML через Python" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить XLTX с MHTML? Базовый документ сливается и объединяется с[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API можно реализовать всего несколькими строками кода.
