---
title: Cara menggambar atau menyisipkan bentuk panah melengkung ke dalam excel menggunakan Python via .Net
weight: 10
description: Python via .Net kode sumber untuk menyisipkan bentuk panah melengkung ke dalam Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan bentuk panah melengkung ke dalam Excel menggunakan Python via .Net" h2="Masukkan bentuk panah melengkung menggunakan Aspose.Cells\' API tanpa software apa pun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Menyisipkan Bentuk Panah Melengkung ke File Excel Menggunakan Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah menyisipkan bentuk panah melengkung ke file Excel menggunakan Python via .Net" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan tambahan shapecollection[metode](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int)untuk menyisipkan bentuk panah melengkung di lembar kerja yang dipilih.
...
-  Sistem operasi apa pun yang dapat menjalankan skrip .Net Python via, seperti Windows dan Linux
...
{{% blocks/products/pf/agp/code-block title="Sisipkan bentuk panah melengkung - Python via .Net" offSpacer="" %}}
