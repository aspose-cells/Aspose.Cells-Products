...
description: Aspose Excel. Converta XLS em WORD de forma rápida e fácil com Aspose.Cells. C++ XLS em WORD. C++ Salve XLS em WORD. Salve XLS como 07611134 81 usando C++.
...
{{% blocks/products/pf/agp/content h2="Converta XLS em WORD usando C++" %}}
...
{{% blocks/products/pf/agp/content h2="Salve XLS para WORD em C++" %}}
...
{{% cells-convert title="Exemplo de código para converter XLS em WORD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="docx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Como converter XLS em WORD por meio de C++" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos XLS em WORD programaticamente? Os desenvolvedores do C++ podem converter facilmente XLS em WORD em apenas algumas linhas de código.
...
1.  Converta XLS em WORD chamando o método Save().
