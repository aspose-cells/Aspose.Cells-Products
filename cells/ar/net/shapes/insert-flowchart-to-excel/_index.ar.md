...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إدراج/إنشاء مخطط انسيابي لملف Excel عبر C#" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم[إضافة طريقة](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape) لإدراج/إنشاء مخطط انسيابي في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="إدراج/إنشاء مخطط انسيابي - C#" offSpacer="" %}}
...
<div class="container-fluid features-section bg-gray">
 ...
 AutoShapeType.FlowChartData
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-12">
 AutoShapeType.FlowChartPreferenceProcess
    </p>
   </div>
   <div class="col-lg-4">
