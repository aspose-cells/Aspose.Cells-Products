---
title: สร้างรายงานในไฟล์ XLS ผ่าน .NET 
weight: 1700
url: /th/net/assembly/xls/ 
description: C# ซอร์สโค้ดเพื่อสร้างรายงานรูปแบบ XLS บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms
---
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการประกอบ XLS ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. สร้างอินสแตนซ์ WorkbookDesigner class1. ตั้งเครื่องหมายในเซลล์ใด ๆ ของเวิร์กชีตใด ๆ1. ตั้งค่าแหล่งข้อมูลสำหรับวัตถุ WorkbookDesigner1. วิธีการเรียก WorkbookDesigner.Process เพื่อเติมเทมเพลตด้วย data1. บันทึกผลลัพธ์ในรูปแบบ XLS ผ่าน WorkbookDesigner.Worbook.Save method
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API สามารถใช้เพื่อสร้าง แก้ไข แปลง และแสดงรูปแบบ Microsoft Excel เป็นรูปแบบต่างๆ นอกจากนี้ยังสามารถใช้สำหรับการสร้างแผนภูมิที่ครอบคลุม การรายงานที่ปรับขนาดได้ และการคำนวณที่เชื่อถือได้ภายในแอปพลิเคชันซอฟต์แวร์ Aspose.Cells เป็นแบบสแตนด์อโลน API และไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ OpenOffice  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="แอพฟรีสำหรับประกอบ XLS" sectionDescription="ตรวจสอบการสาธิตสดของเราที่ [สร้างไฟล์ XLS](https://products.aspose.app/cells/assembly/xls) พร้อมสิทธิประโยชน์ดังต่อไปนี้" >}}
