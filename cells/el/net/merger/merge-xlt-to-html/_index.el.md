---
title:  Συγχώνευση XLT σε HTML μέσω C#
url: /el/net/merger/merge-xlt-to-html/ 
description: Συγχώνευση XLT σε HTML Online δωρεάν. Δωρεάν Online XLT έως HTML Συγχώνευση. Συγχώνευση XLT σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το XLT με το HTML στο C#.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση XLT με HTML σε απευθείας σύνδεση" InputFormat="xlt" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
