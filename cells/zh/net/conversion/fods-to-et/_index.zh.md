---
title: C# FODS 至 ET - FODS 至 ET 转换器
description: Aspose Excel。此综合解决方案为 C# 开发人员提供了一种完全集成的方法，可将 FODS 转换为 ET 格式，从而能够使用 Aspose.Cells 库将 FODS 数据无缝保存为 ET 格式，所有这些都通过高效且可定制的 C# 代码实现。
...
{{% blocks/products/pf/agp/content h2="将 FODS 保存到 C# 的 ET 中" %}}

以下示例演示如何将 FODS 转换为 C# 中的 ET。
...
{{% cells-convert title="将 FODS 转换为 ET 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="fods" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通过 C# 将 FODS 转换为 ET" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 FODS 文件转换为 ET？.NET 开发人员只需几行代码即可轻松加载并将 FODS 转换为 ET。
...
1. 向您的 C# 项目添加库引用（导入库）。
1. 使用工作簿实例加载 FODS 文件。
1. 调用 Workbook.Save 方法将 FODS 转换为 ET。
1. 获取FODS至ET的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# 库用于将 FODS 转换为 ET" %}}
