---
title: Python MHT naar MHT - MHT naar MHT-converter
description: Aspose Excel. Converteer MHT snel en eenvoudig naar MHT met Aspose.Cells. Python MHT naar MHT. Python MHT opslaan in MHT. Sla MHT op als MHT met Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer MHT naar MHT in Python" h2="Snelle Python-bibliotheek voor het converteren van MHT naar MHT. Dit is een professionele softwareoplossing voor het importeren en exporteren van MHT, MHT en vele andere formaten met behulp van Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Sla MHT op in MHT in Python" %}}

In het volgende voorbeeld ziet u hoe u MHT naar MHT converteert in Python.
