...
{{% blocks/products/pf/agp/content h2="Sla TXT op in SXC in Java" %}}

Het volgende voorbeeld laat zien hoe je TXT omzet naar SXC in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TXT om naar SXC of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TXT programmatisch converteren naar SXC? Ontwikkelaars van Java kunnen bestanden met de extensie TXT eenvoudig converteren naar SXC met slechts een paar regels code.
