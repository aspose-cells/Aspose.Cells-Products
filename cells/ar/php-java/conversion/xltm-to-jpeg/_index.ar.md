---
title: PHP XLTM إلى JPEG - XLTM إلى JPEG محول
description: Aspose اكسل. قم بتحويل XLTM إلى JPEG بسرعة وسهولة باستخدام Aspose.Cells. PHP XLTM إلى JPEG. PHP احفظ XLTM إلى JPEG. احفظ XLTM كـ JPEG باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTM إلى JPEG عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLTM إلى JPEG برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLTM إلى JPEG بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLTM إلى JPEG عن طريق استدعاء طريقة حفظ المصنف.
