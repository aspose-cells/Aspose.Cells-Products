...
{{% blocks/products/pf/agp/content h2="在 Java 免費在線合併 TSV 到 TSV" %}}

以下示例演示如何將 TSV 合併到 Java 中的 TSV。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 TSV 合併到 TSV。上傳文件，調用 Workbook.Combine 方法合併文件，然後將其保存到 TSV 文件。如果您在 Java 中開發代碼，這將比聽起來更簡單。請參閱將 TSV 合併到 TSV 的 Java 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="免費應用程序在線將 TSV 合併為 TSV" InputFormat="tsv" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="如何合併 TSV 到 TSV via Java" %}}
...
{{% blocks/products/pf/agp/content h2="Java 庫合併 TSV 到 TSV" %}}
