...
url: /pl/net/merger/merge-image-to-jpg/ 
...
Poniższy przykład pokazuje, jak połączyć OBRAZ z JPG w Aspose.Cells for .NET.
...
Chcesz programowo scalić OBRAZ z JPG? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do scalania OBRAZU z JPG" %}}
