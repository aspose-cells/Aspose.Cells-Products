---
title: Buat FODS - Buat file FODS di C++
description: Aspose Unggul. C++ Buat file FODS dengan cepat dan mudah dengan Aspose.Cells. Hasilkan file FODS menggunakan C++. Buat FODS di C++. C++ FODS Creater.
...
{{% blocks/products/pf/agp/content h2="Cara Membuat FODS di C++" %}}

{{% blocks/products/pf/agp/text %}}

 Mudah bagi pengembang untuk membuat, memuat, memodifikasi, dan mengonversi file FODS dalam menjalankan aplikasi pelaporan untuk pemrosesan data hanya dalam beberapa baris kode.
...
1.  Simpan buku kerja sebagai file .fods menggunakan metode Save().

{{% blocks/products/pf/agp/code-block title="Kode contoh menunjukkan cara membuat file FODS di C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Perpustakaan C++ untuk membuat file FODS" %}}
