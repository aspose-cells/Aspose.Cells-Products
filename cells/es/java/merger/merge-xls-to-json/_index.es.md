---
title: Combinar XLS a JSON - Combinar XLS a JSON en Java
url: /es/java/merger/merge-xls-to-json/ 
description: AsposeExcel. Java Aspose.Cells. Combinar gratis en línea XLS a JSON guardar formato. Java Combina el formato XLS con el JSON. Combinar XLS a JSON en Java. XLS Combinar.
...
{{% blocks/products/pf/agp/content h2="Combine XLS a JSON en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar XLS con JSON en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar XLS a JSON. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en el archivo JSON. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que combina XLS con JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar XLS a JSON en Java" InputFormat="xls" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLS a JSON via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLS con JSON mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar XLS a JSON" %}}
