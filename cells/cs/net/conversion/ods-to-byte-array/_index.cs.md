---
title:  Převést ODS na Byte Array přes C#
weight: 7690
description: C# Ukázkový kód pro konverzi ODS na Byte Array. Tento kód použijte pro převod Excel ODS na Byte Array v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte ODS na bajtové pole přes C#" h2="Nativní a vysoce výkonné Microsoft Excel ODS na konverzi bajtového pole nebo naopak pro zpracování dat tabulkových procesorů pomocí .NET API na straně serveru." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Byte Array je užitečné pro zpracování nebo ukládání dat. Můžete převést soubor ODS na Byte Array, stejně jako a**Byte Array na ODS** dokument pomocí jazyka C#. Abychom převedli ODS na bajtové pole, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Jak převést ODS na Byte Array přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Pro vývojáře je snadné načíst a převést soubory ODS na bajtové pole pro další manipulační úkoly v několika řádcích kódu.

{{% /blocks/products/pf/agp/text %}}

1.  Zahrňte jmenný prostor do souboru třídy
1.  Načíst vstup ODS Soubor pomocí sešitu
