...
В следующем примере показано, как объединить ЧИСЛА с PNG в Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Нужно программно объединить NUMBERS с PNG? Базовый документ, объединяющийся и конкатенированный с[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) API можно создать с помощью всего нескольких строк кода.
