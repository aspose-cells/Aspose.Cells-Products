...
description: Aspose Excel'de. Aspose.Cells ile NUMBERS'ı hızlı ve kolay bir şekilde OTS'ye dönüştürün. Python NUMBERS'i OTS'ye dönüştürün. Python NUMARALARI OTS'ye kaydedin. NUMBERS'ı Python'i kullanarak OTS olarak kaydedin.
...
{{< blocks/products/pf/i18n/upper-banner h1="Python\'de NUMBERS\'ı OTS\'ye dönüştürün" h2="NUMBERS\'ı OTS\'ye dönüştürmek için yüksek hızlı Python kitaplığı. Bu, Python\'i kullanarak NUMBERS, OTS ve diğer birçok formatı içe ve dışa aktarmak için kullanılan profesyonel bir yazılım çözümüdür." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python\'i kullanarak NUMBERS\'ı OTS\'ye dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="NUMBERS\'ı Python\'deki OTS\'ye kaydedin" %}}

Aşağıdaki örnekte Python'de NUMBERS'ın OTS'ye nasıl dönüştürüleceği gösterilmektedir.
...
{{% blocks/products/pf/agp/content h2="NUMBERS\'ı OTS\'ye dönüştürmek için Python kütüphane" %}}
