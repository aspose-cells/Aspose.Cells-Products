---
title: Voeg TXT samen met XLSB - Combineer TXT met XLSB in Java
url: /nl/java/merger/merge-txt-to-xlsb/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online Samenvoegen TXT naar XLSB saveformat. Java Combineer het formaat TXT tot XLSB. Samenvoegen TXT tot XLSB in Java. TXT Samenvoegen.
...
Het volgende voorbeeld laat zien hoe u TXT samenvoegt met XLSB in Aspose.Cells for Java.
...
{{% cells-merger title="Gratis online om TXT samen te voegen tot XLSB in Java" InputFormat="txt" InputFormat2="xlsb" outformat="xlsb" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Hoe TXT samen te voegen tot XLSB via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u TXT programmatisch samenvoegen tot XLSB? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
