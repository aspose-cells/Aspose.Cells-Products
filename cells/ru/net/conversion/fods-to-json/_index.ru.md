...
{{% blocks/products/pf/agp/content h2="Преобразовать FODS в JSON, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в JSON в C#" %}}
...
1.  Преобразуйте значение FODS в JSON, вызвав метод Workbook.Save.
