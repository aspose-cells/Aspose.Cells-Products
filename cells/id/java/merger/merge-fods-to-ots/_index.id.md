...
description: Aspose Unggul. Java Aspose.Cells. Gabung Online Gratis FODS ke format simpan OTS. Java Gabungkan FODS ke format OTS. Gabung FODS menjadi OTS di Java. FODS Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan FODS menjadi OTS di Java Online Gratis" %}}
...
{{% cells-merger title="Online Gratis Menggabungkan FODS menjadi OTS di Java" InputFormat="fods" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan FODS ke OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Perlu menggabungkan FODS ke OTS secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Java untuk menggabungkan FODS ke OTS" %}}
