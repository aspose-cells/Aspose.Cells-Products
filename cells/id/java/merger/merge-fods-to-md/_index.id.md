---
title: Gabungkan FODS ke MD - Gabungkan FODS ke MD di Java
url: /id/java/merger/merge-fods-to-md/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan FODS ke format simpan MD. Java Gabungkan FODS ke format MD. Gabung FODS menjadi MD di Java. FODS Gabung.
...
{{% blocks/products/pf/agp/content h2="Gabungkan FODS menjadi MD di Java" %}}

Contoh berikut menunjukkan cara menggabungkan FODS ke MD di Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah menggabungkan FODS ke MD. Unggah file Anda, panggil metode Workbook.Combine untuk menggabungkan file, lalu simpan ke file MD. Jika Anda mengembangkan kode di Java, ini akan lebih sederhana daripada kedengarannya. Lihat contoh Java yang menggabungkan FODS ke MD.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan FODS ke MD secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
