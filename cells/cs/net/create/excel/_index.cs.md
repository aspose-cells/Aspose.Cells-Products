---
title: Vytvořit EXCEL - Vytvořte soubor EXCEL v C#
description: Aspose Excel. Snadno generujte a manipulujte se soubory EXCEL s knihovnou Aspose.Cells for .NET. Tato výkonná knihovna API poskytuje efektivní a zjednodušené řešení pro vytváření, úpravu a správu souborů EXCEL přímo ve vašich aplikacích C# a splňuje specifické potřeby vývojářů s vysokou přesností.
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit EXCEL v souboru C#" %}}
...
1.  Pomocí metody Uložit uložte sešit jako soubor EXCEL.

{{% blocks/products/pf/agp/code-block title="Ukázkový kód ukazuje, jak vytvořit soubor EXCEL v adresáři C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna C# pro vytvoření souboru EXCEL" %}}
