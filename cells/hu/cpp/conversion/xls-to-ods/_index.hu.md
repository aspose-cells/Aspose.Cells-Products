---
title: Konvertálja az XLS-t ODS-vé a C++ alkalmazással 
weight: 1160
url: /hu/cpp/conversion/xls-to-ods/ 
description: Minta C++ konverziós kód az XLS dokumentumhoz ODS formátumba. A programozók ezt a forráskódot használhatják az XLS-ből ODS-be történő kötegelt konvertáláshoz bármely C++-alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS konvertálása ODS-re a következőn keresztül: C++" h2="Nagy teljesítményű XLS konvertálás ODS-be a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Az XLS konvertálása ODS-vé a következővel: C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLS-ből ODS-vé konvertálás lépései a következőn keresztül: C++" %}}

{{% blocks/products/pf/agp/text %}}

 A C++ fejlesztői egyszerűen konvertálhatnak XLS-fájlt ODS-vé, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLS fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (ODS) fájlkiterjesztéssel.1. Az ODS fájl a megadott elérési útra kerül mentésre.1. Nyissa meg az ODS fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="XLS-ből ODS-be C++ konverziós forráskód" offSpacer="" %}}
