...
ต้องการแปลงไฟล์ TXT เป็น EXCEL โดยใช้โปรแกรมใช่หรือไม่? นักพัฒนา C++ สามารถแปลง TXT เป็น EXCEL ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลงรหัส TXT เป็นรูปแบบ EXCEL โดยเรียกใช้เมธอด Save()
