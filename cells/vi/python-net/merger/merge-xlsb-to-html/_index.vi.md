---
title:  Ghép XLSB thành HTML qua Python
...
Ví dụ sau minh họa cách hợp nhất XLSB thành HTML trong Python.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất XLSB thành HTML. Tải tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất tệp rồi lưu vào tệp HTML. Nếu bạn phát triển mã trong Python, điều này sẽ đơn giản hơn bạn tưởng. Xem ví dụ Python hợp nhất XLSB thành HTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ứng dụng miễn phí để hợp nhất XLSB thành HTML trực tuyến" InputFormat="xlsb" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonnet" %}}
