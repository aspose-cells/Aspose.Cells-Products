---
title:  Jak narysować lub wstawić zakrzywiony kształt strzałki do programu Excel via Java
weight: 30
description: Narysuj lub wstaw zakrzywiony kształt strzałki za pomocą Aspose.Cells' Java API bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw kształt zakrzywionej strzałki do programu Excel via Java" h2="Wstaw zakrzywiony kształt strzałki za pomocą Aspose.Cells\' API bez oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Jak wstawić zakrzywiony kształt strzałki do pliku Excel za pomocą Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić zakrzywiony kształt strzałki do pliku programu Excel via Java" %}}
...
+ Wybierz arkusz roboczy za pomocą jego indeksu.
 + Użyj[dodaj metodę](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) , aby wstawić kształt zakrzywionej strzałki w wybranym arkuszu
...
{{% blocks/products/pf/agp/code-block title="Wstaw kształt zakrzywionej strzałki - Java" offSpacer="" %}}
