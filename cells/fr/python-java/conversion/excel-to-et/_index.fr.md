---
title: Python EXCEL vers ET - Convertisseur EXCEL vers ET en ligne
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Gratuit en ligne Python Convertir EXCEL en format de sauvegarde ET. Python Format EXCEL vers ET. Enregistrez EXCEL sous ET Python.
...
{{% cells-convert title="Application gratuite et exemple de code pour convertir EXCEL en ET en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="et" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir EXCEL en ET via Python" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers EXCEL en ET par programme ? Les développeurs Python peuvent facilement charger et convertir EXCEL en ET en quelques lignes de code.
...
1.  Obtenez le résultat de la conversion d'EXCEL en ET.
