---
title: Sloučit XLTX až PDF - Sloučit XLTX až PDF v C++
url: /cs/cpp/merger/merge-xltx-to-pdf/ 
description: Aspose Excel. C++ Aspose.Cells. Online sloučení zdarma XLTX do formátu uložení PDF. C++ Kombinujte formát XLTX až PDF. Sloučit XLTX až PDF v C++. XLTX Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTX až PDF v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit XLTX až PDF v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XLTX do PDF. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru PDF. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí XLTX do PDF.
...
{{% blocks/products/pf/agp/content h2="Jak sloučit XLTX na PDF přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLTX až PDF? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ ke sloučení XLTX až PDF" %}}
