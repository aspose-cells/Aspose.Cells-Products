---
title: 檢視或編輯 XLSB 檔案元資料 via .NET
weight: 7890
description: C# 原始碼，用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上編輯或檢視 XLSB 格式元資料。
