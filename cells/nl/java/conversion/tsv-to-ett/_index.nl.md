...
Het volgende voorbeeld laat zien hoe je TSV omzet naar ETT in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TSV om naar ETT via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u TSV-bestanden programmatisch naar ETT converteren? Ontwikkelaars van Java kunnen TSV-bestanden eenvoudig in een paar regels code naar ETT converteren.
