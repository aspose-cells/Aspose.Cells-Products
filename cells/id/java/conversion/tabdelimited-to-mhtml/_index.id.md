---
title: Konversi TABDELIMITED ke MHTML melalui Java 
url: /id/java/conversion/tabdelimited-to-mhtml/ 
description: Contoh Java kode konversi untuk format TABDELIMITED ke file MHTML. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke MHTML dalam Aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi TABDELIMITED ke MHTML melalui Java" h2="TABDELIMITED ke MHTML Java konversi untuk mengonversi satu atau beberapa halaman ke MHTML menggunakan perpustakaan Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi TABDELIMITED ke MHTML Menggunakan Java" %}}

 Untuk merender TABDELIMITED ke MHTML, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengkonversi TABDELIMITED ke MHTML melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file TABDELIMITED ke MHTML hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file TABDELIMITED dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi MHTML & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file MHTML yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED ke MHTML Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file TABDELIMITED dalam contoh Workbook
Workbook book = new Workbook("template.tabdelimited");
// simpan TABDELIMITED sebagai MHTML
