...
Нужно программно преобразовать файлы XLAM в SQL? Разработчики, работающие с файлами C++, могут легко преобразовать файлы XLAM в SQL всего несколькими строками кода.
...
1.  Преобразуйте XLAM в SQL, вызвав метод Save().
