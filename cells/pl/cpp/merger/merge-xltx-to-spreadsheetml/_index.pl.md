---
title: Scal XLTX do SPREADSHEETML - Połącz XLTX do SPREADSHEETML w C++
url: /pl/cpp/merger/merge-xltx-to-spreadsheetml/ 
description: Aspose Excel. C++ Aspose.Cells. Bezpłatne scalanie online numeru XLTX do formatu zapisu SPREADSHEETML. C++ Połącz XLTX do formatu SPREADSHEETML. Scal XLTX do SPREADSHEETML w C++. XLTX Scal.
...
{{% blocks/products/pf/agp/content h2="Scal XLTX w SPREADSHEETML w C++ Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć XLTX z SPREADSHEETML w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć XLTX z SPREADSHEETML. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do scalania plików, a następnie zapisz ją w pliku SPREADSHEETML. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy XLTX z SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online XLTX z SPREADSHEETML w C++" InputFormat="xltx" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLTX z SPREADSHEETML przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić numer XLTX ze SPREADSHEETML? Podstawowy dokument łączący i łączący z[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia XLTX z SPREADSHEETML" %}}
