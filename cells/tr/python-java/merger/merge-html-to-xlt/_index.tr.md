---
title:  HTML'i Python aracılığıyla XLT ile birleştirin
...
Aşağıdaki örnek, HTML'in Python'de XLT ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="HTML\'i hatta XLT ile birleştirmek için Ücretsiz Uygulama" InputFormat="html" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
