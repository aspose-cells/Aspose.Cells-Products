---
title: A XLSB-PDF-es számok egyesítése – a XLSB-es és a PDF-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-xlsb-to-pdf/ 
description: Aspose Excel. C# Aspose.Cells. A XLSB és a PDF mentési formátum egyesítése. C# A XLSB és a PDF formátum kombinálása. Egyesítse a XLSB-PDF-et a C#-ben. XLSB Egyesítse.
...
{{% blocks/products/pf/agp/content h2="A XLSB és a PDF egyesítése a C#-ben" %}}

A következő példa bemutatja a XLSB és a PDF egyesítését a Aspose.Cells for .NET számban.
...
{{% cells-merger title="Mintakód a XLSB és PDF közötti egyesítéshez a C#-ben" InputFormat="xlsb" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A XLSB és a PDF egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a XLSB-et a PDF-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
