---
title: C# XLS till XLT - XLS till XLT Omvandlare
description: Aspose Excel. Konvertera XLS till XLT snabbt och enkelt med Aspose.Cells. C# XLS till XLT. C# Spara XLS till 07611 till 07161. 07611 till 07161. 3481 med C#.
...
{{% blocks/products/pf/agp/content h2="Spara XLS till XLT i C#" %}}

Följande exempel visar hur man konverterar XLS till XLT i C#.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att konvertera XLS till XLT. Ladda upp din XLS-fil och spara den sedan som XLT-fil. För både XLS läsning och XLT skrivning kan du använda fullt kvalificerade filnamn. Utdata XLT innehåll och formatering kommer att vara identisk med originaldokumentet XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exempelkod för att konvertera XLS till XLT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xlt" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till XLT via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till XLT programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till XLT på bara några rader kod.
...
1.  Konvertera XLS till XLT genom att anropa Workbook.Save-metoden.
1.  Få konverteringsresultatet från XLS till XLT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# bibliotek för att konvertera XLS till XLT" %}}
