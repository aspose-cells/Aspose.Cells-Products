---
title: 创建XPS - 在C++中创建XPS文件
description: Aspose Excel。 C++ 使用 Aspose.Cells 快速轻松地创建 XPS 文件。使用 C++ 生成 XPS 文件。在 C++ 中创建 XPS。C++ XPS 创建者。
...
{{< blocks/products/pf/i18n/upper-banner h1="在C++中创建XPS文件" h2="使用 C++ 库以编程方式创建本机高性能 XPS 文件，无需 Microsoft Office。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何在C++中创建XPS" %}}

{{% blocks/products/pf/agp/text %}}

开发人员只需几行代码即可轻松在运行的报告应用程序中创建、加载、修改和转换 XPS 文件以进行数据处理。
...
1. 使用 Save() 方法将工作簿保存为 .xps 文件。

{{% blocks/products/pf/agp/code-block title="示例代码展示了如何在 C++ 中创建 XPS 文件。" offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++库创建XPS文件" %}}
