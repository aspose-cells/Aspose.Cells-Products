---
title: Fusionner XLS en MD - Combiner XLS en MD en C#
url: /fr/net/merger/merge-xls-to-md/ 
description: Aspose Excel. C# Aspose.Cells. Fusion gratuite en ligne XLS au format de sauvegarde MD. C# Combinez XLS au format MD. Fusionner XLS avec MD dans C#. XLS Fusionner.
...
{{% blocks/products/pf/agp/content h2="Fusionner XLS à MD dans C# en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner XLS à MD dans Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner XLS en MD. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier MD. Si vous développez du code en C#, ce sera plus simple qu'il n'y paraît. Voir l'exemple C# qui fusionne XLS en MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner XLS à MD en C#" InputFormat="xls" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XLS à MD via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XLS vers MD par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner XLS à MD" %}}
