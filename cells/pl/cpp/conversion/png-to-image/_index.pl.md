...
description: Aspose Excel. Szybko i łatwo przekonwertuj PNG na IMAGE za pomocą Aspose.Cells. C++ PNG na IMAGE. C++ Zapisz PNG w OBRAZIE. Zapisz PNG jako OBRAZ, używając C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj PNG na OBRAZ w C++" h2="Wysokowydajna konwersja PNG na OBRAZ przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Konwertuj PNG na OBRAZ za pomocą C++" %}}
...
Poniższy przykład pokazuje, jak przekonwertować PNG na IMAGE w C++.
...
Chcesz programowo przekonwertować pliki PNG na IMAGE? Programiści C++ mogą z łatwością przekonwertować PNG na IMAGE w zaledwie kilku linijkach kodu.
