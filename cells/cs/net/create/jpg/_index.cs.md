...
description: Aspose Excel. Snadno generujte a manipulujte se soubory JPG pomocí knihovny Aspose.Cells for .NET. Tato výkonná knihovna API poskytuje efektivní a zjednodušené řešení pro vytváření, úpravu a správu souborů JPG přímo ve vašich aplikacích C# a splňuje specifické potřeby vývojářů s vysokou přesností.
...
1.  Pomocí metody Uložit uložte sešit jako soubor JPG.

{{% blocks/products/pf/agp/code-block title="Ukázkový kód ukazuje, jak vytvořit soubor JPG v adresáři C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Knihovna C# pro vytvoření souboru JPG" %}}
