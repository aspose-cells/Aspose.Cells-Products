...
url: /pt/python-net/merger/merge-sxc-to-xls/ 
description: Aspose Excel. Python Excel. Mesclar SXC com XLS salvar formato. Python Combine o formato SXC com XLS. Mesclar SXC com XLS na Biblioteca Excel Python. SXC Mesclar.
...
{{% cells-merger title="Exemplo de código para mesclar SXC a XLS na biblioteca Python do Excel" InputFormat="sxc" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SXC a XLS por meio da biblioteca Python Excel" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar SXC com XLS programaticamente? Um documento básico mesclado e concatenado com[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) APIs podem ser feitas com apenas algumas linhas de código.
