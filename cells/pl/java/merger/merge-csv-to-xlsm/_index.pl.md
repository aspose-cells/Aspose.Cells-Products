---
title: Połącz CSV z XLSM - Połącz CSV z XLSM w Java
url: /pl/java/merger/merge-csv-to-xlsm/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online CSV do XLSM w formacie zapisu. Java Połącz format CSV z XLSM. Połącz CSV z XLSM w Java. CSV Połącz.
...
{{% blocks/products/pf/agp/content h2="Połącz CSV z XLSM w Java Online za darmo" %}}

Poniższy przykład pokazuje, jak połączyć CSV z XLSM w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć CSV z XLSM. Prześlij swoje pliki, wywołaj metodę Workbook.Combine, aby scalić pliki, a następnie zapisz ją w pliku XLSM. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy numery CSV z XLSM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatne połączenie online CSV z XLSM w Java" InputFormat="csv" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć CSV z XLSM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić CSV z XLSM programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do połączenia CSV z XLSM" %}}
