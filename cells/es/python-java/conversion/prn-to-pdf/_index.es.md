---
title: Python PRN a PDF - Convertidor PRN a PDF
description: Aspose Excel. Esta solución integral proporciona a los desarrolladores de Python un enfoque totalmente integrado para convertir PRN al formato PDF, lo que permite guardar sin problemas los datos PRN en formato PDF mediante la biblioteca Aspose.Cells, todo mediante código Python eficiente y personalizable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convierta PRN a PDF en la biblioteca de Excel Python" h2="Biblioteca Excel Python de alta velocidad para convertir PRN a PDF. Esta es una solución de software profesional para importar y exportar PRN, PDF y muchos otros formatos utilizando Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Convierta PRN a PDF usando la biblioteca de Excel Python" %}}

 ¿Cómo convierto PRN a PDF? Con la biblioteca Aspose.Cells for Python, puede convertir fácilmente PRN a PDF mediante programación con unas pocas líneas de código.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)es capaz de crear aplicaciones multiplataforma con la capacidad de generar, modificar, convertir, renderizar e imprimir todos los archivos de Excel. Python Excel API no solo convierte entre formatos de hojas de cálculo, sino que también puede representar archivos de Excel como imágenes, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT y más, lo que lo convierte en una opción perfecta para intercambiar documentos en formatos estándar de la industria.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Guarde PRN en PDF en la biblioteca de Excel Python" %}}

El siguiente ejemplo demuestra cómo convertir PRN a PDF en la biblioteca de Excel Python.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para convertir PRN a PDF. Cargue su archivo PRN y luego simplemente guárdelo como archivo PDF. Tanto para la lectura de PRN como para la escritura de PDF, puede utilizar nombres de archivo completos. El contenido y el formato de salida PDF serán idénticos al documento PRN original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de muestra para convertir PRN a PDF a través de la biblioteca de Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="prn" outformat="pdf" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir PRN a PDF a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos PRN a PDF mediante programación? Los desarrolladores de Python pueden cargar y convertir fácilmente PRN a PDF en tan solo unas pocas líneas de código.
...
1.  Convierta PRN a PDF llamando al método Workbook.save.
1.  Obtenga el resultado de la conversión de PRN a PDF.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Biblioteca de Excel para convertir PRN a PDF" %}}
