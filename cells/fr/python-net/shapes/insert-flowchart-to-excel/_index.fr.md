...
{{% blocks/products/pf/agp/content h2="Comment insérer/créer un organigramme dans un fichier Excel à l\'aide de Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour insérer/créer un fichier FlowChart vers Excel en utilisant Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="Insérer/créer un organigramme - Python via .Net" offSpacer="" %}}
