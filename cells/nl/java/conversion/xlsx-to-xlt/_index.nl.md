...
{{% blocks/products/pf/agp/content h2="Sla XLSX op in XLT in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSX omzet naar XLT in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSX om naar XLT of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSX programmatisch converteren naar XLT? Ontwikkelaars van Java kunnen bestanden met de extensie XLSX eenvoudig converteren naar XLT met slechts een paar regels code.
