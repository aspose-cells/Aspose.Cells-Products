---
title: "TSV konvertálása FODS-re a következőn keresztül: Python"
url: /hu/python-java/conversion/tsv-to-fods/
description: Mintakód a tsv to fods Python konverziójához. Használjon API példakódot a tsv fájlok kötegelt konvertálásához a Python alkalmazáson belül.
---
...
{{% blocks/products/pf/agp/content h2="A TSV konvertálása FODS-re a következővel: Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a TSV FODS-vé konvertálásához a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a TSV-fájlokat FODS-formátumba.
