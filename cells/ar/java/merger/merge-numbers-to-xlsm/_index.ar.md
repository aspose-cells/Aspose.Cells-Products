---
title:  دمج الأرقام في XLSM via Java
...
يوضح المثال التالي كيفية دمج الأرقام مع XLSM في Java.
...
{{% cells-merger title="تطبيق مجاني لدمج الأرقام في XLSM على الإنترنت" InputFormat="numbers" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
