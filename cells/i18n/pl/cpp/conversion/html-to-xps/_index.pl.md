---
title: Konwertuj HTML na XPS za pomocą aplikacji C++ 
weight: 1420
url: /pl/cpp/conversion/html-to-xps/ 
description: Przykładowy kod konwersji C++ dla dokumentu HTML do formatu XPS. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji HTML do XPS w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj HTML na XPS za pomocą C++" h2="Wysokowydajna konwersja HTML do XPS przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować HTML na XPS za pomocą C++" %}}

 Aby przekonwertować HTML na XPS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować HTML na XPS za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik HTML na XPS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik HTML przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XPS).1. Plik XPS zostanie zapisany pod określoną ścieżką.1. Otwórz plik XPS w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="HTML do XPS C++ Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo konwersji HTML do XPS" sectionDescription="[Konwertuj HTML na XPS](https://products.aspose.app/cells/conversion/html-to-xps) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik HTML, zostanie on natychmiast przekonwertowany do XPS." >}}
