---
title: Python XLSX sang MD - XLSX sang MD Bộ chuyển đổi
description: Aspose Excel. Chuyển đổi XLSX sang MD nhanh chóng và dễ dàng với Aspose.Cells. Python XLSX sang MD. Python Lưu XLSX vào MD. Lưu XLSX dưới dạng MD bằng Python.
...
{{% blocks/products/pf/agp/content h2="Chuyển đổi XLSX sang MD trong Python" %}}

 Làm cách nào để chuyển đổi XLSX sang MD? Với Aspose.Cells for Python qua thư viện NET, bạn có thể dễ dàng chuyển đổi XLSX sang MD theo chương trình chỉ với một vài dòng mã.[Aspose.Cells for Python qua NET](https://pypi.org/project/aspose-cells-python/)có khả năng xây dựng các ứng dụng đa nền tảng với khả năng tạo, sửa đổi, chuyển đổi, hiển thị và in tất cả các tệp Excel. Python Excel API không chỉ chuyển đổi giữa các định dạng bảng tính mà còn có thể hiển thị các tệp Excel dưới dạng hình ảnh, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT và hơn thế nữa, do đó biến nó thành một lựa chọn hoàn hảo để trao đổi tài liệu ở các định dạng tiêu chuẩn ngành.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Lưu XLSX vào MD trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLSX thành MD trong Python via NET.
{{% blocks/products/pf/agp/text %}}

Thực hiện theo các bước đơn giản để chuyển đổi XLSX sang MD. Tải lên tệp XLSX của bạn, sau đó chỉ cần lưu nó dưới dạng tệp MD. Đối với cả việc đọc và ghi MD XLSX, bạn có thể sử dụng tên tệp đủ điều kiện. Nội dung và định dạng MD đầu ra sẽ giống hệt với tài liệu XLSX gốc.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Mã mẫu để chuyển đổi XLSX sang MD" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="md" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi XLSX sang MD" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tập tin XLSX sang MD theo chương trình? Các nhà phát triển Python có thể dễ dàng tải và chuyển đổi XLSX sang MD chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi XLSX thành MD bằng cách gọi phương thức Workbook.save.
1.  Nhận kết quả chuyển đổi XLSX sang MD.

{{% /blocks/products/pf/agp/content %}}


{{% blocks/products/pf/agp/content h2="Thư viện Python để chuyển đổi XLSX sang MD" %}}
