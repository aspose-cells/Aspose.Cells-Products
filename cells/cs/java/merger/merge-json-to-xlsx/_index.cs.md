---
title:  Sloučit JSON až XLSX via Java
...
Následující příklad ukazuje, jak sloučit JSON až XLSX v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení JSON až XLSX online" InputFormat="json" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
