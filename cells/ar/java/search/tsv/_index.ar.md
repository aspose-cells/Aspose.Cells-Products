---
title:  ابحث عن مستند TSV بدون فتح via Java
weight: 4940
description: نموذج التعليمات البرمجية Java للبحث عن الكلمات ذات النمط في ملف TSV على Java بيئة التشغيل لتطبيقات JSP/JSF وتطبيقات سطح المكتب.
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات البحث عن الملفات TSV في Java" %}}
...
+ تحميل ملف TSV عن طريق إنشاء كائن مصنف.
+ الوصول إلى ورقة العمل الأولى في الملف TSV.
...
{{% blocks/products/pf/agp/code-block title="بحث TSV ملفات - Java" offSpacer="" %}}
