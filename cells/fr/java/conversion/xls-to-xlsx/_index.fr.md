---
title: Java XLS à XLSX - Convertisseur en ligne XLS à XLSX
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir XLS en format de sauvegarde XLSX. Format Java XLS à XLSX. Enregistrez XLS à XLSX Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLS à XLSX dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLS en XLSX en Java.
...
Besoin de convertir les fichiers XLS en XLSX par programmation ? Les développeurs de Java peuvent facilement convertir XLS en XLSX en seulement quelques lignes de code.
