...
description: Aspose Unggul. Ubah SXC menjadi OTS dengan cepat dan mudah dengan Aspose.Cells. Python SXC menjadi OTS. Python Simpan SXC ke OTS. Simpan SXC sebagai OTS menggunakan Python.
...
{{% blocks/products/pf/agp/content h2="Ubah SXC menjadi OTS Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/content h2="Simpan SXC ke OTS di Python" %}}

Contoh berikut menunjukkan cara mengonversi SXC ke OTS di Python.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengkonversi SXC ke OTS" %}}
