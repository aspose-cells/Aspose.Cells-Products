...
description: Aspose Excel. Java Aspose.Cells. Sloučit TXT do FODS uložit formát. Java Kombinujte formát TXT až FODS. Sloučit TXT až FODS v Java. TXT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit TXT až FODS v Java" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení TXT až FODS v Java" InputFormat="txt" InputFormat2="fods" outformat="fods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
