---
title: 合併影像到 PRN - 將影像合併到 C# 中的 PRN
url: /zh-hant/net/merger/merge-image-to-prn/ 
description: Aspose Excel。 C# Aspose.Cells. 將 IMAGE 合併為 PRN 儲存格式。 C# 將IMAGE合併為PRN格式。將 IMAGE 合併到 C# 中的 PRN。IMAGE 合併。
...
{{% blocks/products/pf/agp/content h2="將 IMAGE 合併到 C# 中的 PRN" %}}

以下範例示範如何將 IMAGE 合併到 Aspose.Cells for .NET 中的 PRN。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 IMAGE 合併到 PRN。上傳文件，呼叫Workbook.Combine方法合併文件，然後儲存到PRN文件。如果您在 C# 中開發程式碼，這會比聽起來更簡單。請參閱 C# 將 IMAGE 合併到 PRN 的範例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="將 IMAGE 合併到 PRN 的範例程式碼（C#）" InputFormat="png" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 IMAGE 合併到 PRN" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式設計方式將 IMAGE 合併到 PRN？基本文檔合併和連接[Aspose.Cells for .NET](https://products.aspose.com/cells/net)只需幾行程式碼即可完成 API。
...
{{% blocks/products/pf/agp/content h2=".NET 將 IMAGE 合併到 PRN 的函式庫" %}}
