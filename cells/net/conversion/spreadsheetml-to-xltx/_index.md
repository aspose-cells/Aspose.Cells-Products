...
url: /net/conversion/spreadsheetml-to-xltx/
description: Sample code for spreadsheetml to xltx C# conversion. Use API example code for batch spreadsheetml files to xltx conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert SPREADSHEETML to XLTX via C#" h2="Export Excel® spreadsheets to XLTX format on .NET Framework, .NET Core, Mono or Xamarin Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert SPREADSHEETML files to XLTX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows spreadsheetml to xltx C# Conversion" offSpacer="" %}}

{{< gist "aspose-cells-gists" "88c9872508ec3150c552eb5155edf06e" "Convert-xml-to-xltx.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert SPREADSHEETML to XLTX" sectionDescription="Check our live demos for [SPREADSHEETML to XLTX conversion](https://products.aspose.app/cells/conversion/spreadsheetml-to-xltx) with following benefits." >}}
