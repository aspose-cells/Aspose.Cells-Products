...
url: /cs/python-net/merger/merge-xlsb-to-excel/ 
...
Následující příklad ukazuje, jak sloučit XLSB do EXCELu v Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete sloučit XLSB do EXCELu programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
