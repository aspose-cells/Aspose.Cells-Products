---
title: 解锁XLS文档via .NET
weight: 4260
description: 用于解锁 .NET Framework、.NET Core、Mono 或 Xamarin 平台上受密码保护的 XLS 文件的 C# 源代码。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 解锁 XLS 电子表格" h2="使用 .NET 库删除 XLS 的保护。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
