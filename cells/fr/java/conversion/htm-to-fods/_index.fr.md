---
title: Java HTM à FODS - Convertisseur HTM à FODS
description: Aspose Excel. Cette solution complète offre aux développeurs Java une approche entièrement intégrée pour convertir le format HTM au format FODS, permettant un enregistrement transparent des données HTM au format FODS à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code Java efficace et personnalisable.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM à FODS dans Java" %}}

L'exemple suivant montre comment convertir HTM en FODS en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir HTM en FODS. Téléchargez votre fichier HTM, puis enregistrez-le simplement sous le nom de fichier FODS. Pour la lecture HTM et l'écriture FODS, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la sortie FODS seront identiques au document HTM original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir du HTM en FODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="htm" outformat="fods" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir du HTM en FODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers HTM au format FODS par programmation ? Les développeurs spécialisés en Java peuvent facilement convertir des fichiers HTM au format FODS en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir HTM en FODS" %}}
{{% blocks/products/pf/agp/text %}}
