---
title:  Tạo Báo cáo trong Tệp ODS via .NET
weight: 520
description: C# để tạo báo cáo định dạng ODS trên .NET Framework, .NET Core, Mono hoặc Nền tảng Xamarin.
---
...
{{% blocks/products/pf/agp/content h2="Cách tạo Báo cáo dựa trên ODS bằng C#" %}}
