...
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji MHTML do formatu SPREADSHEETML, umożliwiając bezproblemowe zapisywanie danych MHTML w formacie SPREADSHEETML za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj MHTML na SPREADSHEETML w C++" h2="Wysokowydajna konwersja formatu MHTML do arkusza kalkulacyjnego przy użyciu biblioteki C++ bez konieczności instalacji programów Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
Poniższy przykład pokazuje, jak przekonwertować liczbę MHTML na format SPREADSHEETML w formacie C++.
...
Trzeba programowo przekonwertować pliki MHTML do formatu SPREADSHEETML? Programiści C++ mogą łatwo przekonwertować pliki MHTML do formatu SPREADSHEETML za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj MHTML do formatu SPREADSHEETML, wywołując metodę Save().
