---
title:  Dokument XLS suchen, ohne es über C++ zu öffnen
weight: 4560
description: C++ Beispielcode zum Suchen von Wörtern mit einem Muster in der Datei XLS auf der Laufzeitumgebung C++ für Windows 32 Bit, Windows 64 Bit und Linux 64 Bit.
...
{{% blocks/products/pf/agp/content h2="So suchen Sie die Datei XLS mithilfe der Nummer C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Suchen von Dateien mit der Kennung XLS in C++" %}}
...
+ Datei XLS mithilfe der Workbook-Klasse laden.
...
{{% blocks/products/pf/agp/code-block title="Suche nach Dateien mit der Nummer XLS - C++" offSpacer="" %}}
