---
title: Konwertuj SPREADSHEETML na XLSB przez Java 
url: /pl/java/conversion/spreadsheetml-to-xlsb/ 
description: Przykładowy kod konwersji Java dla formatu SPREADSHEETML do pliku XLSB. Programiści mogą użyć tego przykładowego kodu do eksportowania arkuszy kalkulacyjnych Excel i OpenOffice do XLSB w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj SPREADSHEETML na XLSB przez Java" h2="Konwersja SPREADSHEETML do XLSB Java w celu konwersji jednej lub wielu stron do formatu XLSB przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować SPREADSHEETML na XLSB za pomocą Java" %}}

 Aby renderować SPREADSHEETML do XLSB, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować SPREADSHEETML na XLSB za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik SPREADSHEETML na XLSB w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik SPREADSHEETML z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem XLSB i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku XLSB
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML do XLSB Java Kod źródłowy konwersji" offSpacer="" %}}

```cs
// załaduj plik SPREADSHEETML w instancji Workbook
Workbook book = new Workbook("template.spreadsheetml");
// zapisz arkusz kalkulacyjny jako XLSB
