...
description: Aspose excel. Java Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme ODS ile PPTX kaydetme biçimi. Java ODS ile PPTX formatını birleştirin. Java içinde ODS'i PPTX ile birleştir. ODS Birleştir.
...
Aşağıdaki örnek, ODS'in Aspose.Cells for Java'de PPTX ile nasıl birleştirileceğini gösterir.
