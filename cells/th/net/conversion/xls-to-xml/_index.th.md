---
title: C# XLS เป็น XML - XLS เป็น XML Converter
description: Aspose เอ็กเซล. แปลง XLS เป็น XML อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C# XLS เป็น XML C# บันทึก XLS ลงใน XML บันทึก XLS เป็น XML โดยใช้ C#
...
{{% blocks/products/pf/agp/content h2="บันทึก XLS ลงใน XML ใน C#" %}}
...
{{% cells-convert title="โค้ดตัวอย่างในการแปลง XLS เป็น XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xml" IsLandingPage="true" %}}
