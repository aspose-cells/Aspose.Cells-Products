---
title: Converti SPREADSHEETML in HTML tramite Java 
url: /it/java/conversion/spreadsheetml-to-html/ 
description: Esempio di codice di conversione Java per il formato SPREADSHEETML in file HTML. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in HTML all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti SPREADSHEETML in HTML tramite Java" h2="Conversione da SPREADSHEETML a HTML Java per convertire pagine singole o multiple in HTML utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire SPREADSHEETML in HTML utilizzando Java" %}}

 Per eseguire il rendering di SPREADSHEETML in HTML, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire SPREADSHEETML in HTML tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente il file SPREADSHEETML in HTML in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file SPREADSHEETML con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con estensione HTML e SaveFormat come parametri1. Controllare il percorso specificato per il file HTML risultante
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML in HTML Java codice sorgente di conversione" offSpacer="" %}}

```cs
// caricare il file SPREADSHEETML in un'istanza di Workbook
Workbook book = new Workbook("template.spreadsheetml");
// salva SPREADSHEETML come HTML
