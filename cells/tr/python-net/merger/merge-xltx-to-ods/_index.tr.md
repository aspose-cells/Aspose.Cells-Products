...
url: /tr/python-net/merger/merge-xltx-to-ods/ 
...
Aşağıdaki örnek, XLTX'in Aspose.Cells for Python via .NET'de ODS ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 XLTX ile ODS'i programlı olarak birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
