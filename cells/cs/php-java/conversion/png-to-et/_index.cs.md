---
title: Převodník PHP PNG na ET – PNG na ET
description: Aspose Excel. Převeďte PNG na ET rychle a snadno pomocí Aspose.Cells. PHP PNG na ET. PHP Uložit PNG do ET. Uložte PNG jako ET pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést PNG na ET přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory PNG na ET programově? Vývojáři PHP mohou snadno načíst a převést PNG na ET v několika řádcích kódu.
...
1.  Převeďte PNG na ET voláním metody uložení sešitu.
1.  Získejte výsledek převodu PNG na ET.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod PNG na ET" %}}
