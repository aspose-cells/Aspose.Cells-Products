---
title: PHP MHT sang EXCEL - Công cụ chuyển đổi MHT sang EXCEL
description: Aspose Excel. Chuyển đổi MHT sang EXCEL nhanh chóng và dễ dàng với Aspose.Cells. PHP MHT sang EXCEL. PHP Lưu MHT vào EXCEL. Lưu MHT dưới dạng EXCEL bằng PHP.
...
Làm cách nào để chuyển đổi MHT sang EXCEL? Với thư viện Aspose.Cells for PHP via Java, bạn có thể dễ dàng chuyển đổi MHT sang EXCEL theo chương trình chỉ với một vài dòng mã.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) có khả năng xây dựng các ứng dụng đa nền tảng với khả năng tạo, sửa đổi, chuyển đổi, hiển thị và in tất cả các tệp Excel. PHP Excel API không chỉ chuyển đổi giữa các định dạng bảng tính mà còn có thể hiển thị các tệp Excel dưới dạng hình ảnh, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT và hơn thế nữa, do đó, nó trở thành một lựa chọn hoàn hảo để trao đổi tài liệu ở các định dạng tiêu chuẩn ngành.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Lưu MHT vào EXCEL trong PHP" %}}

Ví dụ sau đây trình bày cách chuyển đổi MHT sang EXCEL trong PHP.
...
{{% cells-convert title="Mã mẫu để chuyển đổi MHT sang EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xlsx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Cách chuyển đổi MHT sang EXCEL qua PHP" %}}

{{% blocks/products/pf/agp/text %}}

Cần chuyển đổi tệp MHT sang EXCEL theo chương trình? Các nhà phát triển PHP có thể dễ dàng tải và chuyển đổi MHT sang EXCEL chỉ bằng một vài dòng mã.
...
1.  Chuyển đổi MHT sang EXCEL bằng cách gọi phương thức lưu của Workbook.
