---
title: Połącz TSV z XLTX - Połącz TSV z XLTX w Java
url: /pl/java/merger/merge-tsv-to-xltx/ 
description: Aspose Excel. Java Aspose.Cells. Bezpłatne scalanie online TSV do XLTX w formacie zapisu. Java Połącz format TSV z XLTX. Połącz TSV z XLTX w Java. TSV Połącz.
...
Poniższy przykład pokazuje, jak połączyć TSV z XLTX w Aspose.Cells for Java.
...
{{% cells-merger title="Bezpłatne połączenie online TSV z XLTX w Java" InputFormat="tsv" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć TSV z XLTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz scalić TSV z XLTX programowo? Podstawowy dokument łączący i łączący z[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
