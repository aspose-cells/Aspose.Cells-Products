...
{{< blocks/products/pf/i18n/upper-banner h1="XLSM-fájlok titkosítása a következőn keresztül: C++" h2="Jelszóval védheti az Excel-táblázatokat, beleértve az XLSM formátumot is a .NET Library használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="XLSM-fájlok biztonságossá tétele a következővel: C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSM-fájlok védelmének lépései a következőn keresztül: C++" %}}
...
1. Töltse be az XLSM fájlt az IWorkbook osztály segítségével1. Használja a Protect(..) metódust a ProtectionType-val és a jelszóval1. Mentse el a védett XLSM fájlt a Save() metódussal
