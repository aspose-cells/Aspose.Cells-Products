...
The following example demonstrates how to merge XLSM to MHT in Aspose.Cells for C++.
...
Need to merge XLSM to MHT programmatically? A basic document merging and concatenating with [Aspose.Cells for C++](https://products.aspose.com/cells/cpp) APIs can be done with just few lines of code.
