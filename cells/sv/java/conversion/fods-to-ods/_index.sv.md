---
title: Konvertera FODS till ODS via Java 

description: Exempel Java-konverteringskod för FODS-format till ODS-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till ODS inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar FODS till ODS med Java" %}}

 För att göra FODS till ODS kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera FODS till ODS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera FODS-fil till ODS på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda FODS-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med ODS-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande ODS-filen
...
{{% blocks/products/pf/agp/code-block title="FODS till ODS Java omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Livedemonstrationer för konvertering av FODS till ODS" sectionDescription="[Konvertera FODS till ODS](https://products.aspose.app/cells/conversion/fods-to-ods) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din FODS-fil, den kommer omedelbart att konverteras till ODS." >}}
