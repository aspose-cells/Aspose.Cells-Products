...
{{% blocks/products/pf/agp/content h2="Jak převést CSV na PNG pomocí Java" %}}

 K vykreslení CSV do PNG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu CSV na PNG prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor CSV na PNG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor CSV s instancí sešitu1. Vyberte výchozí nebo libovolný pracovní list z kolekce1. Vytvořte a nastavte objekt ImageOrPrintOptions1. Vytvořte SheetRender s objekty Worksheet & ImageOrPrintOptions1. Chcete-li uložit výsledek ve formátu PNG, zavolejte metodu SheetRender.toImage
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze CSV na PNG Java" offSpacer="" %}}
