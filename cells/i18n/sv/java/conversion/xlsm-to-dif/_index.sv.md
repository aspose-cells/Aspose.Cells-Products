---
title: Konvertera XLSM till DIF via Java 
weight: 1940
url: /sv/java/conversion/xlsm-to-dif/ 
description: Exempel på Java-konverteringskod för XLSM-format till DIF-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till DIF inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera XLSM till DIF via Java" h2="XLSM till DIF Java-konvertering för att konvertera enstaka eller flera sidor till DIF med hjälp av lokalt Java-bibliotek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du XLSM till DIF med Java" %}}

 För att rendera XLSM till DIF kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera XLSM till DIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera XLSM-fil till DIF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda XLSM-fil med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med DIF-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande DIF-filen
...
{{% blocks/products/pf/agp/code-block title="XLSM till DIF Java omvandlingskällkod" offSpacer="" %}}
