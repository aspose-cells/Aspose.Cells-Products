---
title: Criar MHTML - Criar arquivo MHTML em C++
description: Aspose Excel. C++ Criar MHTML Arquivo. Criar MHTML C++. C++ MHTML Criador. Crie MHTML em C++. Gere o arquivo MHTML usando C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Criar arquivo MHTML em C++" h2="Criação de arquivo MHTML nativa e de alto desempenho programaticamente sem o Micorsoft Office usando a biblioteca C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como criar MHTML em C++" %}}

{{% blocks/products/pf/agp/text %}}

 É fácil para os desenvolvedores criar, carregar, modificar e converter arquivos MHTML em aplicativos de relatórios em execução para processamento de dados em apenas algumas linhas de código.
...
1.  Salve a pasta de trabalho como arquivo .mhtml usando o método Save().

{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar o arquivo MHTML em C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++ biblioteca para criar o arquivo MHTML" %}}
