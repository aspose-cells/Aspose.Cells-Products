...
url: /cs/net/merger/merge-xls-to-et/ 
...
Následující příklad ukazuje, jak sloučit XLS do ET v Aspose.Cells for .NET.
...
{{% cells-merger title="Ukázkový kód pro sloučení XLS do ET v C#" InputFormat="xls" InputFormat2="et" outformat="et" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLS do ET přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete sloučit XLS do ET programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2=".NET knihovna ke sloučení XLS do ET" %}}
