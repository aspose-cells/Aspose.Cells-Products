...
{{% blocks/products/pf/agp/content h2="So fügen Sie mit Python via .Net eine gebogene Pfeilform in eine Excel-Datei ein" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Einfügen einer gebogenen Pfeilform in eine Excel-Datei mit Python via .Net" %}}
...
{{% blocks/products/pf/agp/code-block title="Gebogene Pfeilform einfügen – Python via .Net" offSpacer="" %}}
