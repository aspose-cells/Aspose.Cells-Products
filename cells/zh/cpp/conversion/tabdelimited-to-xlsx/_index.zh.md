---
title: 通过 C++ 应用程序将 TABDELIMITED 转换为 XLSX 
url: /zh/cpp/conversion/tabdelimited-to-xlsx/ 
description: TABDELIMITED 文档到 XLSX 格式的示例 C++ 转换代码。程序员可以使用此源代码在任何 C++ 应用程序中将 TABDELIMITED 批量转换为 XLSX。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 将 TABDELIMITED 转换为 XLSX" h2="使用 C++ 库的高性能 TABDELIMITED 到 XLSX 转换，无需安装 Microsoft Excel、OpenOffice 或 Adobe Acrobat。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 开发人员只需几行代码即可轻松地将 TABDELIMITED 文件转换为 XLSX。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加载 TABDELIMITED 文件。1. 调用 Save() 方法。1. 使用 (XLSX) 文件扩展名传递输出文件路径。1. XLSX 文件将保存在指定路径。1. 在兼容程序中打开 XLSX 文件。
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED 到 XLSX C++ 转换源代码" offSpacer="" %}}
