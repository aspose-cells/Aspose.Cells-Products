---
title: تحويل C# صورة إلى XLS - صورة إلى XLS
description: Aspose اكسل. قم بتحويل IMAGE إلى XLS بسرعة وسهولة باستخدام Aspose.Cells. C# IMAGE إلى XLS. C# احفظ IMAGE إلى XLS. احفظ IMAGE كـ XLS باستخدام C#.
...
{{% blocks/products/pf/agp/content h2="احفظ الصورة في XLS في C#" %}}

يوضح المثال التالي كيفية تحويل IMAGE إلى XLS في C#.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل IMAGE إلى XLS عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات IMAGE إلى XLS برمجياً؟ يمكن لمطوري .NET تحميل وتحويل IMAGE إلى XLS بسهولة في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C# لتحويل IMAGE إلى XLS" %}}
