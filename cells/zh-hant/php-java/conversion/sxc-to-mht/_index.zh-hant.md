---
title: PHP SXC 轉 MHT - SXC 轉 MHT 轉換器
description: Aspose Excel。此綜合解決方案為 PHP 開發人員提供了一種完全整合的方法，可將 SXC 轉換為 MHT 格式，從而能夠使用 Aspose.Cells 庫將 SXC 資料無縫保存為 MHT 格式，所有這些都透過高效且可自訂的 PHP 程式碼實現。
...
1. 使用工作簿實例載入 SXC 檔案。
1. 呼叫工作簿的 save 方法將 SXC 轉換為 MHT。
1. 取得 SXC 到 MHT 的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="用於將 SXC 轉換為 MHT 的 PHP 函式庫" %}}
