---
title:  Diviser XLSB Fichiers via Java
weight: 7880
description: Exemple de code Java pour diviser les documents XLSB sur l'environnement d'exécution Java pour les applications JSP/JSF et les applications de bureau.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Diviser XLSB Fichiers via Java" h2="XLSB fractionnement à l\'aide de la bibliothèque côté serveur Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Comment diviser le fichier XLSB à l\'aide de Java" %}}
...
+ Charger le fichier XLSB en utilisant la classe Workbook.
+ Parcourir chaque feuille
+ Créer un nouvel objet de classe Workbook
+ Copier la feuille sélectionnée dans un nouvel objet
+ Appelez la méthode save avec le nouveau chemin de fichier XLSB.
...
{{% blocks/products/pf/agp/code-block title="Séparer XLSB Fichier - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section title="Autres formats de fractionnement pris en charge" subTitle="En utilisant Java, on peut également diviser un fichier volumineux en morceaux de nombreux autres formats de fichiers, y compris." >}}
