...
{{< blocks/products/pf/i18n/upper-banner h1="ODS-indelingen samenvoegen in Java" h2="Native ODS-documentfusie met server-side Java API\'s." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="ODS-bestanden samenvoegen met Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het samenvoegen van ODS-bestanden in Java" %}}
...
+ Laad het eerste ODS-bestand met een exemplaar van de Workbook-klasse.
+ Laad het tweede ODS-document met een exemplaar van de Workbook-klasse.
+ Voeg bestanden samen met de combine()-methode.
+ sla het samengevoegde ODS-bestand op het opgegeven pad op
...
{{% blocks/products/pf/agp/code-block title="ODS-bestanden samenvoegen - Java" offSpacer="" %}}

```cs
// Open het eerste ODS-bestand.
Workbook odsFile1 = new Workbook("chartsFileWithPath.ods");

// Definieer het tweede bronboek.
// Open het tweede ODS-bestand.
