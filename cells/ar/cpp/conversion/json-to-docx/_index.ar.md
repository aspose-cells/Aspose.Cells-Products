---
title: تحويل JSON إلى DOCX عبر تطبيق C++ 
url: /ar/cpp/conversion/json-to-docx/ 
description: نموذج رمز تحويل C++ لمستند JSON إلى تنسيق DOCX. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل JSON المجمع إلى DOCX داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل JSON إلى DOCX عبر C++" h2="تحويل JSON عالي الأداء إلى DOCX باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOCX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل JSON إلى DOCX باستخدام C++" %}}
 ...
 من أجل تحويل JSON إلى DOCX ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري C++ بسهولة تحويل ملف JSON إلى DOCX في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف JSON باستخدام Factory :: CreateIWorkbook.1. قم باستدعاء طريقة Save ().1. قم بتمرير مسار ملف الإخراج بامتداد الملف (DOCX).1. سيتم حفظ ملف DOCX في المسار المحدد.1. افتح ملف DOCX في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="JSON إلى DOCX C++ شفرة مصدر التحويل" offSpacer="" %}}
