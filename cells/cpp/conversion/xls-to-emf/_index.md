...
description: Sample C++ conversion code for XLS document to EMF format. Programmers can use this source code for batch XLS to EMF conversion within any C++ Application.
---
...
{{% blocks/products/pf/agp/code-block title="XLS to EMF C++ Conversion Source Code" offSpacer="" %}}
