---
title: Převodník PHP XLAM na HTM – XLAM na HTM
description: Aspose Excel. Převeďte XLAM na HTM rychle a snadno pomocí Aspose.Cells. PHP XLAM na HTM. PHP Uložit XLAM do HTM. Uložte XLAM jako HTM pomocí PHP.
...
{{% blocks/products/pf/agp/content h2="Jak převést XLAM na HTM přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést XLAM soubory na HTM programově? Vývojáři PHP mohou snadno načíst a převést XLAM na HTM v několika řádcích kódu.
...
1.  Převeďte XLAM na HTM voláním metody uložení sešitu.
1.  Získejte výsledek převodu XLAM na HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod XLAM na HTM" %}}
