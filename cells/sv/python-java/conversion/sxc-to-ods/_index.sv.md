---
title: Konvertera SXC till ODS via Python
url: /sv/python-java/conversion/sxc-to-ods/
description: Exempelkod för konvertering från sxc till ods Python. Använd API exempelkod för batch-sxc-filer till ods-konvertering i Python-applikationen.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du SXC till ODS med Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera SXC till ODS via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python-utvecklare kan enkelt ladda och konvertera SXC-filer till ODS på bara några rader kod.
...
{{% cells-convert title="Gratis app och provkod för att konvertera SXC till ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="ods" IsLandingPage="true" language="python" %}}
