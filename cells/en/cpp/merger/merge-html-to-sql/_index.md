...
description: Aspose Excel. C++ Aspose.Cells. Merge HTML to SQL saveformat. C++ Combine HTML to SQL format. Merge HTML to SQL in C++. HTML Merge.
...
{{% blocks/products/pf/agp/content h2="Merge HTML to SQL in C++" %}}
...
{{% cells-merger title="Sample Code to Merge HTML to SQL in C++" InputFormat="html" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
