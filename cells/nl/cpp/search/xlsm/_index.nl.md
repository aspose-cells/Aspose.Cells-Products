---
title:  Zoek document XLSM zonder te openen via C++
weight: 9280
description: C++ voorbeeldcode om woorden met patroon te zoeken in het bestand XLSM op C++ Runtime Environment voor Windows 32 bit, Windows 64 bit en Linux 64 bit.
...
{{< blocks/products/pf/i18n/upper-banner h1="Zoek XLSM Formaten in C++" h2="Native en krachtige XLSM-documentzoekopdracht met behulp van server-side Aspose.Cells for C++ API\'s, zonder het gebruik van software zoals Microsoft of Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u het bestand XLSM kunt zoeken met behulp van C++" %}}
...
+ Laad het bestand XLSM door een werkmapklasse te instantiëren.
...
+ Bewaar het XLSM-bestand met de methode Workbook::Save(...).
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online XLSM Zoek live demo\'s" sectionDescription=" Zoek nu tekst, woorden en zinnen in XLSM-documenten door naar onze[Live demo-website](https://products.aspose.app/cells/search). De live demo heeft de volgende voordelen" >}}
