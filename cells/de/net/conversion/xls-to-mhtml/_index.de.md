---
title: C# XLS bis MHTML - XLS bis MHTML Konverter
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bis MHTML in C#" %}}

Das folgende Beispiel zeigt, wie man XLS in C# in MHTML umwandelt.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie XLS über C# in MHTML" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie XLS-Dateien programmgesteuert in MHTML konvertieren? .NET-Entwickler können XLS mit nur wenigen Codezeilen problemlos in MHTML laden und konvertieren.
...
1.  Konvertieren Sie XLS in MHTML durch Aufruf der Workbook.Save-Methode.
1.  Holen Sie sich das Konvertierungsergebnis von XLS in MHTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C# zur Konvertierung von XLS in MHTML" %}}
