---
title: إنشاء MHT - قم بإنشاء ملف MHT في C#
description: Aspose إكسل. أنشئ ملفات MHT وتعامل معها بسهولة تامة باستخدام مكتبة Aspose.Cells for .NET. توفر هذه المكتبة القوية API حلاً مبسطاً وفعالاً لإنشاء ملفات MHT وتعديلها وإدارتها مباشرةً ضمن تطبيقاتك C#، مما يلبي احتياجات المطورين بدقة عالية.
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء MHT في C#" %}}
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية كيفية إنشاء ملف MHT في C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة C# لإنشاء ملف MHT" %}}
