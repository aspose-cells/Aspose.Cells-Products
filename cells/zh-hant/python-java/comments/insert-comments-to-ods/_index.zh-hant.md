...
{{% blocks/products/pf/agp/content h2="如何通過 Python 在 ODS 文件中插入註釋" %}}
...
在 Office 365 中，註釋用於對話，您可以使用以下 Python 代碼在 ODS 文件中插入和刪除註釋。

{{% blocks/products/pf/agp/code-block title="Python 在 ODS 文件中插入和刪除註釋的示例代碼" offSpacer="" %}}
...
{{% cells-annotation title="免費應用程序可從 ODS 文件中刪除註釋" InputFormat="ods" IsLandingPage="true" language="python" %}}
