...
description: Aspose Excel. Легко создавайте и обрабатывайте файлы NUMBERS с помощью библиотеки Aspose.Cells for C++. Эта мощная библиотека API предоставляет оптимизированное и эффективное решение для создания, редактирования и управления файлами NUMBERS непосредственно в ваших приложениях C++, удовлетворяя специфические потребности разработчиков с высокой точностью.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчикам легко создавать, загружать, изменять и преобразовывать файлы с числовыми значениями в работающих приложениях для создания отчетов и обработки данных всего несколькими строками кода.
...
1.  Сохраните рабочую книгу как файл с расширением .numbers, используя метод Save().
