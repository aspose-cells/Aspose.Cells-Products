...
{{% blocks/products/pf/agp/content h2="Jak vložit poznámky do souboru XLSB přes C#" %}}
...
V Office 365 jsou poznámky pro anotace, můžete použít následující kód C# pro vkládání a odebírání poznámek v souboru XLSB.

{{% blocks/products/pf/agp/code-block title="C# ukázkový kód pro vložení a odstranění poznámek v souboru XLSB" offSpacer="" %}}
