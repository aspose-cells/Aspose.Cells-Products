---
title: Converter HTML para TIFF via C#
url: /pt/net/conversion/html-to-tiff/
description: Código de exemplo para conversão de html para tiff C#. Use API código de exemplo para arquivos html em lote para conversão tiff em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter arquivos HTML para TIFF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo HTML com uma instância da pasta de trabalho1. Chame o método Workbook.Save1. Passe o caminho de saída com a extensão TIFF como parâmetro1. Verifique o caminho especificado para o arquivo TIFF resultante
...
{{% cells-convert title="Aplicativo gratuito e código de exemplo para converter HTML em TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="tiff" IsLandingPage="true" %}}
