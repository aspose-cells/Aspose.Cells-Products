---
title:  ODS を Python 経由で PDF に結合
url: /ja/python-java/merger/merge-ods-to-pdf/ 
description: ODS を PDF にオンラインで無料で結合します。無料オンラインODSからPDF合併。 ODS を Word、Excel、PPTX、PDF、JPG、HTML、ODS、SVG、XPS などに結合します。
---
...
次の例は、ODS を Python の PDF にマージする方法を示しています。
...
{{% cells-merger title="オンラインでODSをPDFにマージする無料アプリ" InputFormat="ods" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
