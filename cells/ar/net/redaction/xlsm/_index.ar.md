---
title:  بحث واستبدال النص في XLSM مستند via .NET
weight: 2370
description: كود المصدر C# لتنقيح المعلومات الحساسة في ملف XLSM على .NET Framework أو .NET Core أو Mono أو Xamarin Platforms.
