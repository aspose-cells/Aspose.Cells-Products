---
title: Konvertieren Sie TABDELIMITED in ODS über Java 
url: /de/java/conversion/tabdelimited-to-ods/ 
description: Beispiel-Umwandlungscode Java für das TABDELIMITED-Format in eine ODS-Datei. Programmierer können diesen Beispielcode verwenden, um Excel- und OpenOffice-Tabellen in ODS innerhalb einer beliebigen Web- oder Desktop-Java-basierten Anwendung zu exportieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie TABDELIMITED in ODS über Java" h2="TABDELIMITED-zu-ODS-Java-Konvertierung zum Konvertieren einzelner oder mehrerer Seiten in ODS unter Verwendung der On-Premise-Java-Bibliothek." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie TABDELIMITED in ODS mit Java" %}}

 Um TABDELIMITED in ODS zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von TABDELIMITED in ODS über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können die TABDELIMITED-Datei in nur wenigen Codezeilen problemlos in ODS konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die TABDELIMITED-Datei mit einer Instanz der Workbook-Klasse1. Rufen Sie die Workbook.save-Methode auf1. Übergeben Sie den Ausgabepfad mit ODS-Erweiterung und SaveFormat als Parameter1. Überprüfen Sie den angegebenen Pfad für die resultierende ODS-Datei
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED zu ODS Java Konvertierungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die TABDELIMITED-Datei in eine Instanz von Workbook
Workbook book = new Workbook("template.tabdelimited");
// TABDELIMITED als ODS speichern
