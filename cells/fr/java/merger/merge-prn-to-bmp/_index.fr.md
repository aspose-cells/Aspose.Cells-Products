---
title: Fusionner PRN à BMP - Combiner PRN à BMP dans Java
url: /fr/java/merger/merge-prn-to-bmp/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite PRN au format de sauvegarde BMP. Java Combine PRN au format BMP. Fusionner PRN à BMP dans Java. Fusion PRN.
...
{{% blocks/products/pf/agp/content h2="Fusionner PRN à BMP en Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner PRN avec BMP dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner PRN en BMP. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans le fichier BMP. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne PRN en BMP.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner PRN à BMP en Java" InputFormat="prn" InputFormat2="bmp" outformat="bmp" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner PRN avec BMP via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner PRN avec BMP par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
