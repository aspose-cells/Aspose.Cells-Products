...
description: Aspose Excel。Python Excel。使用 Aspose.Cells 快速轻松地将 SXC 转换为 MHTML。Python 将 SXC 转换为 MHTML。Python 将 SXC 保存为 MHTML。使用 Python Excel 库将 SXC 保存为 MHTML。
...
{{< blocks/products/pf/i18n/upper-banner h1="在 Python Excel 库中将 SXC 转换为 MHTML" h2="高速 Python excel 库，用于将 SXC 转换为 MHTML。这是一个专业的软件解决方案，可使用 Python 导入和导出 SXC、MHTML 和许多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="使用 Python Excel 库将 SXC 转换为 MHTML" %}}

如何将 SXC 转换为 MHTML？使用 Aspose.Cells for Python 库，您只需几行代码即可以编程方式轻松将 SXC 转换为 MHTML。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)能够构建跨平台应用程序，具有生成、修改、转换、呈现和打印所有 Excel 文件的能力。Python Excel API 不仅可以在电子表格格式之间进行转换，还可以将 Excel 文件呈现为图像 PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等等，因此使其成为交换行业标准格式文档的完美选择。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="将 SXC 保存至 MHTML 至 Python Excel 库" %}}

下面的示例演示如何在 Python excel 库中将 SXC 转换为 MHTML。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 SXC 转换为 MHTML。上传您的 SXC 文件，然后将其另存为 MHTML 文件。对于 SXC 读取和 MHTML 写入，您都可以使用完全合格的文件名。输出 MHTML 内容和格式将与原始 SXC 文档相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="通过 Python Excel 库将 SXC 转换为 MHTML 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="mhtml" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何将 SXC 通过 Python 转换为 MHTML" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 SXC 文件转换为 MHTML 吗？Python 开发人员只需几行代码即可轻松加载并将 SXC 转换为 MHTML。
...
1. 使用工作簿实例加载 SXC 文件。
1. 通过调用 Workbook.save 方法将 SXC 转换为 MHTML。
1. 得到SXC至MHTML的转换结果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Excel 库将 SXC 转换为 MHTML" %}}
