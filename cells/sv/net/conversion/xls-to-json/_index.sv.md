---
title: C# XLS till JSON - XLS till JSON Omvandlare
description: Aspose Excel. Denna omfattande lösning ger C#-utvecklare en helt integrerad metod för att konvertera XLS till JSON-format, vilket möjliggör sömlös sparning av XLS-data till JSON-format med hjälp av Aspose.Cells-biblioteket, allt genom effektiv och anpassningsbar C#-kod.
...
{{% blocks/products/pf/agp/content h2="Spara XLS till JSON i C#" %}}

Följande exempel visar hur man konverterar XLS till JSON i C#.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att konvertera XLS till JSON. Ladda upp din XLS-fil och spara den sedan som JSON-fil. För både XLS läsning och JSON skrivning kan du använda fullt kvalificerade filnamn. Utdata JSON innehåll och formatering kommer att vara identisk med originaldokumentet XLS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exempelkod för att konvertera XLS till JSON" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="json" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Hur man konverterar XLS till JSON via C#" %}}

{{% blocks/products/pf/agp/text %}}

Behöver du konvertera XLS-filer till JSON programmatiskt? .NET-utvecklare kan enkelt ladda och konvertera XLS till JSON på bara några rader kod.
...
1.  Konvertera XLS till JSON genom att anropa Workbook.Save-metoden.
1.  Få konverteringsresultatet från XLS till JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-biblioteket för att konvertera XLS till JSON" %}}
