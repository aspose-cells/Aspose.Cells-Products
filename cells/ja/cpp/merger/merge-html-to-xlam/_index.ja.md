...
url: /ja/cpp/merger/merge-html-to-xlam/ 
...
次の例は、HTML を Aspose.Cells for C++ の XLAM にマージする方法を示しています。
...
HTML をプログラムで XLAM にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)API はわずか数行のコードで実行できます。
...
{{% blocks/products/pf/agp/content h2="C++ HTML を XLAM にマージするライブラリ" %}}
