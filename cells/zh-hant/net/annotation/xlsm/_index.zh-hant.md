---
title: 新增或刪除 XLSM 註 via .NET
weight: 9890
description: C# 原始碼，用於在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上新增和刪除 XLSM 格式註解。
...
{{< blocks/products/pf/i18n/upper-banner h1="透過 C# 從 XLSM 新增或刪除註釋" h2="建立您自己的 .NET 應用程序，以使用伺服器端 API 操作文件檔案中的評論和作者。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C# 從 XLSM 新增或刪除註釋" %}}
