---
title: دمج XLSB في POWERPOINT - دمج XLSB في POWERPOINT في C++
url: /ar/cpp/merger/merge-xlsb-to-powerpoint/ 
description: Aspose اكسل. C++ Aspose.Cells. دمج XLSB في تنسيق الحفظ POWERPOINT. C++ قم بدمج XLSB إلى تنسيق POWERPOINT. دمج XLSB في POWERPOINT في C++. XLSB دمج.
...
{{% blocks/products/pf/agp/content h2="دمج XLSB في Powerpoint في C++" %}}

يوضح المثال التالي كيفية دمج XLSB في POWERPOINT في Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج XLSB في POWERPOINT. قم بتحميل ملفاتك، واستدعاء طريقة Workbook.Combine لدمج الملفات، ثم احفظها في ملف POWERPOINT. إذا قمت بتطوير التعليمات البرمجية في C++، فسيكون هذا أبسط مما يبدو. راجع مثال C++ الذي يدمج XLSB في POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="نموذج التعليمات البرمجية لدمج XLSB إلى POWERPOINT في C++" InputFormat="xlsb" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج XLSB إلى Powerpoint عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج XLSB في POWERPOINT برمجياً؟ وثيقة أساسية دمج وتسلسل مع[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) يمكن إنشاء واجهات برمجة التطبيقات باستخدام بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة C++ لدمج XLSB في POWERPOINT" %}}
