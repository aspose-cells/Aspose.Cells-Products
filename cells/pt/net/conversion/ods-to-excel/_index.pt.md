---
title: C# ODS para EXCEL - Online ODS para EXCEL Conversor
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Online Grátis C# Converter ODS para EXCEL saveformat. C# ODS para o formato EXCEL. Salve ODS em EXCEL C#.
...
{{% blocks/products/pf/agp/content h2="Salve ODS em EXCEL em C# Online Gratuitamente" %}}

O exemplo a seguir demonstra como converter ODS para EXCEL em C#.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para converter ODS para EXCEL. Carregue seu arquivo ODS e simplesmente salve-o como arquivo EXCEL. Para leitura de ODS e escrita em EXCEL, você pode usar nomes de arquivos totalmente qualificados. O conteúdo e a formatação do EXCEL de saída serão idênticos ao documento ODS original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplicativo gratuito e código de exemplo para converter ODS para EXCEL Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ods" outformat="xlsx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Como converter ODS para EXCEL via C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS para EXCEL programaticamente? .NET desenvolvedores podem facilmente carregar e converter ODS para EXCEL em apenas algumas linhas de código.
...
1.  Converta ODS para EXCEL chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para EXCEL.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteca para converter ODS para EXCEL" %}}
