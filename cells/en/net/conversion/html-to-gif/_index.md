...
description: Convert HTML to GIF format in C# code. Save HTML as GIF using VB.NET, Asp.NET or any .NET based application.
---
...
The following example demonstrates how to convert HTML to GIF document format in C#.
...
{{% cells-convert title="Free App and Sample Code to Convert HTML to GIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="gif" IsLandingPage="true" %}}
