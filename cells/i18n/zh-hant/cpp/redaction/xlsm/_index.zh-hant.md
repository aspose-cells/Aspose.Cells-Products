---
title: 通過 C++ 搜索和替換 XLSM 文檔中的文本 
weight: 9570
url: /zh-hant/cpp/redaction/xlsm/ 
description: C++ 用於編輯 XLSM 文件中敏感信息的示例代碼 C++ 適用於 Windows 32 位、Windows 64 位和 Linux 64 位的運行時環境。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="在 C++ 中編輯 XLSM 格式" h2="本機和高性能 XLSM 使用用於 C++ API 的服務器端 Aspose.Cells 記錄敏感的編校信息，無需使用 Microsoft 或 Adobe PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 C++ 中編輯 XLSM 文件的步驟" %}}
