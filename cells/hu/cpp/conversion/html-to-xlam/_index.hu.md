---
title: Konvertálja a HTML-t XLAM-re a(z) C++ alkalmazással 
url: /hu/cpp/conversion/html-to-xlam/ 
description: Minta C++ konverziós kód HTML-dokumentumhoz XLAM formátumba. A programozók ezt a forráskódot használhatják kötegelt HTML-ből XLAM-má konvertálásához bármely C++ alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="HTML konvertálása XLAM-re a következőn keresztül: C++" h2="Nagy teljesítményű HTML-XLAM konvertálás a C++ könyvtár használatával Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítése nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLAM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="HTML" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 A C++ fejlesztői könnyedén konvertálhatják a HTML-fájlt XLAM-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be HTML-fájlt a Factory::CreateIWorkbook segítségével.1. Hívja a Save() metódust.1. Adja meg a kimeneti fájl elérési útját (XLAM) fájlkiterjesztéssel.1. Az XLAM fájl a megadott elérési útra kerül mentésre.1. Nyissa meg az XLAM fájlt egy kompatibilis programban.
...
{{% blocks/products/pf/agp/code-block title="HTML-ből XLAM-be C++ konverziós forráskód" offSpacer="" %}}
