...
description: Aspose Excel. Convierta XLSB a JSON rápida y fácilmente con Aspose.Cells. Python XLSB a JSON. Python Guarde XLSB en JSON. Guarde XLSB como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLSB al JSON en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSB a JSON en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSB en JSON" %}}
