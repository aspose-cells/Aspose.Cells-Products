---
title: Mesclar SXC com IMAGE - Combinar SXC com IMAGE em Python
url: /pt/python-net/merger/merge-sxc-to-image/ 
description: Aspose Excel. Python Excel. Mesclar SXC para salvar o formato IMAGE. Python Combine SXC para o formato IMAGEM. Mesclar SXC com IMAGE na biblioteca Python Excel. SXC Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC com IMAGE usando a biblioteca Python do Excel" %}}
...
{{% blocks/products/pf/agp/content h2="Mesclar SXC com IMAGE na biblioteca Python Excel" %}}

O exemplo a seguir demonstra como mesclar SXC com IMAGE em Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar SXC com IMAGE. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-os no arquivo IMAGE. Se você desenvolver código em Python, será mais simples do que parece. Veja o exemplo Python que mescla SXC com IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Exemplo de código para mesclar SXC com IMAGE na biblioteca Python Excel" InputFormat="sxc" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar SXC com IMAGE por meio da biblioteca Python Excel" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar SXC com IMAGE programaticamente? Um documento básico mesclado e concatenado com[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para mesclar SXC com IMAGE" %}}
