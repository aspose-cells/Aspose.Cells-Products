...
description: C# source code to combine CSV to HTM file on .NET, .NET Core, Mono or Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="How to Merge CSV to HTM File Using C#" %}}
 ...
 In order to merge CSV to HTM file, we’ll use
...
{{% blocks/products/pf/agp/code-block title="Merge CSV to HTM Files - C#" offSpacer="" %}}
