...
url: /hu/python-net/merger/merge-excel-to-tiff/ 
...
{{< blocks/products/pf/i18n/upper-banner h1="Az EXCEL egyesítése a TIFF-gyel a Python Excel könyvtáron keresztül" h2="Nagysebességű Python excel könyvtár az EXCEL és a TIFF egyesítéséhez. Használja a API-es excel-konverziónkat magas szintű, platformfüggetlen szoftverek fejlesztésére Python-ben. Ez egy professzionális szoftvermegoldás Excel, CSV, OpenOffice, PDF, HTML, image és sok más excel formátum importálásához és exportálásához." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="EXCEL" additionalConversionTag="TIFF" pfName="Aspose.Cells" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="XLSX" fileiconsmall2="ODS" fileiconsmall3="HTML" fileiconsmall4="NUMBERS" fileiconsmall5="CSV" >}}
...
A következő példa bemutatja, hogyan egyesítheti az EXCEL-t a TIFF-gyel a Aspose.Cells for Python via .NET-ben.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell az EXCEL-t a TIFF-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
