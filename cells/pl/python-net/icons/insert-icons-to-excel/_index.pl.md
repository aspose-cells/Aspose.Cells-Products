---
title:  Wstaw SVG obrazów/ikon do programu Excel, używając Python via .Net
weight: 200
description: Python via .Net kod źródłowy do wstawienia SVG obrazów / ikon do programu Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wstaw SVG obrazów/ikon do programu Excel, używając Python via .Net" h2="Wstaw obrazy/ikony SVG za pomocą Aspose.Cells\' API bez żadnego oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF itp." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wstawić obrazy/ikony SVG do pliku programu Excel za pomocą Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wstawić obrazy/ikony SVG do pliku Excel przy użyciu Python via .Net" %}}
...
+ Wybierz arkusz roboczy za pomocą jego indeksu.
 + Użyj dodatku shapecollection[metoda](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/) aby wstawić ikonę w wybranym arkuszu.
...
{{% blocks/products/pf/agp/code-block title="Wstaw SVG obrazy/ikony - Python via .Net" offSpacer="" %}}
