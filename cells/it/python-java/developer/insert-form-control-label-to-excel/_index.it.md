...
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci etichetta (controllo modulo) in Excel tramite Python" h2="Inserisci oggetti utilizzando le API lato server senza alcun software come Microsoft o Open Office, Adobe PDF, ecc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa la collezione di forme[aggiungere metodo](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection#addLabel(int,%20int,%20int,%20int,%20int,%20int)) per inserire un'etichetta (controllo modulo) nel foglio di lavoro selezionato.
