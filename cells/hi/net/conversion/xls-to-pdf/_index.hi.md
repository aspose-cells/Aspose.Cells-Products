---
title: C# XLS से PDF - ऑनलाइन XLS से PDF कनवर्टर
description: Aspose एक्सेल। C# Aspose.Cells. C# Aspose Cells. मुफ़्त ऑनलाइन C# XLS को PDF सेव फॉर्मेट में कनवर्ट करें। C# XLS से PDF प्रारूप। XLS को PDF C# पर सेव करें।
...
{{% blocks/products/pf/agp/content h2="C# में XLS से PDF को निःशुल्क ऑनलाइन सेव करें" %}}

निम्नलिखित उदाहरण दर्शाता है कि C# में XLS को PDF में कैसे परिवर्तित किया जाए।
...
{{% blocks/products/pf/agp/content h2="C# के माध्यम से XLS को PDF में कैसे परिवर्तित करें" %}}

{{% blocks/products/pf/agp/text %}}

XLS फ़ाइलों को प्रोग्रामेटिक रूप से PDF में कनवर्ट करने की आवश्यकता है? .NET डेवलपर्स कोड की कुछ पंक्तियों में XLS को PDF में आसानी से लोड और परिवर्तित कर सकते हैं।
...
1.  Workbook.Save पद्धति पर कॉल करके XLS को PDF में कनवर्ट करें।
