---
title:  Gabungkan XLSB File via .NET
weight: 2970
description: Kode sumber C# untuk menggabungkan dokumen XLSB pada .NET Framework, .NET Core, Mono atau Platform Xamarin.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Penggabungan File XLSB di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Gabungkan XLSB File - C#" offSpacer="" %}}
