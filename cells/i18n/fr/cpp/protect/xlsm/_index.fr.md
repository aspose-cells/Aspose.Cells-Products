...
weight: 8770
url: /fr/cpp/protect/xlsm/ 
description: C++ Exemple de code pour verrouiller le fichier XLSM à l'aide d'un mot de passe sur C++ Runtime Environment pour Windows 32 bits, Windows 64 bits et Linux 64 bits.
---
...
{{% blocks/products/pf/agp/content h2="Comment sécuriser un fichier XLSM à l\'aide de C++" %}}
...
1. Charger le fichier XLSM à l'aide de la classe IWorkbook1. Utiliser la méthode Protect(..) avec ProtectionType et Password1. Enregistrez le fichier XLSM protégé par la méthode Save ()
