---
title:  แทรกป้ายกำกับ (ตัวควบคุมฟอร์ม) ลงใน Excel ผ่าน Python
weight: 80
description: ซอร์สโค้ด Python เพื่อแทรก Label (Form control) ลงใน Excel
---
...
{{% blocks/products/pf/agp/content h2="วิธีแทรกป้ายกำกับ (ตัวควบคุมแบบฟอร์ม) ลงในไฟล์ Excel โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแทรก Label (Form control) ลงในไฟล์ Excel ผ่าน Python" %}}
...
+ ใช้วิธีการเพิ่มของ shapecollection เพื่อแทรกป้ายกำกับ (การควบคุมแบบฟอร์ม) ในเวิร์กชีตที่เลือก
...
{{% blocks/products/pf/agp/code-block title="แทรกป้ายกำกับ(ตัวควบคุมแบบฟอร์ม) - Python" offSpacer="" %}}
