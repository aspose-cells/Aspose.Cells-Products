---
title: C++ OTS en PNG - Convertisseur OTS en PNG
description: Aspose Excel. Cette solution complète offre aux développeurs C++ une approche entièrement intégrée pour convertir OTS au format PNG, permettant un enregistrement transparent des données OTS au format PNG à l'aide de la bibliothèque Aspose.Cells, le tout grâce à un code C++ efficace et personnalisable.
...
{{< blocks/products/pf/i18n/upper-banner h1="Convertir OTS en PNG dans C++" h2="Conversion OTS haute performance vers PNG utilisant la bibliothèque C++ sans avoir besoin de l\'installation d\'Excel, d\'OpenOffice ou d\'Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer OTS au PNG dans C++" %}}

L'exemple suivant montre comment convertir OTS en PNG en C++.
...
{{% blocks/products/pf/agp/content h2="Comment convertir OTS en PNG via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers OTS au format PNG par programmation ? Les développeurs spécialisés en C++ peuvent facilement convertir des fichiers OTS au format PNG en quelques lignes de code seulement.
...
1.  Convertissez OTS en PNG en appelant la méthode Save().
1.  Obtenez le résultat de la conversion de OTS en PNG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour convertir OTS en PNG" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/conversion/ots-to-pdf/" name="OTS AU PDF" description="Format de document portable" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/conversion/ots-to-png/" name="OTS AU PNG" description="Graphiques de réseau portables" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/cells/cpp/conversion/ots-to-tiff/" name="OTS AU TIFF" description="Format d\'image balisé" >}}
