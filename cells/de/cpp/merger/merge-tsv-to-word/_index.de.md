---
title: TSV mit WORD zusammenführen - TSV mit WORD in C++ kombinieren
url: /de/cpp/merger/merge-tsv-to-word/ 
description: Aspose Excel. C++ Aspose.Cells. TSV mit WORD Saveformat zusammenführen. C++ Kombinieren Sie das Format TSV mit dem Format WORD. TSV zu WORD in C++ zusammenführen. TSV Zusammenführen.
...
{{% blocks/products/pf/agp/content h2="TSV mit WORD in C++ zusammenführen" %}}

Das folgende Beispiel zeigt, wie TSV mit WORD in Aspose.Cells for C++ zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um TSV mit WORD zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in der Datei WORD. Wenn Sie Code in C++ entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C++, das TSV mit WORD zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Beispielcode zum Zusammenführen von TSV mit WORD in C++" InputFormat="tsv" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}
