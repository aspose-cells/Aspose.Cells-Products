---
title: Mesclar TABDELIMITED para IMAGE - Combinar TABDELIMITED para IMAGE em C#
url: /pt/net/merger/merge-tabdelimited-to-image/ 
description: Aspose Excel. C# Aspose.Cells. Mesclagem on-line gratuita TABDELIMITED para IMAGE saveformat. C# Combine TABDELIMITED para o formato IMAGE. Mesclar TABDELIMITED para IMAGE em C#. TABDELIMITED Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar TABDELIMITED para IMAGE em C# online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar TABDELIMITED com IMAGE em Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar TABDELIMITED com IMAGE. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo IMAGE. Se você desenvolver código em C#, isso será mais simples do que parece. Veja o exemplo C# que mescla TABDELIMITED com IMAGE.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar TABDELIMITED com IMAGE em C#" InputFormat="tsv" InputFormat2="png" outformat="png" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar TABDELIMITED para IMAGE via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Precisa mesclar TABDELIMITED a IMAGE programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for .NET](https://products.aspose.com/cells/net) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteca para mesclar TABDELIMITED com IMAGE" %}}
