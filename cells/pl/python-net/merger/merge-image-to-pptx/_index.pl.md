---
title: Scal OBRAZ z PPTX - Połącz OBRAZ z PPTX w Python
url: /pl/python-net/merger/merge-image-to-pptx/ 
description: Aspose Excel. Python Excel. Scal OBRAZ do formatu zapisu PPTX. Python Połącz OBRAZ do formatu PPTX. Scal OBRAZ z PPTX w Python Bibliotece Excel. OBRAZ Scal.
...
{{% blocks/products/pf/agp/content h2="Scal OBRAZ z PPTX przy użyciu biblioteki Excel Python" %}}

Jak połączyć OBRAZ z numerem PPTX? Dzięki bibliotece Aspose.Cells for Python via .NET możesz łatwo programowo połączyć IMAGE z PPTX za pomocą kilku linii kodu.[Aspose.Cells for Python via .NET](https://pypi.org/project/aspose-cells-python) potrafi budować aplikacje wieloplatformowe z możliwością generowania, modyfikowania, konwertowania, renderowania i drukowania wszystkich plików Excel. Python Excel API nie tylko konwertuje pomiędzy formatami arkuszy kalkulacyjnych, ale może także renderować pliki Excel jako obrazy, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT i więcej, co czyni go idealnym wyborem do wymiany dokumentów w formatach będących standardami branżowymi. Możesz zainstalować Aspose.Cells for Python via .NET z<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , użyj polecenia jako:<code>$ pip install aspose-cells-python</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Scal OBRAZ z PPTX w Python Bibliotece Excel" %}}

Poniższy przykład pokazuje, jak połączyć IMAGE z PPTX w Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić IMAGE z PPTX. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku PPTX. Jeśli opracujesz kod w Python, będzie to prostsze niż się wydaje. Zobacz przykład Python, który łączy OBRAZ z PPTX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia OBRAZU z PPTX w bibliotece Excel Python" InputFormat="png" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić OBRAZ z PPTX za pomocą biblioteki Excel Python" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić IMAGE z PPTX? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do połączenia OBRAZU z PPTX" %}}
