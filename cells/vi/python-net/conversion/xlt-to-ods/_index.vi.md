...
description: Aspose Excel. Chuyển đổi XLT sang ODS nhanh chóng và dễ dàng với Aspose.Cells. Python XLT sang ODS. Python Lưu XLT thành ODS. Lưu XLT thành 07611134 81 sử dụng Python.
...
{{% blocks/products/pf/agp/content h2="Lưu XLT vào ODS trong Python" %}}

Ví dụ sau đây minh họa cách chuyển đổi XLT thành ODS trong Python via NET.
...
{{% blocks/products/pf/agp/content h2="Thư viện Python chuyển đổi XLT thành ODS" %}}
