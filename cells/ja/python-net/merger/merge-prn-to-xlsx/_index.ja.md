---
title: PRN を XLSX に結合 - PRN を Python に XLSX に結合
url: /ja/python-net/merger/merge-prn-to-xlsx/ 
description: Aspose エクセル。 Python Aspose.Cells。無料オンライン PRN を XLSX 保存形式にマージします。 Python PRN を XLSX 形式に結合します。 PRN を Python の XLSX にマージします。PRN をマージします。
...
次の例は、PRN を Aspose.Cells for Python via .NET の XLSX にマージする方法を示しています。
...
{{% cells-merger title="PRNをPythonにXLSXにマージする無料オンライン" InputFormat="prn" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}

{{% blocks/products/pf/agp/content h2="Python 経由で PRN を XLSX にマージする方法" %}}

{{% blocks/products/pf/agp/text %}}

PRN をプログラムで XLSX にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net)API はわずか数行のコードで実行できます。
