---
title: C# ओटीएस से XLSB - ओटीएस से XLSB कन्वर्टर
description: Aspose एक्सेल। Aspose.Cells के साथ OTS को XLSB में जल्दी और आसानी से बदलें। C# OTS को XLSB पर बदलें। C# OTS को XLSB पर सहेजें। C# का उपयोग करके OTS को XLSB के रूप में सहेजें।
...
{{% blocks/products/pf/agp/content h2="OTS को C# में XLSB पर सेव करें" %}}
...
{{% cells-convert title="ओटीएस को XLSB में बदलने के लिए नमूना कोड" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="xlsb" IsLandingPage="true" %}}
