---
title: Converti SPREADSHEETML in MHTML tramite Python

description: Codice di esempio per la conversione da foglio di lavoroml a mhtml Python. Usa API codice di esempio per la conversione batch di file da fogli di lavoro ml in mhtml all'interno dell'applicazione Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti SPREADSHEETML in MHTML tramite Python" h2="Esporta fogli di lavoro Excel® in formato MHTML utilizzando Python API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire SPREADSHEETML in MHTML utilizzando Python" %}}

 Per convertire SPREADSHEETML in MHTML, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire SPREADSHEETML in MHTML tramite Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python gli sviluppatori possono caricare e convertire facilmente file SPREADSHEETML in MHTML in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file SPREADSHEETML con un'istanza di Workbook1. Chiama il metodo Workbook.Save1. Passa il percorso di output con l'estensione MHTML come parametro1. Controllare il percorso specificato per il file MHTML risultante
