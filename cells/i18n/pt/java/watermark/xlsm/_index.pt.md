...
{{< blocks/products/pf/i18n/upper-banner h1="Adicionar marca d\'água de texto ao XLSM via Java" h2="Crie seus próprios aplicativos Java para marcar arquivos XLSM com marca d\'água usando APIs do lado do servidor." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Como marcar o arquivo XLSM com marca d\'água usando Java" %}}

 Para marcar o arquivo XLSM com marca d'água, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para adicionar marca d\'água ao XLSM via Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Criar um novo objeto Workbook1. Selecione a planilha por meio de seu índice1. Crie uma forma e use sua função addTextEffect1. Definir cores, transparência e muito mais1. Salvar pasta de trabalho no formato XLSM
...
{{% blocks/products/pf/agp/code-block title="Adicionar marca d\'água ao XLSM - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API pode ser usado para criar, editar, converter e renderizar formatos do Microsoft Excel para diferentes formatos. Além disso, ele pode ser usado para gráficos abrangentes, relatórios escaláveis e cálculos confiáveis em aplicativos de software. Aspose.Cells é um API autônomo e não requer nenhum software como Microsoft ou OpenOffice.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Marca d\'água XLSM via aplicativo online" sectionDescription="Adicione marca d\'água a documentos XLSM visitando nosso [Site de demonstrações ao vivo](https://products.aspose.app/cells/watermark). A demonstração ao vivo tem os seguintes benefícios" >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Não há necessidade de baixar ou configurar nada" >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Não há necessidade de escrever nenhum código" >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Basta fazer o upload do seu arquivo XLSM, definir sua marca d\'água e clicar no botão \"Adicionar\"" >}}
