---
title: Konwertuj XLSB na TSV za pomocą aplikacji C++ 
weight: 720
url: /pl/cpp/conversion/xlsb-to-tsv/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLSB do formatu TSV. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLSB na TSV w dowolnej aplikacji C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLSB na TSV przez C++" h2="Wysoce wydajna konwersja XLSB do TSV przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLSB na TSV w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLSB przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (TSV).1. Plik TSV zostanie zapisany pod określoną ścieżką.1. Otwórz plik TSV w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLSB do TSV C++ Kod źródłowy konwersji" offSpacer="" %}}
