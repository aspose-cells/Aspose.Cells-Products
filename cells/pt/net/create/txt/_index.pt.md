---
title: Criar TXT - Criar arquivo TXT em C#
description: Aspose Excel. Gere e manipule arquivos TXT sem esforço com a biblioteca Aspose.Cells for .NET. Esta poderosa biblioteca API oferece uma solução simplificada e eficiente para criar, editar e gerenciar arquivos TXT diretamente em seus aplicativos C#, atendendo às necessidades específicas dos desenvolvedores com alta precisão.
...
{{% blocks/products/pf/agp/content h2="Como criar TXT em C#" %}}
...
1.  Use o método Salvar para salvar a pasta de trabalho como arquivo TXT.

{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar o arquivo TXT em C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para criar o arquivo TXT" %}}
