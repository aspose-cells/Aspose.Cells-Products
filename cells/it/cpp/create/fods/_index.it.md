...
{{% blocks/products/pf/agp/text %}}
 ...
 È facile per gli sviluppatori creare, caricare, modificare e convertire i file FODS all'interno delle applicazioni di reporting in esecuzione per l'elaborazione dei dati in poche righe di codice.
...
1.  Salva la cartella di lavoro come file .fods usando il metodo Save().
