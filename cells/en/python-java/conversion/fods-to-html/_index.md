...
Follow the easy steps to convert FODS into HTML. Upload your FODS file, then simply save it as HTML file. For both FODS reading and HTML writing you can use fully qualified filenames. The output HTML content and formatting will be identical to the original FODS document.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Python developers can easily load & convert FODS to HTML in just a few lines of code.
