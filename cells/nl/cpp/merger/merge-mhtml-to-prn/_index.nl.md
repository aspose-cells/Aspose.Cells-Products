...
description: Aspose Excel. C++ Aspose.Cells. Voeg MHTML samen naar PRN-opslagformaat. C++ Combineer MHTML naar PRN-formaat. Voeg MHTML samen met PRN in C++. MHTML Voeg samen.
...
{{% blocks/products/pf/agp/content h2="Hoe u MHTML samenvoegt met PRN via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u MHTML programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API's kunnen met slechts enkele regels code worden uitgevoerd.
