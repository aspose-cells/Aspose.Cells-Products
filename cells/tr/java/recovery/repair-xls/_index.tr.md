---
title: Java xls Dosyasını Onar - Ücretsiz Online xls Dosyasını Onar
url: /tr/java/recovery/repair-xls/ 
description: Aspose excel. Java Aspose.Cells. Java xls dosyasını onarın. Ücretsiz Çevrimiçi xls onarım aracı. Bozuk bir xls dosyasını onarın. Java uygulamasında bozuk bir xls dosyasını kurtarın.
...
{{% blocks/products/pf/agp/content h2="Java\'de xls dosyası nasıl onarılır" %}}

{{% blocks/products/pf/agp/text %}}

Xls dosyasını programlı olarak onarmanız mı gerekiyor? Java geliştiriciler, xls dosyasını yalnızca birkaç satır kodla kolayca yükleyebilir ve onarabilir.
...
{{% cells-recovery title="Çevrimiçi XLS dosyasını onarmak için Ücretsiz Uygulama ve Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xls" outformat="xls" IsLandingPage="true" language="java" %}}    
    
{{% blocks/products/pf/agp/content h2="XLS dosyasını onarmak için Java kitaplığı" %}}
