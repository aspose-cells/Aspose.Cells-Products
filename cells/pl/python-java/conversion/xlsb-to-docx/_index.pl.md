---
title: Konwertuj XLSB na DOCX przez Python
url: /pl/python-java/conversion/xlsb-to-docx/
description: Przykładowy kod konwersji xlsb do docx Python. Użyj przykładowego kodu API dla plików wsadowych xlsb do konwersji docx w aplikacji Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na DOCX za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLSB na DOCX przez Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programiści mogą łatwo ładować i konwertować pliki XLSB do formatu DOCX w zaledwie kilku linijkach kodu.
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLSB na DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="docx" IsLandingPage="true" language="python" %}}
