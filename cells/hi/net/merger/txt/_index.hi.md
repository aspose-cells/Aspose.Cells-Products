---
title:  मर्ज TXT फ़ाइलें via .NET
weight: 7350
description: .NET फ्रेमवर्क, .NET कोर, Mono या Xamarin प्लेटफार्मों पर TXT दस्तावेजों को संयोजित करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="TXT प्रारूपों को C# में मर्ज करें" h2="मूल और उच्च प्रदर्शन TXT सर्वर-साइड Aspose.Cells for .NET एपीआई का उपयोग करके दस्तावेज़ विलय, Microsoft या ओपन ऑफिस, एडोब PDF जैसे किसी भी सॉफ़्टवेयर के उपयोग के बिना।" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
+ सहेजें () विधि को कॉल करें और पैरामीटर के रूप में फ़ाइल नाम (पूर्ण पथ) और प्रारूप (TXT) पास करें।
+ अब आप TXT फ़ाइल को Microsoft कार्यालय, एडोब PDF या किसी अन्य संगत प्रोग्राम में खोल और उपयोग कर सकते हैं।
...
{{% blocks/products/pf/agp/code-block title="मर्ज TXT फ़ाइलें - C#" offSpacer="" %}}
