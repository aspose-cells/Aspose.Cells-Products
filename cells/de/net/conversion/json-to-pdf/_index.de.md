---
title: Konvertieren Sie JSON in PDF über C#

description: Beispielcode für die Umwandlung von json in pdf C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von JSON-Dateien in PDF innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie JSON in PDF über C#" h2="Exportieren Sie Excel®-Tabellen in das PDF-Format auf .NET Framework-, .NET Core-, Mono- oder Xamarin-Plattformen." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können JSON-Dateien in nur wenigen Codezeilen einfach laden und in PDF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die JSON-Datei mit einer Instanz von Workbook1. Rufen Sie die Workbook.Save-Methode auf1. Ausgabepfad mit PDF-Endung als Parameter übergeben1. Überprüfen Sie den angegebenen Pfad für die resultierende PDF-Datei
...
{{% cells-convert title="Kostenlose App und Beispielcode zum Konvertieren von JSON in PDF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="json" outformat="pdf" IsLandingPage="true" %}}
