...
{{% cells-convert title="Beispielcode zum Konvertieren von JPEG in IMAGE" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="png" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie JPEG über C++ in IMAGE" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie JPEG-Dateien programmgesteuert in IMAGE konvertieren? C++-Entwickler können JPEG in nur wenigen Codezeilen problemlos in IMAGE konvertieren.
...
1.  Konvertieren Sie JPEG in IMAGE, indem Sie die Save()-Methode aufrufen.
