---
title: Converti FODS in TABDELIMITED tramite Python
url: /it/python-java/conversion/fods-to-tabdelimited/
description: Codice di esempio per la conversione da fod a Python delimitata da tabulazioni. Usa API codice di esempio per file batch fods in conversione delimitata da tabulazioni all'interno dell'applicazione Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti FODS in TABDELIMITED tramite Python" h2="Esporta fogli di lavoro Excel® in formato TABDELIMITED utilizzando Python API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire FODS in TABDELIMITED utilizzando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire FODS in TABDELIMITED tramite Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python gli sviluppatori possono caricare e convertire facilmente i file FODS in TABDELIMITED in poche righe di codice.
