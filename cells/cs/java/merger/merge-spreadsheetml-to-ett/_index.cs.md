...
description: Aspose Excel. Java Aspose.Cells. Sloučit SPREADSHEETML do formátu uložení ETT. Java Zkombinujte SPREADSHEETML s formátem ETT. Sloučit SPREADSHEETML do ETT v Java. SPREADSHEETML Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit SPREADSHEETML do ETT v Java" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení SPREADSHEETML do ETT v Java" InputFormat="xml" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}
