---
title: C++ أرقام إلى XLTX - أرقام على الإنترنت لتحويل XLTX
description: Aspose إكسل. C++ Aspose.Cells. C++ Aspose Cells. مجاني على الإنترنت C++ قم بتحويل الأرقام إلى XLTX saveformat. C++ أرقام إلى تنسيق XLTX. احفظ الأرقام في XLTX C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل الأرقام إلى XLTX في C++" h2="أرقام عالية الأداء لتحويل XLTX باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="احفظ الأرقام في XLTX في C++ عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات NUMBERS إلى XLTX برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل الأرقام إلى XLTX في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل الأرقام إلى XLTX باستدعاء طريقة Save ().
