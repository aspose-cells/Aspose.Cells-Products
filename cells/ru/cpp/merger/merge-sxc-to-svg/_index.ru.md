...
В следующем примере показано, как объединить SXC с SVG в Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Нужно программно объединить SXC с SVG? Базовый документ сливается и объединяется с[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API можно реализовать всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="библиотека C++ для объединения SXC с SVG" %}}
