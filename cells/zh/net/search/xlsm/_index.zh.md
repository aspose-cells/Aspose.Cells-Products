---
title: 搜索XLSM文档，无需打开via .NET
weight: 4880
description: C# 源代码，用于在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上搜索 XLSM 文件中具有模式的单词。
...
{{< blocks/products/pf/i18n/upper-banner h1="搜索 XLSM C# 中的格式" h2="使用服务器端 Aspose.Cells for .NET API 进行本机高性能 XLSM 文档搜索，无需使用 Microsoft 或 Adobe PDF 等任何软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="搜索 C# 中的 XLSM 文件的步骤" %}}
