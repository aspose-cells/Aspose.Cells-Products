---
title: قم بتحويل XLTX إلى SVG عبر تطبيق C++ 
url: /ar/cpp/conversion/xltx-to-svg/ 
description: نموذج C++ رمز تحويل لمستند XLTX إلى تنسيق SVG. يمكن للمبرمجين استخدام كود المصدر هذا لتحويل XLTX دفعة واحدة إلى SVG داخل أي تطبيق C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل XLTX إلى SVG عبر C++" h2="تحويل XLTX عالي الأداء إلى SVG باستخدام مكتبة C++ دون الحاجة إلى تثبيت Microsoft Excel أو OpenOffice أو Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل XLTX إلى SVG باستخدام C++" %}}

 من أجل تحويل XLTX إلى SVG ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل XLTX إلى SVG عبر C++" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري C++ بسهولة تحويل ملف XLTX إلى SVG في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف XLTX باستخدام Factory :: CreateIWorkbook.1. حدد ورقة العمل الأولى.1. اضبط خيارات (SVG).1. كرر خلال كل صفحة من الورقة وعرضها.1. افتح ملف SVG في برنامج متوافق.
...
{{% blocks/products/pf/agp/code-block title="XLTX إلى شفرة مصدر التحويل SVG C++" offSpacer="" %}}
