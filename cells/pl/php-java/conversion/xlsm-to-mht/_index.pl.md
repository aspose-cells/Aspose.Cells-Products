...
description: Aspose Excel. Szybko i łatwo przekonwertuj XLSM na MHT za pomocą Aspose.Cells. PHP XLSM na MHT. PHP Zapisz XLSM w MHT. Zapisz XLSM jako MHT przy użyciu PHP.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSM na MHT przez PHP" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSM na MHT? Programiści PHP mogą łatwo załadować i przekonwertować XLSM na MHT w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XLSM na MHT, wywołując metodę zapisu skoroszytu.
