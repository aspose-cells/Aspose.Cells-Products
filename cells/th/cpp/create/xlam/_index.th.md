...
description: Aspose เอ็กเซล. C++ สร้างไฟล์ XLAM อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells สร้างไฟล์ XLAM โดยใช้ C++ สร้าง XLAM ใน C++ C++ XLAM Creater
...
1.  บันทึกสมุดงานเป็นไฟล์ .xlam โดยใช้เมธอด Save()
