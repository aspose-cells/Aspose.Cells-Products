...
{{% blocks/products/pf/agp/content h2="Sla FODS op in FODS in Java" %}}

Het volgende voorbeeld laat zien hoe je FODS omzet naar FODS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik FODS om naar FODS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie FODS programmatisch converteren naar FODS? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig converteren naar FODS met slechts een paar regels code.
