...
weight: 9280
description: รหัสตัวอย่าง C++ เพื่อค้นหาคำที่มีรูปแบบในไฟล์ XLSM บน C++ Runtime Environment สำหรับ Windows 32 บิต, Windows 64 บิต และ Linux 64 บิต
---
...
โหลดไฟล์ XLSM โดยสร้างอินสแตนซ์ของคลาส IWorkbook
