---
title: 透過 C++ 將箭頭插入 Excel 中
weight: 770
description: C++ 在 Windows 32 位元、Windows 64 位元和 Linux 64 位元的 C++ 執行時間環境中在 Excel 檔案中插入區塊箭頭的範例程式碼。
keywords: [C++ Aspose.Cells., C++ add block arrows., C++ insert block arrows., C++ create block arrows]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="透過 C++ 將箭頭插入 Excel 中" h2="使用伺服器端的本機高效能插入物件 Aspose.Cells for C++ API，無需使用任何軟體，例如 Microsoft 或 Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 將箭頭插入 Excel 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C++ 將區塊箭頭插入 Excel 檔案的步驟" %}}

實例化一個 Workbook 物件。（或->載入 XLSX 檔案的完整路徑。）
+ 透過索引選擇工作表。
 + 使用[添加方法](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addautoshape/)在選定的工作表中插入區塊箭頭類型概述
以 XLSX 格式儲存工作簿。
...
下面的範例程式碼示範如何插入「右箭頭」。更多類型請參考下面的「方塊箭頭類型概述」。

{{% /blocks/products/pf/agp/text %}}

{{% blocks/products/pf/agp/code-block title="插入箭頭塊 - C++" offSpacer="" %}}
...
區塊箭頭類型概述
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
自選圖形類型::<br>AutoShapeType_RightArrow
    </p>
   </div>
   <div class="col-lg-4">
