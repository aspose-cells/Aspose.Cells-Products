---
title:  XLS belgesi via Java'den metin ve resimleri ayıklayın
weight: 3700
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Çalışma Zamanı Ortamı üzerindeki XLS dosyasından metin ve görüntüleri ayıklamak için Java örnek kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLS Biçimlerini Java\'de ayrıştırın" h2="Microsoft veya Adobe PDF gibi herhangi bir yazılım kullanmadan, sunucu tarafı Aspose.Cells for Java API\'leri kullanılarak yerel ve yüksek performanslı XLS belge ayrıştırma." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="XLS Dosyasını Java Kullanarak Ayrıştırma" %}}
...
{{% blocks/products/pf/agp/code-block title="Ayrıştırma XLS Dosyalar - Java" offSpacer="" %}}
