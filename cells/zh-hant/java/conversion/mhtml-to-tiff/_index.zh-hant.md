...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 MHTML 轉換為 TIFF" %}}

 為了將 MHTML 呈現為 TIFF，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 MHTML 轉換為 TIFF 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 Java 開發人員只需幾行代碼即可輕鬆地將 MHTML 文件轉換為 TIFF。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Workbook 實例加載 MHTML 文件1. 從集合中選擇默認或任何工作表1. 創建和設置 ImageOrPrintOptions 的對象1. 使用 Worksheet 和 ImageOrPrintOptions 對象創建 SheetRender1. 調用 SheetRender.toImage 方法以 TIFF 格式保存結果
...
{{% blocks/products/pf/agp/code-block title="MHTML 到 TIFF Java 轉換源代碼" offSpacer="" %}}
