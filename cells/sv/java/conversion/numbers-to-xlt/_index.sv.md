---
title: Konvertera NUMBERS till XLT via Java 

description: Exempel på Java-konverteringskod för NUMBERS-format till XLT-fil. Programmerare kan använda den här exempelkoden för att exportera Excel- och OpenOffice-kalkylblad till XLT inom alla webb- eller skrivbordsbaserade Java-applikationer.
---
...
{{% blocks/products/pf/agp/content h2="Hur man konverterar TAL till XLT med Java" %}}

 För att rendera NUMBERS till XLT kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera NUMBERS till XLT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera NUMBERS-filen till XLT på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda NUMBERS-filen med en instans av Workbook-klassen1. Ring Workbook.save-metoden1. Passera utdatasökväg med XLT-tillägg och SaveFormat som parametrar1. Kontrollera den angivna sökvägen för den resulterande XLT-filen
...
{{% blocks/products/pf/agp/code-block title="NUMBERS till XLT Java omvandlingskällkod" offSpacer="" %}}

```cs
// ladda NUMBERS-filen i en instans av Workbook
Workbook book = new Workbook("template.numbers");
// spara NUMBERS som XLT
...
{{< blocks/products/pf/agp/demobox sectionTitle="NUMBERS till XLT Live Demos" sectionDescription="[Konvertera NUMBERS till XLT](https://products.aspose.app/cells/conversion/numbers-to-xlt) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din NUMBERS-fil, den konverteras omedelbart till XLT." >}}
