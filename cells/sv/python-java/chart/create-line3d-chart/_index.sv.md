...
description: Python Exempelkod för att skapa 3D-linjediagram till Excel med Python Library. Använd den här koden för att skapa ett 3D-linjediagram till MS Excel inom Python-baserad applikation.
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 Det är enkelt att skapa 3D-linjediagram dynamiskt i ett program som körs. För att skapa olika diagram till kalkylblad från grunden utan att behöva MS Office, kommer vi att använda[Aspose.Cells for Python](https://pypi.org/project/aspose.cells) API som erbjuder olika funktioner för att skapa, manipulera och konvertera kalkylark på Python-plattformen. Aspose.Cells tillhandahåller många flexibla sjökortsobjekt.
{{% /blocks/products/pf/agp/content %}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="Hur man skapar 3D-linjediagram via Python" %}}
...
1. Lägg till ett 3D-linjediagram till kalkylbladet
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="Följande källkod visar hur man skapar ett 3D-linjediagram till MS Excel XLSX-fil med Python." offSpacer="" %}}
