---
title: Convert XLSX to  PDF/A Complied Files via Java 
weight: 3200
url: /java/conversion/xlsx-to-pdf-a/ 
description: Sample Java conversion code for XLSX format to  PDF A Complied Files. Programmers can use this example code to export Excel & OpenOffice spreadsheets to  PDFA Complied Files within any Web or Desktop Java based Application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XLSX to PDF/A via Java" h2="XLSX to PDF/A Java conversion to convert single or multiple pages to PDF/A using On-premise Java library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF/A" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF/A" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert XLSX to PDF/A Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XLSX to PDF/A via Java" %}}
...
1.  Create PdfSaveOptions class object
1.  Set the compliance type PdfCompliance.PdfA1b
1.  Call Workbook.save method
1.  Pass output path with PDF extension & PdfSaveOptions object as parameters
1.  Check specified path for resultant PDF/A file
...
{{% blocks/products/pf/agp/code-block title="XLSX to PDF/A Java Conversion Source Code" offSpacer="" %}}
