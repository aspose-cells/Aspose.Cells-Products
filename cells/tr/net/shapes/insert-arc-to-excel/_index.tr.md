...
weight: 337
description: C# .NET Kitaplığı'nı kullanarak Excel'e yay şekli eklemek veya eklemek için örnek kod. VB.NET, Asp.NET veya .NET tabanlı herhangi bir uygulama içinde MS Excel'de yay şekli oluşturmak için bu kodu kullanın.
keywords: [C# Aspose.Cells., c# add arc shape., c# insert arc shape., c# create arc shape]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Arc\'ı Excel\'e Ekle via .NET" h2="Arc\'ı Aspose.Cells\' API\'i kullanarak, Microsoft veya Open Office, Adobe PDF vb. herhangi bir yazılım olmadan ekleyin." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
+ Dizini aracılığıyla Çalışma Sayfasını seçin.
 + Kullan[yöntem ekle](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/methods/addArc) seçilen çalışma sayfasına bir Yay eklemek için
