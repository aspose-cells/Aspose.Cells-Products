---
title: C# JPG en SVG - Convertisseur JPG en SVG
description: Aspose Exceller. Convertissez JPG en SVG rapidement et facilement avec Aspose.Cells. C# JPG en SVG. C# Enregistrez JPG en SVG. Enregistrez JPG sous SVG en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer JPG au SVG dans C#" %}}

L'exemple suivant montre comment convertir JPG en SVG en C#.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir JPG en SVG. Téléchargez votre fichier JPG, puis enregistrez-le simplement sous le nom de fichier SVG. Pour la lecture JPG et l'écriture SVG, vous pouvez utiliser des noms de fichiers complets. Le contenu et le formatage de la sortie SVG seront identiques au document JPG d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Exemple de code pour convertir JPG en SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="jpg" outformat="svg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir JPG en SVG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers JPG en SVG par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en SVG en quelques lignes de code.
...
1.  Convertissez JPG en SVG en appelant la méthode Workbook.Save.
1.  Obtenez le résultat de la conversion de JPG en SVG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour convertir JPG en SVG" %}}
