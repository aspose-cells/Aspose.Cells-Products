...
{{% blocks/products/pf/agp/content h2="Сохраните значение HTML в электронную таблицу Java." %}}

Следующий пример демонстрирует, как преобразовать HTML в формат SPREADSHEETML в файле Java.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать HTML в формат SPREADSHEETML via Java" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы HTML в SPREADSHEETML? Разработчики, работающие с файлами Java, могут легко преобразовать файлы HTML в SPREADSHEETML всего за несколько строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для преобразования HTML в формат SPREADSHEETML." %}}
{{% blocks/products/pf/agp/text %}}
