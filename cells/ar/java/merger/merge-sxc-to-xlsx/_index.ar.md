---
title:  ادمج SXC إلى XLSX via Java
...
يوضح المثال التالي كيفية دمج SXC مع XLSX في Java.
...
{{% cells-merger title="تطبيق مجاني لدمج SXC إلى XLSX عبر الإنترنت" InputFormat="sxc" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
