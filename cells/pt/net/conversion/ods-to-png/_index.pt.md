---
title: C# ODS a PNG - ODS a PNG Conversor
description: Aspose Excel. Esta solução abrangente fornece aos desenvolvedores C# uma abordagem totalmente integrada para converter ODS para o formato PNG, permitindo o salvamento perfeito de dados ODS no formato PNG usando a biblioteca Aspose.Cells, tudo por meio de código C# eficiente e personalizável.
...
{{% blocks/products/pf/agp/content h2="Salve ODS a PNG em C#" %}}

exemplo a seguir demonstra como converter ODS em PNG em C#.
...
{{% blocks/products/pf/agp/content h2="Como converter ODS em PNG por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos ODS em PNG programaticamente? Os desenvolvedores do .NET podem facilmente carregar e converter ODS em PNG em apenas algumas linhas de código.
...
1.  Converta ODS para PNG chamando o método Workbook.Save.
1.  Obtenha o resultado da conversão de ODS para PNG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C# para converter ODS em PNG" %}}
