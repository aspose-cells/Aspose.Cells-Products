---
title: ดูรูปแบบไฟล์ XLSM ผ่าน .NET 
weight: 9980
url: /th/net/viewer/xlsm/ 
description: C# ซอร์สโค้ดสำหรับการโหลด แสดงผล และแสดงเอกสาร XLSM บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="โปรแกรมดูไฟล์ XLSM for .NET" h2="ดูสเปรดชีต Excel และ OpenOffice เช่น XLSM โดยไม่ต้องใช้ Microsoft Excel หรือ Office Automation" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSM" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการดู XLSM ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells ทำให้นักพัฒนาสามารถดูไฟล์ XLSM ได้ง่ายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ XLSM ในอินสแตนซ์ของ Workbook1. สร้างอินสแตนซ์ของ HtmlSaveOptions & ตั้งค่าคุณสมบัติ ExportHeadings เป็น true1. บันทึกไฟล์ XLSM ในรูปแบบ HTML โดยใช้ Workbook.Save method1. โหลด HTML ที่เป็นผลลัพธ์ในเบราว์เซอร์เริ่มต้นด้วย Process.Start
...
{{% blocks/products/pf/agp/code-block title="C# ตัวอย่างโค้ดเพื่อดูไฟล์ XLSM" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API สามารถใช้เพื่อสร้าง แก้ไข แปลง และแสดงรูปแบบ Microsoft Excel เป็นรูปแบบต่างๆ นอกจากนี้ยังสามารถใช้สำหรับการสร้างแผนภูมิที่ครอบคลุม การรายงานที่ปรับขนาดได้ และการคำนวณที่เชื่อถือได้ภายในแอปพลิเคชันซอฟต์แวร์ Aspose.Cells เป็นแบบสแตนด์อโลน API และไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ OpenOffice  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="แอพฟรีเพื่อดู XLSM" sectionDescription="ตรวจสอบการสาธิตสดของเราที่ [ดู XLSM](https://products.aspose.app/cells/viewer/xlsm) พร้อมสิทธิประโยชน์ดังต่อไปนี้" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" ดาวน์โหลดไฟล์ XLSM จากลิงค์ ถ้าจำเป็น" >}}
