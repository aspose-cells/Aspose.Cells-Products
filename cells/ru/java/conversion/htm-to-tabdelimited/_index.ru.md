...
{{% blocks/products/pf/agp/content h2="Преобразовать HTM в TABDELIMITED, используя код Java." %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните HTM в TABDELIMITED по номеру Java" %}}

Следующий пример демонстрирует, как преобразовать HTM в TABDELIMITED в коде Java.
...
Нужно программно преобразовать HTML-файлы в формат TABDELIMITED? Разработчики, использующие код Java, могут легко преобразовать HTML в TABDELIMITED всего за несколько строк кода.
...
{{% blocks/products/pf/agp/content h2="Библиотека Java для преобразования HTM в TABDELIMITED" %}}
{{% blocks/products/pf/agp/text %}}
