...
The following example demonstrates how to convert TABDELIMITED to XLSB document format in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert TABDELIMITED file into XLSB format. Upload your TABDELIMITED file, then simply save it as XLSB file. For both TABDELIMITED reading and XLSB writing you can use fully qualified filenames. The output XLSB content and formatting will be identical to the original TABDELIMITED document.
