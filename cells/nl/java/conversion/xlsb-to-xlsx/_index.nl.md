...
{{% blocks/products/pf/agp/content h2="Sla XLSB op in XLSX in Java" %}}

Het volgende voorbeeld laat zien hoe je XLSB omzet naar XLSX in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLSB om naar XLSX of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLSB programmatisch converteren naar XLSX? Ontwikkelaars van Java kunnen bestanden met de extensie XLSB eenvoudig converteren naar XLSX met slechts een paar regels code.
