...
weight: 3680
url: /vi/cpp/unlock/xlsx/ 
description: C++ mã ví dụ để mở khóa tệp XLSX được bảo vệ bằng mật khẩu trên C++ Môi trường thời gian chạy cho Windows 32 bit, Windows 64 bit và Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mở khóa tệp XLSX qua C++" h2="Xóa bảo vệ khỏi bảng tính Excel bao gồm cả tệp XLSX bằng cách sử dụng C++ Thư viện." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách xóa bảo vệ tệp XLSX bằng cách sử dụng C++" %}}
...
1. Tải tệp bị khóa XLSX bằng CreateIWorkbook.1. Gọi hàm Unprotect () để mở khóa.1. Đặt mật khẩu thành NULL bằng SetPassword.1. Lưu tệp XLSX tại một vị trí được chỉ định.
