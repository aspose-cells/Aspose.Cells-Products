...
description: Aspose Exceller. Convertissez XLSM en JPG rapidement et facilement avec Aspose.Cells. Python XLSM en JPG. Python Enregistrez XLSM au format JPG. Enregistrez XLSM au format JPG en utilisant Python.
...
{{% blocks/products/pf/agp/content h2="Convertir XLSM en JPG en utilisant Python" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer XLSM au format JPG dans Python" %}}

L'exemple suivant montre comment convertir XLSM en JPG en Python.
...
{{% blocks/products/pf/agp/content h2="Bibliothèque Python pour convertir XLSM en JPG" %}}
