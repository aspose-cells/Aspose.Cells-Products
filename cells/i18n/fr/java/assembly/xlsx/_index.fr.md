---
title: Générer des rapports dans des fichiers XLSX via Java 
weight: 7710
url: /fr/java/assembly/xlsx/ 
description: Java exemple de code pour créer des rapports au format XLSX sur Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Génération de rapports en masse au format XLSX via Java" h2="Générez des rapports au format XLSX à l\'aide d\'une source de données et d\'un modèle." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment générer des rapports XLSX à l\'aide de Java" %}}

 Afin de créer des rapports de fichiers XLSX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour générer des rapports XLSX via Java" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. Instancier la classe WorkbookDesigner1. Ajouter des objets Datasource dans une ArrayList1. Définir la source de données et le processus pour l'objet WorkbookDesigner1. Enregistrer le résultat au format XLSX via la méthode Worbook.save
...
{{% blocks/products/pf/agp/code-block title="Générer des rapports Excel au format XLSX - C#" offSpacer="" %}}
