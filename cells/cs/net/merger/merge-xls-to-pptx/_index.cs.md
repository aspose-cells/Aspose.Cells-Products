...
url: /cs/net/merger/merge-xls-to-pptx/ 
...
Následující příklad ukazuje, jak sloučit XLS až PPTX v Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit XLS až PPTX? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET ke sloučení XLS až PPTX" %}}
