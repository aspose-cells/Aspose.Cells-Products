---
title:  Chèn TextBox vào Excel qua Python
weight: 10
description: Python mã nguồn chèn TextBox vào Excel.
---
...
{{% blocks/products/pf/agp/content h2="Cách Chèn TextBox Vào File Excel Bằng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn TextBox vào file Excel qua Python" %}}
...
+ Sử dụng phương thức add của shapecollection để chèn TextBox vào bảng tính đã chọn.
...
{{% blocks/products/pf/agp/code-block title="Chèn TextBox - Python" offSpacer="" %}}
