...
Het volgende voorbeeld laat zien hoe u XLSM converteert naar XLS in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Hoe XLSM naar XLS te converteren" %}}
