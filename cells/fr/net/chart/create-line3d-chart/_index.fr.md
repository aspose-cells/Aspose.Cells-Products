---
title: Créez des graphiques linéaires 3D via C#
description: C# Exemple de code pour créer des graphiques linéaires 3D vers Excel à l'aide de la bibliothèque .NET. Utilisez ce code pour créer un graphique linéaire 3D sur MS Excel dans VB.NET, Asp.NET ou toute application basée sur .NET.
...
{{< blocks/products/pf/i18n/upper-banner h1="Créez des graphiques linéaires 3D via C#" h2="Création de graphiques MS Excel natifs et hautes performances par programmation à l\'aide des API .NET côté serveur." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Comment créer des graphiques linéaires 3D via C#" %}}
...
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/code-block title="Le code source suivant montre comment créer un graphique linéaire 3D dans un fichier MS Excel XLSX à l\'aide de C#." offSpacer="" %}}
