...
{{% blocks/products/pf/agp/content h2="C++을 사용하여 XLSX 메타데이터를 가져오는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++를 통해 XLSX의 메타데이터를 추출하는 단계" %}}
...
+ CreateIWorkbookMetadata를 사용하여 XLSX 파일 로드
...
{{% blocks/products/pf/agp/code-block title="XLSX의 메타데이터 추출 - C++" offSpacer="" %}}
