---
title: Convertir TSV en JPG via l'application C++ 
url: /fr/cpp/conversion/tsv-to-jpg/ 
description: Exemple de code de conversion C++ pour le document TSV au format JPG. Les programmeurs peuvent utiliser ce code source pour la conversion par lots de TSV en JPG dans n'importe quelle application C++.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir TSV en JPG via C++" h2="Conversion TSV en JPG haute performance à l\'aide de la bibliothèque C++ sans avoir besoin de l\'installation de Microsoft Excel, OpenOffice ou Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs C++ peuvent facilement convertir un fichier TSV en JPG en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Chargez le fichier TSV à l'aide de Factory :: CreateIWorkbook.1. Appelez la méthode Save().1. Transmettez le chemin du fichier de sortie avec l'extension de fichier (JPG).1. Le fichier JPG sera enregistré dans le chemin spécifié.1. Ouvrez le fichier JPG dans un programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion TSV en JPG C++" offSpacer="" %}}
