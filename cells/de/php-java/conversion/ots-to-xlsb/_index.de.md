...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in XLSB mit Aspose.Cells. PHP OTS in XLSB. PHP Speichern Sie OTS in XLSB. Speichern Sie OTS mit PHP als XLSB.
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über PHP in XLSB" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in XLSB konvertieren? PHP-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in XLSB konvertieren.
...
1.  Konvertieren Sie OTS in XLSB, indem Sie die Save-Methode von Workbook aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in XLSB.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="PHP-Bibliothek zum Konvertieren von OTS in XLSB" %}}
