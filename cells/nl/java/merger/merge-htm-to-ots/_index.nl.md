---
title: Voeg HTM samen met OTS - Combineer HTM met OTS in Java
url: /nl/java/merger/merge-htm-to-ots/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online HTM samenvoegen naar OTS-opslagformaat. Java Combineer HTM naar OTS formaat. Voeg HTM samen met OTS in Java. HTM samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg HTM gratis samen met OTS in Java Online" %}}

Het volgende voorbeeld laat zien hoe u HTM kunt samenvoegen met OTS in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTM samen te voegen met OTS. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het OTS-bestand. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat HTM samenvoegt met OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om HTM samen te voegen met OTS in Java" InputFormat="htm" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="HTM samenvoegen met OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTM programmatisch samenvoegen met OTS? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om HTM samen te voegen met OTS" %}}
