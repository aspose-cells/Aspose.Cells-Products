...
description: Aspose Excel. Esta solución integral proporciona a los desarrolladores de C# un enfoque totalmente integrado para convertir HTML a formato HTM, lo que permite guardar sin problemas los datos de HTML en formato HTM mediante la biblioteca Aspose.Cells, todo mediante código C# eficiente y personalizable.
...
{{% blocks/products/pf/agp/content h2="Guardar HTML en HTM en C#" %}}

El siguiente ejemplo demuestra cómo convertir HTML a HTM en C#.
{{% blocks/products/pf/agp/text %}}

Sigue estos sencillos pasos para convertir HTML a HTM. Sube tu archivo HTML y guárdalo como HTM. Puedes usar nombres de archivo completos tanto para leer como para escribir en HTM. El contenido y el formato HTM de salida serán idénticos al documento HTML original.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Código de ejemplo para convertir HTML a HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="html" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir HTML a HTM mediante C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesitas convertir archivos HTML a HTM mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente archivos HTML a HTM con solo unas pocas líneas de código.
