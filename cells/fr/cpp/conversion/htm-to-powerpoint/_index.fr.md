...
Besoin de convertir des fichiers HTM en POWERPOINT par programmation ? Les développeurs de C++ peuvent facilement convertir des fichiers HTM en POWERPOINT en quelques lignes de code seulement.
...
1.  Convertissez le format HTM en POWERPOINT en appelant la méthode Save().
