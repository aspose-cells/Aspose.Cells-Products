...
description: Aspose Excel. Java Aspose.Cells. Unione online gratuita da ODS a CSV saveformat. Java Combina il formato ODS con CSV. Unisci ODS a CSV in Java. ODS Unisci.
...
L'esempio seguente mostra come unire ODS a CSV in Aspose.Cells for Java.
...
{{% cells-merger title="Online gratuito per unire ODS a CSV in Java" InputFormat="ods" InputFormat2="csv" outformat="csv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Come unire ODS a CSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire ODS a CSV a livello di codice? Un documento di base che si fonde e si concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Le API possono essere eseguite con poche righe di codice.
