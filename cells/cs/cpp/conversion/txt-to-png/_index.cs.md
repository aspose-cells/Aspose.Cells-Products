...
{{% blocks/products/pf/agp/content h2="Jak převést TXT na PNG pomocí C++" %}}

 převodu TXT na PNG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TXT na PNG přes C++" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři C++ mohou snadno převést soubor TXT na PNG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TXT pomocí Factory::CreateIWorkbook.1. Vyberte první list.1. Nastavit možnosti (PNG).1. Iterujte každou stránku listu a vykreslete.1. Otevřete soubor PNG v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu TXT na PNG C++" offSpacer="" %}}
