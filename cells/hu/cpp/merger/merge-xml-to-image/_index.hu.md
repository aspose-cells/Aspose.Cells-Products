...
url: /hu/cpp/merger/merge-xml-to-image/ 
...
A következő példa bemutatja, hogyan lehet XML-t egyesíteni az IMAGE-val a Aspose.Cells for C++-ben.
...
Programozottan egyesítenie kell az XML-t az IMAGE-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2="C++ könyvtár az XML és az IMAGE egyesítéséhez" %}}
