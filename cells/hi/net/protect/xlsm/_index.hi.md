---
title:  XLSM दस्तावेज़ via .NET को सुरक्षित रखें और लॉक करें
weight: 7530
description: .NET फ्रेमवर्क, .NET कोर, Mono या ज़ामरिन प्लेटफ़ॉर्म पर पासवर्ड का उपयोग करके XLSM फ़ाइल को लॉक करने के लिए C# स्रोत कोड।
...
1.  XLSM फ़ाइल के पथ के साथ वर्कबुक क्लास को त्वरित करें
