...
description: Aspose Эксель. Python Эксель. Объедините файлы SXC и XLT в формате сохранения. Python Объедините форматы SXC и XLT. Объедините числа SXC и XLT в библиотеке Excel Python. SXC Слияние.
...
{{% blocks/products/pf/agp/content h2="Объедините числа SXC и XLT с помощью библиотеки Excel Python." %}}
...
{{% blocks/products/pf/agp/content h2="Объединить числа SXC и XLT в библиотеке Excel Python." %}}

В следующем примере показано, как объединить SXC с XLT в Aspose.Cells for Python via Java.
...
{{% cells-merger title="Пример кода для объединения чисел SXC и XLT в библиотеке Excel Python" InputFormat="sxc" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Как объединить SXC с XLT через библиотеку Excel Python" %}}
