---
title: Python XLS a WORD-hoz – Online XLS a WORD konverterhez
description: Aspose Excel. Python Aspose.Cells. Python Aspose Cells. Ingyenes online Python A XLS konvertálása WORD mentési formátumba. Python XLS WORD formátumba. Mentse el a XLS számot a Python WORD-ba.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konvertálja a XLS-et WORD-ra a Python-ben" h2="Nagysebességű Python-es könyvtár a XLS-es szám WORD-ba konvertálásához. Ez egy professzionális szoftvermegoldás a XLS, a WORD és sok más formátum importálásához és exportálásához a Python használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="A XLS konvertálása WORD-ra a Python-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

A XLS fájlt programozottan WORD-ba kell konvertálni? A Python fejlesztők egyszerűen betölthetik és konvertálhatják a XLS-et WORD-ra, mindössze néhány sornyi kóddal.
...
1.  Konvertálja a XLS-et WORD-ra a Workbook.save metódus meghívásával.
1.  Szerezze meg a XLS konvertálási eredményt WORD-ra.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python könyvtár a XLS konvertálásához WORD-ba" %}}
