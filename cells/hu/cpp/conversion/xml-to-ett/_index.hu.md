...
description: Aspose Excel. A Aspose.Cells segítségével gyorsan és egyszerűen konvertálhat XML-t ETT-vé. C++ XML-t ETT-vé. C++ XML mentése az ETT-be. Mentse az XML-t ETT-ként a C++ használatával.
...
{{% blocks/products/pf/agp/content h2="Konvertálja az XML-t ETT-vé a C++ használatával" %}}
...
{{% blocks/products/pf/agp/content h2="Mentse az XML-t az ETT-be a C++ számon" %}}

A következő példa bemutatja, hogyan lehet XML-t ETT-vé konvertálni a C++-ben.
...
1.  Konvertálja az XML-t ETT-vé a Save() metódus meghívásával.
1.  Szerezze meg az XML konvertálási eredményét ETT-vé.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C++ könyvtár az XML ETT-vé konvertálásához" %}}
