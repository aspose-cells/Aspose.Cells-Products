...
{{% blocks/products/pf/agp/content h2="Javaを使用してXLSファイルにウォーターマークを付ける方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Javaを介して透かしをXLSに追加する手順" %}}

{{% blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/text %}}

1. 新しいWorkbookオブジェクトを作成します1. インデックスからワークシートを選択1. シェイプを作成し、そのaddTextEffect関数を使用します1. 色、透明度などを設定します1. ブックをXLS形式で保存する
...
{{% blocks/products/pf/agp/code-block title="XLSに透かしを追加-Java" offSpacer="" %}}
