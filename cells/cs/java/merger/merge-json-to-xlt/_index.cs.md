---
title:  Sloučit JSON až XLT via Java
...
Následující příklad ukazuje, jak sloučit JSON až XLT v Java.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení JSON až XLT online" InputFormat="json" InputFormat2="xlt" outformat="xlt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="java" %}}
