...
description: Aspose Excel. Python Aspose.Cells. Gratis online samenvoegen XLT naar PRN-opslagformaat. Python Combineer XLT naar PRN-formaat. Samenvoegen XLT naar PRN in Python. XLT Samenvoegen.
...
{{% blocks/products/pf/agp/content h2="Voeg XLT samen met PRN met behulp van Python" %}}
...
{{% blocks/products/pf/agp/content h2="Voeg gratis XLT samen met PRN in Python online" %}}

Het volgende voorbeeld laat zien hoe u XLT kunt samenvoegen met PRN in Aspose.Cells for Python via .NET.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om XLT samen te voegen met PRN. Upload uw bestanden, bel de methode Workbook.Combine voor het samenvoegen van bestanden en sla deze vervolgens op in het PRN-bestand. Als u code ontwikkelt in Python, is dit eenvoudiger dan het klinkt. Zie voorbeeld Python dat XLT samenvoegt met PRN.
...
{{% blocks/products/pf/agp/content h2="Hoe XLT samen te voegen met PRN via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Wilt u XLT programmatisch samenvoegen met PRN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen worden gedaan met slechts enkele regels code.
