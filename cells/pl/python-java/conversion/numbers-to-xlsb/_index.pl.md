---
title: Konwertuj NUMBERS na XLSB przez Python
url: /pl/python-java/conversion/numbers-to-xlsb/
description: Przykładowy kod konwersji liczb do formatu xlsb Python. Użyj przykładowego kodu API dla plików numerów partii do konwersji xlsb w aplikacji Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj NUMBERS na XLSB przez Python" h2="Eksportuj arkusze kalkulacyjne Excel® do formatu XLSB przy użyciu Python interfejsów API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować NUMBERS na XLSB za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować NUMBERS na XLSB za pomocą Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programiści mogą łatwo ładować i konwertować pliki NUMBERS na XLSB w zaledwie kilku linijkach kodu.
