---
title: HTM samenvoegen naar MARKDOWN - HTM combineren naar MARKDOWN in Java
url: /nl/java/merger/merge-htm-to-markdown/ 
description: Aspose Excel. Java Aspose.Cells. Gratis online HTM samenvoegen naar MARKDOWN opslagformaat. Java Combineer HTM naar formaat MARKDOWN. HTM samenvoegen naar MARKDOWN in Java. HTM samenvoegen.
...
{{% blocks/products/pf/agp/content h2="HTM samenvoegen naar MARKDOWN in Java Online gratis" %}}

Het volgende voorbeeld laat zien hoe u HTM samenvoegt met MARKDOWN in Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Volg de eenvoudige stappen om HTM samen te voegen tot MARKDOWN. Upload uw bestanden, roep de methode Workbook.Combine voor het samenvoegen van bestanden aan en sla deze vervolgens op in het bestand MARKDOWN. Als u code ontwikkelt in Java, is dit eenvoudiger dan het klinkt. Zie voorbeeld Java dat HTM samenvoegt tot MARKDOWN.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online om HTM samen te voegen met MARKDOWN in Java" InputFormat="htm" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="HTM samenvoegen tot MARKDOWN via Java" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u HTM programmatisch samenvoegen met MARKDOWN? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Java](https://products.aspose.com/cells/java) API's kunnen worden gedaan met slechts enkele regels code.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om HTM samen te voegen tot MARKDOWN" %}}
