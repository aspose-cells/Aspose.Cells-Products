---
title:  Hợp nhất XLTM Tệp via Java
weight: 8210
description: Mã mẫu Java để kết hợp các tài liệu XLTM trên Java Môi trường thời gian chạy cho ứng dụng JSP/JSF và ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các định dạng XLTM trong Java" h2="Hợp nhất tài liệu gốc XLTM bằng cách sử dụng API Java phía máy chủ." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất các tệp XLTM bằng Java" %}}

 Để hợp nhất tệp XLTM, chúng tôi sẽ sử dụng[Aspose.Cells for Java](https://products.aspose.com/cells/java) API là một nền tảng sáp nhập giàu tính năng, mạnh mẽ và dễ sử dụng API for Java. Bạn có thể tải xuống phiên bản mới nhất của nó trực tiếp từ[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) và cài đặt nó trong dự án dựa trên Maven của bạn bằng cách thêm các cấu hình sau vào pom.xml.
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước gộp file XLTM vào Java" %}}
...
+ Tải file XLTM đầu tiên với instance của lớp Workbook.
+ Tải tài liệu XLTM thứ hai với một thể hiện của lớp Workbook.
+ Gộp file bằng phương thức Combine().
+ lưu file XLTM đã merge vào đường dẫn xác định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất các tập tin XLTM - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Trực tuyến XLTM Sáp nhập Demo trực tiếp" sectionDescription=" Hợp nhất tài liệu XLTM ngay bây giờ bằng cách truy cập của chúng tôi[Trang web demo trực tiếp](https://products.aspose.app/cells/merger). Bản demo trực tiếp có những lợi ích sau" >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải Aspose API." >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Chỉ cần tải lên tệp XLTM của bạn." >}}
