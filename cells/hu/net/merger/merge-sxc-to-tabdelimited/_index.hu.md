---
title: A SXC egyesítése a TABDELIMITED számmal – a SXC és a TABDELIMITED egyesítése a C#-ben
url: /hu/net/merger/merge-sxc-to-tabdelimited/ 
description: Aspose Excel. C# Aspose.Cells. Ingyenes online egyesítés SXC TABDELIMITED mentési formátumba. C# A SXC kombinálása TABDELIMITED formátumba. A SXC egyesítése a TABDELIMITED-hez a C#-ben. SXC Egyesítés.
...
{{% blocks/products/pf/agp/content h2="Csatlakoztassa a SXC-et a TABDELIMITED-hez a C#-ben online ingyen" %}}

A következő példa bemutatja, hogyan lehet egyesíteni a SXC-et a TABDELIMITED-szel a Aspose.Cells-es for .NET-ben.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a SXC és a TABDELIMITED egyesítéséhez. Töltse fel fájljait, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a TABDELIMITED fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C# példát, amely egyesíti a SXC-et a TABDELIMITED-be.
...
{{% blocks/products/pf/agp/content h2="A SXC és a TABDELIMITED egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a SXC-et a TABDELIMITED-el? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a SXC a TAB-ba egyesítéséhezDELIMITED" %}}
