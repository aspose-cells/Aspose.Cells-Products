---
title: Mesclar XLSB para OTS - Combine XLSB para OTS em Java
url: /pt/java/merger/merge-xlsb-to-ots/ 
description: Aspose Excel. Java Aspose.Cells. Mesclagem on-line gratuita XLSB para OTS saveformat. Java Combine XLSB para o formato OTS. Mesclar XLSB para OTS em Java. XLSB Mesclar.
...
{{% blocks/products/pf/agp/content h2="Mesclar XLSB para OTS em Java online gratuitamente" %}}

O exemplo a seguir demonstra como mesclar XLSB com OTS em Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga as etapas fáceis para mesclar XLSB com OTS. Carregue seus arquivos, chame o método Workbook.Combine para mesclar arquivos e salve-o no arquivo OTS. Se você desenvolver código em Java, isso será mais simples do que parece. Consulte o exemplo Java que mescla XLSB com OTS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online grátis para mesclar XLSB para OTS em Java" InputFormat="xlsb" InputFormat2="ots" outformat="ots" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Como mesclar XLSB para OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa mesclar XLSB para OTS programaticamente? Um documento básico mesclando e concatenando com[Aspose.Cells for Java](https://products.aspose.com/cells/java) As APIs podem ser feitas com apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para mesclar XLSB para OTS" %}}
