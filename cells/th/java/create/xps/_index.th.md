...
description: Aspose เก่ง. Java สร้างไฟล์ XPS สร้าง XPS Java Java XPS สร้าง สร้าง XPS ใน Java สร้างไฟล์ XPS โดยใช้ Java
...
1.  บันทึกสมุดงานเป็นรูปแบบ XPS โดยใช้วิธีบันทึก ()
