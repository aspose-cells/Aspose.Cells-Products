...
description: Aspose Excel. C++ Aspose.Cells. Scal XLSM w formacie zapisu POWERPOINT. C++ Połącz XLSM w formacie POWERPOINT. Scal XLSM z POWERPOINT w C++. XLSM Scal.
...
{{% blocks/products/pf/agp/content h2="Scal XLSM z POWERPOINT w C++" %}}

Poniższy przykład pokazuje, jak połączyć XLSM z POWERPOINT w Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć numer XLSM z POWERPOINT. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku POWERPOINT. Jeśli opracujesz kod w C++, będzie to prostsze niż się wydaje. Zobacz przykład C++, który łączy XLSM z POWERPOINT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia XLSM z POWERPOINT w C++" InputFormat="xlsm" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć XLSM z POWERPOINT poprzez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć numer XLSM z POWERPOINT? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka C++ do połączenia XLSM z POWERPOINT" %}}
