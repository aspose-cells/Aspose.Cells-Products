---
title: Объединить XLSM в JPEG - Объединить XLSM в JPEG в C#
url: /ru/net/merger/merge-xlsm-to-jpeg/ 
description: Aspose Excel. C# Aspose.Cells. Бесплатное онлайн объединение XLSM в формат сохранения JPEG. C# Объединить формат XLSM в формат JPEG. Объединить XLSM с JPEG в C#. XLSM Объединить.
...
{{% blocks/products/pf/agp/content h2="Объединить XLSM с JPEG в C# онлайн бесплатно" %}}

В следующем примере показано, как объединить XLSM с JPEG в Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Выполните простые шаги, чтобы объединить XLSM с JPEG. Загрузите свои файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файл JPEG. Если вы разрабатываете код в C#, это будет проще, чем кажется. См. пример C#, в котором XLSM объединяется с JPEG.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Бесплатно онлайн объединить XLSM с JPEG в C#" InputFormat="xlsm" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Как объединить XLSM с JPEG через C#" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить XLSM с JPEG? Базовый документ сливается и объединяется с[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API можно реализовать всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2="библиотека .NET для объединения XLSM с JPEG" %}}
