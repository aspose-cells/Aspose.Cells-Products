...
{{% blocks/products/pf/agp/content h2="Преобразовать FODS в GIF, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в GIF в C#" %}}
...
1.  Преобразуйте значение FODS в GIF, вызвав метод Workbook.Save.
