---
title: C++アプリケーションを介してXLSXをSPREADSHEETMLに変換します 
url: /ja/cpp/conversion/xlsx-to-spreadsheetml/ 
description: XLSXドキュメントからSPREADSHEETML形式へのサンプルC++変換コード。プログラマーは、このソースコードを使用して、任意のC++アプリケーション内でXLSXからSPREADSHEETMLへのバッチ変換を行うことができます。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C++を介してXLSXをSPREADSHEETMLに変換します" h2="Microsoft Excel、OpenOffice、またはAdobe Acrobatをインストールすることなく、C++ライブラリを使用した高性能XLSXからSPREADSHEETMLへの変換。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="SPREADSHEETML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++開発者は、わずか数行のコードでXLSXファイルをSPREADSHEETMLに簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbookを使用してXLSXファイルをロードします。1. Save（）メソッドを呼び出します。1. （SPREADSHEETML）ファイル拡張子を付けて出力ファイルパスを渡します。1. SPREADSHEETMLファイルは指定されたパスに保存されます。1. 互換性のあるプログラムでSPREADSHEETMLファイルを開きます。
...
{{% blocks/products/pf/agp/code-block title="XLSXからSPREADSHEETMLC++への変換ソースコード" offSpacer="" %}}
