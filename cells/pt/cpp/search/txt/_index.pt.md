---
title:  Pesquisar documento TXT sem abrir através de C++
weight: 5090
description: C++ código de exemplo para pesquisar palavras com padrão no arquivo TXT no ambiente de execução C++ para Windows 32 bits, Windows 64 bits e Linux 64 bits.
...
{{< blocks/products/pf/i18n/upper-banner h1="Pesquisar TXT formatos em C++" h2="Pesquisa de documentos nativa e de alto desempenho TXT usando APIs do lado do servidor Aspose.Cells for C++, sem o uso de qualquer software como Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TXT" >}}
...
{{% blocks/products/pf/agp/content h2="Como pesquisar o arquivo TXT usando o código C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passos para pesquisar arquivos TXT em C++" %}}
...
+ Carregar o arquivo TXT usando a classe Workbook.
...
{{< blocks/products/pf/agp/about-file-section >}}
    ...
    {{< blocks/products/pf/agp/demobox sectionTitle="Online TXT Pesquisar Demonstrações ao Vivo" sectionDescription=" Pesquise agora mesmo textos, palavras e frases em documentos com o código TXT, visitando nosso site.[Site de demonstrações ao vivo](https://products.aspose.app/cells/search). A demonstração ao vivo tem os seguintes benefícios" >}}
