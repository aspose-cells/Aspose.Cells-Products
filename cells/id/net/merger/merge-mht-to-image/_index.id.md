...
url: /id/net/merger/merge-mht-to-image/ 
...
Contoh berikut menunjukkan cara menggabungkan MHT ke IMAGE di Aspose.Cells for .NET.
...
Perlu menggabungkan MHT ke IMAGE secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Perpustakaan .NET untuk menggabungkan MHT ke IMAGE" %}}
