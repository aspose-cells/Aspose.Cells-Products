---
title: Java HTML na HTM – Online Převodník HTML na HTM
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Online zdarma Java Převeďte HTML do formátu uložení HTM. Java HTML do formátu HTM. Uložit HTML do HTM Java.
...
{{% blocks/products/pf/agp/content h2="Ušetřete HTML na HTM v Java online zdarma" %}}

Následující příklad ukazuje, jak převést HTML na HTM v Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro převod HTML na HTM. Nahrajte svůj soubor HTML a poté jej jednoduše uložte jako soubor HTM. Pro čtení HTML i zápis HTM můžete použít plně kvalifikované názvy souborů. Výstupní obsah a formátování HTM budou shodné s původním dokumentem HTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod HTML na HTM Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="htm" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak převést HTML na HTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést HTML soubory na HTM programově? Vývojáři Java mohou snadno převést HTML na HTM v několika řádcích kódu.
...
1.  Převeďte HTML na HTM voláním metody Workbook.save.
1.  Získejte výsledek převodu HTML na HTM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna Java pro převod HTML na HTM" %}}
{{% blocks/products/pf/agp/text %}}
