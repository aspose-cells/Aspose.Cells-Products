...
description: Aspose Excel. Konwertuj HTM na FODS szybko i łatwo za pomocą Aspose.Cells. Python HTM na FODS. Python Zapisz HTM na FODS. Zapisz HTM jako FODS, używając Python.
...
{{% blocks/products/pf/agp/content h2="Konwertuj HTM na FODS za pomocą Python" %}}
...
{{% blocks/products/pf/agp/content h2="Zapisz HTM pod numerem FODS w Python" %}}

Poniższy przykład ilustruje sposób konwersji HTM na FODS w Python.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Python do konwersji HTM na FODS" %}}
