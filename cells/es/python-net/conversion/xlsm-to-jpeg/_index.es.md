...
description: Aspose Excel. Convierta XLSM a JPEG rápida y fácilmente con Aspose.Cells. Python XLSM a JPEG. Python Guarde XLSM en JPEG. Guarde XLSM como 07611134 81 usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar XLSM al JPEG en Python" %}}

El siguiente ejemplo demuestra cómo convertir XLSM a JPEG en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir XLSM en JPEG" %}}
