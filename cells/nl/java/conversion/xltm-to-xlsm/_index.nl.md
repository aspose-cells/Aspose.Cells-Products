...
{{% blocks/products/pf/agp/content h2="Sla XLTM op in XLSM in Java" %}}

Het volgende voorbeeld laat zien hoe je XLTM omzet naar XLSM in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLTM om naar XLSM of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLTM programmatisch converteren naar XLSM? Ontwikkelaars van Java kunnen bestanden met de extensie XLTM eenvoudig converteren naar XLSM met slechts een paar regels code.
