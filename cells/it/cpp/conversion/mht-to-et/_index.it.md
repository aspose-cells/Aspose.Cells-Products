...
Hai bisogno di convertire i file MHT in ET tramite codice? Gli sviluppatori di C++ possono facilmente convertire i file MHT in ET in poche righe di codice.
...
1.  Convertire MHT in ET chiamando il metodo Save().
