...
url: /hu/net/merger/merge-xlsb-to-ots/ 
...
A következő példa bemutatja, hogyan lehet egyesíteni a XLSB-et az OTS-szel a Aspose.Cells-es for .NET-ben.
...
Programozottan egyesítenie kell a XLSB-et az OTS-hez? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a XLSB OTS-hez való egyesítéséhez" %}}
