...
url: /cs/python-java/merger/merge-xlsb-to-txt/ 
description: Aspose Excel. Python Excel. Sloučit XLSB do TXT uložit formát. Python Kombinujte formát XLSB až TXT. Sloučit XLSB až TXT v knihovně Excel Python. XLSB Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB do TXT pomocí knihovny Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit XLSB až TXT v Python knihovně Excel" %}}

Následující příklad ukazuje, jak sloučit XLSB až TXT v Aspose.Cells for Python via Java.
...
{{% cells-merger title="Ukázkový kód pro sloučení XLSB až TXT v knihovně Excel Python" InputFormat="xlsb" InputFormat2="txt" outformat="txt" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLSB do TXT přes Python Excel Library" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLSB až TXT? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Python ke sloučení XLSB až TXT" %}}
