---
title: Hợp nhất FODS thành DOCX - Hợp nhất FODS thành DOCX thành C#
url: /vi/net/merger/merge-fods-to-docx/ 
description: Aspose Excel. C# Aspose.Cells. Hợp nhất trực tuyến miễn phí FODS thành DOCX saveformat. C# Kết hợp định dạng FODS thành DOCX. Hợp nhất FODS thành DOCX thành C#. FODS Hợp nhất.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất FODS thành DOCX trong C# Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất FODS thành DOCX trong Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất FODS thành DOCX. Tải các tệp của bạn lên, gọi phương thức Workbook.Combine để hợp nhất các tệp rồi lưu vào tệp DOCX. Nếu bạn phát triển mã trong C#, điều này sẽ đơn giản hơn bạn tưởng. Xem ví dụ C# hợp nhất FODS thành DOCX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Hợp nhất trực tuyến miễn phí FODS thành DOCX trong C#" InputFormat="fods" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất FODS thành DOCX qua C#" %}}
...
{{% blocks/products/pf/agp/content h2=".NET thư viện để hợp nhất FODS thành DOCX" %}}
