...
description: Aspose Excel. Python Aspose.Cells. Sloučit MHT do ETT saveformat. Python Kombinujte formát MHT s ETT. Sloučit MHT do ETT v Python. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT do ETT v Python" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení MHT do ETT v Python" InputFormat="mht" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
