---
title: C++ MHTML až WORD - MHTML až WORD Převodník
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům C++ plně integrovaný přístup k převodu formátu MHTML do formátu WORD, což umožňuje bezproblémové ukládání dat MHTML do formátu WORD pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte MHTML na WORD v C++" h2="Vysoce výkonná konverze z MHTML na WORD s využitím knihovny C++ bez nutnosti instalace Excelu, OpenOffice nebo Adobe Acrobatu Microsoft." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="WORD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte MHTML na WORD v C++" %}}

Následující příklad ukazuje, jak převést číslo MHTML na WORD v kódu C++.
...
Potřebujete programově převést soubory MHTML na WORD? Vývojáři C++ mohou snadno převést MHTML na WORD pomocí několika řádků kódu.
...
1.  Převeďte číslo MHTML na WORD voláním metody Save().
