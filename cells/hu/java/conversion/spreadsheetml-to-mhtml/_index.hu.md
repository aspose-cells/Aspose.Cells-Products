---
title: "SPREADSHEETML konvertálása MHTML-re a következőn keresztül: Java "

description: Minta Java konverziós kód SPREADSHEETML formátumhoz MHTML fájlba. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására MHTML-be bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SPREADSHEETML konvertálása MHTML-re a következőn keresztül: Java" h2="A SPREADSHEETML-ből MHTML-re Java konvertálhat egyetlen vagy több oldalt MHTML-re a Helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="A SPREADSHEETML konvertálása MHTML-re a következővel: Java" %}}

 Ahhoz, hogy a SPREADSHEETML-t MHTML-be rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A SPREADSHEETML konvertálása MHTML-re a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java fejlesztői könnyedén konvertálhatják a SPREADSHEETML fájlt MHTML-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be a SPREADSHEETML-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat MHTML kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott MHTML-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML-ből MHTML Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a SPREADSHEETML fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.spreadsheetml");
// mentse a SPREADSHEETML-t MHTML-ként
