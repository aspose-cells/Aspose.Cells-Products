---
title:  Buscar documento XLSM sin abrir mediante C++
weight: 9280
description: C++ código de ejemplo para buscar palabras con patrón en el archivo XLSM en el entorno de ejecución C++ para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
...
{{% blocks/products/pf/agp/content h2="Cómo buscar el archivo XLSM usando C++" %}}
 ...
 Para buscar el archivo XLSM, utilizaremos
