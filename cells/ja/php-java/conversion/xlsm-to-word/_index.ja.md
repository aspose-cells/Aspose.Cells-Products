---
title: PHP XLSM ～ WORD - XLSM ～ WORD コンバーター
description: Aspose エクセル。 Aspose.Cells を使用して、XLSM を WORD にすばやく簡単に変換します。PHP XLSM から WORD。PHP XLSM から WORD に保存します。PHP を使用して、XLSM を WORD として保存します。
...
{{% blocks/products/pf/agp/content h2="PHP 経由で XLSM を WORD に変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

XLSM ファイルをプログラムで WORD に変換する必要がありますか? PHP 開発者は、わずか数行のコードで XLSM を簡単にロードして WORD に変換できます。
