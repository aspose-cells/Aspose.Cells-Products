...
description: Aspose Excel. Konvertieren Sie OTS schnell und einfach in ET mit Aspose.Cells. C# OTS in ET. C# OTS in ET speichern. Speichern Sie OTS als ET mit C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie OTS auf ET in C#" %}}

Das folgende Beispiel zeigt, wie OTS in C# in ET konvertiert wird.
...
{{% cells-convert title="Beispielcode zum Konvertieren von OTS in ET" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="et" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="So konvertieren Sie OTS über C# in ET" %}}

{{% blocks/products/pf/agp/text %}}

Müssen Sie OTS-Dateien programmgesteuert in ET konvertieren? .NET-Entwickler können OTS in nur wenigen Codezeilen problemlos laden und in ET konvertieren.
...
1.  Konvertieren Sie OTS in ET, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von OTS in ET.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zur Konvertierung von OTS in ET" %}}
