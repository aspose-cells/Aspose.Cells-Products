...
{{% cells-convert title="Przykładowy kod do konwersji XLSB na XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLSB na XML za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki XLSB na XML? Programiści .NET mogą łatwo załadować i przekonwertować XLSB na XML w zaledwie kilku linijkach kodu.
...
1.  Konwertuj XLSB na XML, wywołując metodę Workbook.Save.
