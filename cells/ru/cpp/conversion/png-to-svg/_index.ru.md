...
Нужно программно конвертировать файлы PNG в SVG? Разработчики C++ могут легко преобразовать PNG в SVG всего за несколько строк кода.
...
1.  Преобразуйте PNG в SVG, вызвав метод Save().
