...
url: /tr/net/merger/merge-prn-to-htm/ 
...
Aşağıdaki örnek, Aspose.Cells for .NET'de PRN'nin HTM ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 PRN'yi HTM ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="PRN\'yi HTM ile birleştirmek için .NET kitaplığı" %}}
