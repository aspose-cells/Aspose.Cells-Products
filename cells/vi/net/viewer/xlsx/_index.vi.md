---
title:  Xem XLSX Định dạng tệp via .NET
weight: 2180
description: C# để tải, kết xuất và hiển thị các tài liệu XLSX trên .NET Framework, .NET Core, Mono hoặc Nền tảng Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSX Trình xem tệp for .NET" h2="Xem bảng tính Excel & OpenOffice chẳng hạn như XLSX mà không cần Microsoft Excel hoặc Office Automation." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Cells " subTitlepfName="for .NET" >}}
{{< blocks/products/pf/i18n/sub-menu autoGeneratedVersion="true" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" apiHomeLink="" codeSamplesLink="https://github.com/aspose-cells" liveDemosLink="https://products.aspose.app/cells/family" docsLink="https://docs.aspose.com/cells/net" installationsDocsLink="https://docs.aspose.com/cells/net" nugetLink="https://www.nuget.org/packages/aspose.cells" nugetPackageName="" downloadAsLink="https://downloads.aspose.com/cells/net" learnAsLink="https://docs.aspose.com/cells/net" apiReference="" mavenRepoLink="" >}}

{{% blocks/products/pf/agp/content h2="Cách Xem File XLSX Bằng C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước xem XLSX qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Cells giúp các nhà phát triển dễ dàng xem tệp XLSX chỉ bằng vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1.  Tải tệp XLSX trong phiên bản Sổ làm việc
1.  Tạo một phiên bản của HtmlSaveOptions và đặt thuộc tính ExportHeadings thành true
1.  Lưu tệp XLSX ở định dạng HTML bằng phương thức Workbook.Save
...
{{% blocks/products/pf/agp/code-block title="Mã ví dụ C# để xem tệp XLSX" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Cells API có thể được sử dụng để tạo, chỉnh sửa, chuyển đổi và hiển thị Microsoft định dạng Excel sang các định dạng khác nhau. Hơn nữa, nó có thể được sử dụng để lập biểu đồ toàn diện, báo cáo có thể mở rộng và tính toán đáng tin cậy trong các ứng dụng phần mềm. Aspose.Cells là một API độc lập và nó không yêu cầu bất kỳ phần mềm nào như Microsoft hoặc OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Ứng dụng miễn phí để xem XLSX" sectionDescription=" Kiểm tra bản trình diễn trực tiếp của chúng tôi để[Xem XLSX](https://products.aspose.app/cells/viewer/xlsx) với những lợi ích sau." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Tải xuống tệp XLSX từ liên kết, nếu được yêu cầu" >}}
