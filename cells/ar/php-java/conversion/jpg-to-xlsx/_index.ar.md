---
title: PHP JPG إلى XLSX - JPG إلى XLSX محول
description: Aspose اكسل. قم بتحويل JPG إلى XLSX بسرعة وسهولة باستخدام Aspose.Cells. PHP JPG إلى XLSX. PHP احفظ JPG إلى XLSX. احفظ JPG كـ XLSX باستخدام PHP.
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل JPG إلى XLSX عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات JPG إلى XLSX برمجياً؟ يمكن لمطوري PHP تحميل وتحويل JPG بسهولة إلى XLSX في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل JPG إلى XLSX عن طريق استدعاء طريقة حفظ المصنف.
1.  احصل على نتيجة تحويل JPG إلى XLSX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="مكتبة PHP لتحويل JPG إلى XLSX" %}}
