---
title: PHP XLAM a EXCEL - Convertidor XLAM a EXCEL
description: Aspose Excel. Convierta XLAM a EXCEL rápida y fácilmente con Aspose.Cells. PHP XLAM a EXCEL. PHP Guarde XLAM en EXCEL. Guarde XLAM como EXCEL usando PHP.
...
{{% cells-convert title="Código de muestra para convertir XLAM a EXCEL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="xlsx" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir XLAM a EXCEL mediante PHP" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos XLAM a EXCEL mediante programación? Los desarrolladores de PHP pueden cargar y convertir fácilmente XLAM a EXCEL en tan solo unas pocas líneas de código.
...
1.  Convierta XLAM a EXCEL llamando al método de guardar del libro de trabajo.
