...
ต้องการแปลงไฟล์ HTM เป็น MARKDOWN โดยใช้โปรแกรมใช่ไหม? นักพัฒนา C++ สามารถแปลง HTM เป็น MARKDOWN ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
1.  แปลงไฟล์ HTM เป็นรหัส MARKDOWN โดยเรียกใช้เมธอด Save()
