---
title: C# PNG'den IMAGE'a - PNG'den IMAGE'a Dönüştürücü
description: Aspose Excel'de. Aspose.Cells ile PNG'i hızlı ve kolay bir şekilde IMAGE'a dönüştürün. C# PNG'i IMAGE'a dönüştürün. C# PNG'i IMAGE'a kaydedin. C#'i kullanarak PNG'i GÖRÜNTÜ olarak kaydedin.
...
{{% blocks/products/pf/agp/content h2="PNG\'i C#\'deki IMAGE\'a kaydedin" %}}

Aşağıdaki örnek, PNG'in C#'de IMAGE'a nasıl dönüştürüleceğini gösterir.
...
{{% cells-convert title="PNG\'i IMAGE\'a Dönüştürmek için Örnek Kod" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="png" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="PNG\'i C# aracılığıyla IMAGE\'a dönüştürme" %}}

{{% blocks/products/pf/agp/text %}}

PNG dosyalarını program aracılığıyla IMAGE'a dönüştürmeniz mi gerekiyor? .NET geliştiricileri, yalnızca birkaç satır kodla PNG'i kolayca yükleyip IMAGE'a dönüştürebilir.
...
{{% blocks/products/pf/agp/content h2="PNG\'i IMAGE\'a dönüştürmek için C# kitaplığı" %}}
