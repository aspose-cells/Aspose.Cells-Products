---
title: Gabungkan FODS menjadi PDF - Gabungkan FODS menjadi PDF menjadi Java
url: /id/java/merger/merge-fods-to-pdf/ 
description: Aspose Unggul. Java Aspose.Cells. Gabungkan FODS menjadi PDF format simpan. Java Gabungkan format FODS menjadi PDF. Gabungkan FODS menjadi PDF di Java. FODS Gabungkan.
...
{{% blocks/products/pf/agp/content h2="Gabungkan FODS menjadi PDF di Java" %}}

Contoh berikut menunjukkan cara menggabungkan FODS menjadi PDF di Aspose.Cells for Java.
...
{{% cells-merger title="Contoh Kode untuk Menggabungkan FODS menjadi PDF di Java" InputFormat="fods" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cara Menggabungkan FODS menjadi PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Perlu menggabungkan FODS ke PDF secara terprogram? Dokumen dasar yang digabungkan dan digabungkan dengan[Aspose.Cells for Java](https://products.aspose.com/cells/java) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Java perpustakaan untuk digabungkan FODS menjadi PDF" %}}
