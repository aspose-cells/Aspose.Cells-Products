---
title: Python XLSX to NUMBERS - Online XLSX to NUMBERS Converter
description: Aspose Unggul. Python Aspose.Cells. Python Aspose Cells. Online Gratis Python Ubah XLSX menjadi ANGKA saveformat. Python XLSX ke format ANGKA. Simpan XLSX ke NOMOR Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah XLSX menjadi ANGKA di Python" h2="Pustaka Python berkecepatan tinggi untuk mengonversi XLSX menjadi ANGKA. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor XLSX, ANGKA, dan banyak format lainnya menggunakan Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="NUMBERS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Ubah XLSX menjadi ANGKA Menggunakan Python" %}}

 Bagaimana cara mengonversi XLSX menjadi ANGKA? Dengan perpustakaan Aspose.Cells for Python, Anda dapat dengan mudah mengonversi XLSX menjadi ANGKA secara terprogram dengan beberapa baris kode.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)mampu membangun aplikasi lintas platform dengan kemampuan untuk menghasilkan, memodifikasi, mengonversi, merender, dan mencetak semua file Excel. Python Excel API tidak hanya mengkonversi antara format spreadsheet, tetapi juga dapat membuat file Excel sebagai gambar, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT dan lainnya, sehingga menjadikannya pilihan yang sempurna untuk bertukar dokumen dalam industri -standar format.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Simpan XLSX ke ANGKA di Python Online Gratis" %}}

Contoh berikut menunjukkan cara mengonversi XLSX menjadi ANGKA di Python.
{{% blocks/products/pf/agp/text %}}

Ikuti langkah mudah untuk mengonversi XLSX menjadi ANGKA. Unggah file XLSX Anda, lalu simpan sebagai file ANGKA. Untuk membaca XLSX dan menulis ANGKA Anda dapat menggunakan nama file yang memenuhi syarat. Konten dan pemformatan ANGKA keluaran akan identik dengan dokumen XLSX asli.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi XLSX menjadi ANGKA Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="numbers" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah XLSX menjadi ANGKA melalui Python" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX menjadi ANGKA secara terprogram? Pengembang Python dapat dengan mudah memuat & mengonversi XLSX menjadi ANGKA hanya dalam beberapa baris kode.
...
1.  Ubah XLSX menjadi ANGKA dengan memanggil metode Workbook.save.
1.  Dapatkan hasil konversi dari XLSX menjadi ANGKA.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Perpustakaan Python untuk mengonversi XLSX menjadi ANGKA" %}}
