...
description: Aspose Exceller. Convertissez EXCEL en PPTX rapidement et facilement avec Aspose.Cells. C# EXCEL en PPTX. C# Enregistrez EXCEL en PPTX. Enregistrez EXCEL sous PPTX en utilisant C#.
...
{{% blocks/products/pf/agp/content h2="Enregistrer EXCEL au PPTX dans C#" %}}
...
{{% cells-convert title="Exemple de code pour convertir EXCEL en PPTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="pptx" IsLandingPage="true" %}}
...
1.  Convertissez EXCEL en PPTX en appelant la méthode Workbook.Save.
