---
title: Konwertuj XLS na DIF przez C#
url: /pl/net/conversion/xls-to-dif/
description: Przykładowy kod dla konwersji xls na dif C#. Użyj przykładowego kodu API dla plików wsadowych xls do konwersji dif w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na DIF za pomocą C#" %}}

 Aby przekonwertować XLS na DIF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLS na DIF za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki XLS do formatu DIF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLS z instancją Workbook1. Wywołaj metodę Workbook.Save1. Przekaż ścieżkę wyjściową z rozszerzeniem DIF jako parametrem1. Sprawdź określoną ścieżkę dla wynikowego pliku DIF
...
{{% cells-convert title="Darmowa aplikacja i przykładowy kod do konwersji XLS na DIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="dif" IsLandingPage="true" %}}
