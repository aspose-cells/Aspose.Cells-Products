...
weight: 810
description: C++ 在 C++ 运行时环境 Windows 32 位、Windows 64 位和 Linux 64 位的 Excel 文件中插入标注的示例代码。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C++ 将标注插入 Excel" h2="使用服务器端Aspose.Cells C++ API的本机和高性能插入对象，无需使用任何软件，例如Microsoft或Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
