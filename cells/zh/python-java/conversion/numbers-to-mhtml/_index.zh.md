---
title: Python 数字到 MHTML - 数字到 MHTML 转换器
description: Aspose Excel。使用 Aspose.Cells 快速轻松地将 NUMBERS 转换为 MHTML。 将 Python NUMBERS 转换为 MHTML。 Python 将 NUMBERS 保存为 MHTML。 使用 Python 将 NUMBERS 保存为 MHTML。
...
如何将 NUMBERS 转换为 MHTML？借助 Aspose.Cells for Python 库，您可以通过几行代码以编程方式轻松将 NUMBERS 转换为 MHTML。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)能够构建跨平台应用程序，能够生成、修改、转换、渲染和打印所有 Excel 文件。 Python Excel API 不仅可以在电子表格格式之间进行转换，还可以将 Excel 文件呈现为图像, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT等等，从而使其成为以行业标准交换文档的完美选择格式。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="将号码保存到 Python 中的 MHTML" %}}
...
{{% cells-convert title="将数字转换为 MHTML 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="mhtml" IsLandingPage="true" language="pythonjava" %}}
