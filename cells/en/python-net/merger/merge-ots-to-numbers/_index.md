...
description: Aspose Excel. Python Aspose.Cells. Merge OTS to NUMBERS saveformat. Python Combine OTS to NUMBERS format. Merge OTS to NUMBERS in Python. OTS Merge.
keywords: [Aspose Excel., Python Aspose.Cells., Merge OTS to NUMBERS in Python., Python Merge OTS to numbers., Python Combine OTS to NUMBERS., OTS Merge]
---
...
{{% blocks/products/pf/agp/content h2="Merge OTS to NUMBERS in Python" %}}
...
{{% cells-merger title="Sample Code to Merge OTS to NUMBERS in Python" InputFormat="ots" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonnet" %}}
