---
title: Sloučit JPG s HTML - Sloučit JPG s HTML v C++
url: /cs/cpp/merger/merge-jpg-to-html/ 
description: Aspose Excel. C++ Aspose.Cells. Online zdarma Sloučit JPG do formátu uložení HTML. C++ Zkombinujte JPG do formátu HTML. Sloučit JPG na HTML v C++. Sloučit JPG.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPG na HTML v C++ Online zdarma" %}}

Následující příklad ukazuje, jak sloučit JPG s HTML v Aspose.Cells for C++.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JPG do HTML. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru HTML. Pokud vytvoříte kód v C++, bude to jednodušší, než to zní. Viz příklad C++, který sloučí JPG do HTML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení JPG na HTML v C++" InputFormat="jpg" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JPG na HTML přes C++" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit JPG na HTML programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ pro sloučení JPG do HTML" %}}
