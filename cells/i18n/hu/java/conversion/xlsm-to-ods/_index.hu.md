---
title: "Az XLSM konvertálása ODS-re a következőn keresztül: Java "
weight: 2400
url: /hu/java/conversion/xlsm-to-ods/ 
description: Minta Java konverziós kód az XLSM formátumhoz ODS-fájllá. A programozók ezt a példakódot használhatják Excel- és OpenOffice-táblázatok exportálására ODS-be bármely web- vagy asztali Java-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Az XLSM konvertálása ODS-re a következőn keresztül: Java" h2="XLSM-ből ODS-be Java konvertálva egyetlen vagy több oldalt ODS-vé konvertálva a helyszíni Java könyvtár használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSM" >}}
...
{{% blocks/products/pf/agp/content h2="Az XLSM átalakítása ODS-vé a következővel: Java" %}}

 Ahhoz, hogy az XLSM-et ODS-re rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLSM ODS-vé konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői egyszerűen konvertálhatják az XLSM-fájlt ODS-vé, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLSM-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat ODS kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott ODS-fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="XLSM-ből ODS Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be az XLSM fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.xlsm");
// mentse az XLSM-et ODS-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="XLSM-ből ODS-be konvertáló élő bemutatók" sectionDescription="[Konvertálja az XLSM-et ODS-re](https://products.aspose.app/cells/conversion/xlsm-to-ods) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel XLSM-fájlját, és azonnal ODS-re konvertálódik." >}}
