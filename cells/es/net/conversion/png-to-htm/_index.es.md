---
title: C# PNG a HTM - Convertidor de PNG a HTM
description: Aspose Excel. Convierta PNG a HTM rápida y fácilmente con Aspose.Cells. C# PNG a HTM. C# Guarde PNG en HTM. Guarde PNG como HTM usando C#.
...
{{% blocks/products/pf/agp/content h2="Guarde PNG en HTM en C#" %}}

El siguiente ejemplo demuestra cómo convertir PNG a HTM en C#.
...
{{% cells-convert title="Código de muestra para convertir PNG a HTM" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="htm" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir PNG a HTM a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos PNG a HTM mediante programación? Los desarrolladores de .NET pueden cargar y convertir fácilmente PNG a HTM en solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca C# para convertir PNG a HTM" %}}
