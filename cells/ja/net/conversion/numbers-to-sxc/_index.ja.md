---
title: C# 番号から SXC - 番号から SXC へのコンバータ
description: Aspose エクセル。 Aspose.Cells を使用して、NUMBERS を SXC にすばやく簡単に変換します。 C# NUMBERS を SXC に変換します。 C# NUMBERS を SXC に保存します。 C# を使用して、NUMBERS を SXC として保存します。
...
{{% blocks/products/pf/agp/content h2="番号を C# の SXC に保存" %}}

次の例は、NUMBERS を C# の SXC に変換する方法を示しています。
...
{{% cells-convert title="NUMBERSをSXCに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="numbers" outformat="sxc" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="C#経由でNUMBERSをSXCに変換する方法" %}}

{{% blocks/products/pf/agp/text %}}

NUMBERS ファイルをプログラムで SXC に変換する必要がありますか? .NET 開発者は、わずか数行のコードで NUMBERS を簡単にロードして SXC に変換できます。
...
{{% blocks/products/pf/agp/content h2="C# NUMBERS を SXC に変換するライブラリ" %}}
