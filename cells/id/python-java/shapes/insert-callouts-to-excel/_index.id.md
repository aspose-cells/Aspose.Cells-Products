---
title: Masukkan Info ke Excel menggunakan Python via Java
weight: 360
description: Python via Java kode sumber untuk memasukkan Callouts ke dalam Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan Info ke Excel menggunakan Python via Java" h2="Masukkan Callouts menggunakan Aspose.Cells\' API tanpa software apa pun seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Memasukkan Info ke File Excel Menggunakan Python via Java" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan[tambahkan metode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) untuk menyisipkan Info di lembar kerja yang dipilih
...
<div class="container-fluid features-section bg-gray">
 ...
 Tipe Bentuk Otomatis.<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR_2
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-12" style="font-size:0.8rem !important;">
 Tipe Bentuk Otomatis.<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR_3
    </p>
   </div>
  </div>
 </div>
