---
title: Převeďte XLSM na CSV pomocí aplikace C++ 

description: Ukázka převodního kódu C++ pro dokument XLSM na formát CSV. Programátoři mohou použít tento zdrojový kód pro dávkový převod XLSM na CSV v jakékoli aplikaci C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést XLSM na CSV pomocí C++" %}}
 ...
 Abychom převedli XLSM na CSV, použijeme
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři C++ mohou snadno převést soubor XLSM na CSV pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor XLSM pomocí Factory::CreateIWorkbook.1. Zavolejte metodu Save().1. Předejte cestu výstupního souboru s příponou souboru (CSV).1. Soubor CSV bude uložen do zadané cesty.1. Otevřete soubor CSV v kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze XLSM na CSV C++" offSpacer="" %}}
