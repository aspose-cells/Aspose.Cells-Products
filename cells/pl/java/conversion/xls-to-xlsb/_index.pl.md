---
title: Konwertuj XLS na XLSB przez Java 
weight: 250
url: /pl/java/conversion/xls-to-xlsb/ 
description: Przykładowy kod konwersji Java dla formatu XLS do pliku XLSB. Programiści mogą użyć tego przykładowego kodu do eksportowania arkuszy kalkulacyjnych Excel i OpenOffice do XLSB w dowolnej aplikacji internetowej lub desktopowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLS na XLSB przez Java" h2="Konwersja XLS do XLSB Java w celu konwersji jednej lub wielu stron do formatu XLSB przy użyciu lokalnej biblioteki Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na XLSB za pomocą Java" %}}

 Aby wyrenderować XLS do XLSB, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLS na XLSB za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik XLS na XLSB w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLS z instancją klasy Workbook1. Wywołaj metodę Workbook.save1. Przekaż ścieżkę wyjściową z rozszerzeniem XLSB i SaveFormat jako parametrami1. Sprawdź określoną ścieżkę dla wynikowego pliku XLSB
...
{{% blocks/products/pf/agp/code-block title="XLS do XLSB Java Kod źródłowy konwersji" offSpacer="" %}}

```cs
// załaduj plik XLS w instancji Workbook
Workbook book = new Workbook("template.xls");
// zapisz XLS jako XLSB
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja XLS na XLSB Prezentacje na żywo" sectionDescription="[Konwertuj XLS na XLSB](https://products.aspose.app/cells/conversion/xls-to-xlsb) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik XLS, zostanie on natychmiast przekonwertowany na XLSB." >}}
