...
{{% blocks/products/pf/agp/content h2="Sla TSV op in DIF in Java" %}}

Het volgende voorbeeld laat zien hoe je TSV omzet naar DIF in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik TSV om naar DIF of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie TSV programmatisch converteren naar DIF? Ontwikkelaars van Java kunnen bestanden met de extensie TSV eenvoudig converteren naar DIF met slechts een paar regels code.
