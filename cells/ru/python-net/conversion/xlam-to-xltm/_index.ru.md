---
title: XLAM в XLTM - Конвертировать файлы XLAM в XLTM Python via Python
...
В следующем примере показано, как преобразовать XLAM в XLTM в Python via NET.
...
{{% blocks/products/pf/agp/content h2="Как преобразовать XLAM в XLTM" %}}
