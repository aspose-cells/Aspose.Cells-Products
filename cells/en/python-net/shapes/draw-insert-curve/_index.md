...
{{% blocks/products/pf/agp/content h2="How to Insert curved shape into Excel File Using Python via .Net" %}}

 In order to insert curved shape into excel file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to insert curved shape to Excel file using Python via .Net" %}}
...
+  Use the shapecollection's add [method](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) to insert a curved shape in the selected worksheet.
...
{{% blocks/products/pf/agp/code-block title="Insert curved shape - Python via .Net" offSpacer="" %}}
