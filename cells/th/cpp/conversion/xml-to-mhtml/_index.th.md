---
title: C++ XML เป็น MHTML - ตัวแปลง XML เป็น MHTML
description: Aspose เอ็กเซล. แปลง XML เป็น MHTML อย่างรวดเร็วและง่ายดายด้วย Aspose.Cells C++ XML เป็น MHTML C++ บันทึก XML เป็น MHTML บันทึก XML เป็น MHTML โดยใช้ C++
...
{{% blocks/products/pf/agp/content h2="บันทึก XML เป็น MHTML ใน C++" %}}
...
1.  แปลง XML เป็น MHTML โดยการเรียกเมธอด Save()
