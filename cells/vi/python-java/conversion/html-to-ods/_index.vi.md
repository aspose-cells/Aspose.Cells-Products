---
title: Chuyển đổi HTML sang ODS qua Python
url: /vi/python-java/conversion/html-to-ods/
description: Mã mẫu cho chuyển đổi html sang ods Python. Sử dụng mã mẫu API cho các tệp html hàng loạt để chuyển đổi ods trong ứng dụng Python.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi HTML sang ODS bằng cách sử dụng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi HTML sang ODS qua Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python các nhà phát triển có thể dễ dàng tải và chuyển đổi các tệp HTML sang ODS chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp HTML với một phiên bản của Workbook1. Gọi phương thức Workbook.Save1. Chuyển đường dẫn đầu ra với phần mở rộng ODS làm tham số1. Kiểm tra đường dẫn được chỉ định cho tệp ODS kết quả
