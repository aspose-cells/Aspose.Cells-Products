...
{{% blocks/products/pf/agp/content h2="Преобразовать XLTM в DOCX, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните XLTM в DOCX в C#" %}}
...
1.  Преобразуйте значение XLTM в DOCX, вызвав метод Workbook.Save.
