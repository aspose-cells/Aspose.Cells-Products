...
description: Aspose Excel. Convierta SXC a ETT rápida y fácilmente con Aspose.Cells. Python SXC a ETT. Python Guardar SXC en ETT. Guarde SXC como ETT usando Python.
...
{{% blocks/products/pf/agp/content h2="Guarde SXC en ETT en Python" %}}

El siguiente ejemplo demuestra cómo convertir SXC a ETT en Python via NET.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir SXC a ETT" %}}
