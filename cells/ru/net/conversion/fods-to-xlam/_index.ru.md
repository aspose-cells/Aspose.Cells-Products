...
{{% blocks/products/pf/agp/content h2="Преобразовать FODS в XLAM, используя C#" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните FODS в XLAM в C#" %}}
...
1.  Преобразуйте значение FODS в XLAM, вызвав метод Workbook.Save.
