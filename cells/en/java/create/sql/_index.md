...
{{% blocks/products/pf/agp/content h2="Create SQL File Using Java" %}}
...
{{% blocks/products/pf/agp/content h2="How to Create SQL in Java" %}}
...
1.  Save the workbook as SQL format using the save() method.

{{% blocks/products/pf/agp/code-block title="Sample code shows how to create SQL file in Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java library to create SQL file" %}}
{{% blocks/products/pf/agp/text %}}
