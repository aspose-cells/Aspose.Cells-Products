...
description: Aspose Excel'de. Aspose.Cells ile hızlı ve kolay bir şekilde XLS'i DIF'e dönüştürün. Python XLS'i DIF'e dönüştürün. Python XLS'i DIF'e kaydedin. XLS'i 07611134 olarak kaydedin 81, Python'i kullanarak.
...
{{% blocks/products/pf/agp/content h2="Python\'i kullanarak XLS\'i DIF\'e dönüştürün" %}}
...
{{% blocks/products/pf/agp/content h2="XLS\'i Python\'e DIF\'e kaydedin" %}}

Aşağıdaki örnek, XLS'in Python'de DIF'e nasıl dönüştürüleceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="XLS\'i DIF\'e dönüştürmek için Python kitaplığı" %}}
