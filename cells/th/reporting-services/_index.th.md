...
weight: 3460
description: ส่วนขยายการแสดงบริการการรายงานของ SQL Server - ส่งออกรูปแบบ Excel XLS XLSX XLSM XLSB CSV SpreadsheetML HTML ODS และ TXT
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="ส่วนขยายบริการรายงานเพื่อส่งรายงานเป็นไฟล์ Excel" h2="ส่งออกรายงาน RDL & RDLC เป็นรูปแบบไฟล์สเปรดชีต Excel ได้อย่างง่ายดาย" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/headers/aspose_cells-for-reporting-services.svg" pfName="Aspose.Cells" subTitlepfName="for Reporting Services" downloadUrl="https://downloads.aspose.com/cells/reportingservices" >}}
...
<p>
 Aspose.Cells for Reporting Services ช่วยให้คุณสามารถส่งรายงาน Excel จากภายใน Microsoft SQL Server Reporting Services และ Microsoft Report Viewer ซึ่งแตกต่างจากผู้ส่งออกดั้งเดิมสำหรับรายงานที่ใช้ Excel - Aspose.Cells for Reporting Services อนุญาตให้แปลง RDL & amp; รายงาน RDLC เป็นรูปแบบไฟล์สเปรดชีต Excel จำนวนหนึ่ง
</p>
...
{{< blocks/products/pf/carousel-item h3="ภาพรวม" description="ภาพรวมของ Aspose.Cells for Reporting Services" >}}
...
{{< blocks/products/pf/carousel-item h3="ความเป็นอิสระของแพลตฟอร์ม" description="Aspose.Cells for Reporting Services รองรับ Microsoft SQL Server Reporting Services" >}}
<div class="diagram1 d1-rs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 บริการรายงานของเซิร์ฟเวอร์ SQL
   </header>
   <ul>
    <li>
     2005
...
{{< blocks/products/pf/carousel-item h3="รูปแบบไฟล์ที่รองรับ" description=" Aspose.Cells for Reporting Services รองรับสเปรดชีตที่ใช้กันทั่วไป[รูปแบบไฟล์](https://docs.aspose.com/cells/reportingservices/supported-file-formats/)." >}}
<div class="diagram1 d2 d1-rs">
 ...
 CSV, TSV, TabDelimited ไฟล์ข้อความ
    </li>
    <li>
     <strong>
 เค้าโครงคงที่:
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 สร้างหลายแท็บ
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
ยุบหรือขยายเขตข้อมูล Pivot Table
    </p>
   </div>
   <div class="col-lg-4">
 ...
 รองรับแผนภูมิ MS Excel 2016
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
 ปรับการตั้งค่าระยะขอบหน้าในแผ่นงาน Excel
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 Aspose.Cells' เครื่องมือออกแบบรายงาน
    ...
    <p>
 นักพัฒนาสามารถออกแบบและส่งรายงานได้โดยตรงจาก Microsoft Excel ในขณะที่ใช้ Aspose.Cells.Report.Designer ซึ่งเป็นเครื่องมือออกแบบอย่างง่ายที่ใช้ Microsoft Excel เป็นเทมเพลตรายงาน คุณลักษณะนี้ช่วยให้สามารถใช้ประโยชน์จากฟังก์ชันและคุณลักษณะอันทรงพลังทั้งหมดที่มีอยู่ในแอปพลิเคชัน Excel Microsoft รวมถึง Pivot Tables แผนภูมิเชิงโต้ตอบ สูตร และอื่นๆ
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 ส่งออกรายงานเป็นรูปแบบสเปรดชีต
    ...
    <p>
Aspose.Cells for Reporting Services รองรับรูปแบบไฟล์ยอดนิยม Microsoft Excel (97 - 2016) ทั้งหมด รวมถึงรูปแบบ "native" Microsoft Excel เช่น XLS, XLSX, XLSM, SpreadsheetML, CSV Tab Delimited และ HTML นอกจากนี้ Aspose.Cells for Reporting Services ยังรองรับรูปแบบไฟล์ ODS (OpenDocument Spreadsheet)
    </p>
    <p>
 ยิ่งไปกว่านั้น Aspose.Cells for Reporting Services ส่งออกเอกสาร Excel เป็นสเปรดชีตที่แก้ไขได้อย่างสมบูรณ์ นั่นคือ ผู้ใช้สามารถแก้ไขสเปรดชีตผลลัพธ์ด้วยตนเองในแอปพลิเคชัน Excel Microsoft หากจำเป็น
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
 ความเที่ยงตรงสูง - เหมือนกับการออกแบบรายงาน
    ...
    <p>
 Aspose.Cells for Reporting Services ส่งออกรายงานไปยังสเปรดชีต Excel Microsoft ในลักษณะที่ผลลัพธ์ปรากฏเหมือนกับต้นฉบับที่สร้างขึ้นโดยโปรแกรมออกแบบรายงานในตัวของ Reporting Services ฟีเจอร์รายงานทั้งหมดจะถูกแปลงเป็นระดับความแม่นยำสูงสุดเพื่อทำให้สเปรดชีต Microsoft Excel ดูคล้ายกับต้นฉบับมากที่สุด
    </p>
   </div>
   <!--
...
-->
   <div class="col-lg-12">
    <h2 class="h2title">
 ตัวเลือกการจัดการข้อมูลที่หลากหลาย
    </h2>
    <p>
Aspose.Cells for Reporting Services สนับสนุนตารางที่มีแถวและส่วนท้ายที่จัดกลุ่มแล้ว ในขณะที่การจัดกลุ่มสามารถตั้งค่าในขณะออกแบบได้เช่นเดียวกับรายการรายงานอื่นๆ Aspose.Cells for Reporting Services ยังสนับสนุนพารามิเตอร์และตัวแปรส่วนกลางเป็นแหล่งข้อมูลรายงาน นักพัฒนายังสามารถใช้ประโยชน์จาก Microsoft Query สำหรับสร้างแหล่งข้อมูลและแบบสอบถาม นี่เป็นเครื่องมือที่ใช้กันอย่างแพร่หลายและคุ้นเคยกับผู้ใช้ส่วนใหญ่
    </p>
    <p>
 นอกจากนี้ Aspose.Cells for Reporting Services ยังสนับสนุนทั้งแหล่งข้อมูลเฉพาะของรายงานและแหล่งข้อมูลที่ใช้ร่วมกันที่สร้างขึ้นบนเซิร์ฟเวอร์รายงานล่วงหน้า นักพัฒนาสามารถใช้แหล่งข้อมูลเฉพาะของรายงานในเวลาออกแบบ และระบุแหล่งข้อมูลที่ใช้ร่วมกันเป็นแหล่งข้อมูลรายงานในขณะที่เผยแพร่รายงาน
    </p>
   </div>
   <!-- 
...
-->
 ...
 Microsoft Office Automation – ไม่จำเป็น
    ...
    <p>
 Aspose.Cells for Reporting Services สร้างขึ้นโดยใช้โค้ดที่มีการจัดการซึ่งไม่จำเป็นต้องติดตั้ง Microsoft Office หรือ Microsoft Excel บนเครื่องเพื่อทำงานกับรูปแบบเอกสาร Excel เป็นทางเลือกการทำงานอัตโนมัติของ Excel Microsoft ที่สมบูรณ์แบบในแง่ของฟีเจอร์ที่รองรับ ความปลอดภัย ความเสถียร ความสามารถในการปรับขนาด ความเร็ว และราคา
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-tab tabTitle="ทำไมต้อง Aspose.Cells for Reporting Services?" tabId="success-stories" >}}
