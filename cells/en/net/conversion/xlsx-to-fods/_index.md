---
title: XLSX to FODS - Convert XLSX to FODS files C#
description: Aspose Excel. Free Online Convert XLSX to FODS saveformat. C# XLSX to FODS format. Save XLSX as FODS in C#.
keywords: [Aspose Excel., C# Aspose.Cells., C# XLSX to FODS saveformat., Free Online XLSX to FODS Converter]
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert XLSX to FODS in C#" h2="High-speed C# library for converting XLSX to FODS. This is a professional software solution to import and export XLSX, FODS, and many other formats on .NET Framework, .NET Core or Mono Platforms." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="FODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
The following example demonstrates how to convert XLSX to FODS in C#.
...
{{% cells-convert title="Free App and Sample Code to Convert XLSX to FODS Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="fods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert XLSX to FODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert XLSX files to FODS programmatically? .NET developers can easily load & convert XLSX to FODS in just a few lines of code.
