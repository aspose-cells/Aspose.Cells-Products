...
{{% blocks/products/pf/agp/content h2="How to Convert XLS to GIF Using Java" %}}

 In order to render XLS to GIF, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert XLS to GIF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java developers can easily convert XLS file to GIF in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="XLS to GIF Java Conversion Source Code" offSpacer="" %}}
