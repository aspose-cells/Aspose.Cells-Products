...
url: /hu/python-java/merger/merge-xls-to-mht/ 
...
A következő példa bemutatja, hogyan lehet egyesíteni a XLS-et az MHT-val a Aspose.Cells for Python via Java-ben.
...
Programozottan egyesítenie kell a XLS-et az MHT-val? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Az API-k néhány sornyi kóddal elkészíthetők.
