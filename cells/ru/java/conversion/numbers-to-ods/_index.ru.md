---
title: Преобразование NUMBERS в ODS через Java 
url: /ru/java/conversion/numbers-to-ods/ 
description: Пример кода преобразования Java для формата NUMBERS в файл ODS. Программисты могут использовать этот пример кода для экспорта электронных таблиц Excel и OpenOffice в ODS в любом веб-или настольном Java приложении.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Преобразование NUMBERS в ODS через Java" h2="Преобразование NUMBERS в ODS Java для преобразования одной или нескольких страниц в ODS с использованием локальной библиотеки Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="NUMBERS" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать NUMBERS в ODS с помощью Java" %}}

 Чтобы отобразить NUMBERS в ODS, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию NUMBERS в ODS через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчики Java могут легко преобразовать файл NUMBERS в ODS, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузите файл NUMBERS с экземпляром класса Workbook1. Вызов метода Workbook.save1. Передайте выходной путь с расширением ODS и SaveFormat в качестве параметров1. Проверить указанный путь для результирующего файла ODS
...
{{% blocks/products/pf/agp/code-block title="NUMBERS в исходный код преобразования Java ODS" offSpacer="" %}}

```cs
// загрузить файл NUMBERS в экземпляр Workbook
Workbook book = new Workbook("template.numbers");
// сохранить ЧИСЛА как ODS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Преобразование NUMBERS в ODS Live Demos" sectionDescription="[Конвертировать NUMBERS в ODS](https://products.aspose.app/cells/conversion/numbers-to-ods) прямо сейчас, посетив наш веб-сайт Live Demos. Живая демонстрация имеет следующие преимущества" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Нет необходимости загружать Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Нет необходимости писать какой-либо код." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто загрузите файл NUMBERS, и он будет мгновенно преобразован в формат ODS." >}}
