...
description: Aspose Excel. Java Szybko i łatwo utwórz plik JPG za pomocą Aspose.Cells. Wygeneruj plik JPG za pomocą Java. Utwórz plik JPG w Java. Java Kreator JPG.
...
{{% blocks/products/pf/agp/content h2="Jak utworzyć JPG w Java" %}}
...
1.  Zapisz skoroszyt w formacie JPG, korzystając z metody save().

{{% blocks/products/pf/agp/code-block title="Przykładowy kod pokazuje, jak utworzyć plik JPG w Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do tworzenia pliku JPG" %}}
{{% blocks/products/pf/agp/text %}}
