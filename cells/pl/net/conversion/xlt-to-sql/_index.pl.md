...
description: Aspose Excel. Szybko i łatwo przekonwertuj XLT na SQL za pomocą Aspose.Cells. C# XLT na SQL. C# Zapisz XLT w SQL. Zapisz XLT jako SQL, używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLT w SQL w C#" %}}

Poniższy przykład ilustruje sposób konwersji XLT na SQL w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XLT na SQL" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlt" outformat="sql" IsLandingPage="true" %}}
