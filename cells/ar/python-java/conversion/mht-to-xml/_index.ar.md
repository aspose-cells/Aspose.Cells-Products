...
description: Aspose اكسل. قم بتحويل MHT إلى XML بسرعة وسهولة باستخدام Aspose.Cells. Python MHT إلى XML. Python حفظ MHT إلى XML. احفظ MHT بتنسيق XML باستخدام Python.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل MHT إلى XML في Python" h2="مكتبة Python عالية السرعة لتحويل MHT إلى XML. يعد هذا حلاً برمجيًا احترافيًا لاستيراد وتصدير MHT وXML والعديد من التنسيقات الأخرى باستخدام Python." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل MHT إلى XML باستخدام Python" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ MHT إلى XML في Python" %}}

يوضح المثال التالي كيفية تحويل MHT إلى XML في Python.
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل MHT إلى XML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mht" outformat="xml" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="مكتبة Python لتحويل MHT إلى XML" %}}
