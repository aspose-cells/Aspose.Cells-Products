...
description: Aspose Excel. Python Создать файл XLAM. Создать XLAM Python. Python XLAM Создатель. Создайте XLAM в Python. Создайте файл XLAM, используя Python.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчикам легко создавать, загружать, изменять и преобразовывать файлы XLAM в рамках запуска различных приложений отчетности для обработки данных всего за несколько строк кода.
...
1. Используйте метод Сохранить, чтобы сохранить книгу как файл XLAM.
