---
title: Создать MHT — создать файл MHT по номеру C++.
description:  Aspose Эксель. C++ Быстро и легко создайте файл MHT с помощью Aspose.Cells. Создайте файл MHT с помощью C++. Создайте MHT в C++. C++ MHT Creater.
...
{{% blocks/products/pf/agp/content h2="Как создать MHT в C++" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчикам легко создавать, загружать, изменять и конвертировать файлы MHT в запущенных приложениях отчетности для обработки данных всего за несколько строк кода.
...
1.  Сохраните книгу как файл .mht, используя метод Save().

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл MHT по номеру C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="C++ библиотека для создания файла MHT" %}}
