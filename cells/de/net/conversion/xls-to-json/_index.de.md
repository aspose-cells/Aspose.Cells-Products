---
title: C# XLS zu JSON - Online-Konverter von XLS zu JSON
description: Aspose Excel. C# Aspose.Cells. C# Aspose Cells. Kostenlos online C# Konvertieren Sie XLS in das Speicherformat JSON. C# XLS bis JSON Format. Speichern Sie XLS bis JSON C#.
...
{{% blocks/products/pf/agp/content h2="Speichern Sie XLS bis JSON in C# kostenlos online" %}}

Das folgende Beispiel zeigt, wie XLS in JSON in C# konvertiert wird.
...
Müssen Sie XLS-Dateien programmgesteuert in JSON konvertieren? .NET-Entwickler können XLS problemlos in nur wenigen Codezeilen laden und in JSON konvertieren.
...
1.  Konvertieren Sie XLS in JSON, indem Sie die Workbook.Save-Methode aufrufen.
1.  Erhalten Sie das Konvertierungsergebnis von XLS in JSON.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#-Bibliothek zum Konvertieren von XLS in JSON" %}}
