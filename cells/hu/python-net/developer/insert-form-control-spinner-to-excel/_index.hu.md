...
{{% blocks/products/pf/agp/content h2="A Spin gomb (űrlapvezérlő) beszúrása Excel fájlba a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A Spin Button (Űrlapvezérlő) Excel-fájlba való beszúrásának lépései a Python számon keresztül" %}}
...
+ Használja a shapecollection hozzáadási módszerét, hogy beszúrjon egy Spin Buttont (Űrlapvezérlőt) a kiválasztott munkalapba.
...
{{% blocks/products/pf/agp/code-block title="Centrifugálás gomb beszúrása (Űrlapvezérlő) - Python" offSpacer="" %}}
