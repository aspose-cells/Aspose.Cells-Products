---
title: Fusionar PRN a MHT - Combinar PRN a MHT en Java
url: /es/java/merger/merge-prn-to-mht/ 
description: AsposeExcel. Java Aspose.Cells. Combinar en línea gratis PRN a MHT guardar formato. Java Combina PRN con formato MHT. Combinar PRN con MHT en Java. Combinar PRN.
...
{{% blocks/products/pf/agp/content h2="Combine PRN a MHT en Java en línea gratis" %}}

El siguiente ejemplo muestra cómo combinar PRN con MHT en Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Siga los sencillos pasos para fusionar PRN con MHT. Cargue sus archivos, llame al método Workbook.Combine para fusionar archivos y luego guárdelo en un archivo MHT. Si desarrolla código en Java, esto será más simple de lo que parece. Consulte el ejemplo Java que combina PRN con MHT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis en línea para fusionar PRN a MHT en Java" InputFormat="prn" InputFormat2="mht" outformat="mht" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar PRN a MHT via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar PRN con MHT mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Java biblioteca para fusionar PRN a MHT" %}}
