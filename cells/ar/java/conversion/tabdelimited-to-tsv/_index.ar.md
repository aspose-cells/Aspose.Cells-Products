---
title: تحويل TABDELIMITED إلى TSV عبر Java 
url: /ar/java/conversion/tabdelimited-to-tsv/ 
description: نموذج رمز تحويل Java لتنسيق TABDELIMITED إلى ملف TSV. يمكن للمبرمجين استخدام رمز المثال هذا لتصدير جداول بيانات Excel & OpenOffice إلى TSV داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل TABDELIMITED إلى TSV عبر Java" h2="TABDELIMITED إلى TSV Java التحويل لتحويل صفحات مفردة أو متعددة إلى TSV باستخدام مكتبة Java محلية." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل TABDELIMITED إلى TSV باستخدام Java" %}}

 من أجل تقديم TABDELIMITED إلى TSV ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل TABDELIMITED إلى TSV عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف TABDELIMITED إلى TSV في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف TABDELIMITED مع مثيل لفئة المصنف1. استدعاء طريقة Workbook.save1. قم بتمرير مسار الإخراج بامتداد TSV & SaveFormat كمعلمات1. تحقق من المسار المحدد لملف TSV الناتج
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED إلى TSV Java رمز مصدر التحويل" offSpacer="" %}}

```cs
// تحميل ملف TABDELIMITED في مثيل المصنف
Workbook book = new Workbook("template.tabdelimited");
// حفظ TABDELIMITED كـ TSV
