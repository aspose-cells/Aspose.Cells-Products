---
title:  XLSB document chart via .NET 
weight: 8560
url: /net/chart/xlsb/ 
description: Try our On-Premise document chart APIs to draw and convert chart or diagram in XLSB file on .NET Framework, .NET Core, Mono or Xamarin Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="XLSB Formats Charts in C#" h2="Native and high performance XLSB document charts using server-side Aspose.Cells for .NET APIs, without the use of any software like Microsoft or Adobe PDF." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/cells/272x272/aspose_cells-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="How to Create XLSB Charts Using C#" %}}

 In order to create XLSB charts, we’ll use
...
```cs
    ...
    var workbook = new Workbook("PieChart.xlsb");
