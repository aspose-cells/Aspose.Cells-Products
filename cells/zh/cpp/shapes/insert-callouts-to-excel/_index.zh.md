...
weight: 810
description: C++ 在 C++ 运行时环境（适用于 Windows 32 位、Windows 64 位和 Linux 64 位）上的 Excel 文件中插入标注的示例代码。
---
...
自选图形类型::<br>AutoShapeType_LineCalloutWithBorderAndAccentBar2
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10" style="font-size:0.8rem !important;">
自选图形类型::<br>AutoShapeType_LineCalloutWithBorderAndAccentBar3
    </p>
   </div>
  </div>
 </div>
