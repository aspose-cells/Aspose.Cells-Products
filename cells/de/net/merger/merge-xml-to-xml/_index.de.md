---
title: XML zu XML zusammenführen – Kombinieren Sie XML zu XML in C#
url: /de/net/merger/merge-xml-to-xml/ 
description: Aspose Excel. C# Aspose.Cells. Kostenloses Online-Merge-XML-zu-XML-Speicherformat. C# Kombinieren Sie XML mit dem XML-Format. Führen Sie XML zu XML in C# zusammen. XML-Zusammenführung.
...
{{% blocks/products/pf/agp/content h2="Führen Sie XML in XML in C# kostenlos online zusammen" %}}

Das folgende Beispiel zeigt, wie XML in Aspose.Cells for .NET mit XML zusammengeführt wird.
{{% blocks/products/pf/agp/text %}}

Befolgen Sie die einfachen Schritte, um XML mit XML zusammenzuführen. Laden Sie Ihre Dateien hoch, rufen Sie die Workbook.Combine-Methode zum Zusammenführen von Dateien auf und speichern Sie sie dann in einer XML-Datei. Wenn Sie Code in C# entwickeln, ist dies einfacher, als es sich anhört. Siehe Beispiel C#, das XML mit XML zusammenführt.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Kostenlos online zum Zusammenführen von XML zu XML in C#" InputFormat="xml" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="So führen Sie XML mit XML über C# zusammen" %}}

{{% blocks/products/pf/agp/text %}}

 Müssen Sie XML programmgesteuert in XML zusammenführen? Ein einfaches Dokument zum Zusammenführen und Verketten mit[Aspose.Cells for .NET](https://products.aspose.com/cells/net) APIs können mit nur wenigen Codezeilen erstellt werden.
...
{{% blocks/products/pf/agp/content h2=".NET-Bibliothek zum Zusammenführen von XML in XML" %}}
