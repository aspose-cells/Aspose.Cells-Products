...
description: Sample code for xlsm to fods C# conversion. Use API example code for batch xlsm files to fods conversion within VB.NET, Asp.NET or any .NET based application.
---
