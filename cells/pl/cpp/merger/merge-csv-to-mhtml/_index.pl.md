...
url: /pl/cpp/merger/merge-csv-to-mhtml/ 
...
Poniższy przykład pokazuje, jak połączyć CSV z MHTML w Aspose.Cells for C++.
...
{{% cells-merger title="Przykładowy kod do połączenia CSV z MHTML w C++" InputFormat="csv" InputFormat2="mhtml" outformat="mhtml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć CSV z MHTML przez C++" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo połączyć CSV z MHTML? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="C++ biblioteka do połączenia CSV z MHTML" %}}
