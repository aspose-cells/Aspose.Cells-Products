...
+ Charger le fichier TXT à l'aide de la classe Workbook.
...
{{% blocks/products/pf/agp/code-block title="Rechercher des fichiers TXT - C#" offSpacer="" %}}
