---
title:  Mesclar SXC para HTM via C++
url: /pt/cpp/merger/merge-sxc-to-htm/ 
description: Mesclar SXC para HTM Online gratuitamente. Online grátis SXC para fusão HTM. Mesclar SXC para Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS e muito mais.
---
...
O exemplo a seguir demonstra como mesclar SXC com HTM em C++.
...
{{% cells-merger title="Aplicativo gratuito para mesclar SXC para HTM on-line" InputFormat="sxc" InputFormat2="htm" outformat="htm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
