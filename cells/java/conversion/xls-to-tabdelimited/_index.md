...
{{< blocks/products/pf/upper-banner h1="Convert XLS to TABDELIMITED via Java" h2="Native Java library to export Excel & OpenOffice spreadsheets to TABDELIMITED." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/cells/272x272/aspose_cells-for-java.png" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/code-block title="Convert XLS to TABDELIMITED - Java‎" offSpacer="" %}}

```cs
// load the XLS file in an instance of Workbook
Workbook book = new Workbook("template.xls");
// save XLS as TABDELIMITED
