...
1. Charger le fichier XLSX en instanciant la classe Workbook1. Utiliser la méthode protect(..) avec ProtectionType et Password1. Enregistrez le fichier XLSX protégé par la méthode save()
