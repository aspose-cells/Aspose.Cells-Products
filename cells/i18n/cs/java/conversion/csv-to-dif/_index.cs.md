...
{{% blocks/products/pf/agp/content h2="Jak převést CSV na DIF pomocí Java" %}}

 K vykreslení CSV do DIF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu CSV na DIF prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor CSV na DIF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor CSV s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením DIF a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor DIF
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze CSV na DIF Java" offSpacer="" %}}
