---
title: Объединить NUMBERS в SPREADSHEETML - Объединить NUMBERS в SPREADSHEETML в C#
url: /ru/net/merger/merge-numbers-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Бесплатное онлайн-объединение NUMBERS в формат сохранения SPREADSHEETML. C# Объедините NUMBERS в формат SPREADSHEETML. Объединить NUMBERS в SPREADSHETML в C#. Объединить NUMBERS.
...
{{% blocks/products/pf/agp/content h2="Объедините NUMBERS в SPREADSHEETML в C# онлайн бесплатно" %}}

В следующем примере показано, как объединить NUMBERS в SPREADSHEETML в Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Следуйте простым шагам, чтобы объединить NUMBERS в SPREADSHEETML. Загрузите свои файлы, вызовите метод Workbook.Combine для объединения файлов, а затем сохраните его в файл SPREADSHEETML. Если вы разрабатываете код в C#, это будет проще, чем кажется. См. пример C#, в котором NUMBERS объединяется с SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Бесплатно онлайн объединить NUMBERS в SPREADSHEETML в C#" InputFormat="numbers" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Как объединить NUMBERS в SPREADSHEETML через C#" %}}

{{% blocks/products/pf/agp/text %}}

 Нужно программно объединить NUMBERS в SPREADSHEETML? Базовый документ сливается и объединяется с[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API можно реализовать всего несколькими строками кода.
...
{{% blocks/products/pf/agp/content h2=".NET библиотека для объединения NUMBERS в SPREADSHEETML" %}}
