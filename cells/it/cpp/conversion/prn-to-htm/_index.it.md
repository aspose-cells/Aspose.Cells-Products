...
Hai bisogno di convertire i file PRN in HTM tramite codice? Gli sviluppatori di C++ possono convertire facilmente i file PRN in HTM in poche righe di codice.
...
1.  Convertire PRN in HTM chiamando il metodo Save().
