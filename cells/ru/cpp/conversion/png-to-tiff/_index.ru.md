...
Нужно программно конвертировать файлы PNG в TIFF? Разработчики C++ могут легко преобразовать PNG в TIFF всего за несколько строк кода.
...
1.  Преобразуйте PNG в TIFF, вызвав метод Save().
