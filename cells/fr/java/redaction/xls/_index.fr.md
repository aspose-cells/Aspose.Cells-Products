---
title:  Rechercher et remplacer le texte dans le document XLS via Java
weight: 7900
description: Exemple de code Java pour supprimer les informations sensibles dans le fichier XLS sur l'environnement d'exécution Java pour les applications JSP/JSF et les applications de bureau.
...
{{% blocks/products/pf/agp/code-block title="Rédiger les dossiers XLS - Java" offSpacer="" %}}
