---
title: Pesquisar documento TSV sem abrir via C++ 
weight: 930
url: /pt/cpp/search/tsv/ 
description: C++ código de exemplo para pesquisar palavras com padrão no arquivo TSV em C++ Runtime Environment para Windows 32 bits, Windows 64 bits e Linux 64 bits.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Pesquisar formatos TSV em C++" h2="Pesquisa de documentos TSV nativa e de alto desempenho usando Aspose.Cells do lado do servidor para C++ APIs, sem o uso de qualquer software como Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
+ Carregue o arquivo TSV instanciando uma classe IWorkbook.
...
+ Salve o arquivo TSV usando o método IWorkbook->Save(.).
