---
title: Group And Ungroup Shapes in Excel Using Python via Java
weight: 371
...
{{% blocks/products/pf/agp/content h2="How to Group And Ungroup Shapes in Excel File Using Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Group And Ungroup Shapes in Excel file using Python via Java" %}}
...
+  Use the [group method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#group(com.aspose.cells.Shape[])) to group shapes in the selected worksheet
+  Use the [ungroup method](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#ungroup(com.aspose.cells.GroupShape)) to ungroup shapes in the selected worksheet
