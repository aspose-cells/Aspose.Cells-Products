...
{{% blocks/products/pf/agp/content h2="Сохраните XML-файл в SXC в C#" %}}

Следующий пример демонстрирует, как преобразовать XML в формат SXC в формате C#.
...
1.  Преобразовать XML в формат SXC, вызвав метод Workbook.Save.
