...
description: Aspose Excel. Toto komplexní řešení poskytuje vývojářům Python plně integrovaný přístup k převodu IMAGE do formátu XLSB, což umožňuje bezproblémové ukládání dat IMAGE do formátu XLSB pomocí knihovny Aspose.Cells, a to vše prostřednictvím efektivního a přizpůsobitelného kódu Python.
...
{{% blocks/products/pf/agp/content h2="Převést IMAGE na XLSB pomocí knihovny Excel Python" %}}
...
{{% blocks/products/pf/agp/content h2="Uložit OBRÁZEK na XLSB v Python knihovně Excel" %}}

Následující příklad ukazuje, jak převést IMAGE na XLSB v knihovně Excel Python.
...
{{% cells-convert title="Ukázkový kód pro převod IMAGE na XLSB prostřednictvím knihovny Excel Python" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="png" outformat="xlsb" IsLandingPage="true" language="pythonjava" %}}
...
{{% blocks/products/pf/agp/content h2="Python Knihovna Excel pro převod OBRÁZKU na XLSB" %}}
