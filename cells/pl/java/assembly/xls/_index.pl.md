---
title:  Generuj raporty w XLS Pliki via Java
weight: 1090
description: Java przykładowy kod do tworzenia raportów w formacie XLS w Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masowe generowanie raportów w formacie XLS via Java" h2="Generuj raporty w formacie XLS, korzystając ze źródła danych i szablonu." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak generować raporty XLS za pomocą Java" %}}
 ...
 Aby utworzyć raporty plików XLS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki do wygenerowania XLS Raporty via Java" %}}
...
1.  Zapisz wynik w formacie XLS za pomocą metody Workbook.save
