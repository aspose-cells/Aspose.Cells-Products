---
title: Converter XLSB para XLSX via Java 
weight: 5700
url: /pt/java/conversion/xlsb-to-xlsx/ 
description: Exemplo de código de conversão Java para formato XLSB para arquivo XLSX. Os programadores podem usar este código de exemplo para exportar planilhas do Excel e OpenOffice para XLSX em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter XLSB para XLSX via Java" h2="Conversão de XLSB para XLSX Java para converter uma ou várias páginas em XLSX usando a biblioteca local Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter XLSB para XLSX usando Java" %}}

 Para renderizar XLSB para XLSX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter XLSB para XLSX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java os desenvolvedores podem facilmente converter arquivos XLSB para XLSX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo XLSB com uma instância da classe Workbook1. Chame o método Workbook.save1. Passe o caminho de saída com a extensão XLSX e SaveFormat como parâmetros1. Verifique o caminho especificado para o arquivo XLSX resultante
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de XLSB para XLSX Java" offSpacer="" %}}

```cs
// carregar o arquivo XLSB em uma instância do Workbook
Workbook book = new Workbook("template.xlsb");
// salve XLSB como XLSX
