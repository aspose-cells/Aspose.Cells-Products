---
title: Вставьте выноски в Excel, используя Python via Java
weight: 360
description: Python via Java исходный код для вставки выносок в Excel.
...
{{% blocks/products/pf/agp/content h2="Как вставить выноски в файл Excel с помощью Python via Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке выносок в файл Excel с помощью Python via Java" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить выноски на выбранный лист
...
{{% blocks/products/pf/agp/code-block title="Вставить выноски — Python via Java" offSpacer="" %}}
