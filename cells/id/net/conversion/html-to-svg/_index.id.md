...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET pengembang dapat dengan mudah memuat & mengonversi file HTML ke SVG hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file HTML dengan instance Workbook1. Panggil metode Workbook.Save1. Lewati jalur keluaran dengan ekstensi SVG sebagai parameter1. Periksa jalur yang ditentukan untuk file SVG yang dihasilkan
...
{{% cells-convert title="Aplikasi Gratis dan Kode Contoh untuk Mengonversi HTML ke SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="svg" IsLandingPage="true" %}}
