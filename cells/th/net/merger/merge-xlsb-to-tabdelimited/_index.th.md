---
title: รวม XLSB ถึง TABDELIMITED - รวม XLSB ถึง TABDELIMITED ใน C#
url: /th/net/merger/merge-xlsb-to-tabdelimited/ 
description: Aspose เอ็กเซล. C# Aspose.Cells รวม XLSB เป็นรูปแบบการบันทึก TABDELIMITED C# รวม XLSB เป็นรูปแบบ TABDELIMITED รวม XLSB ไปที่ TABDELIMITED ใน C# XLSB รวม
...
{{% blocks/products/pf/agp/content h2="รวม XLSB ไปที่ TABDELIMITED ใน C#" %}}

ตัวอย่างต่อไปนี้สาธิตวิธีการผสาน XLSB ไปยัง TABDELIMITED ใน Aspose.Cells for .NET
{{% blocks/products/pf/agp/text %}}

ทำตามขั้นตอนง่าย ๆ เพื่อรวม XLSB เข้ากับ TABDELIMITED อัปโหลดไฟล์ของคุณ เรียกใช้เมธอด Workbook.Combine สำหรับการรวมไฟล์ จากนั้นบันทึกลงในไฟล์ TABDELIMITED หากคุณพัฒนาโค้ดใน C# สิ่งนี้จะง่ายกว่าที่คิด ดูตัวอย่าง C# ที่ผสาน XLSB เข้ากับ TABDELIMITED

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="โค้ดตัวอย่างที่จะรวม XLSB ถึง TABDELIMITED ใน C#" InputFormat="xlsb" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="วิธีผสาน XLSB ไปยัง TABDELIMITED ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 ต้องการรวม XLSB เข้ากับ TABDELIMITED โดยทางโปรแกรมหรือไม่ เอกสารพื้นฐานที่ผสานและต่อเข้าด้วยกัน[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API สามารถทำได้โดยใช้โค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/content h2=".NET ไลบรารี่เพื่อรวม XLSB ไปที่ TABDELIMITED" %}}
