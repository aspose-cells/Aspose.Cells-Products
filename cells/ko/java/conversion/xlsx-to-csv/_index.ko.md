---
title: Java을(를) 통해 XLSX를 CSV로 변환 
weight: 2540
url: /ko/java/conversion/xlsx-to-csv/ 
description: XLSX 형식을 CSV 파일로 변환하는 샘플 Java 변환 코드. 프로그래머는 이 예제 코드를 사용하여 웹 또는 데스크톱 Java 기반 응용 프로그램 내에서 Excel 및 OpenOffice 스프레드시트를 CSV로 내보낼 수 있습니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java을(를) 통해 XLSX를 CSV로 변환" h2="온프레미스 Java 라이브러리를 사용하여 단일 또는 여러 페이지를 CSV로 변환하는 XLSX에서 CSV Java로 변환" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 XLSX를 CSV로 변환하는 방법" %}}

 XLSX를 CSV로 렌더링하기 위해 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Java을(를) 통해 XLSX를 CSV로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 Java 개발자는 몇 줄의 코드로 XLSX 파일을 CSV로 쉽게 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1. Workbook 클래스의 인스턴스로 XLSX 파일 로드1. Workbook.save 메서드 호출1. CSV 확장자 및 SaveFormat을 매개변수로 사용하여 출력 경로 전달1. 결과 CSV 파일의 지정된 경로 확인
...
{{% blocks/products/pf/agp/code-block title="XLSX에서 CSV로 Java 변환 소스 코드" offSpacer="" %}}
