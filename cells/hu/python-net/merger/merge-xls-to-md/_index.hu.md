...
url: /hu/python-net/merger/merge-xls-to-md/ 
...
A következő példa bemutatja, hogyan egyesítheti a XLS-et a Aspose.Cells-es for Python-es via .NET-es MD-vel.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a XLS-et az MD-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Az API-k néhány sornyi kóddal elkészíthetők.
