---
title: "SXC konvertálása DIF-re a következőn keresztül: Python"
url: /hu/python-java/conversion/sxc-to-dif/
description: Mintakód az sxc to dif Python konverzióhoz. Használjon API példakódot kötegelt sxc fájlokhoz a Python alkalmazáson belüli átalakításhoz.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SXC konvertálása DIF-re a következőn keresztül: Python" h2="Exportálja az Excel® táblázatokat DIF formátumba Python API-k használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DIF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Az SXC konvertálása DIF-re a következővel: Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az SXC konvertálása DIF-re a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 A Python fejlesztői egyszerűen betölthetnek és konvertálhatnak SXC fájlokat DIF-re, mindössze néhány sornyi kóddal.
