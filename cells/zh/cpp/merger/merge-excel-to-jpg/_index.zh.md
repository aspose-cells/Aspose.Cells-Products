...
按照简单的步骤将 EXCEL 合并为 JPG。上传文件，调用Workbook.Combine方法合并文件，然后保存为JPG文件。如果您在 C++ 中开发代码，这会比听起来更简单。请参阅 C++ 将 EXCEL 合并为 JPG 的示例。
...
需要以编程方式将 EXCEL 合并为 JPG？基本文档合并和连接[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2="C++ 合并EXCEL到JPG的库" %}}
