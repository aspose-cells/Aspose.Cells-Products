...
description: Aspose إكسل. C# Aspose.Cells. C# Aspose Cells. مجاني على الإنترنت C# تحويل TABDELIMITED إلى XML saveformat. C# TABDELIMITED إلى تنسيق XML. حفظ TABDELIMITED إلى XML C#.
...
{{% blocks/products/pf/agp/content h2="حفظ TABDELIMITED إلى XML في C# عبر الإنترنت مجانًا" %}}
...
هل تحتاج إلى تحويل ملفات TABDELIMITED إلى XML برمجيًا؟ يمكن للمطورين .NET تحميل وتحويل TABDELIMITED بسهولة إلى XML في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل TABDELIMITED إلى XML عن طريق استدعاء أسلوب Workbook.Save.
1.  احصل على نتيجة التحويل من TABDELIMITED إلى XML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# مكتبة لتحويل TABDELIMITED إلى XML" %}}
