---
title:  Illessze be a WordArt-ot az Excelbe a Python számon keresztül
weight: 200
description: Python forráskód a WordArt Excelbe való beillesztéséhez.
---
...
{{% blocks/products/pf/agp/content h2="WordArt beszúrása Excel fájlba a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A WordArt Excel-fájlba való beszúrásának lépései a Python számon keresztül" %}}
...
+ Használja a shapecollection add metódusát WordArt beszúrásához a kiválasztott munkalapba.
...
-  Telepítés: Aspose.Cells for Python via .NET innen<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> , használja a parancsot a következőképpen:<code>$ pip install aspose-cells-python</code>.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="WordArt beszúrása – Python" offSpacer="" %}}
