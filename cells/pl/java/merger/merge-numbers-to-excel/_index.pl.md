---
title: Scal NUMERY do EXCEL - Połącz NUMERY do EXCEL w Java
url: /pl/java/merger/merge-numbers-to-excel/ 
description: Aspose Excel. Java Aspose.Cells. Scal NUMERY w formacie zapisu EXCEL. Java Połącz LICZBY do formatu EXCEL. Scal NUMBERS do EXCEL w Java. NUMBERS Scal.
...
{{% blocks/products/pf/agp/content h2="Połącz NUMERY z EXCEL w Java" %}}

Poniższy przykład pokazuje, jak połączyć NUMBERS z EXCEL w Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby połączyć NUMERY z formatem EXCEL. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz je w pliku EXCEL. Jeśli opracujesz kod w Java, będzie to prostsze niż się wydaje. Zobacz przykład Java, który łączy NUMBERS z EXCEL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia NUMERÓW z formatem EXCEL w Java" InputFormat="numbers" InputFormat2="xlsx" outformat="xlsx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć NUMERY z EXCEL via Java" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo połączyć NUMERY z EXCEL? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Java](https://products.aspose.com/cells/java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Java biblioteka do łączenia NUMERÓW z EXCEL-em" %}}
