---
title: XLTM'i PRN ile birleştir - XLTM'i C#'de PRN ile birleştir
url: /tr/net/merger/merge-xltm-to-prn/ 
description: Aspose excel. C# Aspose.Cells. XLTM'i PRN saveformat'a Ücretsiz Çevrimiçi Birleştirme. C# XLTM'i PRN formatına birleştirin. XLTM'i C#'de PRN ile birleştir. XLTM Birleştir.
...
{{% blocks/products/pf/agp/content h2="XLTM\'i C# Online\'da PRN ile Ücretsiz Olarak Birleştirin" %}}

Aşağıdaki örnek, XLTM'in Aspose.Cells for .NET'de PRN ile nasıl birleştirileceğini gösterir.
...
{{% cells-merger title="XLTM\'i C#\'de PRN ile Birleştirmek için Ücretsiz Çevrimiçi" InputFormat="xltm" InputFormat2="prn" outformat="prn" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="XLTM\'i C# aracılığıyla PRN\'ye Birleştirme" %}}

{{% blocks/products/pf/agp/text %}}

 XLTM'i programlı olarak PRN ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2="XLTM\'i PRN ile birleştirmek için .NET kitaplığı" %}}
