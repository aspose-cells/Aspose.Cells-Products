---
title:  Sloučit CSV do POWERPOINT přes C++
...
Následující příklad ukazuje, jak sloučit CSV do POWERPOINT v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení CSV do POWERPOINT online" InputFormat="csv" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
