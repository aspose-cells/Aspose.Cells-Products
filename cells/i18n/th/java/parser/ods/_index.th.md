---
title: แยกข้อความและรูปภาพจากเอกสาร ODS ผ่าน Java 
weight: 4740
url: /th/java/parser/ods/ 
description: Java โค้ดตัวอย่างเพื่อดึงข้อความและรูปภาพจากไฟล์ ODS บน Java Runtime Environment สำหรับแอปพลิเคชัน JSP/JSF และแอปพลิเคชันเดสก์ท็อป
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แยกวิเคราะห์รูปแบบ ODS ใน Java" h2="การแยกวิเคราะห์เอกสาร ODS ดั้งเดิมและประสิทธิภาพสูงโดยใช้ API ฝั่งเซิร์ฟเวอร์ Aspose.Cells for Java โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Adobe PDF" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแยกวิเคราะห์ไฟล์ ODS โดยใช้ Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแยกวิเคราะห์ไฟล์ ODS ใน Java" %}}
...
+ โหลดเอกสาร ODS โดยใช้คลาสสมุดงาน
...
{{% blocks/products/pf/agp/code-block title="แยกวิเคราะห์ไฟล์ ODS - Java" offSpacer="" %}}
