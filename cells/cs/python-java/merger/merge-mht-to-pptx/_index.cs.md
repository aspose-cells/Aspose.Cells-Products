...
description: Aspose Excel. Python Aspose.Cells. Sloučit MHT do formátu uložení PPTX. Python Zkombinujte MHT do formátu PPTX. Sloučit MHT na PPTX v Python. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT na PPTX v Python" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení MHT s PPTX v Python" InputFormat="mht" InputFormat2="pptx" outformat="pptx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}
