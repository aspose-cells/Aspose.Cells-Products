---
title: Konwertuj XLT na XLTM za pomocą aplikacji C++ 
url: /pl/cpp/conversion/xlt-to-xltm/ 
description: Przykładowy kod konwersji C++ dla dokumentu XLT do formatu XLTM. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji XLT na XLTM w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLT na XLTM za pomocą C++" %}}

 Aby przekonwertować XLT na XLTM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować XLT na XLTM za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik XLT na XLTM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLT przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLTM).1. Plik XLTM zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLTM w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLT do XLTM C++ Kod źródłowy konwersji" offSpacer="" %}}
