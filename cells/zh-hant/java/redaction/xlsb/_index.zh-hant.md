---
title: 在 XLSB 文檔 via Java 中搜索和替換文本
weight: 4590
description: Java 示例代碼，用於編輯 Java JSP/JSF 應用程序和桌面應用程序運行時環境中 XLSB 文件中的敏感信息。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="在 Java 中編輯 XLSB 格式" h2="本機和高性能 XLSB 使用服務器端 Aspose.Cells for Java API 記錄敏感的編輯信息，無需使用任何軟件，如 Microsoft 或 Adobe PDF。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
