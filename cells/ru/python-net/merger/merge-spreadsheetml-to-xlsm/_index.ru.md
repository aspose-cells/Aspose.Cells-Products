---
title:  Объединить SPREADSHETML в XLSM через Python
...
В следующем примере показано, как объединить SPREADSHEETML с XLSM в Python.
