---
title:  Συγχώνευση PRN στο XLS μέσω Python
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το PRN στο XLS στο Python.
