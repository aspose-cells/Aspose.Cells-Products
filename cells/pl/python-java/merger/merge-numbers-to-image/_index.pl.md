...
url: /pl/python-java/merger/merge-numbers-to-image/ 
...
Poniższy przykład pokazuje, jak połączyć NUMBERS z IMAGE w Aspose.Cells for Python via Java.
...
Chcesz programowo scalić NUMBERS z IMAGE? Podstawowy dokument łączący i łączący z[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
