---
title: Combinar XLSM a TSV - Combinar XLSM a TSV en Java
url: /es/java/merger/merge-xlsm-to-tsv/ 
description: AsposeExcel. Java Aspose.Cells. Combinar gratis en línea XLSM a TSV guardar formato. Java Combina el formato XLSM con el TSV. Combinar XLSM a TSV en Java. XLSM Combinar.
...
El siguiente ejemplo muestra cómo combinar XLSM con TSV en Aspose.Cells for Java.
...
{{% cells-merger title="Gratis en línea para fusionar XLSM a TSV en Java" InputFormat="xlsm" InputFormat2="tsv" outformat="tsv" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cómo fusionar XLSM a TSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

 ¿Necesita fusionar XLSM con TSV mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Java](https://products.aspose.com/cells/java) Las API se pueden hacer con solo unas pocas líneas de código.
