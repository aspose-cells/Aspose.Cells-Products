...
weight: 4820
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Çalışma Zamanı Ortamı'ndaki XLSB dosya meta verilerini düzenlemek veya görüntülemek için örnek kod.
...
{{% blocks/products/pf/agp/content h2="C++ Kullanılarak XLSB Meta Verisi Nasıl Alınır?" %}}
...
+ WorkbookMetadata'yı kullanarak XLSB dosyasını yükleyin
