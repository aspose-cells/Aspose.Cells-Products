---
title: C# SXC do XLS - SXC do XLS Konwerter
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji formatu SXC do XLS, umożliwiając bezproblemowe zapisywanie danych SXC do formatu XLS za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz SXC do XLS w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować SXC na XLS w C#.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby przekonwertować numer SXC na numer XLS. Prześlij plik SXC, a następnie po prostu zapisz go jako plik XLS. Zarówno do odczytu SXC, jak i do zapisu XLS można używać w pełni kwalifikowanych nazw plików. Treść i formatowanie wyjściowego XLS będą identyczne z oryginalnym dokumentem SXC.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Przykładowy kod do konwersji SXC na XLS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="sxc" outformat="xls" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Jak przekonwertować SXC na XLS przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo przekonwertować pliki SXC na XLS? Programiści .NET mogą łatwo załadować i przekonwertować SXC na XLS w zaledwie kilku linijkach kodu.
...
1.  Konwertuj SXC na XLS wywołując metodę Workbook.Save.
1.  Uzyskaj wynik konwersji SXC na XLS.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# biblioteka do konwersji SXC na XLS" %}}
