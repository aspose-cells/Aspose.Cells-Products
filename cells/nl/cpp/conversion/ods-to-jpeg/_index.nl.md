---
title: Converteer ODS naar JPEG via C++ applicatie 
weight: 7230

description: Voorbeeld C++ conversiecode voor ODS-document naar JPEG-indeling. Programmeurs kunnen deze broncode gebruiken voor batch-ODS-naar-JPEG-conversie binnen elke C++-toepassing.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer ODS naar JPEG via C++" h2="Hoogwaardige ODS-naar-JPEG-conversie met behulp van de C++-bibliotheek zonder installatie van Microsoft Excel, OpenOffice of Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ ontwikkelaars kunnen ODS-bestanden eenvoudig in slechts een paar regels code naar JPEG converteren.

{{% /blocks/products/pf/agp/text %}}

1. Laad het ODS-bestand met Factory::CreateIWorkbook.1. Selecteer het eerste werkblad.1. Stel (JPEG)-opties in.1. Doorloop elke pagina van het blad en render.1. Open het JPEG-bestand in een compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="ODS naar JPEG C++ Conversiebroncode" offSpacer="" %}}
