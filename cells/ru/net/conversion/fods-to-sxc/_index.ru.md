---
title: Преобразователь C# FODS в SXC - FODS в SXC
description: Aspose Эксель. Преобразуйте FODS в SXC быстро и легко с помощью Aspose.Cells. C# FODS в SXC. C# Сохранить FODS в SXC. Сохранить FODS как 07611134 81, используя C#.
...
{{% blocks/products/pf/agp/content h2="Сохраните с FODS по SXC в C#." %}}
...
{{% cells-convert title="Пример кода для преобразования FODS в SXC" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="sxc" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Как преобразовать FODS в SXC через C#" %}}

{{% blocks/products/pf/agp/text %}}

Нужно программно преобразовать файлы FODS в SXC? Разработчики .NET могут легко загрузить и преобразовать FODS в SXC всего за несколько строк кода.
