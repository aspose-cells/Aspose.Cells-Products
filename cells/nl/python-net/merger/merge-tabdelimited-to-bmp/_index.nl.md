...
url: /nl/python-net/merger/merge-tabdelimited-to-bmp/ 
...
In het volgende voorbeeld ziet u hoe u TABDELLIMITED kunt samenvoegen tot BMP in Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Wilt u TABDELLIMITED programmatisch samenvoegen met BMP? Een basisdocument dat samenvoegt en samenvoegt met[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API's kunnen met slechts enkele regels code worden uitgevoerd.
