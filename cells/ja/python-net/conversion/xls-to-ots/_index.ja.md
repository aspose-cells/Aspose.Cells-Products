...
description: Aspose Excel。Python Excel。Aspose.Cells を使用して、XLS を OTS にすばやく簡単に変換します。Python XLS を OTS に変換します。Python XLS を OTS に保存します。Python Excel ライブラリを使用して、XLS を OTS として保存します。
