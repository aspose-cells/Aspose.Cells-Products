...
{{% blocks/products/pf/agp/content h2="Comment créer un fichier HTM en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="L\'exemple de code montre comment créer un fichier HTM en C#." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C# pour créer un fichier HTM" %}}
