...
description: Aspose Excel'de. Java Aspose.Cells ile hızlı ve kolay bir şekilde SXC Dosyası oluşturun. Java'i kullanarak SXC dosyası oluşturun. Java'de SXC oluşturun. Java SXC Oluşturucu.
...
1. Save() yöntemini kullanarak çalışma kitabını SXC biçiminde kaydedin.
