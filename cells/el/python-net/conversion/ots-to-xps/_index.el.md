...
description: Aspose Excel. Μετατρέψτε το OTS σε XPS γρήγορα και εύκολα με το Aspose.Cells. Python OTS σε XPS. Python Αποθήκευση OTS σε XPS. Αποθηκεύστε το OTS ως 07617837481 χρησιμοποιώντας 3.
...
{{% blocks/products/pf/agp/content h2="Αποθηκεύστε το OTS στο XPS στο Python" %}}
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή OTS σε XPS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="ots" outformat="xps" IsLandingPage="true" language="pythonnet" %}}
