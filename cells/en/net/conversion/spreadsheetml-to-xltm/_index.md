...
The following example demonstrates how to convert SPREADSHEETML to XLTM document format in C#.
{{% blocks/products/pf/agp/text %}}

Follow the easy steps to convert SPREADSHEETML file into XLTM format. Upload your SPREADSHEETML file, then simply save it as XLTM file. For both SPREADSHEETML reading and XLTM writing you can use fully qualified filenames. The output XLTM content and formatting will be identical to the original SPREADSHEETML document.
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert SPREADSHEETML files to XLTM in just a few lines of code.
