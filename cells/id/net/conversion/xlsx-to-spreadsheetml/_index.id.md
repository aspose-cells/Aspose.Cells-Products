---
title: C# XLSX ke SPREADSHEETML - XLSX ke SPREADSHEETML Konverter
description: Aspose Excel. Solusi komprehensif ini menyediakan C# pengembang dengan pendekatan terintegrasi penuh untuk mengkonversi XLSX ke format SPREADSHEETML, memungkinkan penyimpanan data XLSX ke format SPREADSHEETML dengan mudah menggunakan pustaka Aspose.Cells, semuanya melalui kode C# yang efisien dan dapat disesuaikan.
...
{{% blocks/products/pf/agp/content h2="Simpan XLSX ke SPREADSHEETML di C#" %}}

Contoh berikut menunjukkan cara mengkonversi XLSX ke SPREADSHEETML di C#.
...
{{% cells-convert title="Contoh Kode untuk Mengonversi XLSX ke SPREADSHEETML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xlsx" outformat="xml" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengubah XLSX menjadi SPREADSHEETML melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file XLSX ke SPREADSHEETML secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi XLSX ke SPREADSHEETML hanya dalam beberapa baris kode.
...
1.  Konversikan XLSX ke SPREADSHEETML dengan memanggil metode Workbook.Save.
1.  Dapatkan hasil konversi XLSX ke SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C# library untuk mengkonversi XLSX ke SPREADSHEETML" %}}
