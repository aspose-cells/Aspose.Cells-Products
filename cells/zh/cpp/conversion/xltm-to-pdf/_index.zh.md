...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ 开发人员只需几行代码即可轻松地将 XLTM 文件转换为 PDF。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Factory::CreateIWorkbook 加载 XLTM 文件。1. 调用 Save() 方法。1. 传递带有 (PDF) 文件扩展名的输出文件路径。1. PDF 文件将保存在指定的路径。1. 在兼容程序中打开 PDF 文件。
...
{{% blocks/products/pf/agp/code-block title="XLTM转PDFC++转换源码" offSpacer="" %}}
