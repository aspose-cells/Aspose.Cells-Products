---
title: Java IMAGE en TXT - Convertisseur en ligne IMAGE en TXT
description: Aspose Excel. Java Aspose.Cells. Java Aspose Cells. Gratuit en ligne Java Convertir IMAGE en format de sauvegarde TXT. Java IMAGE au format TXT. Enregistrez IMAGE au TXT Java.
...
{{% blocks/products/pf/agp/content h2="Enregistrez IMAGE au TXT en Java en ligne gratuitement" %}}

L'exemple suivant montre comment convertir IMAGE en TXT en Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour convertir IMAGE en TXT. Téléchargez votre fichier IMAGE, puis enregistrez-le simplement en tant que fichier TXT. Pour la lecture IMAGE et l'écriture TXT, vous pouvez utiliser des noms de fichiers complets. Le contenu et la mise en forme de la sortie TXT seront identiques au document IMAGE d'origine.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="Application gratuite et exemple de code pour convertir IMAGE en TXT en ligne" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="png" outformat="txt" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir IMAGE en TXT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers IMAGE en TXT par programmation ? Les développeurs Java peuvent facilement convertir IMAGE en TXT en quelques lignes de code.
...
1.  Convertissez IMAGE en TXT en appelant la méthode Workbook.save.
1.  Obtenez le résultat de la conversion de IMAGE en TXT.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothèque Java pour convertir IMAGE en TXT" %}}
{{% blocks/products/pf/agp/text %}}
