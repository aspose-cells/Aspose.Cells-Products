---
title: Java FODS naar BEELD - FODS naar BEELD Converter
description: Aspose Excel. Converteer FODS snel en eenvoudig naar IMAGE met Aspose.Cells. Java FODS naar IMAGE. Java Sla FODS op in AFBEELDING. Sla FODS op als AFBEELDING met Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converteer FODS naar AFBEELDING in Java" h2="Snelle Java-bibliotheek voor het converteren van FODS naar IMAGE. Dit is een professionele softwareoplossing voor het importeren en exporteren van FODS, IMAGE en vele andere formaten met behulp van Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Sla FODS op in AFBEELDING in Java" %}}

Het volgende voorbeeld laat zien hoe u FODS converteert naar IMAGE in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe FODS naar AFBEELDING via Java te converteren" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u FODS-bestanden programmatisch naar IMAGE converteren? Java-ontwikkelaars kunnen FODS eenvoudig in slechts een paar regels code naar IMAGE converteren.
...
{{% blocks/products/pf/agp/content h2="Java bibliotheek om FODS naar IMAGE te converteren" %}}
{{% blocks/products/pf/agp/text %}}
