---
title: 通過 C++ 的 XLSB 文檔圖表 
weight: 5200
url: /zh-hant/cpp/chart/xlsb/ 
description: C++ 用於在 XLSB 文件中繪製和轉換圖表或圖表的示例代碼，適用於 C++ Windows 32 位、Windows 64 位和 Linux 64 位運行時環境。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB 格式化 C++ 中的圖表" h2="使用用於 C++ API 的服務器端 Aspose.Cells 的原生和高性能 XLSB 文檔圖表，無需使用 Microsoft 或 Adobe PDF 等任何軟件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSB" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 創建 XLSB 文件圖表" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 C++ 中創建 XLSB 文件圖表的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="創建 XLSB 文件圖表 - C++" offSpacer="" %}}
