...
{{% blocks/products/pf/agp/content h2="TXT konvertálása XLT-vé a Java használatával" %}}

 Ahhoz, hogy a TXT-t XLT-vé rendereljük, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A TXT XLT-vé konvertálásának lépései a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői könnyedén konvertálhatják a TXT fájlt XLT-vé, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be TXT-fájlt a Workbook osztály egy példányával1. Hívja a Workbook.save metódust1. Adja meg a kimeneti útvonalat XLT kiterjesztéssel és SaveFormat paraméterekkel1. Ellenőrizze az eredményül kapott XLT fájl megadott elérési útját
...
{{% blocks/products/pf/agp/code-block title="TXT-ből XLT-be Java konverziós forráskód" offSpacer="" %}}

```cs
// töltse be a TXT fájlt a munkafüzet egy példányába
Workbook book = new Workbook("template.txt");
// TXT mentése XLT-ként
...
{{< blocks/products/pf/agp/demobox sectionTitle="TXT-ből XLT-be konvertáló élő bemutatók" sectionDescription="[Konvertálja a TXT-t XLT-vé](https://products.aspose.app/cells/conversion/txt-to-xlt) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel TXT-fájlját, és azonnal XLT-vé konvertálódik." >}}
