...
description: Convert HTML to PNG format in C# code. Save HTML as PNG using VB.NET, Asp.NET or any .NET based application.
---
...
The following example demonstrates how to convert HTML to PNG document format in C#.
