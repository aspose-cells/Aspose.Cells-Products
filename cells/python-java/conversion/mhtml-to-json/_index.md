---
title: Convert MHTML to JSON via Python
url: /python-java/conversion/mhtml-to-json/
description: Sample code for mhtml to json Python conversion. Use API example code for batch mhtml files to json conversion within Python application.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert MHTML to JSON Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MHTML to JSON via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python developers can easily load & convert MHTML files to JSON in just a few lines of code.
...
{{% cells-convert title="Free App and Sample Code to Convert MHTML to JSON" formats=pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx InputFormat=mhtml outformat=json IsLandingPage=true language=python %}}
