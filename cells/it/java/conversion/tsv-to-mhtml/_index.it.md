---
title: Converti TSV in MHTML tramite Java 
weight: 4970

description: Esempio di codice di conversione Java per il formato TSV in file MHTML. I programmatori possono utilizzare questo codice di esempio per esportare fogli di calcolo Excel e OpenOffice in MHTML all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti TSV in MHTML tramite Java" h2="Conversione da TSV a MHTML Java per convertire pagine singole o multiple in MHTML utilizzando la libreria Java on-premise." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire TSV in MHTML utilizzando Java" %}}

 Per rendere TSV in MHTML, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire TSV in MHTML tramite Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java gli sviluppatori possono convertire facilmente file TSV in MHTML in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file TSV con un'istanza della classe Workbook1. Chiama il metodo Workbook.save1. Passa il percorso di output con estensione MHTML e SaveFormat come parametri1. Controllare il percorso specificato per il file MHTML risultante
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da TSV a MHTML Java" offSpacer="" %}}

```cs
// caricare il file TSV in un'istanza di Workbook
Workbook book = new Workbook("template.tsv");
// salva TSV come MHTML
