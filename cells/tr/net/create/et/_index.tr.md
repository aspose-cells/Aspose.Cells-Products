...
{{% blocks/products/pf/agp/text %}}
 ...
 Geliştiricilerin, yalnızca birkaç kod satırında veri işleme için farklı raporlama uygulamalarını çalıştırırken ET dosyalarını oluşturması, yüklemesi, değiştirmesi ve dönüştürmesi kolaydır.
...
{{% blocks/products/pf/agp/content h2="ET dosyası oluşturmak için C# kitaplığı" %}}
