---
title: 将 XLTM 合并至 PDF - 将 XLTM 和 PDF 合并为 Python
url: /zh/python-java/merger/merge-xltm-to-pdf/ 
description: Aspose Excel。Python Excel。将 XLTM 合并为 PDF 保存格式。Python 将 XLTM 合并为 PDF 格式。将 XLTM 合并为 PDF 并入 Python Excel 库中。XLTM 合并。
...
{{% blocks/products/pf/agp/content h2="使用 Python Excel 库将 XLTM 合并到 PDF" %}}

如何将 XLTM 合并到 PDF？使用 Aspose.Cells for Python via Java 库，您只需几行代码即可以编程方式轻松将 XLTM 合并到 PDF。[Aspose.Cells for Python via Java](https://pypi.org/project/aspose-cells)能够构建跨平台应用程序，并具有生成、修改、转换、呈现和打印所有 Excel 文件的能力。Python Excel API 不仅可以在电子表格格式之间进行转换，还可以将 Excel 文件呈现为图像 PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，因此使其成为以行业标准格式交换文档的完美选择。您可以从以下位置安装 Aspose.Cells for Python via Java<a href="https://pypi.org/project/aspose-cells/">pypi</a>，使用命令如下：<code>$ pip install aspose-cells</code>.


{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="将 XLTM 合并到 Python Excel 库中的 PDF" %}}

下面的示例说明如何将 XLTM 和 PDF 合并到 Aspose.Cells for Python via Java 中。
{{% blocks/products/pf/agp/text %}}

按照简单的步骤将 XLTM 合并到 PDF。上传文件，调用 Workbook.Combine 方法合并文件，然后将其保存到 PDF 文件。如果您在 Python 中开发代码，这将比听起来更简单。请参阅将 XLTM 合并到 PDF 的 Python 示例。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="在 Python Excel 库中将 XLTM 合并到 PDF 的示例代码" InputFormat="xltm" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何通过 Python Excel 库将 XLTM 合并到 PDF" %}}

{{% blocks/products/pf/agp/text %}}

需要以编程方式将 XLTM 合并到 PDF 吗？合并和连接的基本文档[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java)只需几行代码即可完成 API。
...
{{% blocks/products/pf/agp/content h2="Python 库将 XLTM 合并至 PDF" %}}
