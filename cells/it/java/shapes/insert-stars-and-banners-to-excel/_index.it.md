---
title:  Inserisci Inserisci stelle e banner in Excel via .NET
weight: 381
...
{{< blocks/products/pf/i18n/upper-banner h1="Inserisci Inserisci stelle e banner in Excel via Java" h2="Inserisci oggetti utilizzando le API lato server senza alcun software come Microsoft o Open Office, Adobe PDF, ecc." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Come inserire Inserisci stelle e banner in un file Excel utilizzando Java" %}}

 Per inserire Insert Stars And Banners nel file excel, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per inserire Inserisci stelle e banner nel file Excel via Java" %}}
...
+ Seleziona Foglio di lavoro tramite il suo indice.
 + Usa il[aggiungere metodo](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-)per inserire Inserisci stelle e banner nel foglio di lavoro selezionato
...
{{% blocks/products/pf/agp/code-block title="Inserisci Inserisci Stelle E Striscioni - Java" offSpacer="" %}}
