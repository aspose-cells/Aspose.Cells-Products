...
description: Aspose Excel. Gere e manipule arquivos XLTX sem esforço com a biblioteca Aspose.Cells for Python via .NET. Esta poderosa biblioteca API oferece uma solução simplificada e eficiente para criar, editar e gerenciar arquivos XLTX diretamente em seus aplicativos Python, atendendo às necessidades específicas dos desenvolvedores com alta precisão.
...
1.  Use o método Salvar para salvar a pasta de trabalho como arquivo XLTX.

{{% blocks/products/pf/agp/code-block title="O código de exemplo mostra como criar o arquivo XLTX na biblioteca Excel Python." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Python Biblioteca Excel para criar arquivo XLTX" %}}
