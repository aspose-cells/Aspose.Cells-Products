...
description: Aspose Exceller. Convertissez XML en OTS rapidement et facilement avec Aspose.Cells. Java XML en OTS. Java Enregistrez XML dans OTS. Enregistrez XML au format OTS en utilisant Java.
...
{{% blocks/products/pf/agp/content h2="Convertir XML en OTS à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/content h2="Enregistrer XML dans OTS dans Java" %}}

L'exemple suivant montre comment convertir XML en OTS dans Java.
...
{{% blocks/products/pf/agp/content h2="Comment convertir XML en OTS via Java" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir des fichiers XML en OTS par programme ? Java peuvent facilement convertir XML en OTS en quelques lignes de code seulement.
