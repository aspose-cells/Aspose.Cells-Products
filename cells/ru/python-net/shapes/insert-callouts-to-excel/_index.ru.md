...
{{% blocks/products/pf/agp/content h2="Как вставить выноски в файл Excel, используя Python via .Net" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке выноски в файл Excel с использованием Python via .Net" %}}
...
+ Выберите Рабочий лист по его индексу.
 + Используйте добавление коллекции форм[метод](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_auto_shape/#AutoShapeType-int-int-int-int-int-int) чтобы вставить выноски в выбранный рабочий лист.
...
{{% blocks/products/pf/agp/code-block title="Вставка выносок — Python via .Net" offSpacer="" %}}
...
Обзор типов выноски
 ...
 Тип автофигуры.<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR2
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-12" style="font-size:0.8rem !important;">
 Тип автофигуры.<br>LINE_CALLOUT_WITH_BORDER_AND_ACCENT_BAR3
    </p>
   </div>
  </div>
 </div>
