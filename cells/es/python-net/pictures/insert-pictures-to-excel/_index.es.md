---
title:  Insertar imagen en Excel usando Python via .Net
weight: 200
description: Python via Código fuente .Net para insertar imagen en Excel.
...
{{< blocks/products/pf/i18n/upper-banner h1="Insertar imagen en Excel usando Python via .Net" h2="Inserte imágenes usando Aspose.Cells\' API sin ningún software como Microsoft u Open Office, Adobe PDF, etc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para insertar una imagen en un archivo Excel usando Python via .Net" %}}
...
+ Seleccione Hoja de trabajo a través de su índice.
 + Utilice el complemento de la colección de imágenes.[método](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/picturecollection/)para insertar una imagen en la hoja de trabajo seleccionada.
