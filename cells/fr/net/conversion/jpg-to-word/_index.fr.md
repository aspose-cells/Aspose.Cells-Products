...
Besoin de convertir des fichiers JPG en WORD par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en WORD en quelques lignes de code.
...
1.  Convertissez le JPG au format WORD en appelant la méthode Workbook.Save.
