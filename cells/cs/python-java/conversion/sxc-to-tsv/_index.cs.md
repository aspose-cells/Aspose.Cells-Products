---
title: Převést SXC na TSV přes Python
url: /cs/python-java/conversion/sxc-to-tsv/
description: Ukázkový kód pro převod sxc na tsv Python. Použijte API ukázkový kód pro dávkový převod souborů sxc na tsv v aplikaci Python.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést SXC na TSV pomocí Python" %}}

 Abychom převedli SXC na TSV, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu SXC na TSV prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno načíst a převést soubory SXC na TSV pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor SXC s instancí Workbook1. Zavolejte metodu Workbook.Save1. Předejte výstupní cestu s rozšířením TSV jako parametrem1. Zkontrolujte zadanou cestu pro výsledný soubor TSV
...
{{% cells-convert title="Bezplatná aplikace a ukázkový kód pro převod SXC na TSV" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="sxc" outformat="tsv" IsLandingPage="true" language="python" %}}
