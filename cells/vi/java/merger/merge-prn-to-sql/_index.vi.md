---
title: Merge PRN to SQL - Kết hợp PRN to SQL trong Java
url: /vi/java/merger/merge-prn-to-sql/ 
description: Aspose Excel. Java Aspose.Cells. Hợp nhất trực tuyến miễn phí định dạng lưu PRN sang SQL. Java Kết hợp định dạng PRN sang SQL. Hợp nhất PRN thành SQL trong Java. Hợp nhất PRN.
...
{{% blocks/products/pf/agp/content h2="Hợp nhất PRN sang SQL trong Java Trực tuyến Miễn phí" %}}

Ví dụ sau minh họa cách hợp nhất PRN với SQL trong Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Làm theo các bước đơn giản để hợp nhất PRN với SQL. Tải lên các tệp của bạn, gọi phương thức Workbook.Combine để hợp nhất các tệp, sau đó lưu tệp đó vào tệp SQL. Nếu bạn phát triển mã trong Java, điều này sẽ đơn giản hơn âm thanh. Xem ví dụ Java hợp nhất PRN với SQL.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Trực tuyến miễn phí để hợp nhất PRN với SQL trong Java" InputFormat="prn" InputFormat2="sql" outformat="sql" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Cách hợp nhất PRN với SQL via Java" %}}
