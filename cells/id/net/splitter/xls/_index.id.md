---
title: Pisahkan File XLS melalui .NET 
weight: 1340
url: /id/net/splitter/xls/ 
description: C# kode sumber untuk membagi dokumen XLS pada .NET Framework, .NET Core, Mono atau Xamarin Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Cara Memisahkan File XLS Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Memisahkan File XLS di C#" %}}
...
+ Muat file XLS dengan jalur lengkap untuk pemisahan.
...
{{% blocks/products/pf/agp/code-block title="Pisahkan File XLS - C#" offSpacer="" %}}
