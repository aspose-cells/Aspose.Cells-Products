---
title:  أدخل WordArt في Excel باستخدام Python via .Net
weight: 200
description: Python via. صافي كود المصدر لإدراج WordArt في Excel.
...
{{% blocks/products/pf/agp/content h2="كيفية إدراج WordArt في ملف Excel باستخدام Python via .Net" %}}
...
+ حدد ورقة العمل من خلال فهرسها.
 + استخدم إضافة مجموعة الأشكال[طريقة](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shapecollection/add_word_art/#PresetWordArtStyle-str-int-int-int-int-int-int) لإدراج WordArt في ورقة العمل المحددة.
...
-  تثبيت Aspose.Cells for Python عبر نت via .NET من<a href="https://pypi.org/project/aspose-cells-python/">pypi</a> ، استخدم الأمر كـ:<code>$ pip install aspose-cells-python</code>.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="إدراج WordArt - Python via .نت" offSpacer="" %}}
