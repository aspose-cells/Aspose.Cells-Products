...
description: Aspose اكسل. قم بتحويل EXCEL إلى TXT بسرعة وسهولة باستخدام Aspose.Cells. Java EXCEL إلى TXT. Java احفظ EXCEL إلى TXT. احفظ EXCEL كـ TXT باستخدام Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="تحويل EXCEL إلى TXT في Java" h2="مكتبة Java عالية السرعة لتحويل EXCEL إلى TXT. هذا حل برمجي احترافي لاستيراد وتصدير EXCEL وTXT والعديد من التنسيقات الأخرى باستخدام Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="تحويل EXCEL إلى TXT باستخدام Java" %}}
...
{{% blocks/products/pf/agp/content h2="احفظ EXCEL إلى TXT في Java" %}}

يوضح المثال التالي كيفية تحويل EXCEL إلى TXT في Java.
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل EXCEL إلى TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="txt" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل EXCEL إلى TXT via Java" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات EXCEL إلى TXT برمجياً؟ يمكن لمطوري Java تحويل EXCEL بسهولة إلى TXT في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة Java لتحويل EXCEL إلى TXT" %}}
{{% blocks/products/pf/agp/text %}}
