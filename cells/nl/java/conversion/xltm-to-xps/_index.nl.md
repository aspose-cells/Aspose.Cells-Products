...
{{% blocks/products/pf/agp/content h2="Sla XLTM op in XPS in Java" %}}

Het volgende voorbeeld laat zien hoe je XLTM omzet naar XPS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe zet ik XLTM om naar XPS of via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet je bestanden met de extensie XLTM programmatisch converteren naar XPS? Ontwikkelaars van Java kunnen bestanden met de extensie XLTM eenvoudig converteren naar XPS met slechts een paar regels code.
