...
weight: 8270
description: Código fuente C# para agregar o eliminar marcas de agua en el archivo XLSM en .NET Framework, .NET Core, Mono o plataformas Xamarin.
