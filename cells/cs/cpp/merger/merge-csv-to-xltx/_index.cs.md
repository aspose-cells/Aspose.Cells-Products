---
title:  Sloučit CSV na XLTX přes C++
...
Následující příklad ukazuje, jak sloučit CSV až XLTX v C++.
...
{{% cells-merger title="Bezplatná aplikace pro sloučení CSV až XLTX online" InputFormat="csv" InputFormat2="xltx" outformat="xltx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
