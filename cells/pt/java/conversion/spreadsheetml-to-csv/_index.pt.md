---
title: Converter SPREADSHEETML para CSV via Java 
url: /pt/java/conversion/spreadsheetml-to-csv/ 
description: Exemplo de código de conversão Java do formato SPREADSHEETML para arquivo CSV. Os programadores podem usar este código de exemplo para exportar planilhas do Excel e OpenOffice para CSV em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter SPREADSHEETML para CSV via Java" h2="Conversão de SPREADSHEETML para CSV Java para converter uma ou várias páginas em CSV usando a biblioteca local Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter SPREADSHEETML para CSV usando Java" %}}

 Para renderizar SPREADSHEETML para CSV, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter SPREADSHEETML em CSV via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java os desenvolvedores podem converter facilmente o arquivo SPREADSHEETML para CSV em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar o arquivo SPREADSHEETML com uma instância da classe Workbook1. Chame o método Workbook.save1. Passe o caminho de saída com extensão CSV e SaveFormat como parâmetros1. Verifique o caminho especificado para o arquivo CSV resultante
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML para CSV Java Código-fonte de conversão" offSpacer="" %}}

```cs
// carregar o arquivo SPREADSHEETML em uma instância do Workbook
Workbook book = new Workbook("template.spreadsheetml");
// salvar SPREADSHEETML como CSV
