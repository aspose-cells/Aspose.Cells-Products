...
description: Aspose Excel. C# Aspose.Cells. Sloučit XLS do SXC uložit formát. C# Kombinujte formát XLS až SXC. Sloučit XLS až SXC v C#. XLS Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLS až SXC v C#" %}}
...
{{% cells-merger title="Ukázkový kód pro sloučení XLS až SXC v C#" InputFormat="xls" InputFormat2="sxc" outformat="sxc" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}
