---
title: C++ XLS ถึง TXT - ออนไลน์ XLS ถึง TXT Converter
description: Aspose เก่ง. C++ Aspose.Cells C++ Aspose Cells ออนไลน์ฟรี C++ แปลง XLS เป็น TXT บันทึกรูปแบบ รูปแบบ C++ XLS ถึง TXT บันทึก XLS ถึง TXT C++
...
{{% blocks/products/pf/agp/content h2="บันทึก XLS ถึง TXT ใน C++ ออนไลน์ฟรี" %}}
...
1.  แปลง XLS เป็น TXT โดยเรียกเมธอด Save()
