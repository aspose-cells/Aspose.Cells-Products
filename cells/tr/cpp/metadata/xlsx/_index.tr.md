...
weight: 8970
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Runtime Environment üzerinde XLSX dosya meta verilerini düzenlemek veya görüntülemek için C++ örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSX Meta Verilerini C++ aracılığıyla çıkarın" h2="Sunucu tarafı API\'lerini kullanarak XLSX dosyalarından meta veri eklemek, düzenlemek, kaldırmak veya ayıklamak için kendi C++ uygulamalarınızı oluşturun." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="C++\'i Kullanarak XLSX Meta Verilerini Alma" %}}
