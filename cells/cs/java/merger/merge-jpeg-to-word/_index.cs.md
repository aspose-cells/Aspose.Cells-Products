---
title: Sloučit JPEG až WORD - Sloučit JPEG až WORD v Java
url: /cs/java/merger/merge-jpeg-to-word/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit JPEG do WORD uložit formát. Java Kombinujte formát JPEG až WORD. Sloučit JPEG až WORD v Java. JPEG Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit JPEG až WORD pomocí Java" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit JPEG až WORD v Java" %}}

Následující příklad ukazuje, jak sloučit JPEG až WORD v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení JPEG do WORD. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru WORD. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí JPEG do WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení JPEG až WORD v Java" InputFormat="jpg" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit JPEG do WORD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit JPEG až WORD? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java ke sloučení JPEG až WORD" %}}
