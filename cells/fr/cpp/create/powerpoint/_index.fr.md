---
title: Créer POWERPOINT - Créer un fichier POWERPOINT au C++
description: Aspose Excel. C++ Créer un fichier POWERPOINT. Créer POWERPOINT C++. C++ Créateur POWERPOINT. Créez POWERPOINT en C++. Générez le fichier POWERPOINT en utilisant C++.
...
{{< blocks/products/pf/i18n/upper-banner h1="Créer un fichier POWERPOINT dans C++" h2="Création de fichiers POWERPOINT natifs et hautes performances par programmation sans Micorsoft Office à l\'aide de la bibliothèque C++." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="POWERPOINT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer POWERPOINT dans C++" %}}

{{% blocks/products/pf/agp/text %}}

 Il est facile pour les développeurs de créer, charger, modifier et convertir des fichiers POWERPOINT dans des applications de création de rapports en cours d'exécution pour le traitement des données en quelques lignes de code seulement.
...
1.  Enregistrez le classeur en tant que fichier .pptx à l'aide de la méthode Save().

{{% blocks/products/pf/agp/code-block title="Un exemple de code montre comment créer un fichier POWERPOINT dans C++." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Bibliothèque C++ pour créer un fichier POWERPOINT" %}}
