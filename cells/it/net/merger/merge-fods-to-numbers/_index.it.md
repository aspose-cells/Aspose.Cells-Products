---
title: Unisci FODS a NUMBERS - Combina FODS a NUMBERS in C#
url: /it/net/merger/merge-fods-to-numbers/ 
description: Aspose Excel. C# Aspose.Cells. Unisci online gratuito FODS in NUMBERS saveformat. C# Combina FODS al formato NUMBERS. Unisci FODS a NUMBERS in C#. FODS Unisci.
...
{{% blocks/products/pf/agp/content h2="Unisci FODS a NUMBERS in C# online gratuitamente" %}}
...
{{% cells-merger title="Online gratuito per unire FODS a NUMBERS in C#" InputFormat="fods" InputFormat2="numbers" outformat="numbers" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Come unire FODS a NUMBERS tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 Devi unire FODS a NUMBERS in modo programmatico? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET libreria da unire FODS a NUMBERS" %}}
