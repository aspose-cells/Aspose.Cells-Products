---
title:  XLSB Excel-fájl hozzáadása vagy eltávolítása Annotáció a C++-en keresztül
weight: 860
description: C++ mintakód a XLSB formátumú megjegyzések törléséhez a C++ Runtime Environment Windows 32 bites, Windows 64 bites és 64 bites Linux esetén.
