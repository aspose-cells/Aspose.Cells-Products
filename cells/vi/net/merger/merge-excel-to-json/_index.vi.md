...
{{% cells-merger title="Ứng dụng miễn phí để hợp nhất EXCEL thành JSON trực tuyến" InputFormat="xlsx" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="net" %}}
...
{{% blocks/products/pf/agp/content h2="Thư viện .NET để hợp nhất EXCEL thành JSON" %}}
