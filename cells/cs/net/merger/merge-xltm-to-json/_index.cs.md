---
title: Sloučit XLTM až JSON - Sloučit XLTM až JSON v C#
url: /cs/net/merger/merge-xltm-to-json/ 
description: Aspose Excel. C# Aspose.Cells. Online sloučení zdarma XLTM do formátu uložení JSON. C# Kombinujte formát XLTM až JSON. Sloučit XLTM až JSON v C#. XLTM Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit XLTM až JSON v C# Online zdarma" %}}

Následující příklad ukazuje, jak sloučit XLTM až JSON v Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení XLTM do JSON. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru JSON. Pokud vytvoříte kód v C#, bude to jednodušší, než to zní. Viz příklad C#, který sloučí XLTM do JSON.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení XLTM až JSON v C#" InputFormat="xltm" InputFormat2="json" outformat="json" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit XLTM na JSON přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Potřebujete programově sloučit XLTM až JSON? Základní dokument, který se spojuje a spojuje[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna .NET ke sloučení XLTM až JSON" %}}
