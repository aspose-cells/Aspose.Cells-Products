---
title: Fusionner PRN en JPG - Combiner PRN en JPG en C#
url: /fr/net/merger/merge-prn-to-jpg/ 
description: Aspose Excel. C# Aspose.Cells. Fusion en ligne gratuite PRN au format de sauvegarde JPG. C# Combinez le format PRN au format JPG. Fusionner PRN en JPG en C#. Fusion PRN.
...
{{% blocks/products/pf/agp/content h2="Fusionner PRN en JPG en C# en ligne gratuitement" %}}
...
{{% cells-merger title="Gratuit en ligne pour fusionner PRN en JPG en C#" InputFormat="prn" InputFormat2="jpg" outformat="jpg" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner PRN en JPG via C#" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de fusionner PRN en JPG par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2=".NET bibliothèque pour fusionner PRN en JPG" %}}
