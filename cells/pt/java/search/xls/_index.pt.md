---
title: Pesquisar documento XLS sem abrir via Java 
weight: 9430
url: /pt/java/search/xls/ 
description: Java código de amostra para pesquisar palavras com padrão no arquivo XLS no Java ambiente de tempo de execução para aplicativos JSP/JSF e aplicativos de desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Pesquisar formatos XLS em Java" h2="Pesquisa de documentos XLS nativa e de alto desempenho usando APIs Aspose.Cells for Java do lado do servidor, sem o uso de nenhum software como Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLS" >}}
...
{{% blocks/products/pf/agp/content h2="Como pesquisar arquivo XLS usando Java" %}}
...
Acesse a primeira planilha do arquivo XLS.
...
{{% blocks/products/pf/agp/code-block title="Pesquisar arquivos XLS - Java" offSpacer="" %}}

```cs
// Instanciando um objeto Workbook
Workbook workbook = new Workbook(dataDir + "book1.xls");

// Acessando a primeira planilha no arquivo XLS
