---
title: C# FODS 至 SVG - FODS 至 SVG 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 FODS 轉換為 SVG。C# FODS 為 SVG. C# 將 0761838381830 1076181 將 0761830761830 10760181 將 07618307618381 儲存。為 07611134 81 使用 C#。
...
以下範例示範如何將 C# 中的 FODS 轉換為 SVG。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 FODS 轉換為 SVG。上傳您的 FODS 文件，然後只需將其另存為 SVG 文件。對於 FODS 讀取和 SVG 寫入，您可以使用完全限定的檔案名稱。輸出 SVG 內容和格式將與原始 FODS 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 FODS 轉換為 SVG 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="fods" outformat="svg" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何透過 C# 將 FODS 轉換為 SVG" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 FODS 檔案轉換為 SVG 嗎？ .NET 開發人員只需幾行程式碼即可輕鬆載入和轉換 FODS 到 SVG。
...
1. 使用工作簿實例載入 FODS 檔案。
1. 透過呼叫Workbook.Save方法將FODS轉換為SVG。
1. 取得FODS到SVG的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#庫將FODS轉換為SVG" %}}
