...
Das folgende Beispiel zeigt, wie man CSV in C++ in XLSM umwandelt.
...
Müssen Sie CSV-Dateien programmatisch in XLSM konvertieren? Entwickler können C++-Dateien problemlos mit nur wenigen Codezeilen in XLSM konvertieren.
...
1.  Wandeln Sie CSV in XLSM um, indem Sie die Save()-Methode aufrufen.
1.  Holen Sie sich das Konvertierungsergebnis von CSV in XLSM.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Bibliothek C++ zur Konvertierung von CSV in XLSM" %}}
