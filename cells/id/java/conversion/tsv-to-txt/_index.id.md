...
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan TSV ke TXT melalui Java" h2="Konversi TSV ke TXT Java untuk mengonversi satu atau beberapa laman ke TXT menggunakan pustaka Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi TSV ke TXT Menggunakan Java" %}}

 Untuk merender TSV ke TXT, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi TSV ke TXT melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file TSV ke TXT hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file TSV dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi TXT & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file TXT yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="TSV ke TXT Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file TSV dalam contoh Workbook
Workbook book = new Workbook("template.tsv");
// simpan TSV sebagai TXT
