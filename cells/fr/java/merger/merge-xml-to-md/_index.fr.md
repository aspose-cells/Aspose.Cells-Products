---
title: Fusionner XML vers MD - Combiner XML vers MD dans Java
url: /fr/java/merger/merge-xml-to-md/ 
description: Aspose Excel. Java Aspose.Cells. Fusion en ligne gratuite XML au format de sauvegarde MD. Java Combinez XML au format MD. Fusionner XML vers MD dans Java. Fusion XML.
...
{{% blocks/products/pf/agp/content h2="Fusionner XML vers MD dans Java en ligne gratuitement" %}}

L'exemple suivant montre comment fusionner XML vers MD dans Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Suivez les étapes simples pour fusionner XML vers MD. Téléchargez vos fichiers, appelez la méthode Workbook.Combine pour fusionner des fichiers, puis enregistrez-la dans un fichier MD. Si vous développez du code en Java, ce sera plus simple qu'il n'y paraît. Voir l'exemple Java qui fusionne XML en MD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratuit en ligne pour fusionner XML vers MD en Java" InputFormat="xml" InputFormat2="md" outformat="md" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Comment fusionner XML vers MD via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Besoin de fusionner XML vers MD par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Java](https://products.aspose.com/cells/java) Les API peuvent être réalisées avec seulement quelques lignes de code.
...
{{% blocks/products/pf/agp/content h2="Java bibliothèque pour fusionner XML vers MD" %}}
