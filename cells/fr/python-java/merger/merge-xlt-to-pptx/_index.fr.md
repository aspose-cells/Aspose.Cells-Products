...
url: /fr/python-java/merger/merge-xlt-to-pptx/ 
...
L'exemple suivant montre comment fusionner XLT à PPTX dans Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Besoin de fusionner XLT à PPTX par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Les API peuvent être réalisées avec seulement quelques lignes de code.
