...
url: /hu/net/merger/merge-spreadsheetml-to-md/ 
...
A következő példa bemutatja, hogyan egyesítheti a SPREADSHEETML-t az MD-vel a Aspose.Cells for .NET számon.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Programozottan egyesítenie kell a SPREADSHEETML-t az MD-vel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a SPREADSHEETML MD-vel való egyesítéséhez" %}}
