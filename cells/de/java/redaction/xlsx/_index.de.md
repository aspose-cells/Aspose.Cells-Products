---
title:  Suchen und ersetzen Sie Text im Dokument XLSX via Java
weight: 1590
description: Java Beispielcode zum Schwärzen sensibler Informationen in der Datei XLSX in der Laufzeitumgebung Java für JSP/JSF-Anwendungen und Desktop-Anwendungen.
...
{{% blocks/products/pf/agp/content h2="So schwärzen Sie die Datei XLSX mit Java" %}}

 Um die Datei XLSX zu redigieren, verwenden wir[Aspose.Cells for Java](https://products.aspose.com/cells/java) API, eine funktionsreiche, leistungsstarke und benutzerfreundliche Redaktionsplattform. Sie können die neueste Version direkt von herunterladen[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) und installieren Sie es in Ihrem Maven-basierten Projekt, indem Sie der pom.xml die folgenden Konfigurationen hinzufügen.
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Schwärzen von XLSX-Dateien in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="XLSX-Dateien redigieren – Java" offSpacer="" %}}
