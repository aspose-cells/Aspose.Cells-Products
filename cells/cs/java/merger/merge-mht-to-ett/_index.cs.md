---
title: Sloučit MHT s ETT – Zkombinujte MHT s ETT v Java
url: /cs/java/merger/merge-mht-to-ett/ 
description: Aspose Excel. Java Aspose.Cells. Online zdarma Sloučit MHT do ETT uloženého formátu. Java Kombinujte formát MHT s ETT. Sloučit MHT do ETT v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT do ETT v Java Online zdarma" %}}

Následující příklad ukazuje, jak sloučit MHT do ETT v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT s ETT. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru ETT. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který spojuje MHT s ETT.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Online zdarma ke sloučení MHT do ETT na čísle Java" InputFormat="mht" InputFormat2="ett" outformat="ett" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT do ETT via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete programově sloučit MHT s ETT? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Java knihovna pro sloučení MHT s ETT" %}}
