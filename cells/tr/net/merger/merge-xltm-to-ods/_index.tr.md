...
description: Aspose excel. C# Aspose.Cells. Ücretsiz Çevrimiçi Birleştirme XLTM ile ODS kaydetme biçimi. C# XLTM ile ODS formatını birleştirin. C# içinde XLTM'i ODS ile birleştir. XLTM Birleştir.
...
Aşağıdaki örnek, XLTM'in Aspose.Cells for .NET'de ODS ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/content h2="XLTM\'i ODS ile birleştirmek için .NET kitaplığı" %}}
