...
Het volgende voorbeeld laat zien hoe je TSV omzet naar OTS in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je TSV naar OTS via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u TSV-bestanden programmatisch naar OTS converteren? Ontwikkelaars van Java kunnen TSV-bestanden eenvoudig in een paar regels code naar OTS converteren.
