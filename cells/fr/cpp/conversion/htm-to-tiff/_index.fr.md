...
description: Aspose Exceller. Convertissez HTM en TIFF rapidement et facilement avec Aspose.Cells. C++ HTM en TIFF. C++ Enregistrez HTM en TIFF. Enregistrez HTM sous TIFF en utilisant C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrer HTM au TIFF dans C++" %}}
...
{{% cells-convert title="Exemple de code pour convertir HTM en TIFF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="htm" outformat="tiff" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Comment convertir HTM en TIFF via C++" %}}

{{% blocks/products/pf/agp/text %}}

Besoin de convertir les fichiers HTM en TIFF par programme ? Les développeurs C++ peuvent facilement convertir HTM en TIFF en quelques lignes de code seulement.
...
1.  Convertissez HTM en TIFF en appelant la méthode Save().
