---
title:  Generar Informes en Archivos XLSB via .NET
weight: 1690
description: Código fuente C# para generar informes en formato XLSB en .NET Framework, .NET Core, Mono o plataformas Xamarin.
...
{{% blocks/products/pf/agp/content h2="Cómo generar informes basados en XLSB utilizando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para Armar XLSB vía C#" %}}
...
1. Guarde el resultado en formato XLSB mediante el método WorkbookDesigner.Worbook.Save
