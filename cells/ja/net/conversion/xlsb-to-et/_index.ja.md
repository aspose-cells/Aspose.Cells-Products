---
title: C# XLSB から ET - XLSB から ET コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、XLSBをETにすばやく簡単に変換します。C# XLSBをETに変換します。 C# XLSB を ET に保存します。 C# を使用して XLSB を ET として保存します。
...
{{% cells-convert title="XLSBをETに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsb" outformat="et" IsLandingPage="true" %}}
