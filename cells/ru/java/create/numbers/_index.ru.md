---
title: Создать ЧИСЛА - Создать файл ЧИСЛА в Java.
description:  Aspose Эксель. Java Быстро и легко создайте файл ЧИСЛА с помощью Aspose.Cells. Создайте файл ЧИСЛА с помощью Java. Создайте ЧИСЛА в Java. Java Создатель ЧИСЕЛ.
...
{{% blocks/products/pf/agp/content h2="Как создать ЧИСЛА в Java" %}}
...
1.  Сохраните книгу в формате ЧИСЛА, используя метод save().

{{% blocks/products/pf/agp/code-block title="Пример кода показывает, как создать файл NUMBERS с номером Java." offSpacer="" %}}
