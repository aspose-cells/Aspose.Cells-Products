...
description: Aspose Excel. Konwertuj PRN na XPS szybko i łatwo za pomocą Aspose.Cells. Java PRN na XPS. Java Zapisz PRN na XPS. Zapisz PRN jako XPS używając Java.
...
{{% blocks/products/pf/agp/content h2="Zapisz PRN pod numerem XPS w Java" %}}

Poniższy przykład ilustruje sposób konwersji PRN na XPS w Java.
...
Chcesz programowo przekonwertować pliki PRN na XPS? Programiści Java mogą łatwo przekonwertować PRN na XPS w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka Java do konwersji PRN na XPS" %}}
{{% blocks/products/pf/agp/text %}}
