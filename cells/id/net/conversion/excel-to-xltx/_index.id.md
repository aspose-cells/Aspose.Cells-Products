...
{{< blocks/products/pf/i18n/upper-banner h1="Ubah EXCEL menjadi XLTX di C#" h2="Pustaka C# berkecepatan tinggi untuk mengonversi EXCEL ke XLTX. Ini adalah solusi perangkat lunak profesional untuk mengimpor dan mengekspor EXCEL, XLTX, dan banyak format lainnya pada Kerangka .NET, Platform .NET Core, atau Mono." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="EXCEL" >}}
...
{{% cells-convert title="Contoh Kode untuk Mengonversi EXCEL menjadi XLTX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="xltx" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="Cara Mengonversi EXCEL ke XLTX melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

Perlu mengonversi file EXCEL ke XLTX secara terprogram? Pengembang .NET dapat dengan mudah memuat & mengonversi EXCEL ke XLTX hanya dalam beberapa baris kode.
