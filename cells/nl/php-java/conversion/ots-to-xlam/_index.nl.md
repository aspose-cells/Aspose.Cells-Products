...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar XLAM met Aspose.Cells. PHP OTS naar XLAM. PHP Bewaar OTS naar XLAM. Sla OTS op als XLAM met behulp van PHP.
...
{{% blocks/products/pf/agp/content h2="Hoe OTS naar XLAM te converteren via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Wilt u OTS-bestanden programmatisch naar XLAM converteren? PHP-ontwikkelaars kunnen OTS eenvoudig laden en converteren naar XLAM in slechts een paar regels code.
...
1.  Converteer OTS naar XLAM door de opslagmethode van Workbook aan te roepen.
