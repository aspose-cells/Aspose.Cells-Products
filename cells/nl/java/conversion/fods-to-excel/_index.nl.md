...
{{% blocks/products/pf/agp/content h2="Sla FODS op in Excel onder de naam Java" %}}

Het volgende voorbeeld laat zien hoe je FODS naar EXCEL kunt converteren in Java.
...
{{% blocks/products/pf/agp/content h2="Hoe converteer je FODS naar Excel via Java?" %}}

{{% blocks/products/pf/agp/text %}}

Moet u bestanden met de extensie FODS programmatisch naar Excel converteren? Ontwikkelaars van Java kunnen bestanden met de extensie FODS eenvoudig in een paar regels code naar Excel converteren.
