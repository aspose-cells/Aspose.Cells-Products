...
url: /it/net/merger/merge-csv-to-xml/ 
...
L'esempio seguente mostra come unire CSV a XML in Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Hai bisogno di unire CSV a XML a livello di programmazione? Un documento di base che si fonde e si concatena con[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Le API possono essere eseguite con poche righe di codice.
...
{{% blocks/products/pf/agp/content h2=".NET per unire CSV a XML" %}}
