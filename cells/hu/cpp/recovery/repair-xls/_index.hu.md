...
{{% blocks/products/pf/agp/content h2="Az xls fájl javítása a C++ használatával" %}}
...
{{% cells-recovery title="Ingyenes alkalmazás a XLS fájl javításához a C++ használatával" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et" InputFormat="xls" outformat="xls" IsLandingPage="true" language="cpp" %}}    
