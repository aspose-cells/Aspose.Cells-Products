---
title: Scal OBRAZ z ODS - Połącz OBRAZ z ODS w C#
url: /pl/net/merger/merge-image-to-ods/ 
description: Aspose Excel. C# Aspose.Cells. Scal OBRAZ do formatu zapisu ODS. C# Połącz OBRAZ do formatu ODS. Scal OBRAZ z ODS w C#. OBRAZ Scal.
...
{{% blocks/products/pf/agp/content h2="Połącz OBRAZ z ODS w C#" %}}

Poniższy przykład pokazuje, jak połączyć IMAGE z ODS w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić IMAGE z ODS. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do łączenia plików, a następnie zapisz ją w pliku ODS. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który łączy OBRAZ z ODS.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Przykładowy kod do połączenia OBRAZU z ODS w C#" InputFormat="png" InputFormat2="ods" outformat="ods" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak połączyć OBRAZ z ODS przez C#" %}}

{{% blocks/products/pf/agp/text %}}

Chcesz programowo scalić IMAGE z ODS? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2="Biblioteka .NET do połączenia OBRAZU z ODS" %}}
