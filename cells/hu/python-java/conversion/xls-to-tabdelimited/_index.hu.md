...
{{< blocks/products/pf/i18n/upper-banner h1="XLS konvertálása TAB-raDELIMITED a következőn keresztül: Python" h2="Exportáljon Excel®-táblázatokat TABDELIMITED formátumba Python API használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TABDELIMITED" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="XLS konvertálása TAB-raDELIMITED a következővel: Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Az XLS-ből TAB-lé konvertálás lépéseiDELIMITED a következőn keresztül: Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python fejlesztői könnyedén betölthetnek és konvertálhatnak XLS fájlokat TABDELIMITED formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltse be az XLS-fájlt a munkafüzet egy példányával1. Hívja a Workbook.Save metódust1. Kimeneti útvonal átadása TSV kiterjesztéssel paraméterként1. Ellenőrizze az eredményül kapott TABDELIMITED fájl megadott elérési útját
