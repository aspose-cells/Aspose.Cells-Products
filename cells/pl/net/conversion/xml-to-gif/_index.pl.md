...
description: Aspose Excel. Konwertuj XML na GIF szybko i łatwo za pomocą Aspose.Cells. C# XML na GIF. C# Zapisz XML na GIF. Zapisz XML jako GIF używając C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XML pod numerem GIF w C#" %}}

Poniższy przykład ilustruje, jak przekonwertować kod XML na GIF w C#.
...
{{% cells-convert title="Przykładowy kod do konwersji XML na GIF" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xml" outformat="gif" IsLandingPage="true" %}}
...
{{% blocks/products/pf/agp/content h2="Biblioteka C# do konwersji XML na GIF" %}}
