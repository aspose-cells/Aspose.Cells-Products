---
title: Converteer XLTM naar TXT via Java 
weight: 4440

description: Voorbeeld Java conversiecode voor XLTM-indeling naar TXT-bestand. Programmeurs kunnen deze voorbeeldcode gebruiken om Excel- en OpenOffice-spreadsheets naar TXT te exporteren binnen elke web- of desktoptoepassing Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer XLTM naar TXT via Java" h2="Conversie van XLTM naar TXT Java om enkele of meerdere pagina\'s naar TXT te converteren met behulp van een lokale bibliotheek Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/content h2="XLTM naar TXT converteren met Java" %}}

 Om XLTM naar TXT te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om XLTM naar TXT te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen XLTM-bestanden gemakkelijk converteren naar TXT in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad XLTM-bestand met een exemplaar van de Workbook-klasse1. Bel de methode Workbook.save1. Geef uitvoerpad door met TXT-extensie & SaveFormat als parameters1. Controleer het opgegeven pad voor het resulterende TXT-bestand
...
{{% blocks/products/pf/agp/code-block title="XLTM naar TXT Java Conversiebroncode" offSpacer="" %}}
