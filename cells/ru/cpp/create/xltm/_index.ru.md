...
description: XLTM создатель. Создайте файлы XLTM в коде C++. Создайте файлы MS Excel XLTM с помощью приложения C++.
---
...
1.  Сохраните книгу как файл .xltm, используя метод Save().

{{% blocks/products/pf/agp/code-block title="В следующем исходном коде показано, как создать файл MS Excel XLTM, используя C++." offSpacer="" %}}
