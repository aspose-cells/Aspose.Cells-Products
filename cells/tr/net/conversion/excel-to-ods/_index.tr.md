...
description: Aspose Excel. Bu kapsamlı çözüm, C# geliştiricilere EXCEL'i ODS formatına dönüştürmek için tamamen entegre bir yaklaşım sunarak, Aspose.Cells kütüphanesini kullanarak EXCEL verilerinin ODS formatına sorunsuz bir şekilde kaydedilmesini sağlar; tüm bunlar verimli ve özelleştirilebilir C# kod aracılığıyla gerçekleştirilir.
...
{{% blocks/products/pf/agp/content h2="EXCEL dosyasını ODS adresine C# olarak kaydedin." %}}

Aşağıdaki örnek, EXCEL dosyasını C# formatında ODS formatına nasıl dönüştüreceğinizi göstermektedir.
...
EXCEL dosyalarını programlı olarak ODS'e dönüştürmeniz mi gerekiyor? .NET geliştiricileri EXCEL'i yalnızca birkaç satır kodla kolayca yükleyip ODS'e dönüştürebilir.
...
1.  Workbook.Save yöntemini çağırarak EXCEL dosyasını ODS formatına dönüştürün.
1.  EXCEL'in ODS'e dönüşüm sonucunu alın.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="EXCEL\'i ODS\'e dönüştürmek için C# kütüphanesi" %}}
