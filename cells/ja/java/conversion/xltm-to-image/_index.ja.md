---
title: Java XLTM から画像 - XLTM から画像コンバータ
description: Aspose エクセル。 Aspose.Cellsを使用して、XLTMをIMAGEにすばやく簡単に変換します。Java XLTMをIMAGEに変換します。 Java XLTMを画像に保存してください。 Java を使用して、XLTM を画像として保存します。
...
{{% cells-convert title="XLTMをIMAGEに変換するサンプルコード" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltm" outformat="png" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="XLTMをIMAGE via Javaに変換する方法" %}}
