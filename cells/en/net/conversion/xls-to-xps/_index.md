...
{{% blocks/products/pf/agp/content h2="Save XLS to XPS in C# Online for Free" %}}

The following example demonstrates how to convert XLS to XPS document format in C#.
...
{{% cells-convert title="Free App and Sample Code to Convert XLS to XPS Online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="xps" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert XLS to XPS via C#" %}}
...
{{% blocks/products/pf/agp/content h2="C# library to convert XLS to XPS" %}}
