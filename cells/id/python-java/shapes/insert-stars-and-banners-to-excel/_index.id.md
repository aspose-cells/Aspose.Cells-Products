...
weight: 381
description: Python via Java kode sumber untuk menyisipkan Bintang/Banner ke dalam Excel.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Masukkan Bintang/Banner ke Excel menggunakan Python via Java" h2="Sisipkan Bintang/Banner menggunakan Aspose.Cells\' API tanpa software seperti Microsoft atau Open Office, Adobe PDF, dll." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Memasukkan Bintang/Banner ke File Excel Menggunakan Python via Java" %}}
 ...
 Untuk menyisipkan Bintang/Banner ke dalam file excel, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah memasukkan Bintang/Banner ke file Excel menggunakan Python via Java" %}}
...
+ Pilih Lembar Kerja melalui indeksnya.
 + Gunakan[menambahkan metode](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addAutoShape(int,%20int,%20int,%20int,%20int,%20int,%20int)) untuk menyisipkan Bintang/Banner di lembar kerja yang dipilih
...
Contoh kode di bawah ini menunjukkan cara menyisipkan "math plus". Untuk jenis lainnya, silakan merujuk ke "Ikhtisar Jenis Bintang dan Spanduk" di bawah.

{{% blocks/products/pf/agp/code-block title="Sisipkan Bintang/Banner - Python via Java" offSpacer="" %}}
