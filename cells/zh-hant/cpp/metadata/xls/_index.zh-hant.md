---
title: 透過 C++ 編輯或檢視 XLS 文件元數據
weight: 2150
description: 用於在 C++ 運行時環境（適用於 Windows 32 位元、Windows 64 位元和 Linux 64 位元）上編輯或檢視 XLS 檔案元資料的 C++ 範例程式碼。
...
{{< blocks/products/pf/i18n/upper-banner h1="透過 C++ 提取 XLS 元數據" h2="建立您自己的 C++ 應用程序，以使用伺服器端 API 新增、編輯、刪除或提取 XLS 檔案中的元資料。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C++ 取得 XLS 元數據" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C++ 擷取 XLS 元資料的步驟" %}}
