...
{{% blocks/products/pf/agp/content h2="Hur man skapar NUMMER i Java" %}}
...
1.  Spara arbetsboken som NUMBERS-format med metoden save().

{{% blocks/products/pf/agp/code-block title="Exempelkod visar hur man skapar NUMBERS-fil i Java." offSpacer="" %}}
...
{{% blocks/products/pf/agp/content h2="Java-biblioteket för att skapa NUMBERS-filen" %}}
{{% blocks/products/pf/agp/text %}}
