---
title:  Làm cách nào để vẽ hoặc chèn mũi tên thẳng vào Excel via Java
weight: 10
description: Vẽ hoặc chèn đối tượng mũi tên thẳng bằng Aspose.Cells' Java API mà không cần bất kỳ phần mềm nào như Microsoft hay Open Office, Adobe PDF, v.v.
keywords: [Java Aspose.Cells., Java add straight arrow., Java insert straight arrow., Java create straight arrow]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chèn mũi tên thẳng vào Excel via Java" h2="Chèn mũi tên thẳng dùng Aspose.Cells\' API không cần phần mềm nào như Microsoft hay Open Office, Adobe PDF..." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSX" pfName="Aspose.Cells" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="Cách chèn mũi tên thẳng vào file excel bằng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chèn mũi tên thẳng vào file Excel via Java" %}}
...
+ Chọn Worksheet thông qua chỉ mục của nó.
 + Sử dụng[thêm phương pháp](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addLine-int-int-int-int-int-int-) để chèn mũi tên thẳng vào bảng tính đã chọn
...
{{% blocks/products/pf/agp/code-block title="Chèn mũi tên thẳng - Java" offSpacer="" %}}
