...
description: Aspose Excel. A PNG-es számot gyorsan és egyszerűen konvertálja OTS-re a Aspose.Cells-es számmal. C++ PNG OTS-re. C++ Mentse a PNG számot az OTS-nél. Mentse el a PNG számot OTS-ként a C++ használatával.
...
{{< blocks/products/pf/i18n/upper-banner h1="Konvertálja a PNG-et OTS-re a C++-ben" h2="Nagy teljesítményű PNG konvertálás OTS-vé a C++ könyvtár használatával, Microsoft Excel, OpenOffice vagy Adobe Acrobat telepítés nélkül." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="OTS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="A PNG konvertálása OTS-re a C++ használatával" %}}
...
{{% blocks/products/pf/agp/content h2="Mentse el a PNG számot az OTS számára a C++ számon" %}}

A következő példa bemutatja, hogyan lehet átalakítani a PNG-et OTS-re a C++-ben.
...
A PNG fájlokat programozottan OTS-re kell konvertálnia? A C++ fejlesztők könnyedén konvertálhatják a PNG-et OTS-re, mindössze néhány sornyi kóddal.
...
1. Konvertálja a PNG-et OTS-re a Save() metódus meghívásával.
