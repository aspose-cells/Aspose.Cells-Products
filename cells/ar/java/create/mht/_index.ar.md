---
title: إنشاء MHT - إنشاء ملف MHT في Java
description: Aspose إكسل. Java إنشاء ملف MHT. إنشاء MHT Java. Java MHT Craduate. قم بإنشاء MHT في Java. قم بإنشاء ملف MHT باستخدام Java.
...
1.  احفظ المصنف بتنسيق MHT باستخدام طريقة الحفظ ().
