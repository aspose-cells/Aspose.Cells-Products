---
title:  Συγχωνεύστε το OTS στο XPS μέσω του C++
url: /el/cpp/merger/merge-ots-to-xps/ 
description: Συγχωνεύστε το OTS στο XPS Online δωρεάν. Δωρεάν Online OTS to XPS Merger. Συγχώνευση OTS σε Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS και άλλα.
---
...
Το ακόλουθο παράδειγμα δείχνει πώς να συγχωνεύσετε το OTS στο XPS στο C++.
...
{{% cells-merger title="Δωρεάν εφαρμογή για συγχώνευση OTS στο XPS σε απευθείας σύνδεση" InputFormat="ots" InputFormat2="xps" outformat="xps" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="cpp" %}}
