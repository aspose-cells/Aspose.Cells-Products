...
{{% blocks/products/pf/agp/content h2="Kép beszúrása Excel fájlba a Python via java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A kép Excel-fájlba történő beszúrásának lépései a Python via java használatával" %}}
...
{{% blocks/products/pf/agp/code-block title="Kép beszúrása - Python via java" offSpacer="" %}}
