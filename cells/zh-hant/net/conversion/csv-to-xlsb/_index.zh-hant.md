---
title: C# CSV 轉 XLSB - 在線 CSV 轉 XLSB 轉換器
description: Aspose Excel。 C# Aspose.Cells。C# Aspose Cells。免費在線 C# 將 CSV 轉換為 XLSB 保存格式。 C# CSV 到 XLSB 格式。將 CSV 保存為 XLSB C#。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 CSV 轉換為 C# 中的 XLSB" h2="高速C#庫，用於將CSV轉換為XLSB。這是一個專業的軟件解決方案，可在.NET Framework、.NET Core或Mono平台上導入和導出CSV、XLSB和許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="免費在線保存 CSV 至 XLSB 於 C#" %}}

以下示例演示如何將 C# 中的 CSV 轉換為 XLSB。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 CSV 轉換為 XLSB。上傳您的 CSV 文件，然後只需將其另存為 XLSB 文件。對於 CSV 讀取和 XLSB 寫入，您可以使用完全限定的文件名。輸出 XLSB 內容和格式將與原始 CSV 文檔相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="免費應用程序和示例代碼可在線將 CSV 轉換為 XLSB" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="csv" outformat="xlsb" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="如何通過 C# 將 CSV 轉換為 XLSB" %}}

{{% blocks/products/pf/agp/text %}}

需要以編程方式將 CSV 文件轉換為 XLSB 嗎？ .NET 開發人員只需幾行代碼即可輕鬆加載和轉換 CSV 到 XLSB。
...
1. 使用工作簿實例加載 CSV 文件。
1. 通過調用 Workbook.Save 方法將 CSV 轉換為 XLSB。
1. 獲取CSV到XLSB的轉換結果。

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="C#庫將CSV轉換為XLSB" %}}
