---
title: Conversor PHP SXC para CSV - SXC para CSV
description: Aspose Excel. Converta SXC em CSV de forma rápida e fácil com Aspose.Cells. PHP SXC em CSV. PHP Salve SXC em CSV. Salve SXC como CSV usando PHP.
...
{{% blocks/products/pf/agp/content h2="Como converter SXC em CSV via PHP" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos SXC em CSV programaticamente? Os desenvolvedores PHP podem facilmente carregar e converter SXC em CSV em apenas algumas linhas de código.
...
1.  Converta SXC em CSV chamando o método save da pasta de trabalho.
