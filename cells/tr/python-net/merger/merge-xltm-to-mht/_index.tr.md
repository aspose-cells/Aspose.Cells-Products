...
Aşağıdaki örnek, XLTM'in Aspose.Cells for Python via .NET'de MHT ile nasıl birleştirileceğini gösterir.
...
XLTM'i programlı olarak MHT ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) API'ler yalnızca birkaç satır kodla yapılabilir.
