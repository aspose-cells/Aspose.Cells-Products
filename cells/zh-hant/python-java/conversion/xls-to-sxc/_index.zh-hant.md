---
title: Python XLS 至 SXC - XLS 至 SXC 轉換器
description: Aspose Excel。使用 Aspose.Cells 快速輕鬆地將 XLS 轉換為 SXC。Python XLS 為 SXC. Python 將 0761838381830 1076181 將 0761830761830 10760181 將 07618307618381 儲存。為 07611134 81 使用 Python。
...
{{< blocks/products/pf/i18n/upper-banner h1="將 XLS 轉換為 Python 中的 SXC" h2="高速Python庫，用於將XLS轉換為SXC。這是一個專業的軟體解決方案，用於導入和導出XLS、SXC和使用Python的許多其他格式。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SXC" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
如何將 XLS 轉換為 SXC？使用 Aspose.Cells for Python 函式庫，您可以透過幾行程式碼以程式設計方式輕鬆將 XLS 轉換為 SXC。[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)能夠建立跨平台應用程序，能夠生成、修改、轉換、渲染和列印所有 Excel 檔案。 Python Excel API 不僅可以在電子表格格式之間進行轉換，還可以將 Excel 文件呈現為圖像、PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT 等，從而使其成為以行業標準格式交換文件的完美選擇。
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="將 XLS 儲存到 Python 中" %}}

以下範例示範如何將 Python 中的 XLS 轉換為 SXC。
{{% blocks/products/pf/agp/text %}}

按照簡單的步驟將 XLS 轉換為 SXC。上傳您的 XLS 文件，然後只需將其另存為 SXC 文件。對於 XLS 讀取和 SXC 寫入，您可以使用完全限定的檔案名稱。輸出 SXC 內容和格式將與原始 XLS 文件相同。

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-convert title="將 XLS 轉換為 SXC 的範例程式碼" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xls" outformat="sxc" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="如何透過 Python 將 XLS 轉換為 SXC" %}}

{{% blocks/products/pf/agp/text %}}

需要以程式方式將 XLS 檔案轉換為 SXC 嗎？ Python 開發人員只需幾行程式碼即可輕鬆載入和轉換 XLS 到 SXC。
...
1. 使用工作簿實例載入 XLS 檔案。
1. 透過呼叫Workbook.save方法將XLS轉換為SXC。
1. 取得XLS到SXC的轉換結果。
