---
title: Вставьте кнопку (элемент управления формой) в Excel, используя Java Python via
weight: 200
...
{{% blocks/products/pf/agp/content h2="Как вставить кнопку (элемент управления формой) в файл Excel с помощью Java Python via" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке кнопки (элемент управления формой) в файл Excel с использованием Java Python via" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте коллекцию фигур[добавить метод](https://reference.aspose.com/cells/python-java/asposecells.api/shapecollection#addButton(int,%20int,%20int,%20int,%20int,%20int)), чтобы вставить кнопку (элемент управления формой) на выбранный лист.
