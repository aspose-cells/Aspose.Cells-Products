...
description: Aspose Excel. Convierta PRN a XLTM rápida y fácilmente con Aspose.Cells. Python PRN a XLTM. Python Guarde PRN en XLTM. Guarde PRN como XLTM usando Python.
...
{{% blocks/products/pf/agp/content h2="Guardar PRN al XLTM en Python" %}}

El siguiente ejemplo demuestra cómo convertir PRN a XLTM en Python via NET.
...
¿Necesita convertir archivos PRN a XLTM mediante programación? Los desarrolladores de Python pueden cargar y convertir fácilmente PRN a XLTM en tan solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Python para convertir PRN a XLTM" %}}
