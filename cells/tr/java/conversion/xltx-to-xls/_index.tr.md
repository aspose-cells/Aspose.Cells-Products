...
{{% blocks/products/pf/agp/content h2="Java Kullanarak XLTX\'i XLS\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla XLTX\'i XLS\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla XLTX dosyasını XLS'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. XLTX dosyasını Workbook sınıfının bir örneğiyle yükleyin1. Workbook.save yöntemini çağırın1. XLS uzantısı ve SaveFormat ile çıktı yolunu parametre olarak iletin1. Ortaya çıkan XLS dosyası için belirtilen yolu kontrol edin
...
{{% blocks/products/pf/agp/code-block title="XLTX - XLS Java Dönüşüm Kaynak Kodu" offSpacer="" %}}

```cs
// XLTX dosyasını bir Çalışma Kitabı örneğine yükleyin
Workbook book = new Workbook("template.xltx");
// XLTX'i XLS olarak kaydet
