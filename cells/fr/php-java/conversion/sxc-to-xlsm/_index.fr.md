---
title: Convertisseur PHP SXC à XLSM - SXC à XLSM
description: Aspose Exceller. Convertissez SXC en XLSM rapidement et facilement avec Aspose.Cells. PHP SXC en XLSM. PHP Enregistrez SXC en XLSM. Enregistrez SXC sous XLSM en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Convertir SXC en XLSM en utilisant PHP" %}}
 ...
 Comment convertir SXC en XLSM ? Avec la bibliothèque Aspose.Cells for PHP via Java, vous pouvez facilement convertir SXC en XLSM par programme avec quelques lignes de code.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. PHP Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrer le SXC au XLSM en PHP" %}}
...
Besoin de convertir les fichiers SXC en XLSM par programme ? Les développeurs PHP peuvent facilement charger et convertir SXC en XLSM en quelques lignes de code.
...
1.  Convertissez SXC en XLSM en appelant la méthode de sauvegarde du classeur.
