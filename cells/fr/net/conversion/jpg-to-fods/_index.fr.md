...
Besoin de convertir des fichiers JPG en FODS par programme ? Les développeurs .NET peuvent facilement charger et convertir JPG en FODS en quelques lignes de code.
...
1.  Convertissez le JPG au format FODS en appelant la méthode Workbook.Save.
