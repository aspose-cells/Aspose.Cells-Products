---
title: Python XLS - MHT - XLS - MHT átalakító
description: Aspose Excel. Ez az átfogó megoldás teljesen integrált megközelítést biztosít a Python fejlesztők számára a XLS MHT formátumba konvertálásához, lehetővé téve a XLS adatok zökkenőmentes mentését MHT formátumba a Aspose.Cells könyvtár segítségével, mindezt hatékony és testreszabható Python kódon keresztül.
...
{{< blocks/products/pf/i18n/upper-banner h1="Alakítsa át a XLS-et MHT-vé a Python Excel könyvtárban" h2="Nagy sebességű Python Excel könyvtár a XLS MHT-vé konvertálásához. Ez egy professzionális szoftvermegoldás XLS, MHT és sok más formátum importálására és exportálására a Python használatával." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="XLS konvertálása MHT-vé a Python Excel könyvtár használatával" %}}

 Hogyan konvertálhatom a XLS-et MHT-vé? A Aspose.Cells for Python könyvtárral könnyedén konvertálhatod a XLS-et MHT-vé programozottan, néhány sornyi kóddal.[Aspose.Cells for Python](https://pypi.org/project/aspose-cells)képes többplatformos alkalmazások létrehozására, amelyek képesek az összes Excel fájl generálására, módosítására, konvertálására, renderelésére és nyomtatására. Python Az Excel API nemcsak a táblázatformátumok között konvertál, hanem Excel-fájlokat is képes megjeleníteni képként, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT és egyebekként, így tökéletes választás a szabványos formátumú dokumentumok cseréjéhez.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Mentse el a XLS-es számot MHT-ként a Python Excel könyvtárban" %}}

A következő példa bemutatja, hogyan konvertálhatja a XLS-et MHT-vé a Python Excel könyvtárban.
...
{{% cells-convert title="Mintakód a XLS MHT-vé konvertálásához a Python Excel könyvtár segítségével" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx;numbers;azw3" InputFormat="xls" outformat="mht" IsLandingPage="true" language="pythonjava" %}}

{{% blocks/products/pf/agp/content h2="Hogyan lehet a XLS-et MHT-vé konvertálni a Python-en keresztül" %}}

{{% blocks/products/pf/agp/text %}}

Programozottan kell MHT formátumba konvertálni a XLS fájlokat? A Python fejlesztői könnyedén betölthetik és MHT formátumba konvertálhatják a XLS fájlokat mindössze néhány sornyi kóddal.
...
1. Alakítsa át a XLS-et MHT-vé a Workbook.save metódus meghívásával.
1.  Szerezd meg a XLS MHT-re való átváltási eredményét.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Python Excel könyvtár a XLS MHT-vé konvertálásához" %}}
