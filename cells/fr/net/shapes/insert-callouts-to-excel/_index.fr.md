...
weight: 360
description: C# Exemple de code pour ajouter ou insérer des légendes dans Excel à l’aide de la bibliothèque .NET. Utilisez ce code pour créer des légendes dans MS Excel dans VB.NET, Asp.NET ou toute application basée sur .NET.
