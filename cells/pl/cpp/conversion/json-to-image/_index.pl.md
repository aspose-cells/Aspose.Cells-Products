...
Poniższy przykład pokazuje, jak przekonwertować liczbę JSON na obraz w formacie C++.
...
Trzeba programowo przekonwertować pliki JSON na IMAGE? Programiści C++ mogą łatwo przekonwertować pliki JSON na IMAGE za pomocą zaledwie kilku linijek kodu.
...
1.  Konwertuj JSON na OBRAZ wywołując metodę Save().
