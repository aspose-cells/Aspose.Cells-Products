...
url: /cs/cpp/merger/merge-xltx-to-png/ 
...
Následující příklad ukazuje, jak sloučit XLTX až PNG v Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit XLTX až PNG? Základní dokument, který se spojuje a spojuje[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna C++ ke sloučení XLTX až PNG" %}}
