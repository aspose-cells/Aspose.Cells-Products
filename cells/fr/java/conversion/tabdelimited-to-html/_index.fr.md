---
title: Convertir TABDELIMITED en HTML via Java 
url: /fr/java/conversion/tabdelimited-to-html/ 
description: Exemple de code de conversion Java pour le format TABDELIMITED en fichier HTML. Les programmeurs peuvent utiliser cet exemple de code pour exporter des feuilles de calcul Excel et OpenOffice au format HTML dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir TABDELIMITED en HTML via Java" h2="Conversion TABDELIMITED en HTML Java pour convertir une ou plusieurs pages en HTML à l\'aide de la bibliothèque Java sur site." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir TABDELIMITED en HTML à l\'aide de Java" %}}

 Afin de rendre TABDELIMITED en HTML, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TABDELIMITED en HTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir le fichier TABDELIMITED en HTML en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier TABDELIMITED avec une instance de la classe Workbook1. Appelez la méthode Workbook.save1. Passer le chemin de sortie avec l'extension HTML et SaveFormat comme paramètres1. Vérifier le chemin spécifié pour le fichier HTML résultant
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED en code source de conversion HTML Java" offSpacer="" %}}

```cs
// charger le fichier TABDELIMITED dans une instance de Workbook
Workbook book = new Workbook("template.tabdelimited");
// enregistrer TABDELIMITED au format HTML
