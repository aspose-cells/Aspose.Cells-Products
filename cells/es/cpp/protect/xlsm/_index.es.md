---
title:  Proteger y bloquear documento XLSM vía C++
weight: 8770
description: Código de ejemplo C++ para bloquear el archivo XLSM usando la contraseña en el entorno de tiempo de ejecución C++ para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
---
...
{{% blocks/products/pf/agp/content h2="Cómo asegurar el archivo XLSM usando C++" %}}
...
1.  Cargue el archivo XLSM usando la clase IWorkbook
1.  Utilice el método Protect(..) con ProtectionType y Password
1.  Guarde el archivo XLSM protegido con el método Save()
