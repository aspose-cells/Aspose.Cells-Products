---
title: Sloučit MHT s WORD - Sloučit MHT s WORD v Java
url: /cs/java/merger/merge-mht-to-word/ 
description: Aspose Excel. Java Aspose.Cells. Sloučit MHT do formátu uložení WORD. Java Zkombinujte MHT do formátu WORD. Sloučit MHT na WORD v Java. MHT Sloučit.
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT na WORD pomocí Java" %}}
...
{{% blocks/products/pf/agp/content h2="Sloučit MHT na WORD v Java" %}}

Následující příklad ukazuje, jak sloučit MHT s WORD v Aspose.Cells for Java.
{{% blocks/products/pf/agp/text %}}

Postupujte podle jednoduchých kroků pro sloučení MHT do WORD. Nahrajte své soubory, zavolejte metodu Workbook.Combine pro sloučení souborů a poté ji uložte do souboru WORD. Pokud vytvoříte kód v Java, bude to jednodušší, než to zní. Viz příklad Java, který sloučí MHT do WORD.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Ukázkový kód pro sloučení MHT s WORD v Java" InputFormat="mht" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak sloučit MHT na WORD via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete sloučit MHT na WORD programově? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Java](https://products.aspose.com/cells/java) Rozhraní API lze vytvořit pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/content h2="Knihovna Java pro sloučení MHT s WORD" %}}
