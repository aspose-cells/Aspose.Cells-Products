...
Нужно преобразовать XML-файлы в XML программным способом? .NET разработчики могут легко загружать и преобразовывать XML в XML, написав всего несколько строк кода.
