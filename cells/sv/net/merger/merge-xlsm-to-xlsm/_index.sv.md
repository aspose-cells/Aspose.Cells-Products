---
title: Slå samman XLSM till XLSM - Kombinera XLSM till XLSM i C#
url: /sv/net/merger/merge-xlsm-to-xlsm/ 
description: Aspose Excel. C# Aspose.Cells. Gratis Online Merge XLSM till XLSM sparaformat. C# Kombinera XLSM till XLSM format. Slå samman XLSM till XLSM i C#. XLSM Slå samman.
...
{{% blocks/products/pf/agp/content h2="Slå samman XLSM till XLSM i C# Online gratis" %}}

Följande exempel visar hur man slår samman XLSM till XLSM i Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att slå samman XLSM till XLSM. Ladda upp dina filer, ring Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i filen XLSM. Om du utvecklar kod i C# blir detta enklare än det låter. Se C# exempel som slår samman XLSM till XLSM.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online för att slå samman XLSM till XLSM i C#" InputFormat="xlsm" InputFormat2="xlsm" outformat="xlsm" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman XLSM till XLSM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman XLSM till XLSM programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman XLSM till XLSM" %}}
