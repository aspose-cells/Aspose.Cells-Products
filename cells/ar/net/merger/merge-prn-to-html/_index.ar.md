---
title: دمج PRN في HTML - ادمج PRN مع HTML في C#
url: /ar/net/merger/merge-prn-to-html/ 
description: Aspose إكسل. C# Aspose.Cells. دمج مجاني عبر الإنترنت PRN إلى HTML saveformat. C# ادمج PRN بتنسيق HTML. دمج PRN إلى HTML في C#. PRN Merge.
...
يوضح المثال التالي كيفية دمج PRN مع HTML في Aspose.Cells for .NET.
...
{{% cells-merger title="مجانًا عبر الإنترنت لدمج PRN في HTML في C#" InputFormat="prn" InputFormat2="html" outformat="html" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="كيفية دمج PRN في HTML عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى دمج PRN في HTML برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
