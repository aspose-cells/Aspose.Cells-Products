...
{{% blocks/products/pf/agp/feature-section-col title="Действия по вставке изогнутой формы в файл Excel via Java" %}}
...
+ Выберите рабочий лист по его индексу.
 + Используйте[добавить метод](https://reference.aspose.com/cells/java/com.aspose.cells/shapecollection/#addAutoShape-int-int-int-int-int-int-int-) вставить изогнутую форму на выбранный лист
