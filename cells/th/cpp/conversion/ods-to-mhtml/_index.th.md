---
title: แปลง ODS เป็น MHTML ผ่าน C++ แอปพลิเคชัน 
weight: 1750
url: /th/cpp/conversion/ods-to-mhtml/ 
description: ตัวอย่างรหัสการแปลง C++ สำหรับเอกสาร ODS เป็นรูปแบบ MHTML โปรแกรมเมอร์สามารถใช้ซอร์สโค้ดนี้สำหรับการแปลง ODS เป็นกลุ่มเป็น MHTML ภายในแอปพลิเคชัน C++ ใดๆ
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แปลง ODS เป็น MHTML ผ่าน C++" h2="การแปลง ODS เป็น MHTML ประสิทธิภาพสูงโดยใช้ไลบรารี C++ โดยไม่ต้องติดตั้ง Microsoft Excel, OpenOffice หรือ Adobe Acrobat" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="ODS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ นักพัฒนาสามารถแปลงไฟล์ ODS เป็น MHTML ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ ODS โดยใช้ Factory::CreateIWorkbook1. เรียกใช้เมธอด Save()1. ส่งพาธไฟล์เอาต์พุตที่มีนามสกุลไฟล์ (MHTML)1. ไฟล์ MHTML จะถูกบันทึกตามเส้นทางที่ระบุ1. เปิดไฟล์ MHTML ในโปรแกรมที่เข้ากันได้
...
{{% blocks/products/pf/agp/code-block title="ODS เป็น MHTML C++ ซอร์สโค้ดการแปลง" offSpacer="" %}}
