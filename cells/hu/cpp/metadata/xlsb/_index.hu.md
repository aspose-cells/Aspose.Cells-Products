---
title: "Szerkessze vagy tekintse meg az XLSB-dokumentum metaadatait a következőn keresztül: C++ "
weight: 4820
url: /hu/cpp/metadata/xlsb/ 
description: C++ példakód az XLSB-fájlok metaadatainak szerkesztéséhez vagy megtekintéséhez a C++ Runtime Environment for Windows 32 bit, Windows 64 bit és Linux 64 bit.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="XLSB metaadatok kibontása a következőn keresztül: C++" h2="Hozzon létre saját C++-alkalmazásokat XLSB-fájlok metaadatok hozzáadásához, szerkesztéséhez, eltávolításához vagy kibontásához szerveroldali API-k segítségével." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PPTX" fileiconsmall2="DOCX" fileiconsmall3="XLSX" fileiconsmall4="PDF" fileiconsmall5=" ODP " >}}
...
{{% blocks/products/pf/agp/content h2="XLSB-metaadatok beszerzése a következővel: C++" %}}
...
+ Töltse be az XLSB fájlt a CreateIWorkbookMetadata segítségével
