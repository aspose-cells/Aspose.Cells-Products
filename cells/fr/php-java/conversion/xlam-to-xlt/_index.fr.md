---
title: Convertisseur PHP XLAM à XLT - XLAM à XLT
description: Aspose Exceller. Convertissez XLAM en XLT rapidement et facilement avec Aspose.Cells. PHP XLAM en XLT. PHP Enregistrez XLAM en XLT. Enregistrez XLAM sous XLT en utilisant PHP.
...
{{% blocks/products/pf/agp/content h2="Convertir XLAM en XLT en utilisant PHP" %}}
 ...
 Comment convertir XLAM en XLT ? Avec la bibliothèque Aspose.Cells for PHP via Java, vous pouvez facilement convertir XLAM en XLT par programme avec quelques lignes de code.[Aspose.Cells for PHP via Java](https://products.aspose.com/cells/php-java/) est capable de créer des applications multiplateformes avec la possibilité de générer, modifier, convertir, restituer et imprimer tous les fichiers Excel. PHP Excel API convertit non seulement entre les formats de feuilles de calcul, il peut également restituer des fichiers Excel sous forme d'images, PDF, HTML, ODS, CSV, SVG, JSON, WORD, PPT et plus, ce qui en fait un choix parfait pour échanger des documents dans des formats standard de l'industrie.
 
{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Enregistrer le XLAM au XLT en PHP" %}}
...
Besoin de convertir les fichiers XLAM en XLT par programme ? Les développeurs PHP peuvent facilement charger et convertir XLAM en XLT en quelques lignes de code.
...
1.  Convertissez XLAM en XLT en appelant la méthode de sauvegarde du classeur.
