---
title: C++ EXCEL a DOCX - Convertidor EXCEL a DOCX
description: Aspose Excel. Convierta EXCEL a DOCX rápida y fácilmente con Aspose.Cells. C++ EXCEL a DOCX. C++ Guarde EXCEL en DOCX. Guarde EXCEL como DOCX usando C++.
...
{{% blocks/products/pf/agp/content h2="Guardar EXCEL al DOCX en C++" %}}

El siguiente ejemplo demuestra cómo convertir EXCEL a DOCX en C++.
...
{{% cells-convert title="Código de muestra para convertir EXCEL a DOCX" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="docx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Cómo convertir EXCEL a DOCX a través de C++" %}}

{{% blocks/products/pf/agp/text %}}

¿Necesita convertir archivos EXCEL a DOCX mediante programación? Los desarrolladores de C++ pueden convertir fácilmente EXCEL a DOCX en tan solo unas pocas líneas de código.
...
1.  Convierta EXCEL a DOCX llamando al método Save().
1.  Obtenga el resultado de la conversión de EXCEL a DOCX.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Biblioteca C++ para convertir EXCEL a DOCX" %}}
