...
weight: 1360
description: C# 原始碼，用於組合 .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 TSV 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="合併 C# 中的 TSV 格式" h2="使用伺服器端 Aspose.Cells for .NET API 進行本機高效能 TSV 文件合併，無需使用 Microsoft 或 Open Office、Adobe PDF 等任何軟體。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TSV" >}}
...
為了合併 TSV 文件，我們將使用[Aspose.Cells for .NET](https://products.aspose.com/cells/net)API這是一個功能豐富、強大且易於使用的文件操作和合併API，適用於C#平台。打開[NuGet](https://www.nuget.org/packages/aspose.cells)套件管理器，搜尋**Aspose.Cells**並安裝。您也可以從套件管理器控制台使用以下命令。
...
+ 製作一個文件作為基礎文件
呼叫相關方法將檔案逐一串聯和合併。
+ 呼叫 Save() 方法並傳遞檔案名稱（完整路徑）和格式（TSV）作為參數。
+ 現在您可以在 Microsoft Office、Adobe PDF 或任何其他相容程式中開啟和使用 TSV 檔案。
...
{{< blocks/products/pf/agp/demobox sectionTitle="線上 TSV 合併現場演示" sectionDescription="立即合併 TSV 文檔，存取我們的[現場示範網站](https://products.aspose.app/cells/merger)。現場演示有以下好處" >}}
