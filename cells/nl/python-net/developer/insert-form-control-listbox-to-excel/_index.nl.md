---
title:  Plaats ListBox (Formulierbeheer) in Excel via Python
weight: 50
description: Python broncode om ListBox (formulierbesturing) in Excel in te voegen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Plaats ListBox (Formulierbeheer) in Excel via Python" h2="Voeg objecten in met behulp van server-side API\'s zonder enige software zoals Microsoft of Open Office, Adobe PDF, etc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/cells/aspose_cells-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for Python via .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe ListBox (formulierbesturing) in Excel-bestand in te voegen met behulp van Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om ListBox (formulierbesturing) in Excel-bestand in te voegen via Python" %}}
...
+ Gebruik de add-methode van de shapecollection om een ListBox (formulierbesturingselement) in het geselecteerde werkblad in te voegen.
...
{{% blocks/products/pf/agp/code-block title="Voeg ListBox in (formulierbesturing) - Python" offSpacer="" %}}
