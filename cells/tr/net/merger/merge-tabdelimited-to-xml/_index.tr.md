...
url: /tr/net/merger/merge-tabdelimited-to-xml/ 
...
Aşağıdaki örnek, Aspose.Cells for .NET'de TABDELIMITED'ın XML ile nasıl birleştirileceğini gösterir.
...
{{% blocks/products/pf/agp/text %}}
 ...
 TABDELIMITED'ı XML ile programlı olarak birleştirmeniz mi gerekiyor? Birleştiren ve birleştiren temel bir belge[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API'ler yalnızca birkaç satır kodla yapılabilir.
...
{{% blocks/products/pf/agp/content h2=".NET kütüphane TABDELIMITED\'ı XML ile birleştirmek için" %}}
