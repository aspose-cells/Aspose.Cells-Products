...
url: /id/net/merger/merge-numbers-to-xps/ 
...
Contoh berikut menunjukkan cara menggabungkan ANGKA ke XPS di Aspose.Cells for .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Perlu menggabungkan ANGKA ke XPS secara terprogram? Penggabungan dan penggabungan dokumen dasar[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API dapat dilakukan hanya dengan beberapa baris kode.
...
{{% blocks/products/pf/agp/content h2="Pustaka .NET untuk menggabungkan ANGKA menjadi XPS" %}}
