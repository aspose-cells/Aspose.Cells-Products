...
url: /cs/python-net/merger/merge-tsv-to-xps/ 
...
Následující příklad ukazuje, jak sloučit TSV až XPS v Aspose.Cells for Python via .NET.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Potřebujete programově sloučit TSV až XPS? Základní dokument, který se spojuje a spojuje[Aspose.Cells for Python via .NET](https://products.aspose.com/cells/python-net) Rozhraní API lze vytvořit pomocí několika řádků kódu.
