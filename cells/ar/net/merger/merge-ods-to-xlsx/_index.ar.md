---
title: دمج ODS إلى XLSX - اجمع ODS إلى XLSX في C#
url: /ar/net/merger/merge-ods-to-xlsx/ 
description: Aspose إكسل. C# Aspose.Cells. الدمج المجاني عبر الإنترنت ODS إلى XLSX saveformat. C# اجمع ODS إلى تنسيق XLSX. دمج ODS إلى XLSX في C#. ODS دمج.
...
{{% blocks/products/pf/agp/content h2="قم بدمج ODS إلى XLSX في C# عبر الإنترنت مجانًا" %}}

يوضح المثال التالي كيفية دمج ODS مع XLSX في Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

اتبع الخطوات السهلة لدمج ODS إلى XLSX. قم بتحميل ملفاتك ، واستدعاء طريقة Workbook.Combine لدمج الملفات ، ثم احفظها في ملف XLSX. إذا قمت بتطوير رمز في C# ، فسيكون هذا أبسط مما يبدو. راجع C# المثال الذي يدمج ODS إلى XLSX.
...
{{% blocks/products/pf/agp/content h2="كيفية الدمج ODS إلى XLSX عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 هل تحتاج إلى دمج ODS مع XLSX برمجيًا؟ مستند أساسي يتم دمجه والتسلسل معه[Aspose.Cells for .NET](https://products.aspose.com/cells/net) يمكن عمل واجهات برمجة التطبيقات ببضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/content h2="مكتبة .NET لدمج ODS إلى XLSX" %}}
