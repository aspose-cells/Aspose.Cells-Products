---
title: Slå samman XLSX till WORD - Kombinera XLSX till WORD i C++
url: /sv/cpp/merger/merge-xlsx-to-word/ 
description: Aspose Excel. C++ Aspose.Cells. Gratis Online Merge XLSX till WORD saveformat. C++ Kombinera XLSX till WORD-format. Slå samman XLSX till WORD i C++. XLSX Slå samman.
...
Följande exempel visar hur man slår samman XLSX till WORD i Aspose.Cells for C++.
...
{{% cells-merger title="Gratis online för att slå samman XLSX till WORD i C++" InputFormat="xlsx" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="cpp" %}}

{{% blocks/products/pf/agp/content h2="Hur man slår samman XLSX till WORD via C++" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman XLSX till WORD programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API:er kan göras med bara några rader kod.
