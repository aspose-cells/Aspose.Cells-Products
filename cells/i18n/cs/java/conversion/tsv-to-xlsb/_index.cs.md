---
title: Převést TSV na XLSB přes Java 
weight: 7570
url: /cs/java/conversion/tsv-to-xlsb/ 
description: Ukázkový konverzní kód Java pro formát TSV na soubor XLSB. Programátoři mohou použít tento příklad kódu k exportu tabulek Excelu a OpenOffice do XLSB v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést TSV na XLSB přes Java" h2="Převod TSV na XLSB Java pro převod jedné nebo více stránek na XLSB pomocí místní knihovny Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLSB" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést TSV na XLSB pomocí Java" %}}

 K vykreslení TSV na XLSB použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu TSV na XLSB prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor TSV na XLSB pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor TSV s instancí třídy Workbook1. Zavolejte metodu Workbook.save1. Předejte výstupní cestu s rozšířením XLSB a SaveFormat jako parametry1. Zkontrolujte zadanou cestu pro výsledný soubor XLSB
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu TSV na XLSB Java" offSpacer="" %}}

```cs
// načíst soubor TSV v instanci sešitu
Workbook book = new Workbook("template.tsv");
// uložit TSV jako XLSB
