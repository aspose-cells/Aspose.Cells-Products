...
{{< blocks/products/pf/carousel-item h3="平台独立性" description="Aspose.Cells for Python via Java 可用。" >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
灵活的显示选项
    ...
    <p>
 Aspose.Cells for Python via Java 提供对页面设置的完全控制，允许操作多个显示选项，如预览分页符、设置缩放级别、设置页面方向、通过冻结窗格控制数据可见性、纸张大小、缩放、标题和标题。页脚和打印区域。
    </p>
   </div>
   <!--<div class="col-lg-12">
...
{{< blocks/products/pf/slr-tab tabTitle="为什么是Aspose.Cells for Python via Java？" tabId="success-stories" >}}
