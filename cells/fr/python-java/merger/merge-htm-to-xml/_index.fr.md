...
url: /fr/python-java/merger/merge-htm-to-xml/ 
...
L'exemple suivant montre comment fusionner HTM vers XML dans Aspose.Cells for Python via Java.
...
Besoin de fusionner HTM vers XML par programmation ? Un document de base fusionnant et concaténant avec[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Les API peuvent être réalisées avec seulement quelques lignes de code.
