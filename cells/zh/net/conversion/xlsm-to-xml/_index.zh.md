...
description: Aspose Excel。使用 Aspose.Cells. C# XLSM 到 XML 快速轻松地将 XLSM 转换为 XML。 C# 将 XLSM 保存到 XML。使用 C# 将 XLSM 保存为 XML。
...
{{% cells-convert title="将 XLSM 转换为 XML 的示例代码" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsm" outformat="xml" IsLandingPage="true" %}}
