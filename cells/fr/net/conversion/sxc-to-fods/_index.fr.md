...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SXC en FODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers SXC en FODS en quelques lignes de code seulement.
