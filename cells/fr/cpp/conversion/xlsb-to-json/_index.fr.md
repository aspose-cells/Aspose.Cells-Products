---
title: C++ XLSB à JSON - Convertisseur en ligne XLSB à JSON
description: Aspose Excel. C++ Aspose.Cells. C++ Aspose Cells. Gratuit en ligne C++ Convertir XLSB en format de sauvegarde JSON. Format C++ XLSB à JSON. Enregistrez XLSB à JSON C++.
...
{{% blocks/products/pf/agp/content h2="Enregistrez XLSB à JSON dans C++ en ligne gratuitement" %}}

L'exemple suivant montre comment convertir XLSB en JSON en C++.
...
Besoin de convertir les fichiers XLSB en JSON par programmation ? Les développeurs de C++ peuvent facilement convertir XLSB en JSON en seulement quelques lignes de code.
