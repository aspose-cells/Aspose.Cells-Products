...
{{% cells-convert title="Ingyenes alkalmazás és mintakód a XLTX konvertálásához TABDELIMITED online" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="tsv" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="A XLTX konvertálása TABDELIMITED via Java-re" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztők könnyedén konvertálhatják a XLTX-et TABDELIMITED-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1.  Töltse be a XLTX számú fájlt a Workbook osztály egy példányával
1.  A XLTX konvertálása TABDELIMITED-re a Workbook.save metódus meghívásával
