...
Нужно программно преобразовать файлы XLAM в JPG? Разработчики, работающие с файлами C++, могут легко преобразовать файлы XLAM в JPG всего несколькими строками кода.
...
1.  Преобразуйте файл XLAM в формат JPG, вызвав метод Save().
