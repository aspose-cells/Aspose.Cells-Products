...
{{% blocks/products/pf/agp/content h2="Преобразование SPREADSHEETML в SPREADSHEETML с использованием кода Java" %}}
...
{{% blocks/products/pf/agp/content h2="Сохраните файл SPREADSHEETML в формате SPREADSHEETML в файле Java" %}}

Следующий пример демонстрирует, как преобразовать SPREADSHEETML в SPREADSHEETML в файле Java.
...
Нужно программно преобразовать файлы SPREADSHEETML в формат SPREADSHEETML? Разработчики, использующие код Java, могут легко преобразовать файлы SPREADSHEETML в формат SPREADSHEETML всего за несколько строк кода.
...
1.  Преобразуйте SPREADSHEETML в SPREADSHEETML, вызвав метод Workbook.save.
1.  Получите результат преобразования SPREADSHEETML в SPREADSHEETML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Библиотека Java для преобразования SPREADSHEETML в SPREADSHEETML" %}}
{{% blocks/products/pf/agp/text %}}
