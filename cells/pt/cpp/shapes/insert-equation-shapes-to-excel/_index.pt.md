---
title: Insira formas de equação no Excel via C++
weight: 780
description: C++ código de exemplo para inserir formas de equação no arquivo Excel no C++ Runtime Environment para Windows 32 bits, Windows 64 bits e Linux 64 bits.
keywords: [C++ Aspose.Cells., C++ add equation shapes., C++ insert equation shapes., C++ create equation shapes]
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Insira formas de equação no Excel via C++" h2="Insira objetos utilizando o nativo e de alto desempenho do server-side Aspose.Cells for C++ API sem utilizar nenhum software como Microsoft ou Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for C++" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como inserir formas de equação em arquivo Excel usando C++" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para inserir formas de equação em arquivo Excel via C++" %}}
