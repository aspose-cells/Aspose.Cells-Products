...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ادراج الشكل المنحني لملف Excel عبر C#" %}}
...
+ حدد ورقة العمل من خلال الفهرس الخاص بها.
 + استخدم ملف[طريقة الإضافة](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapecollection/addautoshape/) لإدراج شكل منحني في ورقة العمل المحددة
...
{{% blocks/products/pf/agp/code-block title="أدخل الشكل المنحني - C#" offSpacer="" %}}
