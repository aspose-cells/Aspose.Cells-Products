---
title:  Editar o ver metadatos del documento XLSB a través de C++
weight: 4820
description: Código de ejemplo C++ para editar o ver metadatos del archivo XLSB en el entorno de ejecución C++ para Windows de 32 bits, Windows de 64 bits y Linux de 64 bits.
...
{{% blocks/products/pf/agp/content h2="Cómo obtener metadatos de XLSB utilizando C++" %}}
...
+ Cargue el archivo XLSB usando WorkbookMetadata
