...
Aşağıdaki örnek, XLT'in Aspose.Cells for C++'de HTM ile nasıl birleştirileceğini gösterir.
...
XLT'i programlı olarak HTM ile birleştirmeniz mi gerekiyor? Birleştirme ve birleştirme ile temel bir belge[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API'ler yalnızca birkaç satır kodla yapılabilir.
