---
title: HTML から MHTML を結合 - HTML から MHTML を C++ に結合
url: /ja/cpp/merger/merge-html-to-mhtml/ 
description: Aspose エクセル。 C++ Aspose.Cells。HTML を MHTML の保存形式に無料でオンライン結合します。 C++ HTML と MHTML の形式を結合します。 HTML から MHTML を C++ に結合します。HTML を結合します。
...
次の例は、HTML を Aspose.Cells for C++ の MHTML にマージする方法を示しています。
...
HTML をプログラムで MHTML にマージする必要がありますか?マージおよび連結する基本的なドキュメント[Aspose.Cells for C++](https://products.aspose.com/cells/cpp)API はわずか数行のコードで実行できます。
