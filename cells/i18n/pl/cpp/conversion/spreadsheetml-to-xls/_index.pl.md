---
title: Konwertuj SPREADSHEETML na XLS za pomocą aplikacji C++ 
url: /pl/cpp/conversion/spreadsheetml-to-xls/ 
description: Przykładowy kod konwersji C++ dla dokumentu SPREADSHEETML do formatu XLS. Programiści mogą używać tego kodu źródłowego do wsadowej konwersji SPREADSHEETML na XLS w dowolnej aplikacji C++.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować SPREADSHEETML na XLS za pomocą C++" %}}

 Aby przekonwertować SPREADSHEETML na XLS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować SPREADSHEETML na XLS za pomocą C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ programiści mogą łatwo przekonwertować plik SPREADSHEETML na XLS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik SPREADSHEETML przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (XLS).1. Plik XLS zostanie zapisany pod określoną ścieżką.1. Otwórz plik XLS w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML do XLS C++ Kod źródłowy konwersji" offSpacer="" %}}
