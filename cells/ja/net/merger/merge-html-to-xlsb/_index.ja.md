...
description: Aspose エクセル。 C# Aspose.Cells。HTML を XLSB の保存形式にマージします。 C# HTML と XLSB の形式を結合します。 HTML から XLSB を C# に結合します。HTML を結合します。
