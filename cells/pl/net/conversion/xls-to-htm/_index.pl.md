---
title: C# XLS do HTM - XLS do konwertera HTM
description: Aspose Excel. To kompleksowe rozwiązanie zapewnia programistom w pełni zintegrowane podejście do konwersji XLS do formatu HTM, umożliwiając bezproblemowe zapisywanie danych XLS w formacie HTM za pomocą biblioteki Aspose.Cells, a wszystko to dzięki wydajnemu i konfigurowalnemu kodowi C#.
...
{{% blocks/products/pf/agp/content h2="Zapisz XLS do HTM w C#" %}}

Poniższy przykład pokazuje, jak przekonwertować liczbę XLS na format HTM w formacie C#.
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować XLS na HTM za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

Trzeba programowo przekonwertować pliki XLS do formatu HTM? Programiści .NET mogą łatwo załadować i przekonwertować pliki XLS do formatu HTM za pomocą zaledwie kilku linijek kodu.
