...
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj XLTM na TXT przez C++" h2="Wysoce wydajna konwersja XLTM do TXT przy użyciu biblioteki C++ bez konieczności instalacji Microsoft Excel, OpenOffice lub Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="XLTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 C++ programiści mogą łatwo przekonwertować plik XLTM na TXT w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik XLTM przy użyciu Factory::CreateIWorkbook.1. Wywołaj metodę Save().1. Przekaż ścieżkę pliku wyjściowego z rozszerzeniem pliku (TXT).1. Plik TXT zostanie zapisany pod określoną ścieżką.1. Otwórz plik TXT w kompatybilnym programie.
...
{{% blocks/products/pf/agp/code-block title="XLTM do TXT C++ Kod źródłowy konwersji" offSpacer="" %}}
