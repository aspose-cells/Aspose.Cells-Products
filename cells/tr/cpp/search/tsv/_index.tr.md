---
title:  TSV belgesini C++ üzerinden açmadan ara
weight: 930
description: C++ Windows 32 bit, Windows 64 bit ve Linux 64 bit için C++ Çalışma Zamanı Ortamı'ndaki TSV dosyasındaki desenli kelimeleri aramak için örnek kod.
...
+ Bir Çalışma Kitabı sınıfını başlatarak TSV dosyasını yükleyin.
...
+ Workbook::Save(...) yöntemini kullanarak TSV dosyasını kaydedin.
