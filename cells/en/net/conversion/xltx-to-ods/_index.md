...
{{% blocks/products/pf/agp/content h2="Save XLTX to ODS in C#" %}}

The following example demonstrates how to convert XLTX to ODS in C#.
...
{{% cells-convert title="Sample Code to Convert XLTX to ODS" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xltx" outformat="ods" IsLandingPage="true" %}}

{{% blocks/products/pf/agp/content h2="How to Convert XLTX to ODS via C#" %}}

{{% blocks/products/pf/agp/text %}}

Need to convert XLTX files to ODS programmatically? .NET developers can easily load & convert XLTX to ODS in just a few lines of code.
...
{{% blocks/products/pf/agp/content h2="C# library to convert XLTX to ODS" %}}
