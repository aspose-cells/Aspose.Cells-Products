---
title:  CSV 문서를 열지 않고 검색 via .NET
weight: 7510
description: .NET 프레임워크, .NET 코어, Mono 또는 Xamarin 플랫폼의 CSV 파일에서 패턴이 있는 단어를 검색하는 C# 소스 코드.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="CSV 형식 검색 C#" h2="Microsoft 또는 Adobe PDF과 같은 소프트웨어를 사용하지 않고 서버 측 Aspose.Cells for .NET API를 사용하여 기본 및 고성능 CSV 문서 검색." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Cells" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
