---
title: Konvertor PHP MHTML až MHTML - MHTML až MHTML
description: Aspose Excel. Převeďte MHTML na MHTML rychle a snadno pomocí Aspose.Cells. PHP MHTML na MHTML. PHP Uložte MHTML na MHTML. Uložte MHTML jako MHTML jako 81 PHP.07481 jako
...
{{% cells-convert title="Ukázkový kód pro převod MHTML na MHTML" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="mhtml" outformat="mhtml" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="Jak převést MHTML na MHTML přes PHP" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést soubory MHTML na MHTML programově? Vývojáři PHP mohou snadno načíst a převést MHTML na MHTML v několika řádcích kódu.
...
1.  Převeďte MHTML na MHTML voláním metody uložení sešitu.
1.  Získejte výsledek převodu MHTML na MHTML.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna PHP pro převod MHTML na MHTML" %}}
