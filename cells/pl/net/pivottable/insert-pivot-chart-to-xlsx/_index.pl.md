...
weight: 7690
description: C# Przykładowy kod umożliwiający dodanie wykresu przestawnego do XLSX przy użyciu biblioteki .NET. Użyj tego kodu, aby wstawić wykres przestawny do pliku XLSX w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
