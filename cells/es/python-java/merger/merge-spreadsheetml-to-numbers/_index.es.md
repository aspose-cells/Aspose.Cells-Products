...
url: /es/python-java/merger/merge-spreadsheetml-to-numbers/ 
...
El siguiente ejemplo muestra cómo combinar SPREADSHEETML con NUMBERS en Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 ¿Necesita fusionar SPREADSHEETML con NUMBERS mediante programación? Un documento básico que se fusiona y concatena con[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Las API se pueden hacer con solo unas pocas líneas de código.
