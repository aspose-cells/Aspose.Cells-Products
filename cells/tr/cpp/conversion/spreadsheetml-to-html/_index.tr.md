---
title: C++ uygulaması aracılığıyla SPREADSHEETML'yi HTML'ye dönüştürün 
url: /tr/cpp/conversion/spreadsheetml-to-html/ 
description: SPREADSHEETML belgesi için HTML biçimine örnek C++ dönüştürme kodu. Programcılar, herhangi bir C++ Uygulamasında toplu SPREADSHEETML'den HTML'ye dönüştürme için bu kaynak kodunu kullanabilir.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="SPREADSHEETML\'yi C++ aracılığıyla HTML\'ye dönüştürün" h2="Microsoft Excel, OpenOffice veya Adobe Acrobat kurulumuna ihtiyaç duymadan C++ kitaplığını kullanarak yüksek performanslı SPREADSHEETML\'den HTML\'ye dönüştürme." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="SPREADSHEETML" >}}
...
{{% blocks/products/pf/agp/content h2="C++ Kullanarak SPREADSHEETML\'yi HTML\'ye Dönüştürme" %}}

 SPREADSHEETML'yi HTML'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="SPREADSHEETML\'yi C++ aracılığıyla HTML\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 C++ geliştiricileri, yalnızca birkaç satır kodla SPREADSHEETML dosyasını HTML'ye kolayca dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Factory::CreateIWorkbook'u kullanarak SPREADSHETML dosyasını yükleyin.1. Save() yöntemini çağırın.1. Çıktı dosyası yolunu (HTML) dosya uzantısıyla iletin.1. HTML dosyası belirtilen yola kaydedilecektir.1. Uyumlu programda HTML dosyasını açın.
...
{{% blocks/products/pf/agp/code-block title="SPREADSHEETML\'den HTML\'ye C++ Dönüşüm Kaynak Kodu" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SPREADSHEETML\'den HTML\'ye Dönüştürme Canlı Demoları" sectionDescription="[SPREADSHETML\'yi HTML\'ye dönüştür](https://products.aspose.app/cells/conversion/spreadsheetml-to-html) Hemen şimdi Canlı Demolar web sitemizi ziyaret ederek. Canlı demo aşağıdaki avantajlara sahiptir." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API dosyasını indirmenize gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Herhangi bir kod yazmaya gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Sadece SPREADSHEETML dosyanızı yükleyin, anında HTML\'ye dönüştürülecektir." >}}
