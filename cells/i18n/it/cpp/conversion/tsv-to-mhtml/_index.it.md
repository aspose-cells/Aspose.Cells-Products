---
title: Converti TSV in MHTML tramite l'applicazione C++ 
weight: 9310
url: /it/cpp/conversion/tsv-to-mhtml/ 
description: Esempio di codice di conversione C++ per un documento TSV in formato MHTML. I programmatori possono utilizzare questo codice sorgente per la conversione batch da TSV a MHTML all'interno di qualsiasi C++ Applicazione.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti TSV in MHTML tramite C++" h2="Conversione da TSV a MHTML ad alte prestazioni utilizzando la libreria C++ senza la necessità di installare Microsoft Excel, OpenOffice o Adobe Acrobat." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-cpp.svg" sourceAdditionalConversionTag="" additionalConversionTag="MHTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TSV" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire TSV in MHTML utilizzando C++" %}}

 Per convertire TSV in MHTML, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire TSV in MHTML tramite C++" %}}

{{% blocks/products/pf/agp/text %}}

 C++ gli sviluppatori possono convertire facilmente file TSV in MHTML in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file TSV usando Factory::CreateIWorkbook.1. Chiama il metodo Save().1. Passa il percorso del file di output con l'estensione del file (MHTML).1. Il file MHTML verrà salvato nel percorso specificato.1. Apri il file MHTML nel programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da TSV a MHTML C++" offSpacer="" %}}

```cs
// Carica il TSV.
intrusive_ptr<Aspose::Cells::IWorkbook> wkb = Factory::CreateIWorkbook(u"sourceFile.tsv");

// Salva in formato MHTML.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo dal vivo di conversione da TSV a MHTML" sectionDescription="[Converti TSV in MHTML](https://products.aspose.app/cells/conversion/tsv-to-mhtml) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file TSV, verrà convertito istantaneamente in MHTML." >}}
