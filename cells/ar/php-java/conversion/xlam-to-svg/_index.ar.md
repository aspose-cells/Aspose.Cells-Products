---
title: PHP XLAM إلى SVG - XLAM إلى SVG محول
description: Aspose اكسل. قم بتحويل XLAM إلى SVG بسرعة وسهولة باستخدام Aspose.Cells. PHP XLAM إلى SVG. PHP احفظ XLAM إلى SVG. احفظ XLAM كـ SVG باستخدام PHP.
...
{{% cells-convert title="نموذج التعليمات البرمجية لتحويل XLAM إلى SVG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlam" outformat="svg" IsLandingPage="true" language="phpjava" %}}

{{% blocks/products/pf/agp/content h2="كيفية تحويل XLAM إلى SVG عبر PHP" %}}

{{% blocks/products/pf/agp/text %}}

هل تحتاج إلى تحويل ملفات XLAM إلى SVG برمجياً؟ يمكن لمطوري PHP تحميل وتحويل XLAM إلى SVG بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  تحويل XLAM إلى SVG عن طريق استدعاء طريقة حفظ المصنف.
