...
description: Aspose Excel. Μετατρέψτε το EXCEL σε TXT γρήγορα και εύκολα με το Aspose.Cells. C++ EXCEL σε TXT. C++ Αποθήκευση EXCEL σε TXT. Αποθηκεύστε το EXCEL χρησιμοποιώντας το C++.
...
{{% cells-convert title="Δείγμα κώδικα για μετατροπή EXCEL σε TXT" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="xlsx" outformat="txt" IsLandingPage="true" language="cpp" %}}
