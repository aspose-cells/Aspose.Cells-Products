---
title:  Fusionner XLT à XLS via Python
url: /fr/python-java/merger/merge-xlt-to-xls/ 
description: Fusionnez XLT à XLS en ligne gratuitement. Gratuit en ligne XLT à XLS Fusion. Fusionnez XLT vers Word, Excel, PPTX, PDF, JPG, HTML, ODS, SVG, XPS et plus.
---
...
L'exemple suivant montre comment fusionner XLT à XLS dans Python.
...
{{% cells-merger title="Application gratuite pour fusionner XLT à XLS en ligne" InputFormat="xlt" InputFormat2="xls" outformat="xls" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xltx;xlt;xltm;json;fods;ods;csv;tsv;txt;xml;sxc;html;jpg;bmp;png;svg;tiff;xps;mhtml;md" IsLandingPage="true" language="pythonjava" %}}
