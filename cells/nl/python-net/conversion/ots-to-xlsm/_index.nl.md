...
description: Aspose Excel. Converteer OTS snel en eenvoudig naar XLSM met Aspose.Cells. Python OTS naar XLSM. Python Bewaar OTS naar XLSM. Sla OTS op als XLSM met Python.
...
{{% blocks/products/pf/agp/content h2="Converteer OTS naar XLSM in Python" %}}
...
{{% blocks/products/pf/agp/content h2="Bewaar OTS op XLSM in Python" %}}

Het volgende voorbeeld laat zien hoe u OTS converteert naar XLSM in Python via NET.
...
{{% blocks/products/pf/agp/content h2="Python-bibliotheek om OTS naar XLSM te converteren" %}}
