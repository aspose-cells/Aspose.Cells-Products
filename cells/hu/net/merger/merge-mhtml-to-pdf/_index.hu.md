---
title: A MHTML-PDF-es számok egyesítése – a MHTML-es és a PDF-es számok egyesítése a C#-ben
url: /hu/net/merger/merge-mhtml-to-pdf/ 
description: Aspose Excel. C# Aspose.Cells. A MHTML és a PDF mentési formátum egyesítése. C# A MHTML és a PDF formátum kombinálása. Egyesítse a MHTML-PDF-et a C#-ben. MHTML Egyesítse.
...
{{% blocks/products/pf/agp/content h2="A MHTML és a PDF egyesítése a C#-ben" %}}

A következő példa bemutatja a MHTML és a PDF egyesítését a Aspose.Cells for .NET számban.
{{% blocks/products/pf/agp/text %}}

Kövesse az egyszerű lépéseket a MHTML-es és a PDF-es számok egyesítéséhez. Töltse fel a fájlokat, hívja meg a Workbook.Combine metódust a fájlok egyesítéséhez, majd mentse el a PDF fájlba. Ha kódot fejleszt a C#-ben, ez egyszerűbb lesz, mint amilyennek hangzik. Lásd a C#-es példát, amely egyesíti a MHTML és PDF számokat.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Mintakód a MHTML és PDF közötti egyesítéshez a C#-ben" InputFormat="mhtml" InputFormat2="pdf" outformat="pdf" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="A MHTML és a PDF egyesítése a C# számon keresztül" %}}

{{% blocks/products/pf/agp/text %}}

 Programozottan egyesítenie kell a MHTML-et a PDF-gyel? Egy alapdokumentum, amely összeolvad és összefűződik[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Az API-k néhány sornyi kóddal elkészíthetők.
...
{{% blocks/products/pf/agp/content h2=".NET könyvtár a MHTML és PDF egyesítéséhez" %}}
