...
description: Aspose Эксель. C++ Создайте файл JPEG быстро и легко с помощью Aspose.Cells. Создайте файл JPEG с помощью C++. Создайте JPEG в C++. C++ JPEG Creater.
...
1.  Сохраните книгу как файл .jpg, используя метод Save().
