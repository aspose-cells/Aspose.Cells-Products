---
title:  Bekijk MHT-bestandsformaten via .NET
description: C# broncode voor het laden, renderen en weergeven van MHT-documenten op .NET Framework, .NET Core, Windows Azure, Mono of Xamarin Platforms.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Cells maakt het voor de ontwikkelaars gemakkelijk om het MHT-bestand te bekijken met slechts enkele regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad het MHT-bestand in een exemplaar van Workbook
1. Maak een exemplaar van HtmlSaveOptions en stel de eigenschap ExportHeadings in op true
1. Sla het MHT-bestand op in de indeling HTML met behulp van de Workbook.Save-methode
...
{{% blocks/products/pf/agp/code-block title="C# voorbeeldcode om het MHT-bestand te bekijken" offSpacer="" %}}
...
Aspose.Cells API kan worden gebruikt voor het maken, bewerken, converteren en renderen van Microsoft Excel-formaten naar verschillende formaten. Bovendien kan het worden gebruikt voor uitgebreide grafieken, schaalbare rapportage en betrouwbare berekeningen binnen softwareapplicaties. Aspose.Cells is een standalone API en vereist geen software zoals Microsoft of OpenOffice.
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Gratis app om MHT te bekijken" sectionDescription=" Bekijk onze live demo\'s om[Bekijk MHT](https://products.aspose.app/cells/viewer/mht) met de volgende voordelen." >}}
