---
title: Java HTML do JPG - HTML do JPG Converter
description: Aspose Excel. Převeďte HTML na JPG rychle a snadno pomocí Aspose.Cells. Java HTML na JPG. Java Uložit HTML do JPG. Uložte HTML jako JPG pomocí Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Převeďte HTML na JPG v Java" h2="Vysokorychlostní knihovna Java pro převod HTML do JPG. Jedná se o profesionální softwarové řešení pro import a export HTML, JPG a mnoha dalších formátů pomocí Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Uložte HTML do JPG v Java" %}}

Následující příklad ukazuje, jak převést HTML na JPG v Java.
...
{{% cells-convert title="Ukázkový kód pro převod HTML na JPG" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" InputFormat="html" outformat="jpg" IsLandingPage="true" language="java" %}}

{{% blocks/products/pf/agp/content h2="Jak převést HTML na JPG via Java" %}}

{{% blocks/products/pf/agp/text %}}

Potřebujete převést HTML soubory do JPG programově? Vývojáři Java mohou snadno převést HTML na JPG v několika řádcích kódu.
...
1.  Převeďte HTML na JPG voláním metody Workbook.save.
1.  Získejte výsledek převodu HTML na JPG.

{{% /blocks/products/pf/agp/content %}}

{{% blocks/products/pf/agp/content h2="Knihovna Java pro převod HTML na JPG" %}}
{{% blocks/products/pf/agp/text %}}
