---
title: Java JPG para BMP - Conversor JPG para BMP
description: Aspose Excel. Converta JPG em BMP de forma rápida e fácil com Aspose.Cells. Java JPG em BMP. Java Salve JPG em BMP. Salve JPG como BMP usando Java.
...
{{< blocks/products/pf/i18n/upper-banner h1="Converter JPG para BMP em Java" h2="Biblioteca Java de alta velocidade para converter JPG em BMP. Esta é uma solução de software profissional para importar e exportar JPG, BMP e muitos outros formatos usando Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Salve JPG em BMP em Java" %}}

O exemplo a seguir demonstra como converter JPG para BMP em Java.
...
{{% blocks/products/pf/agp/content h2="Como converter JPG para BMP via Java" %}}

{{% blocks/products/pf/agp/text %}}

Precisa converter arquivos JPG para BMP programaticamente? Os desenvolvedores do Java podem converter facilmente JPG em BMP em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/content h2="Biblioteca Java para converter JPG em BMP" %}}
{{% blocks/products/pf/agp/text %}}
