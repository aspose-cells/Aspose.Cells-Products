...
url: /sv/cpp/merger/merge-png-to-docx/ 
...
Följande exempel visar hur man slår samman PNG till DOCX i Aspose.Cells for C++.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Behöver du slå samman PNG till DOCX programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for C++](https://products.aspose.com/cells/cpp) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2="C++ bibliotek för att slå samman PNG till DOCX" %}}
