---
title: Scal JPG do SPREADSHEETML - Połącz JPG do SPREADSHEETML w C#
url: /pl/net/merger/merge-jpg-to-spreadsheetml/ 
description: Aspose Excel. C# Aspose.Cells. Bezpłatne scalanie JPG online do formatu zapisu SPREADSHEETML. C# Połącz JPG z formatem SPREADSHEETML. Scal JPG do SPREADSHEETML w C#. Scal JPG.
...
{{% blocks/products/pf/agp/content h2="Scal JPG do SPREADSHEETML w C# Online za darmo" %}}

Poniższy przykład pokazuje, jak scalić JPG z SPREADSHEETML w Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Wykonaj proste kroki, aby scalić JPG z SPREADSHEETML. Prześlij swoje pliki, wywołaj metodę Workbook.Combine do scalania plików, a następnie zapisz ją w pliku SPREADSHEETML. Jeśli opracujesz kod w C#, będzie to prostsze niż się wydaje. Zobacz przykład C#, który scala JPG z SPREADSHEETML.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Bezpłatnie online, aby scalić JPG do SPREADSHEETML w C#" InputFormat="jpg" InputFormat2="xml" outformat="xml" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Jak scalić JPG z SPREADSHEETML przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 Chcesz programowo scalić JPG z SPREADSHEETML? Podstawowy dokument łączący i łączący z[Aspose.Cells for .NET](https://products.aspose.com/cells/net) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
...
{{% blocks/products/pf/agp/content h2=".NET biblioteka do scalania JPG z SPREADSHEETML" %}}
