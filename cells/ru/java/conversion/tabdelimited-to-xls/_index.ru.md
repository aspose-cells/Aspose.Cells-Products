---
title: Преобразование TABDELIMITED в XLS через Java 
url: /ru/java/conversion/tabdelimited-to-xls/ 
description: Пример кода преобразования Java для формата TABDELIMITED в файл XLS. Программисты могут использовать этот пример кода для экспорта электронных таблиц Excel и OpenOffice в формат XLS в любом веб- или настольном Java приложении.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Преобразование TABDELIMITED в XLS через Java" h2="TABDELIMITED для преобразования XLS Java для преобразования одной или нескольких страниц в XLS с использованием локальной библиотеки Java." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XLS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TABDELIMITED" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать TABDELIMITED в XLS с помощью Java" %}}

 Чтобы преобразовать TABDELIMITED в XLS, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию TABDELIMITED в XLS через Java" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчики Java могут легко преобразовать файл TABDELIMITED в XLS, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузите файл TABDELIMITED с экземпляром класса Workbook1. Вызов метода Workbook.save1. Передайте выходной путь с расширением XLS и SaveFormat в качестве параметров1. Проверить указанный путь для результирующего файла XLS
...
{{% blocks/products/pf/agp/code-block title="TABDELIMITED в XLS Java Исходный код преобразования" offSpacer="" %}}

```cs
// загрузить файл TABDELIMITED в экземпляр Workbook
Workbook book = new Workbook("template.tabdelimited");
// сохранить TABDELIMITED как XLS
...
{{< blocks/products/pf/agp/demobox sectionTitle="Преобразование TABDELIMITED в XLS Live Demos" sectionDescription="[Конвертировать TABDELIMITED в XLS](https://products.aspose.app/cells/conversion/tabdelimited-to-xls) прямо сейчас, посетив наш веб-сайт Live Demos. Живая демонстрация имеет следующие преимущества" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Нет необходимости загружать Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Нет необходимости писать какой-либо код." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Просто загрузите файл TABDELIMITED, и он будет мгновенно преобразован в XLS." >}}
