...
url: /pl/python-java/merger/merge-xlsb-to-sxc/ 
...
Poniższy przykład pokazuje, jak połączyć XLSB z SXC w Aspose.Cells for Python via Java.
...
{{% blocks/products/pf/agp/text %}}
 ...
 Chcesz programowo połączyć XLSB z SXC? Podstawowy dokument służący do łączenia i łączenia[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java) Interfejsy API można wykonać za pomocą zaledwie kilku linii kodu.
