---
title: Konversikan FODS ke PDF melalui Java 
url: /id/java/conversion/fods-to-pdf/ 
description: Contoh Java kode konversi untuk format FODS ke file PDF. Pemrogram dapat menggunakan kode contoh ini untuk mengekspor spreadsheet Excel & OpenOffice ke PDF dalam Aplikasi berbasis Web atau Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan FODS ke PDF melalui Java" h2="Konversi FODS ke PDF Java untuk mengonversi satu atau beberapa halaman ke PDF menggunakan perpustakaan Java Lokal." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/cells/aspose_cells-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FODS" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi FODS ke PDF Menggunakan Java" %}}

 Untuk merender FODS ke PDF, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi FODS ke PDF melalui Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java pengembang dapat dengan mudah mengonversi file FODS ke PDF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file FODS dengan instance kelas Workbook1. Panggil Workbook.save metode1. Lewati jalur keluaran dengan ekstensi PDF & SaveFormat sebagai parameter1. Periksa jalur yang ditentukan untuk file PDF yang dihasilkan
...
{{% blocks/products/pf/agp/code-block title="FODS ke PDF Java Kode Sumber Konversi" offSpacer="" %}}

```cs
// memuat file FODS dalam contoh Workbook
Workbook book = new Workbook("template.fods");
// simpan FODS sebagai PDF
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi FODS ke PDF" sectionDescription="[Konversikan FODS ke PDF](https://products.aspose.app/cells/conversion/fods-to-pdf) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file FODS Anda, itu akan langsung dikonversi ke PDF." >}}
