...
هل تحتاج إلى تحويل ملفات IMAGE إلى ET برمجياً؟ يمكن لمطوري C++ تحويل IMAGE إلى ET بسهولة في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل IMAGE إلى ET عن طريق استدعاء طريقة Save().
