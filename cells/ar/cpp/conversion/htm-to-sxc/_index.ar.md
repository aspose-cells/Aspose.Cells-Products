...
هل تحتاج إلى تحويل ملفات HTM إلى SXC برمجيًا؟ يمكن للمطورين C++ بسهولة تحويل HTM إلى SXC في بضعة أسطر من التعليمات البرمجية.
...
1.  قم بتحويل HTM إلى SXC باستدعاء طريقة Save ().
