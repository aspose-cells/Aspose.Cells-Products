---
title: Slå samman XML till DOCX - Kombinera XML till DOCX i C#
url: /sv/net/merger/merge-xml-to-docx/ 
description: Aspose Excel. C# Aspose.Cells. Free Online Merge XML to DOCX saveformat. C# Kombinera XML till DOCX format. Slå samman XML till DOCX i C#. XML Merge.
...
{{% blocks/products/pf/agp/content h2="Slå samman XML till DOCX i C# Online gratis" %}}

Följande exempel visar hur man slår samman XML till DOCX i Aspose.Cells for .NET.
{{% blocks/products/pf/agp/text %}}

Följ de enkla stegen för att sammanfoga XML till DOCX. Ladda upp dina filer, anrop Workbook.Combine-metoden för att sammanfoga filer och spara den sedan i filen DOCX. Om du utvecklar kod i C# blir detta enklare än det låter. Se C# exempel som slår samman XML med DOCX.

{{% /blocks/products/pf/agp/text %}}

{{% /blocks/products/pf/agp/content %}}

{{% cells-merger title="Gratis online för att slå samman XML till DOCX i C#" InputFormat="xml" InputFormat2="docx" outformat="docx" formats="pdf;xls;xlsx;docx;pptx;xlsm;xlsb;xlt;ods;ots;csv;tsv;html;htm;mht;numbers;jpg;bmp;png;webp;svg;tiff;xps;mhtml;md;json;xml;zip;sql;txt;et;ett;prn;dif;emf;fods;gif;sxc;xlam;xltm;xltx" IsLandingPage="true" language="net" %}}

{{% blocks/products/pf/agp/content h2="Hur man sammanfogar XML till DOCX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Behöver du slå samman XML till DOCX programmatiskt? Ett grundläggande dokument som sammanfogas och sammanfogas med[Aspose.Cells for .NET](https://products.aspose.com/cells/net) API:er kan göras med bara några rader kod.
...
{{% blocks/products/pf/agp/content h2=".NET bibliotek för att slå samman XML till DOCX" %}}
